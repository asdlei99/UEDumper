...
public:
	...
	// void ServerRequestServerTime(double requestUtcTime);                                                                  // [0x7b87c20] Net|NetReliableNative|Event|Public|NetServer|BlueprintCallable 
	// Function /Script/EpicMediaUtilities.EpicMediaServerTime.GetTimeUtc
	// bool GetTimeUtc(FDateTime& OutDateTime);                                                                              // [0x7b87b88] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EpicMediaUtilities.EpicMediaServerTime.ClientReportServerTime
	// void ClientReportServerTime(double requestUtcTime, double serverUtcTime);                                             // [0x7b87ab0] Net|NetReliableNative|Event|Public|NetClient 
};
...
{ 
	SDK_UNDEFINED(16,2017) /* FString */               __um(URL);                                                  // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2018) /* FString */               __um(FullUrl);                                              // 0x0010   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2019) /* FString */               __um(Language);                                             // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2020) /* FString */               __um(Type);                                                 // 0x0010   (0x0010)  
	SDK_UNDEFINED(16,2021) /* FString */               __um(URL);                                                  // 0x0020   (0x0010)  
	SDK_UNDEFINED(16,2022) /* FString */               __um(RelUrl);                                               // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,2023) /* FString */               __um(Data);                                                 // 0x0040   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,2024) /* FString */               __um(Type);                                                 // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,2025) /* TArray<FString> */       __um(AllowList);                                            // 0x0018   (0x0010)  
	SDK_UNDEFINED(16,2026) /* TArray<FString> */       __um(DenyList);                                             // 0x0028   (0x0010)  
	SDK_UNDEFINED(80,2027) /* TMap<FString, FString> */ __um(Limits);                                              // 0x0038   (0x0050)  
	SDK_UNDEFINED(16,2028) /* FString */               __um(ContentId);                                            // 0x0088   (0x0010)  
...
{ 
	SDK_UNDEFINED(80,2029) /* TMap<FString, FEpicMediaAudioMetadataTrackIndicesExt> */ __um(TrackData);            // 0x0000   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(16,2030) /* FString */               __um(ShortName);                                            // 0x0000   (0x0010)  
	int32_t                                            SongID;                                                     // 0x0010   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0014   (0x0004)  MISSED
	SDK_UNDEFINED(16,2031) /* FString */               __um(Title);                                                // 0x0018   (0x0010)  
	SDK_UNDEFINED(16,2032) /* FString */               __um(Artist);                                               // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,2033) /* FString */               __um(Album);                                                // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,2034) /* FString */               __um(Genre);                                                // 0x0048   (0x0010)  
	int32_t                                            Year;                                                       // 0x0058   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x005C   (0x0004)  MISSED
	SDK_UNDEFINED(80,2035) /* TMap<FString, int32_t> */ __um(Difficulty);                                          // 0x0060   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(80,2036) /* TMap<FString, FEpicMediaAudioMetadataTrackIndicesExt> */ __um(Tracks);               // 0x0000   (0x0050)  
...
{ 
	SDK_UNDEFINED(16,2037) /* FString */               __um(AssetId);                                              // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2038) /* TArray<FString> */       __um(BaseURLs);                                             // 0x0010   (0x0010)  
	SDK_UNDEFINED(16,2039) /* FString */               __um(BaseURL);                                              // 0x0020   (0x0010)  
	...
	SDK_UNDEFINED(16,2040) /* FString */               __um(UserContentProtection);                                // 0x0048   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,2041) /* FString */               __um(Type);                                                 // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,2042) /* FString */               __um(Envelope);                                             // 0x0040   (0x0010)  
	SDK_UNDEFINED(16,2043) /* FString */               __um(Limits);                                               // 0x0050   (0x0010)  
	SDK_UNDEFINED(16,2044) /* FString */               __um(Subtitles);                                            // 0x0060   (0x0010)  
	SDK_UNDEFINED(16,2045) /* FString */               __um(UserContentProtection);                                // 0x0070   (0x0010)  
	...
	SDK_UNDEFINED(16,2046) /* FString */               __um(DenyHTTPCode);                                         // 0x0090   (0x0010)  
