...
{ 
	SDK_UNDEFINED(16,13736) /* FString */              __um(EventName);                                            // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,13737) /* FString */              __um(EventPage);                                            // 0x0010   (0x0010)  
	SDK_UNDEFINED(16,13738) /* FString */              __um(VUID);                                                 // 0x0020   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,13739) /* FMulticastInlineDelegate */ __um(OnPlayCompleted);                                  // 0x0168   (0x0010)  
	SDK_UNDEFINED(16,13740) /* FMulticastInlineDelegate */ __um(CMSMetadataEvent);                                 // 0x0178   (0x0010)  
	...
	SDK_UNDEFINED(32,13741) /* TWeakObjectPtr<AActor*> */ __um(MirroredDevice);                                    // 0x0210   (0x0020)  
	...
	SDK_UNDEFINED(12,13742) /* FDelegateProperty */    __um(OnSubmixSpectralAnalysisDelegate);                     // 0x0268   (0x000C)  
