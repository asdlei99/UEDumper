...
public:
	...
	// void FireEvent_EndJunoFishingSession(class AFortPlayerPawn* PlayerPawn, class UFortWorldItemDefinition* ItemFished, bool bFromHotspot, bool bIsPlayerSpawnedHotspot, FString HotspotTierTag, FString WaterBodyName, FString CatchTypeName, class AActor* ItemUsedToFish); // [0xc07a898] Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
	// Function /Script/JunoFishing.JunoFishingBlueprintLibrary.FireEvent_BeginJunoFishingSession
	// void FireEvent_BeginJunoFishingSession(class AFortPlayerPawn* PlayerPawn);                                            // [0xc07a804] Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
};
...
{ 
	...
	SDK_UNDEFINED(8,14369) /* TWeakObjectPtr<AActor*> */ __um(ItemUsedToFish);                                     // 0x0010   (0x0008)  
	...
	SDK_UNDEFINED(16,14370) /* FString */              __um(HotspotTierTag);                                       // 0x0020   (0x0010)  
	SDK_UNDEFINED(16,14371) /* FString */              __um(WaterBodyName);                                        // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,14372) /* FString */              __um(CatchTypeName);                                        // 0x0040   (0x0010)  
};
