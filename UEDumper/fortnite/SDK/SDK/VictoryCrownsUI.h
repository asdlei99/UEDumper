...
public:
	...
	// void RebuildBearerIndicators(TArray<AFortPlayerStateAthena*>& CrownBearerList);                                       // [0xb7d5188] Final|Native|Protected|HasOutParms 
};
...
{ 
public:
	SDK_UNDEFINED(8,15603) /* TWeakObjectPtr<AFortPlayerStateAthena*> */ __um(WeakPSA);                            // 0x02E8   (0x0008)  
	...
	// void SetPlayerState(class AFortPlayerStateAthena* InPlayerState);                                                     // [0xb7d52d4] Final|Native|Public|BlueprintCallable 
	// Function /Script/VictoryCrownsUI.VictoryCrownsBearerInfoBase.OnSetPlayerState
	// void OnSetPlayerState(class AFortPlayerStateAthena* PSA);                                                             // [0x3d1d968] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// class AFortPlayerStateAthena* GetIndicatedPlayerStateAthena();                                                        // [0xb7d50ac] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnPlayerVictoryCrownStatusChanged(bool bHasCrown);                                                               // [0x3d1d968] Event|Protected|BlueprintEvent 
	// Function /Script/VictoryCrownsUI.VictoryCrownsPlayerInfoWidget.HandleCrownBearerListChanged
	// void HandleCrownBearerListChanged(TArray<AFortPlayerStateAthena*>& CrownBearerList);                                  // [0xb7d50d0] Final|Native|Protected|HasOutParms 
};
...
public:
	...
	// void UnregisterCloseButtonInput();                                                                                    // [0xb7d5354] Final|Native|Private 
	// Function /Script/VictoryCrownsUI.VictoryCrownsPreGameWidget.StartFadeOut
	// void StartFadeOut();                                                                                                  // [0x3d1d968] Event|Protected|BlueprintEvent 
	// Function /Script/VictoryCrownsUI.VictoryCrownsPreGameWidget.RegisterCloseButtonInput
	// void RegisterCloseButtonInput();                                                                                      // [0xb7d52c0] Final|Native|Private 
	// Function /Script/VictoryCrownsUI.VictoryCrownsPreGameWidget.RebuildBearerList
	// void RebuildBearerList(TArray<AFortPlayerStateAthena*>& CrownBearerList);                                             // [0xb7d5224] Final|Native|Private|HasOutParms 
	// Function /Script/VictoryCrownsUI.VictoryCrownsPreGameWidget.OnInputMethodChanged
	// void OnInputMethodChanged(ECommonInputType CurrentInput);                                                             // [0x3d1d968] Event|Protected|BlueprintEvent 
	// Function /Script/VictoryCrownsUI.VictoryCrownsPreGameWidget.OnCloseActionsComplete
	// void OnCloseActionsComplete();                                                                                        // [0xb7d516c] Final|Native|Protected|BlueprintCallable 
	// Function /Script/VictoryCrownsUI.VictoryCrownsPreGameWidget.OnButtonCloseProgress
	// void OnButtonCloseProgress(float Progress);                                                                           // [0x3d1d968] Event|Protected|BlueprintEvent 
	// Function /Script/VictoryCrownsUI.VictoryCrownsPreGameWidget.OnButtonClose
	// void OnButtonClose();                                                                                                 // [0x3d1d968] Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/VictoryCrownsUI.VictoryCrownsPreGameWidget.FadeOutTimerFinished
	// void FadeOutTimerFinished();                                                                                          // [0xb7d5098] Final|Native|Private 
};
