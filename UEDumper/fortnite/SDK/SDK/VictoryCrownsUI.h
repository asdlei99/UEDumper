...
public:
	...
	// void RebuildBearerIndicators(TArray<AFortPlayerStateAthena*>& CrownBearerList);                                       // [0xb6c7ffc] Final|Native|Protected|HasOutParms 
};
...
{ 
public:
	SDK_UNDEFINED(8,15460) /* TWeakObjectPtr<AFortPlayerStateAthena*> */ __um(WeakPSA);                            // 0x02E8   (0x0008)  
	...
	// void SetPlayerState(class AFortPlayerStateAthena* InPlayerState);                                                     // [0xb6c8148] Final|Native|Public|BlueprintCallable 
	// Function /Script/VictoryCrownsUI.VictoryCrownsBearerInfoBase.OnSetPlayerState
	// void OnSetPlayerState(class AFortPlayerStateAthena* PSA);                                                             // [0x130d900] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// class AFortPlayerStateAthena* GetIndicatedPlayerStateAthena();                                                        // [0xb6c7f20] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnPlayerVictoryCrownStatusChanged(bool bHasCrown);                                                               // [0x130d900] Event|Protected|BlueprintEvent 
	// Function /Script/VictoryCrownsUI.VictoryCrownsPlayerInfoWidget.HandleCrownBearerListChanged
	// void HandleCrownBearerListChanged(TArray<AFortPlayerStateAthena*>& CrownBearerList);                                  // [0xb6c7f44] Final|Native|Protected|HasOutParms 
};
...
public:
	...
	// void UnregisterCloseButtonInput();                                                                                    // [0xb6c8208] Final|Native|Private 
	// Function /Script/VictoryCrownsUI.VictoryCrownsPreGameWidget.StartFadeOut
	// void StartFadeOut();                                                                                                  // [0x130d900] Event|Protected|BlueprintEvent 
	// Function /Script/VictoryCrownsUI.VictoryCrownsPreGameWidget.RegisterCloseButtonInput
	// void RegisterCloseButtonInput();                                                                                      // [0xb6c8134] Final|Native|Private 
	// Function /Script/VictoryCrownsUI.VictoryCrownsPreGameWidget.RebuildBearerList
	// void RebuildBearerList(TArray<AFortPlayerStateAthena*>& CrownBearerList);                                             // [0xb6c8098] Final|Native|Private|HasOutParms 
	// Function /Script/VictoryCrownsUI.VictoryCrownsPreGameWidget.OnInputMethodChanged
	// void OnInputMethodChanged(ECommonInputType CurrentInput);                                                             // [0x130d900] Event|Protected|BlueprintEvent 
	// Function /Script/VictoryCrownsUI.VictoryCrownsPreGameWidget.OnCloseActionsComplete
	// void OnCloseActionsComplete();                                                                                        // [0xb6c7fe0] Final|Native|Protected|BlueprintCallable 
	// Function /Script/VictoryCrownsUI.VictoryCrownsPreGameWidget.OnButtonCloseProgress
	// void OnButtonCloseProgress(float Progress);                                                                           // [0x130d900] Event|Protected|BlueprintEvent 
	// Function /Script/VictoryCrownsUI.VictoryCrownsPreGameWidget.OnButtonClose
	// void OnButtonClose();                                                                                                 // [0x130d900] Event|Protected|BlueprintCallable|BlueprintEvent 
	// Function /Script/VictoryCrownsUI.VictoryCrownsPreGameWidget.FadeOutTimerFinished
	// void FadeOutTimerFinished();                                                                                          // [0xb6c7f0c] Final|Native|Private 
};
