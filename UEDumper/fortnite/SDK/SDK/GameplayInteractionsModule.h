...
{ 
public:
	SDK_UNDEFINED(16,2304) /* FMulticastInlineDelegate */ __um(OnFinished);                                        // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,2305) /* FMulticastInlineDelegate */ __um(OnSucceeded);                                       // 0x0078   (0x0010)  
	SDK_UNDEFINED(16,2306) /* FMulticastInlineDelegate */ __um(OnFailed);                                          // 0x0088   (0x0010)  
	SDK_UNDEFINED(16,2307) /* FMulticastInlineDelegate */ __um(OnMoveToFailed);                                    // 0x0098   (0x0010)  
