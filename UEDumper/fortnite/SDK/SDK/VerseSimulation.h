...
{ 
public:
	SDK_UNDEFINED(8,9318) /* TWeakObjectPtr<AController*> */ __um(Controller);                                     // 0x0028   (0x0008)  
};
...
{ 
public:
	SDK_UNDEFINED(80,9319) /* TMap<TWeakObjectPtr<AController*>, UVerseAgent*> */ __um(TrackedAgents);             // 0x0030   (0x0050)  
