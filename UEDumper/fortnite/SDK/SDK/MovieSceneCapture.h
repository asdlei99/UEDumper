...
{ 
public:
	SDK_UNDEFINED(16,14965) /* FString */              __um(Filename);                                             // 0x0058   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,14966) /* TArray<FString> */      __um(Value);                                                // 0x0000   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(1,14967) /* TEnumAsByte<EHDRCaptureGamut> */ __um(CaptureGamut);                                 // 0x0070   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(1,14968) /* TEnumAsByte<EHDRCaptureGamut> */ __um(CaptureGamut);                                 // 0x00D9   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(16,14969) /* FString */              __um(OutputFormat);                                         // 0x0018   (0x0010)  
	...
	SDK_UNDEFINED(16,14970) /* FString */              __um(MovieExtension);                                       // 0x0030   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,14971) /* FString */              __um(AdditionalCommandLineArguments);                       // 0x00F0   (0x0010)  
	SDK_UNDEFINED(16,14972) /* FString */              __um(InheritedCommandLineArguments);                        // 0x0100   (0x0010)  
...
{ 
	SDK_UNDEFINED(80,14973) /* TMap<FName, FName> */   __um(Identifiers);                                          // 0x0000   (0x0050)  
};
