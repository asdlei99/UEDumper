...
{ 
	SDK_UNDEFINED(16,2589) /* FString */               __um(Key);                                                  // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2590) /* FString */               __um(Key);                                                  // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2591) /* FString */               __um(DefaultText);                                          // 0x0010   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2592) /* FString */               __um(Value);                                                // 0x0000   (0x0010)  
};
