...
public:
	...
	SDK_UNDEFINED(16,11837) /* FMulticastInlineDelegate */ __um(OnFailedToSprint);                                 // 0x00B8   (0x0010)  
	...
	SDK_UNDEFINED(16,11838) /* FMulticastInlineDelegate */ __um(OnTacticalSprintStarted);                          // 0x0138   (0x0010)  
	SDK_UNDEFINED(16,11839) /* FMulticastInlineDelegate */ __um(OnTacticalSprintEnded);                            // 0x0148   (0x0010)  
