...
public:
	...
	// void OnVehicleStateChanged(ENevadaFlightStates VehicleState);                                                         // [0x3d1d968] Event|Protected|BlueprintEvent 
	// Function /Script/NevadaUI.FortNevadaVehicleReticle.OnTractorBeamEnabledChanged
	// void OnTractorBeamEnabledChanged(bool bEnabled);                                                                      // [0x3d1d968] Event|Protected|BlueprintEvent 
	// Function /Script/NevadaUI.FortNevadaVehicleReticle.OnTractorBeamDetached
	// void OnTractorBeamDetached();                                                                                         // [0x3d1d968] Event|Protected|BlueprintEvent 
	// Function /Script/NevadaUI.FortNevadaVehicleReticle.OnTractorBeamDeactivated
	// void OnTractorBeamDeactivated(float Cooldown);                                                                        // [0x3d1d968] Event|Protected|BlueprintEvent 
	...
	// void OnEnergyCanonFired(float Cooldown);                                                                              // [0x3d1d968] Event|Protected|BlueprintEvent 
	// Function /Script/NevadaUI.FortNevadaVehicleReticle.OnEnergyCannonEnabledChanged
	// void OnEnergyCannonEnabledChanged(bool bEnabled);                                                                     // [0x3d1d968] Event|Protected|BlueprintEvent 
	// Function /Script/NevadaUI.FortNevadaVehicleReticle.OnBatteryChanged
	// void OnBatteryChanged(float BatteryLevel);                                                                            // [0x3d1d968] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnTractorBeamAttached(bool bAttached);                                                                           // [0x3d1d968] Event|Protected|BlueprintEvent 
	// Function /Script/NevadaUI.NevadaTargetIndicator.OnTractorBeamActivated
	// void OnTractorBeamActivated(bool bActivated);                                                                         // [0x3d1d968] Event|Protected|BlueprintEvent 
};
