...
public:
	...
	SDK_UNDEFINED(16,2337) /* FString */               __um(Salt);                                                 // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,2338) /* TArray<FString> */       __um(CatalogItems);                                         // 0x0040   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(16,2339) /* FString */               __um(Salt);                                                 // 0x0030   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(1,2340) /* TEnumAsByte<ECatalogSaleType> */ __um(SaleType);                                      // 0x0004   (0x0001)  
...
{ 
	SDK_UNDEFINED(16,2345) /* FString */               __um(Storefront);                                           // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2346) /* FString */               __um(StoreId);                                              // 0x0010   (0x0010)  
	SDK_UNDEFINED(16,2347) /* FString */               __um(GroupId);                                              // 0x0020   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2348) /* FString */               __um(IslandId);                                             // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,2349) /* FString */               __um(IslandTitle);                                          // 0x0040   (0x0010)  
	SDK_UNDEFINED(16,2350) /* FString */               __um(ProductTag);                                           // 0x0050   (0x0010)  
	SDK_UNDEFINED(16,2351) /* FString */               __um(StoreContext);                                         // 0x0060   (0x0010)  
	SDK_UNDEFINED(80,2352) /* TMap<FString, FString> */ __um(CheckoutProperties);                                  // 0x0070   (0x0050)  
...
{ 
	SDK_UNDEFINED(16,2353) /* FString */               __um(Key);                                                  // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2354) /* FString */               __um(Value);                                                // 0x0010   (0x0010)  
};
...
{ 
	EAppStore                                          AppStore;                                                   // 0x0000   (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x0001   (0x0007)  MISSED
	SDK_UNDEFINED(16,2355) /* TArray<FString> */       __um(AuthTokens);                                           // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,2356) /* TArray<FString> */       __um(ReceiptIds);                                           // 0x0018   (0x0010)  
	...
	SDK_UNDEFINED(16,2357) /* TArray<FString> */       __um(CatalogItems);                                         // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,2358) /* FString */               __um(PurchaseCorrelationId);                                // 0x0040   (0x0010)  
...
{ 
	EAppStore                                          AppStore;                                                   // 0x0000   (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x0001   (0x0007)  MISSED
	SDK_UNDEFINED(16,2359) /* FString */               __um(AppStoreId);                                           // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,2360) /* FString */               __um(ReceiptId);                                            // 0x0018   (0x0010)  
	SDK_UNDEFINED(16,2361) /* FString */               __um(ReceiptInfo);                                          // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,2362) /* FString */               __um(PurchaseCorrelationId);                                // 0x0038   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(1,2364) /* TEnumAsByte<EStoreCurrencyType> */ __um(Currency);                                    // 0x0014   (0x0001)  
...
{ 
	SDK_UNDEFINED(16,2367) /* FString */               __um(OfferId);                                              // 0x0000   (0x0010)  
	SDK_UNDEFINED(1,2368) /* TEnumAsByte<EStoreCurrencyType> */ __um(Currency);                                    // 0x0010   (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x0011   (0x0007)  MISSED
	SDK_UNDEFINED(16,2369) /* FString */               __um(CurrencySubType);                                      // 0x0018   (0x0010)  
	int32_t                                            ExpectedTotalPrice;                                         // 0x0028   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x002C   (0x0004)  MISSED
	SDK_UNDEFINED(16,2370) /* FString */               __um(GameContext);                                          // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,2371) /* TArray<FString> */       __um(ReceiverAccountIds);                                   // 0x0040   (0x0010)  
	SDK_UNDEFINED(16,2372) /* FString */               __um(GiftWrapTemplateId);                                   // 0x0050   (0x0010)  
	SDK_UNDEFINED(16,2373) /* FString */               __um(PersonalMessage);                                      // 0x0060   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2374) /* FString */               __um(Key);                                                  // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2375) /* FString */               __um(Value);                                                // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2376) /* FString */               __um(StructName);                                           // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2377) /* FString */               __um(TemplateId);                                           // 0x0000   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(24,2378) /* FText */                 __um(Title);                                                // 0x0048   (0x0018)  
	SDK_UNDEFINED(24,2379) /* FText */                 __um(Description);                                          // 0x0060   (0x0018)  
};
...
{ 
	...
	SDK_UNDEFINED(1,2380) /* TEnumAsByte<EStoreCurrencyType> */ __um(CurrencyType);                                // 0x000C   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x000D   (0x0003)  MISSED
	SDK_UNDEFINED(16,2381) /* FString */               __um(CurrencySubType);                                      // 0x0010   (0x0010)  
	SDK_UNDEFINED(1,2382) /* TEnumAsByte<ECatalogSaleType> */ __um(DisplayType);                                   // 0x0020   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(16,2383) /* FString */               __um(RequiredId);                                           // 0x0008   (0x0010)  
};
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x0001   (0x0007)  MISSED
	SDK_UNDEFINED(16,2384) /* FString */               __um(ForcedGiftBoxTemplateId);                              // 0x0008   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2385) /* FString */               __um(OfferId);                                              // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2386) /* FString */               __um(DevName);                                              // 0x0010   (0x0010)  
	...
	SDK_UNDEFINED(16,2387) /* TArray<FString> */       __um(Categories);                                           // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,2388) /* FString */               __um(CatalogGroup);                                         // 0x00A0   (0x0010)  
	int32_t                                            CatalogGroupPriority;                                       // 0x00B0   (0x0004)  
	int32_t                                            SortPriority;                                               // 0x00B4   (0x0004)  
	SDK_UNDEFINED(24,2389) /* FText */                 __um(Title);                                                // 0x00B8   (0x0018)  
	SDK_UNDEFINED(24,2390) /* FText */                 __um(ShortDescription);                                     // 0x00D0   (0x0018)  
	SDK_UNDEFINED(24,2391) /* FText */                 __um(Description);                                          // 0x00E8   (0x0018)  
	SDK_UNDEFINED(192,2392) /* FString */              __um(AppStoreId);                                           // 0x0100   (0x00C0)  
	FCatalogMetaAssetInfo                              MetaAssetInfo;                                              // 0x01C0   (0x0030)  
	SDK_UNDEFINED(16,2393) /* FString */               __um(DisplayAssetPath);                                     // 0x01F0   (0x0010)  
	...
	SDK_UNDEFINED(16,2394) /* TArray<FString> */       __um(DenyItemTemplateIds);                                  // 0x0250   (0x0010)  
};
...
struct FStorefront
{ 
	SDK_UNDEFINED(16,2395) /* FString */               __um(Name);                                                 // 0x0000   (0x0010)  
...
{ 
	EAppStore                                          AppStore;                                                   // 0x0000   (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x0001   (0x0007)  MISSED
	SDK_UNDEFINED(16,2396) /* TArray<FString> */       __um(IDs);                                                  // 0x0008   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2397) /* TArray<FString> */       __um(Receipts);                                             // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2398) /* TArray<FString> */       __um(IgnoredReceipts);                                      // 0x0010   (0x0010)  
	SDK_UNDEFINED(16,2399) /* TArray<FString> */       __um(Fulfillments);                                         // 0x0020   (0x0010)  
	SDK_UNDEFINED(80,2400) /* TMap<FString, int32_t> */ __um(FulfillmentCounts);                                   // 0x0030   (0x0050)  
	SDK_UNDEFINED(80,2401) /* TMap<EAppStore, FMcpEntitlementRefreshTimerInfo> */ __um(RefreshTimers);             // 0x0080   (0x0050)  
