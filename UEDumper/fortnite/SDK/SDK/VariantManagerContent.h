...
public:
	...
	SDK_UNDEFINED(80,15445) /* TMap<UBlueprintGeneratedClass*, ULevelVariantSetsFunctionDirector*> */ __um(DirectorInstances); // 0x02A8   (0x0050)  
...
{ 
	SDK_UNDEFINED(16,15446) /* FString */              __um(PropertyName);                                         // 0x0000   (0x0010)  
	int32_t                                            PropertyIndex;                                              // 0x0010   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0014   (0x0004)  MISSED
	SDK_UNDEFINED(16,15447) /* FString */              __um(ComponentName);                                        // 0x0018   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(16,15448) /* TArray<Properties> */   __um(Properties);                                           // 0x0088   (0x0010)  
	TArray<int32_t>                                    PropertyIndices;                                            // 0x0098   (0x0010)  
	TArray<FCapturedPropSegment>                       CapturedPropSegments;                                       // 0x00A8   (0x0010)  
	SDK_UNDEFINED(16,15449) /* FString */              __um(FullDisplayString);                                    // 0x00B8   (0x0010)  
	FName                                              PropertySetterName;                                         // 0x00C8   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x00CC   (0x0004)  MISSED
	SDK_UNDEFINED(80,15450) /* TMap<FString, FString> */ __um(PropertySetterParameterDefaults);                    // 0x00D0   (0x0050)  
...
{ 
	SDK_UNDEFINED(32,15451) /* TWeakObjectPtr<UVariantSet*> */ __um(VariantSet);                                   // 0x0000   (0x0020)  
	SDK_UNDEFINED(32,15452) /* TWeakObjectPtr<UVariant*> */ __um(Variant);                                         // 0x0020   (0x0020)  
...
public:
	...
	SDK_UNDEFINED(24,15453) /* FText */                __um(DisplayText);                                          // 0x0038   (0x0018)  
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(16,15454) /* FString */              __um(CachedActorLabel);                                     // 0x0028   (0x0010)  
	FSoftObjectPath                                    ObjectPtr;                                                  // 0x0038   (0x0018)  
	SDK_UNDEFINED(24,15455) /* TLazyObjectPtr<UObject*> */ __um(LazyObjectPtr);                                    // 0x0050   (0x0018)  
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(24,15456) /* FText */                __um(DisplayText);                                          // 0x0028   (0x0018)  
