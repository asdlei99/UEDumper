...
{ 
	SDK_UNDEFINED(16,13344) /* FString */              __um(CurrentLevel);                                         // 0x0000   (0x0010)  
	...
	SDK_UNDEFINED(16,13345) /* FString */              __um(InstanceType);                                         // 0x0028   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,13346) /* FString */              __um(UserName);                                             // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,13347) /* FString */              __um(UserToDeny);                                           // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,13348) /* FString */              __um(UserName);                                             // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,13349) /* FString */              __um(UserToGrant);                                          // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,13350) /* FString */              __um(Command);                                              // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,13351) /* FString */              __um(UserName);                                             // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,13352) /* FString */              __um(UserName);                                             // 0x0000   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,13353) /* FString */              __um(Text);                                                 // 0x0000   (0x0010)  
