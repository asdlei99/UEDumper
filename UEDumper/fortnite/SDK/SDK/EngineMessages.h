...
{ 
	SDK_UNDEFINED(16,13438) /* FString */              __um(CurrentLevel);                                         // 0x0000   (0x0010)  
	...
	SDK_UNDEFINED(16,13439) /* FString */              __um(InstanceType);                                         // 0x0028   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,13440) /* FString */              __um(UserName);                                             // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,13441) /* FString */              __um(UserToDeny);                                           // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,13442) /* FString */              __um(UserName);                                             // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,13443) /* FString */              __um(UserToGrant);                                          // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,13444) /* FString */              __um(Command);                                              // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,13445) /* FString */              __um(UserName);                                             // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,13446) /* FString */              __um(UserName);                                             // 0x0000   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,13447) /* FString */              __um(Text);                                                 // 0x0000   (0x0010)  
