...
{ 
public:
	SDK_UNDEFINED(80,9277) /* TMap<FGuid, UVerseItem*> */ __um(ItemMap);                                           // 0x0048   (0x0050)  
	SDK_UNDEFINED(80,9278) /* TMap<FGuid, UVerseInventory*> */ __um(InventoryMap);                                 // 0x0098   (0x0050)  
	SDK_UNDEFINED(80,9279) /* TMap<FGuid, UVerseInventory*> */ __um(EquippableInventoryMap);                       // 0x00E8   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(8,9280) /* TWeakObjectPtr<AInventoryCollection*> */ __um(OwningInventoryCollection);             // 0x0038   (0x0008)  
	SDK_UNDEFINED(8,9281) /* TWeakObjectPtr<UVerseInventoryCollectionWrapper*> */ __um(OwningCollectionWrapper);   // 0x0040   (0x0008)  
	SDK_UNDEFINED(80,9282) /* TSet<FGuid> */           __um(ItemSetIDSet);                                         // 0x0048   (0x0050)  
