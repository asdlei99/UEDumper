...
/// Size: 0x07
enum class EMovieSceneSubSectionFlags : uint32_t
{
...
public:
	...
	unsigned char                                      UnknownData01_6[0x310];                                     // 0x0430   (0x0310)  MISSED
};
...
{ 
public:
	unsigned char                                      UnknownData00_3[0x240];                                     // 0x0000   (0x0240)  MISSED
...
{ 
	...
	EMovieSceneSubSectionFlags                         Flags;                                                      // 0x0018   (0x0004)  
