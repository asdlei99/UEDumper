...
{ 
	SDK_UNDEFINED(32,12299) /* TWeakObjectPtr<AActor*> */ __um(Target);                                            // 0x0000   (0x0020)  
...
{ 
	...
	SDK_UNDEFINED(8,12300) /* TWeakObjectPtr<UUserWidget*> */ __um(Widget);                                        // 0x0004   (0x0008)  
};
...
public:
	...
	SDK_UNDEFINED(32,12301) /* TWeakObjectPtr<UFortWeaponItemDefinition*> */ __um(ActivatorAsset);                 // 0x0100   (0x0020)  
	TArray<FUIExtension>                               UIExtensions;                                               // 0x0120   (0x0010)  
	SDK_UNDEFINED(80,12302) /* TMap<FGameplayTag, TWeakObjectPtr<UClass*>> */ __um(TaggedUIExtensions);            // 0x0130   (0x0050)  
	...
	SDK_UNDEFINED(32,12303) /* TWeakObjectPtr<AActor*> */ __um(CurrentlyFocusedActor);                             // 0x01B0   (0x0020)  
