...
{ 
	SDK_UNDEFINED(16,9459) /* FString */               __um(CountryCode);                                          // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,9460) /* FString */               __um(ProfanityList);                                        // 0x0010   (0x0010)  
	SDK_UNDEFINED(16,9461) /* FString */               __um(WhiteList);                                            // 0x0020   (0x0010)  
