...
{ 
	SDK_UNDEFINED(16,9410) /* FString */               __um(CountryCode);                                          // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,9411) /* FString */               __um(ProfanityList);                                        // 0x0010   (0x0010)  
	SDK_UNDEFINED(16,9412) /* FString */               __um(WhiteList);                                            // 0x0020   (0x0010)  
