...
public:
	...
	SDK_UNDEFINED(16,12277) /* FString */              __um(DebugControlDetailFilter);                             // 0x0238   (0x0010)  
	bool                                               bShowDebugBodyModifierList;                                 // 0x0248   (0x0001)  
	unsigned char                                      UnknownData02_5[0x7];                                       // 0x0249   (0x0007)  MISSED
	SDK_UNDEFINED(16,12278) /* FString */              __um(DebugBodyModifierDetailFilter);                        // 0x0250   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(32,12279) /* TWeakObjectPtr<USkeletalMesh*> */ __um(PreviewSkeletalMesh);                        // 0x0030   (0x0020)  
...
public:
	...
	SDK_UNDEFINED(80,12280) /* TMap<FName, FInitialPhysicsControl> */ __um(InitialControls);                       // 0x02F8   (0x0050)  
	SDK_UNDEFINED(80,12281) /* TMap<FName, FInitialBodyModifier> */ __um(InitialBodyModifiers);                    // 0x0348   (0x0050)  
...
{ 
	SDK_UNDEFINED(80,12282) /* TMap<FName, FRigidBodyControlTarget> */ __um(Targets);                              // 0x0000   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(80,12283) /* TMap<FName, FRigidBodyKinematicTarget> */ __um(Targets);                            // 0x0000   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(1,12284) /* TEnumAsByte<ECollisionChannel> */ __um(OverlapChannel);                              // 0x02E4   (0x0001)  
	...
	SDK_UNDEFINED(80,12285) /* TMap<FName, FName> */   __um(BoneToBodyNameMap);                                    // 0x02F8   (0x0050)  
