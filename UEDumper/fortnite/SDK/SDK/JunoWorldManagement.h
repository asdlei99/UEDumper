...
public:
	...
	SDK_UNDEFINED(16,11916) /* FString */              __um(DeviceProfileSuffix);                                  // 0x0038   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,11917) /* TMap<FString, UJunoUserWorldView*> */ __um(WorldViewMap);                           // 0x0170   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(80,11918) /* TMap<FString, UJunoUserWorldView*> */ __um(WorldViewMap);                           // 0x0028   (0x0050)  
...
{ 
	SDK_UNDEFINED(16,11919) /* FString */              __um(McpBackend);                                           // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,11920) /* FString */              __um(ID);                                                   // 0x0000   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,11921) /* FString */              __um(Title);                                                // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,11922) /* FString */              __um(MapName);                                              // 0x0018   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,11923) /* FString */              __um(ID);                                                   // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(80,11924) /* TMap<FString, FName> */ __um(GameplayProperties);                                   // 0x0000   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(16,11925) /* FString */              __um(WorldId);                                              // 0x0000   (0x0010)  
};
