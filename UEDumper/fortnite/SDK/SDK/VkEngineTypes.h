...
enum class EValkyrieProjectDescriptorFileVersion : uint8_t
{
	...
	EValkyrieProjectDescriptorFileVersion__LatestPlusOne                             = 15,
	EValkyrieProjectDescriptorFileVersion__Latest                                    = 14,
	EValkyrieProjectDescriptorFileVersion__EValkyrieProjectDescriptorFileVersion_MAX = 16
};
...
enum class EVkValidationFlags : uint8_t
{
	...
	EVkValidationFlags__EVkValidationFlags_MAX                                       = 17
};
...
{ 
	SDK_UNDEFINED(16,2752) /* FString */               __um(SessionId);                                            // 0x0000   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2753) /* FString */               __um(Name);                                                 // 0x0000   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,2754) /* FString */               __um(ID);                                                   // 0x0008   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2755) /* FString */               __um(ProjectID);                                            // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2756) /* FString */               __um(ProjectVersePath);                                     // 0x0010   (0x0010)  
	SDK_UNDEFINED(80,2757) /* TMap<FString, FString> */ __um(Modules);                                             // 0x0020   (0x0050)  
};
...
{ 
	char                                               FileVersion;                                                // 0x0000   (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x0001   (0x0007)  MISSED
	SDK_UNDEFINED(16,2758) /* FString */               __um(VersionSuffix);                                        // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,2759) /* FString */               __um(Title);                                                // 0x0018   (0x0010)  
	SDK_UNDEFINED(16,2760) /* FString */               __um(Description);                                          // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,2761) /* FString */               __um(KeyArt);                                               // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,2762) /* FString */               __um(DocsUrl);                                              // 0x0048   (0x0010)  
	EValkyrieProjectKind                               Kind;                                                       // 0x0058   (0x0004)  
	EValkyrieProjectTemplateCategory                   TemplateCategory;                                           // 0x005C   (0x0004)  
	SDK_UNDEFINED(16,2763) /* FString */               __um(CompatibilityVersion);                                 // 0x0060   (0x0010)  
	SDK_UNDEFINED(16,2764) /* TArray<FString> */       __um(EditorPermissions);                                    // 0x0070   (0x0010)  
	SDK_UNDEFINED(16,2765) /* FString */               __um(EpicApp);                                              // 0x0080   (0x0010)  
	...
	SDK_UNDEFINED(80,2766) /* TMap<FString, FJsonObjectWrapper> */ __um(DataSets);                                 // 0x00A8   (0x0050)  
...
struct FVkNamedId
{ 
	SDK_UNDEFINED(16,2767) /* FString */               __um(Name);                                                 // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2768) /* FString */               __um(ID);                                                   // 0x0010   (0x0010)  
};
...
struct FVkTypedId
{ 
	SDK_UNDEFINED(16,2769) /* FString */               __um(ID);                                                   // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2770) /* FString */               __um(Mnemonic);                                             // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2771) /* FString */               __um(Platform);                                             // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2772) /* FString */               __um(BuildVersion);                                         // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2773) /* FString */               __um(ArtifactId);                                           // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2774) /* FString */               __um(ArtifactId);                                           // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2775) /* FString */               __um(Name);                                                 // 0x0010   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2776) /* FString */               __um(ModuleId);                                             // 0x0000   (0x0010)  
	int32_t                                            Version;                                                    // 0x0010   (0x0004)  
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x0014   (0x0004)  MISSED
};
...
{ 
	SDK_UNDEFINED(16,2777) /* FString */               __um(ModuleId);                                             // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2778) /* FString */               __um(TicketId);                                             // 0x0010   (0x0010)  
};
...
struct FVkModuleDoc
{ 
	SDK_UNDEFINED(16,2779) /* FString */               __um(ModuleId);                                             // 0x0000   (0x0010)  
	FDateTime                                          Created;                                                    // 0x0010   (0x0008)  
	FDateTime                                          Updated;                                                    // 0x0018   (0x0008)  
	FVkTypedId                                         Author;                                                     // 0x0020   (0x0018)  
	SDK_UNDEFINED(16,2780) /* FString */               __um(ProjectID);                                            // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,2781) /* FString */               __um(ModuleName);                                           // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,2782) /* FString */               __um(ContentType);                                          // 0x0058   (0x0010)  
	SDK_UNDEFINED(80,2783) /* TMap<EConsumerRole, bool> */ __um(Relevance);                                        // 0x0068   (0x0050)  
	SDK_UNDEFINED(16,2784) /* FString */               __um(AliasForModuleId);                                     // 0x00B8   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(80,2785) /* TMap<FString, int32_t> */ __um(Resolutions);                                         // 0x0018   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(16,2786) /* FString */               __um(ProjectID);                                            // 0x0000   (0x0010)  
	SDK_UNDEFINED(80,2787) /* TMap<FString, FString> */ __um(ProjectFlags);                                        // 0x0010   (0x0050)  
...
{ 
	SDK_UNDEFINED(16,2788) /* FString */               __um(GameFeaturePluginUri);                                 // 0x0000   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2789) /* FString */               __um(BaseURL);                                              // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2790) /* FString */               __um(manifest);                                             // 0x0010   (0x0010)  
	SDK_UNDEFINED(16,2791) /* TArray<FString> */       __um(Files);                                                // 0x0020   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2792) /* FString */               __um(ModuleId);                                             // 0x0000   (0x0010)  
	int32_t                                            Version;                                                    // 0x0010   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0014   (0x0004)  MISSED
	SDK_UNDEFINED(16,2793) /* FString */               __um(BinaryVersion);                                        // 0x0018   (0x0010)  
	SDK_UNDEFINED(16,2794) /* FString */               __um(ArtifactId);                                           // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,2795) /* FString */               __um(CookJobId);                                            // 0x0038   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2796) /* FString */               __um(ProjectID);                                            // 0x0000   (0x0010)  
	SDK_UNDEFINED(80,2797) /* TMap<FString, FString> */ __um(ProjectFlags);                                        // 0x0010   (0x0050)  
...
{ 
	SDK_UNDEFINED(16,2798) /* FString */               __um(ArtifactId);                                           // 0x0018   (0x0010)  
	SDK_UNDEFINED(16,2799) /* FString */               __um(CookJobId);                                            // 0x0028   (0x0010)  
...
struct FVkFileSize
{ 
	SDK_UNDEFINED(16,2800) /* TArray<FString> */       __um(Types);                                                // 0x0000   (0x0010)  
...
struct FVkFileSizes
{ 
	SDK_UNDEFINED(80,2801) /* TMap<FString, FVkFileSize> */ __um(FileSizeMap);                                     // 0x0000   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(16,2802) /* FString */               __um(Key);                                                  // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2803) /* FString */               __um(Value);                                                // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2804) /* FString */               __um(FormatKey);                                            // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2805) /* FString */               __um(FormatNs);                                             // 0x0010   (0x0010)  
	SDK_UNDEFINED(16,2806) /* FString */               __um(Message);                                              // 0x0020   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2807) /* FString */               __um(ErrorCode);                                            // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2808) /* FString */               __um(ErrorMessage);                                         // 0x0010   (0x0010)  
...
struct FVkVersePath
{ 
	SDK_UNDEFINED(16,2809) /* FString */               __um(VersePath);                                            // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2810) /* FString */               __um(URL);                                                  // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2811) /* FString */               __um(ProjectID);                                            // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2812) /* FString */               __um(Major);                                                // 0x0000   (0x0010)  
...
struct FVkJobOutput
{ 
	SDK_UNDEFINED(16,2813) /* FString */               __um(BaseURL);                                              // 0x0000   (0x0010)  
	double                                             TotalSizeKb;                                                // 0x0010   (0x0008)  
	double                                             UserContentTotalSizeKb;                                     // 0x0018   (0x0008)  
	SDK_UNDEFINED(16,2814) /* TArray<FString> */       __um(Files);                                                // 0x0020   (0x0010)  
	SDK_UNDEFINED(16,2815) /* FString */               __um(manifest);                                             // 0x0030   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2816) /* FString */               __um(ModuleId);                                             // 0x0000   (0x0010)  
	int32_t                                            Version;                                                    // 0x0010   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0014   (0x0004)  MISSED
	SDK_UNDEFINED(16,2817) /* FString */               __um(ProjectID);                                            // 0x0018   (0x0010)  
	...
	SDK_UNDEFINED(16,2818) /* FString */               __um(ContentType);                                          // 0x00D8   (0x0010)  
	SDK_UNDEFINED(80,2819) /* TMap<EConsumerRole, bool> */ __um(Relevance);                                        // 0x00E8   (0x0050)  
	SDK_UNDEFINED(16,2820) /* FString */               __um(ArtifactKey);                                          // 0x0138   (0x0010)  
	SDK_UNDEFINED(16,2821) /* FString */               __um(Checksum);                                             // 0x0148   (0x0010)  
...
{ 
	...
	int32_t                                            Version;                                                    // 0x0010   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0014   (0x0004)  MISSED
	SDK_UNDEFINED(16,2823) /* FString */               __um(MoreInfoUrl);                                          // 0x0018   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2824) /* FString */               __um(ProjectID);                                            // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2825) /* FString */               __um(AccountId);                                            // 0x0010   (0x0010)  
	SDK_UNDEFINED(16,2826) /* FString */               __um(Title);                                                // 0x0020   (0x0010)  
	bool                                               HasStar;                                                    // 0x0030   (0x0001)  
	bool                                               IsNew;                                                      // 0x0031   (0x0001)  
	unsigned char                                      UnknownData00_5[0x6];                                       // 0x0032   (0x0006)  MISSED
	SDK_UNDEFINED(80,2827) /* TMap<FString, bool> */   __um(Access);                                               // 0x0038   (0x0050)  
	SDK_UNDEFINED(16,2828) /* TArray<FString> */       __um(Permissions);                                          // 0x0088   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2829) /* FString */               __um(Owner);                                                // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2830) /* FString */               __um(Brand);                                                // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2831) /* FString */               __um(DesiredProjectId);                                     // 0x0000   (0x0010)  
	FJsonObjectWrapper                                 Meta;                                                       // 0x0010   (0x0020)  
	FJsonObjectWrapper                                 SysMeta;                                                    // 0x0030   (0x0020)  
	SDK_UNDEFINED(16,2832) /* TArray<FString> */       __um(GameFeaturesets);                                      // 0x0050   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2833) /* FString */               __um(TeamId);                                               // 0x0000   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2834) /* FString */               __um(ModuleName);                                           // 0x0000   (0x0010)  
	FJsonObjectWrapper                                 Meta;                                                       // 0x0010   (0x0020)  
	SDK_UNDEFINED(16,2835) /* FString */               __um(ContentType);                                          // 0x0030   (0x0010)  
	SDK_UNDEFINED(80,2836) /* TMap<EConsumerRole, bool> */ __um(Relevance);                                        // 0x0040   (0x0050)  
	SDK_UNDEFINED(16,2837) /* FString */               __um(DesiredModuleId);                                      // 0x0090   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(80,2838) /* TMap<FString, FString> */ __um(RawFiles);                                            // 0x0000   (0x0050)  
	TArray<FVkModuleVersion>                           Dependencies;                                               // 0x0050   (0x0010)  
	SDK_UNDEFINED(16,2839) /* TArray<FString> */       __um(StaticDependencies);                                   // 0x0060   (0x0010)  
	FJsonObjectWrapper                                 Meta;                                                       // 0x0070   (0x0020)  
	SDK_UNDEFINED(16,2840) /* FString */               __um(Checksum);                                             // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,2841) /* FString */               __um(ManifestLink);                                         // 0x00A0   (0x0010)  
	SDK_UNDEFINED(16,2842) /* TArray<FString> */       __um(GameFeaturesets);                                      // 0x00B0   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2843) /* FString */               __um(ProjectID);                                            // 0x0068   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,2844) /* FString */               __um(MapPath);                                              // 0x0078   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2845) /* FString */               __um(UniqueID);                                             // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2846) /* FString */               __um(ProjectID);                                            // 0x0010   (0x0010)  
	SDK_UNDEFINED(16,2847) /* FString */               __um(AccountId);                                            // 0x0020   (0x0010)  
	...
	SDK_UNDEFINED(16,2848) /* FString */               __um(MapPath);                                              // 0x00B8   (0x0010)  
...
{ 
	FVkResolvedContent                                 Content;                                                    // 0x0000   (0x0068)  
	SDK_UNDEFINED(16,2849) /* FString */               __um(CommitMessage);                                        // 0x0068   (0x0010)  
	FJsonObjectWrapper                                 MatchmakingConfig;                                          // 0x0078   (0x0020)  
	SDK_UNDEFINED(16,2850) /* FString */               __um(SourceControlBase);                                    // 0x0098   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,2852) /* FString */               __um(LinkCode);                                             // 0x0060   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,2853) /* FString */               __um(Title);                                                // 0x0018   (0x0010)  
	SDK_UNDEFINED(16,2854) /* FString */               __um(Description);                                          // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,2855) /* FString */               __um(LinkCode);                                             // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,2856) /* FString */               __um(RcsProvider);                                          // 0x0048   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2858) /* FString */               __um(Name);                                                 // 0x0000   (0x0010)  
	SDK_UNDEFINED(80,2859) /* TMap<FString, bool> */   __um(Access);                                               // 0x0010   (0x0050)  
	SDK_UNDEFINED(16,2860) /* FString */               __um(Status);                                               // 0x0060   (0x0010)  
	SDK_UNDEFINED(16,2861) /* FString */               __um(MembershipId);                                         // 0x0070   (0x0010)  
	SDK_UNDEFINED(16,2862) /* FString */               __um(TeamId);                                               // 0x0080   (0x0010)  
	SDK_UNDEFINED(16,2863) /* FString */               __um(AccountId);                                            // 0x0090   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2864) /* FString */               __um(Domain);                                               // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2865) /* FString */               __um(Name);                                                 // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2866) /* FString */               __um(Description);                                          // 0x0010   (0x0010)  
...
struct FVkTeamDoc
{ 
	SDK_UNDEFINED(16,2867) /* FString */               __um(TeamId);                                               // 0x0000   (0x0010)  
	FDateTime                                          Created;                                                    // 0x0010   (0x0008)  
	FDateTime                                          Updated;                                                    // 0x0018   (0x0008)  
...
{ 
	SDK_UNDEFINED(16,2868) /* FString */               __um(Owner);                                                // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2869) /* FString */               __um(Brand);                                                // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2870) /* FString */               __um(LinkCode);                                             // 0x0000   (0x0010)  
	int32_t                                            Version;                                                    // 0x0010   (0x0004)  
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x0014   (0x0004)  MISSED
};
...
{ 
	SDK_UNDEFINED(16,2871) /* TArray<FString> */       __um(Users);                                                // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2872) /* FString */               __um(PlaytestGroupId);                                      // 0x0010   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,2873) /* FString */               __um(OwnerType);                                            // 0x0020   (0x0010)  
	SDK_UNDEFINED(80,2874) /* TMap<FString, FVkProjectAccessControl> */ __um(Playtesters);                         // 0x0030   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(16,2875) /* FString */               __um(SnapshotId);                                           // 0x0000   (0x0010)  
	SDK_UNDEFINED(80,2876) /* TMap<FString, FString> */ __um(DeltaFileLinks);                                      // 0x0010   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(16,2877) /* FString */               __um(BuildId);                                              // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2878) /* FString */               __um(Platform);                                             // 0x0010   (0x0010)  
	SDK_UNDEFINED(80,2879) /* TMap<FString, float> */  __um(Stat);                                                 // 0x0020   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(16,2880) /* FString */               __um(AccountId);                                            // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2881) /* FString */               __um(BuildId);                                              // 0x0010   (0x0010)  
	SDK_UNDEFINED(16,2882) /* FString */               __um(Platform);                                             // 0x0020   (0x0010)  
	SDK_UNDEFINED(80,2883) /* TMap<FString, float> */  __um(Stat);                                                 // 0x0030   (0x0050)  
};
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0004   (0x0004)  MISSED
	SDK_UNDEFINED(16,2884) /* FString */               __um(SessionId);                                            // 0x0008   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2885) /* FString */               __um(LinkCode);                                             // 0x0000   (0x0010)  
	int32_t                                            LinkVersion;                                                // 0x0010   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0014   (0x0004)  MISSED
	FDateTime                                          LastPublished;                                              // 0x0018   (0x0008)  
	SDK_UNDEFINED(16,2886) /* FString */               __um(base);                                                 // 0x0020   (0x0010)  
	SDK_UNDEFINED(16,2887) /* FString */               __um(CommitMessage);                                        // 0x0030   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2888) /* FString */               __um(ProjectID);                                            // 0x0000   (0x0010)  
	FDateTime                                          Created;                                                    // 0x0010   (0x0008)  
	...
	FVkPublishedLink                                   LiveLink;                                                   // 0x0088   (0x00E8)  
};
...
{ 
	SDK_UNDEFINED(16,2889) /* FString */               __um(LinkCode);                                             // 0x0000   (0x0010)  
	int32_t                                            Version;                                                    // 0x0010   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0014   (0x0004)  MISSED
	SDK_UNDEFINED(16,2890) /* FString */               __um(Type);                                                 // 0x0018   (0x0010)  
	bool                                               IsActive;                                                   // 0x0028   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0029   (0x0007)  MISSED
	SDK_UNDEFINED(16,2891) /* FString */               __um(ProjectID);                                            // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,2892) /* FString */               __um(CreatorName);                                          // 0x0040   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2893) /* FString */               __um(LinkCode);                                             // 0x0000   (0x0010)  
	int32_t                                            Version;                                                    // 0x0010   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0014   (0x0004)  MISSED
	SDK_UNDEFINED(16,2894) /* FString */               __um(Type);                                                 // 0x0018   (0x0010)  
	SDK_UNDEFINED(16,2895) /* FString */               __um(ProjectID);                                            // 0x0028   (0x0010)  
	SDK_UNDEFINED(80,2896) /* TMap<FString, int32_t> */ __um(Public_Modules);                                      // 0x0038   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(80,2897) /* TMap<FString, FString> */ __um(_validation_flags);                                   // 0x0000   (0x0050)  
};
