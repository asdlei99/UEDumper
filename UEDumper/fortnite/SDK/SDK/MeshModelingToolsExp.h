...
enum class EBakeMapType : uint16_t
{
	...
	EBakeMapType__EBakeMapType_MAX                                                   = 2049
};
...
enum class ECubeGridToolAction : uint8_t
{
	...
	ECubeGridToolAction__ECubeGridToolAction_MAX                                     = 12
};
...
public:
	...
	SDK_UNDEFINED(16,14873) /* FString */              __um(TargetUVLayer);                                        // 0x00C0   (0x0010)  
	...
	SDK_UNDEFINED(16,14874) /* FString */              __um(SourceNormalMapUVLayer);                               // 0x0100   (0x0010)  
	...
	SDK_UNDEFINED(16,14875) /* TArray<FString> */      __um(TargetUVLayerNamesList);                               // 0x0120   (0x0010)  
	SDK_UNDEFINED(16,14876) /* TArray<FString> */      __um(SourceUVLayerNamesList);                               // 0x0130   (0x0010)  


	/// Functions
	// Function /Script/MeshModelingToolsExp.BakeInputMeshProperties.GetTargetUVLayerNamesFunc
	// TArray<FString> GetTargetUVLayerNamesFunc();                                                                          // [0xab9e304] Final|Native|Public|Const 
	// Function /Script/MeshModelingToolsExp.BakeInputMeshProperties.GetSourceUVLayerNamesFunc
	// TArray<FString> GetSourceUVLayerNamesFunc();                                                                          // [0xab9e2e8] Final|Native|Public|Const 
};
...
public:
	...
	SDK_UNDEFINED(16,14877) /* FString */              __um(UVLayer);                                              // 0x00B0   (0x0010)  
	SDK_UNDEFINED(16,14878) /* TArray<FString> */      __um(UVLayerNamesList);                                     // 0x00C0   (0x0010)  


	/// Functions
	// Function /Script/MeshModelingToolsExp.BakeTexture2DProperties.GetUVLayerNamesFunc
	// TArray<FString> GetUVLayerNamesFunc();                                                                                // [0xaa7a708] Final|Native|Public|Const 
};
...
public:
	...
	SDK_UNDEFINED(16,14879) /* FString */              __um(UVLayer);                                              // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,14880) /* TArray<FString> */      __um(UVLayerNamesList);                                     // 0x00C8   (0x0010)  
	...
	// TArray<FString> GetUVLayerNamesFunc();                                                                                // [0xab9d860] Final|Native|Public|Const 
};
...
public:
	...
	SDK_UNDEFINED(80,14881) /* TSet<UPrimitiveComponent*> */ __um(AllComponents);                                  // 0x03C8   (0x0050)  
...
public:
	...
	// bool IsPreventTinyTrianglesEnabled();                                                                                 // [0x610da68] Native|Protected|Const 
	// Function /Script/MeshModelingToolsExp.MeshConstraintProperties.IsPreventNormalFlipsEnabled
	// bool IsPreventNormalFlipsEnabled();                                                                                   // [0x3519bc8] Native|Protected|Const 
};
...
public:
	...
	// void ResetAxis();                                                                                                     // [0xabb5c68] Final|Native|Public  
};
...
public:
	...
	SDK_UNDEFINED(16,14882) /* FString */              __um(MapPreview);                                           // 0x00B0   (0x0010)  
	...
	SDK_UNDEFINED(16,14883) /* TArray<FString> */      __um(MapPreviewNamesList);                                  // 0x00D8   (0x0010)  
	...
	// TArray<FString> GetMapPreviewNamesFunc();                                                                             // [0xabb5c30] Final|Native|Public  
};

/// Class /Script/MeshModelingToolsExp.BakeMeshAttributeTool
/// Size: 0x00E8 (0x0000C0 - 0x0001A8)
...
public:
	...
	unsigned char                                      UnknownData01_6[0xB0];                                      // 0x00F8   (0x00B0)  MISSED
};
...
{ 
public:
	unsigned char                                      UnknownData00_3[0x8];                                       // 0x01A8   (0x0008)  MISSED
	...
	SDK_UNDEFINED(80,14884) /* TMap<EBakeMapType, UTexture2D*> */ __um(CachedMaps);                                // 0x0220   (0x0050)  
...
public:
	...
	unsigned char                                      UnknownData00_6[0x58];                                      // 0x0338   (0x0058)  MISSED
};
...
{ 
public:
	SDK_UNDEFINED(80,14885) /* TMap<EBakeMapType, UTexture2D*> */ __um(Result);                                    // 0x00A8   (0x0050)  
};
...
public:
	...
	unsigned char                                      UnknownData01_6[0xD0];                                      // 0x01D8   (0x00D0)  MISSED
};
...
public:
	int32_t                                            MapTypes;                                                   // 0x00A8   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00AC   (0x0004)  MISSED
	SDK_UNDEFINED(16,14886) /* FString */              __um(MapPreview);                                           // 0x00B0   (0x0010)  
	EBakeTextureResolution                             Resolution;                                                 // 0x00C0   (0x0004)  
	EBakeTextureBitDepth                               BitDepth;                                                   // 0x00C4   (0x0004)  
	EBakeTextureSamplesPerPixel                        SamplesPerPixel;                                            // 0x00C8   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x00CC   (0x0004)  MISSED
	class UTexture2D*                                  SampleFilterMask;                                           // 0x00D0   (0x0008)  
	SDK_UNDEFINED(16,14887) /* TArray<FString> */      __um(MapPreviewNamesList);                                  // 0x00D8   (0x0010)  
	unsigned char                                      UnknownData02_6[0x50];                                      // 0x00E8   (0x0050)  MISSED
...
public:
	...
	class USkeletalMesh*                               TargetSkeletalMesh;                                         // 0x00B0   (0x0008)  
	class AActor*                                      TargetDynamicMesh;                                          // 0x00B8   (0x0008)  
	SDK_UNDEFINED(16,14888) /* FString */              __um(TargetUVLayer);                                        // 0x00C0   (0x0010)  
	...
	SDK_UNDEFINED(16,14889) /* TArray<FString> */      __um(TargetUVLayerNamesList);                               // 0x00E8   (0x0010)  


	/// Functions
	// Function /Script/MeshModelingToolsExp.BakeMultiMeshInputToolProperties.GetTargetUVLayerNamesFunc
	// TArray<FString> GetTargetUVLayerNamesFunc();                                                                          // [0xabb5c4c] Final|Native|Public|Const 
};
...
public:
	...
	class UBakeMeshAttributeMapsResultToolProperties*  ResultSettings;                                             // 0x0330   (0x0008)  
	unsigned char                                      UnknownData00_6[0x90];                                      // 0x0338   (0x0090)  MISSED
};
...
public:
	unsigned char                                      UnknownData00_3[0x8];                                       // 0x00C0   (0x0008)  MISSED
	class UConvertMeshesToolProperties*                BasicProperties;                                            // 0x00C8   (0x0008)  
...
public:
	...
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00AC   (0x0004)  MISSED
	SDK_UNDEFINED(16,14890) /* TArray<FString> */      __um(OptionsList);                                          // 0x00B0   (0x0010)  
	bool                                               bShowNewLayerName;                                          // 0x00C0   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x00C1   (0x0007)  MISSED
	SDK_UNDEFINED(16,14891) /* FString */              __um(NewLayerName);                                         // 0x00C8   (0x0010)  


	/// Functions
	// Function /Script/MeshModelingToolsExp.OutputPolygroupLayerProperties.GetGroupOptionsList
	// TArray<FString> GetGroupOptionsList();                                                                                // [0xaa7a6cc] Final|Native|Public  
};
...
public:
	...
	unsigned char                                      UnknownData03_5[0x6];                                       // 0x010A   (0x0006)  MISSED
	...
	SDK_UNDEFINED(16,14892) /* FString */              __um(ToggleCornerMode);                                     // 0x0120   (0x0010)  
	SDK_UNDEFINED(16,14893) /* FString */              __um(PushPull);                                             // 0x0130   (0x0010)  
	SDK_UNDEFINED(16,14894) /* FString */              __um(ResizeGrid);                                           // 0x0140   (0x0010)  
	unsigned char                                      UnknownData05_5[0x10];                                      // 0x0150   (0x0010)  MISSED
	SDK_UNDEFINED(16,14895) /* FString */              __um(FlipSelection);                                        // 0x0160   (0x0010)  
	SDK_UNDEFINED(16,14896) /* FString */              __um(GridGizmo);                                            // 0x0170   (0x0010)  
	SDK_UNDEFINED(16,14897) /* FString */              __um(QuickShiftGizmo);                                      // 0x0180   (0x0010)  
	SDK_UNDEFINED(16,14898) /* FString */              __um(AlignGizmo);                                           // 0x0190   (0x0010)  
...
public:
	...
	// void Done();                                                                                                          // [0xabea8bc] Final|Native|Public  
	// Function /Script/MeshModelingToolsExp.CubeGridDuringActivityActions.Cancel
	// void Cancel();                                                                                                        // [0xabea844] Final|Native|Public  
};
...
public:
	...
	class UCubeGridDuringActivityActions*              DuringActivityActions;                                      // 0x0118   (0x0008)  
	class UNewMeshMaterialProperties*                  MaterialProperties;                                         // 0x0120   (0x0008)  
	class UCreateMeshObjectTypeProperties*             OutputTypeProperties;                                       // 0x0128   (0x0008)  
	class UToolTarget*                                 Target;                                                     // 0x0130   (0x0008)  
	unsigned char                                      UnknownData01_5[0x180];                                     // 0x0138   (0x0180)  MISSED
	class UMeshOpPreviewWithBackgroundCompute*         Preview;                                                    // 0x02B8   (0x0008)  
	unsigned char                                      UnknownData02_6[0x370];                                     // 0x02C0   (0x0370)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData01_6[0x16E8];                                    // 0x0128   (0x16E8)  MISSED
};
...
public:
	...
	SDK_UNDEFINED(16,14899) /* TArray<FString> */      __um(WeightMapsList);                                       // 0x00C0   (0x0010)  
	...
	// TArray<FString> GetWeightMapsFunc();                                                                                  // [0xabea904] Final|Native|Public  
};
...
public:
	...
	SDK_UNDEFINED(16,14900) /* TArray<FString> */      __um(MaterialIDList);                                       // 0x00B0   (0x0010)  


	/// Functions
	// Function /Script/MeshModelingToolsExp.SelectiveTessellationProperties.GetMaterialIDsFunc
	// TArray<FString> GetMaterialIDsFunc();                                                                                 // [0xaa7a6cc] Final|Native|Public  
};
...
/// Size: 0x03B0 (0x0000C0 - 0x000470)
class UDisplaceMeshTool : public USingleSelectionMeshEditingTool
{ 
public:
	class UDisplaceMeshCommonProperties*               CommonProperties;                                           // 0x00C0   (0x0008)  
	class UDisplaceMeshDirectionalFilterProperties*    DirectionalFilterProperties;                                // 0x00C8   (0x0008)  
	class UDisplaceMeshTextureMapProperties*           TextureMapProperties;                                       // 0x00D0   (0x0008)  
	class UDisplaceMeshPerlinNoiseProperties*          NoiseProperties;                                            // 0x00D8   (0x0008)  
	class UDisplaceMeshSineWaveProperties*             SineWaveProperties;                                         // 0x00E0   (0x0008)  
	class USelectiveTessellationProperties*            SelectiveTessellationProperties;                            // 0x00E8   (0x0008)  
	class UCurveFloat*                                 ActiveContrastCurveTarget;                                  // 0x00F0   (0x0008)  
	class UMeshStatisticsProperties*                   MeshStatistics;                                             // 0x00F8   (0x0008)  
	unsigned char                                      UnknownData00_5[0x340];                                     // 0x0100   (0x0340)  MISSED
...
public:
	...
	unsigned char                                      UnknownData00_6[0x38];                                      // 0x0290   (0x0038)  MISSED
};
...
public:
	...
	// void DiscardAttributes();                                                                                             // [0xabea88c] Final|Native|Public  
};
...
public:
	...
	unsigned char                                      UnknownData00_5[0x70];                                      // 0x00E0   (0x0070)  MISSED
	...
	unsigned char                                      UnknownData01_6[0x160];                                     // 0x0160   (0x0160)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData01_5[0xD8];                                      // 0x00D8   (0x00D8)  MISSED
...
public:
	...
	unsigned char                                      UnknownData01_6[0x398];                                     // 0x0148   (0x0398)  MISSED
};
...
public:
	...
	// void SelectAll();                                                                                                     // [0xac36388] Final|Native|Public  
	// Function /Script/MeshModelingToolsExp.HoleFillToolActions.Clear
	// void Clear();                                                                                                         // [0xac36108] Final|Native|Public  
};
...
{ 
public:
	SDK_UNDEFINED(16,14901) /* FString */              __um(InitialHoles);                                         // 0x00A8   (0x0010)  
	SDK_UNDEFINED(16,14902) /* FString */              __um(SelectedHoles);                                        // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,14903) /* FString */              __um(SuccessfulFills);                                      // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,14904) /* FString */              __um(FailedFills);                                          // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,14905) /* FString */              __um(RemainingHoles);                                       // 0x00E8   (0x0010)  
};
...
{ 
public:
	class USmoothHoleFillProperties*                   SmoothHoleFillProperties;                                   // 0x00C0   (0x0008)  
	class UHoleFillToolProperties*                     Properties;                                                 // 0x00C8   (0x0008)  
	class UHoleFillToolActions*                        Actions;                                                    // 0x00D0   (0x0008)  
	class UHoleFillStatisticsProperties*               Statistics;                                                 // 0x00D8   (0x0008)  
	class UMeshOpPreviewWithBackgroundCompute*         Preview;                                                    // 0x00E0   (0x0008)  
	class UBoundarySelectionMechanic*                  SelectionMechanic;                                          // 0x00E8   (0x0008)  
	unsigned char                                      UnknownData00_6[0x160];                                     // 0x00F0   (0x0160)  MISSED
};
...
public:
	...
	// void Constrain();                                                                                                     // [0xac3617c] Final|Native|Public  
	// Function /Script/MeshModelingToolsExp.LatticeDeformerToolProperties.ClearConstraints
	// void ClearConstraints();                                                                                              // [0xac36150] Final|Native|Public  
};
...
{ 
public:
	SDK_UNDEFINED(16,14906) /* FString */              __um(Attribute);                                            // 0x00A8   (0x0010)  
	...
	// TArray<FString> GetAttributeNames();                                                                                  // [0xab9d87c] Final|Native|Public  
};
...
/// Size: 0x04F8 (0x0002C8 - 0x0007C0)
class UMeshAttributePaintTool : public UDynamicMeshBrushTool
{ 
public:
	class UMeshAttributePaintBrushOperationProperties* BrushActionProps;                                           // 0x02C8   (0x0008)  
	class UMeshAttributePaintToolProperties*           AttribProps;                                                // 0x02D0   (0x0008)  
	unsigned char                                      UnknownData00_6[0x4E8];                                     // 0x02D8   (0x04E8)  MISSED
};
...
{ 
public:
	unsigned char                                      UnknownData00_3[0xE0];                                      // 0x00C0   (0x00E0)  MISSED
...
class alignas(0x10) 
UMeshSculptToolBase : public UMeshSurfacePointTool
{ 
public:
	...
	SDK_UNDEFINED(80,14907) /* TMap<int32_t, UMeshSculptBrushOpProps*> */ __um(BrushOpPropSets);                   // 0x0230   (0x0050)  
	unsigned char                                      UnknownData01_5[0x50];                                      // 0x0280   (0x0050)  MISSED
	SDK_UNDEFINED(80,14908) /* TMap<int32_t, UMeshSculptBrushOpProps*> */ __um(SecondaryBrushOpPropSets);          // 0x02D0   (0x0050)  
	...
	unsigned char                                      UnknownData04_6[0x148];                                     // 0x0A50   (0x0148)  MISSED
};
#pragma pack(pop)

/// Class /Script/MeshModelingToolsExp.MeshGroupPaintTool
/// Size: 0x0430 (0x000BA0 - 0x000FD0)
...
public:
	...
	unsigned char                                      UnknownData00_5[0x8];                                       // 0x0BC0   (0x0008)  MISSED
	...
	unsigned char                                      UnknownData01_6[0x3E8];                                     // 0x0BE8   (0x03E8)  MISSED
};
...
public:
	...
	SDK_UNDEFINED(16,14909) /* FString */              __um(UVChannel);                                            // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,14910) /* TArray<FString> */      __um(UVChannelNamesList);                                   // 0x00C8   (0x0010)  
	...
	// TArray<FString> GetUVChannelNamesFunc();                                                                              // [0xab9d860] Final|Native|Public|Const 
};

/// Class /Script/MeshModelingToolsExp.MeshInspectorTool
/// Size: 0x01A0 (0x0000C0 - 0x000260)
...
public:
	...
	unsigned char                                      UnknownData01_6[0x168];                                     // 0x00F8   (0x0168)  MISSED
};
...
/// Size: 0x0428 (0x0002C8 - 0x0006F0)
class UMeshSelectionTool : public UDynamicMeshBrushTool
{ 
public:
	unsigned char                                      UnknownData00_3[0x8];                                       // 0x02C8   (0x0008)  MISSED
	class UMeshSelectionToolProperties*                SelectionProps;                                             // 0x02D0   (0x0008)  
	class UMeshSelectionEditActions*                   SelectionActions;                                           // 0x02D8   (0x0008)  
	class UMeshSelectionToolActionPropertySet*         EditActions;                                                // 0x02E0   (0x0008)  
	class UMeshStatisticsProperties*                   MeshStatisticsProperties;                                   // 0x02E8   (0x0008)  
	class UMeshElementsVisualizer*                     MeshElementsDisplay;                                        // 0x02F0   (0x0008)  
	class UMeshUVChannelProperties*                    UVChannelProperties;                                        // 0x02F8   (0x0008)  
	class UPolygroupLayersProperties*                  PolygroupLayerProperties;                                   // 0x0300   (0x0008)  
	unsigned char                                      UnknownData01_5[0x58];                                      // 0x0308   (0x0058)  MISSED
	class UMeshSelectionSet*                           Selection;                                                  // 0x0360   (0x0008)  
	TArray<class AActor*>                              SpawnedActors;                                              // 0x0368   (0x0010)  
	unsigned char                                      UnknownData02_6[0x378];                                     // 0x0378   (0x0378)  MISSED
};
...
public:
	...
	// void ShiftToCenter();                                                                                                 // [0xac363d0] Final|Native|Public  
};
...
public:
	...
	class UMeshOpPreviewWithBackgroundCompute*         Preview;                                                    // 0x00E0   (0x0008)  
	unsigned char                                      UnknownData00_5[0x10];                                      // 0x00E8   (0x0010)  MISSED
	...
	unsigned char                                      UnknownData01_6[0x1A0];                                     // 0x0130   (0x01A0)  MISSED
};
...
public:
	...
	FName                                              WeightMap;                                                  // 0x00BC   (0x0004)  
	SDK_UNDEFINED(16,14911) /* TArray<FString> */      __um(WeightMapsList);                                       // 0x00C0   (0x0010)  
	...
	SDK_UNDEFINED(16,14912) /* FString */              __um(CopyToLODName);                                        // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,14913) /* TArray<FString> */      __um(LODNamesList);                                         // 0x00E8   (0x0010)  
	...
	// TArray<FString> GetLODNamesFunc();                                                                                    // [0xabb5c4c] Final|Native|Public|Const 
	// Function /Script/MeshModelingToolsExp.MeshVertexPaintToolUtilityActions.ApplySelectedOperation
	// void ApplySelectedOperation();                                                                                        // [0xac360d8] Final|Native|Public  
};

/// Class /Script/MeshModelingToolsExp.MeshVertexPaintTool
/// Size: 0x0590 (0x000BA0 - 0x001130)
class UMeshVertexPaintTool : public UMeshSculptToolBase
{ 
public:
	class UPolygroupLayersProperties*                  PolygroupLayerProperties;                                   // 0x0B98   (0x0008)  
	class UVertexPaintBasicProperties*                 BasicProperties;                                            // 0x0BA0   (0x0008)  
	class UVertexPaintBrushFilterProperties*           FilterProperties;                                           // 0x0BA8   (0x0008)  
	class UVertexColorPaintBrushOpProps*               PaintBrushOpProperties;                                     // 0x0BB0   (0x0008)  
	class UVertexColorPaintBrushOpProps*               EraseBrushOpProperties;                                     // 0x0BB8   (0x0008)  
	class UMeshVertexPaintToolQuickActions*            QuickActions;                                               // 0x0BC0   (0x0008)  
	class UMeshVertexPaintToolUtilityActions*          UtilityActions;                                             // 0x0BC8   (0x0008)  
	unsigned char                                      UnknownData00_5[0x8];                                       // 0x0BD0   (0x0008)  MISSED
	class UPolyLassoMarqueeMechanic*                   PolyLassoMechanic;                                          // 0x0BD8   (0x0008)  
	...
	class UMeshElementsVisualizer*                     MeshElementsDisplay;                                        // 0x0BF0   (0x0008)  
	unsigned char                                      UnknownData01_6[0x538];                                     // 0x0BF8   (0x0538)  MISSED
};
...
public:
	...
	SDK_UNDEFINED(8,14914) /* TWeakObjectPtr<UMeshVertexSculptTool*> */ __um(Tool);                                // 0x00AC   (0x0008)  
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x00B4   (0x0004)  MISSED
};
...
public:
	...
	SDK_UNDEFINED(8,14915) /* TWeakObjectPtr<UMeshVertexSculptTool*> */ __um(Tool);                                // 0x00BC   (0x0008)  
...
public:
	...
	unsigned char                                      UnknownData00_5[0x18];                                      // 0x0BB8   (0x0018)  MISSED
	class AInternalToolFrameworkActor*                 PreviewMeshActor;                                           // 0x0BD0   (0x0008)  
	class UDynamicMeshComponent*                       DynamicMeshComponent;                                       // 0x0BD8   (0x0008)  
	unsigned char                                      UnknownData01_6[0x910];                                     // 0x0BE0   (0x0910)  MISSED
};
...
{ 
public:
	SDK_UNDEFINED(16,14916) /* FString */              __um(ObjectName);                                           // 0x00A8   (0x0010)  
...
public:
	...
	bool                                               bEnableShowCollision;                                       // 0x00C8   (0x0001)  
	unsigned char                                      UnknownData02_6[0x7];                                       // 0x00C9   (0x0007)  MISSED
};
...
/// Size: 0x0278 (0x0000C0 - 0x000338)
class UExtractCollisionGeometryTool : public USingleSelectionMeshEditingTool
{ 
public:
	class UCreateMeshObjectTypeProperties*             OutputTypeProperties;                                       // 0x00C0   (0x0008)  
	class UExtractCollisionToolProperties*             Settings;                                                   // 0x00C8   (0x0008)  
	class UCollisionGeometryVisualizationProperties*   VizSettings;                                                // 0x00D0   (0x0008)  
	class UPhysicsObjectToolPropertySet*               ObjectProps;                                                // 0x00D8   (0x0008)  
	class UPreviewGeometry*                            PreviewElements;                                            // 0x00E0   (0x0008)  
	class UPreviewMesh*                                PreviewMesh;                                                // 0x00E8   (0x0008)  
	unsigned char                                      UnknownData00_6[0x248];                                     // 0x00F0   (0x0248)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData00_6[0x10];                                      // 0x00E8   (0x0010)  MISSED
};
...
public:
	...
	bool                                               bSimplifyHulls;                                             // 0x00C3   (0x0001)  
	int32_t                                            HullTargetFaceCount;                                        // 0x00C4   (0x0004)  
	int32_t                                            MaxHullsPerMesh;                                            // 0x00C8   (0x0004)  
	float                                              ConvexDecompositionSearchFactor;                            // 0x00CC   (0x0004)  
	float                                              AddHullsErrorTolerance;                                     // 0x00D0   (0x0004)  
	float                                              MinPartThickness;                                           // 0x00D4   (0x0004)  
	float                                              HullTolerance;                                              // 0x00D8   (0x0004)  
	EProjectedHullAxis                                 SweepAxis;                                                  // 0x00DC   (0x0004)  
	int32_t                                            LevelSetResolution;                                         // 0x00E0   (0x0004)  
	ECollisionGeometryMode                             SetCollisionType;                                           // 0x00E4   (0x0004)  
	bool                                               bUsingMultipleInputs;                                       // 0x00E8   (0x0001)  
	unsigned char                                      UnknownData02_6[0x7];                                       // 0x00E9   (0x0007)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData02_5[0x278];                                     // 0x00F8   (0x0278)  MISSED
...
public:
	...
	// void FlipPlane();                                                                                                     // [0xac6b154] Final|Native|Protected 
	// Function /Script/MeshModelingToolsExp.PlaneCutTool.Cut
	// void Cut();                                                                                                           // [0xac6b100] Final|Native|Protected 
};
...
{ 
public:
	SDK_UNDEFINED(16,14917) /* FString */              __um(SurfaceArea);                                          // 0x00A8   (0x0010)  
	SDK_UNDEFINED(16,14918) /* FString */              __um(Volume);                                               // 0x00B8   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(16,14919) /* FString */              __um(Mesh);                                                 // 0x00A8   (0x0010)  
	SDK_UNDEFINED(16,14920) /* FString */              __um(UV);                                                   // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,14921) /* FString */              __um(Attributes);                                           // 0x00C8   (0x0010)  
};
...
/// Size: 0x00F8 (0x0002C8 - 0x0003C0)
class USeamSculptTool : public UDynamicMeshBrushTool
{ 
public:
	class USeamSculptToolProperties*                   Settings;                                                   // 0x02C8   (0x0008)  
	class UPreviewGeometry*                            PreviewGeom;                                                // 0x02D0   (0x0008)  
	unsigned char                                      UnknownData00_6[0xE8];                                      // 0x02D8   (0x00E8)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData00_6[0x38];                                      // 0x0118   (0x0038)  MISSED
};
...
{ 
public:
	class USmoothMeshToolProperties*                   SmoothProperties;                                           // 0x0410   (0x0008)  
	class UIterativeSmoothProperties*                  IterativeProperties;                                        // 0x0418   (0x0008)  
	class UDiffusionSmoothProperties*                  DiffusionProperties;                                        // 0x0420   (0x0008)  
	class UImplicitSmoothProperties*                   ImplicitProperties;                                         // 0x0428   (0x0008)  
	class USmoothWeightMapSetProperties*               WeightMapProperties;                                        // 0x0430   (0x0008)  
...
public:
	...
	unsigned char                                      UnknownData00_5[0x6];                                       // 0x00AA   (0x0006)  MISSED
	SDK_UNDEFINED(16,14922) /* FString */              __um(SourceLOD);                                            // 0x00B0   (0x0010)  
	SDK_UNDEFINED(16,14923) /* FString */              __um(TargetLod);                                            // 0x00C0   (0x0010)  
	bool                                               bIsStaticMeshSource;                                        // 0x00D0   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x00D1   (0x0007)  MISSED
	SDK_UNDEFINED(16,14924) /* TArray<FString> */      __um(SourceLODNamesList);                                   // 0x00D8   (0x0010)  
	unsigned char                                      UnknownData02_5[0x10];                                      // 0x00E8   (0x0010)  MISSED
	SDK_UNDEFINED(16,14925) /* TArray<FString> */      __um(TargetLODNamesList);                                   // 0x00F8   (0x0010)  
	...
	// TArray<FString> GetTargetLODNamesFunc();                                                                              // [0xac6b16c] Final|Native|Public|Const 
	// Function /Script/MeshModelingToolsExp.TransferMeshToolProperties.GetSourceLODNamesFunc
	// TArray<FString> GetSourceLODNamesFunc();                                                                              // [0xabb5c30] Final|Native|Public|Const 
};
...
public:
	...
	unsigned char                                      UnknownData01_6[0xB8];                                      // 0x00E8   (0x00B8)  MISSED
};
...
public:
	...
	SDK_UNDEFINED(8,14926) /* TWeakObjectPtr<UWorld*> */ __um(TargetWorld);                                        // 0x00C8   (0x0008)  
	SDK_UNDEFINED(16,14927) /* TArray<TWeakObjectPtr<AActor*>> */ __um(ActorsWithSplines);                         // 0x00D0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(24,14928) /* TLazyObjectPtr<AVolume*> */ __um(TargetVolume);                                     // 0x00B8   (0x0018)  
...
{ 
public:
	class UWeldMeshEdgesToolProperties*                Settings;                                                   // 0x00C0   (0x0008)  
	class UMeshOpPreviewWithBackgroundCompute*         PreviewCompute;                                             // 0x00C8   (0x0008)  
	class UMeshElementsVisualizer*                     MeshElementsDisplay;                                        // 0x00D0   (0x0008)  
	class UWeldMeshEdgesOperatorFactory*               OperatorFactory;                                            // 0x00D8   (0x0008)  
