...
public:
	...
	SDK_UNDEFINED(16,2011) /* FMulticastInlineDelegate */ __um(VideoOnTerminalError);                              // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,2012) /* FMulticastInlineDelegate */ __um(VideoOnSuccess);                                    // 0x0040   (0x0010)  
	SDK_UNDEFINED(16,2013) /* FMulticastInlineDelegate */ __um(VideoOnClosed);                                     // 0x0050   (0x0010)  
	SDK_UNDEFINED(16,2014) /* FMulticastInlineDelegate */ __um(VideoOnEndReached);                                 // 0x0060   (0x0010)  
	SDK_UNDEFINED(16,2015) /* FMulticastInlineDelegate */ __um(VideoOnOpenTimeout);                                // 0x0070   (0x0010)  
	SDK_UNDEFINED(16,2016) /* FMulticastInlineDelegate */ __um(VideoOnResumed);                                    // 0x0080   (0x0010)  
