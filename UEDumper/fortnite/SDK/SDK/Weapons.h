...
public:
	...
	FAnimNode_RigidBody                                AnimGraphNode_RigidBody;                                    // 0x0AD0   (0x0960)  
	FAnimNode_RigidBody                                AnimGraphNode_RigidBody3;                                   // 0x1430   (0x0960)  
	class UCustomCharacterPartAnimInstance*            Character_Part_Anim_Instance;                               // 0x1D90   (0x0008)  
	double                                             FrontEnd_variable;                                          // 0x1D98   (0x0008)  
	FGravityOverrideParamsStruct                       Gravity_Override_Params;                                    // 0x1DA0   (0x07B8)  
	FVector                                            GravityOverride;                                            // 0x2558   (0x0018)  
...
{ 
public:
	FPointerToUberGraphFrame                           UberGraphFrame;                                             // 0x1C80   (0x0008)  
	float                                              AnimateScopePostProcess_DownSightPostProcessAmount_393D8BA5486879173797EF8C9B8D4642; // 0x1C88   (0x0004)  
	SDK_UNDEFINED(1,15641) /* TEnumAsByte<ETimelineDirection> */ __um(AnimateScopePostProcess__Direction_393D8BA5486879173797EF8C9B8D4642); // 0x1C8C   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x1C8D   (0x0003)  MISSED
	class UTimelineComponent*                          AnimateScopePostProcess;                                    // 0x1C90   (0x0008)  
	class UNiagaraSystem*                              OpticGlint;                                                 // 0x1C98   (0x0008)  
	bool                                               UseDestroyEffect;                                           // 0x1CA0   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x1CA1   (0x0007)  MISSED
	class UParticleSystem*                             WeaponDurabilityDestroyEffect;                              // 0x1CA8   (0x0008)  
	class UParticleSystem*                             WeaponDurabilityDestroyEffectIcon;                          // 0x1CB0   (0x0008)  
	bool                                               Use_Reload_Particles;                                       // 0x1CB8   (0x0001)  
	bool                                               UseShellsOnFire_;                                           // 0x1CB9   (0x0001)  
	bool                                               UseShellsOnReload_;                                         // 0x1CBA   (0x0001)  
	bool                                               UseShellsOnPump_;                                           // 0x1CBB   (0x0001)  
	unsigned char                                      UnknownData02_5[0x4];                                       // 0x1CBC   (0x0004)  MISSED
	class UNiagaraSystem*                              Shell_Burst_FX;                                             // 0x1CC0   (0x0008)  
	class UNiagaraSystem*                              Shell_Looping_FX;                                           // 0x1CC8   (0x0008)  
	class UNiagaraSystem*                              Reload_System;                                              // 0x1CD0   (0x0008)  
	class UMaterialInterface*                          Reload_Smoke_Material;                                      // 0x1CD8   (0x0008)  
	FName                                              ReloadSocketName;                                           // 0x1CE0   (0x0004)  
	FGameplayTag                                       TagToApplyOpticGlint;                                       // 0x1CE4   (0x0004)  
	TArray<class AFortAIPawn*>                         Array_Of_Active_Enemy_AI;                                   // 0x1CE8   (0x0010)  
	bool                                               Scope___Render_Enemies_To_Custom_Depth_Buffer;              // 0x1CF8   (0x0001)  
	unsigned char                                      UnknownData03_5[0x3];                                       // 0x1CF9   (0x0003)  MISSED
	FName                                              Shells_Socket_Name;                                         // 0x1CFC   (0x0004)  
	SDK_UNDEFINED(1,15642) /* TEnumAsByte<En_ShellTypes_01> */ __um(ShellTypeSelect);                              // 0x1D00   (0x0001)  
	unsigned char                                      UnknownData04_5[0x7];                                       // 0x1D01   (0x0007)  MISSED
	double                                             Shells_Spawn_Rate_Scale;                                    // 0x1D08   (0x0008)  
	FVector                                            ShellsRotationRate;                                         // 0x1D10   (0x0018)  
	FVector                                            Shells_Velocity;                                            // 0x1D28   (0x0018)  
	FVector                                            Shells_Gravity;                                             // 0x1D40   (0x0018)  
	FVector                                            Shells_Size;                                                // 0x1D58   (0x0018)  
	double                                             Target_Scope_Vignette_Blur_Screen_Percentage;               // 0x1D70   (0x0008)  
	double                                             ScopeCameraOffsetX;                                         // 0x1D78   (0x0008)  
	double                                             ScopeCameraOffsetY;                                         // 0x1D80   (0x0008)  
	double                                             Scope_Camera_Offset_Amount;                                 // 0x1D88   (0x0008)  
	double                                             Inherit_Parent_Velocity;                                    // 0x1D90   (0x0008)  
	double                                             Cylindrical_Radius;                                         // 0x1D98   (0x0008)  
	double                                             Cylindrical_Height;                                         // 0x1DA0   (0x0008)  
	FLinearColor                                       Shell_Color;                                                // 0x1DA8   (0x0010)  
	class UNiagaraComponent*                           Spawned_Shells;                                             // 0x1DB8   (0x0008)  
	bool                                               DebugShellsSocket_;                                         // 0x1DC0   (0x0001)  
	unsigned char                                      UnknownData05_5[0x7];                                       // 0x1DC1   (0x0007)  MISSED
	class USoundBase*                                  Sound_ScopeZoomIn;                                          // 0x1DC8   (0x0008)  
	class USoundBase*                                  Sound_ScopeZoomOut;                                         // 0x1DD0   (0x0008)  
	class UNiagaraComponent*                           Alteration_Ambient_PS;                                      // 0x1DD8   (0x0008)  
	FGameplayTagContainer                              ReticleHUDElementTags;                                      // 0x1DE0   (0x0020)  
	bool                                               Is_Wind_Enabled;                                            // 0x1E00   (0x0001)  
	unsigned char                                      UnknownData06_5[0x7];                                       // 0x1E01   (0x0007)  MISSED
	class UParticleSystem*                             MuzzleWindParticleSystem;                                   // 0x1E08   (0x0008)  
	bool                                               ShouldHideReticleAfterDelay;                                // 0x1E10   (0x0001)  
	unsigned char                                      UnknownData07_5[0x7];                                       // 0x1E11   (0x0007)  MISSED
	class UParticleSystemComponent*                    MuzzleWindParticleSpawned;                                  // 0x1E18   (0x0008)  
	int32_t                                            StencilBufferValue;                                         // 0x1E20   (0x0004)  
	unsigned char                                      UnknownData08_5[0x4];                                       // 0x1E24   (0x0004)  MISSED
	class UCurveFloat*                                 Curve_PitchOffset;                                          // 0x1E28   (0x0008)  
	class USoundBase*                                  Sound_ScopedInLoop;                                         // 0x1E30   (0x0008)  
	class UAudioComponent*                             ScopeZoomInComp;                                            // 0x1E38   (0x0008)  
	class UAudioComponent*                             ScopedInLoopComp;                                           // 0x1E40   (0x0008)  
	class UAudioComponent*                             ScopeZoomOutComp;                                           // 0x1E48   (0x0008)  
	double                                             Alteration_Ambient_PS_Max_Draw_Distance;                    // 0x1E50   (0x0008)  
	double                                             Muzzle_PS_Max_Draw_Distance;                                // 0x1E58   (0x0008)  
	double                                             Beam_PS_Max_Draw_Distance;                                  // 0x1E60   (0x0008)  
	double                                             Reload_PS_Max_Draw_Distance;                                // 0x1E68   (0x0008)  
	double                                             Shells_PS_Max_Draw_Distance;                                // 0x1E70   (0x0008)  
	SDK_UNDEFINED(16,15643) /* FMulticastInlineDelegate */ __um(onAimDownSightsChanged);                           // 0x1E78   (0x0010)  
	class UNiagaraComponent*                           MuzzleNiagaraComponentInstance;                             // 0x1E88   (0x0008)  
	FTimerHandle                                       ScopeEffectDelay1Handle;                                    // 0x1E90   (0x0008)  
	FTimerHandle                                       ScopeEffectDelay2Handle;                                    // 0x1E98   (0x0008)  
	FScalableFloat                                     UseUpdatedFeedback;                                         // 0x1EA0   (0x0028)  
	SDK_UNDEFINED(16,15644) /* FMulticastInlineDelegate */ __um(OnStartFiring);                                    // 0x1EC8   (0x0010)  
	SDK_UNDEFINED(16,15645) /* FMulticastInlineDelegate */ __um(OnPersistentFireStopped);                          // 0x1ED8   (0x0010)  
	class UStaticMesh*                                 ScopeMesh;                                                  // 0x1EE8   (0x0008)  
	class UStaticMeshComponent*                        ScopeMesh1P_Spawned;                                        // 0x1EF0   (0x0008)  
	TArray<class UMaterialInterface*>                  ScopeMaterialOverrides;                                     // 0x1EF8   (0x0010)  
	float                                              Reload_Smoke_Lifetime;                                      // 0x1F08   (0x0004)  
	float                                              Reload_Smoke_Width_Scale;                                   // 0x1F0C   (0x0004)  
	FLinearColor                                       BaseColorAlpha;                                             // 0x1F10   (0x0010)  
	bool                                               Use_Emissive_in_Reload;                                     // 0x1F20   (0x0001)  
	unsigned char                                      UnknownData09_5[0x3];                                       // 0x1F21   (0x0003)  MISSED
	FLinearColor                                       Reload_Emissive_Color;                                      // 0x1F24   (0x0010)  
	bool                                               Is_Rocket_Launcher;                                         // 0x1F34   (0x0001)  
	unsigned char                                      UnknownData10_5[0x3];                                       // 0x1F35   (0x0003)  MISSED
	FLinearColor                                       Rocket_Launcher_Spark_Color;                                // 0x1F38   (0x0010)  
	bool                                               Reload_Ejects_Shells;                                       // 0x1F48   (0x0001)  
	unsigned char                                      UnknownData11_5[0x7];                                       // 0x1F49   (0x0007)  MISSED
	class UNiagaraComponent*                           OpticGlintComp;                                             // 0x1F50   (0x0008)  
	class UFXSystemAsset*                              Muzzle_System;                                              // 0x1F58   (0x0008)  
	float                                              Muzzle_Hue_Control;                                         // 0x1F60   (0x0004)  
	float                                              Muzzle_Core_Cap_Scale;                                      // 0x1F64   (0x0004)  
	FVector                                            Muzzle_Core_Scale;                                          // 0x1F68   (0x0018)  
	float                                              Spark_Amount_Scale;                                         // 0x1F80   (0x0004)  
	float                                              Smoke_Size_Scale;                                           // 0x1F84   (0x0004)  
	FLinearColor                                       MuzzleSmokeInitialColor;                                    // 0x1F88   (0x0010)  
	float                                              Smoke_Initial_Color_Scale_Variance;                         // 0x1F98   (0x0004)  
	float                                              Smoke_Emissive_Scale;                                       // 0x1F9C   (0x0004)  
	bool                                               Use_Heated_Elements;                                        // 0x1FA0   (0x0001)  
	unsigned char                                      UnknownData12_5[0x3];                                       // 0x1FA1   (0x0003)  MISSED
	float                                              Decal_Size;                                                 // 0x1FA4   (0x0004)  
	FVector                                            Decal_Offset;                                               // 0x1FA8   (0x0018)  
	float                                              Decal_Alpha;                                                // 0x1FC0   (0x0004)  
	unsigned char                                      UnknownData13_5[0x4];                                       // 0x1FC4   (0x0004)  MISSED
	class UFXSystemComponent*                          Spawned_Muzzle_System;                                      // 0x1FC8   (0x0008)  
	int32_t                                            Burst_Loops;                                                // 0x1FD0   (0x0004)  
	bool                                               Muzzle_BakedSupressor__Always_Suppressed_;                  // 0x1FD4   (0x0001)  
	bool                                               Baked_Optics__Always_has_Optics_element_;                   // 0x1FD5   (0x0001)  
	unsigned char                                      UnknownData14_5[0x2];                                       // 0x1FD6   (0x0002)  MISSED
	double                                             MinPlayFXTime;                                              // 0x1FD8   (0x0008)  
	double                                             LastPlayFXTime;                                             // 0x1FE0   (0x0008)  
	FScalableFloat                                     UseNativeFX;                                                // 0x1FE8   (0x0028)  
	bool                                               bIsLocal;                                                   // 0x2010   (0x0001)  
	unsigned char                                      UnknownData15_5[0x7];                                       // 0x2011   (0x0007)  MISSED
	class UNiagaraSystem*                              Magazine_Eject_System;                                      // 0x2018   (0x0008)  
	FName                                              Magazine_Eject_Socket_Name;                                 // 0x2020   (0x0004)  
	bool                                               Use_Magazine_Eject;                                         // 0x2024   (0x0001)  
	unsigned char                                      UnknownData16_5[0x3];                                       // 0x2025   (0x0003)  MISSED
	class UMaterialInterface*                          Magazine_Eject_Material;                                    // 0x2028   (0x0008)  
	class UStaticMesh*                                 Magazine_Eject_Model;                                       // 0x2030   (0x0008)  
	float                                              ScopeEffectDelay1Time;                                      // 0x2038   (0x0004)  
	float                                              ScopeEffectDelay2Time;                                      // 0x203C   (0x0004)  
...
{ 
public:
	FPointerToUberGraphFrame                           UberGraphFrame;                                             // 0x1760   (0x0008)  
	class UParticleSystemComponent*                    MeleeHeavy_PSC;                                             // 0x1768   (0x0008)  
	class UParticleSystem*                             MeleeHeavy_ParticleSystem;                                  // 0x1770   (0x0008)  
	class UParticleSystem*                             WeaponDurabilityDestroyEffect;                              // 0x1778   (0x0008)  
	class UParticleSystem*                             WeaponDurabilityDestroyEffectIcon;                          // 0x1780   (0x0008)  
	bool                                               UseDestroyEffect;                                           // 0x1788   (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x1789   (0x0007)  MISSED
	class UNiagaraComponent*                           Alteration_Ambient_PS;                                      // 0x1790   (0x0008)  
	FVector                                            Effects_Color_Level;                                        // 0x1798   (0x0018)  
	bool                                               Equipped;                                                   // 0x17B0   (0x0001)  
	bool                                               bEquipPendingInstigator;                                    // 0x17B1   (0x0001)  
	bool                                               UseTimeofDayControl;                                        // 0x17B2   (0x0001)  
	bool                                               Swing_Right_;                                               // 0x17B3   (0x0001)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x17B4   (0x0004)  MISSED
	class UFXSystemComponent*                          Impact_FX;                                                  // 0x17B8   (0x0008)  
	FRotator                                           Left_Swing_Rotation;                                        // 0x17C0   (0x0018)  
	FRotator                                           Right_Swing_Rotation;                                       // 0x17D8   (0x0018)  
...
{ 
public:
	FPointerToUberGraphFrame                           UberGraphFrame;                                             // 0x1A80   (0x0008)  
	bool                                               Equipped;                                                   // 0x1A88   (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x1A89   (0x0007)  MISSED
	class UNiagaraComponent*                           Alteration_Ambient_PS;                                      // 0x1A90   (0x0008)  
	class UParticleSystem*                             MeleeHeavy_ParticleSystem;                                  // 0x1A98   (0x0008)  
	class UParticleSystemComponent*                    MeleeHeavy_PSC;                                             // 0x1AA0   (0x0008)  
	bool                                               UseDestroyEffect;                                           // 0x1AA8   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x1AA9   (0x0007)  MISSED
	class UParticleSystem*                             WeaponDurabilityDestroyEffect;                              // 0x1AB0   (0x0008)  
	class UParticleSystem*                             WeaponDurabilityDestroyEffectIcon;                          // 0x1AB8   (0x0008)  
	class UNiagaraComponent*                           Offhand_Alteration_Ambient_PS;                              // 0x1AC0   (0x0008)  
	bool                                               bEquipPendingInstigator;                                    // 0x1AC8   (0x0001)  
	unsigned char                                      UnknownData02_5[0x3];                                       // 0x1AC9   (0x0003)  MISSED
	FName                                              Offhand_Socket_Name;                                        // 0x1ACC   (0x0004)  
	class UAnimMontage*                                MontageReference;                                           // 0x1AD0   (0x0008)  
	bool                                               UseTimeofDayControl;                                        // 0x1AD8   (0x0001)  
	unsigned char                                      UnknownData03_5[0x7];                                       // 0x1AD9   (0x0007)  MISSED
	class UFXSystemComponent*                          Impact_FX;                                                  // 0x1AE0   (0x0008)  
	bool                                               Swing_Right_;                                               // 0x1AE8   (0x0001)  
	unsigned char                                      UnknownData04_5[0x7];                                       // 0x1AE9   (0x0007)  MISSED
	FRotator                                           Left_Swing_Rotation;                                        // 0x1AF0   (0x0018)  
	FRotator                                           Right_Swing_Rotation;                                       // 0x1B08   (0x0018)  
	bool                                               Swing_Right_0;                                              // 0x1B20   (0x0001)  
...
struct FAnimBlueprintGeneratedConstantDatadup_179 : FAnimBlueprintConstantData
{ 
...
/// Size: 0x011F (0x000001 - 0x000120)
struct FAnimBlueprintGeneratedConstantDatadup_182 : FAnimBlueprintConstantData
{ 
...
struct FAnimBlueprintGeneratedMutableDatadup_183 : FAnimBlueprintMutableData
{ 
...
struct FAnimBlueprintGeneratedConstantDatadup_186 : FAnimBlueprintConstantData
{ 
	unsigned char                                      UnknownData00_3[0x3];                                       // 0x0001   (0x0003)  MISSED
	FName                                              __NameProperty;                                             // 0x0004   (0x0004)  
	FName                                              __NameProperty0;                                            // 0x0008   (0x0004)  
...
struct FAnimBlueprintGeneratedConstantDatadup_188 : FAnimBlueprintConstantData
{ 
	unsigned char                                      UnknownData00_3[0x3];                                       // 0x0001   (0x0003)  MISSED
	FName                                              __NameProperty;                                             // 0x0004   (0x0004)  
	FName                                              __NameProperty0;                                            // 0x0008   (0x0004)  
...
/// Size: 0x0001 (0x000001 - 0x000002)
struct FAnimBlueprintGeneratedMutableDatadup_189 : FAnimBlueprintMutableData
{ 
	bool                                               __BoolProperty;                                             // 0x0001   (0x0001)  
};
