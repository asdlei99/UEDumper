...
public:
	...
	SDK_UNDEFINED(32,14982) /* TWeakObjectPtr<UAnimMontage*> */ __um(CannonFiringMontage);                         // 0x06B0   (0x0020)  
...
{ 
public:
	FNevadaState                                       ServerReplicatedState;                                      // 0x1F18   (0x0014)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x1F2C   (0x0004)  MISSED
	class UFortNevadaVehicleConfigs*                   FortNevadaVehicleConfigs;                                   // 0x1F30   (0x0008)  
	class UClass*                                      FortNevadaAudioControllerClass;                             // 0x1F38   (0x0008)  
	class UChildActorComponent*                        AudioControllerActor;                                       // 0x1F40   (0x0008)  
	class AFortNevadaAudioController*                  FortNevadaAudioController;                                  // 0x1F48   (0x0008)  
	FVehicleGamepadLiftInputs                          LiftInputs;                                                 // 0x1F50   (0x0008)  
	float                                              LastBatteryRegenTickTime;                                   // 0x1F58   (0x0004)  
	bool                                               bBoostThrust;                                               // 0x1F5C   (0x0001)  
	bool                                               bBoostDrag;                                                 // 0x1F5D   (0x0001)  
	bool                                               bBoostInputReleased;                                        // 0x1F5E   (0x0001)  
	bool                                               bUseTractorBeamUprightForce;                                // 0x1F5F   (0x0001)  
	bool                                               bDeadBattery;                                               // 0x1F60   (0x0001)  
	unsigned char                                      UnknownData01_5[0x3];                                       // 0x1F61   (0x0003)  MISSED
	float                                              TractorBeamExtraLengthForExtents;                           // 0x1F64   (0x0004)  
	FVector                                            CrashingDesiredUp;                                          // 0x1F68   (0x0018)  
	float                                              BoostStartTime;                                             // 0x1F80   (0x0004)  
	float                                              BoostPitchAlpha;                                            // 0x1F84   (0x0004)  
	float                                              BoostChargeProgress;                                        // 0x1F88   (0x0004)  
	int32_t                                            BoostChargesAvailable;                                      // 0x1F8C   (0x0004)  
	FVector                                            CachedBoostMoveDir;                                         // 0x1F90   (0x0018)  
	float                                              CurrentStateStartTime;                                      // 0x1FA8   (0x0004)  
	float                                              HeightAtLandingTime;                                        // 0x1FAC   (0x0004)  
	float                                              CrashingScrapingTime;                                       // 0x1FB0   (0x0004)  
	float                                              CrashingNotMovingTimer;                                     // 0x1FB4   (0x0004)  
	float                                              AltimeterTraceHitDistance;                                  // 0x1FB8   (0x0004)  
	float                                              TractorBeamAppliedForceMagnitude;                           // 0x1FBC   (0x0004)  
	float                                              AnimParamDriverSeatLeftRight;                               // 0x1FC0   (0x0004)  
	float                                              AnimParamDriverSeatForwardBack;                             // 0x1FC4   (0x0004)  
	bool                                               bForceNegativeLift;                                         // 0x1FC8   (0x0001)  
	bool                                               bForcePositiveLift;                                         // 0x1FC9   (0x0001)  
	bool                                               bInitialLift;                                               // 0x1FCA   (0x0001)  
	ENevadaFlightStates                                CurrentVehicleState;                                        // 0x1FCB   (0x0001)  
	unsigned char                                      UnknownData02_5[0x4C];                                      // 0x1FCC   (0x004C)  MISSED
	SDK_UNDEFINED(8,14983) /* TWeakObjectPtr<ALandscapeProxy*> */ __um(CachedLandscapeProxy);                      // 0x2018   (0x0008)  
	class UClass*                                      PassengerCameraModeClass;                                   // 0x2020   (0x0008)  
	bool                                               bTractorBeamChargeStarted;                                  // 0x2028   (0x0001)  
	unsigned char                                      UnknownData03_5[0x7];                                       // 0x2029   (0x0007)  MISSED
	FTowhookParams                                     TowhookParams;                                              // 0x2030   (0x00D0)  
	class UClass*                                      AttachedPawnHiddenVehicle;                                  // 0x2100   (0x0008)  
	SDK_UNDEFINED(8,14984) /* TWeakObjectPtr<UPrimitiveComponent*> */ __um(TractorBeamAttachedPrimitive);          // 0x2108   (0x0008)  
	class AFortAthenaVehicle*                          SpawnedTractorBeamVictimVehicle;                            // 0x2110   (0x0008)  
	SDK_UNDEFINED(8,14985) /* TWeakObjectPtr<UPrimitiveComponent*> */ __um(PreviousTractorBeamAttachedPrimitive);  // 0x2118   (0x0008)  
	TArray<class AActor*>                              TractorBeamTargetedActors;                                  // 0x2120   (0x0010)  
	TArray<class AActor*>                              PreviouslyTargetedActors;                                   // 0x2130   (0x0010)  
	class AActor*                                      TractorBeamAttachedActor;                                   // 0x2140   (0x0008)  
	class AActor*                                      TractorBeamTargetedActor;                                   // 0x2148   (0x0008)  
	FVector                                            TractorBeamTargetPosition;                                  // 0x2150   (0x0018)  
	unsigned char                                      UnknownData04_5[0x1];                                       // 0x2168   (0x0001)  MISSED
	bool                                               bBeamButtonReleased;                                        // 0x2169   (0x0001)  
	unsigned char                                      UnknownData05_5[0x6];                                       // 0x216A   (0x0006)  MISSED
	SDK_UNDEFINED(16,14986) /* TArray<TEnumAsByte<EObjectTypeQuery>> */ __um(TractorBeamObjectsTypes);             // 0x2170   (0x0010)  
	FGameplayTagContainer                              DisallowedBeamTags;                                         // 0x2180   (0x0020)  
	FGameplayTagContainer                              AlwaysAllowedBeamTags;                                      // 0x21A0   (0x0020)  
	unsigned char                                      UnknownData06_5[0x98];                                      // 0x21C0   (0x0098)  MISSED
	class UNiagaraSystem*                              TractorBeamFX_Unattached;                                   // 0x2258   (0x0008)  
	class UNiagaraSystem*                              TractorBeamFX_Attached;                                     // 0x2260   (0x0008)  
	class UNiagaraComponent*                           BeamPSC;                                                    // 0x2268   (0x0008)  
	unsigned char                                      UnknownData07_5[0x50];                                      // 0x2270   (0x0050)  MISSED
	SDK_UNDEFINED(1,14987) /* TEnumAsByte<ETractorBeamState> */ __um(TractorBeamState);                            // 0x22C0   (0x0001)  
	unsigned char                                      UnknownData08_5[0x27];                                      // 0x22C1   (0x0027)  MISSED
	float                                              TractorBeamDeactivationTimestamp;                           // 0x22E8   (0x0004)  
	float                                              TractorBeamDisruptedTimestamp;                              // 0x22EC   (0x0004)  
	unsigned char                                      UnknownData09_5[0x80];                                      // 0x22F0   (0x0080)  MISSED
	float                                              CockpitHealth;                                              // 0x2370   (0x0004)  
	float                                              Native_CockpitEnabled;                                      // 0x2374   (0x0004)  
	float                                              LastCockpitHealthTickTime;                                  // 0x2378   (0x0004)  
	float                                              LastCockpitDamageTime;                                      // 0x237C   (0x0004)  
	float                                              CockpitDissolveStartTime;                                   // 0x2380   (0x0004)  
	unsigned char                                      UnknownData10_5[0x4];                                       // 0x2384   (0x0004)  MISSED
	FScalableFloat                                     CockpitMaxHealth;                                           // 0x2388   (0x0028)  
	FScalableFloat                                     CockpitHealthTickRate;                                      // 0x23B0   (0x0028)  
	FScalableFloat                                     CockpitHealthPerTick;                                       // 0x23D8   (0x0028)  
	FScalableFloat                                     CockpitRegenDelay;                                          // 0x2400   (0x0028)  
	class UCurveFloat*                                 CockpitHitMaterialWobble;                                   // 0x2428   (0x0008)  
	float                                              LastDamageAlpha;                                            // 0x2430   (0x0004)  
	bool                                               bDissolvingCockpit;                                         // 0x2434   (0x0001)  
	bool                                               bRestoringCockpit;                                          // 0x2435   (0x0001)  
	bool                                               bCockpitWobble;                                             // 0x2436   (0x0001)  
	unsigned char                                      UnknownData11_5[0x1];                                       // 0x2437   (0x0001)  MISSED
	class UStaticMeshComponent*                        NativeComp_ShieldMesh;                                      // 0x2438   (0x0008)  
	class UMaterialInstanceDynamic*                    Native_CockpitMaterial;                                     // 0x2440   (0x0008)  
	class UMaterialInstanceDynamic*                    Native_EnergyRingMatInstance;                               // 0x2448   (0x0008)  
	class UMaterialInstanceDynamic*                    Native_EnergyFieldMatInstance;                              // 0x2450   (0x0008)  
	class UAudioComponent*                             NativeComp_DamageStateLastLife;                             // 0x2458   (0x0008)  
	class UAudioComponent*                             NativeComp_DamageState;                                     // 0x2460   (0x0008)  
	FVector                                            Native_LastHitLocation;                                     // 0x2468   (0x0018)  
	FVector                                            Native_LastHitNormal;                                       // 0x2480   (0x0018)  
	class UNiagaraComponent*                           NativeComp_DamageStateFX;                                   // 0x2498   (0x0008)  
	class UNiagaraComponent*                           NativeComp_HologramScreen;                                  // 0x24A0   (0x0008)  
	class UNiagaraComponent*                           NativeComp_SpeedLines;                                      // 0x24A8   (0x0008)  
	class UMaterialInterface*                          Native_EnergyRingMat;                                       // 0x24B0   (0x0008)  
	class UMaterialInterface*                          Native_EnergyFieldMat;                                      // 0x24B8   (0x0008)  
	class UNiagaraSystem*                              NativeSys_DamageStateFX;                                    // 0x24C0   (0x0008)  
	class UNiagaraSystem*                              NativeSys_CockpitDestroyed;                                 // 0x24C8   (0x0008)  
	class USoundBase*                                  CockpitDamagedSound;                                        // 0x24D0   (0x0008)  
	class USoundBase*                                  CockpitDestroyedSound;                                      // 0x24D8   (0x0008)  
	class USoundBase*                                  CockpitRespawnSound;                                        // 0x24E0   (0x0008)  
	class USoundBase*                                  Native_DamageStateSound;                                    // 0x24E8   (0x0008)  
	class USoundBase*                                  Native_DamageStateLastLifeSound;                            // 0x24F0   (0x0008)  
	class UForceFeedbackEffect*                        CockpitDeactivatedForceFeedback;                            // 0x24F8   (0x0008)  
	class UClass*                                      CockpitDestroyedCamShake;                                   // 0x2500   (0x0008)  
	TArray<class UClass*>                              TractorBeamDisallowedClasses;                               // 0x2508   (0x0010)  
	unsigned char                                      UnknownData12_6[0x8];                                       // 0x2518   (0x0008)  MISSED
