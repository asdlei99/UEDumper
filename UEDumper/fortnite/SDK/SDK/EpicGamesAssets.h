...
public:
	...
	// void OnSystemFinished(class UNiagaraComponent* FinishedComponent);                                                    // [0xa7d743c] Final|Native|Private 
	// Function /Script/EpicGamesAssets.SpawnedParticleSystemReplication.OnRep_VFXAsset
	// void OnRep_VFXAsset();                                                                                                // [0xa7d7428] Final|Native|Private 
	// Function /Script/EpicGamesAssets.SpawnedParticleSystemReplication.OnRep_StartTime
	// void OnRep_StartTime();                                                                                               // [0xa7d7414] Final|Native|Private 
};
