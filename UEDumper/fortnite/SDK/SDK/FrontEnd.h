...
public:
	...
	// void ExecuteUbergraph_SpecialEventsCamera_Blueprint(int32_t EntryPoint);                                              // [0x130d900] Final|HasDefaults    
};
...
public:
	...
	// void GetCampaignQuestManager(class UFortQuestManager*& QuestManager);                                                 // [0x130d900] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/FrontEnd/HomebaseOnboarding/HBOnboardingFlow.HBOnboardingFlow_C.RecheckNeedToPlayEventMovie
	// void RecheckNeedToPlayEventMovie(bool& WaitingToCheckAgain);                                                          // [0x130d900] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/FrontEnd/HomebaseOnboarding/HBOnboardingFlow.HBOnboardingFlow_C.NeedsToPlayEventMovie
	// bool NeedsToPlayEventMovie();                                                                                         // [0x130d900] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	...
	// void OnCanceled_856A325D44ECC73B857CE5B301E90D33();                                                                   // [0x130d900] BlueprintCallable|BlueprintEvent 
...
public:
	...
	// void OnClientAnnouncementStop();                                                                                      // [0x130d900] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Game/FrontEnd/HomebaseOnboarding/Announcements/Announce_EventCine.Announce_EventCine_C.OnPlayerSkippedCutscene
	// void OnPlayerSkippedCutscene();                                                                                       // [0x130d900] BlueprintCosmetic|Event|Public|BlueprintEvent 
	...
	// void HandleClientEvent_CinematicFinishedPlaying(class UObject* EventSource, class UObject* EventFocus, FFortClientEvent& ClientEvent); // [0x130d900] HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/FrontEnd/HomebaseOnboarding/Announcements/Announce_EventCine.Announce_EventCine_C.HandleAllowSkip
	// void HandleAllowSkip();                                                                                               // [0x130d900] BlueprintCallable|BlueprintEvent 
	// Function /Game/FrontEnd/HomebaseOnboarding/Announcements/Announce_EventCine.Announce_EventCine_C.OnEnteredCinematicState
	// void OnEnteredCinematicState();                                                                                       // [0x130d900] Event|Protected|BlueprintEvent 
	...
	// void ExecuteUbergraph_Announce_EventCine(int32_t EntryPoint);                                                         // [0x130d900] Final|HasDefaults    
};
...
public:
	...
	SDK_UNDEFINED(1,13873) /* TEnumAsByte<ETimelineDirection> */ __um(ChoicePack__Direction_ACA3841D4D5084BE3482FA8EBB7CE9C0); // 0x0A1C   (0x0001)  
	...
	SDK_UNDEFINED(1,13874) /* TEnumAsByte<ETimelineDirection> */ __um(Timeline_0__Direction_6555812E4B246E6144D3C99FC49F7FE9); // 0x0A2C   (0x0001)  
	...
	// void ChoicePack__FinishedFunc();                                                                                      // [0x130d900] BlueprintEvent       
	// Function /Game/FrontEnd/Cameras/StoreCamera_Blueprint.StoreCamera_Blueprint_C.ChoicePack__UpdateFunc
	// void ChoicePack__UpdateFunc();                                                                                        // [0x130d900] BlueprintEvent       
...
public:
	...
	// void InitiatePinata();                                                                                                // [0x130d900] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_StoreCardReveal_Parent(int32_t EntryPoint);                                                     // [0x130d900] Final                
};
...
public:
	...
	// void ExecuteUbergraph_HeroesCamera_Blueprint(int32_t EntryPoint);                                                     // [0x130d900] Final|HasDefaults    
};
...
public:
	...
	// void CameraResetComplete();                                                                                           // [0x130d900] BlueprintCallable|BlueprintEvent 
	...
	// void CameraTransitionComplete();                                                                                      // [0x130d900] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_StorePinataMaster_Parent(int32_t EntryPoint);                                                   // [0x130d900] Final                
};
...
public:
	...
	// void ExecuteUbergraph_LoginCamera_Blueprint(int32_t EntryPoint);                                                      // [0x130d900] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_VaultCamera_Blueprint(int32_t EntryPoint);                                                      // [0x130d900] Final|HasDefaults    
};
