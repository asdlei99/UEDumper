...
public:
	...
	// void DelMarResetNux();                                                                                                // [0x3097b14] Final|Exec|Native|Protected 
	// Function /Script/DelMarFrontend.DelMarFrontendCheatManager.DelMarMarkTutorialPlayed
	// void DelMarMarkTutorialPlayed();                                                                                      // [0x3097b14] Final|Exec|Native|Protected 
};
...
public:
	...
	SDK_UNDEFINED(32,13145) /* TWeakObjectPtr<UClass*> */ __um(VideoPlayerClass);                                  // 0x0040   (0x0020)  
	class UClass*                                      ConfirmationWindowClass;                                    // 0x0060   (0x0008)  
	SDK_UNDEFINED(24,13146) /* FText */                __um(TutorialPromptTitle);                                  // 0x0068   (0x0018)  
	SDK_UNDEFINED(24,13147) /* FText */                __um(TutorialPromptDescription);                            // 0x0080   (0x0018)  
	SDK_UNDEFINED(24,13148) /* FText */                __um(TutorialPromptConfirmButtonText);                      // 0x0098   (0x0018)  
	SDK_UNDEFINED(24,13149) /* FText */                __um(TutorialPromptDeclineButtonText);                      // 0x00B0   (0x0018)  
	class UDelMarGameUserSettings*                     DelMarUserSettings;                                         // 0x00C8   (0x0008)  
	unsigned char                                      UnknownData01_5[0x8];                                       // 0x00D0   (0x0008)  MISSED
	SDK_UNDEFINED(80,13150) /* TMap<FString, FString> */ __um(NUXTrailerRating);                                   // 0x00D8   (0x0050)  
...
public:
	unsigned char                                      UnknownData00_3[0x30];                                      // 0x0000   (0x0030)  MISSED
	SDK_UNDEFINED(24,13151) /* FText */                __um(ModeSetButtonPrimaryText);                             // 0x0030   (0x0018)  
...
public:
	unsigned char                                      UnknownData00_3[0x30];                                      // 0x0000   (0x0030)  MISSED
	SDK_UNDEFINED(32,13152) /* TWeakObjectPtr<UClass*> */ __um(RankInfoModalOverride);                             // 0x0030   (0x0020)  
};
...
{ 
public:
	SDK_UNDEFINED(16,13153) /* FString */              __um(FrontendNuxVideoKey);                                  // 0x0038   (0x0010)  
	FName                                              FrontendNuxVideoName;                                       // 0x0048   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x004C   (0x0004)  MISSED
	SDK_UNDEFINED(16,13154) /* FString */              __um(FrontendNuxVideoId);                                   // 0x0050   (0x0010)  
	bool                                               bDisableFrontendNuxFlow;                                    // 0x0060   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0061   (0x0007)  MISSED
	SDK_UNDEFINED(16,13155) /* FString */              __um(DelMarTutorialLinkCode);                               // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,13156) /* FString */              __um(DelMarDefaultLinkCode);                                // 0x0078   (0x0010)  


	/// Functions
	// Function /Script/DelMarFrontend.DelMarFrontendRuntimeOptions.GetDelMarFrontendRuntimeOptions
	// class UDelMarFrontendRuntimeOptions* GetDelMarFrontendRuntimeOptions();                                               // [0xbedc284] Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
