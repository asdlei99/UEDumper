...
public:
	...
	SDK_UNDEFINED(32,14575) /* TWeakObjectPtr<UAnimMontage*> */ __um(DashMontage);                                 // 0x0748   (0x0020)  
	SDK_UNDEFINED(32,14576) /* TWeakObjectPtr<UAnimMontage*> */ __um(DeltaEquipMontage);                           // 0x0768   (0x0020)  
	SDK_UNDEFINED(16,14577) /* TArray<TWeakObjectPtr<UAnimMontage*>> */ __um(SwingMontages);                       // 0x0788   (0x0010)  
