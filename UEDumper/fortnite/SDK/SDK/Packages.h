...
public:
	...
	// void Construction();                                                                                                  // [0x3d1d968] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Handle Water Penetration Components And Arrays(bool In T Out F, class AActor* Touching Actor, class UStaticMeshComponent* Touching Volume); // [0x3d1d968] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Find Placement on water mesh surfaces(FTransform& Traced Transform, FVector& VelocityVector, bool& Trace Hit);   // [0x3d1d968] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void SetupMeshCollisionVolumes(class UStaticMeshComponent* StaticMeshComponent, int32_t Target Int);                  // [0x3d1d968] Public|BlueprintCallable|BlueprintEvent 
	...
	// void BndEvt__CollisionMesh2_K2Node_ComponentBoundEvent_220_ComponentEndOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // [0x3d1d968] BlueprintEvent       
	...
	// void BndEvt__CollisionMesh3_K2Node_ComponentBoundEvent_211_ComponentEndOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // [0x3d1d968] BlueprintEvent       
	...
	// void BndEvt__CollisionMesh_K2Node_ComponentBoundEvent_66_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& SweepResult); // [0x3d1d968] HasOutParms|BlueprintEvent 
	...
	// void BndEvt__CollisionMesh4_K2Node_ComponentBoundEvent_203_ComponentEndOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // [0x3d1d968] BlueprintEvent       
	...
	// void BndEvt__CollisionMesh2_K2Node_ComponentBoundEvent_196_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& SweepResult); // [0x3d1d968] HasOutParms|BlueprintEvent 
	...
	// void BndEvt__CollisionMesh3_K2Node_ComponentBoundEvent_190_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& SweepResult); // [0x3d1d968] HasOutParms|BlueprintEvent 
	...
	// void BndEvt__CollisionMesh_K2Node_ComponentBoundEvent_69_ComponentEndOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // [0x3d1d968] BlueprintEvent       
	...
	// void Construct();                                                                                                     // [0x3d1d968] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph__WaterMeshBlueprintMaster(int32_t EntryPoint);                                                  // [0x3d1d968] Final|HasDefaults    
};
