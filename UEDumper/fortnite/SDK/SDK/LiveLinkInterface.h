...
public:
	...
	SDK_UNDEFINED(16,2503) /* FString */               __um(ConnectionString);                                     // 0x0090   (0x0010)  
...
{ 
	SDK_UNDEFINED(80,2504) /* TMap<FString, FSoftObjectPath> */ __um(CurveConversionAssetMap);                     // 0x0000   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(24,2506) /* FText */                 __um(SourceType);                                           // 0x0018   (0x0018)  
};
...
{ 
	SDK_UNDEFINED(80,2507) /* TMap<FName, FString> */  __um(StringMetaData);                                       // 0x0000   (0x0050)  
