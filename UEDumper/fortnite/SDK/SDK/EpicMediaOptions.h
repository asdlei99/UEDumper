...
{ 
	...
	SDK_UNDEFINED(16,13379) /* TArray<FString> */      __um(VideoEVMap);                                           // 0x0030   (0x0010)  
	TArray<float>                                      CDNDistribution;                                            // 0x0040   (0x0010)  
	SDK_UNDEFINED(16,13380) /* TArray<FString> */      __um(VODHostNames);                                         // 0x0050   (0x0010)  
	SDK_UNDEFINED(16,13381) /* TArray<FString> */      __um(VODHostNamesCN);                                       // 0x0060   (0x0010)  
	SDK_UNDEFINED(16,13382) /* TArray<FString> */      __um(LiveHostNames);                                        // 0x0070   (0x0010)  
	SDK_UNDEFINED(16,13383) /* TArray<FString> */      __um(LiveHostNamesCN);                                      // 0x0080   (0x0010)  
	SDK_UNDEFINED(16,13384) /* TArray<FString> */      __um(VODHostNamesDev);                                      // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,13385) /* TArray<FString> */      __um(LiveHostNamesDev);                                     // 0x00A0   (0x0010)  
	SDK_UNDEFINED(16,13386) /* TArray<FString> */      __um(VODHostNamesHF);                                       // 0x00B0   (0x0010)  
	SDK_UNDEFINED(16,13387) /* TArray<FString> */      __um(LiveHostNamesHF);                                      // 0x00C0   (0x0010)  
	SDK_UNDEFINED(16,13388) /* TArray<FString> */      __um(VODHostNamesCNHF);                                     // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,13389) /* TArray<FString> */      __um(LiveHostNamesCNHF);                                    // 0x00E0   (0x0010)  
