...
{ 
	...
	SDK_UNDEFINED(80,63) /* TMap<FName, FCustomizedToolMenuEntry> */ __um(Entries);                                // 0x0008   (0x0050)  
	SDK_UNDEFINED(80,64) /* TMap<FName, FCustomizedToolMenuSection> */ __um(Sections);                             // 0x0058   (0x0050)  
	SDK_UNDEFINED(80,65) /* TMap<FName, FCustomizedToolMenuNameArray> */ __um(EntryOrder);                         // 0x00A8   (0x0050)  
	TArray<FName>                                      SectionOrder;                                               // 0x00F8   (0x0010)  
	TArray<FName>                                      SuppressExtenders;                                          // 0x0108   (0x0010)  
	unsigned char                                      UnknownData01_6[0xE8];                                      // 0x0118   (0x00E8)  MISSED
};
