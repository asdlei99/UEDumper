...
public:
	...
	SDK_UNDEFINED(16,11760) /* FMulticastInlineDelegate */ __um(OnGearChangedEvent);                               // 0x0108   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(16,11761) /* FMulticastInlineDelegate */ __um(OnRevLimiterHit);                                  // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,11762) /* FMulticastInlineDelegate */ __um(OnRevLimiterStateChanged);                         // 0x00D8   (0x0010)  
...
public:
	...
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00C4   (0x0004)  MISSED
	SDK_UNDEFINED(16,11763) /* FMulticastInlineDelegate */ __um(OnUpShift);                                        // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,11764) /* FMulticastInlineDelegate */ __um(OnDownShift);                                      // 0x00D8   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(16,11765) /* FMulticastInlineDelegate */ __um(OnThrottleEngaged);                                // 0x00B0   (0x0010)  
	SDK_UNDEFINED(16,11766) /* FMulticastInlineDelegate */ __um(OnThrottleReleased);                               // 0x00C0   (0x0010)  
	SDK_UNDEFINED(16,11767) /* FMulticastInlineDelegate */ __um(OnEngineBlowoff);                                  // 0x00D0   (0x0010)  
