...
public:
	...
	SDK_UNDEFINED(16,11650) /* TArray<FString> */      __um(SharedOptionNames);                                    // 0x00C8   (0x0010)  
	SDK_UNDEFINED(32,11651) /* TWeakObjectPtr<UClass*> */ __um(DefaultAIPawn);                                     // 0x00D8   (0x0020)  
	...
	SDK_UNDEFINED(16,11652) /* FMulticastInlineDelegate */ __um(OnPatrolPointFailedToReach);                       // 0x0180   (0x0010)  
	SDK_UNDEFINED(16,11653) /* FMulticastInlineDelegate */ __um(OnPatrolPointReached);                             // 0x0190   (0x0010)  
	SDK_UNDEFINED(16,11654) /* FMulticastInlineDelegate */ __um(OnPatrolPathStarted);                              // 0x01A0   (0x0010)  
	SDK_UNDEFINED(16,11655) /* FMulticastInlineDelegate */ __um(OnPatrolPathStopped);                              // 0x01B0   (0x0010)  
