...
{ 
public:
	SDK_UNDEFINED(32,15219) /* TWeakObjectPtr<UClass*> */ __um(EmotePickerClass);                                  // 0x0458   (0x0020)  
...
public:
	...
	SDK_UNDEFINED(80,15220) /* TMap<FString, TWeakObjectPtr<UPilgrimQuestNotificationEntry*>> */ __um(QuestWidgetMap); // 0x02F0   (0x0050)  
