...
public:
	...
	SDK_UNDEFINED(1,14751) /* TEnumAsByte<ETimelineDirection> */ __um(ItemDetails__Direction_68C3898D424BEACDFEB5559E091141D8); // 0x0364   (0x0001)  
	...
	SDK_UNDEFINED(1,14752) /* TEnumAsByte<ETimelineDirection> */ __um(Floor_Visibility__Direction_B8DF0E7548B0B3258911ACA2E59C4ED5); // 0x0374   (0x0001)  
	...
	SDK_UNDEFINED(1,14753) /* TEnumAsByte<ETimelineDirection> */ __um(Background_Effects__Direction_B72E13E64AF840AB5A739E8485EAFB0C); // 0x0384   (0x0001)  
	...
	SDK_UNDEFINED(1,14754) /* TEnumAsByte<ETimelineDirection> */ __um(TransitionForward__Direction_630B799D41239619956D94A08501493D); // 0x039C   (0x0001)  
	...
	SDK_UNDEFINED(1,14755) /* TEnumAsByte<ETimelineDirection> */ __um(TransitionBackward__Direction_0417507846315C71198827A55A7AB86E); // 0x03B4   (0x0001)  
	...
	// void ExecuteUbergraph_PilgrimEventScreenEventVaultWorld(int32_t EntryPoint);                                          // [0x3d1d968] Final|HasDefaults    
};
...
public:
	...
	SDK_UNDEFINED(1,14756) /* TEnumAsByte<ETimelineDirection> */ __um(ItemDetails__Direction_F6B0AC7B41049DEF369CBC83DDF5BBFF); // 0x0364   (0x0001)  
	unsigned char                                      UnknownData01_5[0x3];                                       // 0x0365   (0x0003)  MISSED
	class UTimelineComponent*                          ItemDetails;                                                // 0x0368   (0x0008)  
	float                                              Floor_Visibility_FloorMask_D214B0DD4C6F2C0C9E1F7EB6B83AA749; // 0x0370   (0x0004)  
	SDK_UNDEFINED(1,14757) /* TEnumAsByte<ETimelineDirection> */ __um(Floor_Visibility__Direction_D214B0DD4C6F2C0C9E1F7EB6B83AA749); // 0x0374   (0x0001)  
	unsigned char                                      UnknownData02_5[0x3];                                       // 0x0375   (0x0003)  MISSED
	class UTimelineComponent*                          Floor_Visibility;                                           // 0x0378   (0x0008)  
	float                                              Background_Effects_SetStreaks_5214A37042D2E029CF5D0EBFD2517F4B; // 0x0380   (0x0004)  
	SDK_UNDEFINED(1,14758) /* TEnumAsByte<ETimelineDirection> */ __um(Background_Effects__Direction_5214A37042D2E029CF5D0EBFD2517F4B); // 0x0384   (0x0001)  
	unsigned char                                      UnknownData03_5[0x3];                                       // 0x0385   (0x0003)  MISSED
	class UTimelineComponent*                          Background_Effects;                                         // 0x0388   (0x0008)  
	...
	SDK_UNDEFINED(1,14759) /* TEnumAsByte<ETimelineDirection> */ __um(TransitionForward__Direction_E69C8C7747ED578039A44EAFE294E4AD); // 0x039C   (0x0001)  
	unsigned char                                      UnknownData04_5[0x3];                                       // 0x039D   (0x0003)  MISSED
	class UTimelineComponent*                          TransitionForward;                                          // 0x03A0   (0x0008)  
	...
	SDK_UNDEFINED(1,14760) /* TEnumAsByte<ETimelineDirection> */ __um(TransitionBackward__Direction_3D20BA10496D96DCB7CDEFB256EE9477); // 0x03B4   (0x0001)  
	unsigned char                                      UnknownData05_5[0x3];                                       // 0x03B5   (0x0003)  MISSED
	class UTimelineComponent*                          TransitionBackward;                                         // 0x03B8   (0x0008)  
	...
	// void ExecuteUbergraph_LinedNotebookEventVaultWorld(int32_t EntryPoint);                                               // [0x3d1d968] Final|HasDefaults    
};
