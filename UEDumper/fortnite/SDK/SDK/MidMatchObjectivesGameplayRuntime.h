...
{ 
public:
	FName                                              ObjectiveCompletedStatName;                                 // 0x00A0   (0x0004)  
	...
	// void SetObjectiveCompletedStat(char SquadId);                                                                         // [0x95fa494] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
};
