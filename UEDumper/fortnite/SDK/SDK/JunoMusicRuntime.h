...
public:
	...
	SDK_UNDEFINED(16,14267) /* TArray<TWeakObjectPtr<UJunoMusicPlaylistDataAsset*>> */ __um(JunoMusicElementsToCreate); // 0x00C0   (0x0010)  
	...
	SDK_UNDEFINED(80,14268) /* TMap<UJunoMusicPlaylistDataAsset*, FElementControllerArray> */ __um(AllActiveMusicElementControllers); // 0x00F0   (0x0050)  
	...
	SDK_UNDEFINED(80,14269) /* TMap<FName, UJunoActiveMusicCooldownGroup*> */ __um(JunoMusicCooldownGroups);       // 0x0160   (0x0050)  
...
{ 
	...
	SDK_UNDEFINED(1,14270) /* TEnumAsByte<EMusicScheduleMode> */ __um(MusicScheduleMode);                          // 0x0028   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(12,14271) /* FDelegateProperty */    __um(OnJunoActiveMusicElementControllerFinishedPlaying);    // 0x0058   (0x000C)  
	unsigned char                                      UnknownData03_5[0x1C];                                      // 0x0064   (0x001C)  MISSED
	SDK_UNDEFINED(1,14272) /* TEnumAsByte<EJunoActiveMusicElementState> */ __um(JunoActiveMusicElementState);      // 0x0080   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(80,14273) /* TMap<UWorld*, FJunoWorldMusicSystem> */ __um(WorldMusicSystems);                    // 0x0040   (0x0050)  
...
{ 
	...
	SDK_UNDEFINED(80,14274) /* TMap<FName, FVector2D> */ __um(CooldownGroups);                                     // 0x0018   (0x0050)  
