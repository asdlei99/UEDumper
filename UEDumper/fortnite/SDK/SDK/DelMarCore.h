...
public:
	...
	SDK_UNDEFINED(16,12690) /* FMulticastInlineDelegate */ __um(OnLoadoutChanged);                                 // 0x03D8   (0x0010)  
	...
	SDK_UNDEFINED(8,12691) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(DelMarVehicle);                              // 0x0598   (0x0008)  
	...
	SDK_UNDEFINED(16,12692) /* FString */              __um(DelMarBotPlayerName);                                  // 0x05B8   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(32,12693) /* TWeakObjectPtr<UDelMarAIVehicleCosmeticLibraryData*> */ __um(VehicleCosmeticLibrary); // 0x0080   (0x0020)  
	...
	SDK_UNDEFINED(32,12694) /* TWeakObjectPtr<UFortAthenaAIBotNameDataAsset*> */ __um(BotNameDataAsset);           // 0x00A8   (0x0020)  
	class UClass*                                      AIControllerClass;                                          // 0x00C8   (0x0008)  
	SDK_UNDEFINED(32,12695) /* TWeakObjectPtr<UDataTable*> */ __um(MMRSpawnTablePtr);                              // 0x00D0   (0x0020)  
	TArray<class ADelMarAIController*>                 DelMarAIControllers;                                        // 0x00F0   (0x0010)  
	SDK_UNDEFINED(8,12696) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(RaceManager);                            // 0x0100   (0x0008)  
	SDK_UNDEFINED(8,12697) /* TWeakObjectPtr<UDelMarRespawnManagerComponent*> */ __um(RespawnManagerComponent);    // 0x0108   (0x0008)  
	SDK_UNDEFINED(80,12698) /* TSet<FString> */        __um(ReservedPlayerNames);                                  // 0x0110   (0x0050)  
...
{ 
	SDK_UNDEFINED(32,12699) /* TWeakObjectPtr<UCosmeticLoadoutSlotTemplate*> */ __um(SlotTemplate);                // 0x0000   (0x0020)  
	SDK_UNDEFINED(32,12700) /* TWeakObjectPtr<UDataTable*> */ __um(VehicleSlotCosmeticDataTable);                  // 0x0020   (0x0020)  
};
...
{ 
public:
	SDK_UNDEFINED(32,12701) /* TWeakObjectPtr<UDataTable*> */ __um(PredefineVehiclCosmeticSetsDataTable);          // 0x0030   (0x0020)  
...
public:
	...
	SDK_UNDEFINED(8,12702) /* TWeakObjectPtr<AActor*> */ __um(Actor);                                              // 0x0028   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12703) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(DelMarVehicle);                              // 0x0098   (0x0008)  
};
...
public:
	...
	SDK_UNDEFINED(1,12704) /* TEnumAsByte<ECollisionChannel> */ __um(RaycastCollisionChannel);                     // 0x0164   (0x0001)  
	...
	SDK_UNDEFINED(8,12705) /* TWeakObjectPtr<UDelMarTrackPositionComponent*> */ __um(TrackPositionComponent);      // 0x03F0   (0x0008)  
	SDK_UNDEFINED(8,12706) /* TWeakObjectPtr<UDelMarTrackOobTubePositionalRenderingComponent*> */ __um(OobTubePositionalRenderingComponent); // 0x03F8   (0x0008)  
	SDK_UNDEFINED(80,12707) /* TMap<TWeakObjectPtr<AActor*>, UDriveHazardInfo*> */ __um(PrevFrameDriveHazardInfoMap); // 0x0400   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(8,12708) /* TWeakObjectPtr<UDelMarPlayerRaceDataComponent*> */ __um(PlayerRaceDataComponent);    // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12709) /* TWeakObjectPtr<UDelMarTrackPositionComponent*> */ __um(TrackPositionComponent);      // 0x00A8   (0x0008)  
...
public:
	FBlackboardKeySelector                             VehicleKey;                                                 // 0x0070   (0x0028)  
	SDK_UNDEFINED(8,12710) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(DelMarVehicle);                              // 0x0098   (0x0008)  
};
...
public:
	...
	SDK_UNDEFINED(8,12711) /* TWeakObjectPtr<UDelMarTrackPositionComponent*> */ __um(TrackPositionComponent);      // 0x0754   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12712) /* TWeakObjectPtr<UDelMarGhostPlaybackSessionComponent*> */ __um(CachedPlaybackSession); // 0x00B8   (0x0008)  
	SDK_UNDEFINED(8,12713) /* TWeakObjectPtr<UDelMarGhostRecordingSessionComponent*> */ __um(CachedRecordingSession); // 0x00C0   (0x0008)  
	SDK_UNDEFINED(8,12714) /* TWeakObjectPtr<ADelMarChallengeRaceManager*> */ __um(CachedRaceManager);             // 0x00C8   (0x0008)  
};
...
public:
	...
	SDK_UNDEFINED(16,12715) /* FMulticastInlineDelegate */ __um(OnRaceFinished);                                   // 0x0320   (0x0010)  
	SDK_UNDEFINED(16,12716) /* FMulticastInlineDelegate */ __um(OnRaceStarted);                                    // 0x0330   (0x0010)  
	SDK_UNDEFINED(16,12717) /* FMulticastInlineDelegate */ __um(OnRaceCountdownStarted);                           // 0x0340   (0x0010)  
	SDK_UNDEFINED(16,12718) /* FMulticastInlineDelegate */ __um(OnRaceReset);                                      // 0x0350   (0x0010)  
	SDK_UNDEFINED(16,12719) /* FMulticastInlineDelegate */ __um(OnPlayerFinishedRace);                             // 0x0360   (0x0010)  
	SDK_UNDEFINED(16,12720) /* FMulticastInlineDelegate */ __um(OnPlayerLapComplete);                              // 0x0370   (0x0010)  
	SDK_UNDEFINED(16,12721) /* FMulticastInlineDelegate */ __um(OnPlayerResetRun);                                 // 0x0380   (0x0010)  
	...
	SDK_UNDEFINED(8,12722) /* TWeakObjectPtr<ADelMarRaceLevelConfig*> */ __um(ActiveRaceLevelConfig);              // 0x03C0   (0x0008)  
	...
	SDK_UNDEFINED(80,12723) /* TSet<AFortPlayerState*> */ __um(ManagedPlayerStates);                               // 0x0400   (0x0050)  
	SDK_UNDEFINED(80,12724) /* TSet<TWeakObjectPtr<AFortPlayerState*>> */ __um(InactivePlayerStates);              // 0x0450   (0x0050)  
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0004   (0x0004)  MISSED
	SDK_UNDEFINED(32,12725) /* TWeakObjectPtr<UClass*> */ __um(StateClass);                                        // 0x0008   (0x0020)  
};
...
public:
	...
	SDK_UNDEFINED(80,12726) /* TMap<FGameplayTag, UClass*> */ __um(StateMappings);                                 // 0x00B0   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(8,12727) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(RaceManager);                            // 0x01A8   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12728) /* TWeakObjectPtr<UEnhancedInputComponent*> */ __um(InputComponent);                    // 0x00C0   (0x0008)  
	SDK_UNDEFINED(8,12729) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00C8   (0x0008)  
	SDK_UNDEFINED(8,12730) /* TWeakObjectPtr<UDelMarRequestComponent*> */ __um(SpectatorRequestComponent);         // 0x00D0   (0x0008)  
	SDK_UNDEFINED(8,12731) /* TWeakObjectPtr<AFortPlayerState*> */ __um(CurrentViewTarget);                        // 0x00D8   (0x0008)  
	SDK_UNDEFINED(8,12732) /* TWeakObjectPtr<AFortPlayerState*> */ __um(PrevValidViewTarget);                      // 0x00E0   (0x0008)  
	SDK_UNDEFINED(8,12733) /* TWeakObjectPtr<AFortPlayerState*> */ __um(SpectatorPlayerState);                     // 0x00E8   (0x0008)  
	SDK_UNDEFINED(8,12734) /* TWeakObjectPtr<AFortPlayerControllerZone*> */ __um(SpectatorController);             // 0x00F0   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12735) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedVehicle);                              // 0x00D8   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(8,12736) /* TWeakObjectPtr<APlayerState*> */ __um(ViewTargetPlayerState);                        // 0x0110   (0x0008)  
};
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0004   (0x0004)  MISSED
	SDK_UNDEFINED(24,12737) /* FText */                __um(SlotName);                                             // 0x0008   (0x0018)  
	SDK_UNDEFINED(24,12738) /* FText */                __um(ShortDescription);                                     // 0x0020   (0x0018)  
	bool                                               bCanBeEmpty;                                                // 0x0038   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0039   (0x0007)  MISSED
	SDK_UNDEFINED(32,12739) /* TWeakObjectPtr<UTexture2D*> */ __um(UnassignedPreviewImage);                        // 0x0040   (0x0020)  
};
...
{ 
public:
	SDK_UNDEFINED(8,12740) /* TWeakObjectPtr<ADelMarDeathRaceManager*> */ __um(DeathRaceManager);                  // 0x0030   (0x0008)  
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(8,12741) /* TWeakObjectPtr<AFortPlayerState*> */ __um(NewFirstPlace);                            // 0x0028   (0x0008)  
	SDK_UNDEFINED(8,12742) /* TWeakObjectPtr<AFortPlayerState*> */ __um(PrevFirstPlace);                           // 0x0030   (0x0008)  
};
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(16,12743) /* FString */              __um(LeaderboardEventId);                                   // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,12744) /* FString */              __um(LeaderboardWindowId);                                  // 0x0038   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,12745) /* FString */              __um(PlayerAccountId);                                      // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,12746) /* FString */              __um(PlayerName);                                           // 0x0018   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,12747) /* FString */              __um(FlowAnalyicsEventName);                                // 0x00A0   (0x0010)  
	SDK_UNDEFINED(8,12748) /* TWeakObjectPtr<AFortPlayerController*> */ __um(PlayerController);                    // 0x00B0   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(16,12749) /* FString */              __um(LastPlayedDelMarMnemonic);                             // 0x0030   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(8,12750) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedDelMarVehicle);                        // 0x00F8   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(16,12751) /* FString */              __um(LeaderboardEventId);                                   // 0x00A0   (0x0010)  
	SDK_UNDEFINED(16,12752) /* FString */              __um(LeaderboardWindowId);                                  // 0x00B0   (0x0010)  
...
{ 
	SDK_UNDEFINED(24,12753) /* FText */                __um(KBMText);                                              // 0x0000   (0x0018)  
	SDK_UNDEFINED(24,12754) /* FText */                __um(GamepadText);                                          // 0x0018   (0x0018)  
	SDK_UNDEFINED(24,12755) /* FText */                __um(TouchText);                                            // 0x0030   (0x0018)  
...
public:
	...
	SDK_UNDEFINED(8,12756) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(RaceManager);                            // 0x0398   (0x0008)  
	SDK_UNDEFINED(8,12757) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(ActiveVehicle);                              // 0x03A0   (0x0008)  
	SDK_UNDEFINED(8,12758) /* TWeakObjectPtr<AFortPlayerController*> */ __um(ActivePlayerController);              // 0x03A8   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(24,12759) /* FText */                __um(DisplayName);                                          // 0x0030   (0x0018)  
	SDK_UNDEFINED(24,12760) /* FText */                __um(LevelDescription);                                     // 0x0048   (0x0018)  
	SDK_UNDEFINED(32,12761) /* TWeakObjectPtr<UTexture2D*> */ __um(LevelBackgroundImage);                          // 0x0060   (0x0020)  
	SDK_UNDEFINED(16,12762) /* TArray<TWeakObjectPtr<UWorld*>> */ __um(Levels);                                    // 0x0080   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(80,12763) /* TMap<FGameplayTag, TWeakObjectPtr<UDelMarCosmeticItemDefinition*>> */ __um(EquippedLoadout); // 0x0028   (0x0050)  
};
...
{ 
public:
	SDK_UNDEFINED(8,12764) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12765) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedVehicle);                              // 0x00A8   (0x0008)  
	SDK_UNDEFINED(8,12766) /* TWeakObjectPtr<UDelMarPlayerRaceDataComponent*> */ __um(CachedPlayerRaceData);       // 0x00B0   (0x0008)  
	SDK_UNDEFINED(8,12767) /* TWeakObjectPtr<UDelMarRaceInfoComponent*> */ __um(CachedRaceInfo);                   // 0x00B8   (0x0008)  
	SDK_UNDEFINED(8,12768) /* TWeakObjectPtr<UDelMarPositionalTrackerComponent*> */ __um(CachedPositionalTracker); // 0x00C0   (0x0008)  
	SDK_UNDEFINED(8,12769) /* TWeakObjectPtr<UDelmarCompetitiveMatchmakeRatingComponent*> */ __um(MatchmakeRatingComponent); // 0x00C8   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(8,12770) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12771) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedDelMarVehicle);                        // 0x00A8   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(8,12772) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedVehicle);                              // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12773) /* TWeakObjectPtr<AFortPlayerState*> */ __um(CachedPlayerState);                        // 0x00A8   (0x0008)  
	SDK_UNDEFINED(8,12774) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00B0   (0x0008)  
	FTimerHandle                                       DistanceTraveledTimer;                                      // 0x00B8   (0x0008)  
	unsigned char                                      UnknownData00_5[0x28];                                      // 0x00C0   (0x0028)  MISSED
	SDK_UNDEFINED(8,12775) /* TWeakObjectPtr<UDelMarObjectiveProcessor_DistanceTraveled*> */ __um(DistanceTravelledObjectiveProcessor); // 0x00E8   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12776) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedVehicle);                              // 0x00A4   (0x0008)  
	SDK_UNDEFINED(8,12777) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00AC   (0x0008)  
	SDK_UNDEFINED(8,12778) /* TWeakObjectPtr<AFortPlayerState*> */ __um(CachedPlayerState);                        // 0x00B4   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12779) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(DelMarRaceManager);                      // 0x0308   (0x0008)  
};
...
{ 
public:
	SDK_UNDEFINED(8,12780) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedDelMarVehicle);                        // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12781) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00A8   (0x0008)  
	SDK_UNDEFINED(8,12782) /* TWeakObjectPtr<UDelMarTrackPositionComponent*> */ __um(CachedTrackPositionComp);     // 0x00B0   (0x0008)  
	SDK_UNDEFINED(8,12783) /* TWeakObjectPtr<UDelMarPlayerRaceDataComponent*> */ __um(CachedRaceData);             // 0x00B8   (0x0008)  
	SDK_UNDEFINED(8,12784) /* TWeakObjectPtr<UDelMarCheckpointManagerComponent*> */ __um(CachedCheckpointManager); // 0x00C0   (0x0008)  
	SDK_UNDEFINED(8,12785) /* TWeakObjectPtr<UDelMarTrackManager*> */ __um(CachedTrackManager);                    // 0x00C8   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(8,12786) /* TWeakObjectPtr<AFortAthenaVehicle*> */ __um(CachedVehicle);                          // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12787) /* TWeakObjectPtr<UVehicleCosmeticsAssembledMeshUserComponent*> */ __um(CachedVCAMUC);  // 0x00A8   (0x0008)  
	class UMaterialInterface*                          ProxyGhostMaterial;                                         // 0x00B0   (0x0008)  
	SDK_UNDEFINED(80,12788) /* TMap<FGameplayTag, FDelMarProxyMeshMaterialInfo> */ __um(VehicleMaterialInfoMap);   // 0x00B8   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(16,12789) /* FString */              __um(RaceGUID);                                             // 0x00A0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,12790) /* TMap<EDelMarRaceMode, UClass*> */ __um(RaceManagerClassMap);                        // 0x0C08   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(8,12791) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12792) /* TWeakObjectPtr<UDelMarPositionalTrackerComponent*> */ __um(PositionalTracker);       // 0x00A8   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(8,12794) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(Vehicle);                                    // 0x0030   (0x0008)  
};
...
{ 
public:
	SDK_UNDEFINED(8,12795) /* TWeakObjectPtr<USplineComponent*> */ __um(MovementSpline);                           // 0x00A0   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(16,12796) /* FMulticastInlineDelegate */ __um(OnPlayerCountdownStarted);                         // 0x00A0   (0x0010)  
	...
	SDK_UNDEFINED(8,12797) /* TWeakObjectPtr<UDelMarRaceConfigComponent*> */ __um(RaceConfig);                     // 0x00C8   (0x0008)  
	SDK_UNDEFINED(8,12798) /* TWeakObjectPtr<ADelMarRaceLevelConfig*> */ __um(RaceLevelConfig);                    // 0x00D0   (0x0008)  
	SDK_UNDEFINED(8,12799) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00D8   (0x0008)  
...
{ 
	SDK_UNDEFINED(24,12800) /* FText */                __um(KBMText);                                              // 0x0000   (0x0018)  
	SDK_UNDEFINED(24,12801) /* FText */                __um(GamepadText);                                          // 0x0018   (0x0018)  
};
...
{ 
	...
	SDK_UNDEFINED(24,12802) /* FText */                __um(Title);                                                // 0x0060   (0x0018)  
...
public:
	...
	SDK_UNDEFINED(8,12803) /* TWeakObjectPtr<UEnhancedInputComponent*> */ __um(InputComponent);                    // 0x0120   (0x0008)  
	SDK_UNDEFINED(8,12804) /* TWeakObjectPtr<AFortPlayerState*> */ __um(PlayerState);                              // 0x0128   (0x0008)  
	SDK_UNDEFINED(8,12805) /* TWeakObjectPtr<AFortPlayerController*> */ __um(PlayerController);                    // 0x0130   (0x0008)  
	SDK_UNDEFINED(8,12806) /* TWeakObjectPtr<UDelMarPlayerPreferencesComponent*> */ __um(PlayerPreferences);       // 0x0138   (0x0008)  
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(16,12807) /* FMulticastInlineDelegate */ __um(OnActionPerformed);                                // 0x0028   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(80,12808) /* TMap<FName, UDelMarVehicleBodySetup*> */ __um(BodySetupMap);                        // 0x0030   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(1,12809) /* TEnumAsByte<ECollisionChannel> */ __um(PenetrationTraceChannel);                     // 0x0104   (0x0001)  
	...
	SDK_UNDEFINED(8,12810) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(VehicleTarget);                              // 0x27A0   (0x0008)  
	SDK_UNDEFINED(8,12811) /* TWeakObjectPtr<UDelMarCameraInputControllerComponent*> */ __um(CameraInputControllerComponent); // 0x27A8   (0x0008)  
...
{ 
	SDK_UNDEFINED(80,12812) /* TMap<FGameplayTag, UDelMarCosmeticItemDefinition*> */ __um(Items);                  // 0x0000   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(8,12813) /* TWeakObjectPtr<UPrimitiveComponent*> */ __um(Component);                             // 0x0064   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12814) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(RaceManager);                            // 0x2124   (0x0008)  
	...
	SDK_UNDEFINED(8,12815) /* TWeakObjectPtr<UDelMarRaceConfigComponent*> */ __um(ActiveRaceConfig);               // 0x2228   (0x0008)  
	SDK_UNDEFINED(8,12816) /* TWeakObjectPtr<UDelMarTimeManagerComponent*> */ __um(RaceTimeManager);               // 0x2230   (0x0008)  
	SDK_UNDEFINED(8,12817) /* TWeakObjectPtr<UDelMarGlobalInputDisabler*> */ __um(GlobalInputDisabler);            // 0x2238   (0x0008)  
	unsigned char                                      UnknownData07_5[0x10];                                      // 0x2240   (0x0010)  MISSED
	SDK_UNDEFINED(16,12818) /* FMulticastInlineDelegate */ __um(OnVehicleWheelsLeftGround);                        // 0x2250   (0x0010)  
	SDK_UNDEFINED(16,12819) /* FMulticastInlineDelegate */ __um(OnSpeedometerSpeedChanged);                        // 0x2260   (0x0010)  
	...
	SDK_UNDEFINED(16,12820) /* FMulticastInlineDelegate */ __um(OnBonusSpeedActivated);                            // 0x22C0   (0x0010)  
	SDK_UNDEFINED(16,12821) /* FMulticastInlineDelegate */ __um(OnBonusSpeedDeactivated);                          // 0x22D0   (0x0010)  
	SDK_UNDEFINED(16,12822) /* FMulticastInlineDelegate */ __um(OnBonusSpeedChanged);                              // 0x22E0   (0x0010)  
	SDK_UNDEFINED(16,12823) /* FMulticastInlineDelegate */ __um(OnAnyWheelsOnGroundChanged);                       // 0x22F0   (0x0010)  
	SDK_UNDEFINED(16,12824) /* FMulticastInlineDelegate */ __um(OnWheelsOnGroundChanged);                          // 0x2300   (0x0010)  
	SDK_UNDEFINED(16,12825) /* FMulticastInlineDelegate */ __um(OnVehicleForwardStateChanged);                     // 0x2310   (0x0010)  
	unsigned char                                      UnknownData09_5[0xC0];                                      // 0x2320   (0x00C0)  MISSED
	SDK_UNDEFINED(16,12826) /* FMulticastInlineDelegate */ __um(OnDelMarVehicleHitWall);                           // 0x23E0   (0x0010)  
	SDK_UNDEFINED(16,12827) /* FMulticastInlineDelegate */ __um(OnDelMarVehicleHitVehicle);                        // 0x23F0   (0x0010)  
	SDK_UNDEFINED(16,12828) /* FMulticastInlineDelegate */ __um(OnDelMarVehicleHitByVehicle);                      // 0x2400   (0x0010)  
	SDK_UNDEFINED(16,12829) /* FMulticastInlineDelegate */ __um(OnVehicleLanded);                                  // 0x2410   (0x0010)  
	unsigned char                                      UnknownData10_5[0x10];                                      // 0x2420   (0x0010)  MISSED
	SDK_UNDEFINED(16,12830) /* FMulticastInlineDelegate */ __um(OnWorldBonusSpeedStackGained);                     // 0x2430   (0x0010)  
	SDK_UNDEFINED(16,12831) /* FMulticastInlineDelegate */ __um(OnWorldBonusSpeedStackLost);                       // 0x2440   (0x0010)  
	unsigned char                                      UnknownData11_5[0x70];                                      // 0x2450   (0x0070)  MISSED
	SDK_UNDEFINED(16,12832) /* FMulticastInlineDelegate */ __um(OnVehicleStartedSkydiving);                        // 0x24C0   (0x0010)  
	SDK_UNDEFINED(16,12833) /* FMulticastInlineDelegate */ __um(OnVehicleStoppedSkydiving);                        // 0x24D0   (0x0010)  
	unsigned char                                      UnknownData12_5[0x8];                                       // 0x24E0   (0x0008)  MISSED
	SDK_UNDEFINED(16,12834) /* FMulticastInlineDelegate */ __um(OnDriftActivated);                                 // 0x24E8   (0x0010)  
	SDK_UNDEFINED(16,12835) /* FMulticastInlineDelegate */ __um(OnDriftDeactivated);                               // 0x24F8   (0x0010)  
	SDK_UNDEFINED(16,12836) /* FMulticastInlineDelegate */ __um(OnDriftSlipAngleRatioChanged);                     // 0x2508   (0x0010)  
	SDK_UNDEFINED(16,12837) /* FMulticastInlineDelegate */ __um(OnDriftKickActivated);                             // 0x2518   (0x0010)  
	SDK_UNDEFINED(16,12838) /* FMulticastInlineDelegate */ __um(OnDriftKickDeactivated);                           // 0x2528   (0x0010)  
	SDK_UNDEFINED(16,12839) /* FMulticastInlineDelegate */ __um(OnDriftControlChanged);                            // 0x2538   (0x0010)  
	SDK_UNDEFINED(16,12840) /* FMulticastInlineDelegate */ __um(OnDriftDurationChanged);                           // 0x2548   (0x0010)  
	unsigned char                                      UnknownData13_5[0x40];                                      // 0x2558   (0x0040)  MISSED
	SDK_UNDEFINED(16,12841) /* FMulticastInlineDelegate */ __um(OnEnteredDriftBoostRange);                         // 0x2598   (0x0010)  
	SDK_UNDEFINED(16,12842) /* FMulticastInlineDelegate */ __um(OnExitedDriftBoostRange);                          // 0x25A8   (0x0010)  
	SDK_UNDEFINED(16,12843) /* FMulticastInlineDelegate */ __um(OnStartedLosingAppliedDriftBoost);                 // 0x25B8   (0x0010)  
	SDK_UNDEFINED(16,12844) /* FMulticastInlineDelegate */ __um(OnDriftBoostActivated);                            // 0x25C8   (0x0010)  
	SDK_UNDEFINED(16,12845) /* FMulticastInlineDelegate */ __um(OnDriftBoostDeactivated);                          // 0x25D8   (0x0010)  
	SDK_UNDEFINED(16,12846) /* FMulticastInlineDelegate */ __um(OnMaxPotentialReached);                            // 0x25E8   (0x0010)  
	SDK_UNDEFINED(16,12847) /* FMulticastInlineDelegate */ __um(OnMaxPotentialLost);                               // 0x25F8   (0x0010)  
	SDK_UNDEFINED(16,12848) /* FMulticastInlineDelegate */ __um(OnAllPotentialLost);                               // 0x2608   (0x0010)  
	SDK_UNDEFINED(16,12849) /* FMulticastInlineDelegate */ __um(OnEarnedDriftBoost);                               // 0x2618   (0x0010)  
	SDK_UNDEFINED(16,12850) /* FMulticastInlineDelegate */ __um(OnPotentialDriftBoostChanged);                     // 0x2628   (0x0010)  
	unsigned char                                      UnknownData14_5[0x38];                                      // 0x2638   (0x0038)  MISSED
	SDK_UNDEFINED(16,12851) /* FMulticastInlineDelegate */ __um(OnDraftActivated);                                 // 0x2670   (0x0010)  
	SDK_UNDEFINED(16,12852) /* FMulticastInlineDelegate */ __um(OnDraftDeactivated);                               // 0x2680   (0x0010)  
	SDK_UNDEFINED(16,12853) /* FMulticastInlineDelegate */ __um(OnDraftStateChanged);                              // 0x2690   (0x0010)  
	SDK_UNDEFINED(16,12854) /* FMulticastInlineDelegate */ __um(OnReachedMaxBonusSpeed);                           // 0x26A0   (0x0010)  
	...
	SDK_UNDEFINED(16,12855) /* FMulticastInlineDelegate */ __um(OnStartlineBoostActivated);                        // 0x2738   (0x0010)  
	SDK_UNDEFINED(16,12856) /* FMulticastInlineDelegate */ __um(OnStartlineBoostDeactivated);                      // 0x2748   (0x0010)  
	SDK_UNDEFINED(16,12857) /* FMulticastInlineDelegate */ __um(OnStartlineBoostFailed);                           // 0x2758   (0x0010)  
	FDelMarStartlineBoostData                          StartlineBoostData;                                         // 0x2768   (0x0010)  
	unsigned char                                      UnknownData17_5[0x20];                                      // 0x2778   (0x0020)  MISSED
	SDK_UNDEFINED(16,12858) /* FMulticastInlineDelegate */ __um(OnStrafeActivated);                                // 0x2798   (0x0010)  
	SDK_UNDEFINED(16,12859) /* FMulticastInlineDelegate */ __um(OnStrafeDeactivated);                              // 0x27A8   (0x0010)  
	SDK_UNDEFINED(16,12860) /* FMulticastInlineDelegate */ __um(OnStrafeCooldownChanged);                          // 0x27B8   (0x0010)  
	SDK_UNDEFINED(16,12861) /* FMulticastInlineDelegate */ __um(OnStrafeUsabilityChanged);                         // 0x27C8   (0x0010)  
	SDK_UNDEFINED(16,12862) /* FMulticastInlineDelegate */ __um(OnStrafeDisabledChanged);                          // 0x27D8   (0x0010)  
	unsigned char                                      UnknownData18_5[0x20];                                      // 0x27E8   (0x0020)  MISSED
	SDK_UNDEFINED(16,12863) /* FMulticastInlineDelegate */ __um(OnTurboActivated);                                 // 0x2808   (0x0010)  
	SDK_UNDEFINED(16,12864) /* FMulticastInlineDelegate */ __um(OnTurboDeactivated);                               // 0x2818   (0x0010)  
	SDK_UNDEFINED(16,12865) /* FMulticastInlineDelegate */ __um(OnTurboChargesUpdated);                            // 0x2828   (0x0010)  
	SDK_UNDEFINED(16,12866) /* FMulticastInlineDelegate */ __um(OnTurboBonusZoneStateChanged);                     // 0x2838   (0x0010)  
	SDK_UNDEFINED(16,12867) /* FMulticastInlineDelegate */ __um(OnTurboChargeUsed);                                // 0x2848   (0x0010)  
	unsigned char                                      UnknownData19_5[0x38];                                      // 0x2858   (0x0038)  MISSED
	SDK_UNDEFINED(16,12868) /* FMulticastInlineDelegate */ __um(OnKickflipActivated);                              // 0x2890   (0x0010)  
	SDK_UNDEFINED(16,12869) /* FMulticastInlineDelegate */ __um(OnKickflipDeactivated);                            // 0x28A0   (0x0010)  
	SDK_UNDEFINED(16,12870) /* FMulticastInlineDelegate */ __um(OnKickflipSuctionActivated);                       // 0x28B0   (0x0010)  
	SDK_UNDEFINED(16,12871) /* FMulticastInlineDelegate */ __um(OnKickflipSuctionDeactivated);                     // 0x28C0   (0x0010)  
	SDK_UNDEFINED(16,12872) /* FMulticastInlineDelegate */ __um(OnKickflipDistanceToSuctionSurfaceChanged);        // 0x28D0   (0x0010)  
	SDK_UNDEFINED(16,12873) /* FMulticastInlineDelegate */ __um(OnKickflipDurationChanged);                        // 0x28E0   (0x0010)  
	SDK_UNDEFINED(16,12874) /* FMulticastInlineDelegate */ __um(OnKickflipActivationChargesChanged);               // 0x28F0   (0x0010)  
	unsigned char                                      UnknownData20_5[0x88];                                      // 0x2900   (0x0088)  MISSED
	SDK_UNDEFINED(16,12875) /* FMulticastInlineDelegate */ __um(OnReattachmentActivated);                          // 0x2988   (0x0010)  
	SDK_UNDEFINED(16,12876) /* FMulticastInlineDelegate */ __um(OnReattachmentDeactivated);                        // 0x2998   (0x0010)  
	FVector                                            ForcedReattachmentDirection;                                // 0x29A8   (0x0018)  
	unsigned char                                      UnknownData21_5[0x28];                                      // 0x29C0   (0x0028)  MISSED
	SDK_UNDEFINED(16,12877) /* FMulticastInlineDelegate */ __um(OnUnderthrustActivated);                           // 0x29E8   (0x0010)  
	SDK_UNDEFINED(16,12878) /* FMulticastInlineDelegate */ __um(OnUnderthrustDeactivated);                         // 0x29F8   (0x0010)  
	SDK_UNDEFINED(16,12879) /* FMulticastInlineDelegate */ __um(OnUnderthrustPercentChanged);                      // 0x2A08   (0x0010)  
	unsigned char                                      UnknownData22_5[0x18];                                      // 0x2A18   (0x0018)  MISSED
	SDK_UNDEFINED(16,12880) /* FMulticastInlineDelegate */ __um(OnJumpActivated);                                  // 0x2A30   (0x0010)  
	SDK_UNDEFINED(16,12881) /* FMulticastInlineDelegate */ __um(OnJumpDeactivated);                                // 0x2A40   (0x0010)  
	...
	SDK_UNDEFINED(16,12882) /* FMulticastInlineDelegate */ __um(OnVehicleDemolished);                              // 0x2A60   (0x0010)  
	SDK_UNDEFINED(16,12883) /* FMulticastInlineDelegate */ __um(OnDemolishPressDurationUpdated);                   // 0x2A70   (0x0010)  
	unsigned char                                      UnknownData25_5[0x18];                                      // 0x2A80   (0x0018)  MISSED
	SDK_UNDEFINED(16,12884) /* FMulticastInlineDelegate */ __um(OnHazardHit);                                      // 0x2A98   (0x0010)  
	SDK_UNDEFINED(16,12885) /* FMulticastInlineDelegate */ __um(OnInvulnerabilityActivated);                       // 0x2AA8   (0x0010)  
	SDK_UNDEFINED(16,12886) /* FMulticastInlineDelegate */ __um(OnInvulnerabilityDeactivated);                     // 0x2AB8   (0x0010)  
	...
	SDK_UNDEFINED(16,12887) /* FMulticastInlineDelegate */ __um(OnDelMarVehicleSpawned);                           // 0x2AE0   (0x0010)  
	bool                                               bAllowExitingVehicle;                                       // 0x2AF0   (0x0001)  
	unsigned char                                      UnknownData27_5[0x7];                                       // 0x2AF1   (0x0007)  MISSED
	SDK_UNDEFINED(16,12888) /* FMulticastInlineDelegate */ __um(OnVehicleTeleportEntered);                         // 0x2AF8   (0x0010)  
	SDK_UNDEFINED(16,12889) /* FMulticastInlineDelegate */ __um(OnVehicleTeleportExit);                            // 0x2B08   (0x0010)  
	SDK_UNDEFINED(16,12890) /* FMulticastInlineDelegate */ __um(OnVehicleAppliedTeleportRotation);                 // 0x2B18   (0x0010)  
	SDK_UNDEFINED(16,12891) /* FMulticastInlineDelegate */ __um(OnAirFreestyleActivated);                          // 0x2B28   (0x0010)  
	SDK_UNDEFINED(16,12892) /* FMulticastInlineDelegate */ __um(OnAirFreestyleDeactivated);                        // 0x2B38   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(8,12893) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedVehicle);                              // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12894) /* TWeakObjectPtr<UAbilitySystemComponent*> */ __um(CachedASC);                         // 0x00A8   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(32,12895) /* TWeakObjectPtr<UAthenaAISettings*> */ __um(AISettings);                             // 0x0028   (0x0020)  
};
...
public:
	...
	SDK_UNDEFINED(16,12896) /* FMulticastInlineDelegate */ __um(OnBigAirStarted);                                  // 0x0350   (0x0010)  
	SDK_UNDEFINED(16,12897) /* FMulticastInlineDelegate */ __um(OnBigAirStopped);                                  // 0x0360   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,12898) /* FMulticastInlineDelegate */ __um(OnCheckpointTirggeredEvent);                       // 0x0BD8   (0x0010)  
	...
	SDK_UNDEFINED(80,12899) /* TSet<TWeakObjectPtr<ADelMarCheckpoint*>> */ __um(NextCheckpoints);                  // 0x0C08   (0x0050)  
	SDK_UNDEFINED(80,12900) /* TSet<TWeakObjectPtr<ADelMarCheckpoint*>> */ __um(PreviousCheckpoints);              // 0x0C58   (0x0050)  
	...
	SDK_UNDEFINED(8,12901) /* TWeakObjectPtr<ADelMarCheckpoint*> */ __um(CheckpointToTeleportTo);                  // 0x0CBC   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(16,12902) /* TArray<FString> */      __um(SafePlayerNames);                                      // 0x0028   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,12903) /* TMap<FGameplayTag, UNiagaraSystem*> */ __um(ParticleClassMap);                      // 0x00A8   (0x0050)  
	...
	SDK_UNDEFINED(80,12904) /* TMap<FGameplayTag, UNiagaraComponent*> */ __um(ParticleComponentMap);               // 0x0178   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(16,12905) /* FMulticastInlineDelegate */ __um(OnCurrentStateChanged);                            // 0x0290   (0x0010)  
	SDK_UNDEFINED(16,12906) /* FMulticastInlineDelegate */ __um(OnEnabledChanged);                                 // 0x02A0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,12907) /* TScriptInterface<Class> */ __um(Vehicle);                                           // 0x02A8   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,12908) /* TArray<TWeakObjectPtr<UClass*>> */ __um(CosmeticActorClasses);                      // 0x03C0   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(16,12909) /* FString */              __um(VariableName);                                         // 0x0340   (0x0010)  
	SDK_UNDEFINED(16,12910) /* FString */              __um(Value);                                                // 0x0350   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(80,12911) /* TMap<UPhysicalMaterial*, FPhysicalMaterialAttributes_X> */ __um(MaterialAttributesMap); // 0x0030   (0x0050)  
};
...
{ 
public:
	SDK_UNDEFINED(8,12912) /* TWeakObjectPtr<UDelMarVehicleManager*> */ __um(VehicleManager);                      // 0x00A0   (0x0008)  
};
...
public:
	...
	SDK_UNDEFINED(8,12913) /* TWeakObjectPtr<UEnhancedInputComponent*> */ __um(InputComponent);                    // 0x00D8   (0x0008)  
	SDK_UNDEFINED(8,12914) /* TWeakObjectPtr<UFortClientSettingsRecord*> */ __um(FortSettings);                    // 0x00E0   (0x0008)  
...
{ 
	SDK_UNDEFINED(24,12915) /* FText */                __um(KBMText);                                              // 0x0000   (0x0018)  
	SDK_UNDEFINED(24,12916) /* FText */                __um(GamepadText);                                          // 0x0018   (0x0018)  
	SDK_UNDEFINED(24,12917) /* FText */                __um(TouchText);                                            // 0x0030   (0x0018)  
...
public:
	...
	SDK_UNDEFINED(80,12918) /* TMap<FGameplayTag, FDelMarEvent_SetTutorialHint> */ __um(DemolishedByHints);        // 0x0100   (0x0050)  
	FDelMarEvent_SetTutorialHint                       SlowerTerrainHint;                                          // 0x0150   (0x0060)  
	SDK_UNDEFINED(8,12919) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(Vehicle);                                    // 0x01B0   (0x0008)  
	SDK_UNDEFINED(8,12920) /* TWeakObjectPtr<APlayerController*> */ __um(CachedPlayerController);                  // 0x01B8   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(8,12921) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12922) /* TWeakObjectPtr<UDelMarCheckpointManagerComponent*> */ __um(CachedCheckpointManager); // 0x00A8   (0x0008)  
	SDK_UNDEFINED(8,12923) /* TWeakObjectPtr<AFortPlayerState*> */ __um(ViewTargetPlayerState);                    // 0x00B0   (0x0008)  
	SDK_UNDEFINED(80,12924) /* TSet<TWeakObjectPtr<ADelMarCheckpoint*>> */ __um(CurrentlyActiveCheckpoints);       // 0x00B8   (0x0050)  
...
public:
	unsigned char                                      UnknownData00_3[0x18];                                      // 0x00A0   (0x0018)  MISSED
	SDK_UNDEFINED(80,12925) /* TSet<int32_t> */        __um(VisitedCheckpoints);                                   // 0x00B8   (0x0050)  
	SDK_UNDEFINED(80,12926) /* TSet<TWeakObjectPtr<ADelMarCheckpoint*>> */ __um(VisitedCheckpoints_ParallelPath);  // 0x0108   (0x0050)  
	...
	SDK_UNDEFINED(8,12927) /* TWeakObjectPtr<ADelMarCheckpoint*> */ __um(MostRecentlyVisitedCheckpoint);           // 0x01A0   (0x0008)  
	SDK_UNDEFINED(8,12928) /* TWeakObjectPtr<UDelMarCheckpointManagerComponent*> */ __um(CachedCheckpointManager); // 0x01A8   (0x0008)  
	SDK_UNDEFINED(8,12929) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x01B0   (0x0008)  
	SDK_UNDEFINED(8,12930) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedDelMarVehicle);                        // 0x01B8   (0x0008)  
	SDK_UNDEFINED(8,12931) /* TWeakObjectPtr<UDelMarPositionalTrackerComponent*> */ __um(CachedPositionalTracker); // 0x01C0   (0x0008)  
	SDK_UNDEFINED(8,12932) /* TWeakObjectPtr<UDelMarTrackPositionComponent*> */ __um(CachedLapTracker);            // 0x01C8   (0x0008)  
	SDK_UNDEFINED(80,12933) /* TSet<TWeakObjectPtr<ADelMarCheckpoint*>> */ __um(CheckpointsVisitedThisLap);        // 0x01D0   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(80,12934) /* TMap<FGameplayTag, FDelMarInputMappingContextData> */ __um(InputMappingContextMap); // 0x00A0   (0x0050)  
	SDK_UNDEFINED(8,12935) /* TWeakObjectPtr<AFortPlayerController*> */ __um(CachedController);                    // 0x00F0   (0x0008)  
	SDK_UNDEFINED(8,12936) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedVehicle);                              // 0x00F8   (0x0008)  
	SDK_UNDEFINED(8,12937) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x0100   (0x0008)  
};
...
{ 
public:
	SDK_UNDEFINED(16,12938) /* FMulticastInlineDelegate */ __um(OnUseToggleOnExpandableHudWidgetChanged);          // 0x00A0   (0x0010)  
	SDK_UNDEFINED(16,12939) /* FMulticastInlineDelegate */ __um(OnUseIconOnlyPlayerNameplatesChanged);             // 0x00B0   (0x0010)  
	...
	SDK_UNDEFINED(8,12940) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedDelMarVehicle);                        // 0x00C8   (0x0008)  
	SDK_UNDEFINED(8,12941) /* TWeakObjectPtr<UFortClientSettingsRecord*> */ __um(FortSettings);                    // 0x00D0   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12942) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(RaceManager);                            // 0x00F8   (0x0008)  
	SDK_UNDEFINED(8,12943) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(DelMarVehicle);                              // 0x0100   (0x0008)  
	SDK_UNDEFINED(8,12944) /* TWeakObjectPtr<UDelMarCheckpointManagerComponent*> */ __um(CheckpointManager);       // 0x0108   (0x0008)  
	SDK_UNDEFINED(8,12945) /* TWeakObjectPtr<UDelMarPlayerRaceDataComponent*> */ __um(PlayerRaceData);             // 0x0110   (0x0008)  
	SDK_UNDEFINED(8,12946) /* TWeakObjectPtr<UDelMarRaceConfigComponent*> */ __um(RaceConfig);                     // 0x0118   (0x0008)  
	SDK_UNDEFINED(8,12947) /* TWeakObjectPtr<ADelMarTrack*> */ __um(LastActiveTrack);                              // 0x0120   (0x0008)  
	SDK_UNDEFINED(8,12948) /* TWeakObjectPtr<UDelMarTrackPositionComponent*> */ __um(TrackPosition);               // 0x0128   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12949) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(DelMarVehicle);                              // 0x00A4   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12950) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedDelMarVehicle);                        // 0x00B4   (0x0008)  
	SDK_UNDEFINED(8,12951) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00BC   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12952) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x010C   (0x0008)  
	SDK_UNDEFINED(8,12953) /* TWeakObjectPtr<UDelMarRespawnManagerComponent*> */ __um(CachedRespawnManager);       // 0x0114   (0x0008)  
	SDK_UNDEFINED(8,12954) /* TWeakObjectPtr<AFortPlayerState*> */ __um(PlayerState);                              // 0x011C   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12955) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(RaceManager);                            // 0x0108   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(8,12956) /* TWeakObjectPtr<AFortPlayerState*> */ __um(PlayerState);                              // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12957) /* TWeakObjectPtr<ADelMarTutorialRaceManager*> */ __um(TutorialRaceManager);            // 0x00A8   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12958) /* TWeakObjectPtr<UDelMarLevelDataAsset*> */ __um(CurrentLevelData);                    // 0x00D0   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12959) /* TWeakObjectPtr<UFortPlaylistAthena*> */ __um(MRSPlaylistData);                       // 0x0708   (0x0008)  
	...
	SDK_UNDEFINED(8,12960) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(ActiveRaceManager);                      // 0x071C   (0x0008)  
	SDK_UNDEFINED(8,12961) /* TWeakObjectPtr<UFortPlaylistAthena*> */ __um(PlaylistData);                          // 0x0724   (0x0008)  
	SDK_UNDEFINED(8,12962) /* TWeakObjectPtr<UDelMarLevelManagerComponent*> */ __um(LevelManager);                 // 0x072C   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12963) /* TWeakObjectPtr<UDelMarPlayerInputManagerComponent*> */ __um(InputManager);           // 0x00E0   (0x0008)  
	SDK_UNDEFINED(8,12964) /* TWeakObjectPtr<UEnhancedInputComponent*> */ __um(InputComponent);                    // 0x00E8   (0x0008)  
	SDK_UNDEFINED(8,12965) /* TWeakObjectPtr<UDelMarPositionalTrackerComponent*> */ __um(PositionTracker);         // 0x00F0   (0x0008)  
	SDK_UNDEFINED(8,12966) /* TWeakObjectPtr<AFortPlayerState*> */ __um(CurrentViewTarget);                        // 0x00F8   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12967) /* TWeakObjectPtr<ADelMarCheckpoint*> */ __um(StartingLineCheckpoint);                  // 0x00A4   (0x0008)  
	SDK_UNDEFINED(8,12968) /* TWeakObjectPtr<ADelMarCheckpoint*> */ __um(FinishLineCheckpoint);                    // 0x00AC   (0x0008)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x00B4   (0x0004)  MISSED
	SDK_UNDEFINED(80,12969) /* TSet<TWeakObjectPtr<ADelMarCheckpoint*>> */ __um(LevelCheckpoints);                 // 0x00B8   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(80,12970) /* TSet<AFortPlayerState*> */ __um(PlayersGivenMMR);                                   // 0x00A0   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(8,12971) /* TWeakObjectPtr<AFortPlayerState*> */ __um(PlayerState);                              // 0x0000   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(80,12972) /* TMap<AFortPlayerState*, FDelMarPositionValue> */ __um(SplinePositions);             // 0x00D8   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(32,12973) /* TWeakObjectPtr<UClass*> */ __um(DefaultVehicleClass);                               // 0x00C0   (0x0020)  
...
{ 
	SDK_UNDEFINED(16,12974) /* TArray<TWeakObjectPtr<AFortPlayerState*>> */ __um(ReadyPlayers);                    // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,12975) /* TArray<TWeakObjectPtr<AFortPlayerState*>> */ __um(UnreadyPlayers);                  // 0x0010   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(8,12976) /* TWeakObjectPtr<UDelMarCheckpointManagerComponent*> */ __um(CachedCheckpointManager); // 0x00B8   (0x0008)  
	SDK_UNDEFINED(8,12977) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00C0   (0x0008)  
	SDK_UNDEFINED(8,12978) /* TWeakObjectPtr<ADelMarPlayerStart*> */ __um(CachedChallengeStartSpawnPoint);         // 0x00C8   (0x0008)  
	SDK_UNDEFINED(16,12979) /* TArray<TWeakObjectPtr<AController*>> */ __um(RespawnRetryQueue);                    // 0x00D0   (0x0010)  
	SDK_UNDEFINED(80,12980) /* TMap<TWeakObjectPtr<AFortPlayerState*>, TWeakObjectPtr<ADelMarVehicle*>> */ __um(LastSpawnedVehicleMap); // 0x00E0   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(80,12981) /* TSet<TWeakObjectPtr<AFortPlayerState*>> */ __um(ReadyPlayers);                      // 0x0040   (0x0050)  
	SDK_UNDEFINED(8,12982) /* TWeakObjectPtr<ADelMarPlayspace*> */ __um(CachedPlayspace);                          // 0x0090   (0x0008)  
	SDK_UNDEFINED(8,12983) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x0098   (0x0008)  
	unsigned char                                      UnknownData01_5[0x30];                                      // 0x00A0   (0x0030)  MISSED
	SDK_UNDEFINED(16,12984) /* FString */              __um(EliminationList);                                      // 0x00D0   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(8,12985) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(RaceManager);                            // 0x0030   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12986) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(RaceManager);                            // 0x0034   (0x0008)  
	FDelMarEvent_LoadedPlayerStates                    LoadedPlayerStates;                                         // 0x003C   (0x0008)  
	SDK_UNDEFINED(8,12987) /* TWeakObjectPtr<AFortPartyBeaconHost*> */ __um(FortPartyBeacon);                      // 0x0044   (0x0008)  
...
{ 
	...
	SDK_UNDEFINED(8,12988) /* TWeakObjectPtr<UCameraShakeBase*> */ __um(CameraShakeInstance);                      // 0x0008   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(80,12989) /* TMap<EBrelmarCameraShake, float> */ __um(ShakeIntensitySettingMap);                 // 0x00A0   (0x0050)  
	...
	SDK_UNDEFINED(16,12990) /* TScriptInterface<Class> */ __um(Vehicle);                                           // 0x0550   (0x0010)  
	SDK_UNDEFINED(8,12991) /* TWeakObjectPtr<AFortPlayerController*> */ __um(CachedPlayerController);              // 0x0560   (0x0008)  
...
{ 
	...
	SDK_UNDEFINED(1,12992) /* TEnumAsByte<ECollisionChannel> */ __um(TrackTraceChannel);                           // 0x0208   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(1,12993) /* TEnumAsByte<ECollisionChannel> */ __um(LandingCollisionChannel);                     // 0x0089   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(1,12994) /* TEnumAsByte<ECollisionChannel> */ __um(LineOfSightChannel);                          // 0x0010   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x0011   (0x0003)  MISSED
...
{ 
	...
	SDK_UNDEFINED(1,12995) /* TEnumAsByte<ECollisionChannel> */ __um(SuctionChannel);                              // 0x013C   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(1,12996) /* TEnumAsByte<ECollisionChannel> */ __um(ReattachmentChannel);                         // 0x0098   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(1,12997) /* TEnumAsByte<EDelMarFloatOperation> */ __um(Operation);                               // 0x000C   (0x0001)  
	SDK_UNDEFINED(1,12998) /* TEnumAsByte<EDelMarModifierStackingPolicy> */ __um(StackingPolicy);                  // 0x000D   (0x0001)  
...
{ 
public:
	SDK_UNDEFINED(16,12999) /* FMulticastInlineDelegate */ __um(OnCosmeticActorSpawned);                           // 0x00A0   (0x0010)  
	SDK_UNDEFINED(16,13000) /* FMulticastInlineDelegate */ __um(OnAllCosmeticActorsSpawned);                       // 0x00B0   (0x0010)  
	SDK_UNDEFINED(16,13001) /* TArray<TWeakObjectPtr<UClass*>> */ __um(StaticCosmeticActorClasses);                // 0x00C0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,13002) /* TScriptInterface<Class> */ __um(Vehicle);                                           // 0x03D0   (0x0010)  
	SDK_UNDEFINED(8,13003) /* TWeakObjectPtr<APlayerController*> */ __um(CachedPlayerController);                  // 0x03E0   (0x0008)  
	SDK_UNDEFINED(8,13004) /* TWeakObjectPtr<UForceFeedbackEffect*> */ __um(CurrentOversteerForceFeedbackEffect);  // 0x03E8   (0x0008)  
...
{ 
	SDK_UNDEFINED(32,13005) /* TWeakObjectPtr<UCosmeticLoadoutSlotTemplate*> */ __um(SlotTemplate);                // 0x0000   (0x0020)  
	SDK_UNDEFINED(32,13006) /* TWeakObjectPtr<UObject*> */ __um(EquippedItemDefinitionObject);                     // 0x0020   (0x0020)  
};
...
{ 
	SDK_UNDEFINED(32,13007) /* TWeakObjectPtr<UObject*> */ __um(EquippedItemDefinitionObject);                     // 0x0008   (0x0020)  
...
{ 
	SDK_UNDEFINED(80,13008) /* TMap<TWeakObjectPtr<AActor*>, UDriveHazardInfo*> */ __um(DriveHazardInfoMap);       // 0x0000   (0x0050)  
...
{ 
	SDK_UNDEFINED(8,13010) /* TWeakObjectPtr<ADelMarCheckpoint*> */ __um(CurrentCheckPoint);                       // 0x0000   (0x0008)  
};
...
{ 
	SDK_UNDEFINED(8,13011) /* TWeakObjectPtr<ADelMarCheckpoint*> */ __um(CheckpointEntered);                       // 0x0000   (0x0008)  
...
{ 
	SDK_UNDEFINED(8,13012) /* TWeakObjectPtr<ADelMarCheckpoint*> */ __um(CheckpointExited);                        // 0x0000   (0x0008)  
};
...
{ 
	...
	SDK_UNDEFINED(8,13013) /* TWeakObjectPtr<ADelMarCheckpoint*> */ __um(CompletedCheckpoint);                     // 0x0008   (0x0008)  
	SDK_UNDEFINED(8,13014) /* TWeakObjectPtr<ADelMarCheckpoint*> */ __um(CurrentCheckPoint);                       // 0x0010   (0x0008)  
...
{ 
	SDK_UNDEFINED(8,13015) /* TWeakObjectPtr<AFortPlayerState*> */ __um(Player);                                   // 0x0000   (0x0008)  
...
{ 
	...
	SDK_UNDEFINED(16,13016) /* TArray<TWeakObjectPtr<UDelMarCosmeticItemDefinition*>> */ __um(RequiredCosmetics);  // 0x0180   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(24,13017) /* FText */                __um(KBMText);                                              // 0x0000   (0x0018)  
	SDK_UNDEFINED(24,13018) /* FText */                __um(GamepadText);                                          // 0x0018   (0x0018)  
	SDK_UNDEFINED(24,13019) /* FText */                __um(TouchText);                                            // 0x0030   (0x0018)  
};
...
{ 
	SDK_UNDEFINED(16,13020) /* FString */              __um(RankType);                                             // 0x0000   (0x0010)  
