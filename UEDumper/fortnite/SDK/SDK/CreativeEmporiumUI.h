...
{ 
public:
	SDK_UNDEFINED(16,12628) /* FMulticastInlineDelegate */ __um(OnFilterEnabled);                                  // 0x1490   (0x0010)  
	SDK_UNDEFINED(16,12629) /* FMulticastInlineDelegate */ __um(OnFilterSelected);                                 // 0x14A0   (0x0010)  
	SDK_UNDEFINED(16,12630) /* FMulticastInlineDelegate */ __um(OnWidgetDestroyed);                                // 0x14B0   (0x0010)  
	...
	SDK_UNDEFINED(24,12631) /* FText */                __um(ButtonText);                                           // 0x14D8   (0x0018)  
...
{ 
	SDK_UNDEFINED(24,12632) /* FText */                __um(Text);                                                 // 0x0000   (0x0018)  
...
{ 
	...
	SDK_UNDEFINED(24,12633) /* FText */                __um(TextRoot);                                             // 0x0008   (0x0018)  
...
{ 
	FName                                              ID;                                                         // 0x0000   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0004   (0x0004)  MISSED
	SDK_UNDEFINED(24,12634) /* FText */                __um(Text);                                                 // 0x0008   (0x0018)  
...
{ 
public:
	SDK_UNDEFINED(16,12635) /* FMulticastInlineDelegate */ __um(OnFilterChanged);                                  // 0x02E8   (0x0010)  
	SDK_UNDEFINED(16,12636) /* FMulticastInlineDelegate */ __um(OnSortChanged);                                    // 0x02F8   (0x0010)  
	SDK_UNDEFINED(16,12637) /* FMulticastInlineDelegate */ __um(OnSubFilterToggled);                               // 0x0308   (0x0010)  
	SDK_UNDEFINED(16,12638) /* FMulticastInlineDelegate */ __um(OnFocusChanged);                                   // 0x0318   (0x0010)  
	SDK_UNDEFINED(16,12639) /* FMulticastInlineDelegate */ __um(OnCategoryActivated);                              // 0x0328   (0x0010)  
	SDK_UNDEFINED(16,12640) /* FMulticastInlineDelegate */ __um(OnCategoryFocused);                                // 0x0338   (0x0010)  
	SDK_UNDEFINED(16,12641) /* FMulticastInlineDelegate */ __um(OnUpdateCategoryCounts);                           // 0x0348   (0x0010)  
	class UClass*                                      FilterSectionHeaderWidgetClass;                             // 0x0358   (0x0008)  
	class UClass*                                      FilterCategoryHeaderWidgetClass;                            // 0x0360   (0x0008)  
	class UClass*                                      FilterHomeHeaderWidgetClass;                                // 0x0368   (0x0008)  
	class UClass*                                      FilterEntryWidgetClass;                                     // 0x0370   (0x0008)  
	TArray<FFortEmporiumSortEntry>                     SortEntries;                                                // 0x0378   (0x0010)  
	TArray<FFortEmporiumFilterEntry>                   FilterEntries;                                              // 0x0388   (0x0010)  
	TArray<FFortEmporiumPriceFilterEntry>              PriceFilterEntries;                                         // 0x0398   (0x0010)  
	TArray<FName>                                      LicenseFilterEntries;                                       // 0x03A8   (0x0010)  
	FName                                              DefaultCategoryFilter;                                      // 0x03B8   (0x0004)  
	unsigned char                                      UnknownData00_5[0x54];                                      // 0x03BC   (0x0054)  MISSED
	class UScrollBox*                                  ScrollBox_FilterScroll;                                     // 0x0410   (0x0008)  
	class UEmporiumBrowserFilterEntry*                 Button_All;                                                 // 0x0418   (0x0008)  
	class UCommonButtonBase*                           Button_SortAndFilter;                                       // 0x0420   (0x0008)  
	unsigned char                                      UnknownData01_5[0xB8];                                      // 0x0428   (0x00B8)  MISSED
	FDataTableRowHandle                                FocusSearchInputActionRow;                                  // 0x04E0   (0x0010)  
	FDataTableRowHandle                                ClearSearchInputActionRow;                                  // 0x04F0   (0x0010)  
	unsigned char                                      UnknownData02_6[0x8];                                       // 0x0500   (0x0008)  MISSED
...
{ 
public:
	SDK_UNDEFINED(16,12642) /* FMulticastInlineDelegate */ __um(OnCategoryActivated);                              // 0x02C0   (0x0010)  
	SDK_UNDEFINED(16,12643) /* FMulticastInlineDelegate */ __um(OnWidgetDestroyed);                                // 0x02D0   (0x0010)  
	SDK_UNDEFINED(16,12644) /* FMulticastInlineDelegate */ __um(OnExpandCategory);                                 // 0x02E0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,12645) /* FMulticastInlineDelegate */ __um(OnItemThumbnailDownloaded);                        // 0x0330   (0x0010)  
	unsigned char                                      UnknownData01_5[0xE8];                                      // 0x0340   (0x00E8)  MISSED
	class UTexture2D*                                  ThumbnailTexture;                                           // 0x0428   (0x0008)  
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(16,12646) /* FString */              __um(Path);                                                 // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,12647) /* FString */              __um(Hash);                                                 // 0x0038   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(80,12648) /* TMap<FName, FText> */   __um(Map_CreativeBetaTagNames);                             // 0x0468   (0x0050)  
	...
	SDK_UNDEFINED(80,12649) /* TMap<FName, UFortCreativeContentBrowserTabPanelBase*> */ __um(TabMap);              // 0x0658   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(16,12650) /* FMulticastInlineDelegate */ __um(OnSourceItemCountChanged);                         // 0x0450   (0x0010)  
	SDK_UNDEFINED(16,12651) /* FMulticastInlineDelegate */ __um(OnItemClickedDelegate);                            // 0x0460   (0x0010)  
	SDK_UNDEFINED(16,12652) /* FMulticastInlineDelegate */ __um(OnItemDoubleClickedDelegate);                      // 0x0470   (0x0010)  
	...
	SDK_UNDEFINED(16,12653) /* FMulticastInlineDelegate */ __um(OnItemCountChanged);                               // 0x0660   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,12654) /* FString */              __um(ID);                                                   // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,12655) /* FString */              __um(Title);                                                // 0x0010   (0x0010)  
	SDK_UNDEFINED(16,12656) /* FString */              __um(NameSpace);                                            // 0x0020   (0x0010)  
	SDK_UNDEFINED(16,12657) /* FString */              __um(EntityType);                                           // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,12658) /* FString */              __um(ThumbnailURL);                                         // 0x0040   (0x0010)  
	float                                              Price;                                                      // 0x0050   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0054   (0x0004)  MISSED
	SDK_UNDEFINED(16,12659) /* FString */              __um(BaseCurrency);                                         // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,12660) /* FString */              __um(SketchfabUID);                                         // 0x0068   (0x0010)  
	...
	SDK_UNDEFINED(16,12661) /* FString */              __um(VersePath);                                            // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,12662) /* TArray<FString> */      __um(AssetIds);                                             // 0x00A0   (0x0010)  
	int32_t                                            FileSize;                                                   // 0x00B0   (0x0004)  
	unsigned char                                      UnknownData02_5[0x4];                                       // 0x00B4   (0x0004)  MISSED
	SDK_UNDEFINED(16,12663) /* FString */              __um(Description);                                          // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,12664) /* FString */              __um(Seller);                                               // 0x00C8   (0x0010)  
...
{ 
	FName                                              ID;                                                         // 0x0000   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0004   (0x0004)  MISSED
	SDK_UNDEFINED(16,12665) /* FString */              __um(Keyword);                                              // 0x0008   (0x0010)  
	SDK_UNDEFINED(24,12666) /* FText */                __um(Name);                                                 // 0x0018   (0x0018)  
	EFortEmporiumItemLicense                           License;                                                    // 0x0030   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0031   (0x0007)  MISSED
	SDK_UNDEFINED(16,12667) /* FString */              __um(URL);                                                  // 0x0038   (0x0010)  
};
