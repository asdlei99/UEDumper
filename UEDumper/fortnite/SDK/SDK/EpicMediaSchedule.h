...
{ 
	...
	SDK_UNDEFINED(16,13391) /* FString */              __um(VUID);                                                 // 0x0008   (0x0010)  
	int32_t                                            DurationSeconds;                                            // 0x0018   (0x0004)  
...
{ 
	SDK_UNDEFINED(16,13392) /* FString */              __um(IsoStartTime);                                         // 0x0000   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,13394) /* FString */              __um(VUID);                                                 // 0x0010   (0x0010)  
	class ULevelSequence*                              Sequence;                                                   // 0x0020   (0x0008)  
};
