...
{ 
	SDK_UNDEFINED(12,14011) /* FDelegateProperty */    __um(OnShieldChanged);                                      // 0x0000   (0x000C)  
	SDK_UNDEFINED(12,14012) /* FDelegateProperty */    __um(OnShieldedDamage);                                     // 0x000C   (0x000C)  
	SDK_UNDEFINED(12,14013) /* FDelegateProperty */    __um(OnShieldDestroyed);                                    // 0x0018   (0x000C)  
	SDK_UNDEFINED(12,14014) /* FDelegateProperty */    __um(OnDamageReceived);                                     // 0x0024   (0x000C)  
};
...
{ 
	SDK_UNDEFINED(12,14015) /* FDelegateProperty */    __um(OnHealthChanged);                                      // 0x0000   (0x000C)  
	SDK_UNDEFINED(12,14016) /* FDelegateProperty */    __um(OnDamageReceived);                                     // 0x000C   (0x000C)  
};
