...
public:
	...
	SDK_UNDEFINED(80,14597) /* TMap<FMassEntityHandle, FMassHitResult> */ __um(HitResults);                        // 0x0058   (0x0050)  
	SDK_UNDEFINED(80,14598) /* TMap<UActorComponent*, FMassEntityHandle> */ __um(ComponentToEntityMap);            // 0x00A8   (0x0050)  
	SDK_UNDEFINED(80,14599) /* TMap<FMassEntityHandle, UActorComponent*> */ __um(EntityToComponentMap);            // 0x00F8   (0x0050)  
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x2A8];                                     // 0x00D8   (0x02A8)  MISSED
...
{ 
	unsigned char                                      UnknownData00_2[0x8];                                       // 0x0020   (0x0008)  MISSED
...
{ 
	unsigned char                                      UnknownData00_2[0x10];                                      // 0x0020   (0x0010)  MISSED
...
{ 
	unsigned char                                      UnknownData00_1[0x6F];                                      // 0x0001   (0x006F)  MISSED
};
...
{ 
	unsigned char                                      UnknownData00_2[0x4];                                       // 0x0020   (0x0004)  MISSED
...
{ 
	unsigned char                                      UnknownData00_2[0x6];                                       // 0x0020   (0x0006)  MISSED
