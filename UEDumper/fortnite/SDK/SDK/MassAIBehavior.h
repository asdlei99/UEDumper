...
public:
	...
	SDK_UNDEFINED(80,14651) /* TMap<FMassEntityHandle, FMassHitResult> */ __um(HitResults);                        // 0x0058   (0x0050)  
	SDK_UNDEFINED(80,14652) /* TMap<UActorComponent*, FMassEntityHandle> */ __um(ComponentToEntityMap);            // 0x00A8   (0x0050)  
	SDK_UNDEFINED(80,14653) /* TMap<FMassEntityHandle, UActorComponent*> */ __um(EntityToComponentMap);            // 0x00F8   (0x0050)  


	/// Functions
	// Function /Script/MassAIBehavior.MassComponentHitSubsystem.OnHitCallback
	// void OnHitCallback(class UPrimitiveComponent* HitComp, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, FVector NormalImpulse, FHitResult& Hit); // [0xc0b5f20] Final|Native|Protected|HasOutParms|HasDefaults 
};
