...
public:
	...
	SDK_UNDEFINED(8,12193) /* TWeakObjectPtr<UFortControllerComponent_VictoryCrowns*> */ __um(BoundVictoryCrownsComponent); // 0x0070   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(16,12194) /* FMulticastInlineDelegate */ __um(OnVictoryCrownStatusChanged);                      // 0x00A8   (0x0010)  
	SDK_UNDEFINED(16,12195) /* FMulticastInlineDelegate */ __um(OnHasWonCrownInMatch);                             // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,12196) /* FMulticastInlineDelegate */ __um(OnHasWonRoyalRoyale);                              // 0x00C8   (0x0010)  
	unsigned char                                      UnknownData00_5[0x30];                                      // 0x00D8   (0x0030)  MISSED
	SDK_UNDEFINED(32,12197) /* TWeakObjectPtr<UFortWorldItemDefinition*> */ __um(CrownInventoryItemClass);         // 0x0108   (0x0020)  
	...
	SDK_UNDEFINED(32,12198) /* TWeakObjectPtr<UFortMontageItemDefinitionBase*> */ __um(RoyalRoyaleEmoteItemDefinition); // 0x0138   (0x0020)  
...
public:
	class UFortVictoryCrownAccountItemDefinition*      VictoryCrownAccountItemDefinition;                          // 0x0088   (0x0008)  
	SDK_UNDEFINED(16,12199) /* TArray<TWeakObjectPtr<UFortControllerComponent_VictoryCrowns*>> */ __um(CachedCrownComponents); // 0x0090   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(24,12200) /* FText */                __um(KillFeedFormat_Dropped);                               // 0x00B0   (0x0018)  
	SDK_UNDEFINED(24,12201) /* FText */                __um(KillFeedFormat_PickedUp);                              // 0x00C8   (0x0018)  
