...
{ 
	SDK_UNDEFINED(16,12563) /* FString */              __um(IsoStartTime);                                         // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,12564) /* FString */              __um(VUID);                                                 // 0x0010   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,12565) /* FString */              __um(VUID);                                                 // 0x0010   (0x0010)  
	int32_t                                            DurationSeconds;                                            // 0x0020   (0x0004)  
...
{ 
	...
	SDK_UNDEFINED(16,12566) /* FString */              __um(VUID);                                                 // 0x0008   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,12567) /* FString */              __um(SimpleSchedule);                                       // 0x0C58   (0x0010)  
	...
	// void TestControlVideoPlayer(FString VUID, FDateTime StartTime, TArray<AController*>& Players);                        // [0xb98ba2c] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/CRD_VideoSchedule.VideoScheduleDeviceBase.StopSchedule
	// void StopSchedule(class AController* InPlayer);                                                                       // [0xb98b9ac] Final|Native|Public|BlueprintCallable 
	// Function /Script/CRD_VideoSchedule.VideoScheduleDeviceBase.StartSchedule
	// void StartSchedule(class AController* InPlayer);                                                                      // [0xb98b8dc] Final|Native|Public|BlueprintCallable 
	// Function /Script/CRD_VideoSchedule.VideoScheduleDeviceBase.OnControlVideoPlayer
	// void OnControlVideoPlayer(FString VUID, FDateTime StartTime, TArray<AController*>& Players, class ULevelSequence* Sequence); // [0x3d1d968] Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
};
...
{ 
	...
	SDK_UNDEFINED(16,12568) /* FString */              __um(VUID);                                                 // 0x0010   (0x0010)  
	class ULevelSequence*                              Sequence;                                                   // 0x0020   (0x0008)  
};
