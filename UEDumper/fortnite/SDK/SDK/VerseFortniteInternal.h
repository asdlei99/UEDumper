...
public:
	...
	// void NotifyOfStateChange(FString& State, bool Active);                                                                // [0xa94b6ac] Final|Native|Public|HasOutParms 
};
...
public:
	...
	SDK_UNDEFINED(1,9288) /* TEnumAsByte<EPlayerSettingStateInternal> */ __um(Building);                           // 0x0080   (0x0001)  
	SDK_UNDEFINED(1,9289) /* TEnumAsByte<EPlayerSettingStateInternal> */ __um(BuildingOnWater);                    // 0x0081   (0x0001)  
	SDK_UNDEFINED(1,9290) /* TEnumAsByte<EPlayerSettingStateInternal> */ __um(Editing);                            // 0x0082   (0x0001)  
	SDK_UNDEFINED(1,9291) /* TEnumAsByte<EPlayerSettingStateInternal> */ __um(EditingHostile);                     // 0x0083   (0x0001)  
	SDK_UNDEFINED(1,9292) /* TEnumAsByte<EPlayerSettingStateInternal> */ __um(TrapPlacement);                      // 0x0084   (0x0001)  
	...
	// void OnRep_Settings();                                                                                                // [0xa94be6c] Final|Native|Private 
};
...
public:
	...
	// void HandlePlayerPawnPossessed(class APawn* Pawn);                                                                    // [0xa94b62c] Final|Native|Public  
	// Function /Script/VerseFortniteInternal.FortPlayspaceComponentHelper.HandlePlayerDied
	// void HandlePlayerDied(class AFortPlayerPawnAthena* FortPlayerPawnAthena);                                             // [0xa94b5ac] Final|Native|Public  
};
