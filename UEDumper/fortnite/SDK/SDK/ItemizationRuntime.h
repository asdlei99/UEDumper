...
{ 
	SDK_UNDEFINED(16,14252) /* FString */              __um(Attributes);                                           // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,14253) /* FString */              __um(InventoryName);                                        // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,14254) /* FString */              __um(InventoryCollectionName);                              // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,14255) /* FString */              __um(FortInventoryName);                                    // 0x0000   (0x0010)  
...
public:
	...
	// void ServerSetMonitoredActor(class AActor* ActorToMonitor);                                                           // [0x659771c] Final|Net|NetReliableNative|Event|Private|NetServer 
	// Function /Script/ItemizationRuntime.InventoryDebugMenu.ServerClose
	// void ServerClose();                                                                                                   // [0x18017a4] Final|Net|NetReliableNative|Event|Private|NetServer 
};
