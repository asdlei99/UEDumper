...
public:
	...
	SDK_UNDEFINED(32,13608) /* TWeakObjectPtr<UStaticMesh*> */ __um(ScalarStaticMesh);                             // 0x0748   (0x0020)  
	SDK_UNDEFINED(32,13609) /* TWeakObjectPtr<UStaticMesh*> */ __um(AudioStaticMesh);                              // 0x0768   (0x0020)  
	SDK_UNDEFINED(32,13610) /* TWeakObjectPtr<UStaticMesh*> */ __um(NoteStaticMesh);                               // 0x0788   (0x0020)  
	SDK_UNDEFINED(32,13611) /* TWeakObjectPtr<UStaticMesh*> */ __um(TextureStaticMesh);                            // 0x07A8   (0x0020)  
	SDK_UNDEFINED(32,13612) /* TWeakObjectPtr<UStaticMesh*> */ __um(MeshStaticMesh);                               // 0x07C8   (0x0020)  
	...
	SDK_UNDEFINED(8,13613) /* TWeakObjectPtr<UFMDeviceCableAnimatorBase*> */ __um(DeviceCableAnimator);            // 0x0838   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,13614) /* TWeakObjectPtr<UFMDeviceCablePortComponent*> */ __um(OwnerPort);                     // 0x0078   (0x0008)  
...
{ 
	SDK_UNDEFINED(8,13615) /* TWeakObjectPtr<UFMDeviceCablePortComponent*> */ __um(TerminalPort);                  // 0x0000   (0x0008)  
	SDK_UNDEFINED(8,13616) /* TWeakObjectPtr<AActor*> */ __um(TerminalActor);                                      // 0x0008   (0x0008)  
};
...
{ 
	SDK_UNDEFINED(8,13617) /* TWeakObjectPtr<UFMDeviceCablePortComponent*> */ __um(InputPort);                     // 0x0000   (0x0008)  
	SDK_UNDEFINED(8,13618) /* TWeakObjectPtr<UFMDeviceCablePortComponent*> */ __um(OutputPort);                    // 0x0008   (0x0008)  
	SDK_UNDEFINED(8,13619) /* TWeakObjectPtr<AActor*> */ __um(PassthroughActor);                                   // 0x0010   (0x0008)  
};
...
public:
	...
	SDK_UNDEFINED(16,13620) /* TArray<TWeakObjectPtr<UFMDeviceCablePortComponent*>> */ __um(BuildingCompositeArtifactFromPorts); // 0x0088   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,13621) /* FMulticastInlineDelegate */ __um(OnControllerCableConnected);                       // 0x00A0   (0x0010)  
	SDK_UNDEFINED(16,13622) /* FMulticastInlineDelegate */ __um(OnControllerCableDisconnected);                    // 0x00B0   (0x0010)  
	...
	SDK_UNDEFINED(8,13623) /* TWeakObjectPtr<AActor*> */ __um(LocalControllerPortActor);                           // 0x00E8   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(80,13624) /* TMap<EDeviceCablePortDataType, UClass*> */ __um(ConnectionClasses);                 // 0x00B0   (0x0050)  
	...
	SDK_UNDEFINED(80,13625) /* TMap<FGuid, TWeakObjectPtr<UFMDeviceCablePortComponent*>> */ __um(PortsInVolume);   // 0x0170   (0x0050)  
	SDK_UNDEFINED(80,13626) /* TMap<FGuid, FGuid> */   __um(OriginalGuidToDuplicatedGuidThisFrame);                // 0x01C0   (0x0050)  
	SDK_UNDEFINED(80,13627) /* TMap<TWeakObjectPtr<UObject*>, TWeakObjectPtr<UObject*>> */ __um(SourceObjectToDuplicatedObjectThisFrame); // 0x0210   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(16,13628) /* FMulticastInlineDelegate */ __um(OnCablePortSizeUpdated);                           // 0x05F8   (0x0010)  
	SDK_UNDEFINED(16,13629) /* FMulticastInlineDelegate */ __um(OnAnimatorCreated);                                // 0x0608   (0x0010)  
	SDK_UNDEFINED(16,13630) /* FMulticastInlineDelegate */ __um(OnConnected);                                      // 0x0618   (0x0010)  
	unsigned char                                      UnknownData01_5[0x20];                                      // 0x0628   (0x0020)  MISSED
	SDK_UNDEFINED(16,13631) /* FMulticastInlineDelegate */ __um(OnDisconnected);                                   // 0x0648   (0x0010)  
	SDK_UNDEFINED(16,13632) /* FMulticastInlineDelegate */ __um(OnConnectionStarted);                              // 0x0658   (0x0010)  
	SDK_UNDEFINED(16,13633) /* FMulticastInlineDelegate */ __um(OnConnectionEnded);                                // 0x0668   (0x0010)  
	SDK_UNDEFINED(16,13634) /* FMulticastInlineDelegate */ __um(OnPortArtifactUpdated);                            // 0x0678   (0x0010)  
	SDK_UNDEFINED(16,13635) /* FMulticastInlineDelegate */ __um(OnReceiveFloatProviders);                          // 0x0688   (0x0010)  
	SDK_UNDEFINED(16,13636) /* FMulticastInlineDelegate */ __um(OnDisconnectFloatProvider);                        // 0x0698   (0x0010)  
	class UClass*                                      DeviceCableManagerClass;                                    // 0x06A8   (0x0008)  
	SDK_UNDEFINED(32,13637) /* TWeakObjectPtr<UStaticMesh*> */ __um(OutputStaticMesh);                             // 0x06B0   (0x0020)  
	SDK_UNDEFINED(32,13638) /* TWeakObjectPtr<UStaticMesh*> */ __um(AudioInStaticMesh);                            // 0x06D0   (0x0020)  
	SDK_UNDEFINED(32,13639) /* TWeakObjectPtr<UStaticMesh*> */ __um(NoteInStaticMesh);                             // 0x06F0   (0x0020)  
	SDK_UNDEFINED(32,13640) /* TWeakObjectPtr<UStaticMesh*> */ __um(TextureInStaticMesh);                          // 0x0710   (0x0020)  
	SDK_UNDEFINED(32,13641) /* TWeakObjectPtr<UStaticMesh*> */ __um(MeshInStaticMesh);                             // 0x0730   (0x0020)  
	SDK_UNDEFINED(32,13642) /* TWeakObjectPtr<UStaticMesh*> */ __um(ScalarInStaticMesh);                           // 0x0750   (0x0020)  
	SDK_UNDEFINED(80,13643) /* TMap<EDeviceCablePortDataType, UClass*> */ __um(CableAnimatorClasses);              // 0x0770   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(16,13644) /* FString */              __um(AssociatedProperty);                                   // 0x08C0   (0x0010)  
	SDK_UNDEFINED(8,13645) /* TWeakObjectPtr<UObject*> */ __um(AssociatedObject);                                  // 0x08D0   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(16,13646) /* FMulticastInlineDelegate */ __um(OnWildcardDataTypeChanged);                        // 0x08B8   (0x0010)  
	SDK_UNDEFINED(16,13647) /* FMulticastInlineDelegate */ __um(OnWildcardPortSlotSetFromSave);                    // 0x08C8   (0x0010)  
...
{ 
	SDK_UNDEFINED(8,13648) /* TWeakObjectPtr<UFMDeviceCablePortComponent*> */ __um(Port);                          // 0x0000   (0x0008)  
