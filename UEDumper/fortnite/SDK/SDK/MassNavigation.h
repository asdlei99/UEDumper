...
{ 
	unsigned char                                      UnknownData00_1[0x247];                                     // 0x0001   (0x0247)  MISSED
};
...
{ 
	unsigned char                                      UnknownData00_1[0x4F];                                      // 0x0001   (0x004F)  MISSED
};
...
{ 
	unsigned char                                      UnknownData00_1[0x37];                                      // 0x0001   (0x0037)  MISSED
};
...
{ 
	unsigned char                                      UnknownData00_1[0x17];                                      // 0x0001   (0x0017)  MISSED
};
...
{ 
	unsigned char                                      UnknownData00_1[0x27];                                      // 0x0001   (0x0027)  MISSED
};
