...
{ 
public:
	SDK_UNDEFINED(16,14636) /* FMulticastInlineDelegate */ __um(OnLiveLinkUpdated);                                // 0x00A0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(32,14637) /* TWeakObjectPtr<ULiveLinkPreset*> */ __um(DefaultLiveLinkPreset);                    // 0x0040   (0x0020)  
...
{ 
	SDK_UNDEFINED(16,14638) /* FString */              __um(Name);                                                 // 0x0010   (0x0010)  
	SDK_UNDEFINED(16,14639) /* FString */              __um(MachineName);                                          // 0x0020   (0x0010)  
