...
{ 
	SDK_UNDEFINED(16,15444) /* FString */              __um(UserName);                                             // 0x0000   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,15445) /* FString */              __um(BuildDate);                                            // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,15446) /* FString */              __um(DeviceName);                                           // 0x0018   (0x0010)  
	FGuid                                              InstanceID;                                                 // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,15447) /* FString */              __um(InstanceName);                                         // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,15448) /* FString */              __um(PlatformName);                                         // 0x0048   (0x0010)  
	FGuid                                              SessionId;                                                  // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,15449) /* FString */              __um(SessionName);                                          // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,15450) /* FString */              __um(SessionOwner);                                         // 0x0078   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,15451) /* FString */              __um(Data);                                                 // 0x0008   (0x0010)  
