...
public:
	...
	SDK_UNDEFINED(24,13911) /* FText */                __um(RegularGiftingPolicy);                                 // 0x0800   (0x0018)  
	SDK_UNDEFINED(24,13912) /* FText */                __um(BattlePassGiftingPolicy);                              // 0x0818   (0x0018)  
	unsigned char                                      UnknownData02_5[0x60];                                      // 0x0830   (0x0060)  MISSED
	SDK_UNDEFINED(80,13913) /* TMap<UCommonButtonBase*, EFilterType> */ __um(FilterMap);                           // 0x0890   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(16,13914) /* TArray<TWeakObjectPtr<UFortGiftBoxItemDefinition*>> */ __um(GiftBoxes);             // 0x0428   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(32,13915) /* TWeakObjectPtr<UClass*> */ __um(GiftingScreenClass);                                // 0x0530   (0x0020)  
};
