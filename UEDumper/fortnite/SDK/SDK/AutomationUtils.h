...
public:
	...
	// void TakeGameplayAutomationScreenshot(FString ScreenshotName, float MaxGlobalError, float MaxLocalError, FString MapNameOverride); // [0x800e374] Final|Native|Static|Public|BlueprintCallable 
};
