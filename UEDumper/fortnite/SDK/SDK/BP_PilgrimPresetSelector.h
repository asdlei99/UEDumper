...
public:
	...
	class UPilgrimPresetSwitcher*                      As_Pilgrim_Preset_Switcher_Widget;                          // 0x0050   (0x0008)  


	/// Functions
	// Function /PilgrimCore/BP_PilgrimPresetSelector.BP_PilgrimPresetSelector_C.OnComplete_274EE33944C9AE07DF8BE0B56A5DE4BC
	// void OnComplete_274EE33944C9AE07DF8BE0B56A5DE4BC(class UUserWidget* UserWidget);                                      // [0x130d900] BlueprintCallable|BlueprintEvent 
	// Function /PilgrimCore/BP_PilgrimPresetSelector.BP_PilgrimPresetSelector_C.DialogResult_4F9481524E7A6435C967A0AEA571B86B
	// void DialogResult_4F9481524E7A6435C967A0AEA571B86B(EFortDialogResult Result, FName ResultName);                       // [0x130d900] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_PilgrimPresetSelector(int32_t EntryPoint);                                                   // [0x130d900] Final                
};
