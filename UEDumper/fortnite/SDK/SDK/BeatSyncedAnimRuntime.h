...
public:
	...
	SDK_UNDEFINED(8,11873) /* TWeakObjectPtr<UMusicClockComponent*> */ __um(WeakMusicClockPtr);                    // 0x00BC   (0x0008)  
	...
	SDK_UNDEFINED(16,11874) /* TArray<TWeakObjectPtr<UMontageBeatSyncComponent*>> */ __um(YoungerSiblings);        // 0x00E0   (0x0010)  
