...
public:
	...
	// void TakeGameplayAutomationScreenshot(FString ScreenshotName, float MaxGlobalError, float MaxLocalError, FString MapNameOverride); // [0x7fffae4] Final|Native|Static|Public|BlueprintCallable 
};
