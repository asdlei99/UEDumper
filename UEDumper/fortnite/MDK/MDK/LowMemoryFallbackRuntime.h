...
public:
	SMember(FString)                                   PluginName                                                  OFFSET(getStruct<T>, {0xC0, 16, 0, 0})
	CMember(TArray<FLowMemoryFallbackThreshold>)       Thresholds                                                  OFFSET(get<T>, {0xD0, 16, 0, 0})
	CMember(TArray<FLowMemoryFallbackThresholdState>)  ThresholdStates                                             OFFSET(get<T>, {0xE0, 16, 0, 0})
};
