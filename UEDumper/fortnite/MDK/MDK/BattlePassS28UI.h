...
public:
	...
	CMember(class UFortBattlePassTutorialTooltipS28*)  TutorialTooltip_BattleStars                                 OFFSET(get<T>, {0xC38, 8, 0, 0})
	CMember(class UFortBattlePassTutorialTooltipS28*)  TutorialTooltip_StylePoints                                 OFFSET(get<T>, {0xC40, 8, 0, 0})
