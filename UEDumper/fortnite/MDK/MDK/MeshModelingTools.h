...
public:
	...
	// void RegenerateExtraCorners();                                                                                           // [0xab9d988] Final|Native|Public  
};
...
public:
	...
	// void Poke();                                                                                                             // [0xab9d940] Final|Native|Public  
...
public:
	...
	// void PlanarProjection();                                                                                                 // [0xab9d928] Final|Native|Public  
};
...
public:
	...
	// void Collapse();                                                                                                         // [0xab9d770] Final|Native|Public  
};
...
public:
	...
	// void Done();                                                                                                             // [0xab9d710] Final|Native|Public  
};
...
public:
	...
	CMember(class UEditMeshPolygonsToolCancelAction*)  CancelAction                                                OFFSET(get<T>, {0x180, 8, 0, 0})
	CMember(class UEditMeshPolygonsToolAcceptCancelAction*) AcceptCancelAction                                     OFFSET(get<T>, {0x188, 8, 0, 0})
	CMember(class UPolyEditTopologyProperties*)        TopologyProperties                                          OFFSET(get<T>, {0x190, 8, 0, 0})
	CMember(class UPolyEditExtrudeActivity*)           ExtrudeActivity                                             OFFSET(get<T>, {0x198, 8, 0, 0})
	CMember(class UPolyEditInsetOutsetActivity*)       InsetOutsetActivity                                         OFFSET(get<T>, {0x1A0, 8, 0, 0})
	CMember(class UPolyEditCutFacesActivity*)          CutFacesActivity                                            OFFSET(get<T>, {0x1A8, 8, 0, 0})
	CMember(class UPolyEditPlanarProjectionUVActivity*) PlanarProjectionUVActivity                                 OFFSET(get<T>, {0x1B0, 8, 0, 0})
	CMember(class UPolyEditInsertEdgeActivity*)        InsertEdgeActivity                                          OFFSET(get<T>, {0x1B8, 8, 0, 0})
	CMember(class UPolyEditInsertEdgeLoopActivity*)    InsertEdgeLoopActivity                                      OFFSET(get<T>, {0x1C0, 8, 0, 0})
	CMember(class UPolyEditBevelEdgeActivity*)         BevelEdgeActivity                                           OFFSET(get<T>, {0x1C8, 8, 0, 0})
	CMember(class UPolyEditActivityContext*)           ActivityContext                                             OFFSET(get<T>, {0x208, 8, 0, 0})
	CMember(class UPolygonSelectionMechanic*)          SelectionMechanic                                           OFFSET(get<T>, {0x210, 8, 0, 0})
	CMember(class UDragAlignmentMechanic*)             DragAlignmentMechanic                                       OFFSET(get<T>, {0x218, 8, 0, 0})
	CMember(class UCombinedTransformGizmo*)            TransformGizmo                                              OFFSET(get<T>, {0x220, 8, 0, 0})
	CMember(class UTransformProxy*)                    TransformProxy                                              OFFSET(get<T>, {0x228, 8, 0, 0})
};
...
public:
	...
	// TArray<FString> GetUVChannelNamesFunc();                                                                                 // [0xab9d87c] Final|Native|Public|Const 
};
...
public:
	...
	CMember(EPolyEditExtrudeDirection)                 Direction                                                   OFFSET(get<T>, {0xB8, 4, 0, 0})
	CMember(EPolyEditExtrudeDirection)                 MeasureDirection                                            OFFSET(get<T>, {0xBC, 4, 0, 0})
	DMember(bool)                                      bShellsToSolids                                             OFFSET(get<bool>, {0xC0, 1, 0, 0})
	CMember(EPolyEditExtrudeModeOptions)               DirectionMode                                               OFFSET(get<T>, {0xC4, 4, 0, 0})
	DMember(double)                                    MaxDistanceScaleFactor                                      OFFSET(get<double>, {0xC8, 8, 0, 0})
...
/// Size: 0x03
enum EProceduralRectType : uint32_t
{
...
/// Size: 0x03
enum EProceduralDiscType : uint32_t
{
...
/// Size: 0x03
enum EProceduralSphereType : uint32_t
{
...
/// Size: 0x05
enum EProceduralStairsType : uint32_t
{
...
/// Size: 0x04
enum EDrawPolygonExtrudeMode : uint8_t
{
...
enum EEditMeshPolygonsToolActions : uint8_t
{
	...
	EEditMeshPolygonsToolActions__SimplifyAlongEdges                                 = 28,
	EEditMeshPolygonsToolActions__PlanarProjectionUV                                 = 29,
	EEditMeshPolygonsToolActions__SimplifyByGroups                                   = 30,
	EEditMeshPolygonsToolActions__RegenerateExtraCorners                             = 31,
	EEditMeshPolygonsToolActions__PokeSingleFace                                     = 32,
	EEditMeshPolygonsToolActions__SplitSingleEdge                                    = 33,
	EEditMeshPolygonsToolActions__FlipSingleEdge                                     = 34,
	EEditMeshPolygonsToolActions__CollapseSingleEdge                                 = 35,
	EEditMeshPolygonsToolActions__BevelAuto                                          = 36,
	EEditMeshPolygonsToolActions__EEditMeshPolygonsToolActions_MAX                   = 37
};

/// Enum /Script/MeshModelingTools.EEditMeshPolygonsToolSelectionMode
/// Size: 0x07
enum EEditMeshPolygonsToolSelectionMode : uint8_t
{
...
/// Size: 0x10
enum EMeshEditingMaterialModes : uint32_t
{
...
/// Size: 0x03
enum EPolyEditCutPlaneOrientation : uint32_t
{
...
/// Size: 0x08
enum EPolyEditExtrudeDirection : uint32_t
{
...
/// Size: 0x03
enum EPolyEditExtrudeDistanceMode : uint32_t
{
...
/// Size: 0x04
enum EPolyEditExtrudeModeOptions : uint32_t
{
...
/// Size: 0x04
enum EPolyEditOffsetModeOptions : uint32_t
{
...
/// Size: 0x05
enum EPolyEditPushPullModeOptions : uint32_t
{
...
/// Size: 0x03
enum EGroupEdgeInsertionMode : uint32_t
{
...
/// Size: 0x04
enum EEdgeLoopPositioningMode : uint32_t
{
...
/// Size: 0x03
enum EEdgeLoopInsertionMode : uint32_t
{
...
/// Size: 0x05
enum EUVProjectionToolInitializationMode : uint32_t
{
