...
public:
	...
	CMember(class UBodySetup*)                         DummyBodySetup                                              OFFSET(get<T>, {0xAF0, 8, 0, 0})
	CMember(class UChaosGameplayEventDispatcher*)      EventDispatcher                                             OFFSET(get<T>, {0xAF8, 8, 0, 0})
	CMember(TArray<class UInstancedStaticMeshComponent*>) EmbeddedGeometryComponents                               OFFSET(get<T>, {0xB00, 16, 0, 0})
	DMember(bool)                                      bUseStaticMeshCollisionForTraces                            OFFSET(get<bool>, {0xB10, 1, 0, 0})
