...
public:
	CMember(class UMatchObjectivesSelectorWidget*)     WBP_MatchQuests_Selector                                    OFFSET(get<T>, {0x350, 8, 0, 0})
	CMember(class USpacer*)                            Spacer_ReservedSpace                                        OFFSET(get<T>, {0x358, 8, 0, 0})
...
public:
	...
	CMember(class UImage*)                             Image_MenuBG                                                OFFSET(get<T>, {0x330, 8, 0, 0})
