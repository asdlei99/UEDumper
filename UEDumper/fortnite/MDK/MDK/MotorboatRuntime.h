...
public:
	SMember(FFortRechargingActionTimer)                BoostAction                                                 OFFSET(getStruct<T>, {0x1F18, 216, 0, 0})
	DMember(float)                                     FxNormalizationMaxSpeedKmh                                  OFFSET(get<float>, {0x1FF0, 4, 0, 0})
	CMember(class UFortVehicleAudioVoice*)             CacheAudioEngineUp                                          OFFSET(get<T>, {0x1FF8, 8, 0, 0})
	CMember(class UFortVehicleAudioVoice*)             CacheAudioEngineDown                                        OFFSET(get<T>, {0x2000, 8, 0, 0})
	CMember(class UFortVehicleAudioVoice*)             CacheAudioWakeTurn                                          OFFSET(get<T>, {0x2008, 8, 0, 0})
	CMember(class UFortVehicleAudioVoice*)             CacheAudioWakeSpeed                                         OFFSET(get<T>, {0x2010, 8, 0, 0})
	CMember(class UFortVehicleAudioVoice*)             CacheAudioScrape                                            OFFSET(get<T>, {0x2018, 8, 0, 0})
	CMember(class UFortVehicleAudioVoice*)             CacheAudioEngineOutOfFuel                                   OFFSET(get<T>, {0x2020, 8, 0, 0})
	CMember(class UMaterialInstanceDynamic*)           BoostMID                                                    OFFSET(get<T>, {0x2028, 8, 0, 0})
	CMember(class UNiagaraComponent*)                  CachedGroundFXComponent                                     OFFSET(get<T>, {0x2030, 8, 0, 0})
	CMember(class APlayerController*)                  DrivingPlayerController                                     OFFSET(get<T>, {0x2038, 8, 0, 0})
	CMember(class ULegacyCameraShake*)                 LandCameraShake                                             OFFSET(get<T>, {0x2040, 8, 0, 0})
	CMember(class UClass*)                             LandCameraShakeClass                                        OFFSET(get<T>, {0x2048, 8, 0, 0})
	CMember(class ULegacyCameraShake*)                 DriverCameraShake                                           OFFSET(get<T>, {0x2050, 8, 0, 0})
	CMember(class UClass*)                             DriverCameraShakeClass                                      OFFSET(get<T>, {0x2058, 8, 0, 0})
	DMember(float)                                     LandRumbleIntensity                                         OFFSET(get<float>, {0x2060, 4, 0, 0})
	DMember(uint64_t)                                  LandForceFeedbackHandle                                     OFFSET(get<uint64_t>, {0x2068, 8, 0, 0})
	DMember(float)                                     TurnRumbleIntensity                                         OFFSET(get<float>, {0x2070, 4, 0, 0})
	DMember(uint64_t)                                  TurnForceFeedbackHandle                                     OFFSET(get<uint64_t>, {0x2078, 8, 0, 0})
	DMember(float)                                     CurrentSnowAltitude                                         OFFSET(get<float>, {0x2080, 4, 0, 0})
	DMember(bool)                                      bHasSnow                                                    OFFSET(get<bool>, {0x2084, 1, 0, 0})
	DMember(bool)                                      bLargeRumble                                                OFFSET(get<bool>, {0x2085, 1, 0, 0})
	DMember(bool)                                      bTurnRumbleActive                                           OFFSET(get<bool>, {0x2086, 1, 0, 0})
	DMember(bool)                                      bWaterDropsOnScreen                                         OFFSET(get<bool>, {0x2087, 1, 0, 0})
	SMember(FGameplayTag)                              GCVehicleScreenDrips                                        OFFSET(getStruct<T>, {0x2088, 4, 0, 0})
	SMember(FGameplayCueParameters)                    GCParamsEmpty                                               OFFSET(getStruct<T>, {0x2090, 208, 0, 0})
	CMember(class UClass*)                             BoostingCamera                                              OFFSET(get<T>, {0x2160, 8, 0, 0})
	CMember(class UClass*)                             VehicleCameraNoWeaponOverride                               OFFSET(get<T>, {0x2168, 8, 0, 0})
	CMember(class UFortMeatballVehicleConfigs*)        FortMeatballVehicleConfigs                                  OFFSET(get<T>, {0x2180, 8, 0, 0})
	DMember(int32_t)                                   WaterLineStartPontoonIndex                                  OFFSET(get<int32_t>, {0x2188, 4, 0, 0})
	DMember(int32_t)                                   WaterLineEndPontoonIndex                                    OFFSET(get<int32_t>, {0x218C, 4, 0, 0})
