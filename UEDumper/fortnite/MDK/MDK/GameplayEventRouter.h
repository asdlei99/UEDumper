...
public:
	...
	// void StopListeningToEvent();                                                                                             // [0x186c4f8] Final|Native|Public|BlueprintCallable 
	// Function /Script/GameplayEventRouter.AsyncAction_StartListeningToEvent.StartListeningToEventBackwardCompatible
	// class UAsyncAction_StartListeningToEvent* StartListeningToEventBackwardCompatible(class UObject* WorldContextObject, FEventMessageTag Channel, class UGameplayEventRouterComponent* Target, class UScriptStruct* EventType, class UObject* Context, EEventBubblingRule EventBubblingRule); // [0x27dba5c] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/GameplayEventRouter.AsyncAction_StartListeningToEvent.StartListeningToEvent
	// class UAsyncAction_StartListeningToEvent* StartListeningToEvent(class UObject* WorldContextObject, class UGameplayEventRouterComponent* Target, class UScriptStruct* EventType, class UObject* Context, EEventBubblingRule EventBubblingRule); // [0x27dbc70] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/GameplayEventRouter.AsyncAction_StartListeningToEvent.GetPayload
	// bool GetPayload(int32_t& OutPayload);                                                                                    // [0x2b2c9dc] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void StopListeningToStatefulEvent();                                                                                     // [0x186c4f8] Final|Native|Public|BlueprintCallable 
	...
	// class UAsyncAction_StartListeningToStatefulEvent* StartListeningToStatefulEventBackwardsCompatible(class UObject* WorldContextObject, FEventMessageTag Channel, class UGameplayEventRouterComponent* Target, class UScriptStruct* EventType, class UObject* Context, EEventBubblingRule EventBubblingRule); // [0x6c23238] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/GameplayEventRouter.AsyncAction_StartListeningToStatefulEvent.StartListeningToStatefulEvent
	// class UAsyncAction_StartListeningToStatefulEvent* StartListeningToStatefulEvent(class UObject* WorldContextObject, class UGameplayEventRouterComponent* Target, class UScriptStruct* EventType, class UObject* Context, EEventBubblingRule EventBubblingRule); // [0x27dbf64] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/GameplayEventRouter.AsyncAction_StartListeningToStatefulEvent.GetPayload
	// bool GetPayload(int32_t& OutPayload);                                                                                    // [0x2c54a44] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void StopListeningToEvent(FGameplayEventListenerHandle& HandleToRemove);                                                 // [0x6c23568] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GameplayEventRouter.GameplayEventRouterComponent.K2_BroadcastStatefulEvent
	// bool K2_BroadcastStatefulEvent(int32_t& EventData, class UObject* EventContext);                                         // [0x6c22cd8] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/GameplayEventRouter.GameplayEventRouterComponent.K2_BroadcastEvent
	// bool K2_BroadcastEvent(int32_t& EventData, class UObject* EventContext);                                                 // [0x32b1654] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/GameplayEventRouter.GameplayEventRouterComponent.HasValidEventState
	// bool HasValidEventState(class UScriptStruct* EventType, class UObject* Context);                                         // [0x6c22668] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GameplayEventRouter.GameplayEventRouterComponent.ClearEventStateByContext
	// void ClearEventStateByContext(class UScriptStruct* EventType, class UObject* Context);                                   // [0x6c2222c] Final|Native|Public|BlueprintCallable 
	// Function /Script/GameplayEventRouter.GameplayEventRouterComponent.ClearEventState
	// void ClearEventState(class UScriptStruct* EventType);                                                                    // [0x6c21e04] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// class UClass* GetEventRouterClass();                                                                                     // [0x35e2c54] Native|Event|Protected|BlueprintEvent|Const 
};
...
public:
	...
	// bool K2_BroadcastStatefulEventBackwardCompatible(class UObject* WorldContextObject, class UGameplayEventRouterComponent* Target, FEventMessageTag Channel, int32_t& EventData, class UObject* EventContext); // [0x6c22e70] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GameplayEventRouter.GameplayEventRouterSubsystem.K2_BroadcastEventBackwardCompatible
	// bool K2_BroadcastEventBackwardCompatible(class UObject* WorldContextObject, class UGameplayEventRouterComponent* Target, FEventMessageTag Channel, int32_t& EventData, class UObject* EventContext); // [0x6c22910] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GameplayEventRouter.GameplayEventRouterSubsystem.GetGlobalEventRouter
	// class UGameplayEventRouterComponent* GetGlobalEventRouter(class UObject* WorldContextObject);                            // [0x34618b0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/GameplayEventRouter.GameplayEventRouterSubsystem.GetEventRouter
	// class UGameplayEventRouterComponent* GetEventRouter(class UClass* Scope, class AActor* ContextActor);                    // [0x312db50] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/GameplayEventRouter.GameplayEventRouterSubsystem.ClearEventStateByContextBackwardCompatible
	// void ClearEventStateByContextBackwardCompatible(class UObject* WorldContextObject, FEventMessageTag Channel, class UGameplayEventRouterComponent* Target, class UScriptStruct* EventType, class UObject* Context); // [0x6c2236c] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/GameplayEventRouter.GameplayEventRouterSubsystem.ClearEventStateBackwardCompatible
	// void ClearEventStateBackwardCompatible(class UObject* WorldContextObject, FEventMessageTag Channel, class UGameplayEventRouterComponent* Target, class UScriptStruct* EventType); // [0x6c21f3c] Final|Native|Static|Public|BlueprintCallable 
};
