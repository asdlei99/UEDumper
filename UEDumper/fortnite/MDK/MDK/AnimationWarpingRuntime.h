...
public:
	...
	DMember(float)                                     MaxCorrectionDegrees                                        OFFSET(get<float>, {0x11C, 4, 0, 0})
	DMember(float)                                     MaxRootMotionDeltaToCompensateDegrees                       OFFSET(get<float>, {0x120, 4, 0, 0})
	DMember(bool)                                      bCounterCompenstateInterpolationByRootMotion                OFFSET(get<bool>, {0x124, 1, 0, 0})
	DMember(bool)                                      bScaleByGlobalBlendWeight                                   OFFSET(get<bool>, {0x125, 1, 0, 0})
	DMember(bool)                                      bUseManualRootMotionVelocity                                OFFSET(get<bool>, {0x126, 1, 0, 0})
	SMember(FVector)                                   ManualRootMotionVelocity                                    OFFSET(getStruct<T>, {0x128, 24, 0, 0})
};
