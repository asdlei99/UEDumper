...
public:
	...
	// void Stop();                                                                                                             // [0x130d900] Event|Public|BlueprintEvent 
	// Function /Script/EntityFortnite.EntityFortniteStormSpawner.Start
	// void Start(float StartRadius, float BoundsRadius, TArray<FEntityFortniteStormPhase>& Phases);                            // [0x130d900] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/EntityFortnite.EntityFortniteStormSpawner.Pause
	// void Pause();                                                                                                            // [0x130d900] Event|Public|BlueprintEvent 
	// Function /Script/EntityFortnite.EntityFortniteStormSpawner.Exists
	// bool Exists();                                                                                                           // [0x130d900] Event|Public|BlueprintEvent|Const 
};
