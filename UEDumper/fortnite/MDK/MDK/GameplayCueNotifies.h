...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x9B0, 8, 0, 0})
	DMember(double)                                    FrequencyToCheckEnergy                                      OFFSET(get<double>, {0x9B8, 8, 0, 0})
	CMember(TArray<class UAudioComponent*>)            Audio_Components                                            OFFSET(get<T>, {0x9C0, 16, 0, 0})
	CMember(class UTacticalSprintEnergyComponent_C*)   TacSprintComp                                               OFFSET(get<T>, {0x9D0, 8, 0, 0})
	CMember(class AActor*)                             Pawn                                                        OFFSET(get<T>, {0x9D8, 8, 0, 0})
	DMember(double)                                    CurrentEnergyPercentage                                     OFFSET(get<double>, {0x9E0, 8, 0, 0})
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x9B0, 8, 0, 0})
	DMember(double)                                    TimeBetweenLoopUpdates                                      OFFSET(get<double>, {0x9B8, 8, 0, 0})
	CMember(TArray<class UNiagaraComponent*>)          Particle_Components                                         OFFSET(get<T>, {0x9C0, 16, 0, 0})
	CMember(class ACharacter*)                         TargetCharacter                                             OFFSET(get<T>, {0x9D0, 8, 0, 0})
	DMember(bool)                                      IsLocallyViewed                                             OFFSET(get<bool>, {0x9D8, 1, 0, 0})
	CMember(class AFortPlayerPawn*)                    As_Fort_Player_Pawn                                         OFFSET(get<T>, {0x9E0, 8, 0, 0})
	DMember(int32_t)                                   SurfaceTypeInt                                              OFFSET(get<int32_t>, {0x9E8, 4, 0, 0})
	SMember(FTimerHandle)                              LoopUpdateTimer                                             OFFSET(getStruct<T>, {0x9F0, 8, 0, 0})
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x9B0, 8, 0, 0})
	CMember(class UCameraShakeBase*)                   ShakeNoise                                                  OFFSET(get<T>, {0x9B8, 8, 0, 0})
	CMember(class UCameraShakeBase*)                   TacSprintIntroShake                                         OFFSET(get<T>, {0x9C0, 8, 0, 0})
	CMember(class UCameraShakeBase*)                   FOVFlare                                                    OFFSET(get<T>, {0x9C8, 8, 0, 0})
	CMember(class AFortPlayerController*)              FortPlayerController                                        OFFSET(get<T>, {0x9D0, 8, 0, 0})
