...
public:
	...
	SMember(FZoneGraphBuildSettings)                   BuildSettings                                               OFFSET(getStruct<T>, {0x1C8, 64, 0, 0})
	DMember(bool)                                      bBuildZoneGraphWhileEditing                                 OFFSET(get<bool>, {0x208, 1, 0, 0})
};
...
/// Size: 0x06
enum EZoneLaneLinkType : uint8_t
{
...
/// Size: 0x08
enum EZoneLaneLinkFlags : uint8_t
{
...
/// Size: 0x03
enum EZoneShapePolygonRoutingType : uint8_t
{
...
/// Size: 0x06
enum EZoneShapeLaneConnectionRestrictions : uint8_t
{
...
/// Size: 0x05
enum FZoneShapePointType : uint8_t
{
