...
public:
	...
	CMember(TMap<FGameplayTag, TWeakObjectPtr<UObject*>>) TagToImageMap                                            OFFSET(get<T>, {0x688, 80, 0, 0})
	CMember(class UCommonTextBlock*)                   Text_CategoryTitle                                          OFFSET(get<T>, {0x6D8, 8, 0, 0})
};
...
public:
	CMember(TArray<class UFortPlayerAugmentItemDefinition*>) AvailableAugmentItemDefinitions                       OFFSET(get<T>, {0x328, 16, 0, 0})
	CMember(class UWidget*)                            Overlay_Reroll                                              OFFSET(get<T>, {0x338, 8, 0, 0})
