...
public:
	...
	// void GetBallisticShieldData(EBallisticShieldPlayerActionState& BallisticShieldPlayerState, float& StaggerBuildupPercent); // [0xaa6dd2c] Native|Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	SMember(FScalableFloat)                            ChargeRotationRate                                          OFFSET(getStruct<T>, {0x3C0, 40, 0, 0})
	CMember(class UClass*)                             GrantedAbility                                              OFFSET(get<T>, {0x3E8, 8, 0, 0})
};
