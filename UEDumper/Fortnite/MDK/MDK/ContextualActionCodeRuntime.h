...
public:
	SMember(FVector)                                   MaxSwingAdditionalViewTargetOffset                          OFFSET(getStruct<T>, {0x1BA0, 24, 0, 0})
	DMember(float)                                     MaxSwingFOV                                                 OFFSET(get<float>, {0x1BB8, 4, 0, 0})
};
