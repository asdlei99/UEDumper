...
public:
	...
	// void PlaySpeech(FString Filename, int32_t SampleRate, class USoundWave* AssetFile);                                      // [0x2047e54] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Maps/Frontend.Frontend_C.OnMatchStarted
	// void OnMatchStarted();                                                                                                   // [0x2047e54] BlueprintAuthorityOnly|Event|Public|BlueprintEvent 
	// Function /Game/Maps/Frontend.Frontend_C.EnableTutorial
	// void EnableTutorial();                                                                                                   // [0x2047e54] BlueprintCallable|BlueprintEvent 
	// Function /Game/Maps/Frontend.Frontend_C.ExecuteUbergraph_Frontend
	// void ExecuteUbergraph_Frontend(int32_t EntryPoint);                                                                      // [0x2047e54] Final                
};
...
public:
	...
	// void BndEvt__CMSLobbyDirector_2_K2Node_ActorBoundEvent_2_RequestDelegate__DelegateSignature();                           // [0x2047e54] BlueprintEvent       
	...
	// void BndEvt__CMSLobbyDirector_2_K2Node_ActorBoundEvent_3_RequestDelegate__DelegateSignature();                           // [0x2047e54] BlueprintEvent       
	...
	// void BndEvt__CMSLobbyDirector_2_K2Node_ActorBoundEvent_1_OnEnvironmentBackgroundTextureChangedDynamic__DelegateSignature(class UTexture* BackgroundImage); // [0x2047e54] BlueprintEvent       
	...
	// void BndEvt__CMSLobbyDirector_2_K2Node_ActorBoundEvent_0_OnEnvironmentChangedDynamic__DelegateSignature(FString PresetEnvironmentName); // [0x2047e54] BlueprintEvent       
	...
	// void BndEvt__CMSLobbyDirector_2_K2Node_ActorBoundEvent_4_OnEnteredItemShop__DelegateSignature();                         // [0x2047e54] BlueprintEvent       
	...
	// void BndEvt__CMSLobbyDirector_2_K2Node_ActorBoundEvent_5_OnEnteredStore__DelegateSignature();                            // [0x2047e54] BlueprintEvent       
	// Function /Game/Maps/UI/Frontend_BG_Main.Frontend_BG_Main_C.ExecuteUbergraph_Frontend_BG_Main
	// void ExecuteUbergraph_Frontend_BG_Main(int32_t EntryPoint);                                                              // [0x2047e54] Final                
};
