...
public:
	...
	// void InitPreview();                                                                                                      // [0x2047e54] Public|BlueprintCallable|BlueprintEvent 
	// Function /SparksCore/Audio/BPC_SparksSongPreviewer.BPC_SparksSongPreviewer_C.ForceStopPreviewImmediate
	// void ForceStopPreviewImmediate();                                                                                        // [0x2047e54] Public|BlueprintCallable|BlueprintEvent 
	// Function /SparksCore/Audio/BPC_SparksSongPreviewer.BPC_SparksSongPreviewer_C.StopPreviewingSong
	// void StopPreviewingSong(bool WithFadeout, FName SongShortName);                                                          // [0x2047e54] Public|BlueprintCallable|BlueprintEvent 
	// Function /SparksCore/Audio/BPC_SparksSongPreviewer.BPC_SparksSongPreviewer_C.IsPlayingPreview
	// void IsPlayingPreview(FName Song, bool& Is Playing Or Pending, bool& Is Playing, bool& Is Pending);                      // [0x2047e54] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /SparksCore/Audio/BPC_SparksSongPreviewer.BPC_SparksSongPreviewer_C.StopPreview
	// void StopPreview(bool WithFadeout);                                                                                      // [0x2047e54] Public|BlueprintCallable|BlueprintEvent 
	...
	// void DoneFadingOutForStop();                                                                                             // [0x2047e54] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_BPC_SparksSongPreviewer(int32_t EntryPoint);                                                       // [0x2047e54] Final|HasDefaults    
};
