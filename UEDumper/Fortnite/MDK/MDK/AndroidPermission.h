...
public:
	...
	// bool CheckPermission(FString Permission);                                                                                // [0xbeb8ac8] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AndroidPermission.AndroidPermissionFunctionLibrary.AcquirePermissions
	// class UAndroidPermissionCallbackProxy* AcquirePermissions(TArray<FString>& Permissions);                                 // [0xbeb89e0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
