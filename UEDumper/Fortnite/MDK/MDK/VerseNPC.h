...
public:
	CMember(class AFortInventory*)                     CachedFortInventory                                         OFFSET(get<T>, {0x80, 8, 0, 0})
	CMember(class AFortPawn*)                          CachedFortPawn                                              OFFSET(get<T>, {0x88, 8, 0, 0})
	CMember(class UBlackboardComponent*)               CachedBlackboardComponent                                   OFFSET(get<T>, {0x90, 8, 0, 0})
};
