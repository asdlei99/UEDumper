...
public:
	...
	DMember(float)                                     BehindAvatarSizeBoxWidth                                    OFFSET(get<float>, {0x2F8, 4, 0, 0})
	DMember(float)                                     AheadAvatarSizeBoxWidth                                     OFFSET(get<float>, {0x2FC, 4, 0, 0})
	DMember(bool)                                      bBehindAvatarImageIsExpanded                                OFFSET(get<bool>, {0x300, 1, 0, 0})
	DMember(bool)                                      bAheadAvatarImageIsExpanded                                 OFFSET(get<bool>, {0x301, 1, 0, 0})
	DMember(float)                                     BehindPlayerNameSizeBoxMaxWidth                             OFFSET(get<float>, {0x304, 4, 0, 0})
	DMember(float)                                     AheadPlayerNameSizeBoxMaxWidth                              OFFSET(get<float>, {0x308, 4, 0, 0})
	DMember(float)                                     BehindBackgroundOverlaySlotPadding                          OFFSET(get<float>, {0x30C, 4, 0, 0})
	DMember(float)                                     AheadBackgroundOverlaySlotPadding                           OFFSET(get<float>, {0x310, 4, 0, 0})
...
public:
	...
	SMember(FVector)                                   DriftBoostUpsideDownOffset                                  OFFSET(getStruct<T>, {0x2A0, 24, 0, 0})
	DMember(float)                                     DriftBoostUpsideDownThreshold                               OFFSET(get<float>, {0x2B8, 4, 0, 0})
	CMember(class APlayerState*)                       ViewPlayerState                                             OFFSET(get<T>, {0x2C0, 8, 0, 0})
	CMember(class USceneComponent*)                    AttachedTarget                                              OFFSET(get<T>, {0x2C8, 8, 0, 0})
	CMember(class ADelMarVehicle*)                     AttachedVehicle                                             OFFSET(get<T>, {0x2D0, 8, 0, 0})
	CMember(class APlayerCameraManager*)               CameraManager                                               OFFSET(get<T>, {0x2D8, 8, 0, 0})
	CMember(class USceneComponent*)                    AttachmentBaseComponent                                     OFFSET(get<T>, {0x2E0, 8, 0, 0})
	CMember(class UDelMarWidgetComponent*)             SpeedometerWidget                                           OFFSET(get<T>, {0x2E8, 8, 0, 0})
	CMember(class UDelMarWidgetComponent*)             DriftBoostWidget                                            OFFSET(get<T>, {0x2F0, 8, 0, 0})
	CMember(class UDelMarWidgetComponent*)             UnderthrustWidget                                           OFFSET(get<T>, {0x2F8, 8, 0, 0})
};
...
public:
	SMember(FVector2D)                                 LeftTopPadding                                              OFFSET(getStruct<T>, {0x6E0, 16, 0, 0})
	SMember(FVector2D)                                 RightBottomPadding                                          OFFSET(getStruct<T>, {0x6F0, 16, 0, 0})
};
...
public:
	SMember(FText)                                     MapName                                                     OFFSET(getStruct<T>, {0x68, 24, 0, 0})
	SMember(FText)                                     MapCreator                                                  OFFSET(getStruct<T>, {0x80, 24, 0, 0})
	SMember(FText)                                     MapDescription                                              OFFSET(getStruct<T>, {0x98, 24, 0, 0})
...
public:
	...
	CMember(TWeakObjectPtr<ADelMarRaceManager*>)       RaceManager                                                 OFFSET(get<T>, {0xD0, 8, 0, 0})
	CMember(TWeakObjectPtr<AFortPlayerState*>)         PlayerState                                                 OFFSET(get<T>, {0xD8, 8, 0, 0})
	CMember(TWeakObjectPtr<UDelMarPositionalTrackerComponent*>) PositionalTrackerComponent                         OFFSET(get<T>, {0xE0, 8, 0, 0})
