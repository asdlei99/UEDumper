...
public:
	CMember(class UNeuralMorphNetworkInstance*)        NetworkInstance                                             OFFSET(get<T>, {0xA8, 8, 0, 0})
};
...
public:
	...
	CMember(class UNeuralMorphNetwork*)                NeuralMorphNetwork                                          OFFSET(get<T>, {0x288, 8, 0, 0})
};
