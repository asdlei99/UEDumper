...
public:
	...
	// void SetSubjectRepresentation(FLiveLinkSubjectRepresentation InSubjectRepresentation);                                   // [0xc119094] Final|Native|Public|BlueprintCallable 
	// Function /Script/LiveLinkComponents.LiveLinkComponentController.GetSubjectRepresentation
	// FLiveLinkSubjectRepresentation GetSubjectRepresentation();                                                               // [0xc119050] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
