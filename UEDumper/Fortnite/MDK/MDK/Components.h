...
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 1652;

public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x660, 8, 0, 0})
	CMember(class AFortAthenaVehicle*)                 VehiclePawn                                                 OFFSET(get<T>, {0x668, 8, 0, 0})
	SMember(FGameplayTag)                              GC_LoopingApplication                                       OFFSET(getStruct<T>, {0x670, 4, 0, 0})
