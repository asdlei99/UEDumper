...
public:
	...
	CMember(TWeakObjectPtr<UStateTree*>)               StateTreeOverride                                           OFFSET(get<T>, {0x3A0, 32, 0, 0})
	SMember(FGameplayCueTag)                           ProximityGameplayCueTag                                     OFFSET(getStruct<T>, {0x3C0, 4, 0, 0})
	SMember(FGameplayCueTag)                           ActorCleanupGameplayCueTag                                  OFFSET(getStruct<T>, {0x3C4, 4, 0, 0})
	CMember(TArray<FName>)                             SuccessRewards                                              OFFSET(get<T>, {0x3C8, 16, 0, 0})
	SMember(FEncounterRewardBehavior)                  SuccessRewardBehavior                                       OFFSET(getStruct<T>, {0x3D8, 128, 0, 0})
	SMember(FGameplayCueTag)                           ActorSuccessGameplayCueTag                                  OFFSET(getStruct<T>, {0x458, 4, 0, 0})
	SMember(FGameplayCueTag)                           PlayerSuccessGameplayCueTag                                 OFFSET(getStruct<T>, {0x45C, 4, 0, 0})
	CMember(TArray<FName>)                             FailureRewards                                              OFFSET(get<T>, {0x460, 16, 0, 0})
	SMember(FEncounterRewardBehavior)                  FailureRewardBehavior                                       OFFSET(getStruct<T>, {0x470, 128, 0, 0})
	SMember(FGameplayCueTag)                           ActorFailureGameplayCueTag                                  OFFSET(getStruct<T>, {0x4F0, 4, 0, 0})
	SMember(FGameplayCueTag)                           PlayerFailureGameplayCueTag                                 OFFSET(getStruct<T>, {0x4F4, 4, 0, 0})
	SMember(FScalableFloat)                            LWMDensityWeight                                            OFFSET(getStruct<T>, {0x4F8, 40, 0, 0})
	SMember(FScalableFloat)                            LWMDensityRange                                             OFFSET(getStruct<T>, {0x520, 40, 0, 0})
	CMember(TArray<FInstancedStruct>)                  Vars                                                        OFFSET(get<T>, {0x548, 16, 0, 0})
	CMember(TArray<FInstancedStruct>)                  VariableSelections                                          OFFSET(get<T>, {0x558, 16, 0, 0})
	SMember(FWorldConditionQueryDefinition)            CanSpawnWorldConditionDefinition                            OFFSET(getStruct<T>, {0x568, 24, 0, 0})
	CMember(TArray<FFortAthenaLivingWorldPrefabActorSpawnerData>) ActorSpawnerDatas                                OFFSET(get<T>, {0x580, 16, 0, 0})
};
...
public:
	...
	CMember(TArray<TWeakObjectPtr<ABuildingActor*>>)   PermanentActors                                             OFFSET(get<T>, {0xB0, 16, 0, 0})
...
public:
	CMember(TArray<FEncounterPrefabInfo>)              EncounterEntries                                            OFFSET(get<T>, {0x978, 16, 0, 0})
	CMember(class UEncounterItem*)                     EncounterItem                                               OFFSET(get<T>, {0x988, 8, 0, 0})
	CMember(class UEncounterItemDefinition*)           EncounterDefinition                                         OFFSET(get<T>, {0x990, 8, 0, 0})
	CMember(TWeakObjectPtr<AActor*>)                   ReservoirActorOverride                                      OFFSET(get<T>, {0x998, 8, 0, 0})
	CMember(TWeakObjectPtr<UEncounterManagerComponent*>) EncounterManager                                          OFFSET(get<T>, {0x9A0, 8, 0, 0})
