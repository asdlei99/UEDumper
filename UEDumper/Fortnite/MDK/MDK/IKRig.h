...
public:
	...
	CMember(TArray<class URetargetChainSettings*>)     ChainSettings                                               OFFSET(get<T>, {0x78, 16, 0, 0})
	CMember(class URetargetRootSettings*)              RootSettings                                                OFFSET(get<T>, {0x88, 8, 0, 0})
	CMember(class UIKRetargetGlobalSettings*)          GlobalSettings                                              OFFSET(get<T>, {0x90, 8, 0, 0})
	CMember(class URetargetOpStack*)                   OpStack                                                     OFFSET(get<T>, {0x98, 8, 0, 0})
...
public:
	...
	CMember(class UIKRetargetProcessor*)               Processor                                                   OFFSET(get<T>, {0x130, 8, 0, 0})
};
...
/// Size: 0x04
enum ERetargetRootLockMode : uint8_t
{
...
/// Size: 0x03
enum EWarpingDirectionSource : uint32_t
{
