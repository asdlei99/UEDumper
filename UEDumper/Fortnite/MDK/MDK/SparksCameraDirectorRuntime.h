...
public:
	CMember(class ACineCameraActor*)                   SpawnedCamera                                               OFFSET(get<T>, {0x608, 8, 0, 0})
	CMember(class USkeletalMeshComponent*)             TargetMesh                                                  OFFSET(get<T>, {0x610, 8, 0, 0})
	CMember(class AActor*)                             SpawnedLookAtTraget                                         OFFSET(get<T>, {0x618, 8, 0, 0})
