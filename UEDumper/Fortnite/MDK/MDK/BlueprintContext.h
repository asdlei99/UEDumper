...
public:
	...
	// class USubsystem* GetContext(class UObject* ContextObject, class UClass* Class);                                         // [0x284d628] Final|BlueprintCosmetic|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
