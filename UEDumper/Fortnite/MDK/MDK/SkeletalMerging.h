...
public:
	...
	// class USkeleton* MergeSkeletons(FSkeletonMergeParams& Params);                                                           // [0x6eae5c4] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/SkeletalMerging.SkeletalMergingLibrary.MergeMeshes
	// class USkeletalMesh* MergeMeshes(FSkeletalMeshMergeParams& Params);                                                      // [0x6eae528] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
