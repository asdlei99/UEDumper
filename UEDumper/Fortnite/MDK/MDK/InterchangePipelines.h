...
public:
	...
	CMember(class UInterchangeGenericCommonMeshesProperties*) CommonMeshesProperties                               OFFSET(get<T>, {0x148, 8, 0, 0})
	CMember(class UInterchangeGenericCommonSkeletalMeshesAndAnimationsProperties*) CommonSkeletalMeshesAndAnimationsProperties OFFSET(get<T>, {0x150, 8, 0, 0})
	CMember(class UInterchangeGenericMeshPipeline*)    MeshPipeline                                                OFFSET(get<T>, {0x158, 8, 0, 0})
	CMember(class UInterchangeGenericAnimationPipeline*) AnimationPipeline                                         OFFSET(get<T>, {0x160, 8, 0, 0})
	CMember(class UInterchangeGenericMaterialPipeline*) MaterialPipeline                                           OFFSET(get<T>, {0x168, 8, 0, 0})
};
...
public:
	...
	CMember(class UInterchangeGenericTexturePipeline*) TexturePipeline                                             OFFSET(get<T>, {0x130, 8, 0, 0})
...
public:
	...
	CMember(class UInterchangeBaseNodeContainer*)      BaseNodeContainer                                           OFFSET(get<T>, {0x118, 8, 0, 0})
};
