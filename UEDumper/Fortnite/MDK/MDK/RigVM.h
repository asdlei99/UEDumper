...
public:
	...
	SMember(FRigVMByteCode)                            ByteCodeStorage                                             OFFSET(getStruct<T>, {0x138, 160, 0, 0})
	SMember(FRigVMInstructionArray)                    Instructions                                                OFFSET(getStruct<T>, {0x1E0, 16, 0, 0})
	CMember(TArray<FName>)                             FunctionNamesStorage                                        OFFSET(get<T>, {0x1F8, 16, 0, 0})
	CMember(TArray<FRigVMParameter>)                   Parameters                                                  OFFSET(get<T>, {0x240, 16, 0, 0})
	DMember(uint32_t)                                  CachedVMHash                                                OFFSET(get<uint32_t>, {0x328, 4, 0, 0})
...
public:
	...
	SMember(FRigVMMemoryStorageStruct)                 WorkMemoryStorage                                           OFFSET(getStruct<T>, {0x10, 80, 0, 0})
	SMember(FRigVMMemoryStorageStruct)                 DebugMemoryStorage                                          OFFSET(getStruct<T>, {0x60, 80, 0, 0})
};
