...
public:
	CMember(class UFortItemDefinition*)                LoadedEmote                                                 OFFSET(get<T>, {0x0, 8, 0, 0})
};
...
public:
	CMember(TArray<TWeakObjectPtr<UFortItemDefinition*>>) ItemShopPreviewStyles                                    OFFSET(get<T>, {0x0, 16, 0, 0})
...
/// Size: 0x04
enum ERedirectorTileDisplayMode : uint32_t
{
