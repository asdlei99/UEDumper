...
public:
	...
	CMember(class UGameplayEventRouterComponent*)      Event_Router                                                OFFSET(get<T>, {0x458, 8, 0, 0})
	CMember(class UWBP_Sparks_Dbg_CosmeticPicker_C*)   DebugWidget                                                 OFFSET(get<T>, {0x460, 8, 0, 0})
