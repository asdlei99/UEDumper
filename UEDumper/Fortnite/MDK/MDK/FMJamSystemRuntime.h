...
public:
	...
	// void UpdateJamUI();                                                                                                      // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/FMJamSystemRuntime.JamControllerComponent.GetControllerOfClass
	// class AController* GetControllerOfClass(class UClass* ControllerType, bool bMatchChildTypes);                            // [0xb64972c] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void Close();                                                                                                            // [0x3b2f124] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// bool ShouldApplyJamOnSplitscreenLogic(class UObject* WorldContextObject, class APlayerController* ReferenceController);  // [0xb649a10] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
	// Function /Script/FMJamSystemRuntime.JamOnOffSwitchComponent.OnPlayerStatePawnSet
	// void OnPlayerStatePawnSet(class APlayerState* Player, class APawn* NewPawn, class APawn* OldPawn);                       // [0xb649918] Final|Native|Protected 
	// Function /Script/FMJamSystemRuntime.JamOnOffSwitchComponent.OnMutatorUpdated
	// void OnMutatorUpdated();                                                                                                 // [0xb649904] Final|Native|Protected 
};
...
public:
	...
	// class APawn* GetPawnOfClass(class UClass* PawnType, bool bMatchChildTypes);                                              // [0xb649818] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
