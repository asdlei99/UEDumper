...
public:
	...
	DMember(bool)                                      bExportThinTranslucentMaterials                             OFFSET(get<bool>, {0x33, 1, 0, 0})
	DMember(bool)                                      bExportEmissiveStrength                                     OFFSET(get<bool>, {0x34, 1, 0, 0})
	CMember(EGLTFMaterialBakeMode)                     BakeMaterialInputs                                          OFFSET(get<T>, {0x35, 1, 0, 0})
