...
public:
	DMember(float)                                     WaterSteerRollFactor                                        OFFSET(get<float>, {0x950, 4, 0, 0})
	DMember(float)                                     InnerTurnPontoonOffsetMultiplier                            OFFSET(get<float>, {0x954, 4, 0, 0})
	DMember(float)                                     OuterTurnPontoonOffsetMultiplier                            OFFSET(get<float>, {0x958, 4, 0, 0})
	DMember(float)                                     MinForwardSpeedToBankOnTurn                                 OFFSET(get<float>, {0x95C, 4, 0, 0})
	DMember(float)                                     BoostMinPushForce                                           OFFSET(get<float>, {0x960, 4, 0, 0})
	DMember(float)                                     BoostTopSpeedForceMultiplier                                OFFSET(get<float>, {0x964, 4, 0, 0})
	DMember(float)                                     BoostTopSpeedMultiplier                                     OFFSET(get<float>, {0x968, 4, 0, 0})
	DMember(float)                                     MaxPontoonOffsetPerSecond                                   OFFSET(get<float>, {0x96C, 4, 0, 0})
	DMember(float)                                     LandTopSpeedMultiplier                                      OFFSET(get<float>, {0x970, 4, 0, 0})
	DMember(float)                                     LandPushForceMultiplier                                     OFFSET(get<float>, {0x974, 4, 0, 0})
	DMember(int32_t)                                   MinPushPontoonsForWaterDriving                              OFFSET(get<int32_t>, {0x978, 4, 0, 0})
	DMember(float)                                     MaxWaterPitchAngle                                          OFFSET(get<float>, {0x97C, 4, 0, 0})
	DMember(float)                                     MinForwardSpeedToPitch                                      OFFSET(get<float>, {0x980, 4, 0, 0})
	DMember(float)                                     MinForwardSpeedForMaxPitch                                  OFFSET(get<float>, {0x984, 4, 0, 0})
	DMember(float)                                     MaxForwardSpeedForMaxPitch                                  OFFSET(get<float>, {0x988, 4, 0, 0})
	DMember(float)                                     MaxFowrardSpeedPitchFactor                                  OFFSET(get<float>, {0x98C, 4, 0, 0})
	DMember(float)                                     BoostMaxForwardSpeedPitchFactor                             OFFSET(get<float>, {0x990, 4, 0, 0})
	DMember(float)                                     FrontLateralFrictionFactor                                  OFFSET(get<float>, {0x994, 4, 0, 0})
	DMember(float)                                     RearLateralFrictionFactor                                   OFFSET(get<float>, {0x998, 4, 0, 0})
	DMember(float)                                     LandFrontLateralFrictionFactor                              OFFSET(get<float>, {0x99C, 4, 0, 0})
	DMember(float)                                     LandRearLateralFrictionFactor                               OFFSET(get<float>, {0x9A0, 4, 0, 0})
	DMember(float)                                     LateralFrictionModStartSpeedKmh                             OFFSET(get<float>, {0x9A4, 4, 0, 0})
	DMember(float)                                     RearLateralFrictionModPerSpeedKmh                           OFFSET(get<float>, {0x9A8, 4, 0, 0})
	DMember(float)                                     FrontLateralFrictionModPerSpeedKmh                          OFFSET(get<float>, {0x9AC, 4, 0, 0})
	DMember(float)                                     SeatOffsetScaleX                                            OFFSET(get<float>, {0x9B0, 4, 0, 0})
	DMember(float)                                     SeatOffsetScaleY                                            OFFSET(get<float>, {0x9B4, 4, 0, 0})
	DMember(float)                                     SeatYawAngleMax                                             OFFSET(get<float>, {0x9B8, 4, 0, 0})
	DMember(float)                                     SeatPitchAngleMax                                           OFFSET(get<float>, {0x9BC, 4, 0, 0})
	DMember(float)                                     BoostSteeringMultiplier                                     OFFSET(get<float>, {0x9C0, 4, 0, 0})
	DMember(float)                                     BoostSteeringMultiplierRampTime                             OFFSET(get<float>, {0x9C4, 4, 0, 0})
	DMember(float)                                     LandSteeringMultiplier                                      OFFSET(get<float>, {0x9C8, 4, 0, 0})
	DMember(float)                                     LandMinSpeedSteeringAngle                                   OFFSET(get<float>, {0x9CC, 4, 0, 0})
	DMember(float)                                     LandMaxSpeedSteeringAngle                                   OFFSET(get<float>, {0x9D0, 4, 0, 0})
	DMember(float)                                     DragCoefficientNoAccel                                      OFFSET(get<float>, {0x9D4, 4, 0, 0})
	DMember(float)                                     DragCoefficient2NoAccel                                     OFFSET(get<float>, {0x9D8, 4, 0, 0})
	DMember(float)                                     DragCoefficientMultiplierRoad                               OFFSET(get<float>, {0x9DC, 4, 0, 0})
	DMember(float)                                     DragCoefficientMultiplierGrass                              OFFSET(get<float>, {0x9E0, 4, 0, 0})
	DMember(float)                                     DragCoefficientMultiplierDirt                               OFFSET(get<float>, {0x9E4, 4, 0, 0})
	DMember(float)                                     DragCoefficientMultiplierSnow                               OFFSET(get<float>, {0x9E8, 4, 0, 0})
	DMember(float)                                     DragCoefficientMultiplierIce                                OFFSET(get<float>, {0x9EC, 4, 0, 0})
	DMember(float)                                     DragCoefficientMultiplierMud                                OFFSET(get<float>, {0x9F0, 4, 0, 0})
	DMember(float)                                     MinSteerAlphaForWaterFriction                               OFFSET(get<float>, {0x9F4, 4, 0, 0})
	DMember(float)                                     TurnInPlaceYawStiff                                         OFFSET(get<float>, {0x9F8, 4, 0, 0})
	DMember(float)                                     TurnInPlaceYawDamp                                          OFFSET(get<float>, {0x9FC, 4, 0, 0})
	DMember(float)                                     MaxSteerRollAngle                                           OFFSET(get<float>, {0xA00, 4, 0, 0})
	DMember(float)                                     MaxTurnInPlaceYawAngle                                      OFFSET(get<float>, {0xA04, 4, 0, 0})
	DMember(float)                                     UprightSpringSteerStrength                                  OFFSET(get<float>, {0xA08, 4, 0, 0})
	DMember(float)                                     TurnInPlaceYawStrength                                      OFFSET(get<float>, {0xA0C, 4, 0, 0})
	DMember(float)                                     MaxSpeedForTurnInPlaceKmH                                   OFFSET(get<float>, {0xA10, 4, 0, 0})
	DMember(float)                                     BlendOutExtraSpeedTurnInPlaceKmH                            OFFSET(get<float>, {0xA14, 4, 0, 0})
	DMember(float)                                     MaxPitchForCameraInPlaceSteer                               OFFSET(get<float>, {0xA18, 4, 0, 0})
	DMember(float)                                     SpringLengthMutliplierWater                                 OFFSET(get<float>, {0xA1C, 4, 0, 0})
};
