...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0xA00, 8, 0, 0})
	CMember(class UStaticMeshComponent*)               Mesh_DarkenBG                                               OFFSET(get<T>, {0xA08, 8, 0, 0})
	CMember(class UCameraComponent*)                   CameraPlaceholderGround                                     OFFSET(get<T>, {0xA10, 8, 0, 0})
	...
	CMember(class UTimelineComponent*)                 ChoicePack                                                  OFFSET(get<T>, {0xA20, 8, 0, 0})
	...
	CMember(class UTimelineComponent*)                 Timeline                                                    OFFSET(get<T>, {0xA30, 8, 0, 0})
	...
	CMember(class AStorePinataMaster_Parent_C*)        PinataInLevel                                               OFFSET(get<T>, {0xAA0, 8, 0, 0})
	CMember(class AStoreCardReveal_Parent_C*)          CardRevealInLevel                                           OFFSET(get<T>, {0xAA8, 8, 0, 0})
...
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 11536;
...
public:
	...
	CMember(class AFortPlayerPawn*)                    Cached_Pawn                                                 OFFSET(get<T>, {0xA10, 8, 0, 0})
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0xA00, 8, 0, 0})
	CMember(class UStaticMeshComponent*)               StaticMesh                                                  OFFSET(get<T>, {0xA08, 8, 0, 0})
	CMember(class UCameraComponent*)                   LoginCamera                                                 OFFSET(get<T>, {0xA10, 8, 0, 0})
