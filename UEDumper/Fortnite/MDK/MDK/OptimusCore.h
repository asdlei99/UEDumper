...
public:
	CMember(class UOptimusDeformerInstance*)           DeformerInstance                                            OFFSET(get<T>, {0x40, 8, 0, 0})
};
...
public:
	CMember(class UOptimusFunctionNodeGraph*)          FunctionGraph                                               OFFSET(get<T>, {0x118, 8, 0, 0})
};
...
public:
	CMember(class UOptimusNodeSubGraph*)               SubGraph                                                    OFFSET(get<T>, {0x118, 8, 0, 0})
};
...
public:
	CMember(TArray<TWeakObjectPtr<UOptimusNode*>>)     KernelToNode                                                OFFSET(get<T>, {0x90, 16, 0, 0})
};
...
public:
	...
	CMember(class UOptimusActionStack*)                ActionStack                                                 OFFSET(get<T>, {0x70, 8, 0, 0})
	CMember(EOptimusDeformerStatus)                    Status                                                      OFFSET(get<T>, {0x78, 4, 0, 0})
	CMember(TArray<class UOptimusNodeGraph*>)          Graphs                                                      OFFSET(get<T>, {0x80, 16, 0, 0})
	CMember(class UOptimusComponentSourceBindingContainer*) Bindings                                               OFFSET(get<T>, {0x90, 8, 0, 0})
	CMember(class UOptimusVariableContainer*)          Variables                                                   OFFSET(get<T>, {0x98, 8, 0, 0})
	CMember(class UOptimusResourceContainer*)          Resources                                                   OFFSET(get<T>, {0xA0, 8, 0, 0})
...
public:
	...
	CMember(TArray<class UOptimusNodeGraph*>)          Subgraphs                                                   OFFSET(get<T>, {0x58, 16, 0, 0})
...
/// Size: 0x03
enum EOptimusConstantType : uint32_t
{
...
/// Size: 0x04
enum EOptimusTerminalType : uint32_t
{
...
/// Size: 0x03
enum EOptimusDataDomainType : uint32_t
{
...
/// Size: 0x05
enum EOptimusDeformerStatus : uint32_t
{
...
/// Size: 0x03
enum EOptimusExecutionDomainType : uint32_t
{
...
/// Size: 0x07
enum EOptimusNodeGraphType : uint32_t
{
