...
public:
	...
	// void EvaluateGraphExposedInputs_ExecuteUbergraph_Blueprint_Paper_VIM_AnimGraphNode_AnimDynamics_9E5EF2534AF35AEF656F7798016DF75B(); // [0x211c0a0] BlueprintEvent       
	...
	// void EvaluateGraphExposedInputs_ExecuteUbergraph_Blueprint_Paper_VIM_AnimGraphNode_AnimDynamics_3AF159404BD341EBBF1D83916A014149(); // [0x211c0a0] BlueprintEvent       
	...
	// void EvaluateGraphExposedInputs_ExecuteUbergraph_Blueprint_Paper_VIM_AnimGraphNode_AnimDynamics_ADC4973B4FF994FAB62509B5C600BF73(); // [0x211c0a0] BlueprintEvent       
	...
	// void EvaluateGraphExposedInputs_ExecuteUbergraph_Blueprint_Paper_VIM_AnimGraphNode_AnimDynamics_BCA43E284168E0AB05BB9E98D217441B(); // [0x211c0a0] BlueprintEvent       
	...
	// void ExecuteUbergraph_Blueprint_Paper_VIM(int32_t EntryPoint);                                                           // [0x211c0a0] Final                
};
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x1C68, 8, 0, 0})
	CMember(class UParticleSystemComponent*)           Muzzle_Empty_                                               OFFSET(get<T>, {0x1C70, 8, 0, 0})
	...
	CMember(class UParticleSystem*)                    MuzzleParticleSystem                                        OFFSET(get<T>, {0x1C90, 8, 0, 0})
	DMember(bool)                                      UseDestroyEffect                                            OFFSET(get<bool>, {0x1C98, 1, 0, 0})
	CMember(class UParticleSystem*)                    WeaponDurabilityDestroyEffect                               OFFSET(get<T>, {0x1CA0, 8, 0, 0})
	CMember(class UParticleSystem*)                    WeaponDurabilityDestroyEffectIcon                           OFFSET(get<T>, {0x1CA8, 8, 0, 0})
	DMember(bool)                                      Use_Reload_Particles                                        OFFSET(get<bool>, {0x1CB0, 1, 0, 0})
	DMember(double)                                    LastPlayFXTime                                              OFFSET(get<double>, {0x1CB8, 8, 0, 0})
	DMember(double)                                    MinPlayFXTime                                               OFFSET(get<double>, {0x1CC0, 8, 0, 0})
	DMember(bool)                                      UseShellsOnFire_                                            OFFSET(get<bool>, {0x1CC8, 1, 0, 0})
	DMember(bool)                                      UseShellsOnReload_                                          OFFSET(get<bool>, {0x1CC9, 1, 0, 0})
	DMember(bool)                                      UseShellsOnPump_                                            OFFSET(get<bool>, {0x1CCA, 1, 0, 0})
	CMember(class UNiagaraSystem*)                     Shell_Burst_FX                                              OFFSET(get<T>, {0x1CD0, 8, 0, 0})
	CMember(class UNiagaraSystem*)                     Shell_Looping_FX                                            OFFSET(get<T>, {0x1CD8, 8, 0, 0})
	CMember(class UNiagaraSystem*)                     Reload_System                                               OFFSET(get<T>, {0x1CE0, 8, 0, 0})
	CMember(class UMaterialInterface*)                 Reload_Smoke_Material                                       OFFSET(get<T>, {0x1CE8, 8, 0, 0})
	SMember(FName)                                     ReloadSocketName                                            OFFSET(getStruct<T>, {0x1CF0, 4, 0, 0})
	SMember(FGameplayTag)                              TagToApplyOpticGlint                                        OFFSET(getStruct<T>, {0x1CF4, 4, 0, 0})
	CMember(TArray<class AFortAIPawn*>)                Array_Of_Active_Enemy_AI                                    OFFSET(get<T>, {0x1CF8, 16, 0, 0})
	DMember(bool)                                      Scope___Render_Enemies_To_Custom_Depth_Buffer               OFFSET(get<bool>, {0x1D08, 1, 0, 0})
	SMember(FName)                                     Shells_Socket_Name                                          OFFSET(getStruct<T>, {0x1D0C, 4, 0, 0})
	CMember(TEnumAsByte<En_ShellTypes_01>)             ShellTypeSelect                                             OFFSET(get<T>, {0x1D10, 1, 0, 0})
	DMember(double)                                    Shells_Spawn_Rate_Scale                                     OFFSET(get<double>, {0x1D18, 8, 0, 0})
	SMember(FVector)                                   ShellsRotationRate                                          OFFSET(getStruct<T>, {0x1D20, 24, 0, 0})
	SMember(FVector)                                   Shells_Velocity                                             OFFSET(getStruct<T>, {0x1D38, 24, 0, 0})
	SMember(FVector)                                   Shells_Gravity                                              OFFSET(getStruct<T>, {0x1D50, 24, 0, 0})
	SMember(FVector)                                   Shells_Size                                                 OFFSET(getStruct<T>, {0x1D68, 24, 0, 0})
	DMember(double)                                    Target_Scope_Vignette_Blur_Screen_Percentage                OFFSET(get<double>, {0x1D80, 8, 0, 0})
	DMember(double)                                    ScopeCameraOffsetX                                          OFFSET(get<double>, {0x1D88, 8, 0, 0})
	DMember(double)                                    ScopeCameraOffsetY                                          OFFSET(get<double>, {0x1D90, 8, 0, 0})
	DMember(double)                                    Scope_Camera_Offset_Amount                                  OFFSET(get<double>, {0x1D98, 8, 0, 0})
	DMember(double)                                    Inherit_Parent_Velocity                                     OFFSET(get<double>, {0x1DA0, 8, 0, 0})
	DMember(double)                                    Cylindrical_Radius                                          OFFSET(get<double>, {0x1DA8, 8, 0, 0})
	DMember(double)                                    Cylindrical_Height                                          OFFSET(get<double>, {0x1DB0, 8, 0, 0})
	SMember(FLinearColor)                              Shell_Color                                                 OFFSET(getStruct<T>, {0x1DB8, 16, 0, 0})
	CMember(class UNiagaraComponent*)                  Spawned_Shells                                              OFFSET(get<T>, {0x1DC8, 8, 0, 0})
	DMember(bool)                                      DebugShellsSocket_                                          OFFSET(get<bool>, {0x1DD0, 1, 0, 0})
	CMember(class USoundBase*)                         Sound_ScopeZoomIn                                           OFFSET(get<T>, {0x1DD8, 8, 0, 0})
	CMember(class USoundBase*)                         Sound_ScopeZoomOut                                          OFFSET(get<T>, {0x1DE0, 8, 0, 0})
	CMember(class UNiagaraComponent*)                  Alteration_Ambient_PS                                       OFFSET(get<T>, {0x1DE8, 8, 0, 0})
	SMember(FGameplayTagContainer)                     ReticleHUDElementTags                                       OFFSET(getStruct<T>, {0x1DF0, 32, 0, 0})
	DMember(bool)                                      Is_Wind_Enabled                                             OFFSET(get<bool>, {0x1E10, 1, 0, 0})
	CMember(class UParticleSystem*)                    MuzzleWindParticleSystem                                    OFFSET(get<T>, {0x1E18, 8, 0, 0})
	CMember(class UParticleSystem*)                    MuzzleParticleSystem1P                                      OFFSET(get<T>, {0x1E20, 8, 0, 0})
	...
	DMember(bool)                                      IsMuzzleNiagara                                             OFFSET(get<bool>, {0x1EA0, 1, 0, 0})
	CMember(class UNiagaraSystem*)                     MuzzleNiagaraSystemInstance                                 OFFSET(get<T>, {0x1EA8, 8, 0, 0})
	CMember(TWeakObjectPtr<UNiagaraSystem*>)           MuzzleNiagaraSystemAsset                                    OFFSET(get<T>, {0x1EB0, 32, 0, 0})
	CMember(class UNiagaraComponent*)                  MuzzleNiagaraComponentInstance                              OFFSET(get<T>, {0x1ED0, 8, 0, 0})
	CMember(TArray<class UParticleSystemComponent*>)   MuzzleParticleSystemComponents                              OFFSET(get<T>, {0x1ED8, 16, 0, 0})
	DMember(double)                                    Muzzle_ChanceOfLargeFlash                                   OFFSET(get<double>, {0x1EE8, 8, 0, 0})
	DMember(double)                                    Muzzle_FlashLarge_MinScale                                  OFFSET(get<double>, {0x1EF0, 8, 0, 0})
	DMember(double)                                    Muzzle_FlashLarge_MaxScale                                  OFFSET(get<double>, {0x1EF8, 8, 0, 0})
	DMember(double)                                    Muzzle_FlashSmall_MinScale                                  OFFSET(get<double>, {0x1F00, 8, 0, 0})
	DMember(double)                                    Muzzle_FlashSmall_MaxScale                                  OFFSET(get<double>, {0x1F08, 8, 0, 0})
	...
	SMember(FScalableFloat)                            UseNativeFX                                                 OFFSET(getStruct<T>, {0x1F20, 40, 0, 0})
	SMember(FScalableFloat)                            UseUpdatedFeedback                                          OFFSET(getStruct<T>, {0x1F48, 40, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnStartFiring                                               OFFSET(getStruct<T>, {0x1F70, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnPersistentFireStopped                                     OFFSET(getStruct<T>, {0x1F80, 16, 0, 0})
	CMember(class UStaticMesh*)                        ScopeMesh                                                   OFFSET(get<T>, {0x1F90, 8, 0, 0})
	CMember(class UStaticMeshComponent*)               ScopeMesh1P_Spawned                                         OFFSET(get<T>, {0x1F98, 8, 0, 0})
	CMember(TArray<class UMaterialInterface*>)         ScopeMaterialOverrides                                      OFFSET(get<T>, {0x1FA0, 16, 0, 0})
	DMember(float)                                     Reload_Smoke_Lifetime                                       OFFSET(get<float>, {0x1FB0, 4, 0, 0})
	DMember(float)                                     Reload_Smoke_Width_Scale                                    OFFSET(get<float>, {0x1FB4, 4, 0, 0})
	SMember(FLinearColor)                              BaseColorAlpha                                              OFFSET(getStruct<T>, {0x1FB8, 16, 0, 0})
	DMember(bool)                                      Use_Emissive_in_Reload                                      OFFSET(get<bool>, {0x1FC8, 1, 0, 0})
	SMember(FLinearColor)                              Reload_Emissive_Color                                       OFFSET(getStruct<T>, {0x1FCC, 16, 0, 0})
	DMember(bool)                                      Is_Rocket_Launcher                                          OFFSET(get<bool>, {0x1FDC, 1, 0, 0})
	SMember(FLinearColor)                              Rocket_Launcher_Spark_Color                                 OFFSET(getStruct<T>, {0x1FE0, 16, 0, 0})
	DMember(bool)                                      Reload_Ejects_Shells                                        OFFSET(get<bool>, {0x1FF0, 1, 0, 0})
	DMember(bool)                                      IsPaprika___MuzzleFX_                                       OFFSET(get<bool>, {0x1FF1, 1, 0, 0})
	CMember(class UNiagaraComponent*)                  OpticGlintComp                                              OFFSET(get<T>, {0x1FF8, 8, 0, 0})
	CMember(class UFXSystemAsset*)                     Muzzle_System                                               OFFSET(get<T>, {0x2000, 8, 0, 0})
	DMember(float)                                     Muzzle_Hue_Control                                          OFFSET(get<float>, {0x2008, 4, 0, 0})
	DMember(float)                                     Muzzle_Core_Cap_Scale                                       OFFSET(get<float>, {0x200C, 4, 0, 0})
	SMember(FVector)                                   Muzzle_Core_Scale                                           OFFSET(getStruct<T>, {0x2010, 24, 0, 0})
	DMember(float)                                     Spark_Amount_Scale                                          OFFSET(get<float>, {0x2028, 4, 0, 0})
	DMember(float)                                     Smoke_Size_Scale                                            OFFSET(get<float>, {0x202C, 4, 0, 0})
	SMember(FLinearColor)                              MuzzleSmokeInitialColor                                     OFFSET(getStruct<T>, {0x2030, 16, 0, 0})
	DMember(float)                                     Smoke_Initial_Color_Scale_Variance                          OFFSET(get<float>, {0x2040, 4, 0, 0})
	DMember(float)                                     Smoke_Emissive_Scale                                        OFFSET(get<float>, {0x2044, 4, 0, 0})
	DMember(bool)                                      Use_Heated_Elements                                         OFFSET(get<bool>, {0x2048, 1, 0, 0})
	DMember(float)                                     Decal_Size                                                  OFFSET(get<float>, {0x204C, 4, 0, 0})
	SMember(FVector)                                   Decal_Offset                                                OFFSET(getStruct<T>, {0x2050, 24, 0, 0})
	DMember(float)                                     Decal_Alpha                                                 OFFSET(get<float>, {0x2068, 4, 0, 0})
	CMember(class UFXSystemComponent*)                 Spawned_Muzzle_System                                       OFFSET(get<T>, {0x2070, 8, 0, 0})
	DMember(int32_t)                                   Burst_Loops                                                 OFFSET(get<int32_t>, {0x2078, 4, 0, 0})
	DMember(bool)                                      Muzzle_BakedSupressor__Always_Suppressed_                   OFFSET(get<bool>, {0x207C, 1, 0, 0})
	DMember(bool)                                      bIsLocal                                                    OFFSET(get<bool>, {0x207D, 1, 0, 0})
	CMember(class UNiagaraSystem*)                     Magazine_Eject_System                                       OFFSET(get<T>, {0x2080, 8, 0, 0})
	SMember(FName)                                     Magazine_Eject_Socket_Name                                  OFFSET(getStruct<T>, {0x2088, 4, 0, 0})
	DMember(bool)                                      Use_Magazine_Eject                                          OFFSET(get<bool>, {0x208C, 1, 0, 0})
	CMember(class UMaterialInterface*)                 Magazine_Eject_Material                                     OFFSET(get<T>, {0x2090, 8, 0, 0})
	CMember(class UStaticMesh*)                        Magazine_Eject_Model                                        OFFSET(get<T>, {0x2098, 8, 0, 0})


	/// Functions
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.Activate Magazine Eject FX
	// void Activate Magazine Eject FX();                                                                                       // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.MuzzleModCheck
	// void MuzzleModCheck(bool& isMuzzleBrake, bool& isMuzzleSupressor, bool& isMuzzleBreacher);                               // [0x211c0a0] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.MuzzleADSCheck
	// void MuzzleADSCheck(bool& Return ADS Bool);                                                                              // [0x211c0a0] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.ShowOpticGlint
	// void ShowOpticGlint(bool AimDownsights);                                                                                 // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.AddRandomScale_Paprika
	// void AddRandomScale_Paprika();                                                                                           // [0x211c0a0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.StopLocalForceFeedback
	// void StopLocalForceFeedback(class UForceFeedbackEffect* ForceFeedbackEffect, FName tag);                                 // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.PlayLocalForceFeedback
	// void PlayLocalForceFeedback(class UForceFeedbackEffect* ForceFeedbackEffect, FName tag, bool bLooping);                  // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.getScopeComp
	// void getScopeComp(class UStaticMeshComponent*& ScopeComponent);                                                          // [0x211c0a0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.initScope
	// void initScope();                                                                                                        // [0x211c0a0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.IsNewFeedbackEnabled
	// void IsNewFeedbackEnabled(bool& Enabled);                                                                                // [0x211c0a0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.LocalReloadStarted
	// void LocalReloadStarted(float ReloadTime, EFortWeaponReloadType ReloadType);                                             // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.GetCorrectMuzzleNiagaraSystem
	// void GetCorrectMuzzleNiagaraSystem(TWeakObjectPtr<UNiagaraSystem*>& OutNiagaraSystem);                                   // [0x211c0a0] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.PlayScopeOutAudio
	// void PlayScopeOutAudio();                                                                                                // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.GetScopeParameters
	// void GetScopeParameters(class UStaticMeshComponent*& ScopeComponent, FVector2D& DepthOfFieldVignetteRange, FVector& WeaponSightsOffset); // [0x211c0a0] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.GetActiveMuzzleComponents
	// void GetActiveMuzzleComponents(TArray<UFXSystemComponent*>& NewParam);                                                   // [0x211c0a0] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.SetActiveMuzzleComponent
	// void SetActiveMuzzleComponent(bool NiagaraEnabled);                                                                      // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.StopScopedAudio
	// void StopScopedAudio();                                                                                                  // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.StartScopedAudio
	// void StartScopedAudio();                                                                                                 // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.SetPostProcessParams
	// void SetPostProcessParams(double InputPin);                                                                              // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.SetActiveAlterationIdleParticles
	// void SetActiveAlterationIdleParticles(bool Active);                                                                      // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.ShowReticle
	// void ShowReticle();                                                                                                      // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.HideReticle
	// void HideReticle();                                                                                                      // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.ActivateOrDeactivateWindParticle
	// void ActivateOrDeactivateWindParticle(bool bNewActive);                                                                  // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.DeactivateMuzzleFX
	// void DeactivateMuzzleFX();                                                                                               // [0x211c0a0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.ActivateReloadSmokeFX
	// void ActivateReloadSmokeFX();                                                                                            // [0x211c0a0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.ActivateShellsFX
	// void ActivateShellsFX(bool bool);                                                                                        // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.DeactivateShellsFX
	// void DeactivateShellsFX();                                                                                               // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.SetupShellFX
	// void SetupShellFX();                                                                                                     // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.UpdateShellEmittersFX
	// void UpdateShellEmittersFX();                                                                                            // [0x211c0a0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.Muzzle Play Reload FX
	// void Muzzle Play Reload FX(TEnumAsByte<EFortReloadFXState> Selection);                                                   // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.Muzzle Flash FX
	// void Muzzle Flash FX(bool Persistent Fire);                                                                              // [0x211c0a0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.SetWpnRarity
	// void SetWpnRarity();                                                                                                     // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.AddRandomScale
	// void AddRandomScale();                                                                                                   // [0x211c0a0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void AnimateScopePostProcess__FinishedFunc();                                                                            // [0x211c0a0] BlueprintEvent       
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.AnimateScopePostProcess__UpdateFunc
	// void AnimateScopePostProcess__UpdateFunc();                                                                              // [0x211c0a0] BlueprintEvent       
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.AnimateScopePostProcess__Toggle Scope__EventFunc
	// void AnimateScopePostProcess__Toggle Scope__EventFunc();                                                                 // [0x211c0a0] BlueprintEvent       
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnLoaded_4D1409A247BFDB4C074B628406FC7A72
	// void OnLoaded_4D1409A247BFDB4C074B628406FC7A72(class UObject* Loaded);                                                   // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnLoaded_3A9BBE884A5C5966375089938B7DC0CA
	// void OnLoaded_3A9BBE884A5C5966375089938B7DC0CA(class UObject* Loaded);                                                   // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnLoaded_83457BA843174AC6288682A342EBEAD9
	// void OnLoaded_83457BA843174AC6288682A342EBEAD9(class UObject* Loaded);                                                   // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnLoaded_5B08633343C4DA6FF40449A8A36357E4
	// void OnLoaded_5B08633343C4DA6FF40449A8A36357E4(class UObject* Loaded);                                                   // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnPlayWeaponFireFX
	// void OnPlayWeaponFireFX(bool bPersistentFire, bool bSecondaryFire);                                                      // [0x211c0a0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnStopWeaponFireFX
	// void OnStopWeaponFireFX();                                                                                               // [0x211c0a0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnPlayReloadFX
	// void OnPlayReloadFX(TEnumAsByte<EFortReloadFXState> ReloadStage);                                                        // [0x211c0a0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnSetTargeting
	// void OnSetTargeting(bool bNewIsTargeting);                                                                               // [0x211c0a0] Event|Public|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.K2_OnUnEquip
	// void K2_OnUnEquip();                                                                                                     // [0x211c0a0] Event|Public|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.InitializeScopeVariables
	// void InitializeScopeVariables();                                                                                         // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.Update Enemy Custom Depths
	// void Update Enemy Custom Depths(bool Enable Or Disable, int32_t StencilBufferValue);                                     // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnWeaponAttached
	// void OnWeaponAttached();                                                                                                 // [0x211c0a0] Event|Public|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnInitAlteration
	// void OnInitAlteration(class UFortAlterationItemDefinition* NewAlteration);                                               // [0x211c0a0] Event|Protected|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnInitCosmeticAlterations
	// void OnInitCosmeticAlterations(FFortCosmeticModification CosmeticMod);                                                   // [0x211c0a0] Event|Protected|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.ShellsON_(onPump)
	// void ShellsON_(onPump)();                                                                                                // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.OnEquippedWeaponDestory
	// void OnEquippedWeaponDestory();                                                                                          // [0x211c0a0] BlueprintCosmetic|Event|Protected|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.SetWeaponPierceThrough
	// void SetWeaponPierceThrough(bool Enable, int32_t TargetLimit);                                                           // [0x211c0a0] Net|NetReliableNetServer|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/Blueprints/B_Ranged_Generic.B_Ranged_Generic_C.SetWeaponPierceThrough_ClientRep
	// void SetWeaponPierceThrough_ClientRep(bool Enable, int32_t TargetLimit);                                                 // [0x211c0a0] Net|NetReliableNetClient|BlueprintCallable|BlueprintEvent 
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x1748, 8, 0, 0})
	CMember(class UParticleSystemComponent*)           MeleeHeavy_PSC                                              OFFSET(get<T>, {0x1750, 8, 0, 0})
	CMember(class UParticleSystem*)                    MeleeHeavy_ParticleSystem                                   OFFSET(get<T>, {0x1758, 8, 0, 0})
	CMember(class UParticleSystem*)                    WeaponDurabilityDestroyEffect                               OFFSET(get<T>, {0x1760, 8, 0, 0})
	CMember(class UParticleSystem*)                    WeaponDurabilityDestroyEffectIcon                           OFFSET(get<T>, {0x1768, 8, 0, 0})
	DMember(bool)                                      UseDestroyEffect                                            OFFSET(get<bool>, {0x1770, 1, 0, 0})
	CMember(class UNiagaraComponent*)                  Alteration_Ambient_PS                                       OFFSET(get<T>, {0x1778, 8, 0, 0})
	SMember(FVector)                                   Effects_Color_Level                                         OFFSET(getStruct<T>, {0x1780, 24, 0, 0})
	DMember(bool)                                      Equipped                                                    OFFSET(get<bool>, {0x1798, 1, 0, 0})
	DMember(bool)                                      bEquipPendingInstigator                                     OFFSET(get<bool>, {0x1799, 1, 0, 0})
	DMember(bool)                                      UseTimeofDayControl                                         OFFSET(get<bool>, {0x179A, 1, 0, 0})
	DMember(bool)                                      Swing_Right_                                                OFFSET(get<bool>, {0x179B, 1, 0, 0})
	CMember(class UFXSystemComponent*)                 Impact_FX                                                   OFFSET(get<T>, {0x17A0, 8, 0, 0})
	SMember(FRotator)                                  Left_Swing_Rotation                                         OFFSET(getStruct<T>, {0x17A8, 24, 0, 0})
	SMember(FRotator)                                  Right_Swing_Rotation                                        OFFSET(getStruct<T>, {0x17C0, 24, 0, 0})
	...
	// int32_t Setup Swing Montage Section Index();                                                                             // [0x211c0a0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void Binding Time of Day Control(bool Bind / Unbind (T/F));                                                              // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void UnbindSwingAnimTrailEvents();                                                                                       // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/FORT_Melee/Blueprints/B_Athena_Pickaxe_Generic.B_Athena_Pickaxe_Generic_C.BindSwingAnimTrailEvents
	// void BindSwingAnimTrailEvents();                                                                                         // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/FORT_Melee/Blueprints/B_Athena_Pickaxe_Generic.B_Athena_Pickaxe_Generic_C.PlayCQCPickaxeEnemyAudio
	// void PlayCQCPickaxeEnemyAudio(FHitResult Hit Result);                                                                    // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void SetActiveAlterationIdleParticles(bool Active, bool Reset);                                                          // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void OnStatChanged_F171C56748FEA3E19F93088E968D3E21(FName StatName, int32_t StatValue);                                  // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void OnLoaded_5BC5DA3B4E308BE7A188FBB2571333D2(class UObject* Loaded);                                                   // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void PlayRClickImpacts();                                                                                                // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void TODCheck(EFortDayPhase CurrentDayPhase, EFortDayPhase PreviousDayPhase, bool bAtCreation);                          // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void HandleWeaponHolstered();                                                                                            // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /Game/Weapons/FORT_Melee/Blueprints/B_Athena_Pickaxe_Generic.B_Athena_Pickaxe_Generic_C.Vehicle Passenger
	// void Vehicle Passenger(class AFortPlayerPawn* FortPlayerPawn, class AActor* NewVehicle, class AActor* OldVehicle);       // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_Athena_Pickaxe_Generic(int32_t EntryPoint);                                                      // [0x211c0a0] Final|HasDefaults    
};
...
public:
	...
	// void AnimGraph(FPoseLink InPose, FPoseLink& AnimGraph);                                                                  // [0x211c0a0] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void BlueprintInitializeAnimation();                                                                                     // [0x211c0a0] Event|Public|BlueprintEvent 
	...
	// void ExecuteUbergraph_EmberRae_Axe_L_AnimBP_Post(int32_t EntryPoint);                                                    // [0x211c0a0] Final                
};
...
public:
	...
	// void ExecuteUbergraph_EmberRae_Axe_R_AnimBP_Post(int32_t EntryPoint);                                                    // [0x211c0a0] Final                
};
...
public:
	...
	// void ExecuteUbergraph_M_MED_Patches_Axe_AnimBP(int32_t EntryPoint);                                                      // [0x211c0a0] Final|HasDefaults    
};
...
public:
	...
	// FGameplayTag DetermineVariantSelection(FFortAthenaLoadout& Loadout);                                                     // [0x211c0a0] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|Const 
};
...
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 6921;

public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x1A68, 8, 0, 0})
	DMember(bool)                                      Equipped                                                    OFFSET(get<bool>, {0x1A70, 1, 0, 0})
	CMember(class UNiagaraComponent*)                  Alteration_Ambient_PS                                       OFFSET(get<T>, {0x1A78, 8, 0, 0})
	CMember(class UParticleSystem*)                    MeleeHeavy_ParticleSystem                                   OFFSET(get<T>, {0x1A80, 8, 0, 0})
	CMember(class UParticleSystemComponent*)           MeleeHeavy_PSC                                              OFFSET(get<T>, {0x1A88, 8, 0, 0})
	DMember(bool)                                      UseDestroyEffect                                            OFFSET(get<bool>, {0x1A90, 1, 0, 0})
	CMember(class UParticleSystem*)                    WeaponDurabilityDestroyEffect                               OFFSET(get<T>, {0x1A98, 8, 0, 0})
	CMember(class UParticleSystem*)                    WeaponDurabilityDestroyEffectIcon                           OFFSET(get<T>, {0x1AA0, 8, 0, 0})
	CMember(class UNiagaraComponent*)                  Offhand_Alteration_Ambient_PS                               OFFSET(get<T>, {0x1AA8, 8, 0, 0})
	DMember(bool)                                      bEquipPendingInstigator                                     OFFSET(get<bool>, {0x1AB0, 1, 0, 0})
	SMember(FName)                                     Offhand_Socket_Name                                         OFFSET(getStruct<T>, {0x1AB4, 4, 0, 0})
	CMember(class UAnimMontage*)                       MontageReference                                            OFFSET(get<T>, {0x1AB8, 8, 0, 0})
	DMember(bool)                                      UseTimeofDayControl                                         OFFSET(get<bool>, {0x1AC0, 1, 0, 0})
	CMember(class UFXSystemComponent*)                 Impact_FX                                                   OFFSET(get<T>, {0x1AC8, 8, 0, 0})
	DMember(bool)                                      Swing_Right_                                                OFFSET(get<bool>, {0x1AD0, 1, 0, 0})
	SMember(FRotator)                                  Left_Swing_Rotation                                         OFFSET(getStruct<T>, {0x1AD8, 24, 0, 0})
	SMember(FRotator)                                  Right_Swing_Rotation                                        OFFSET(getStruct<T>, {0x1AF0, 24, 0, 0})
	DMember(bool)                                      Swing_Right_1                                               OFFSET(get<bool>, {0x1B08, 1, 0, 0})
	...
	// void Unbind Dual Melee Swing Events();                                                                                   // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Bind Dual Melee Swing Events();                                                                                     // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Set Active Alteration Idle Particles(bool Active, bool Reset);                                                      // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void OnStatChanged_9F72D14C4573F491E38302B51F08A0B8(FName StatName, int32_t StatValue);                                  // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void OnLoaded_F1C7B8E24518F4F2DE2C8DBABB95E06D(class UObject* Loaded);                                                   // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void Swing Left End();                                                                                                   // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void Swing Right End();                                                                                                  // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void SwingRight_Common();                                                                                                // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void SwingLeft_Common();                                                                                                 // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void Swing Left();                                                                                                       // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void Swing Right();                                                                                                      // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void Swing Left 2();                                                                                                     // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void Swing Right 2();                                                                                                    // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_Athena_Pickaxe_DualWield_Generic(int32_t EntryPoint);                                            // [0x211c0a0] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_LoudPhoenix_Axe_AnimBP(int32_t EntryPoint);                                                        // [0x211c0a0] Final                
};
...
public:
	...
	// void ExecuteUbergraph_NitroFlow_Axe_AnimBP(int32_t EntryPoint);                                                          // [0x211c0a0] Final                
};
...
public:
	...
	// void ExecuteUbergraph_HighTower_Tapas_Axe_AnimBP(int32_t EntryPoint);                                                    // [0x211c0a0] Final                
};
...
public:
	...
	// void ExecuteUbergraph_Mechanical_Engineer_Female_AnimBP(int32_t EntryPoint);                                             // [0x211c0a0] Final                
};
...
public:
	...
	// void ExecuteUbergraph_MetalScout_Axe_AnimBP(int32_t EntryPoint);                                                         // [0x211c0a0] Final                
};
...
public:
	...
	// void ExecuteUbergraph_GoldenGuard_Axe_AnimBP(int32_t EntryPoint);                                                        // [0x211c0a0] Final                
};
