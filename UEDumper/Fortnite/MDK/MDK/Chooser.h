...
public:
	CMember(EChooserEvaluationFrequency)               EvaluationFrequency                                         OFFSET(get<T>, {0xC0, 4, 0, 0})
	SMember(FInstancedStruct)                          Chooser                                                     OFFSET(getStruct<T>, {0xC8, 16, 0, 0})
	CMember(class UMirrorDataTable*)                   MirrorDataTable                                             OFFSET(get<T>, {0xD8, 8, 0, 0})
	DMember(float)                                     BlendSpaceX                                                 OFFSET(get<float>, {0xE0, 4, 0, 0})
	DMember(float)                                     BlendSpaceY                                                 OFFSET(get<float>, {0xE4, 4, 0, 0})
...
/// Size: 0x04
enum EContextObjectDirection : uint32_t
{
...
/// Size: 0x05
enum EEnumColumnCellValueComparison : uint32_t
{
...
/// Size: 0x03
enum EObjectChooserResultType : uint32_t
{
...
/// Size: 0x05
enum EObjectColumnCellValueComparison : uint32_t
{
...
/// Size: 0x05
enum EChooserEvaluationFrequency : uint32_t
{
