...
public:
	...
	DMember(float)                                     MinSpeed                                                    OFFSET(get<float>, {0xF0, 4, 0, 0})
	DMember(float)                                     MaxSpeed                                                    OFFSET(get<float>, {0xF4, 4, 0, 0})
	CMember(class UCurveFloat*)                        SpeedCurve                                                  OFFSET(get<T>, {0xF8, 8, 0, 0})
	DMember(float)                                     FloorTraceHeight                                            OFFSET(get<float>, {0x100, 4, 0, 0})
	CMember(class UCurveVector*)                       PathOffsetCurve                                             OFFSET(get<T>, {0x108, 8, 0, 0})
	SMember(FVector)                                   PreviousEndLocationWithoutOffset                            OFFSET(getStruct<T>, {0x110, 24, 0, 0})
};
