...
public:
	...
	CMember(class UArrowComponent*)                    Arrow                                                       OFFSET(get<T>, {0xA08, 8, 0, 0})
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0xA00, 8, 0, 0})
	CMember(class UCameraComponent*)                   CameraActor                                                 OFFSET(get<T>, {0xA08, 8, 0, 0})
	DMember(bool)                                      MouseDown                                                   OFFSET(get<bool>, {0xA10, 1, 0, 0})
	CMember(class AFortPlayerPawn*)                    CachedPawn                                                  OFFSET(get<T>, {0xA18, 8, 0, 0})
