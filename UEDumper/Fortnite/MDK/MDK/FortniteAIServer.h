...
public:
	CMember(class UClass*)                             ProjectionNavigationQueryFilterClass                        OFFSET(get<T>, {0x1F0, 8, 0, 0})
	CMember(class UClass*)                             ValidNavigationQueryFilterClassOverride                     OFFSET(get<T>, {0x1F8, 8, 0, 0})
	SMember(FScalableFloat)                            MaximumTimeToHelpFromLastPlayerDamage                       OFFSET(getStruct<T>, {0x200, 40, 0, 0})
	SMember(FScalableFloat)                            KeepTargetTimeOnWeaponTrigger                               OFFSET(getStruct<T>, {0x228, 40, 0, 0})
	SMember(FScalableFloat)                            AmountOfTimesPlayerBuiltStructuresNeedToBeDamaged           OFFSET(getStruct<T>, {0x250, 40, 0, 0})
	SMember(FScalableFloat)                            TimeToTrackDamagedActors                                    OFFSET(getStruct<T>, {0x278, 40, 0, 0})
	SMember(FScalableFloat)                            MaxDistanceFromActorForFallbackNoHarvestBehaviour           OFFSET(getStruct<T>, {0x2A0, 40, 0, 0})
	CMember(TArray<class UClass*>)                     GEsToApplyOnFallbackBehaviorTrigger                         OFFSET(get<T>, {0x2C8, 16, 0, 0})
	CMember(TArray<class UClass*>)                     GEsToApplyOnCannotDamageBehaviorTrigger                     OFFSET(get<T>, {0x2D8, 16, 0, 0})
	SMember(FName)                                     HarvestTargetKeyName                                        OFFSET(getStruct<T>, {0x2E8, 4, 0, 0})
	SMember(FName)                                     HarvestTargetHitPointKeyName                                OFFSET(getStruct<T>, {0x2F0, 4, 0, 0})
	SMember(FName)                                     HarvestDestinationKeyName                                   OFFSET(getStruct<T>, {0x2F8, 4, 0, 0})
	SMember(FName)                                     FallbackBehaviorKeyName                                     OFFSET(getStruct<T>, {0x300, 4, 0, 0})
	SMember(FName)                                     CannotDamageKeyName                                         OFFSET(getStruct<T>, {0x308, 4, 0, 0})
	SMember(FName)                                     WeaponTriggerMeleeKeyName                                   OFFSET(getStruct<T>, {0x310, 4, 0, 0})
...
public:
	...
	CMember(class UEnvQuery*)                          FindAwayLocationFromPawnQueryTemplate                       OFFSET(get<T>, {0x290, 8, 0, 0})
...
public:
	CMember(TArray<class UObject*>)                    ReferenceHolder                                             OFFSET(get<T>, {0x70, 16, 0, 0})
	CMember(TArray<FFortBTService_InjectionTagKey>)    InjectionTagsKeys                                           OFFSET(get<T>, {0x80, 16, 0, 0})
	SMember(FName)                                     InjectionItemKeyName                                        OFFSET(getStruct<T>, {0x90, 4, 0, 0})
};
...
public:
	...
	CMember(class AActor*)                             CurrentThreatActorAvoiding                                  OFFSET(get<T>, {0x1C0, 8, 0, 0})
	CMember(class UFortAthenaAIBotEvasiveManeuversDigestedSkillSet*) CacheEMDigestedSkillSet                       OFFSET(get<T>, {0x1C8, 8, 0, 0})
};
...
public:
	...
	CMember(class UEnvQuery*)                          TeleportToConverterQueryTemplate                            OFFSET(get<T>, {0x290, 8, 0, 0})
	...
	SMember(FGameplayTagQuery)                         RequiredTagQueryToTargetConverterDamagedPawn                OFFSET(getStruct<T>, {0x2B0, 72, 0, 0})
	CMember(class AFortPawn*)                          ConverterPawn                                               OFFSET(get<T>, {0x360, 8, 0, 0})
	CMember(class UFortAthenaAIRuntimeParameters_AIBotConvert*) CachedAIBotConvertParameters                       OFFSET(get<T>, {0x368, 8, 0, 0})
...
public:
	...
	CMember(TArray<class AFortPlayerPawnAthena*>)      AllyPawns                                                   OFFSET(get<T>, {0x1B0, 16, 0, 0})
	SMember(FVector)                                   CachedCurrentDestination                                    OFFSET(getStruct<T>, {0x1C0, 24, 0, 0})
	CMember(class UFortAthenaAIBotDBNODigestedSkillSet*) DBNOSkillSet                                              OFFSET(get<T>, {0x1D8, 8, 0, 0})
	CMember(class UFortAthenaAICoverComponent*)        CachedCoverComponent                                        OFFSET(get<T>, {0x1E0, 8, 0, 0})
	CMember(class UFortAthenaAIRuntimeParameters_DBNOBehavior*) DBNOBehaviorRuntimeParameters                      OFFSET(get<T>, {0x1E8, 8, 0, 0})
...
public:
	CMember(class AFortAIDirector*)                    CachedAIDirector                                            OFFSET(get<T>, {0x1A8, 8, 0, 0})
	...
	CMember(TArray<TWeakObjectPtr<AActor*>>)           ActorsInArea                                                OFFSET(get<T>, {0x1F0, 16, 0, 0})
};
...
public:
	...
	CMember(class AActor*)                             CurrentActorFleeingFrom                                     OFFSET(get<T>, {0x1D8, 8, 0, 0})
};
...
public:
	...
	CMember(class UClass*)                             SearchQueryFilterClass                                      OFFSET(get<T>, {0x1C0, 8, 0, 0})
	CMember(class UFortAthenaAIBotAimingDigestedSkillSet*) CacheAimingDigestedSkillSet                             OFFSET(get<T>, {0x1D8, 8, 0, 0})
	CMember(class UFortAthenaAIBotAttackingDigestedSkillSet*) CacheAttackingDigestedSkillSet                       OFFSET(get<T>, {0x1E0, 8, 0, 0})
	CMember(class UFortAthenaAIBotUnstuckDigestedSkillSet*) CachedUnstuckSkillSet                                  OFFSET(get<T>, {0x1E8, 8, 0, 0})
	CMember(class AActor*)                             InvestigatingSupportingActor                                OFFSET(get<T>, {0x238, 8, 0, 0})
	CMember(class ABuildingSMActor*)                   UnderminingBuildingActor                                    OFFSET(get<T>, {0x240, 8, 0, 0})
	CMember(class AActor*)                             ExcludeReachingTarget                                       OFFSET(get<T>, {0x248, 8, 0, 0})
};
...
public:
	...
	SMember(FName)                                     TargetContextReachableKeyName                               OFFSET(getStruct<T>, {0x1D0, 4, 0, 0})
	SMember(FName)                                     TargetContextInsideLeashKeyName                             OFFSET(getStruct<T>, {0x1D4, 4, 0, 0})
	CMember(class UFortAthenaAIBotAttackingDigestedSkillSet*) AttackingSkillSet                                    OFFSET(get<T>, {0x1F0, 8, 0, 0})
};
...
public:
	...
	CMember(class UClass*)                             NavigationQueryFilterClass                                  OFFSET(get<T>, {0x1F0, 8, 0, 0})
	...
	CMember(class AFortGameModeAthena*)                CacheAthenaGameMode                                         OFFSET(get<T>, {0x218, 8, 0, 0})
};
...
public:
	...
	CMember(class AActor*)                             ExcludeReachingTarget                                       OFFSET(get<T>, {0x1B8, 8, 0, 0})
};
...
public:
	SMember(FName)                                     WeaponReloadName                                            OFFSET(getStruct<T>, {0x1F8, 4, 0, 0})
	SMember(FName)                                     WeaponFireName                                              OFFSET(getStruct<T>, {0x1FC, 4, 0, 0})
	SMember(FName)                                     RangeAttackIsReadyToFireName                                OFFSET(getStruct<T>, {0x200, 4, 0, 0})
	SMember(FName)                                     WeaponTargetingName                                         OFFSET(getStruct<T>, {0x204, 4, 0, 0})
	SMember(FName)                                     AggressivenessName                                          OFFSET(getStruct<T>, {0x208, 4, 0, 0})
	SMember(FName)                                     HasLoSOnThreatName                                          OFFSET(getStruct<T>, {0x20C, 4, 0, 0})
	SMember(FName)                                     UrgentMovementKeyName                                       OFFSET(getStruct<T>, {0x210, 4, 0, 0})
	DMember(bool)                                      bAlwaysAllowTargetingEvaluation                             OFFSET(get<bool>, {0x222, 1, 0, 0})
	DMember(bool)                                      bSkipADSEvaluation                                          OFFSET(get<bool>, {0x223, 1, 0, 0})
	DMember(bool)                                      bConsiderLoF                                                OFFSET(get<bool>, {0x224, 1, 0, 0})
	DMember(bool)                                      bShouldValidateRangedWeapon                                 OFFSET(get<bool>, {0x225, 1, 0, 0})
	DMember(float)                                     RangeReachHysteresisRatio                                   OFFSET(get<float>, {0x228, 4, 0, 0})
	CMember(class UFortAthenaAIBotRangeAttackDigestedSkillSet*) CacheRangeAttackDigestedSkillSet                   OFFSET(get<T>, {0x248, 8, 0, 0})
	CMember(class UFortAthenaAIBotAimingDigestedSkillSet*) CacheAimingDigestedSkillSet                             OFFSET(get<T>, {0x250, 8, 0, 0})
	CMember(class UFortAthenaAIBotPerceptionDigestedSkillSet*) CachePerceptionDigestedSkillSet                     OFFSET(get<T>, {0x258, 8, 0, 0})
	CMember(class UFortAthenaAIBotAttackingDigestedSkillSet*) CacheAttackingDigestedSkillSet                       OFFSET(get<T>, {0x260, 8, 0, 0})
	CMember(TWeakObjectPtr<UAthenaAIServiceZoneManager*>) CacheZoneManager                                         OFFSET(get<T>, {0x268, 8, 0, 0})
	CMember(TWeakObjectPtr<UAthenaAIServiceCover*>)    CachedAIServiceCover                                        OFFSET(get<T>, {0x270, 8, 0, 0})
	CMember(class AActor*)                             ExcludeReachingTarget                                       OFFSET(get<T>, {0x278, 8, 0, 0})
...
public:
	CMember(class UFortAthenaAIBotReactToVerbDigestedSkillSet*) CacheReactToVerbDigestedSkillSet                   OFFSET(get<T>, {0x210, 8, 0, 0})
	CMember(class UDataTable*)                         VerbReactions                                               OFFSET(get<T>, {0x218, 8, 0, 0})
	SMember(FScalableFloat)                            MinDistanceFromPlayerToReact                                OFFSET(getStruct<T>, {0x220, 40, 0, 0})
	SMember(FScalableFloat)                            MaxReactionEmoteDuration                                    OFFSET(getStruct<T>, {0x248, 40, 0, 0})
	SMember(FScalableFloat)                            MaxReactionWaitTime                                         OFFSET(getStruct<T>, {0x270, 40, 0, 0})
	...
	SMember(FPersistenceFrameworkSaveControl)          SaveControl                                                 OFFSET(getStruct<T>, {0x3D8, 16, 0, 0})
...
public:
	...
	CMember(class UFortAthenaAIBotAttackingDigestedSkillSet*) CacheAttackingDigestedSkillSet                       OFFSET(get<T>, {0x1B0, 8, 0, 0})
	CMember(class UFortAthenaAICoverComponent*)        CachedCoverComponent                                        OFFSET(get<T>, {0x1B8, 8, 0, 0})
...
public:
	...
	CMember(class UFortAthenaAIRuntimeParameters_ReviveBehavior*) ReviveBehaviorRuntimeParameters                  OFFSET(get<T>, {0x1D8, 8, 0, 0})
	CMember(class AFortPlayerPawnAthena*)              CurrentReviveTarget                                         OFFSET(get<T>, {0x1E0, 8, 0, 0})
	CMember(TArray<class AFortPlayerPawnAthena*>)      DBNOAllyPawns                                               OFFSET(get<T>, {0x1E8, 16, 0, 0})
	CMember(class UFortAthenaAIBotReviveDigestedSkillSet*) ReviveSkillSet                                          OFFSET(get<T>, {0x1F8, 8, 0, 0})
...
public:
	...
	CMember(class AFortTeamInfoAthena*)                CachedTeamInfo                                              OFFSET(get<T>, {0x1B8, 8, 0, 0})
...
public:
	...
	CMember(class AFortPoiVolume*)                     StartingGroundPOI                                           OFFSET(get<T>, {0x1B8, 8, 0, 0})
	...
	CMember(class AFortTeamInfoAthena*)                CachedTeamInfo                                              OFFSET(get<T>, {0x1D0, 8, 0, 0})
	CMember(class UFortAthenaAIBotLootingDigestedSkillSet*) CachedLootingSkillSet                                  OFFSET(get<T>, {0x1D8, 8, 0, 0})
};
...
public:
	...
	CMember(TArray<FName>)                             ExecutionStatusesToCheckForAllowToAvoidGoingToSOKeyNames    OFFSET(get<T>, {0x228, 16, 0, 0})
	SMember(FName)                                     SmartObjectExecutionStatusKeyName                           OFFSET(getStruct<T>, {0x248, 4, 0, 0})
	SMember(FName)                                     SmartObjectMovementStateKeyName                             OFFSET(getStruct<T>, {0x24C, 4, 0, 0})
	SMember(FName)                                     SmartObjectDestinationKeyName                               OFFSET(getStruct<T>, {0x250, 4, 0, 0})
	SMember(FName)                                     SmartObjectDestinationRotationKeyName                       OFFSET(getStruct<T>, {0x254, 4, 0, 0})
	SMember(FName)                                     SmartObjectShouldMoveKeyName                                OFFSET(getStruct<T>, {0x258, 4, 0, 0})
	SMember(FName)                                     SmartObjectUrgencyKeyName                                   OFFSET(getStruct<T>, {0x25C, 4, 0, 0})
};
...
public:
	...
	CMember(class AFortGameModeAthena*)                CacheAthenaGameMode                                         OFFSET(get<T>, {0x1B8, 8, 0, 0})
	CMember(class UBehaviorTreeComponent*)             CachedBTComp                                                OFFSET(get<T>, {0x1C0, 8, 0, 0})
...
public:
	CMember(class UFortAthenaAIBotRangeAttackDigestedSkillSet*) CacheRangeAttackDigestedSkillSet                   OFFSET(get<T>, {0x1A8, 8, 0, 0})
	CMember(class UFortAthenaAIBotAimingDigestedSkillSet*) CacheAimingDigestedSkillSet                             OFFSET(get<T>, {0x1B0, 8, 0, 0})
	...
	CMember(class ABuildingActor*)                     CachedCoverBuildingActor                                    OFFSET(get<T>, {0x1E8, 8, 0, 0})
	CMember(TArray<class ABuildingActor*>)             ExcludedBuildingActors                                      OFFSET(get<T>, {0x1F0, 16, 0, 0})
};
...
public:
	...
	CMember(class UFortAthenaAIBotAttackingDigestedSkillSet*) AttackingSkillSet                                    OFFSET(get<T>, {0x1D0, 8, 0, 0})
	CMember(class UFortAthenaAIBotRangeAttackDigestedSkillSet*) RangeAttackSkillSet                                OFFSET(get<T>, {0x1D8, 8, 0, 0})
	CMember(class UFortAthenaAIBotAimingDigestedSkillSet*) AimingSkillSet                                          OFFSET(get<T>, {0x1E0, 8, 0, 0})
	CMember(class UFortWorldItem*)                     ChosenWeapon                                                OFFSET(get<T>, {0x1E8, 8, 0, 0})
	CMember(class AFortPawn*)                          CachedFortPawn                                              OFFSET(get<T>, {0x1F0, 8, 0, 0})
};
...
public:
	...
	CMember(class UFortPawnComponent_AIGroup*)         CachedAIGroupComponent                                      OFFSET(get<T>, {0x1C0, 8, 0, 0})
};
...
public:
	...
	SMember(FName)                                     TriggerLeashBehaviorKeyName                                 OFFSET(getStruct<T>, {0x1C0, 4, 0, 0})
	DMember(bool)                                      bAlwaysForceMoveToLeashCenter                               OFFSET(get<bool>, {0x1C4, 1, 0, 0})
	CMember(class UClass*)                             AvoidObstaclesFilterClass                                   OFFSET(get<T>, {0x1C8, 8, 0, 0})
	CMember(class UFortAthenaAIRuntimeParameters_Leash*) LeashRuntimeParameters                                    OFFSET(get<T>, {0x1E0, 8, 0, 0})
};
...
public:
	...
	CMember(class UFortAthenaNpcPatrollingComponent*)  CachedNpcPatrollingComponent                                OFFSET(get<T>, {0x1E8, 8, 0, 0})
};
...
public:
	CMember(TArray<class AActor*>)                     ActorsToCleanup                                             OFFSET(get<T>, {0x0, 16, 0, 0})
...
public:
	...
	DMember(uint32_t)                                  Value                                                       OFFSET(get<uint32_t>, {0x14, 4, 0, 0})
};
...
/// Size: 0x04
enum EFortAthenaStateTreeTaskFeatureExecutionMode : uint32_t
{
