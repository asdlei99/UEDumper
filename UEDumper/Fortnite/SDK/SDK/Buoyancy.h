...
public:
	...
	// void OnSurfaceTouching(class AWaterBody* WaterBodyActor, class UPrimitiveComponent* WaterComponent, class UPrimitiveComponent* SubmergedComponent, float SubmergedVolume, FVector& SubmergedCenterOfMass, FVector& SubmergedVelocity); // [0x2177018] Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/Buoyancy.BuoyancyEventInterface.OnSurfaceTouchEnd
	// void OnSurfaceTouchEnd(class AWaterBody* WaterBodyActor, class UPrimitiveComponent* WaterComponent, class UPrimitiveComponent* SubmergedComponent, float SubmergedVolume, FVector& SubmergedCenterOfMass, FVector& SubmergedVelocity); // [0x2177018] Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/Buoyancy.BuoyancyEventInterface.OnSurfaceTouchBegin
	// void OnSurfaceTouchBegin(class AWaterBody* WaterBodyActor, class UPrimitiveComponent* WaterComponent, class UPrimitiveComponent* SubmergedComponent, float SubmergedVolume, FVector& SubmergedCenterOfMass, FVector& SubmergedVelocity); // [0x2177018] Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
};
...
public:
	...
	SDK_UNDEFINED(1,12168) /* TEnumAsByte<ECollisionChannel> */ __um(CollisionChannelForWaterObjects);             // 0x003C   (0x0001)  
...
public:
	...
	// bool IsEnabled();                                                                                                     // [0x7ce8818] Final|Native|Public|Const 
};
