...
{ 
	SDK_UNDEFINED(16,2627) /* FString */               __um(LanguageId);                                           // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2628) /* FString */               __um(IARCLocaleId);                                         // 0x0010   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(16,2629) /* FString */               __um(DefaultLocale);                                        // 0x0038   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(24,2630) /* FText */                 __um(DisplayName);                                          // 0x0000   (0x0018)  
	SDK_UNDEFINED(16,2631) /* FString */               __um(LanguageId);                                           // 0x0018   (0x0010)  
	SDK_UNDEFINED(16,2632) /* FString */               __um(BackendId);                                            // 0x0028   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,2634) /* FString */               __um(RegionId);                                             // 0x0018   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,2636) /* FString */               __um(SubModeLinkType);                                      // 0x0018   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,2637) /* TArray<FString> */       __um(DevelopmentLinkCodes);                                 // 0x0008   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2638) /* FString */               __um(Text);                                                 // 0x0000   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2639) /* TArray<FString> */       __um(texts);                                                // 0x0000   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2640) /* FString */               __um(Name);                                                 // 0x0000   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2641) /* TArray<FString> */       __um(Names);                                                // 0x0000   (0x0010)  
};
