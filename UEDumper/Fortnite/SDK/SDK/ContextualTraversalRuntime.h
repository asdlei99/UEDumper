...
{ 
	...
	SDK_UNDEFINED(8,12188) /* TWeakObjectPtr<AActor*> */ __um(RefActor);                                           // 0x0110   (0x0008)  
	SDK_UNDEFINED(8,12189) /* TWeakObjectPtr<UPrimitiveComponent*> */ __um(RefActorComponent);                     // 0x0118   (0x0008)  
