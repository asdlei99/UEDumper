...
{ 
public:
	unsigned char                                      UnknownData00_2[0x30];                                      // 0x0118   (0x0030)  MISSED
...
struct FFortMovementMode_TraversalBaseRuntimeData : FFortMovementMode_BaseExtRuntimeData
{ 
...
{ 
	...
	SDK_UNDEFINED(8,12232) /* TWeakObjectPtr<AActor*> */ __um(RefActor);                                           // 0x0110   (0x0008)  
	SDK_UNDEFINED(8,12233) /* TWeakObjectPtr<UPrimitiveComponent*> */ __um(RefActorComponent);                     // 0x0118   (0x0008)  
	...
	unsigned char                                      UnknownData01_6[0xA];                                       // 0x0126   (0x000A)  MISSED
};
