...
public:
	...
	SDK_UNDEFINED(80,14786) /* TMap<FName, FNeuralMorphMaskInfo> */ __um(BoneMaskInfos);                           // 0x01B0   (0x0050)  
	SDK_UNDEFINED(80,14787) /* TMap<FName, FNeuralMorphMaskInfo> */ __um(BoneGroupMaskInfos);                      // 0x0200   (0x0050)  
