...
{ 
public:
	class UNeuralMorphNetworkInstance*                 NetworkInstance;                                            // 0x00A8   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(80,14691) /* TMap<FName, FNeuralMorphMaskInfo> */ __um(BoneMaskInfos);                           // 0x01B0   (0x0050)  
	SDK_UNDEFINED(80,14692) /* TMap<FName, FNeuralMorphMaskInfo> */ __um(BoneGroupMaskInfos);                      // 0x0200   (0x0050)  
	...
	int32_t                                            GlobalNumMorphTargets;                                      // 0x0258   (0x0004)  
	int32_t                                            NumIterations;                                              // 0x025C   (0x0004)  
	int32_t                                            LocalNumHiddenLayers;                                       // 0x0260   (0x0004)  
	int32_t                                            LocalNumNeuronsPerLayer;                                    // 0x0264   (0x0004)  
	int32_t                                            GlobalNumHiddenLayers;                                      // 0x0268   (0x0004)  
	int32_t                                            GlobalNumNeuronsPerLayer;                                   // 0x026C   (0x0004)  
	int32_t                                            BatchSize;                                                  // 0x0270   (0x0004)  
	float                                              LearningRate;                                               // 0x0274   (0x0004)  
	float                                              RegularizationFactor;                                       // 0x0278   (0x0004)  
	bool                                               bEnableBoneMasks;                                           // 0x027C   (0x0001)  
	unsigned char                                      UnknownData01_5[0x3];                                       // 0x027D   (0x0003)  MISSED
	float                                              SmoothLossBeta;                                             // 0x0280   (0x0004)  
	unsigned char                                      UnknownData02_5[0x4];                                       // 0x0284   (0x0004)  MISSED
	class UNeuralMorphNetwork*                         NeuralMorphNetwork;                                         // 0x0288   (0x0008)  
};
