...
public:
	...
	// void Timeline__FinishedFunc();                                                                                        // [0x2177018] BlueprintEvent       
	// Function /SparksCosmetics/FrontendPreview/SongItemPreview.SongItemPreview_C.Timeline__UpdateFunc
	// void Timeline__UpdateFunc();                                                                                          // [0x2177018] BlueprintEvent       
	...
	// void ExecuteUbergraph_SongItemPreview(int32_t EntryPoint);                                                            // [0x2177018] Final                
};
...
public:
	...
	// void ExecuteUbergraph_B_SparksOnActorPreviewDefault(int32_t EntryPoint);                                              // [0x2177018] Final|HasDefaults    
};
...
public:
	...
	// void FixupMeshAndMaterials(class USkeletalMeshComponent* MeshComponent, class USkeletalMesh* NewMesh, class UMaterialInstance* Material1, class UMaterialInstance* Material2); // [0x2177018] Public|BlueprintCallable|BlueprintEvent 
	// Function /SparksCosmetics/FrontendPreview/B_SparksCosmeticPreviewDisplay.B_SparksCosmeticPreviewDisplay_C.Hide all
	// void Hide all();                                                                                                      // [0x2177018] Public|BlueprintCallable|BlueprintEvent 
	...
	// void CustomizePreviewInstance(class UFortItemDefinition* InItemDefinition);                                           // [0x2177018] Event|Public|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_SparksCosmeticPreviewDisplay(int32_t EntryPoint);                                             // [0x2177018] Final|HasDefaults    
};
...
public:
	...
	// void Switch Erebus Lighting(bool Visibility);                                                                         // [0x2177018] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Timeline__PlayResIn__EventFunc();                                                                                // [0x2177018] BlueprintEvent       
	...
	// void Timeline__LoadingFXOutro__EventFunc();                                                                           // [0x2177018] BlueprintEvent       
	// Function /SparksCosmetics/FrontendPreview/B_SparksOffActorPreview.B_SparksOffActorPreview_C.Timeline__ShowPawn__EventFunc
	// void Timeline__ShowPawn__EventFunc();                                                                                 // [0x2177018] BlueprintEvent       
	...
	// void ExecuteUbergraph_B_SparksOffActorPreview(int32_t EntryPoint);                                                    // [0x2177018] Final                
};
...
public:
	...
	// void PerformSpecialAction(FName ActionName);                                                                          // [0x2177018] Event|Public|BlueprintCallable|BlueprintEvent 
	...
	// void DebounceEvent();                                                                                                 // [0x2177018] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_SparksSong_PreviewDisplay(int32_t EntryPoint);                                                // [0x2177018] Final|HasDefaults    
};
