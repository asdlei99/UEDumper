...
{ 
	SDK_UNDEFINED(16,15025) /* FString */              __um(ItemId);                                               // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,15026) /* FString */              __um(EntitlementId);                                        // 0x0010   (0x0010)  
	SDK_UNDEFINED(16,15027) /* FString */              __um(ValidationInfo);                                       // 0x0020   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,15028) /* FString */              __um(OfferNamespace);                                       // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,15029) /* FString */              __um(OfferId);                                              // 0x0010   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,15030) /* FString */              __um(TransactionId);                                        // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,15031) /* FString */              __um(TransactionState);                                     // 0x0010   (0x0010)  
