...
public:
	...
	// void ExportToDisk(class UTexture* Texture, FString Filename, FImageWriteOptions& Options);                            // [0x5bd01c0] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
{ 
	...
	SDK_UNDEFINED(12,13882) /* FDelegateProperty */    __um(OnComplete);                                           // 0x0004   (0x000C)  
