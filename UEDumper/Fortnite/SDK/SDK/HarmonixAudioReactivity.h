...
public:
	...
	SDK_UNDEFINED(1,13955) /* TEnumAsByte<TextureAddress> */ __um(TextureTilingMode);                              // 0x0139   (0x0001)  
...
{ 
public:
	SDK_UNDEFINED(8,13956) /* TWeakObjectPtr<UMusicClockComponent*> */ __um(MusicClock);                           // 0x0170   (0x0008)  
