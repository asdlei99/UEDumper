...
{ 
	SDK_UNDEFINED(32,12543) /* TWeakObjectPtr<UMaterialInstanceConstant*> */ __um(Window_23_9242D84D446944DD0D7D739136E38C28); // 0x0000   (0x0020)  
};
...
{ 
	SDK_UNDEFINED(32,12544) /* TWeakObjectPtr<UMaterialInstanceConstant*> */ __um(SkinMIC_19_9242D84D446944DD0D7D739136E38C28); // 0x0000   (0x0020)  
};
