...
{ 
	SDK_UNDEFINED(16,12339) /* FString */              __um(EventName);                                            // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,12340) /* FString */              __um(EventName);                                            // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(80,12341) /* TMap<FString, float> */ __um(PointGroupStepPercentOverrides);                       // 0x0000   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(16,12342) /* TArray<TWeakObjectPtr<UFortItemDefinition*>> */ __um(SoftRefsToLoad);               // 0x0008   (0x0010)  
	SDK_UNDEFINED(80,12343) /* TMap<FName, FScalableFloat> */ __um(LootTableMods);                                 // 0x0018   (0x0050)  
};
