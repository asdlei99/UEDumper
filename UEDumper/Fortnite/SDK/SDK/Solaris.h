...
public:
	...
	SDK_UNDEFINED(16,15260) /* FString */              __um(ProjectName);                                          // 0x0058   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,15261) /* TArray<FString> */      __um(Blacklist);                                            // 0x0028   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,15262) /* FString */              __um(Path);                                                 // 0x0000   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,15263) /* TSet<UVerseClass*> */   __um(InterfaceClasses);                                     // 0x0218   (0x0050)  
	SDK_UNDEFINED(80,15264) /* TMap<FName, InterfaceMethodFunctionProperties> */ __um(InterfaceMethodFunctionProperties); // 0x0268   (0x0050)  
...
{ 
	SDK_UNDEFINED(16,15265) /* FString */              __um(VersePath);                                            // 0x0000   (0x0010)  
	EVersePackageScope                                 VerseScope;                                                 // 0x0010   (0x0001)  
	unsigned char                                      UnknownData00_5[0xF];                                       // 0x0011   (0x000F)  MISSED
	SDK_UNDEFINED(16,15266) /* TArray<FString> */      __um(DependencyPackages);                                   // 0x0020   (0x0010)  
	SDK_UNDEFINED(16,15267) /* FString */              __um(VniDestDir);                                           // 0x0030   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,15268) /* FString */              __um(Filename);                                             // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,15269) /* FString */              __um(Name);                                                 // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,15270) /* FString */              __um(DirPath);                                              // 0x0010   (0x0010)  
	...
	SDK_UNDEFINED(16,15271) /* TArray<FString> */      __um(AssetDependencies);                                    // 0x0088   (0x0010)  
