...
public:
	...
	// void ExecuteUbergraph(int32_t EntryPoint);                                                                            // [0x2177018] Event|Public|BlueprintEvent 
};
...
{ 
public:
	unsigned char                                      UnknownData00_1[0x80];                                      // 0x0200   (0x0080)  MISSED
};
...
{ 
	SDK_UNDEFINED(80,31) /* TMap<FName, FString> */    __um(FieldMetaData);                                        // 0x0000   (0x0050)  
};
