...
public:
	...
	// void OnIsCraftableItemChanged(bool bIsCraftableItem);                                                                 // [0x2047e54] Event|Protected|BlueprintEvent 
	// Function /Script/CraftingUI.AthenaCraftingQuickBarButton.OnCanCraftNowChanged
	// void OnCanCraftNowChanged(bool bCanCraftNow);                                                                         // [0x2047e54] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void HandleWeaponEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                               // [0xab6dbe4] Final|Native|Private 
};
...
public:
	...
	// void HandleInventoryItemSelected(class UFortItem* SelectedItem);                                                      // [0xab6da64] Final|Native|Private 
};
...
public:
	...
	// void OnIngredientChanged(bool bCanCraftNow);                                                                          // [0x2047e54] Event|Protected|BlueprintEvent 
	...
	// void HandleWeaponEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon);                               // [0xab6dd24] Final|Native|Private 
};
...
public:
	...
	// void OnIngredientWidgetUpdated(int32_t NumAvailable, int32_t NumRequired, bool bIsPrimaryIngredient, bool bIsLastIngredient); // [0x2047e54] Event|Protected|BlueprintEvent 
};
...
public:
	unsigned char                                      UnknownData00_2[0x8];                                       // 0x0400   (0x0008)  MISSED
	SDK_UNDEFINED(24,12398) /* FText */                __um(RarityTextFormat);                                     // 0x0408   (0x0018)  
...
public:
	...
	// void OnCraftingListItemSet();                                                                                         // [0x2047e54] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnFormulaListUpdated(int32_t NumFormulas);                                                                       // [0x2047e54] Event|Protected|BlueprintEvent 
	// Function /Script/CraftingUI.FortCraftingTab.HandleInventoryItemSelected
	// void HandleInventoryItemSelected(class UFortItem* Item);                                                              // [0xab6db24] Final|Native|Private 
};
...
public:
	...
	// void SetOwningCraftingObject(class ACraftingObjectBGA* InCraftingObject);                                             // [0xab6de58] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	SDK_UNDEFINED(32,12399) /* TWeakObjectPtr<UClass*> */ __um(CraftingMenuWidget);                                // 0x0030   (0x0020)  
