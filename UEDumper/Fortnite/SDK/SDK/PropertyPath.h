...
{ 
	...
	SDK_UNDEFINED(1,1374) /* TEnumAsByte<EPropertyPathTestEnum> */ __um(EnumOne);                                  // 0x000D   (0x0001)  
	SDK_UNDEFINED(1,1375) /* TEnumAsByte<EPropertyPathTestEnum> */ __um(EnumTwo);                                  // 0x000E   (0x0001)  
	SDK_UNDEFINED(1,1376) /* TEnumAsByte<EPropertyPathTestEnum> */ __um(EnumThree);                                // 0x000F   (0x0001)  
	SDK_UNDEFINED(1,1377) /* TEnumAsByte<EPropertyPathTestEnum> */ __um(EnumFour);                                 // 0x0010   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x0011   (0x0003)  MISSED
	int32_t                                            Integer;                                                    // 0x0014   (0x0004)  
	SDK_UNDEFINED(16,1378) /* FString */               __um(String);                                               // 0x0018   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(1,1379) /* TEnumAsByte<EPropertyPathTestEnum> */ __um(EnumOne);                                  // 0x0010   (0x0001)  
	SDK_UNDEFINED(1,1380) /* TEnumAsByte<EPropertyPathTestEnum> */ __um(EnumTwo);                                  // 0x0011   (0x0001)  
	SDK_UNDEFINED(1,1381) /* TEnumAsByte<EPropertyPathTestEnum> */ __um(EnumThree);                                // 0x0012   (0x0001)  
	SDK_UNDEFINED(1,1382) /* TEnumAsByte<EPropertyPathTestEnum> */ __um(EnumFour);                                 // 0x0013   (0x0001)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x0014   (0x0004)  MISSED
	SDK_UNDEFINED(16,1383) /* FString */               __um(String);                                               // 0x0018   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(1,1384) /* TEnumAsByte<EPropertyPathTestEnum> */ __um(EnumOne);                                  // 0x0029   (0x0001)  
	SDK_UNDEFINED(1,1385) /* TEnumAsByte<EPropertyPathTestEnum> */ __um(EnumTwo);                                  // 0x002A   (0x0001)  
	SDK_UNDEFINED(1,1386) /* TEnumAsByte<EPropertyPathTestEnum> */ __um(EnumThree);                                // 0x002B   (0x0001)  
	SDK_UNDEFINED(1,1387) /* TEnumAsByte<EPropertyPathTestEnum> */ __um(EnumFour);                                 // 0x002C   (0x0001)  
	...
	SDK_UNDEFINED(16,1388) /* FString */               __um(String);                                               // 0x0038   (0x0010)  
	...
	// void SetStructRef(FPropertyPathTestStruct InStruct);                                                                  // [0x5b60970] Final|Native|Public  
	// Function /Script/PropertyPath.PropertyPathTestObject.SetStructConstRef
	// void SetStructConstRef(FPropertyPathTestStruct InStruct);                                                             // [0x5b60818] Final|Native|Public  
	// Function /Script/PropertyPath.PropertyPathTestObject.SetStruct
	// void SetStruct(FPropertyPathTestStruct InStruct);                                                                     // [0x5b606c0] Final|Native|Public  
	// Function /Script/PropertyPath.PropertyPathTestObject.SetFloat
	// void SetFloat(float InFloat);                                                                                         // [0x5b6063c] Final|Native|Public  
	// Function /Script/PropertyPath.PropertyPathTestObject.GetStructRef
	// FPropertyPathTestStruct GetStructRef();                                                                               // [0x5b60618] Final|Native|Public|Const 
	// Function /Script/PropertyPath.PropertyPathTestObject.GetStructConstRef
	// FPropertyPathTestStruct GetStructConstRef();                                                                          // [0x5b605f4] Final|Native|Public|Const 
	// Function /Script/PropertyPath.PropertyPathTestObject.GetStruct
	// FPropertyPathTestStruct GetStruct();                                                                                  // [0x5b605b0] Final|Native|Public|Const 
	// Function /Script/PropertyPath.PropertyPathTestObject.GetFloat
	// float GetFloat();                                                                                                     // [0x5b60594] Final|Native|Public|Const 
};
