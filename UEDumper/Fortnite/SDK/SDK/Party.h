...
{ 
public:
	SDK_UNDEFINED(16,2654) /* FString */               __um(CurrentChatRoomId);                                    // 0x0028   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(8,2655) /* TWeakObjectPtr<ULocalPlayer*> */ __um(LocalPlayerOwner);                              // 0x00D4   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(80,2656) /* TMap<TWeakObjectPtr<USocialUser*>, USocialPrivateMessageChannel*> */ __um(DirectChannelsByTargetUser); // 0x0078   (0x0050)  
	SDK_UNDEFINED(80,2657) /* TMap<FString, USocialChatRoom*> */ __um(ChatRoomsById);                              // 0x00C8   (0x0050)  
	SDK_UNDEFINED(80,2658) /* TMap<FString, USocialReadOnlyChatChannel*> */ __um(ReadOnlyChannelsByDisplayName);   // 0x0118   (0x0050)  
	bool                                               bEnableChatSlashCommands;                                   // 0x0168   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0169   (0x0007)  MISSED
	SDK_UNDEFINED(80,2659) /* TMap<FUniqueNetIdRepl, USocialGroupChannel*> */ __um(GroupChannels);                 // 0x0170   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(24,2660) /* FText */                 __um(DisplayName);                                          // 0x0060   (0x0018)  
...
public:
	...
	SDK_UNDEFINED(80,2661) /* TMap<FUniqueNetIdRepl, UPartyMember*> */ __um(PartyMembersById);                     // 0x00E0   (0x0050)  
	...
	SDK_UNDEFINED(8,2662) /* TWeakObjectPtr<APartyBeaconClient*> */ __um(ReservationBeaconClient);                 // 0x0208   (0x0008)  
	unsigned char                                      UnknownData04_5[0x4];                                       // 0x0210   (0x0004)  MISSED
	SDK_UNDEFINED(8,2663) /* TWeakObjectPtr<ASpectatorBeaconClient*> */ __um(SpectatorBeaconClient);               // 0x0214   (0x0008)  
...
{ 
	SDK_UNDEFINED(16,2664) /* FString */               __um(Name);                                                 // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2665) /* FString */               __um(PlatformType);                                         // 0x0010   (0x0010)  
	FName                                              OnlineSubsystem;                                            // 0x0020   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0024   (0x0004)  MISSED
	SDK_UNDEFINED(16,2666) /* FString */               __um(SessionType);                                          // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,2667) /* FString */               __um(ExternalAccountType);                                  // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,2668) /* FString */               __um(CrossplayPool);                                        // 0x0048   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,2669) /* FString */               __um(SessionId);                                            // 0x0088   (0x0010)  
};
...
{ 
	unsigned char                                      UnknownData00_2[0x10];                                      // 0x0018   (0x0010)  MISSED
	...
	SDK_UNDEFINED(16,2670) /* FString */               __um(JoinMethod);                                           // 0x0188   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2671) /* FString */               __um(SessionType);                                          // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2672) /* FString */               __um(SessionId);                                            // 0x0010   (0x0010)  
...
{ 
	unsigned char                                      UnknownData00_2[0x9];                                       // 0x0018   (0x0009)  MISSED
