...
public:
	...
	// void OnPresentationModeChanged(EGiftingPresentationMode NewMode);                                                     // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.AthenaGiftingConfirmationScreen.HandleTokenOfferPurchaseComplete
	// void HandleTokenOfferPurchaseComplete(bool bSuccess, TArray<FPurchasedItemInfo>& PurchasedItems);                     // [0xb206724] Final|Native|Private|HasOutParms 
	// Function /Script/GiftingUI.AthenaGiftingConfirmationScreen.HandleGiftSent
	// void HandleGiftSent(bool bSuccess, TArray<FString>& IneligibleAccounts, TArray<FString>& ErrorCodes);                 // [0xb2063bc] Final|Native|Private|HasOutParms 
	// Function /Script/GiftingUI.AthenaGiftingConfirmationScreen.Dismiss
	// void Dismiss(bool bGiftConfirmed);                                                                                    // [0xb206320] Final|Native|Private|BlueprintCallable 
};
...
public:
	...
	// void UpdateGiftEligibility(bool bStillGiftable);                                                                      // [0x2177018] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void SetPresentationMode(EGiftingPricePresentationMode Mode);                                                         // [0x2177018] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void PlayIntroAnimation();                                                                                            // [0x2177018] Event|Public|BlueprintEvent 
};
...
public:
	...
	SDK_UNDEFINED(24,13790) /* FText */                __um(RegularGiftingPolicy);                                 // 0x0800   (0x0018)  
	SDK_UNDEFINED(24,13791) /* FText */                __um(BattlePassGiftingPolicy);                              // 0x0818   (0x0018)  
	unsigned char                                      UnknownData02_5[0x60];                                      // 0x0830   (0x0060)  MISSED
	SDK_UNDEFINED(80,13792) /* TMap<UCommonButtonBase*, EFilterType> */ __um(FilterMap);                           // 0x0890   (0x0050)  
	...
	// void OnShowSearchWarningText(bool bShow);                                                                             // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.AthenaGiftingScreen.OnShownItemChanged
	// void OnShownItemChanged();                                                                                            // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.AthenaGiftingScreen.OnSetupFilterTabButton
	// void OnSetupFilterTabButton(class UCommonButtonBase* Button, EFilterType FilterType);                                 // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.AthenaGiftingScreen.OnPresentationModeChanged
	// void OnPresentationModeChanged(EGiftingScreenPresentationMode Mode);                                                  // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.AthenaGiftingScreen.OnPartyListUpdated
	// void OnPartyListUpdated(bool bEmpty);                                                                                 // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.AthenaGiftingScreen.OnHandlePreviewItem
	// void OnHandlePreviewItem(bool bUseWidePreview);                                                                       // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.AthenaGiftingScreen.OnFriendSelectionChanged
	// void OnFriendSelectionChanged();                                                                                      // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.AthenaGiftingScreen.OnFilterChanged
	// void OnFilterChanged(EFilterType FilterType);                                                                         // [0x2177018] Event|Protected|BlueprintEvent 
...
public:
	...
	SDK_UNDEFINED(16,13793) /* TArray<TWeakObjectPtr<UFortGiftBoxItemDefinition*>> */ __um(GiftBoxes);             // 0x0428   (0x0010)  
...
public:
	...
	// void SetPresentationMode(ERecipientPresentationMode Mode);                                                            // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.FortGiftingSocialUserListEntry.OnUserItemSet
	// void OnUserItemSet();                                                                                                 // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.FortGiftingSocialUserListEntry.OnRecipientStatusUpdated
	// void OnRecipientStatusUpdated();                                                                                      // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.FortGiftingSocialUserListEntry.BP_OnTouchSelectionConfirmed
	// void BP_OnTouchSelectionConfirmed();                                                                                  // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.FortGiftingSocialUserListEntry.BP_OnHighlightedStateChanged
	// void BP_OnHighlightedStateChanged(bool bInIsHighlighted, bool bPlayAnimation);                                        // [0x2177018] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnSearchCommit(bool bSearchStringShort);                                                                         // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/GiftingUI.FortGiftingUserSearchWidget.HandleSearchFriendsTextEntered
	// void HandleSearchFriendsTextEntered(FText& Text, TEnumAsByte<ETextCommit> CommitMethod);                              // [0xb206594] Final|Native|Private|HasOutParms 
	// Function /Script/GiftingUI.FortGiftingUserSearchWidget.HandleSearchFriendsTextChanged
	// void HandleSearchFriendsTextChanged(FText& Text);                                                                     // [0xb206508] Final|Native|Private|HasOutParms 
	// Function /Script/GiftingUI.FortGiftingUserSearchWidget.FocusEditableText
	// void FocusEditableText();                                                                                             // [0xb2063a0] Final|Native|Protected|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(32,13794) /* TWeakObjectPtr<UClass*> */ __um(GiftingScreenClass);                                // 0x0530   (0x0020)  
};
