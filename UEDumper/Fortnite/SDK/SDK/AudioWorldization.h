...
{ 
	...
	SDK_UNDEFINED(80,1761) /* TSet<USoundModulatorBase*> */ __um(VolumeModulators);                                // 0x0008   (0x0050)  
...
{ 
	...
	SDK_UNDEFINED(1,1762) /* TEnumAsByte<ECollisionChannel> */ __um(TraceChannel);                                 // 0x0050   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0051   (0x0007)  MISSED
	SDK_UNDEFINED(16,1763) /* TArray<TEnumAsByte<ECollisionChannel>> */ __um(ResponseChannels);                    // 0x0058   (0x0010)  
