...
{ 
	SDK_UNDEFINED(16,14560) /* FString */              __um(Name);                                                 // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,14561) /* FString */              __um(TypeName);                                             // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,14562) /* FString */              __um(Name);                                                 // 0x0000   (0x0010)  
