...
{ 
	...
	SDK_UNDEFINED(16,14731) /* FString */              __um(EventName);                                            // 0x0010   (0x0010)  
	int64_t                                            Time;                                                       // 0x0020   (0x0008)  
	SDK_UNDEFINED(16,14732) /* FString */              __um(Parameter);                                            // 0x0028   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(80,14733) /* TMap<FString, UMediaPlayer*> */ __um(MediaPlayerMap);                               // 0x0290   (0x0050)  
	...
	SDK_UNDEFINED(16,14734) /* FString */              __um(ScreenName);                                           // 0x0430   (0x0010)  
