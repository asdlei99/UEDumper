...
{ 
	SDK_UNDEFINED(16,11643) /* TScriptInterface<Class> */ __um(Sim);                                               // 0x0000   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,11644) /* TArray<TScriptInterface<Class>> */ __um(AudioComponents);                           // 0x00B0   (0x0010)  
