...
enum class EOptimusDataTypeUsageFlags : uint8_t
{
	...
	EOptimusDataTypeUsageFlags__EOptimusDataTypeUsageFlags_MAX                       = 5
};
...
{ 
public:
	SDK_UNDEFINED(16,14628) /* FString */              __um(Source);                                               // 0x0098   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(8,14629) /* TWeakObjectPtr<UObject*> */ __um(TypeObject);                                        // 0x0004   (0x0008)  
};
...
{ 
	SDK_UNDEFINED(16,14630) /* FString */              __um(Name);                                                 // 0x0000   (0x0010)  
	...
	SDK_UNDEFINED(16,14631) /* FString */              __um(HlslId);                                               // 0x0028   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(8,14632) /* TWeakObjectPtr<UOptimusComponentSourceBinding*> */ __um(ComponentSourceBinding);     // 0x0030   (0x0008)  
	SDK_UNDEFINED(16,14633) /* FString */              __um(NumThreadsExpression);                                 // 0x0038   (0x0010)  
...
public:
	...
	class UOptimusDeformerInstance*                    DeformerInstance;                                           // 0x0040   (0x0008)  
};
...
{ 
	SDK_UNDEFINED(16,14634) /* FString */              __um(Name);                                                 // 0x0000   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,14635) /* FString */              __um(Expression);                                           // 0x0020   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(8,14636) /* TWeakObjectPtr<UOptimusComponentSourceBinding*> */ __um(ComponentSourceBinding);     // 0x0070   (0x0008)  
...
public:
	unsigned char                                      UnknownData00_2[0x8];                                       // 0x0028   (0x0008)  MISSED
	SDK_UNDEFINED(24,14637) /* FText */                __um(DisplayName);                                          // 0x0030   (0x0018)  
	FVector2D                                          GraphPosition;                                              // 0x0048   (0x0010)  
	TArray<class UOptimusNodePin*>                     Pins;                                                       // 0x0058   (0x0010)  
	SDK_UNDEFINED(80,14638) /* TSet<FName> */          __um(ExpandedPins);                                         // 0x0068   (0x0050)  
	...
	// bool SetGraphPosition(FVector2D& InPosition);                                                                         // [0xb300f10] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNode.GetNodeName
	// FName GetNodeName();                                                                                                  // [0xb2ff960] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/OptimusCore.OptimusNode.GetNodeCategory
	// FName GetNodeCategory();                                                                                              // [0xb2ff930] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/OptimusCore.OptimusNode.GetGraphPosition
	// FVector2D GetGraphPosition();                                                                                         // [0xb2ff8d8] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/OptimusCore.OptimusNode.GetDisplayName
	// FText GetDisplayName();                                                                                               // [0xa4f8648] Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x18];                                      // 0x0110   (0x0018)  MISSED
...
{ 
	...
	SDK_UNDEFINED(16,14639) /* FString */              __um(Expression);                                           // 0x0008   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(16,14640) /* FString */              __um(ShaderSource);                                         // 0x0250   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,14641) /* FString */              __um(Declarations);                                         // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,14642) /* FString */              __um(ShaderText);                                           // 0x0010   (0x0010)  
};
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x20];                                      // 0x0118   (0x0020)  MISSED
...
public:
	unsigned char                                      UnknownData00_2[0x18];                                      // 0x0110   (0x0018)  MISSED
	SDK_UNDEFINED(8,14643) /* TWeakObjectPtr<UOptimusResourceDescription*> */ __um(ResourceDesc);                  // 0x0128   (0x0008)  
...
{ 
	...
	FOptimusDataTypeRef                                DataType;                                                   // 0x0004   (0x000C)  
	SDK_UNDEFINED(16,14644) /* FString */              __um(DefaultValue);                                         // 0x0010   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(8,14645) /* TWeakObjectPtr<UOptimusVariableDescription*> */ __um(VariableDesc);                  // 0x0120   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,14646) /* TWeakObjectPtr<UOptimusNodeSubGraph*> */ __um(OwningGraph);                          // 0x011C   (0x0008)  
...
public:
	...
	unsigned char                                      UnknownData00_6[0xB4];                                      // 0x002C   (0x00B4)  MISSED
};
...
{ 
public:
	SDK_UNDEFINED(16,14647) /* TArray<TWeakObjectPtr<UOptimusNode*>> */ __um(KernelToNode);                        // 0x0090   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,14648) /* FString */              __um(Expression);                                           // 0x0010   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(80,14649) /* TMap<FName, int32_t> */ __um(GroupNameToBindingIndex);                              // 0x0020   (0x0050)  
};
...
public:
	...
	FOptimusConstantContainer                          ConstantContainer;                                          // 0x0060   (0x0010)  
	class UOptimusActionStack*                         ActionStack;                                                // 0x0070   (0x0008)  
	EOptimusDeformerStatus                             Status;                                                     // 0x0078   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x007C   (0x0004)  MISSED
	TArray<class UOptimusNodeGraph*>                   Graphs;                                                     // 0x0080   (0x0010)  
	class UOptimusComponentSourceBindingContainer*     Bindings;                                                   // 0x0090   (0x0008)  
	class UOptimusVariableContainer*                   Variables;                                                  // 0x0098   (0x0008)  
	class UOptimusResourceContainer*                   Resources;                                                  // 0x00A0   (0x0008)  
	unsigned char                                      UnknownData02_6[0x90];                                      // 0x00A8   (0x0090)  MISSED


	/// Functions
	// Function /Script/OptimusCore.OptimusDeformer.GetVariables
	// TArray<UOptimusVariableDescription*> GetVariables();                                                                  // [0xb2ffa14] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/OptimusCore.OptimusDeformer.GetResources
	// TArray<UOptimusResourceDescription*> GetResources();                                                                  // [0xb2ff998] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/OptimusCore.OptimusDeformer.GetPrimaryComponentBinding
	// class UOptimusComponentSourceBinding* GetPrimaryComponentBinding();                                                   // [0xb2ff978] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/OptimusCore.OptimusDeformer.GetComponentBindings
	// TArray<UOptimusComponentSourceBinding*> GetComponentBindings();                                                       // [0xb2ff838] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
public:
	SDK_UNDEFINED(8,14650) /* TWeakObjectPtr<UOptimusDeformer*> */ __um(Deformer);                                 // 0x0028   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(8,14651) /* TWeakObjectPtr<UMeshComponent*> */ __um(MeshComponent);                              // 0x0028   (0x0008)  
	SDK_UNDEFINED(8,14652) /* TWeakObjectPtr<UOptimusDeformerInstanceSettings*> */ __um(InstanceSettings);         // 0x0030   (0x0008)  
	...
	SDK_UNDEFINED(16,14653) /* TArray<TWeakObjectPtr<UActorComponent*>> */ __um(WeakBoundComponents);              // 0x0050   (0x0010)  
	SDK_UNDEFINED(16,14654) /* TArray<TWeakObjectPtr<UOptimusComponentSource*>> */ __um(WeakComponentSources);     // 0x0060   (0x0010)  
	...
	// bool SetVectorVariable(FName InVariableName, FVector& InValue);                                                       // [0xb3012d0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusDeformerInstance.SetVector4Variable
	// bool SetVector4Variable(FName InVariableName, FVector4& InValue);                                                     // [0xb3011e4] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusDeformerInstance.SetTransformVariable
	// bool SetTransformVariable(FName InVariableName, FTransform& InValue);                                                 // [0xb30108c] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusDeformerInstance.SetIntVariable
	// bool SetIntVariable(FName InVariableName, int32_t InValue);                                                           // [0xb300fb8] Final|Native|Public|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusDeformerInstance.SetFloatVariable
	// bool SetFloatVariable(FName InVariableName, double InValue);                                                          // [0xb300e48] Final|Native|Public|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusDeformerInstance.SetBoolVariable
	// bool SetBoolVariable(FName InVariableName, bool InValue);                                                             // [0xb300d70] Final|Native|Public|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusDeformerInstance.GetVariables
	// TArray<UOptimusVariableDescription*> GetVariables();                                                                  // [0xb2ffa34] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/OptimusCore.OptimusDeformerInstance.EnqueueTriggerGraph
	// bool EnqueueTriggerGraph(FName InTriggerGraphName);                                                                   // [0xb2ff6bc] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool RenameGraph(class UOptimusNodeGraph* InGraph, FString InNewName);                                                // [0xb300698] Final|Native|Public|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.RemoveNodes
	// bool RemoveNodes(TArray<UOptimusNode*>& InNodes);                                                                     // [0xb2fffdc] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.RemoveNode
	// bool RemoveNode(class UOptimusNode* InNode);                                                                          // [0xb2fff4c] Final|Native|Public|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.RemoveLink
	// bool RemoveLink(class UOptimusNodePin* InNodeOutputPin, class UOptimusNodePin* InNodeInputPin);                       // [0xb2ffe2c] Final|Native|Public|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.RemoveAllLinks
	// bool RemoveAllLinks(class UOptimusNodePin* InNodePin);                                                                // [0xb2ffd9c] Final|Native|Public|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.MoveGraph
	// bool MoveGraph(class UOptimusNodeGraph* InGraph, int32_t InInsertBefore);                                             // [0xb2ffcd8] Final|Native|Public|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.IsSubGraphReference
	// bool IsSubGraphReference(class UOptimusNode* InNode);                                                                 // [0xb2ffc40] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/OptimusCore.OptimusNodeGraph.IsKernelFunction
	// bool IsKernelFunction(class UOptimusNode* InNode);                                                                    // [0xb2ffbb4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/OptimusCore.OptimusNodeGraph.IsFunctionReference
	// bool IsFunctionReference(class UOptimusNode* InNode);                                                                 // [0xb2ffb1c] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/OptimusCore.OptimusNodeGraph.IsFunctionGraph
	// bool IsFunctionGraph();                                                                                               // [0xb2ffb04] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/OptimusCore.OptimusNodeGraph.IsExecutionGraph
	// bool IsExecutionGraph();                                                                                              // [0xb2ffaec] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/OptimusCore.OptimusNodeGraph.IsCustomKernel
	// bool IsCustomKernel(class UOptimusNode* InNode);                                                                      // [0xb2ffa54] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/OptimusCore.OptimusNodeGraph.GetGraphType
	// EOptimusNodeGraphType GetGraphType();                                                                                 // [0x62ef414] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/OptimusCore.OptimusNodeGraph.GetGraphs
	// TArray<UOptimusNodeGraph*> GetGraphs();                                                                               // [0xb2ff8f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/OptimusCore.OptimusNodeGraph.GetGraphIndex
	// int32_t GetGraphIndex();                                                                                              // [0xb2ff8b4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/OptimusCore.OptimusNodeGraph.ExpandCollapsedNodes
	// TArray<UOptimusNode*> ExpandCollapsedNodes(class UOptimusNode* InFunctionNode);                                       // [0xb2ff798] Final|Native|Public|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.DuplicateNodes
	// bool DuplicateNodes(TArray<UOptimusNode*>& InNodes, FVector2D& InPosition);                                           // [0xb2fef98] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.DuplicateNode
	// class UOptimusNode* DuplicateNode(class UOptimusNode* InNode, FVector2D& InPosition);                                 // [0xb2fede4] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.ConvertFunctionToCustomKernel
	// class UOptimusNode* ConvertFunctionToCustomKernel(class UOptimusNode* InKernelFunction);                              // [0xb2fed54] Final|Native|Public|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.ConvertCustomKernelToFunction
	// class UOptimusNode* ConvertCustomKernelToFunction(class UOptimusNode* InCustomKernel);                                // [0xb2fecc4] Final|Native|Public|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.CollapseNodesToSubGraph
	// class UOptimusNode* CollapseNodesToSubGraph(TArray<UOptimusNode*>& InNodes);                                          // [0xb2fe608] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.CollapseNodesToFunction
	// class UOptimusNode* CollapseNodesToFunction(TArray<UOptimusNode*>& InNodes);                                          // [0xb2fdf64] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.AddVariableGetNode
	// class UOptimusNode* AddVariableGetNode(class UOptimusVariableDescription* InVariableDesc, FVector2D& InPosition);     // [0xb2fde40] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.AddValueNode
	// class UOptimusNode* AddValueNode(FOptimusDataTypeRef InDataTypeRef, FVector2D& InPosition);                           // [0xb2fdc98] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.AddResourceSetNode
	// class UOptimusNode* AddResourceSetNode(class UOptimusResourceDescription* InResourceDesc, FVector2D& InPosition);     // [0xb2fdb74] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.AddResourceNode
	// class UOptimusNode* AddResourceNode(class UOptimusResourceDescription* InResourceDesc, FVector2D& InPosition);        // [0xb2fda50] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.AddResourceGetNode
	// class UOptimusNode* AddResourceGetNode(class UOptimusResourceDescription* InResourceDesc, FVector2D& InPosition);     // [0xb2fd92c] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.AddNode
	// class UOptimusNode* AddNode(class UClass* InNodeClass, FVector2D& InPosition);                                        // [0xb2fd828] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.AddLink
	// bool AddLink(class UOptimusNodePin* InNodeOutputPin, class UOptimusNodePin* InNodeInputPin);                          // [0xb2fd764] Final|Native|Public|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.AddDataInterfaceNode
	// class UOptimusNode* AddDataInterfaceNode(class UClass* InDataInterfaceClass, FVector2D& InPosition);                  // [0xb2fd674] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/OptimusCore.OptimusNodeGraph.AddComponentBindingGetNode
	// class UOptimusNode* AddComponentBindingGetNode(class UOptimusComponentSourceBinding* InComponentBinding, FVector2D& InPosition); // [0xb2fd598] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	SDK_UNDEFINED(8,14655) /* TWeakObjectPtr<UOptimusNode_GraphTerminal*> */ __um(EntryNode);                      // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,14656) /* TWeakObjectPtr<UOptimusNode_GraphTerminal*> */ __um(ReturnNode);                     // 0x00A8   (0x0008)  
};
...
public:
	...
	SDK_UNDEFINED(8,14657) /* TWeakObjectPtr<UOptimusComponentSourceBinding*> */ __um(ComponentBinding);           // 0x0038   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(16,14658) /* FString */              __um(SourceText);                                           // 0x0040   (0x0010)  
};
...
{ 
	FName                                              TypeName;                                                   // 0x0000   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0004   (0x0004)  MISSED
	SDK_UNDEFINED(24,14659) /* FText */                __um(DisplayName);                                          // 0x0008   (0x0018)  
	...
	SDK_UNDEFINED(8,14660) /* TWeakObjectPtr<UObject*> */ __um(TypeObject);                                        // 0x0030   (0x0008)  
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0004   (0x0004)  MISSED
	SDK_UNDEFINED(16,14661) /* FString */              __um(Value);                                                // 0x0008   (0x0010)  
};
