...
public:
	...
	SDK_UNDEFINED(1,15313) /* TEnumAsByte<ETimelineDirection> */ __um(Ramp_Up_down_values_on_death__Direction_1CA080D642E9F1C3CB297DBE1BD2C9A4); // 0x02BC   (0x0001)  
	...
	SDK_UNDEFINED(16,15314) /* FMulticastInlineDelegate */ __um(NewEventDispatcher);                               // 0x02C8   (0x0010)  
	SDK_UNDEFINED(16,15315) /* FMulticastInlineDelegate */ __um(NewEventDispatcher0);                              // 0x02D8   (0x0010)  
	...
	SDK_UNDEFINED(16,15316) /* TScriptInterface<Class> */ __um(CameraLensEffectInterface);                         // 0x0400   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(1,15317) /* TEnumAsByte<ETimelineDirection> */ __um(Alpha__Direction_06897833405CC2B231B02C93C4E725A3); // 0x038C   (0x0001)  
