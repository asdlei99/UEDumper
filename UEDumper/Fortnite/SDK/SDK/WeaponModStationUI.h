...
public:
	...
	SDK_UNDEFINED(16,15441) /* FMulticastInlineDelegate */ __um(OnWeaponModsWorkbenchRequestClose);                // 0x0050   (0x0010)  
	unsigned char                                      UnknownData01_5[0x18];                                      // 0x0060   (0x0018)  MISSED
	SDK_UNDEFINED(16,15442) /* FMulticastInlineDelegate */ __um(OnWeaponModsWorkbenchSelectedModChanged);          // 0x0078   (0x0010)  
