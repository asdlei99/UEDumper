...
public:
	...
	// void Stop();                                                                                                          // [0x2177018] Event|Public|BlueprintEvent 
	// Function /Script/EntityFortnite.EntityFortniteStormSpawner.Start
	// void Start(float StartRadius, float BoundsRadius, TArray<FEntityFortniteStormPhase>& Phases);                         // [0x2177018] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/EntityFortnite.EntityFortniteStormSpawner.Pause
	// void Pause();                                                                                                         // [0x2177018] Event|Public|BlueprintEvent 
	// Function /Script/EntityFortnite.EntityFortniteStormSpawner.Exists
	// bool Exists();                                                                                                        // [0x2177018] Event|Public|BlueprintEvent|Const 
};
