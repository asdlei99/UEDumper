...
/// Size: 0x0058 (0x0006F8 - 0x000750)
class AFGF_PlayerController : public APlayerController
{ 
public:
	unsigned char                                      UnknownData00_1[0x58];                                      // 0x06F8   (0x0058)  MISSED
};
...
{ 
	SDK_UNDEFINED(32,2063) /* TWeakObjectPtr<UStateTree*> */ __um(StateTreeAsset);                                 // 0x0000   (0x0020)  
