...
public:
	...
	SDK_UNDEFINED(80,14235) /* TMap<FJunoLandscapeMaterialInstanceCacheKey, FJunoLandscapeCombinedMaterialInstance> */ __um(MaterialInstances); // 0x0058   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(80,14236) /* TMap<FName, UJunoLandscapeRenderTarget*> */ __um(TextureProperties);                // 0x0038   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(80,14237) /* TMap<FString, UTexture*> */ __um(WeightMaps);                                       // 0x0038   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(80,14238) /* TMap<FJunoLandscapeCombinedMaterialCacheKey, UJunoLandscapeCombinedMaterial*> */ __um(ExternalCombinedMaterials); // 0x0000   (0x0050)  
	SDK_UNDEFINED(80,14239) /* TMap<FJunoLandscapeCombinedMaterialCacheKey, UJunoLandscapeCombinedMaterial*> */ __um(MaterialCombinations); // 0x0050   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(80,14240) /* TMap<FName, ULandscapeLayerInfoObject*> */ __um(AllLayerInfos);                     // 0x0040   (0x0050)  
	SDK_UNDEFINED(16,14241) /* TArray<FString> */      __um(LayerInfoDirectories);                                 // 0x0090   (0x0010)  
	...
	SDK_UNDEFINED(80,14242) /* TMap<FName, uint32_t> */ __um(LayerNameToIndex);                                    // 0x0180   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(80,14243) /* TMap<FIntPoint, UJunoLandscapeComponent*> */ __um(ExistingComponents);              // 0x0130   (0x0050)  
	SDK_UNDEFINED(80,14244) /* TMap<UPrimitiveComponent*, UJunoLandscapeComponent*> */ __um(ExternalComponents);   // 0x0180   (0x0050)  
...
{ 
	...
	SDK_UNDEFINED(32,14245) /* TWeakObjectPtr<UObject*> */ __um(Generator);                                        // 0x0008   (0x0020)  
	SDK_UNDEFINED(32,14246) /* TWeakObjectPtr<UMaterialInterface*> */ __um(LandscapeMaterial);                     // 0x0028   (0x0020)  
	SDK_UNDEFINED(32,14247) /* TWeakObjectPtr<UJunoLandscapeLayersData*> */ __um(LayersData);                      // 0x0048   (0x0020)  
};
...
public:
	...
	SDK_UNDEFINED(80,14248) /* TMap<FName, UJunoLandscapeRenderTarget*> */ __um(RenderTargets);                    // 0x0050   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(1,14249) /* TEnumAsByte<ETextureRenderTargetFormat> */ __um(Format);                             // 0x002C   (0x0001)  
