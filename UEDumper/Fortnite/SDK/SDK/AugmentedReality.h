...
{ 
public:
	SDK_UNDEFINED(16,11681) /* FMulticastInlineDelegate */ __um(OnSuccess);                                        // 0x0050   (0x0010)  
	SDK_UNDEFINED(16,11682) /* FMulticastInlineDelegate */ __um(OnFailed);                                         // 0x0060   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,11683) /* FMulticastInlineDelegate */ __um(OnSuccess);                                        // 0x0050   (0x0010)  
	SDK_UNDEFINED(16,11684) /* FMulticastInlineDelegate */ __um(OnFailed);                                         // 0x0060   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,11685) /* FString */              __um(QRCode);                                               // 0x0098   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,11686) /* FString */              __um(AnchorName);                                           // 0x0090   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(16,11687) /* FMulticastInlineDelegate */ __um(OnSuccess);                                        // 0x0050   (0x0010)  
	SDK_UNDEFINED(16,11688) /* FMulticastInlineDelegate */ __um(OnFailed);                                         // 0x0060   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,11689) /* FMulticastInlineDelegate */ __um(OnSuccess);                                        // 0x0050   (0x0010)  
	SDK_UNDEFINED(16,11690) /* FMulticastInlineDelegate */ __um(OnFailed);                                         // 0x0060   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,11691) /* FMulticastInlineDelegate */ __um(OnARActorSpawnedDelegate);                         // 0x0220   (0x0010)  
	SDK_UNDEFINED(16,11692) /* FMulticastInlineDelegate */ __um(OnARActorToBeDestroyedDelegate);                   // 0x0230   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,11693) /* FMulticastInlineDelegate */ __um(OnARTrackingStateChanged);                         // 0x0120   (0x0010)  
	SDK_UNDEFINED(16,11694) /* FMulticastInlineDelegate */ __um(OnARTransformUpdated);                             // 0x0130   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,11695) /* FString */              __um(QRCode);                                               // 0x0170   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,11696) /* TMap<EARFaceBlendShape, float> */ __um(BlendShapes);                                // 0x0178   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(16,11697) /* FMulticastInlineDelegate */ __um(OnAddTrackedGeometry);                             // 0x00A0   (0x0010)  
	SDK_UNDEFINED(16,11698) /* FMulticastInlineDelegate */ __um(OnUpdateTrackedGeometry);                          // 0x00B0   (0x0010)  
	SDK_UNDEFINED(16,11699) /* FMulticastInlineDelegate */ __um(OnRemoveTrackedGeometry);                          // 0x00C0   (0x0010)  
	SDK_UNDEFINED(16,11700) /* FMulticastInlineDelegate */ __um(OnAddTrackedPlane);                                // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,11701) /* FMulticastInlineDelegate */ __um(OnUpdateTrackedPlane);                             // 0x00E0   (0x0010)  
	SDK_UNDEFINED(16,11702) /* FMulticastInlineDelegate */ __um(OnRemoveTrackedPlane);                             // 0x00F0   (0x0010)  
	SDK_UNDEFINED(16,11703) /* FMulticastInlineDelegate */ __um(OnAddTrackedPoint);                                // 0x0100   (0x0010)  
	SDK_UNDEFINED(16,11704) /* FMulticastInlineDelegate */ __um(OnUpdateTrackedPoint);                             // 0x0110   (0x0010)  
	SDK_UNDEFINED(16,11705) /* FMulticastInlineDelegate */ __um(OnRemoveTrackedPoint);                             // 0x0120   (0x0010)  
	SDK_UNDEFINED(16,11706) /* FMulticastInlineDelegate */ __um(OnAddTrackedImage);                                // 0x0130   (0x0010)  
	SDK_UNDEFINED(16,11707) /* FMulticastInlineDelegate */ __um(OnUpdateTrackedImage);                             // 0x0140   (0x0010)  
	SDK_UNDEFINED(16,11708) /* FMulticastInlineDelegate */ __um(OnRemoveTrackedImage);                             // 0x0150   (0x0010)  
	SDK_UNDEFINED(16,11709) /* FMulticastInlineDelegate */ __um(OnAddTrackedFace);                                 // 0x0160   (0x0010)  
	SDK_UNDEFINED(16,11710) /* FMulticastInlineDelegate */ __um(OnUpdateTrackedFace);                              // 0x0170   (0x0010)  
	SDK_UNDEFINED(16,11711) /* FMulticastInlineDelegate */ __um(OnRemoveTrackedFace);                              // 0x0180   (0x0010)  
	SDK_UNDEFINED(16,11712) /* FMulticastInlineDelegate */ __um(OnAddTrackedEnvProbe);                             // 0x0190   (0x0010)  
	SDK_UNDEFINED(16,11713) /* FMulticastInlineDelegate */ __um(OnUpdateTrackedEnvProbe);                          // 0x01A0   (0x0010)  
	SDK_UNDEFINED(16,11714) /* FMulticastInlineDelegate */ __um(OnRemoveTrackedEnvProbe);                          // 0x01B0   (0x0010)  
	SDK_UNDEFINED(16,11715) /* FMulticastInlineDelegate */ __um(OnAddTrackedObject);                               // 0x01C0   (0x0010)  
	SDK_UNDEFINED(16,11716) /* FMulticastInlineDelegate */ __um(OnUpdateTrackedObject);                            // 0x01D0   (0x0010)  
	SDK_UNDEFINED(16,11717) /* FMulticastInlineDelegate */ __um(OnRemoveTrackedObject);                            // 0x01E0   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(16,11718) /* FString */              __um(FriendlyName);                                         // 0x0038   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,11719) /* FString */              __um(FriendlyName);                                         // 0x0040   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,11720) /* FString */              __um(AdditionalInfo);                                       // 0x0000   (0x0010)  
