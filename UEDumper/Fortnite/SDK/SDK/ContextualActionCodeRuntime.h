...
public:
	...
	SDK_UNDEFINED(24,12258) /* FText */                __um(StartHijackInteractText);                              // 0x00C0   (0x0018)  
	SDK_UNDEFINED(24,12259) /* FText */                __um(StartHijackInteractSubText);                           // 0x00D8   (0x0018)  
	SDK_UNDEFINED(24,12260) /* FText */                __um(CompleteHijackInteractText);                           // 0x00F0   (0x0018)  
	SDK_UNDEFINED(24,12261) /* FText */                __um(CompleteHijackInteractSubText);                        // 0x0108   (0x0018)  
...
public:
	...
	SDK_UNDEFINED(8,12262) /* TWeakObjectPtr<AFortSwingingObject*> */ __um(ReplicatedSwingingObject);              // 0x00E4   (0x0008)  
...
{ 
	...
	SDK_UNDEFINED(8,12263) /* TWeakObjectPtr<AFortSwingingObject*> */ __um(TargetSwingingObject);                  // 0x0020   (0x0008)  
};
...
{ 
	FVector                                            AttachLocation;                                             // 0x0008   (0x0018)  
	SDK_UNDEFINED(8,12264) /* TWeakObjectPtr<AFortSwingingObject*> */ __um(TargetSwingingRope);                    // 0x0020   (0x0008)  
};
