...
public:
	...
	SDK_UNDEFINED(80,14729) /* TMap<UClass*, FORSClassTupleList> */ __um(ClassMap);                                // 0x0038   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(16,14730) /* TScriptInterface<Class> */ __um(Object);                                            // 0x0000   (0x0010)  
