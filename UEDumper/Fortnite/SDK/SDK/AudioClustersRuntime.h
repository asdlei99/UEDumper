...
{ 
public:
	SDK_UNDEFINED(80,11602) /* TMap<FGameplayTag, UAudioClusterConfig*> */ __um(TagConfigMap);                     // 0x0028   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(8,11603) /* TWeakObjectPtr<AActor*> */ __um(Actor);                                              // 0x0000   (0x0008)  
