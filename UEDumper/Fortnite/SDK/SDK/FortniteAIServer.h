...
{ 
public:
	unsigned char                                      UnknownData00_2[0x20];                                      // 0x01A8   (0x0020)  MISSED
	FScalableFloat                                     MaxApproaches;                                              // 0x01C8   (0x0028)  
	FFortNearbyActorsPerceptionConfiguration           PerceptionConfiguration;                                    // 0x01F0   (0x00D0)  
	FName                                              EnableKeyName;                                              // 0x02C0   (0x0004)  
	unsigned char                                      UnknownData01_6[0xC];                                       // 0x02C4   (0x000C)  MISSED
};

/// Class /Script/FortniteAIServer.FortAthenaAIBotEvaluator_Harvest
/// Size: 0x0170 (0x0001A8 - 0x000318)
class UFortAthenaAIBotEvaluator_Harvest : public UFortAthenaAIBotEvaluator_Movement
{ 
public:
	unsigned char                                      UnknownData00_2[0x48];                                      // 0x01A8   (0x0048)  MISSED
	class UClass*                                      ProjectionNavigationQueryFilterClass;                       // 0x01F0   (0x0008)  
	class UClass*                                      ValidNavigationQueryFilterClassOverride;                    // 0x01F8   (0x0008)  
	FScalableFloat                                     MaximumTimeToHelpFromLastPlayerDamage;                      // 0x0200   (0x0028)  
	FScalableFloat                                     KeepTargetTimeOnWeaponTrigger;                              // 0x0228   (0x0028)  
	FScalableFloat                                     AmountOfTimesPlayerBuiltStructuresNeedToBeDamaged;          // 0x0250   (0x0028)  
	FScalableFloat                                     TimeToTrackDamagedActors;                                   // 0x0278   (0x0028)  
	FScalableFloat                                     MaxDistanceFromActorForFallbackNoHarvestBehaviour;          // 0x02A0   (0x0028)  
	TArray<class UClass*>                              GEsToApplyOnFallbackBehaviorTrigger;                        // 0x02C8   (0x0010)  
	TArray<class UClass*>                              GEsToApplyOnCannotDamageBehaviorTrigger;                    // 0x02D8   (0x0010)  
	FName                                              HarvestTargetKeyName;                                       // 0x02E8   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x02EC   (0x0004)  MISSED
	FName                                              HarvestTargetHitPointKeyName;                               // 0x02F0   (0x0004)  
	unsigned char                                      UnknownData02_5[0x4];                                       // 0x02F4   (0x0004)  MISSED
	FName                                              HarvestDestinationKeyName;                                  // 0x02F8   (0x0004)  
	unsigned char                                      UnknownData03_5[0x4];                                       // 0x02FC   (0x0004)  MISSED
	FName                                              FallbackBehaviorKeyName;                                    // 0x0300   (0x0004)  
	unsigned char                                      UnknownData04_5[0x4];                                       // 0x0304   (0x0004)  MISSED
	FName                                              CannotDamageKeyName;                                        // 0x0308   (0x0004)  
	unsigned char                                      UnknownData05_5[0x4];                                       // 0x030C   (0x0004)  MISSED
	FName                                              WeaponTriggerMeleeKeyName;                                  // 0x0310   (0x0004)  
	unsigned char                                      UnknownData06_6[0x4];                                       // 0x0314   (0x0004)  MISSED


	/// Functions
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_Harvest.HandleUnconverted
	// void HandleUnconverted(class AFortPawn* UnconvertedPawn, EUnconvertReason UnconvertReason);                           // [0x9c23e4c] Final|Native|Protected 
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_Harvest.HandleConverted
	// void HandleConverted(class AFortPawn* InstigatorPawn, class AFortPawn* ConvertedPawn);                                // [0x9c23d8c] Final|Native|Protected 
};
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x70];                                      // 0x01A8   (0x0070)  MISSED
	FScalableFloat                                     MaxSecondsToReactToBump;                                    // 0x0218   (0x0028)  
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x4];                                       // 0x01A8   (0x0004)  MISSED
	FName                                              WeaponKeyName;                                              // 0x01AC   (0x0004)  
	FName                                              MoveToDestinationKeyName;                                   // 0x01B0   (0x0004)  
	FName                                              TargetActorName;                                            // 0x01B4   (0x0004)  
...
public:
	...
	TArray<FPositioningEQS>                            EQSs;                                                       // 0x01D0   (0x0010)  
	float                                              TokenPositionCooldown;                                      // 0x01E0   (0x0004)  
	float                                              TokenPositionCooldownVariation;                             // 0x01E4   (0x0004)  
...
public:
	...
	class UAbilitySystemComponent*                     CachedAbilitySystemComponent;                               // 0x0108   (0x0008)  
};
...
{ 
public:
	TArray<class UObject*>                             ReferenceHolder;                                            // 0x0070   (0x0010)  
	TArray<FFortBTService_InjectionTagKey>             InjectionTagsKeys;                                          // 0x0080   (0x0010)  
	FName                                              InjectionItemKeyName;                                       // 0x0090   (0x0004)  
...
public:
	...
	// void HandleTimeOfDayPhaseChange(EFortDayPhase CurrentDayPhase, EFortDayPhase PreviousDayPhase, bool bAtCreation);     // [0x9c41e38] Final|Native|Private 
};
...
public:
	...
	// void SetQueryTemplate(class UEnvQuery* InPrevisQueryTemplate);                                                        // [0x5fffda8] Final|Native|Public|BlueprintCallable 
	// Function /Script/FortniteAIServer.FortEQSPrevisActor.PrepForPrevis
	// void PrepForPrevis();                                                                                                 // [0x2177018] Event|Public|BlueprintEvent 
};
...
public:
	...
	// bool CanBeUsedBy(class AActor* User, class AActor* SmartObjectActor);                                                 // [0x68eeea0] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
...
{ 
public:
	FName                                              LastKnownPositionName;                                      // 0x01A8   (0x0004)  
	FName                                              DestinationKeyName;                                         // 0x01AC   (0x0004)  
	FName                                              MoveToDestinationKeyName;                                   // 0x01B0   (0x0004)  
...
{ 
public:
	FName                                              AvoidThreatKeyName;                                         // 0x01A8   (0x0004)  
	FName                                              AvoidThreatMovementStateKeyName;                            // 0x01AC   (0x0004)  
	FName                                              AvoidThreatDestinationKeyName;                              // 0x01B0   (0x0004)  
	unsigned char                                      UnknownData00_5[0xC];                                       // 0x01B4   (0x000C)  MISSED
	class AActor*                                      CurrentThreatActorAvoiding;                                 // 0x01C0   (0x0008)  
	class UFortAthenaAIBotEvasiveManeuversDigestedSkillSet* CacheEMDigestedSkillSet;                               // 0x01C8   (0x0008)  
};
...
{ 
public:
	FName                                              BuildExecutionStatusKeyName;                                // 0x01A8   (0x0004)  
...
public:
	...
	// void OnZiplineStateChanged(bool bIsZiplining, class AFortPlayerPawn* FortPlayerPawn);                                 // [0x9c93410] Final|Native|Private 
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_CharacterLaunched.OnCharacterLaunchChanged
	// void OnCharacterLaunchChanged(class UFortMovementComp_Character* MovementComponent, FVector& LaunchVelocity);         // [0x9c92eb8] Final|Native|Private|HasOutParms|HasDefaults 
};
...
public:
	...
	// void OnPlayerPawnSpawned(class AAIController* Controller, class AFortPawn* Pawn);                                     // [0x9c93290] Final|Native|Private 
};
...
/// Size: 0x01D8 (0x0001A8 - 0x000380)
class UFortAthenaAIBotEvaluator_Converted : public UFortAthenaAIBotEvaluator_Movement
{ 
public:
	FName                                              ShouldMoveTowardsConverterName;                             // 0x01A8   (0x0004)  
	FName                                              ShouldTeleportTowardsConverterName;                         // 0x01AC   (0x0004)  
	FName                                              ConvertedAllowPatrolAroundName;                             // 0x01B0   (0x0004)  
	FName                                              ConvertedAllowScanAroundWhenWaitingName;                    // 0x01B4   (0x0004)  
	FName                                              ConvertedDestinationName;                                   // 0x01B8   (0x0004)  
	FName                                              CrouchExecutionStatusName;                                  // 0x01BC   (0x0004)  
	FVector                                            TeleportLocationProjectionExtent;                           // 0x01C0   (0x0018)  
	FVector                                            MovingFromLosLocationProjectionExtent;                      // 0x01D8   (0x0018)  
	FScalableFloat                                     AmountOfTimesNonHostilePawnNeedsToBeDamagedForTargeting;    // 0x01F0   (0x0028)  
	FScalableFloat                                     TimeToTrackDamagedActors;                                   // 0x0218   (0x0028)  
	...
	unsigned char                                      UnknownData01_5[0x68];                                      // 0x02F8   (0x0068)  MISSED
	class AFortPawn*                                   ConverterPawn;                                              // 0x0360   (0x0008)  
	class UFortAthenaAIRuntimeParameters_AIBotConvert* CachedAIBotConvertParameters;                               // 0x0368   (0x0008)  
	...
	// void OnUnconvertedEvent(class AFortPawn* UnconvertedPawn, EUnconvertReason UnconvertReason);                          // [0x9c93354] Final|Native|Protected 
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_Converted.OnConvertedEvent
	// void OnConvertedEvent(class AFortPawn* InstigatorPawn, class AFortPawn* ConvertedPawn);                               // [0x9c92fc0] Final|Native|Protected 
};
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x10];                                      // 0x00F8   (0x0010)  MISSED
...
{ 
public:
	FName                                              DBNODestinationKeyName;                                     // 0x01A8   (0x0004)  
	unsigned char                                      UnknownData00_5[0x2];                                       // 0x01AC   (0x0002)  MISSED
	bool                                               bAllowReachSquadmates : 1;                                  // 0x01AE:0 (0x0001)  
	bool                                               bAllowReachSameFactionNPCs : 1;                             // 0x01AE:1 (0x0001)  
	unsigned char                                      UnknownData01_4[0x1];                                       // 0x01AF   (0x0001)  MISSED
	TArray<class AFortPlayerPawnAthena*>               AllyPawns;                                                  // 0x01B0   (0x0010)  
	FVector                                            CachedCurrentDestination;                                   // 0x01C0   (0x0018)  
	class UFortAthenaAIBotDBNODigestedSkillSet*        DBNOSkillSet;                                               // 0x01D8   (0x0008)  
	class UFortAthenaAICoverComponent*                 CachedCoverComponent;                                       // 0x01E0   (0x0008)  
	class UFortAthenaAIRuntimeParameters_DBNOBehavior* DBNOBehaviorRuntimeParameters;                              // 0x01E8   (0x0008)  
	...
	// void OnAllyPawnDBNOStateChanged(class AFortPawn* InPlayer, bool bInIsDBNO);                                           // [0x9c92df0] Final|Native|Private 
};
...
{ 
public:
	FGameplayTagContainer                              EscapeTags;                                                 // 0x01A8   (0x0020)  
	float                                              CooldownBetweenAggressivenessChanges;                       // 0x01C8   (0x0004)  
	FName                                              AggressivenessName;                                         // 0x01CC   (0x0004)  
	unsigned char                                      UnknownData00_6[0x8];                                       // 0x01D0   (0x0008)  MISSED
};
...
{ 
public:
	unsigned char                                      UnknownData00_2[0xA8];                                      // 0x00A8   (0x00A8)  MISSED
	...
	// void OnMoveCompleted(FAIRequestID RequestID, TEnumAsByte<EPathFollowingResult> MovementResult);                       // [0x9c93080] Final|Native|Public  
};
...
{ 
public:
	class AFortAIDirector*                             CachedAIDirector;                                           // 0x01A8   (0x0008)  
	class UFortAthenaAIBotRangeAttackDigestedSkillSet* CachedRangeAttackDigestedSkillSet;                          // 0x01B0   (0x0008)  
	FName                                              FlankingExecutionStatusKeyName;                             // 0x01B8   (0x0004)  
	FName                                              FlankingMovementStateKeyName;                               // 0x01BC   (0x0004)  
	FName                                              FlankingDestinationKeyName;                                 // 0x01C0   (0x0004)  
...
{ 
public:
	float                                              MinDistanceFromTarget;                                      // 0x01A8   (0x0004)  
	float                                              MinValidDistanceForFleeLocation;                            // 0x01AC   (0x0004)  
	float                                              FleeDistance;                                               // 0x01B0   (0x0004)  
	float                                              MaxDistanceFromTargetWhenFleeing;                           // 0x01B4   (0x0004)  
	float                                              MinDistanceHysteresisWhenChangingTarget;                    // 0x01B8   (0x0004)  
	FName                                              FleeKeyName;                                                // 0x01BC   (0x0004)  
	FName                                              FleeMovementStateKeyName;                                   // 0x01C0   (0x0004)  
	FName                                              FleeDestinationKeyName;                                     // 0x01C4   (0x0004)  
	FName                                              FleeActorKeyName;                                           // 0x01C8   (0x0004)  
	unsigned char                                      UnknownData00_5[0xC];                                       // 0x01CC   (0x000C)  MISSED
	class AActor*                                      CurrentActorFleeingFrom;                                    // 0x01D8   (0x0008)  
};
...
public:
	...
	// void HandlePlayerHealthOrShieldChanged();                                                                             // [0x9c92ddc] Final|Native|Private 
};
...
{ 
public:
	FScalableFloat                                     AttackDurationBeforeEvade;                                  // 0x01A8   (0x0028)  
	FScalableFloat                                     MeleeAttackMaxDistToEvade;                                  // 0x01D0   (0x0028)  
	FScalableFloat                                     ClampEvadeDistanceEnable;                                   // 0x01F8   (0x0028)  
	FScalableFloat                                     MinDistanceToEvade;                                         // 0x0220   (0x0028)  
	FScalableFloat                                     MaxDistanceToEvade;                                         // 0x0248   (0x0028)  
	FName                                              EvadeKeyName;                                               // 0x0270   (0x0004)  
	FName                                              EvadeMovementStateKeyName;                                  // 0x0274   (0x0004)  
	FName                                              EvadeDestinationKeyName;                                    // 0x0278   (0x0004)  
	FName                                              WeaponTriggerMeleeName;                                     // 0x027C   (0x0004)  
	unsigned char                                      UnknownData00_5[0x10];                                      // 0x0280   (0x0010)  MISSED
	float                                              MeleeAttackMaxDistToEvadeSqr;                               // 0x0290   (0x0004)  
	float                                              MaxDistanceToEvadeSqr;                                      // 0x0294   (0x0004)  
...
public:
	...
	FName                                              MoveToDestinationKeyName;                                   // 0x01B0   (0x0004)  
	FName                                              AggressivenessName;                                         // 0x01B4   (0x0004)  
	FName                                              CautiousKeyName;                                            // 0x01B8   (0x0004)  
	FName                                              AlertLevelName;                                             // 0x01BC   (0x0004)  
	class UClass*                                      SearchQueryFilterClass;                                     // 0x01C0   (0x0008)  
	unsigned char                                      UnknownData00_5[0x10];                                      // 0x01C8   (0x0010)  MISSED
	class UFortAthenaAIBotAimingDigestedSkillSet*      CacheAimingDigestedSkillSet;                                // 0x01D8   (0x0008)  
	class UFortAthenaAIBotAttackingDigestedSkillSet*   CacheAttackingDigestedSkillSet;                             // 0x01E0   (0x0008)  
	class UFortAthenaAIBotUnstuckDigestedSkillSet*     CachedUnstuckSkillSet;                                      // 0x01E8   (0x0008)  
	unsigned char                                      UnknownData01_5[0x48];                                      // 0x01F0   (0x0048)  MISSED
	class AActor*                                      InvestigatingSupportingActor;                               // 0x0238   (0x0008)  
	class ABuildingSMActor*                            UnderminingBuildingActor;                                   // 0x0240   (0x0008)  
	class AActor*                                      ExcludeReachingTarget;                                      // 0x0248   (0x0008)  
	unsigned char                                      UnknownData02_6[0x18];                                      // 0x0250   (0x0018)  MISSED
};
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x4];                                       // 0x01C0   (0x0004)  MISSED
	FName                                              WeaponTriggerMeleeName;                                     // 0x01C4   (0x0004)  
	FName                                              ThrowableAttacksAllowedName;                                // 0x01C8   (0x0004)  
	FName                                              TraversalBlockMeleeAttackName;                              // 0x01CC   (0x0004)  
	FName                                              TargetContextReachableKeyName;                              // 0x01D0   (0x0004)  
	FName                                              TargetContextInsideLeashKeyName;                            // 0x01D4   (0x0004)  
	unsigned char                                      UnknownData01_5[0x18];                                      // 0x01D8   (0x0018)  MISSED
	class UFortAthenaAIBotAttackingDigestedSkillSet*   AttackingSkillSet;                                          // 0x01F0   (0x0008)  
...
{ 
public:
	FEQSParametrizedQueryExecutionRequest              EQSRequest;                                                 // 0x01A8   (0x0048)  
	class UClass*                                      NavigationQueryFilterClass;                                 // 0x01F0   (0x0008)  
	bool                                               bFallbackToPointWithNoCustomNavigationQueryFilter;          // 0x01F8   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x01F9   (0x0003)  MISSED
	FName                                              PatrolDestinationName;                                      // 0x01FC   (0x0004)  
	FName                                              PatrolExecutionStatusName;                                  // 0x0200   (0x0004)  
	FName                                              PatrolMovementStateName;                                    // 0x0204   (0x0004)  
	FName                                              BestTargetActorName;                                        // 0x0208   (0x0004)  
	FName                                              EnableKeyName;                                              // 0x020C   (0x0004)  
	unsigned char                                      UnknownData01_5[0x8];                                       // 0x0210   (0x0008)  MISSED
	class AFortGameModeAthena*                         CacheAthenaGameMode;                                        // 0x0218   (0x0008)  
	unsigned char                                      UnknownData02_6[0x20];                                      // 0x0220   (0x0020)  MISSED
};
...
{ 
public:
	FName                                              PlayEmoteExecutionStatusKeyName;                            // 0x01A8   (0x0004)  
	FName                                              PlayEmoteDestinationKeyName;                                // 0x01AC   (0x0004)  
	unsigned char                                      UnknownData00_5[0x8];                                       // 0x01B0   (0x0008)  MISSED
	class AActor*                                      ExcludeReachingTarget;                                      // 0x01B8   (0x0008)  
...
/// Size: 0x0170 (0x0001C0 - 0x000330)
class UFortAthenaAIBotEvaluator_RangeAttack : public UFortAthenaAIBotEvaluator_Attack
{ 
public:
	unsigned char                                      UnknownData00_2[0x38];                                      // 0x01C0   (0x0038)  MISSED
	FName                                              WeaponReloadName;                                           // 0x01F8   (0x0004)  
	FName                                              WeaponFireName;                                             // 0x01FC   (0x0004)  
	FName                                              RangeAttackIsReadyToFireName;                               // 0x0200   (0x0004)  
	FName                                              WeaponTargetingName;                                        // 0x0204   (0x0004)  
	FName                                              AggressivenessName;                                         // 0x0208   (0x0004)  
	FName                                              HasLoSOnThreatName;                                         // 0x020C   (0x0004)  
	FName                                              UrgentMovementKeyName;                                      // 0x0210   (0x0004)  
	unsigned char                                      UnknownData01_5[0xE];                                       // 0x0214   (0x000E)  MISSED
	bool                                               bAlwaysAllowTargetingEvaluation;                            // 0x0222   (0x0001)  
	bool                                               bSkipADSEvaluation;                                         // 0x0223   (0x0001)  
	bool                                               bConsiderLoF;                                               // 0x0224   (0x0001)  
	bool                                               bShouldValidateRangedWeapon;                                // 0x0225   (0x0001)  
	unsigned char                                      UnknownData02_5[0x2];                                       // 0x0226   (0x0002)  MISSED
	float                                              RangeReachHysteresisRatio;                                  // 0x0228   (0x0004)  
	unsigned char                                      UnknownData03_5[0x1C];                                      // 0x022C   (0x001C)  MISSED
	class UFortAthenaAIBotRangeAttackDigestedSkillSet* CacheRangeAttackDigestedSkillSet;                           // 0x0248   (0x0008)  
	...
	// void FindShootingPosition_Async(int32_t RequestID, float DistanceFromTarget, float WeaponIdealAttackRange, FVector& TargetPosition); // [0x9cb1d84] Final|Native|Protected|HasOutParms|HasDefaults 
};
...
{ 
public:
	FName                                              ReachBeaconStatusKeyName;                                   // 0x01A8   (0x0004)  
...
/// Size: 0x0248 (0x0001A8 - 0x0003F0)
class UFortAthenaAIBotEvaluator_ReactToVerb : public UFortAthenaAIBotEvaluator_Movement
{ 
public:
	unsigned char                                      UnknownData00_2[0x68];                                      // 0x01A8   (0x0068)  MISSED
	class UFortAthenaAIBotReactToVerbDigestedSkillSet* CacheReactToVerbDigestedSkillSet;                           // 0x0210   (0x0008)  
	class UDataTable*                                  VerbReactions;                                              // 0x0218   (0x0008)  
	FScalableFloat                                     MinDistanceFromPlayerToReact;                               // 0x0220   (0x0028)  
	FScalableFloat                                     MaxReactionEmoteDuration;                                   // 0x0248   (0x0028)  
	FScalableFloat                                     MaxReactionWaitTime;                                        // 0x0270   (0x0028)  
	...
	unsigned char                                      UnknownData03_5[0x4];                                       // 0x03A4   (0x0004)  MISSED
	...
	// void HandlePawnStoppedEmote(class UFortItemDefinition* MontageItemDef, class AFortPawn* PawnEmoting);                 // [0x696d714] Final|Native|Protected 
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_ReactToVerb.HandlePawnStartedEmote
	// void HandlePawnStartedEmote(class UFortItemDefinition* MontageItemDef, class AFortPawn* PawnEmoting);                 // [0x696d714] Final|Native|Protected 
};
...
{ 
public:
	FScalableFloat                                     RecoveringLineOfSightMaxDuration;                           // 0x01A8   (0x0028)  
	TArray<FName>                                      ExecutionStatusToListenKeyNames;                            // 0x01D0   (0x0010)  
	FName                                              RecoverLineOfSightExecutionStatusKeyName;                   // 0x01E0   (0x0004)  
	FName                                              RecoverLineOfSightMovementStateKeyName;                     // 0x01E4   (0x0004)  
	FName                                              RecoverLineOfSightDestinationKeyName;                       // 0x01E8   (0x0004)  
	unsigned char                                      UnknownData00_6[0x24];                                      // 0x01EC   (0x0024)  MISSED
};
...
{ 
public:
	FName                                              RetreatDestinationName;                                     // 0x01A8   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x01AC   (0x0004)  MISSED
	class UFortAthenaAIBotAttackingDigestedSkillSet*   CacheAttackingDigestedSkillSet;                             // 0x01B0   (0x0008)  
	class UFortAthenaAICoverComponent*                 CachedCoverComponent;                                       // 0x01B8   (0x0008)  
	unsigned char                                      UnknownData01_6[0x18];                                      // 0x01C0   (0x0018)  MISSED


	/// Functions
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_Retreat.HandlePlayerHealthOrShieldChanged
	// void HandlePlayerHealthOrShieldChanged();                                                                             // [0x9cb1f04] Final|Native|Protected 
};
...
{ 
public:
	FScalableFloat                                     LastReviveTargetExpiration;                                 // 0x01A8   (0x0028)  
	FName                                              ReviveTargetKeyName;                                        // 0x01D0   (0x0004)  
	FName                                              ReviveLastTargetKeyName;                                    // 0x01D4   (0x0004)  
	class UFortAthenaAIRuntimeParameters_ReviveBehavior* ReviveBehaviorRuntimeParameters;                          // 0x01D8   (0x0008)  
	class AFortPlayerPawnAthena*                       CurrentReviveTarget;                                        // 0x01E0   (0x0008)  
	TArray<class AFortPlayerPawnAthena*>               DBNOAllyPawns;                                              // 0x01E8   (0x0010)  
	class UFortAthenaAIBotReviveDigestedSkillSet*      ReviveSkillSet;                                             // 0x01F8   (0x0008)  
	unsigned char                                      UnknownData00_6[0x10];                                      // 0x0200   (0x0010)  MISSED


	/// Functions
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_Revive.OnCurrentTargetRevived
	// void OnCurrentTargetRevived(class AFortPlayerPawn* RevivedPawn);                                                      // [0x9cb20f4] Final|Native|Private 
};
...
public:
	...
	// void OnBotControllerAlertLevelChanged(class AFortAthenaAIBotController* BotController, EAlertLevel OldAlertLevel, EAlertLevel NewAlertLevel); // [0x9cb1ff0] Final|Native|Private 
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_SandTunnel.Jump
	// void Jump();                                                                                                          // [0x9cb1f18] Final|Native|Protected 
};
...
{ 
public:
	FName                                              DynamicPOIExecutionStatusKeyName;                           // 0x01A8   (0x0004)  
	FName                                              DynamicPOILocationKeyName;                                  // 0x01AC   (0x0004)  
	unsigned char                                      UnknownData00_5[0x8];                                       // 0x01B0   (0x0008)  MISSED
	class AFortTeamInfoAthena*                         CachedTeamInfo;                                             // 0x01B8   (0x0008)  
	class UFortGameStateComponent_BattleRoyaleGamePhaseLogic* CachedGamePhaseLogic;                                // 0x01C0   (0x0008)  
	unsigned char                                      UnknownData01_5[0x38];                                      // 0x01C8   (0x0038)  MISSED
	FTimerHandle                                       NextSearchTimerHandle;                                      // 0x0200   (0x0008)  
	TArray<FFailedToReachPOI>                          FailedBotPOIList;                                           // 0x0208   (0x0010)  
	int32_t                                            CachedSelectedBotPOIID;                                     // 0x0218   (0x0004)  
	unsigned char                                      UnknownData02_6[0x4];                                       // 0x021C   (0x0004)  MISSED


	/// Functions
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_SelectNextDynamicPOI.ReachingPositionFail_Async
	// void ReachingPositionFail_Async(int32_t RequestID);                                                                   // [0x9cb2290] Final|Native|Private 
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_SelectNextDynamicPOI.OnSafeZonePhaseChanged
	// void OnSafeZonePhaseChanged(FFortSafeZonePhaseUpdatedEvent& Event);                                                   // [0x9cb2200] Final|Native|Private|HasOutParms 
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_SelectNextDynamicPOI.OnGamePhaseLogicReady
	// void OnGamePhaseLogicReady(FFortBattleRoyaleGamePhaseLogicComponentReadyEvent& Event);                                // [0x9cb2174] Final|Native|Private|HasOutParms 
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_SelectNextDynamicPOI.OnAgentDied
	// void OnAgentDied(class AFortAthenaAIBotController* BotController, class AFortPawn* FortPawn);                         // [0x9cb1f2c] Final|Native|Protected 
};
...
{ 
public:
	FName                                              NextPOIKeyName;                                             // 0x01A8   (0x0004)  
	FName                                              MarkerLocationKeyName;                                      // 0x01AC   (0x0004)  
	unsigned char                                      UnknownData00_5[0x8];                                       // 0x01B0   (0x0008)  MISSED
	class AFortPoiVolume*                              StartingGroundPOI;                                          // 0x01B8   (0x0008)  
	bool                                               bCheckForStartingGroundPOI;                                 // 0x01C0   (0x0001)  
	unsigned char                                      UnknownData01_5[0x3];                                       // 0x01C1   (0x0003)  MISSED
	float                                              CurrentPOICompletionTime;                                   // 0x01C4   (0x0004)  
	float                                              DurationInsideCurrentPOI;                                   // 0x01C8   (0x0004)  
	unsigned char                                      UnknownData02_5[0x4];                                       // 0x01CC   (0x0004)  MISSED
	class AFortTeamInfoAthena*                         CachedTeamInfo;                                             // 0x01D0   (0x0008)  
	class UFortAthenaAIBotLootingDigestedSkillSet*     CachedLootingSkillSet;                                      // 0x01D8   (0x0008)  
};
...
{ 
public:
	FName                                              VehicleDestinationKeyName;                                  // 0x01A8   (0x0004)  
	FName                                              SelectVehicleMovementStateKeyName;                          // 0x01AC   (0x0004)  
	FName                                              SelectVehicleStatusKeyName;                                 // 0x01B0   (0x0004)  
	FName                                              SelectedVehicleKeyName;                                     // 0x01B4   (0x0004)  
	unsigned char                                      UnknownData00_5[0x8];                                       // 0x01B8   (0x0008)  MISSED
	FScalableFloat                                     Enabled;                                                    // 0x01C0   (0x0028)  
	float                                              VehicleSearchRadius;                                        // 0x01E8   (0x0004)  
	bool                                               bCanEnterOnlyWithHisConverter;                              // 0x01EC   (0x0001)  
	bool                                               bCanEnterAsDriver;                                          // 0x01ED   (0x0001)  
	bool                                               bCanEnterVehiclesInWater;                                   // 0x01EE   (0x0001)  
	bool                                               bCanEnterOutOfFuelVehicles;                                 // 0x01EF   (0x0001)  
	bool                                               bCanEnterWithPlayerDriver;                                  // 0x01F0   (0x0001)  
	bool                                               bCanEnterOnlyMatchingPatrols;                               // 0x01F1   (0x0001)  
	unsigned char                                      UnknownData01_5[0x6];                                       // 0x01F2   (0x0006)  MISSED
	FGameplayTagQuery                                  VehiclesFilterTagQuery;                                     // 0x01F8   (0x0048)  
	FGameplayTagQuery                                  SeatsFilterTagQuery;                                        // 0x0240   (0x0048)  
};
...
{ 
public:
	class UFortAthenaAIRuntimeParameters_SmartObjectBase* SmartObjectRuntimeParameters;                            // 0x01A8   (0x0008)  
	class USmartObjectSubsystem*                       SmartObjectSubsystem;                                       // 0x01B0   (0x0008)  
	unsigned char                                      UnknownData00_5[0x8];                                       // 0x01B8   (0x0008)  MISSED
	bool                                               bEvaluateSOValidityAfterChosen;                             // 0x01C0   (0x0001)  
	bool                                               bEnableEntryLocationsSupport;                               // 0x01C1   (0x0001)  
	unsigned char                                      UnknownData01_5[0x6];                                       // 0x01C2   (0x0006)  MISSED
	FScalableFloat                                     MaximumEntryLocationsChecksPerEvaluation;                   // 0x01C8   (0x0028)  
	FScalableFloat                                     EntryLocationFailuresBlacklistedTime;                       // 0x01F0   (0x0028)  
	class UCurveFloat*                                 DistanceToWeightCurveForSlotPicking;                        // 0x0218   (0x0008)  
	class UClass*                                      OverridenFilterClassForEntryPoints;                         // 0x0220   (0x0008)  
	TArray<FName>                                      ExecutionStatusesToCheckForAllowToAvoidGoingToSOKeyNames;   // 0x0228   (0x0010)  
	unsigned char                                      UnknownData02_5[0x10];                                      // 0x0238   (0x0010)  MISSED
	FName                                              SmartObjectExecutionStatusKeyName;                          // 0x0248   (0x0004)  
	FName                                              SmartObjectMovementStateKeyName;                            // 0x024C   (0x0004)  
	FName                                              SmartObjectDestinationKeyName;                              // 0x0250   (0x0004)  
	FName                                              SmartObjectDestinationRotationKeyName;                      // 0x0254   (0x0004)  
	FName                                              SmartObjectShouldMoveKeyName;                               // 0x0258   (0x0004)  
	FName                                              SmartObjectUrgencyKeyName;                                  // 0x025C   (0x0004)  
	unsigned char                                      UnknownData03_6[0x20];                                      // 0x0260   (0x0020)  MISSED
};
...
{ 
public:
	class UFortAthenaAIBotRangeAttackDigestedSkillSet* CachedRangeAttackDigestedSkillSet;                          // 0x01A8   (0x0008)  
	class UAthenaAIServiceCover*                       CachedAIServiceCover;                                       // 0x01B0   (0x0008)  
	unsigned char                                      UnknownData00_5[0x8];                                       // 0x01B8   (0x0008)  MISSED
	FName                                              StepBackExecutionStatusKeyName;                             // 0x01C0   (0x0004)  
	FName                                              StepBackMovementStateKeyName;                               // 0x01C4   (0x0004)  
	FName                                              StepBackDestinationKeyName;                                 // 0x01C8   (0x0004)  
	unsigned char                                      UnknownData01_6[0xC];                                       // 0x01CC   (0x000C)  MISSED
};
...
{ 
public:
	FName                                              StormDestinationName;                                       // 0x01A8   (0x0004)  
	unsigned char                                      UnknownData00_5[0xC];                                       // 0x01AC   (0x000C)  MISSED
	class AFortGameModeAthena*                         CacheAthenaGameMode;                                        // 0x01B8   (0x0008)  
	class UBehaviorTreeComponent*                      CachedBTComp;                                               // 0x01C0   (0x0008)  
	...
	// void OnSafeZoneStateChanged(EFortSafeZoneState NewState);                                                             // [0x9cd39dc] Final|Native|Public  
};
...
{ 
public:
	class UFortAthenaAIBotRangeAttackDigestedSkillSet* CacheRangeAttackDigestedSkillSet;                           // 0x01A8   (0x0008)  
	class UFortAthenaAIBotAimingDigestedSkillSet*      CacheAimingDigestedSkillSet;                                // 0x01B0   (0x0008)  
	class UAthenaAIServiceCover*                       CachedAIServiceCover;                                       // 0x01B8   (0x0008)  
	FName                                              DestinationKeyName;                                         // 0x01C0   (0x0004)  
	FName                                              MoveToDestinationKeyName;                                   // 0x01C4   (0x0004)  
	FName                                              HealingStatusKeyName;                                       // 0x01C8   (0x0004)  
	FName                                              WeaponFireName;                                             // 0x01CC   (0x0004)  
	FName                                              TargetActorName;                                            // 0x01D0   (0x0004)  
	FName                                              BunkerStatusKeyName;                                        // 0x01D4   (0x0004)  
	unsigned char                                      UnknownData00_5[0x10];                                      // 0x01D8   (0x0010)  MISSED
	class ABuildingActor*                              CachedCoverBuildingActor;                                   // 0x01E8   (0x0008)  
	TArray<class ABuildingActor*>                      ExcludedBuildingActors;                                     // 0x01F0   (0x0010)  
	unsigned char                                      UnknownData01_6[0x38];                                      // 0x0200   (0x0038)  MISSED
};
...
{ 
public:
	FName                                              WeaponTriggerThrowableName;                                 // 0x01C0   (0x0004)  
	FName                                              ThrowableAttackIsReadyToThrowName;                          // 0x01C4   (0x0004)  
	unsigned char                                      UnknownData00_5[0x8];                                       // 0x01C8   (0x0008)  MISSED
	class UFortAthenaAIBotAttackingDigestedSkillSet*   AttackingSkillSet;                                          // 0x01D0   (0x0008)  
	class UFortAthenaAIBotRangeAttackDigestedSkillSet* RangeAttackSkillSet;                                        // 0x01D8   (0x0008)  
	class UFortAthenaAIBotAimingDigestedSkillSet*      AimingSkillSet;                                             // 0x01E0   (0x0008)  
	class UFortWorldItem*                              ChosenWeapon;                                               // 0x01E8   (0x0008)  
	class AFortPawn*                                   CachedFortPawn;                                             // 0x01F0   (0x0008)  
	unsigned char                                      UnknownData01_6[0x18];                                      // 0x01F8   (0x0018)  MISSED
};
...
{ 
public:
	FName                                              CurrentDestinationKeyName;                                  // 0x01A8   (0x0004)  
	FName                                              ZiplineTargetKeyName;                                       // 0x01AC   (0x0004)  
	FName                                              LastZiplineUsedName;                                        // 0x01B0   (0x0004)  
	FName                                              ZiplineMoveExecutionStatusKeyName;                          // 0x01B4   (0x0004)  
	FName                                              ZiplineEntryLocationKeyName;                                // 0x01B8   (0x0004)  
	FName                                              ZiplineExitLocationKeyName;                                 // 0x01BC   (0x0004)  
	FName                                              ZiplineLastUsageTimeName;                                   // 0x01C0   (0x0004)  
	FName                                              ZiplineUsageExecutionStatusName;                            // 0x01C4   (0x0004)  
	FScalableFloat                                     WaitTimeBetweenZiplineRandomChoices;                        // 0x01C8   (0x0028)  
	FScalableFloat                                     ProbabilityToUseZipline;                                    // 0x01F0   (0x0028)  
	unsigned char                                      UnknownData00_6[0x30];                                      // 0x0218   (0x0030)  MISSED


	/// Functions
	// Function /Script/FortniteAIServer.FortAthenaAIBotEvaluator_Zipline.OnZiplineStateChanged
	// void OnZiplineStateChanged(bool bIsZiplining, class AFortPlayerPawn* FortPlayerPawn);                                 // [0x9cd3b14] Final|Native|Protected 
};
...
public:
	...
	// void OnExit(class UBehaviorTreeComponent* OwnerComp);                                                                 // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/FortniteAIServer.FortAthenaAIEvaluator_BlueprintBase.OnEnter
	// void OnEnter(class UBehaviorTreeComponent* OwnerComp);                                                                // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/FortniteAIServer.FortAthenaAIEvaluator_BlueprintBase.EvaluateStartingConditions
	// bool EvaluateStartingConditions(class UBehaviorTreeComponent* OwnerComp);                                             // [0x9cd3838] Native|Event|Protected|BlueprintEvent|Const 
	// Function /Script/FortniteAIServer.FortAthenaAIEvaluator_BlueprintBase.EvaluateOngoingConditions
	// bool EvaluateOngoingConditions(class UBehaviorTreeComponent* OwnerComp);                                              // [0x9cd37a4] Native|Event|Protected|BlueprintEvent|Const 
};
...
{ 
public:
	FName                                              FollowGroupLeaderStatusKeyName;                             // 0x01A8   (0x0004)  
	FName                                              FollowGroupLeaderMovementStateKeyName;                      // 0x01AC   (0x0004)  
	FName                                              FollowGroupLeaderDestinationKeyName;                        // 0x01B0   (0x0004)  
	FName                                              TooFarFromLeaderKeyName;                                    // 0x01B4   (0x0004)  
	unsigned char                                      UnknownData00_5[0x8];                                       // 0x01B8   (0x0008)  MISSED
	class UFortPawnComponent_AIGroup*                  CachedAIGroupComponent;                                     // 0x01C0   (0x0008)  
};
...
public:
	...
	unsigned char                                      UnknownData03_6[0xF0];                                      // 0x0160   (0x00F0)  MISSED
};
...
public:
	...
	// void ManageWeaponTargeting(class UBehaviorTreeComponent* OwnerComp);                                                  // [0x9cd38cc] Final|Native|Protected|Const 
};
...
public:
	...
	// void OnStopSliding(class AFortPlayerPawn* Pawn);                                                                      // [0x9cd3a5c] Final|Native|Private 
};
...
{ 
public:
	FName                                              SmartObjectsStatusKeyName;                                  // 0x0070   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0074   (0x0004)  MISSED
	FName                                              SmartObjectDestinationRotationKeyName;                      // 0x0078   (0x0004)  
	unsigned char                                      UnknownData01_5[0x2];                                       // 0x007C   (0x0002)  MISSED
	bool                                               bHandleAbortWithSoftDisable;                                // 0x007E   (0x0001)  
	unsigned char                                      UnknownData02_5[0x29];                                      // 0x007F   (0x0029)  MISSED
...
public:
	...
	// void OnZiplineStateChanged(bool bIsZiplining, class AFortPlayerPawn* FortPlayerPawn);                                 // [0x9cf71fc] Final|Native|Public  
};
...
{ 
public:
	FScalableFloat                                     EncampmentEnable;                                           // 0x01A8   (0x0028)  
	FScalableFloat                                     EncampmentTentativeDelayMin;                                // 0x01D0   (0x0028)  
	FScalableFloat                                     EncampmentTentativeDelayMax;                                // 0x01F8   (0x0028)  
	FScalableFloat                                     EncampmentDurationMin;                                      // 0x0220   (0x0028)  
	FScalableFloat                                     EncampmentDurationMax;                                      // 0x0248   (0x0028)  
	FScalableFloat                                     BuilderPercentage;                                          // 0x0270   (0x0028)  
	FScalableFloat                                     BuilderMinDistance;                                         // 0x0298   (0x0028)  
	FScalableFloat                                     BuilderMaxDistance;                                         // 0x02C0   (0x0028)  
	FScalableFloat                                     GuardMinDistance;                                           // 0x02E8   (0x0028)  
	FScalableFloat                                     GuardMaxDistance;                                           // 0x0310   (0x0028)  
	FScalableFloat                                     AllowInSwimming;                                            // 0x0338   (0x0028)  
	FScalableFloat                                     AllowInFalling;                                             // 0x0360   (0x0028)  
	FScalableFloat                                     MinSquadMembersCountToBuild;                                // 0x0388   (0x0028)  
	FName                                              EncampmentStatusKeyName;                                    // 0x03B0   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x03B4   (0x0004)  MISSED
	FName                                              EncampmentMovementStateKeyName;                             // 0x03B8   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x03BC   (0x0004)  MISSED
	FName                                              EncampmentCenterLocationKeyName;                            // 0x03C0   (0x0004)  
	unsigned char                                      UnknownData02_5[0x4];                                       // 0x03C4   (0x0004)  MISSED
	FName                                              EncampmentDestinationKeyName;                               // 0x03C8   (0x0004)  
	unsigned char                                      UnknownData03_5[0x4];                                       // 0x03CC   (0x0004)  MISSED
	FName                                              EncampmentAroundCampFireLocationKeyName;                    // 0x03D0   (0x0004)  
	unsigned char                                      UnknownData04_5[0x4];                                       // 0x03D4   (0x0004)  MISSED
	FName                                              EncampmentRoleKeyName;                                      // 0x03D8   (0x0004)  
	unsigned char                                      UnknownData05_5[0x4];                                       // 0x03DC   (0x0004)  MISSED
	FName                                              DefensiveBuildName;                                         // 0x03E0   (0x0004)  
	unsigned char                                      UnknownData06_6[0x6C];                                      // 0x03E4   (0x006C)  MISSED
};
...
{ 
public:
	FName                                              FollowPatrolPathKeyName;                                    // 0x01A8   (0x0004)  
	FName                                              FollowPatrolPathMovementStateKeyName;                       // 0x01AC   (0x0004)  
	FName                                              FollowPatrolPathDestinationKeyName;                         // 0x01B0   (0x0004)  
	unsigned char                                      UnknownData00_5[0x8];                                       // 0x01B4   (0x0008)  MISSED
	float                                              ChanceToTakeABreak;                                         // 0x01BC   (0x0004)  
	float                                              BreakDurationMin;                                           // 0x01C0   (0x0004)  
	float                                              BreakDurationMax;                                           // 0x01C4   (0x0004)  
...
{ 
public:
	FScalableFloat                                     FormationOffsetRadiusMin;                                   // 0x01A8   (0x0028)  
	FScalableFloat                                     FormationOffsetRadiusMax;                                   // 0x01D0   (0x0028)  
	FScalableFloat                                     TooFarFromSquadLeaderDistance;                              // 0x01F8   (0x0028)  
	FScalableFloat                                     MaxNoiseRadius;                                             // 0x0220   (0x0028)  
	FScalableFloat                                     MinDurationNoiseEvaluate;                                   // 0x0248   (0x0028)  
	FScalableFloat                                     MaxDurationNoiseEvaluate;                                   // 0x0270   (0x0028)  
	FName                                              FollowSquadLeaderStatusKeyName;                             // 0x0298   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x029C   (0x0004)  MISSED
	FName                                              FollowSquadLeaderMovementStateKeyName;                      // 0x02A0   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x02A4   (0x0004)  MISSED
	FName                                              FollowSquadLeaderDestinationKeyName;                        // 0x02A8   (0x0004)  
	unsigned char                                      UnknownData02_5[0x4];                                       // 0x02AC   (0x0004)  MISSED
	FName                                              TooFarFromLeaderKeyName;                                    // 0x02B0   (0x0004)  
	unsigned char                                      UnknownData03_5[0x4];                                       // 0x02B4   (0x0004)  MISSED
	FVector                                            CachedSquadFormationOffset;                                 // 0x02B8   (0x0018)  
	FVector                                            CachedNoiseOffset;                                          // 0x02D0   (0x0018)  
	float                                              CachedTooFarFromSquadLeaderDistanceSqr;                     // 0x02E8   (0x0004)  
	float                                              LastNoiseOffsetUpdateTime;                                  // 0x02EC   (0x0004)  
	float                                              DurationNoiseEvaluate;                                      // 0x02F0   (0x0004)  
	unsigned char                                      UnknownData04_6[0x4];                                       // 0x02F4   (0x0004)  MISSED
};
...
{ 
public:
	FName                                              LeashKeyName;                                               // 0x01A8   (0x0004)  
	FName                                              LeashMovementStateKeyName;                                  // 0x01AC   (0x0004)  
	FName                                              LeashDestinationKeyName;                                    // 0x01B0   (0x0004)  
	FName                                              LeashLocationKeyName;                                       // 0x01B4   (0x0004)  
	FName                                              LeashOuterRadiusKeyName;                                    // 0x01B8   (0x0004)  
...
{ 
public:
	FName                                              PatrollingKeyName;                                          // 0x01A8   (0x0004)  
	FName                                              PatrollingMovementStateKeyName;                             // 0x01AC   (0x0004)  
	FName                                              PatrollingDestinationKeyName;                               // 0x01B0   (0x0004)  
	FName                                              DynamicBlueprintStatusKeyName;                              // 0x01B4   (0x0004)  
	FName                                              DynamicBlueprintActorKeyName;                               // 0x01B8   (0x0004)  
	FName                                              PatrollingShouldMoveKeyName;                                // 0x01BC   (0x0004)  
	FName                                              PatrollingAppendDestinationKeyName;                         // 0x01C0   (0x0004)  
	unsigned char                                      UnknownData00_5[0x10];                                      // 0x01C4   (0x0010)  MISSED
	float                                              DistanceToTestPoint;                                        // 0x01D4   (0x0004)  
	bool                                               bCanDisablePatrolling;                                      // 0x01D8   (0x0001)  
	bool                                               bCanReenablePatrolling;                                     // 0x01D9   (0x0001)  
	unsigned char                                      UnknownData01_5[0x2];                                       // 0x01DA   (0x0002)  MISSED
	float                                              ReenableTimer;                                              // 0x01DC   (0x0004)  
	bool                                               bCanSelectNearestPatrolPointAtStart;                        // 0x01E0   (0x0001)  
	unsigned char                                      UnknownData02_5[0x7];                                       // 0x01E1   (0x0007)  MISSED
	class UFortAthenaNpcPatrollingComponent*           CachedNpcPatrollingComponent;                               // 0x01E8   (0x0008)  
...
public:
	...
	unsigned char                                      UnknownData05_6[0x17];                                      // 0x00E9   (0x0017)  MISSED


	/// Functions
	// Function /Script/FortniteAIServer.FortAthenaPlayContextualAnimTaskInstanceData.OnNotifyBeginReceived
	// void OnNotifyBeginReceived(FName NotifyName, FBranchingPointNotifyPayload& BranchingPointNotifyPayload);              // [0x9cf703c] Final|Native|Public|HasOutParms 
	// Function /Script/FortniteAIServer.FortAthenaPlayContextualAnimTaskInstanceData.OnMontageEnded
	// void OnMontageEnded(class UAnimMontage* EndedMontage, bool bInterrupted);                                             // [0x9cf6eac] Final|Native|Public  
};
...
public:
	...
	// void OnNotifyBeginReceived(FName NotifyName, FBranchingPointNotifyPayload& BranchingPointNotifyPayload);              // [0x9cf711c] Final|Native|Private|HasOutParms 
	// Function /Script/FortniteAIServer.FortAthenaPlayInteractionStateTreeTask.OnMontageEnded
	// void OnMontageEnded(class UAnimMontage* EndedMontage, bool bInterrupted);                                             // [0x9cf6f74] Final|Native|Private 
};
...
public:
	...
	// void HandleNotifyBeginReceived(FName NotifyName, FBranchingPointNotifyPayload& BranchingPointNotifyPayload);          // [0x9cf6dcc] Final|Native|Private|HasOutParms 
	// Function /Script/FortniteAIServer.FortAthenaPlayMontageStateTreeTask.HandleMontageEnded
	// void HandleMontageEnded(class UAnimMontage* EndedMontage, bool bInterrupted);                                         // [0x9cf6d04] Final|Native|Private 
};
...
public:
	...
	// void HandleWorldStateChanged();                                                                                       // [0x9cfa950] Final|Native|Private 
};
