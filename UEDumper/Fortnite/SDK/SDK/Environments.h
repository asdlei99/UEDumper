...
public:
	...
	SDK_UNDEFINED(1,11163) /* TEnumAsByte<ETimelineDirection> */ __um(HoloMatColorPulse__Direction_E6C257BB472EFEF7971B66A1E8FAE3D8); // 0x059C   (0x0001)  
	...
	SDK_UNDEFINED(1,11164) /* TEnumAsByte<ETimelineDirection> */ __um(ScaleAnimEvolve__Direction_6D0D09564D54A0DEA88CCC96FA6653CC); // 0x05AC   (0x0001)  
	...
	SDK_UNDEFINED(1,11165) /* TEnumAsByte<ETimelineDirection> */ __um(ScaleAnimLevel__Direction_CC68128E49202D0C982B7A945E41AF43); // 0x05BC   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(1,11166) /* TEnumAsByte<ETimelineDirection> */ __um(ItemDetails__Direction_1EDCEF5F41216A9DADD25897C8B68493); // 0x0364   (0x0001)  
	...
	SDK_UNDEFINED(1,11167) /* TEnumAsByte<ETimelineDirection> */ __um(Floor_Visibility__Direction_37382717410D795E9E7E0990FC3EFCC2); // 0x0374   (0x0001)  
	...
	SDK_UNDEFINED(1,11168) /* TEnumAsByte<ETimelineDirection> */ __um(Background_Effects__Direction_7B5688E44724D9F68D3C20A520093829); // 0x0384   (0x0001)  
	...
	SDK_UNDEFINED(1,11169) /* TEnumAsByte<ETimelineDirection> */ __um(TransitionForward__Direction_FDB9DC244ED5578954F07A87EDA84CA5); // 0x039C   (0x0001)  
	...
	SDK_UNDEFINED(1,11170) /* TEnumAsByte<ETimelineDirection> */ __um(TransitionBackward__Direction_9CCDE9524354AF859735079DD2ED12AA); // 0x03B4   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(1,11171) /* TEnumAsByte<ETimelineDirection> */ __um(Timeline_1__Direction_F81FDC884C74C17EBF78B0B928138870); // 0x0444   (0x0001)  
	...
	SDK_UNDEFINED(1,11172) /* TEnumAsByte<ETimelineDirection> */ __um(Timeline_0__Direction_F92CF88A423F8300F5A67CB744A0DA45); // 0x0454   (0x0001)  
	...
	SDK_UNDEFINED(1,11173) /* TEnumAsByte<ETimelineDirection> */ __um(MoveOutRight__Direction_89D9209D4024EFFF08326CBAE53949F1); // 0x0478   (0x0001)  
	...
	SDK_UNDEFINED(1,11174) /* TEnumAsByte<ETimelineDirection> */ __um(MoveInRight__Direction_3FE1D8EB4B6BCBA0C3D120B521728FCE); // 0x04A0   (0x0001)  
	...
	SDK_UNDEFINED(1,11175) /* TEnumAsByte<ETimelineDirection> */ __um(MoveInLeft__Direction_B344DA1A46B3CB2F19E2E0A1F7E36A47); // 0x04C8   (0x0001)  
	...
	SDK_UNDEFINED(1,11176) /* TEnumAsByte<ETimelineDirection> */ __um(MoveOutLeft__Direction_6890893D4037128B5CB3B2AE9A4AE0A1); // 0x04F0   (0x0001)  
	...
	SDK_UNDEFINED(16,11177) /* FMulticastInlineDelegate */ __um(On_New_Item_Spawned);                              // 0x0508   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(1,11178) /* TEnumAsByte<ETimelineDirection> */ __um(TransitionForward__Direction_46DACBD74D0A8B2278950785C007984A); // 0x036C   (0x0001)  
	...
	SDK_UNDEFINED(1,11179) /* TEnumAsByte<ETimelineDirection> */ __um(BackgroundIntenstiy__Direction_8C51F99C4026F0204F2184AD9661CD23); // 0x037C   (0x0001)  
	...
	SDK_UNDEFINED(1,11180) /* TEnumAsByte<ETimelineDirection> */ __um(ItemDetailsIntensity__Direction_1EC6205345E5A708DA53B5A9449F1700); // 0x038C   (0x0001)  
	...
	SDK_UNDEFINED(1,11181) /* TEnumAsByte<ETimelineDirection> */ __um(Background_Effects__Direction_50767E4640E86998EC96B7B2D57E5E27); // 0x039C   (0x0001)  
	unsigned char                                      UnknownData04_5[0x3];                                       // 0x039D   (0x0003)  MISSED
	...
	SDK_UNDEFINED(1,11182) /* TEnumAsByte<ETimelineDirection> */ __um(IconDissolve__Direction_983A4DA644BE5CFAED0C378063FC66FC); // 0x03AC   (0x0001)  
	...
	SDK_UNDEFINED(1,11183) /* TEnumAsByte<ETimelineDirection> */ __um(ItemDetails__Direction_F4D1C4E246C708FA1F53EDA5A3FEE781); // 0x03C0   (0x0001)  
	...
	SDK_UNDEFINED(1,11184) /* TEnumAsByte<ETimelineDirection> */ __um(Floor_Visibility__Direction_CE7E338346E82397065B65AA77823F50); // 0x03D4   (0x0001)  
	...
	SDK_UNDEFINED(1,11185) /* TEnumAsByte<ETimelineDirection> */ __um(TransitionBackward__Direction_7073CD0840227233D3A64795A5A1B1B8); // 0x03EC   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(1,11186) /* TEnumAsByte<ETimelineDirection> */ __um(Timeline_YawRotation__Direction_F13714DD4AFE0C9C8857E2950BEC127B); // 0x043C   (0x0001)  
	...
	SDK_UNDEFINED(1,11187) /* TEnumAsByte<ETimelineDirection> */ __um(Timeline_Zoom__Direction_6FFD6729471BD965D850258DA1C0AF39); // 0x044C   (0x0001)  
	...
	SDK_UNDEFINED(1,11188) /* TEnumAsByte<ETimelineDirection> */ __um(CameraTurn_180_to_360__Direction_DF51680448A0BDB5D459C9BB5786D714); // 0x0490   (0x0001)  
	...
	SDK_UNDEFINED(1,11189) /* TEnumAsByte<ETimelineDirection> */ __um(CameraTurn_0_to_180__Direction_EEFFCB9D4EE2DC181BC00CBD7C0E7EF0); // 0x04D8   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(1,11190) /* TEnumAsByte<ETimelineDirection> */ __um(RezInMaterialEffectTimeLine2__Direction_FBE08AE14EC4BA399756F0BBFA6ABC31); // 0x07B4   (0x0001)  
	...
	SDK_UNDEFINED(1,11191) /* TEnumAsByte<ETimelineDirection> */ __um(RezInMaterialEffectTimeLine__Direction_963A663B4B1DFB2954D581893C8ACFD8); // 0x07C4   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(16,11192) /* FMulticastInlineDelegate */ __um(NewEventDispatcher);                               // 0x02D0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,11193) /* FMulticastInlineDelegate */ __um(OnZoomLevelUpdated);                               // 0x0348   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(24,11194) /* FText */                __um(CustomText);                                           // 0x02D0   (0x0018)  
