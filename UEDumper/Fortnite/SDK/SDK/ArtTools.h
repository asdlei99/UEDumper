...
public:
	...
	// void Set Canvas Material Scale and Position(FVector2D Size, FVector2D Position, double Scale, class UObject* __WorldContext, FVector2D& Screen Position, FVector2D& Screen Size); // [0x2047e54] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	...
	// void Array to HLSL Int Array(TEnumAsByte<EIntTypes> Type, FString& Variable Name, TArray<int32_t>& Int, TArray<FVector2D>& int2, TArray<FVector>& int3, TArray<FLinearColor>& int4, class UObject* __WorldContext, FString& String); // [0x2047e54] Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void BindScalabilitySettings(FDelegateProperty& Delegate, class UObject* __WorldContext);                             // [0x2047e54] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/ArtTools/Tech_Art/Libraries/Macros/B_TechArt_GlobalLibrary.B_TechArt_GlobalLibrary_C.IsLumenEnabled
	// void IsLumenEnabled(class UObject* __WorldContext, bool& IsEnabled);                                                  // [0x2047e54] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	...
	// void GetDynamicMaterialInstance(class UMeshComponent* MeshComponent, int32_t MaterialIndex, class UObject* __WorldContext, class UMaterialInstanceDynamic*& Material Instance Dynamic); // [0x2047e54] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/ArtTools/Tech_Art/Libraries/Macros/B_TechArt_GlobalLibrary.B_TechArt_GlobalLibrary_C.AreBoundsOverlapping?
	// void AreBoundsOverlapping?(FBox BoundsA, FBox BoundsB, class UObject* __WorldContext, bool& BoundsOverlap?);          // [0x2047e54] Static|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/ArtTools/Tech_Art/Libraries/Macros/B_TechArt_GlobalLibrary.B_TechArt_GlobalLibrary_C.AddActorTag
	// void AddActorTag(class AActor* Actor, FName& tag, class UObject* __WorldContext);                                     // [0x2047e54] Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
