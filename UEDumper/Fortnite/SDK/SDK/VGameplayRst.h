...
public:
	...
	// void OnRep_SoundAsset();                                                                                              // [0xa64dbd8] Final|Native|Protected 
	// Function /Script/VGameplayRst.AudioComponentBase.OnRep_ActiveSoundInfo
	// void OnRep_ActiveSoundInfo();                                                                                         // [0xa64d9dc] Final|Native|Protected 
};
...
{ 
public:
	SDK_UNDEFINED(16,9256) /* TArray<FString> */       __um(ActiveStates);                                         // 0x00A0   (0x0010)  
	...
	// void OnRep_ActiveStates();                                                                                            // [0xa64da0c] Final|Native|Private 
};
...
{ 
	...
	SDK_UNDEFINED(16,9257) /* FString */               __um(ValueData);                                            // 0x0010   (0x0010)  
};
...
public:
	...
	// void TellServer_ClientLevelUnloaded(class UVerseLevelStreamingComponentBase* LevelStreamingComponent);                // [0x67c0c88] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/VGameplayRst.VerseLevelStreamingPlayerControllerRpcComponent.TellServer_ClientLevelLoaded
	// void TellServer_ClientLevelLoaded(class UVerseLevelStreamingComponentBase* LevelStreamingComponent);                  // [0x6965e0c] Net|NetReliableNative|Event|Public|NetServer 
};
...
{ 
	...
	SDK_UNDEFINED(16,9258) /* FString */               __um(LevelNameOverride);                                    // 0x0018   (0x0010)  
};
...
public:
	...
	// void OnRep_LightComponent();                                                                                          // [0xa64dafc] Final|Native|Protected 
	// Function /Script/VGameplayRst.VerseLightPropertiesBase.OnRep_LightColor
	// void OnRep_LightColor();                                                                                              // [0xa64dabc] Final|Native|Protected 
	// Function /Script/VGameplayRst.VerseLightPropertiesBase.OnRep_Intensity
	// void OnRep_Intensity();                                                                                               // [0xa64da88] Final|Native|Protected 
};
...
public:
	...
	// void OnRep_AttenuationRadius();                                                                                       // [0xa64da20] Final|Native|Protected 
};
...
public:
	...
	// void OnRep_SourceRadius();                                                                                            // [0xa64dc34] Final|Native|Public  
	// Function /Script/VGameplayRst.VersePointLightProperties.OnRep_SourceLength
	// void OnRep_SourceLength();                                                                                            // [0xa64dc00] Final|Native|Public  
};
...
public:
	...
	// void OnRep_OuterConeAngle();                                                                                          // [0xa64db90] Final|Native|Public  
	// Function /Script/VGameplayRst.VerseSpotLightProperties.OnRep_InnerConeAngle
	// void OnRep_InnerConeAngle();                                                                                          // [0xa64da54] Final|Native|Public  
};
...
public:
	...
	// void OnRep_ParticleSystemAsset();                                                                                     // [0xa64dbc4] Final|Native|Protected 
	// Function /Script/VGameplayRst.ParticleSystemComponentBase.OnRep_bActive
	// void OnRep_bActive();                                                                                                 // [0xa64dc68] Final|Native|Protected 
};
