...
{ 
	...
	SDK_UNDEFINED(1,54) /* TEnumAsByte<ESlateBrushRoundingType> */ __um(RoundingType);                             // 0x0038   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(1,55) /* TEnumAsByte<ESlateBrushDrawType> */ __um(DrawAs);                                       // 0x0011   (0x0001)  
	SDK_UNDEFINED(1,56) /* TEnumAsByte<ESlateBrushTileType> */ __um(Tiling);                                       // 0x0012   (0x0001)  
	SDK_UNDEFINED(1,57) /* TEnumAsByte<ESlateBrushMirrorType> */ __um(Mirroring);                                  // 0x0013   (0x0001)  
	SDK_UNDEFINED(1,58) /* TEnumAsByte<ESlateBrushImageType> */ __um(ImageType);                                   // 0x0014   (0x0001)  
	...
	unsigned char                                      UnknownData03_6[0x10];                                      // 0x00B0   (0x0010)  MISSED
};
...
{ 
	...
	SDK_UNDEFINED(1,59) /* TEnumAsByte<EVerticalAlignment> */ __um(DownArrowAlign);                                // 0x0590   (0x0001)  
...
struct FFontData
{ 
	SDK_UNDEFINED(16,60) /* FString */                 __um(FontFilename);                                         // 0x0000   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,61) /* FString */                 __um(Cultures);                                             // 0x0028   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(1,62) /* TEnumAsByte<ESlateCheckBoxType> */ __um(CheckBoxType);                                  // 0x0008   (0x0001)  
