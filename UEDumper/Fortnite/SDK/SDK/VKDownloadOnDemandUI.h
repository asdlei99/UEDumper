...
{ 
public:
	unsigned char                                      UnknownData00_2[0x30];                                      // 0x02C0   (0x0030)  MISSED
	...
	// void UpdateProjectConfirmed();                                                                                        // [0xb6ae6c4] Final|Native|Protected|BlueprintCallable 
	// Function /Script/VKDownloadOnDemandUI.DownloadOnDemandProjectManagementTab.RemoveProjectConfirmed
	// void RemoveProjectConfirmed();                                                                                        // [0xb6ae620] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	// void UpdateLightningViolator(ESlateVisibility InVisibility, FText& InText);                                           // [0x2177018] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/VKDownloadOnDemandUI.DownloadOnDemandAddProjectModal.HandleDownloadLinkIdTextChanged
	// void HandleDownloadLinkIdTextChanged(FText& InputLinkCode);                                                           // [0xb6ae584] Final|Native|Private|HasOutParms 
};
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x10];                                      // 0x14E0   (0x0010)  MISSED
	...
	// void UpdateLabel(bool bShowLabel);                                                                                    // [0xb6ae644] Final|Native|Public|BlueprintCallable 
	// Function /Script/VKDownloadOnDemandUI.DownloadOnDemandProjectTile.OnLabelUpdated
	// void OnLabelUpdated();                                                                                                // [0x2177018] Event|Protected|BlueprintEvent 
};
