...
{ 
	...
	SDK_UNDEFINED(8,15403) /* TWeakObjectPtr<AActor*> */ __um(TargetActor);                                        // 0x0100   (0x0008)  
	SDK_UNDEFINED(8,15404) /* TWeakObjectPtr<UPrimitiveComponent*> */ __um(TargetActorComponent);                  // 0x0108   (0x0008)  
