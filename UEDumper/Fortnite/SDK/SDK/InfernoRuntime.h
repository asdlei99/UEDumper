...
public:
	...
	SDK_UNDEFINED(80,13990) /* TSet<UFortCurieComponent*> */ __um(PendingUpdateComponents);                        // 0x0070   (0x0050)  
	SDK_UNDEFINED(80,13991) /* TSet<UFortCurieComponent*> */ __um(PendingRemoveComponents);                        // 0x00C0   (0x0050)  
	...
	SDK_UNDEFINED(80,13992) /* TSet<FFortSpatialCellIndex> */ __um(CachedBurningGrassGridCells);                   // 0x0258   (0x0050)  
	SDK_UNDEFINED(80,13993) /* TMap<FFortSpatialCellIndex, UAudioComponent*> */ __um(GrassAudioMap);               // 0x02A8   (0x0050)  
