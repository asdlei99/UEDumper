...
public:
	...
	SDK_UNDEFINED(80,13883) /* TSet<UFortCurieComponent*> */ __um(PendingUpdateComponents);                        // 0x0070   (0x0050)  
	SDK_UNDEFINED(80,13884) /* TSet<UFortCurieComponent*> */ __um(PendingRemoveComponents);                        // 0x00C0   (0x0050)  
	...
	SDK_UNDEFINED(80,13885) /* TSet<FFortSpatialCellIndex> */ __um(CachedBurningGrassGridCells);                   // 0x0258   (0x0050)  
	SDK_UNDEFINED(80,13886) /* TMap<FFortSpatialCellIndex, UAudioComponent*> */ __um(GrassAudioMap);               // 0x02A8   (0x0050)  
