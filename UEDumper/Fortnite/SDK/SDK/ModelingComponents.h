...
public:
	...
	unsigned char                                      UnknownData02_5[0x5C8];                                     // 0x00F8   (0x05C8)  MISSED
	...
	unsigned char                                      UnknownData03_5[0x50];                                      // 0x06D0   (0x0050)  MISSED
	class UMaterialInterface*                          HighlightedFaceMaterial;                                    // 0x0720   (0x0008)  
	unsigned char                                      UnknownData04_6[0x3C8];                                     // 0x0728   (0x03C8)  MISSED
};
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x210];                                     // 0x0030   (0x0210)  MISSED
	...
	unsigned char                                      UnknownData03_6[0x110];                                     // 0x0450   (0x0110)  MISSED
};
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x1F0];                                     // 0x0030   (0x01F0)  MISSED
	...
	unsigned char                                      UnknownData03_6[0x1B0];                                     // 0x0350   (0x01B0)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData02_6[0x220];                                     // 0x0068   (0x0220)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData00_6[0x8];                                       // 0x0AF8   (0x0008)  MISSED
};
