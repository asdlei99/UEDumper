...
public:
	...
	SDK_UNDEFINED(80,12282) /* TMap<TEnumAsByte<ECollisionChannel>, TEnumAsByte<ECollisionResponse>> */ __um(OriginalCollisionResponseMap); // 0x08E0   (0x0050)  
	FSoundIndicatorIconPicker                          RidingSoundIndicatorIconOverride;                           // 0x0930   (0x0028)  
	SDK_UNDEFINED(16,12283) /* FMulticastInlineDelegate */ __um(AudioOnJump);                                      // 0x0958   (0x0010)  
	SDK_UNDEFINED(16,12284) /* FMulticastInlineDelegate */ __um(AudioOnJumpApex);                                  // 0x0968   (0x0010)  
	...
	SDK_UNDEFINED(24,12285) /* FText */                __um(Riding_Interaction_Text);                              // 0x09C0   (0x0018)  
	...
	SDK_UNDEFINED(16,12286) /* FMulticastInlineDelegate */ __um(RidableUIStart);                                   // 0x0C30   (0x0010)  
	SDK_UNDEFINED(16,12287) /* FMulticastInlineDelegate */ __um(RidableUIUpdateEnergy);                            // 0x0C40   (0x0010)  
	FGameplayTag                                       OutOfEnergySoundLibTag;                                     // 0x0C50   (0x0004)  
	FGameplayTag                                       SprintStartSoundLibTag;                                     // 0x0C54   (0x0004)  
	SDK_UNDEFINED(1,12288) /* TEnumAsByte<TInteractionType> */ __um(Riding_Interaction_Type);                      // 0x0C58   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(16,12289) /* FMulticastInlineDelegate */ __um(RiderUINewStats);                                  // 0x0708   (0x0010)  
	SDK_UNDEFINED(16,12290) /* FMulticastInlineDelegate */ __um(RiderUIEnd);                                       // 0x0718   (0x0010)  
	double                                             targetEnergy;                                               // 0x0728   (0x0008)  
	double                                             targetHealth;                                               // 0x0730   (0x0008)  
	FGameplayTagContainer                              T_CannotRideBucket;                                         // 0x0738   (0x0020)  
	SDK_UNDEFINED(16,12291) /* FMulticastInlineDelegate */ __um(RiderUIUpdateEnergy);                              // 0x0758   (0x0010)  
	SDK_UNDEFINED(16,12292) /* FMulticastInlineDelegate */ __um(RiderUIUpdateHealth);                              // 0x0768   (0x0010)  
