...
public:
	...
	// void ToggleRidingAlternative();                                                                                       // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/RidingGeneric_Interafce.RidingGeneric_Interafce_C.GetRidingInfoFromTarget
	// void GetRidingInfoFromTarget(double& JumpAttachGroundHeightMin, double& JumpAttachGroundHeightBuffer, bool& UsesAltRidingMessage); // [0x211c0a0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void AlternateRidingEvent();                                                                                          // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_CreatureBaseNonRidableComponent(int32_t EntryPoint);                                            // [0x211c0a0] Final                
};
...
public:
	...
	SDK_UNDEFINED(80,12237) /* TMap<TEnumAsByte<ECollisionChannel>, TEnumAsByte<ECollisionResponse>> */ __um(OriginalCollisionResponseMap); // 0x08E0   (0x0050)  
	FSoundIndicatorIconPicker                          RidingSoundIndicatorIconOverride;                           // 0x0930   (0x0028)  
	SDK_UNDEFINED(16,12238) /* FMulticastInlineDelegate */ __um(AudioOnJump);                                      // 0x0958   (0x0010)  
	SDK_UNDEFINED(16,12239) /* FMulticastInlineDelegate */ __um(AudioOnJumpApex);                                  // 0x0968   (0x0010)  
	...
	SDK_UNDEFINED(24,12240) /* FText */                __um(Riding_Interaction_Text);                              // 0x09C0   (0x0018)  
	...
	SDK_UNDEFINED(16,12241) /* FMulticastInlineDelegate */ __um(RidableUIStart);                                   // 0x0C30   (0x0010)  
	SDK_UNDEFINED(16,12242) /* FMulticastInlineDelegate */ __um(RidableUIUpdateEnergy);                            // 0x0C40   (0x0010)  
	FGameplayTag                                       OutOfEnergySoundLibTag;                                     // 0x0C50   (0x0004)  
	FGameplayTag                                       SprintStartSoundLibTag;                                     // 0x0C54   (0x0004)  
	SDK_UNDEFINED(1,12243) /* TEnumAsByte<TInteractionType> */ __um(Riding_Interaction_Type);                      // 0x0C58   (0x0001)  
	...
	// void JumpFatigue_LandTimeStamp();                                                                                     // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Should Convert Jump Exit to Jump(bool& Out);                                                                     // [0x211c0a0] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	...
	// void ShouldBufferJumpExitToRetryJump(bool& Output);                                                                   // [0x211c0a0] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.SetInfiniteStaminaBuff
	// void SetInfiniteStaminaBuff(bool Enabled);                                                                            // [0x211c0a0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.CanBePet
	// bool CanBePet(class URiderComponent* Rider);                                                                          // [0x211c0a0] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.CanJumpExit
	// void CanJumpExit(bool& CanJumpExit);                                                                                  // [0x211c0a0] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.UpdateLootAnimalGlow
	// void UpdateLootAnimalGlow(double Scale);                                                                              // [0x211c0a0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.OnRep_currentEnergyValue
	// void OnRep_currentEnergyValue();                                                                                      // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void Propagate Immunity Fall Damage();                                                                                // [0x211c0a0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.CanRiderPlayEmote
	// bool CanRiderPlayEmote(class URiderComponent* Rider);                                                                 // [0x211c0a0] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	...
	// void HandleEnemyFoleySoundLibrary(class UActorComponent* Rider, bool bIsRiding);                                      // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.OnMovementModeChanged
	// void OnMovementModeChanged(class ACharacter* Character, TEnumAsByte<EMovementMode> PrevMovementMode, char PreviousCustomMode); // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.IsSwimming
	// void IsSwimming(bool& IsSwimming);                                                                                    // [0x211c0a0] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.StopSprinting
	// void StopSprinting();                                                                                                 // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.RemoveGEByTag
	// void RemoveGEByTag(FGameplayTagContainer Tags);                                                                       // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.ApplyGEToSelf
	// void ApplyGEToSelf(class UClass* GameplayEffectClass, bool& IsValidClass);                                            // [0x211c0a0] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.KickRiderOffSelf
	// void KickRiderOffSelf();                                                                                              // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.DetermineRateOfChange
	// void DetermineRateOfChange(double& rateOfChange);                                                                     // [0x211c0a0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.CommitEnergyCosts
	// void CommitEnergyCosts(bool RequireAllEnergy, double EnergyCost, bool& Success);                                      // [0x211c0a0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.TestThreshold
	// void TestThreshold(bool isDecaying, double CurrentValue, double testTreshold, bool PreviousState, bool& crossedThreshold); // [0x211c0a0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.SetWildlifeHealth
	// void SetWildlifeHealth();                                                                                             // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.UpdateValue
	// void UpdateValue(double TargetValue, double rateOfChange, double DeltaTime, double& updatedValue, bool& EnergyDepleted); // [0x211c0a0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.ToggleRiding
	// void ToggleRiding(class AActor* PlayerPawn, class AActor* Target, bool ShouldRide, bool& bChangedRiding);             // [0x211c0a0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.ForceTaming
	// void ForceTaming(class AActor* PlayerPawn, class AActor* CreaturePawn, bool& IsTamingEnabled);                        // [0x211c0a0] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.RestoreCollisionResponses
	// void RestoreCollisionResponses();                                                                                     // [0x211c0a0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.ApplyCollisionResponse
	// void ApplyCollisionResponse(TArray<TEnumAsByte<ECollisionChannel>>& Channels, TEnumAsByte<ECollisionResponse> Response); // [0x211c0a0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.ShouldCameraFocusOnRidable
	// bool ShouldCameraFocusOnRidable(class URiderComponent* Rider);                                                        // [0x211c0a0] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.UpdateAnimInputBool
	// void UpdateAnimInputBool(class AFortPawn* FortPawn, bool IsBeingRidden);                                              // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.GetRiderCapsuleSize
	// void GetRiderCapsuleSize(class URiderComponent* Rider, double& RiderCapsuleRadius, double& RiderCapsuleHH);           // [0x211c0a0] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.GetRidingEmoteCapsuleSize
	// void GetRidingEmoteCapsuleSize(class URiderComponent* Rider, float OriginalRadius, float OriginalHalfHeight, float& OutRadius, float& OutHalfHeight); // [0x211c0a0] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.GetRidingCapsuleSize
	// void GetRidingCapsuleSize(class URiderComponent* Rider, float OriginalRadius, float OriginalHalfHeight, float& OutRadius, float& OutHalfHeight); // [0x211c0a0] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.OnRep_IdleAnim_Add
	// void OnRep_IdleAnim_Add();                                                                                            // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.ShouldSetAsViewTarget
	// bool ShouldSetAsViewTarget(class URiderComponent* Rider);                                                             // [0x211c0a0] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.GetRiderLocation
	// void GetRiderLocation(FVector& Location);                                                                             // [0x211c0a0] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	...
	// void Removed_AD51144144164FD235EE5BA4F6E87456();                                                                      // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void Added_FBD936634BCC61A726DA279226E2F4BE();                                                                        // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void Removed_C4C6E29B4217C014B9DE0E80B7134D6E();                                                                      // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void HandleRiderStartedRiding(class URiderComponent* Rider);                                                          // [0x211c0a0] Event|Protected|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.HandleRiderStoppedRiding
	// void HandleRiderStoppedRiding(class URiderComponent* Rider);                                                          // [0x211c0a0] Event|Protected|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.UpdateDebug
	// void UpdateDebug();                                                                                                   // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void OnJumping(double JumpPitchInterpSpeed);                                                                          // [0x211c0a0] Net|NetReliableNetMulticast|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.OnJumpingApex
	// void OnJumpingApex();                                                                                                 // [0x211c0a0] Net|NetReliableNetMulticast|BlueprintCallable|BlueprintEvent 
	...
	// void NPCPawnInteractWithDispatcher_Event(class AActor* AIPawn, class AFortPlayerPawn* InteractingPlayerPawn);         // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.EnergyTrackingStart
	// void EnergyTrackingStart();                                                                                           // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.EnergyTrackingStop
	// void EnergyTrackingStop();                                                                                            // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void UpdateEnergy();                                                                                                  // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.ConvertedDispatcher_Event
	// void ConvertedDispatcher_Event(bool Converted, class AFortPawn* InstigatorPawn);                                      // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.OnPawnHealthChanged_Event
	// void OnPawnHealthChanged_Event();                                                                                     // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.UseEnergyAmountServer
	// void UseEnergyAmountServer(double EnergyCost);                                                                        // [0x211c0a0] Net|NetServer|BlueprintCallable|BlueprintEvent 
	...
	// void Check Regen on Stopped Riding();                                                                                 // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteBufferedJumpExit();                                                                                       // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.CancelJumpExitAndJump
	// void CancelJumpExitAndJump();                                                                                         // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.MountLandedClient
	// void MountLandedClient(FHitResult& Hit);                                                                              // [0x211c0a0] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void TryConvertBufferedJumpExitToJump();                                                                              // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void MountLandedServer_JumpFatigue(FHitResult& Hit);                                                                  // [0x211c0a0] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_CreatureBaseRidableComponent(int32_t EntryPoint);                                               // [0x211c0a0] Final|HasDefaults    
	...
	// void RidableUIUpdateEnergy__DelegateSignature(double Energy, bool bIsResting);                                        // [0x211c0a0] Public|Delegate|BlueprintCallable|BlueprintEvent 
	...
	// void RidableUIStart__DelegateSignature(FText Name, FSlateBrush Icon);                                                 // [0x211c0a0] Public|Delegate|BlueprintCallable|BlueprintEvent 
	...
	// void AudioOnJumpApex__DelegateSignature();                                                                            // [0x211c0a0] Public|Delegate|BlueprintCallable|BlueprintEvent 
	...
	// void AudioOnJump__DelegateSignature(double JumpPitchInterpSpeed);                                                     // [0x211c0a0] Public|Delegate|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	SDK_UNDEFINED(16,12244) /* FMulticastInlineDelegate */ __um(RiderUINewStats);                                  // 0x0708   (0x0010)  
	SDK_UNDEFINED(16,12245) /* FMulticastInlineDelegate */ __um(RiderUIEnd);                                       // 0x0718   (0x0010)  
	double                                             targetEnergy;                                               // 0x0728   (0x0008)  
	double                                             targetHealth;                                               // 0x0730   (0x0008)  
	FGameplayTagContainer                              T_CannotRideBucket;                                         // 0x0738   (0x0020)  
	SDK_UNDEFINED(16,12246) /* FMulticastInlineDelegate */ __um(RiderUIUpdateEnergy);                              // 0x0758   (0x0010)  
	SDK_UNDEFINED(16,12247) /* FMulticastInlineDelegate */ __um(RiderUIUpdateHealth);                              // 0x0768   (0x0010)  
	...
	// void OnRep_targetHealth();                                                                                            // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.OnRep_targetEnergy
	// void OnRep_targetEnergy();                                                                                            // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.GetJumpInfo
	// void GetJumpInfo(class AActor* TargetActor, class UActorComponent*& TargetActorComponent, double& JumpAttach_GroundHeightMin, double& JumpAttach_GroundHeightBuffer, bool& UseAltRidingMessage); // [0x211c0a0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.TestIfValidForRidingAttempt
	// void TestIfValidForRidingAttempt(class UObject* Object, bool& Success, class UObject*& TargetObject, bool& UseAltRidingMessage); // [0x211c0a0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void EventReceived_E5B5FB5340DB5660002329825657B406(FGameplayEventData Payload);                                      // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.Added_42EF586645CCFF06FFA4D9A5D59B1298
	// void Added_42EF586645CCFF06FFA4D9A5D59B1298();                                                                        // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.Added_A83C775344FE0F6BDAAC4B971F57425E
	// void Added_A83C775344FE0F6BDAAC4B971F57425E();                                                                        // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void EventReceived_3DA19BC649FB853BA2CC0FADFF8D08F6(FGameplayEventData Payload);                                      // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.Added_D3DFE4374EED456A4C597E95375A2028
	// void Added_D3DFE4374EED456A4C597E95375A2028();                                                                        // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void HandleStartedRiding(class URidableComponent* Ridable);                                                           // [0x211c0a0] Event|Protected|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.HandleStoppedRiding
	// void HandleStoppedRiding(class URidableComponent* Ridable);                                                           // [0x211c0a0] Event|Protected|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.ToggleRidingOnServer
	// void ToggleRidingOnServer(class UObject* TargetObject, bool UseAltRidingMessage);                                     // [0x211c0a0] Net|NetServer|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.SetTargetHealth
	// void SetTargetHealth(double targetHealth);                                                                            // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.RiderUIStartClient
	// void RiderUIStartClient(FText Name, FSlateBrush Icon, class AActor* Ridable);                                         // [0x211c0a0] Net|NetClient|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.RiderUIEndClient
	// void RiderUIEndClient(class AActor* Ridable);                                                                         // [0x211c0a0] Net|NetClient|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.MovementModeChanged
	// void MovementModeChanged(class ACharacter* Character, TEnumAsByte<EMovementMode> PrevMovementMode, char PreviousCustomMode); // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.MountLanded
	// void MountLanded(FHitResult& Hit);                                                                                    // [0x211c0a0] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_PlayerRiderComponent(int32_t EntryPoint);                                                       // [0x211c0a0] Final|HasDefaults    
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.RiderUIUpdateHealth__DelegateSignature
	// void RiderUIUpdateHealth__DelegateSignature(double Health);                                                           // [0x211c0a0] Public|Delegate|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.RiderUIUpdateEnergy__DelegateSignature
	// void RiderUIUpdateEnergy__DelegateSignature(double Energy);                                                           // [0x211c0a0] Public|Delegate|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.RiderUIEnd__DelegateSignature
	// void RiderUIEnd__DelegateSignature(class AActor* RidableActor);                                                       // [0x211c0a0] Public|Delegate|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.RiderUINewStats__DelegateSignature
	// void RiderUINewStats__DelegateSignature(FText Name, FSlateBrush Icon, class AActor* RidableActor);                    // [0x211c0a0] Public|Delegate|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void OnReaction(class UObject* Object, FHitResult HitResult);                                                         // [0x211c0a0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void OnReactionEvent(class AActor* HitActor, bool bFromAsyncSweepBox, FCollisionReactionType CollisionReactionType, bool bIsFirstContinuousReactionOnDelayableActor, FHitResult& HitResult); // [0x211c0a0] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_BoarRidableComponent(int32_t EntryPoint);                                                       // [0x211c0a0] Final|HasDefaults    
};
...
public:
	...
	class AFortAthenaVehicle*                          VehiclePawn;                                                // 0x0668   (0x0008)  
	FGameplayTag                                       GC_LoopingApplication;                                      // 0x0670   (0x0004)  


	/// Functions
	// Function /VehicleCosmetics/Components/BP_VehicleCosmeticsAMUC.BP_VehicleCosmeticsAMUC_C.ApplyInitialGC
	// void ApplyInitialGC();                                                                                                // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void RemoveInitialGC();                                                                                               // [0x211c0a0] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_VehicleCosmeticsAMUC(int32_t EntryPoint);                                                    // [0x211c0a0] Final|HasDefaults    
};
