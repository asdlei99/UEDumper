...
{ 
public:
	SDK_UNDEFINED(16,14849) /* FMulticastInlineDelegate */ __um(LoginSuccessEvent);                                // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,14850) /* FMulticastInlineDelegate */ __um(LogoutSuccessEvent);                               // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,14851) /* FMulticastInlineDelegate */ __um(QRCodeReceivedEvent);                              // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,14852) /* FMulticastInlineDelegate */ __um(ErrorDelegate);                                    // 0x0058   (0x0010)  
	unsigned char                                      UnknownData00_5[0x8];                                       // 0x0068   (0x0008)  MISSED
	SDK_UNDEFINED(16,14853) /* FString */              __um(UserName);                                             // 0x0070   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,14854) /* FString */              __um(PartnerName);                                          // 0x0028   (0x0010)  
	...
	SDK_UNDEFINED(8,14855) /* TWeakObjectPtr<UCommonLazyImage*> */ __um(ThumbnailImageNext);                       // 0x01B8   (0x0008)  
	SDK_UNDEFINED(8,14856) /* TWeakObjectPtr<UCommonLazyImage*> */ __um(ThumbnailImagePrevious);                   // 0x01C0   (0x0008)  
	...
	SDK_UNDEFINED(16,14857) /* FMulticastInlineDelegate */ __um(BaseErrorEvent);                                   // 0x0410   (0x0010)  
	SDK_UNDEFINED(16,14858) /* FMulticastInlineDelegate */ __um(BaseEnabledEvent);                                 // 0x0420   (0x0010)  
	SDK_UNDEFINED(16,14859) /* FMulticastInlineDelegate */ __um(SourcesChangedEvent);                              // 0x0430   (0x0010)  
	SDK_UNDEFINED(16,14860) /* FMulticastInlineDelegate */ __um(SourceSelectedEvent);                              // 0x0440   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,14861) /* FMulticastInlineDelegate */ __um(OnPartnerUpdateComplete);                          // 0x0040   (0x0010)  
	SDK_UNDEFINED(16,14862) /* FMulticastInlineDelegate */ __um(OnPartnerChanged);                                 // 0x0050   (0x0010)  
	...
	SDK_UNDEFINED(16,14863) /* FString */              __um(CurrentPlatform);                                      // 0x0068   (0x0010)  
	unsigned char                                      UnknownData01_5[0x10];                                      // 0x0078   (0x0010)  MISSED
	SDK_UNDEFINED(80,14864) /* TMap<FString, UPictureInPicturePartnerControls*> */ __um(SupportedPartnerControls); // 0x0088   (0x0050)  
	SDK_UNDEFINED(16,14865) /* FString */              __um(CurrentPartnerName);                                   // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,14866) /* FString */              __um(CurrentContinent);                                     // 0x00E8   (0x0010)  
	SDK_UNDEFINED(16,14867) /* FString */              __um(CurrentCountry);                                       // 0x00F8   (0x0010)  
	SDK_UNDEFINED(16,14868) /* TArray<FString> */      __um(CurrentSubdivisions);                                  // 0x0108   (0x0010)  
