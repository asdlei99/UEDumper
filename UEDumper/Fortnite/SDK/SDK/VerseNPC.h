...
{ 
public:
	unsigned char                                      UnknownData00_2[0x28];                                      // 0x0058   (0x0028)  MISSED
	class AFortInventory*                              CachedFortInventory;                                        // 0x0080   (0x0008)  
	class AFortPawn*                                   CachedFortPawn;                                             // 0x0088   (0x0008)  
	class UBlackboardComponent*                        CachedBlackboardComponent;                                  // 0x0090   (0x0008)  
};
...
public:
	...
	// void OnBotControllerAlertLevelChanged(class AFortAthenaAIBotController* BotController, EAlertLevel OldAlertLevel, EAlertLevel NewAlertLevel); // [0xa94c20c] Final|Native|Protected 
};
