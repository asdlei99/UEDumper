...
public:
	...
	SDK_UNDEFINED(16,13595) /* TArray<TWeakObjectPtr<UFabricChildActorComponent*>> */ __um(ChildActorComponentsPendingSpawn); // 0x00D8   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(16,13596) /* FMulticastInlineDelegate */ __um(OnWidgetCreated);                                  // 0x0220   (0x0010)  
	SDK_UNDEFINED(16,13597) /* FMulticastInlineDelegate */ __um(OnWidgetAdded);                                    // 0x0230   (0x0010)  
	unsigned char                                      UnknownData00_5[0x18];                                      // 0x0240   (0x0018)  MISSED
	SDK_UNDEFINED(8,13598) /* TWeakObjectPtr<UFabricScreenWidget*> */ __um(ScreenWidget);                          // 0x0258   (0x0008)  
	class UWidgetComponent*                            ScreenWidgetComponent;                                      // 0x0260   (0x0008)  
	SDK_UNDEFINED(80,13599) /* TMap<UFMInWorldKnobActorCopyComponent*, FScreenWidgetLayoutInfo> */ __um(CopyComponentsToWidget); // 0x0268   (0x0050)  
...
{ 
	SDK_UNDEFINED(16,13600) /* FString */              __um(UserOption);                                           // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,13601) /* FString */              __um(Key);                                                  // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,13602) /* FString */              __um(Value);                                                // 0x0010   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(16,13603) /* TArray<FString> */      __um(UserOptionsToSave);                                    // 0x00A8   (0x0010)  
	int32_t                                            MaxSaveSlots;                                               // 0x00B8   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x00BC   (0x0004)  MISSED
	SDK_UNDEFINED(16,13604) /* FString */              __um(SaveIndexParam);                                       // 0x00C0   (0x0010)  
	TArray<class UFabricUserOptionPresetAsset*>        PresetAssets;                                               // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,13605) /* FString */              __um(PresetIndexParam);                                     // 0x00E0   (0x0010)  
	SDK_UNDEFINED(16,13606) /* FString */              __um(ApplyIndexImmediatelyToggleParam);                     // 0x00F0   (0x0010)  
	SDK_UNDEFINED(16,13607) /* FMulticastInlineDelegate */ __um(OnActiveOverridesChanged);                         // 0x0100   (0x0010)  
	...
	SDK_UNDEFINED(80,13608) /* TSet<FString> */        __um(FloatUserOptions);                                     // 0x0148   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(16,13609) /* FMulticastInlineDelegate */ __um(OnModulatedPropertyValueChanged);                  // 0x02A8   (0x0010)  
	SDK_UNDEFINED(16,13610) /* FMulticastInlineDelegate */ __um(OnKnobRuntimeValueChanged);                        // 0x02B8   (0x0010)  
	SDK_UNDEFINED(16,13611) /* FMulticastInlineDelegate */ __um(OnKnobSerializedValueChanged);                     // 0x02C8   (0x0010)  
	SDK_UNDEFINED(16,13612) /* FMulticastInlineDelegate */ __um(OnFloatProviderConnectionChanged);                 // 0x02D8   (0x0010)  
	SDK_UNDEFINED(16,13613) /* FString */              __um(OptionKey);                                            // 0x02E8   (0x0010)  
	SDK_UNDEFINED(24,13614) /* FText */                __um(OverriddenTitle);                                      // 0x02F8   (0x0018)  
	...
	SDK_UNDEFINED(16,13615) /* TArray<TWeakObjectPtr<UFabricFloatProviderBase*>> */ __um(CurrentFloatProviders);   // 0x0338   (0x0010)  
	SDK_UNDEFINED(8,13616) /* TWeakObjectPtr<UFabricFloatProviderBase*> */ __um(ActiveFloatProvider);              // 0x0348   (0x0008)  
	class USceneComponent*                             HitComponent;                                               // 0x0350   (0x0008)  
	SDK_UNDEFINED(8,13617) /* TWeakObjectPtr<APlayerController*> */ __um(InteractingController);                   // 0x0358   (0x0008)  
	EFabricInteractableType                            InteractableType;                                           // 0x0360   (0x0001)  
	unsigned char                                      UnknownData03_5[0x3];                                       // 0x0361   (0x0003)  MISSED
	SDK_UNDEFINED(8,13618) /* TWeakObjectPtr<UFabricInteractableViewModel*> */ __um(WidgetViewModel);              // 0x0364   (0x0008)  
	unsigned char                                      UnknownData04_5[0x4];                                       // 0x036C   (0x0004)  MISSED
	SDK_UNDEFINED(16,13619) /* TArray<FText> */        __um(OverrideLabels);                                       // 0x0370   (0x0010)  
	SDK_UNDEFINED(16,13620) /* TArray<FText> */        __um(OptionLabels);                                         // 0x0380   (0x0010)  
	SDK_UNDEFINED(16,13621) /* TArray<FString> */      __um(OptionValues);                                         // 0x0390   (0x0010)  
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x10];                                      // 0x02F0   (0x0010)  MISSED
	SDK_UNDEFINED(16,13622) /* FMulticastInlineDelegate */ __um(OnModulatedPropertyValueChanged);                  // 0x0300   (0x0010)  
	SDK_UNDEFINED(16,13623) /* FMulticastInlineDelegate */ __um(OnKnobRuntimeValueChanged);                        // 0x0310   (0x0010)  
	SDK_UNDEFINED(16,13624) /* FMulticastInlineDelegate */ __um(OnKnobSerializedValueChanged);                     // 0x0320   (0x0010)  
	SDK_UNDEFINED(16,13625) /* FMulticastInlineDelegate */ __um(OnFloatProviderConnectionChanged);                 // 0x0330   (0x0010)  
	SDK_UNDEFINED(16,13626) /* FMulticastInlineDelegate */ __um(OnKnobActorSet);                                   // 0x0340   (0x0010)  
	class UClass*                                      DefaultKnobActorClass;                                      // 0x0350   (0x0008)  
	class AFMInWorldKnobActorBase*                     InWorldKnobActor;                                           // 0x0358   (0x0008)  
	SDK_UNDEFINED(16,13627) /* FString */              __um(OptionKey);                                            // 0x0360   (0x0010)  
	SDK_UNDEFINED(24,13628) /* FText */                __um(OverriddenTitle);                                      // 0x0370   (0x0018)  
...
public:
	unsigned char                                      UnknownData00_2[0x8];                                       // 0x00A0   (0x0008)  MISSED
	SDK_UNDEFINED(16,13629) /* FMulticastInlineDelegate */ __um(OnInitialKnobValuesLoaded);                        // 0x00A8   (0x0010)  
	SDK_UNDEFINED(16,13630) /* FMulticastInlineDelegate */ __um(OnAllKnobsLoaded);                                 // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,13631) /* FMulticastInlineDelegate */ __um(OnAnyKnobRuntimeValueChanged);                     // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,13632) /* FMulticastInlineDelegate */ __um(OnAnyKnobSerializedValueChanged);                  // 0x00D8   (0x0010)  
	SDK_UNDEFINED(80,13633) /* TSet<UObject*> */       __um(InWorldKnobInterfaceObjects);                          // 0x00E8   (0x0050)  
	...
	SDK_UNDEFINED(80,13634) /* TMap<FString, UPlaylistUserOptionBase*> */ __um(PropertiesEditedByUserOptions);     // 0x0180   (0x0050)  
	SDK_UNDEFINED(80,13635) /* TMap<FString, UObject*> */ __um(OptionKeyToInWorldKnobObject);                      // 0x01D0   (0x0050)  
	SDK_UNDEFINED(80,13636) /* TMap<FString, UFMDeviceCableModulatorPortComponent*> */ __um(OptionKeyToModulatorPort); // 0x0220   (0x0050)  
...
{ 
	...
	SDK_UNDEFINED(32,13637) /* TWeakObjectPtr<UObject*> */ __um(Device);                                           // 0x0008   (0x0020)  
...
{ 
	SDK_UNDEFINED(16,13638) /* TArray<TWeakObjectPtr<UStaticMesh*>> */ __um(ScreenMeshArrayByHeight);              // 0x0000   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,13639) /* FString */              __um(Value);                                                // 0x0008   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,13640) /* FString */              __um(Value);                                                // 0x0008   (0x0010)  
};
