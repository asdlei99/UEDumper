...
public:
	...
	// void StopAnalyzing(class UObject* WorldContextObject);                                                                // [0xa7d0fb0] Final|RequiredAPI|BlueprintCosmetic|Native|Public|BlueprintCallable 
	// Function /Script/AudioAnalyzer.AudioAnalyzer.StartAnalyzing
	// void StartAnalyzing(class UObject* WorldContextObject, class UAudioBus* AudioBusToAnalyze);                           // [0xa7d0bfc] Final|RequiredAPI|BlueprintCosmetic|Native|Public|BlueprintCallable 
};
