...
{ 
	SDK_UNDEFINED(12,13807) /* FDelegateProperty */    __um(OnOvershieldChanged);                                  // 0x0000   (0x000C)  
	SDK_UNDEFINED(12,13808) /* FDelegateProperty */    __um(OnShieldedDamage);                                     // 0x000C   (0x000C)  
	SDK_UNDEFINED(12,13809) /* FDelegateProperty */    __um(OnOvershieldedDamage);                                 // 0x0018   (0x000C)  
	SDK_UNDEFINED(12,13810) /* FDelegateProperty */    __um(OnShieldDestroyed);                                    // 0x0024   (0x000C)  
	SDK_UNDEFINED(12,13811) /* FDelegateProperty */    __um(OnOvershieldDestroyed);                                // 0x0030   (0x000C)  
	SDK_UNDEFINED(12,13812) /* FDelegateProperty */    __um(OnDamageReceived);                                     // 0x003C   (0x000C)  
};
