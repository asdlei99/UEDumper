...
public:
	...
	SDK_UNDEFINED(32,14727) /* TWeakObjectPtr<UMeshDeformer*> */ __um(DefaultDeformer);                            // 0x0038   (0x0020)  
	SDK_UNDEFINED(32,14728) /* TWeakObjectPtr<UMeshDeformer*> */ __um(DefaultRecomputeTangentDeformer);            // 0x0058   (0x0020)  
};
