...
public:
	...
	SDK_UNDEFINED(16,11641) /* FMulticastInlineDelegate */ __um(OnAllSoundsFinished);                              // 0x00B0   (0x0010)  
	SDK_UNDEFINED(16,11642) /* FMulticastInlineDelegate */ __um(OnSoundFinished);                                  // 0x00C0   (0x0010)  
