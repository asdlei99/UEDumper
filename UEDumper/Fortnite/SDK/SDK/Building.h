...
public:
	...
	// void ExecuteUbergraph_PBWA_S1_Solid(int32_t EntryPoint);                                                              // [0x2177018] Final|HasDefaults    
};
...
public:
	...
	// void OnRep_Random Chance();                                                                                           // [0x2177018] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_PBW_BP_Parent(int32_t EntryPoint);                                                              // [0x2177018] Final                
};
