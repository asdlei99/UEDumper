...
{ 
	SDK_UNDEFINED(24,13411) /* FText */                __um(SampleLabel);                                          // 0x0000   (0x0018)  
...
{ 
public:
	SDK_UNDEFINED(16,13412) /* TArray<TWeakObjectPtr<UFabricMetasoundDrumPlayerSampleBankAsset*>> */ __um(SampleBanks); // 0x0030   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(16,13413) /* TArray<TWeakObjectPtr<UFabricMetasoundInstrumentPlayerDataAsset*>> */ __um(InstrumentPlayerData); // 0x0030   (0x0010)  
};
