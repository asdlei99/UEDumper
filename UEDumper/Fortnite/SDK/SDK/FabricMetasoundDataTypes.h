...
{ 
	SDK_UNDEFINED(24,13356) /* FText */                __um(SampleLabel);                                          // 0x0000   (0x0018)  
...
public:
	...
	// TArray<FText> GetSampleLabels();                                                                                      // [0xb526cc0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
public:
	SDK_UNDEFINED(16,13357) /* TArray<TWeakObjectPtr<UFabricMetasoundDrumPlayerSampleBankAsset*>> */ __um(SampleBanks); // 0x0030   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(16,13358) /* TArray<TWeakObjectPtr<UFabricMetasoundInstrumentPlayerDataAsset*>> */ __um(InstrumentPlayerData); // 0x0030   (0x0010)  
};
