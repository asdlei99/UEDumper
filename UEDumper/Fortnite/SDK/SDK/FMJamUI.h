...
public:
	...
	// void RebuildJamSongIndicatorsForPlayspace(class AJamPlayspace* Playspace);                                            // [0xb64a794] Final|Native|Public|BlueprintCallable 
	// Function /Script/FMJamUI.JamUIManagerComponent_SongIndicators.ClearJamIndicators
	// void ClearJamIndicators();                                                                                            // [0xb64a714] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnInitInfo(class UCatalogData* Song, EFMJamLoopType Type);                                                       // [0x2177018] Event|Protected|BlueprintEvent 
	...
	// class AFortPlayerStateAthena* GetIndicatedPlayerStateAthena();                                                        // [0xb64a728] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
