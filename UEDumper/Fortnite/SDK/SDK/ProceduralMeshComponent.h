...
{ 
public:
	bool                                               bUseComplexAsSimpleCollision;                               // 0x05B0   (0x0001)  
	bool                                               bUseAsyncCooking;                                           // 0x05B1   (0x0001)  
	unsigned char                                      UnknownData00_5[0x6];                                       // 0x05B2   (0x0006)  MISSED
	class UBodySetup*                                  ProcMeshBodySetup;                                          // 0x05B8   (0x0008)  
	TArray<FProcMeshSection>                           ProcMeshSections;                                           // 0x05C0   (0x0010)  
	TArray<FKConvexElem>                               CollisionConvexElems;                                       // 0x05D0   (0x0010)  
	FBoxSphereBounds                                   LocalBounds;                                                // 0x05E0   (0x0038)  
	TArray<class UBodySetup*>                          AsyncBodySetupQueue;                                        // 0x0618   (0x0010)  
	unsigned char                                      UnknownData01_6[0x8];                                       // 0x0628   (0x0008)  MISSED
