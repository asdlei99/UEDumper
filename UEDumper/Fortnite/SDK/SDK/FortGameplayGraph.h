...
{ 
public:
	SDK_UNDEFINED(80,11799) /* TSet<FGraphVertexHandle> */ __um(SupportNodes);                                     // 0x0100   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(80,11800) /* TMap<FGraphVertexHandle, FSerializableConnectivityGraphVertex> */ __um(ConnectivityVertexData); // 0x00B8   (0x0050)  
};
