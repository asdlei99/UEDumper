...
public:
	...
	SDK_UNDEFINED(1,45) /* TEnumAsByte<EPhysicsType> */ __um(PhysicsType);                                         // 0x002C   (0x0001)  
	SDK_UNDEFINED(1,46) /* TEnumAsByte<ECollisionTraceFlag> */ __um(CollisionTraceFlag);                           // 0x002D   (0x0001)  
	SDK_UNDEFINED(1,47) /* TEnumAsByte<EBodyCollisionResponse> */ __um(CollisionReponse);                          // 0x002E   (0x0001)  
...
public:
	float                                              Friction;                                                   // 0x0028   (0x0004)  
	float                                              StaticFriction;                                             // 0x002C   (0x0004)  
	SDK_UNDEFINED(1,48) /* TEnumAsByte<EFrictionCombineMode> */ __um(FrictionCombineMode);                         // 0x0030   (0x0001)  
	...
	SDK_UNDEFINED(1,49) /* TEnumAsByte<EFrictionCombineMode> */ __um(RestitutionCombineMode);                      // 0x0038   (0x0001)  
	...
	SDK_UNDEFINED(1,50) /* TEnumAsByte<EPhysicalSurface> */ __um(SurfaceType);                                     // 0x0060   (0x0001)  
	...
	unsigned char                                      UnknownData04_6[0x1C];                                      // 0x0074   (0x001C)  MISSED
};
...
public:
	...
	SDK_UNDEFINED(1,51) /* TEnumAsByte<EFrictionCombineMode> */ __um(FrictionCombineMode);                         // 0x0054   (0x0001)  
	SDK_UNDEFINED(1,52) /* TEnumAsByte<EFrictionCombineMode> */ __um(RestitutionCombineMode);                      // 0x0055   (0x0001)  
	...
	SDK_UNDEFINED(1,53) /* TEnumAsByte<ECollisionTraceFlag> */ __um(DefaultShapeComplexity);                       // 0x006D   (0x0001)  
