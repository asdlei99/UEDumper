...
public:
	...
	SDK_UNDEFINED(32,14518) /* TWeakObjectPtr<UClass*> */ __um(SprayCustomizerClass);                              // 0x03D0   (0x0020)  
	...
	SDK_UNDEFINED(8,14519) /* TWeakObjectPtr<UAthenaCosmeticItemDefinition*> */ __um(ItemDefinition);              // 0x0418   (0x0008)  
	TArray<FFortVariantRedirectorTileLoadedEmoteToRandomize> LoadedEmotesToRandomize;                              // 0x0420   (0x0010)  
	SDK_UNDEFINED(16,14520) /* FMulticastInlineDelegate */ __um(OnVariantEngagedEvent);                            // 0x0430   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(80,14521) /* TMap<FGameplayTag, FFortVariantSprayCustomizerCosmeticOptions> */ __um(SprayCustomizerOptions); // 0x0030   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(16,14522) /* TArray<TWeakObjectPtr<UFortItemDefinition*>> */ __um(ItemShopPreviewStyles);        // 0x0000   (0x0010)  
	SDK_UNDEFINED(80,14523) /* TMap<FGameplayTag, FFortVariantSprayCustomizerChannelOptions> */ __um(ChannelOptions); // 0x0010   (0x0050)  
};
