...
{ 
	SDK_UNDEFINED(80,14043) /* TMap<FName, FInterchangePipelineStack> */ __um(PipelineStacks);                     // 0x0000   (0x0050)  
	FName                                              DefaultPipelineStack;                                       // 0x0050   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0054   (0x0004)  MISSED
	SDK_UNDEFINED(32,14044) /* TWeakObjectPtr<UClass*> */ __um(PipelineConfigurationDialogClass);                  // 0x0058   (0x0020)  
...
{ 
	SDK_UNDEFINED(80,14045) /* TMap<EInterchangeTranslatorAssetType, FName> */ __um(DefaultPipelineStackOverride); // 0x0080   (0x0050)  
	SDK_UNDEFINED(80,14046) /* TMap<EInterchangeTranslatorAssetType, bool> */ __um(ShowPipelineStacksConfigurationDialogOverride); // 0x00D0   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(32,14047) /* TWeakObjectPtr<UClass*> */ __um(FilePickerClass);                                   // 0x01D0   (0x0020)  
	...
	SDK_UNDEFINED(32,14048) /* TWeakObjectPtr<UClass*> */ __um(GenericPipelineClass);                              // 0x01F8   (0x0020)  
};
...
{ 
public:
	SDK_UNDEFINED(32,14049) /* TWeakObjectPtr<UClass*> */ __um(PythonClass);                                       // 0x0028   (0x0020)  
	class UInterchangePythonPipelineBase*              GeneratedPipeline;                                          // 0x0048   (0x0008)  
	SDK_UNDEFINED(16,14050) /* FString */              __um(JsonDefaultProperties);                                // 0x0050   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(16,14051) /* FString */              __um(NodeUniqueID);                                         // 0x0040   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,14052) /* TSet<UClass*> */        __um(RegisteredTranslatorsClass);                           // 0x00D8   (0x0050)  
	SDK_UNDEFINED(80,14053) /* TMap<UClass*, UClass*> */ __um(RegisteredFactoryClasses);                           // 0x0128   (0x0050)  
	SDK_UNDEFINED(80,14054) /* TMap<UClass*, UInterchangeWriterBase*> */ __um(RegisteredWriters);                  // 0x0178   (0x0050)  
...
{ 
	...
	SDK_UNDEFINED(24,14055) /* FText */                __um(Title);                                                // 0x0008   (0x0018)  
	SDK_UNDEFINED(16,14056) /* FString */              __um(DefaultPath);                                          // 0x0020   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(32,14057) /* TWeakObjectPtr<UClass*> */ __um(Translator);                                        // 0x0000   (0x0020)  
...
{ 
	...
	SDK_UNDEFINED(16,14058) /* FString */              __um(DestinationName);                                      // 0x0028   (0x0010)  
	bool                                               bReplaceExisting;                                           // 0x0038   (0x0001)  
	unsigned char                                      UnknownData01_5[0x3];                                       // 0x0039   (0x0003)  MISSED
	SDK_UNDEFINED(12,14059) /* FDelegateProperty */    __um(OnAssetDone);                                          // 0x003C   (0x000C)  
	unsigned char                                      UnknownData02_5[0x10];                                      // 0x0048   (0x0010)  MISSED
	SDK_UNDEFINED(12,14060) /* FDelegateProperty */    __um(OnAssetsImportDone);                                   // 0x0058   (0x000C)  
	unsigned char                                      UnknownData03_5[0x14];                                      // 0x0064   (0x0014)  MISSED
	SDK_UNDEFINED(12,14061) /* FDelegateProperty */    __um(OnSceneObjectDone);                                    // 0x0078   (0x000C)  
	unsigned char                                      UnknownData04_5[0x14];                                      // 0x0084   (0x0014)  MISSED
	SDK_UNDEFINED(12,14062) /* FDelegateProperty */    __um(OnSceneImportDone);                                    // 0x0098   (0x000C)  
