...
{ 
public:
	SDK_UNDEFINED(240,15324) /* FText */               __um(EditStatusLocalizedText);                              // 0x0400   (0x00F0)  
	...
	// void OnMinigameStateChanged(EFortMinigameState MinigameState, EFortMinigameState PreviousMinigameState);              // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/VKEditUI.VKConnectionIndicator.HandleMemorySamplerProgressUpdated
	// void HandleMemorySamplerProgressUpdated(float Progress);                                                              // [0xb6b6908] Final|Native|Private 
};
...
public:
	...
	// void HandleGameStateInitialized(class AFortGameState* GameState);                                                     // [0xb6b6888] Final|Native|Protected 
	// Function /Script/VKEditUI.VKDebugMessagesBase.BP_OnGameStateInitialized
	// void BP_OnGameStateInitialized(class AFortGameState* GameState);                                                      // [0x2177018] Event|Protected|BlueprintEvent 
};
