...
public:
	...
	SDK_UNDEFINED(16,12349) /* TArray<FText> */        __um(DesignerPreviewTabNames);                              // 0x0370   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(24,12350) /* FText */                __um(ButtonText);                                           // 0x14A0   (0x0018)  
	...
	// void SetButtonText(FText& InText);                                                                                    // [0xb4c8ed4] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x90];                                      // 0x14D0   (0x0090)  MISSED
	...
	// void OnTeamSet(FMinigameTeam& NewTeamData);                                                                           // [0x211c0a0] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/CRD_ClassSelectorUI.ClassSelectorTeamTile.OnTeamIconSet
	// void OnTeamIconSet(FCreativeIconOption& NewTeamIcon);                                                                 // [0x211c0a0] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/CRD_ClassSelectorUI.ClassSelectorTeamTile.OnTeamColorIndexSet
	// void OnTeamColorIndexSet(int32_t TeamColorIndex);                                                                     // [0x211c0a0] Event|Public|BlueprintEvent 
	// Function /Script/CRD_ClassSelectorUI.ClassSelectorTeamTile.OnPlayerCountSet
	// void OnPlayerCountSet(int32_t NewPlayerCount);                                                                        // [0x211c0a0] Event|Public|BlueprintEvent 
};
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x8];                                       // 0x14D0   (0x0008)  MISSED
	...
	// void OnClassEntryDataSet(bool bIsCurrentClass, bool bIsPendingClass);                                                 // [0x211c0a0] Event|Public|BlueprintEvent 
	// Function /Script/CRD_ClassSelectorUI.CreativeClassEntry.OnBrowsingLoadout
	// void OnBrowsingLoadout(bool bBrowsingLoadout);                                                                        // [0x211c0a0] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void OnTimerCountdown(int32_t RemainingTime);                                                                         // [0x211c0a0] Event|Protected|BlueprintEvent 
	// Function /Script/CRD_ClassSelectorUI.CreativeClassSelector.OnLoadoutCommitted
	// void OnLoadoutCommitted(FText& NewClassName, FText& NewTeamName, bool bNewLoadout);                                   // [0x211c0a0] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/CRD_ClassSelectorUI.CreativeClassSelector.OnClassSelectorUIPopulated
	// void OnClassSelectorUIPopulated(bool bHasValidData);                                                                  // [0x211c0a0] Event|Protected|BlueprintEvent 
	// Function /Script/CRD_ClassSelectorUI.CreativeClassSelector.OnClassSelectionChanged
	// void OnClassSelectionChanged(FText& NewClassName, FText& NewClassDescription);                                        // [0x211c0a0] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/CRD_ClassSelectorUI.CreativeClassSelector.HandleMinigameStateChanged
	// void HandleMinigameStateChanged(class AFortMinigame* Minigame, EFortMinigameState MinigameState);                     // [0xb4c8e14] Final|Native|Protected 
	// Function /Script/CRD_ClassSelectorUI.CreativeClassSelector.GetFirstLoadoutItem
	// class UWidget* GetFirstLoadoutItem();                                                                                 // [0xb4c8dd8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetTabName(FText& TabName);                                                                                      // [0xb4c8f70] Final|Native|Public|HasOutParms|BlueprintCallable 
};
