...
public:
	...
	// void SetButtonText(FText& InText);                                                                                    // [0xb4f41c4] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void OnTeamSet(FMinigameTeam& NewTeamData);                                                                           // [0x2177018] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/CRD_ClassSelectorUI.ClassSelectorTeamTile.OnTeamIconSet
	// void OnTeamIconSet(FCreativeIconOption& NewTeamIcon);                                                                 // [0x2177018] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/CRD_ClassSelectorUI.ClassSelectorTeamTile.OnTeamColorIndexSet
	// void OnTeamColorIndexSet(int32_t TeamColorIndex);                                                                     // [0x2177018] Event|Public|BlueprintEvent 
	// Function /Script/CRD_ClassSelectorUI.ClassSelectorTeamTile.OnPlayerCountSet
	// void OnPlayerCountSet(int32_t NewPlayerCount);                                                                        // [0x2177018] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void OnClassEntryDataSet(bool bIsCurrentClass, bool bIsPendingClass);                                                 // [0x2177018] Event|Public|BlueprintEvent 
	// Function /Script/CRD_ClassSelectorUI.CreativeClassEntry.OnBrowsingLoadout
	// void OnBrowsingLoadout(bool bBrowsingLoadout);                                                                        // [0x2177018] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void OnTimerCountdown(int32_t RemainingTime);                                                                         // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/CRD_ClassSelectorUI.CreativeClassSelector.OnLoadoutCommitted
	// void OnLoadoutCommitted(FText& NewClassName, FText& NewTeamName, bool bNewLoadout);                                   // [0x2177018] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/CRD_ClassSelectorUI.CreativeClassSelector.OnClassSelectorUIPopulated
	// void OnClassSelectorUIPopulated(bool bHasValidData);                                                                  // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/CRD_ClassSelectorUI.CreativeClassSelector.OnClassSelectionChanged
	// void OnClassSelectionChanged(FText& NewClassName, FText& NewClassDescription);                                        // [0x2177018] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/CRD_ClassSelectorUI.CreativeClassSelector.HandleMinigameStateChanged
	// void HandleMinigameStateChanged(class AFortMinigame* Minigame, EFortMinigameState MinigameState);                     // [0xb4f4104] Final|Native|Protected 
	// Function /Script/CRD_ClassSelectorUI.CreativeClassSelector.GetFirstLoadoutItem
	// class UWidget* GetFirstLoadoutItem();                                                                                 // [0xb4f40c8] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetTabName(FText& TabName);                                                                                      // [0xb4f4260] Final|Native|Public|HasOutParms|BlueprintCallable 
};
