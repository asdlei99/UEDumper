...
public:
	...
	// FGameplayAttribute GetGameplayAttributeForClass(class UClass*& AttributeClass);                                       // [0xa9473b8] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
