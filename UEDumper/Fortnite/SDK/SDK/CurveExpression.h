...
{ 
	SDK_UNDEFINED(16,12525) /* FString */              __um(AssignmentExpressions);                                // 0x0000   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(80,12526) /* TMap<FName, FString> */ __um(CurveExpressions);                                     // 0x0040   (0x0050)  
...
{ 
	SDK_UNDEFINED(8,12527) /* TWeakObjectPtr<USkeletalMeshComponent*> */ __um(SourceMeshComponent);                // 0x0110   (0x0008)  
