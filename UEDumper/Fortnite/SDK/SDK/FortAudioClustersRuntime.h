...
{ 
public:
	SDK_UNDEFINED(80,13729) /* TMap<FGameplayTag, double> */ __um(ParameterDefaults);                              // 0x0030   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(16,13730) /* TArray<TWeakObjectPtr<UClass*>> */ __um(ActorClasses);                              // 0x0008   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(80,13731) /* TMap<FName, FGameplayTag> */ __um(OverrideTable);                                   // 0x0038   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(16,13732) /* TArray<TWeakObjectPtr<UAudioClusterConfigMap*>> */ __um(ConfigMaps);                // 0x0028   (0x0010)  
