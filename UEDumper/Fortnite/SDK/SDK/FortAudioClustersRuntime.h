...
{ 
public:
	SDK_UNDEFINED(80,13673) /* TMap<FGameplayTag, double> */ __um(ParameterDefaults);                              // 0x0030   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(16,13674) /* TArray<TWeakObjectPtr<UClass*>> */ __um(ActorClasses);                              // 0x0008   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(80,13675) /* TMap<FName, FGameplayTag> */ __um(OverrideTable);                                   // 0x0038   (0x0050)  
	...
	// void HandleRegisteredActorDeath(float Damage, FGameplayTagContainer& DamageTags, FVector Momentum, FHitResult& HitInfo, class AFortPawn* InstigatedBy, class AActor* DamageCauser, FGameplayEffectContextHandle EffectContext); // [0x22ce028] Final|Native|Private|HasOutParms|HasDefaults 
};
...
{ 
public:
	SDK_UNDEFINED(16,13676) /* TArray<TWeakObjectPtr<UAudioClusterConfigMap*>> */ __um(ConfigMaps);                // 0x0028   (0x0010)  
