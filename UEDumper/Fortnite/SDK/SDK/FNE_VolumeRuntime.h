...
{ 
public:
	SDK_UNDEFINED(16,13717) /* FMulticastInlineDelegate */ __um(OnPlayerStateBeginOverlap);                        // 0x0270   (0x0010)  
	SDK_UNDEFINED(16,13718) /* FMulticastInlineDelegate */ __um(OnPlayerStateEndOverlap);                          // 0x0280   (0x0010)  
	SDK_UNDEFINED(16,13719) /* FMulticastInlineDelegate */ __um(OnOtherActorBeginOverlap);                         // 0x0290   (0x0010)  
	SDK_UNDEFINED(16,13720) /* FMulticastInlineDelegate */ __um(OnOtherActorEndOverlap);                           // 0x02A0   (0x0010)  
	bool                                               bEnableOverlap;                                             // 0x02B0   (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x02B1   (0x0007)  MISSED
	SDK_UNDEFINED(80,13721) /* TMap<EFNEVolumeShapeTypeEnum, UStaticMesh*> */ __um(FNEVolumeShapeMap);             // 0x02B8   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(16,13722) /* FMulticastInlineDelegate */ __um(OnPlayerStateBeginOverlap);                        // 0x05C0   (0x0010)  
	SDK_UNDEFINED(16,13723) /* FMulticastInlineDelegate */ __um(OnPlayerStateEndOverlap);                          // 0x05D0   (0x0010)  
	SDK_UNDEFINED(16,13724) /* FMulticastInlineDelegate */ __um(OnOtherActorBeginOverlap);                         // 0x05E0   (0x0010)  
	SDK_UNDEFINED(16,13725) /* FMulticastInlineDelegate */ __um(OnOtherActorEndOverlap);                           // 0x05F0   (0x0010)  
	bool                                               bEnableOverlap;                                             // 0x0600   (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x0601   (0x0007)  MISSED
	SDK_UNDEFINED(80,13726) /* TMap<EFNEVolumeShapeTypeEnum, UStaticMesh*> */ __um(FNEVolumeShapeMap);             // 0x0608   (0x0050)  
	EFNEVolumeShapeTypeEnum                            SceneQueryShape;                                            // 0x0658   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0659   (0x0007)  MISSED
	SDK_UNDEFINED(16,13727) /* TArray<TEnumAsByte<EObjectTypeQuery>> */ __um(SceneQueryObjectTypes);               // 0x0660   (0x0010)  
	unsigned char                                      UnknownData02_5[0x20];                                      // 0x0670   (0x0020)  MISSED
	SDK_UNDEFINED(8,13728) /* TWeakObjectPtr<AFortMinigame*> */ __um(CachedMinigame);                              // 0x0690   (0x0008)  
