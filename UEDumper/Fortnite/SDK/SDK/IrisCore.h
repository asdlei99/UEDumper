...
{ 
	unsigned char                                      UnknownData00_2[0x20];                                      // 0x0010   (0x0020)  MISSED
...
{ 
	SDK_UNDEFINED(8,43) /* TWeakObjectPtr<UStruct*> */ __um(Owner);                                                // 0x0000   (0x0008)  
...
{ 
	unsigned char                                      UnknownData00_2[0x4];                                       // 0x0108   (0x0004)  MISSED
