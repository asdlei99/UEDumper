...
public:
	...
	// void OnTargetDamaged();                                                                                               // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/MotherGameplayUI.AvocadoEaterHealthBarWidget.OnSetMarkerPosition
	// void OnSetMarkerPosition(float MarkerPosition);                                                                       // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/MotherGameplayUI.AvocadoEaterHealthBarWidget.OnParasiteDetached
	// void OnParasiteDetached();                                                                                            // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/MotherGameplayUI.AvocadoEaterHealthBarWidget.OnParasiteAttached
	// void OnParasiteAttached();                                                                                            // [0x2177018] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnItemInactivatable();                                                                                           // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/MotherGameplayUI.FortGravyGoblinReticleExtensionWidget.OnItemActivatable
	// void OnItemActivatable();                                                                                             // [0x2177018] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnPropIndexChanged(FText& CategoryText, int32_t PropIndex, int32_t MaxPropCount, int32_t CategoryIndex, int32_t MaxCategoryCount); // [0x2177018] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/MotherGameplayUI.FortPaddleGingerReticleExtensionWidget.OnPropActivationChanged
	// void OnPropActivationChanged(bool Activated);                                                                         // [0x2177018] Event|Protected|BlueprintEvent 
};
...
public:
	...
	// void OnUpdateChargeToMin(float ChargePercent);                                                                        // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/MotherGameplayUI.FortReactorGradeReticleExtensionWidget.OnUpdateChargeToAutoDischarge
	// void OnUpdateChargeToAutoDischarge(float ChargePercent);                                                              // [0x2177018] Event|Protected|BlueprintEvent 
	// Function /Script/MotherGameplayUI.FortReactorGradeReticleExtensionWidget.OnMinimumChargeReached
	// void OnMinimumChargeReached();                                                                                        // [0x2177018] Event|Protected|BlueprintEvent 
};
