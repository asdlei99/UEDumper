...
public:
	...
	class UGameplayEventRouterComponent*               Event_Router;                                               // 0x0458   (0x0008)  
	class UWBP_Sparks_Dbg_CosmeticPicker_C*            DebugWidget;                                                // 0x0460   (0x0008)  
	...
	// void ExecuteUbergraph_BP_SparksCosmeticComponent(int32_t EntryPoint);                                                 // [0x211c0a0] Final                
};
...
public:
	...
	// void ExecuteUbergraph_SunDirectionandColorSet(int32_t EntryPoint);                                                    // [0x211c0a0] Final                
};
...
public:
	...
	// void GetChoice(ESparksAccountItemSubtype Item Subtype, ESparksInstrumentType Instrument type, FGameplayTag Variant Channel, FString& Choice); // [0x211c0a0] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /SparksCosmetics/Tools/WBP_Sparks_Dbg_CosmeticPicker.WBP_Sparks_Dbg_CosmeticPicker_C.OnCosmeticItemChanged
	// void OnCosmeticItemChanged(class USparksAccountItemDefinition* ItemDef);                                              // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /SparksCosmetics/Tools/WBP_Sparks_Dbg_CosmeticPicker.WBP_Sparks_Dbg_CosmeticPicker_C.OnCosmeticChoiceChanged
	// void OnCosmeticChoiceChanged(ESparksAccountItemSubtype Subtype, ESparksInstrumentType InstrumentType);                // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /SparksCosmetics/Tools/WBP_Sparks_Dbg_CosmeticPicker.WBP_Sparks_Dbg_CosmeticPicker_C.SetCosmeticComponent
	// void SetCosmeticComponent(class UBP_SparksCosmeticComponent_C* Component);                                            // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /SparksCosmetics/Tools/WBP_Sparks_Dbg_CosmeticPicker.WBP_Sparks_Dbg_CosmeticPicker_C.ReloadData
	// void ReloadData();                                                                                                    // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	...
	// void BndEvt__WBP_Sparks_CosmeticPicker_chk_Collapse_K2Node_ComponentBoundEvent_1_OnCheckBoxComponentStateChanged__DelegateSignature(bool bIsChecked); // [0x211c0a0] BlueprintEvent       
	...
	// void BndEvt__WBP_Sparks_CosmeticPicker_btn_Reload_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature(class UCommonButtonLegacy* Button); // [0x211c0a0] BlueprintEvent       
	...
	// void BndEvt__WBP_Sparks_Dbg_CosmeticPicker_btn_Defaults_K2Node_ComponentBoundEvent_2_CommonButtonClicked__DelegateSignature(class UCommonButtonLegacy* Button); // [0x211c0a0] BlueprintEvent       
	...
	// void BndEvt__WBP_Sparks_Dbg_CosmeticPicker_btn_Save_K2Node_ComponentBoundEvent_3_CommonButtonClicked__DelegateSignature(class UCommonButtonLegacy* Button); // [0x211c0a0] BlueprintEvent       
	...
	// void ExecuteUbergraph_WBP_Sparks_Dbg_CosmeticPicker(int32_t EntryPoint);                                              // [0x211c0a0] Final                
};
...
public:
	...
	// void ShouldSendUpdates(bool ShouldSend);                                                                              // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /SparksCosmetics/Tools/WBP_Sparks_Dbg_VariantChannel.WBP_Sparks_Dbg_VariantChannel_C.SetSelection
	// void SetSelection(FString Choice);                                                                                    // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /SparksCosmetics/Tools/WBP_Sparks_Dbg_VariantChannel.WBP_Sparks_Dbg_VariantChannel_C.SetNameAndChannels
	// void SetNameAndChannels(FGameplayTag tag, FText Channel Name, TArray<FString>& Options);                              // [0x211c0a0] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void BndEvt__WBP_Sparks_Dbg_VariantChannel_cb_ItemList_K2Node_ComponentBoundEvent_0_OnSelectionChangedEvent__DelegateSignature(FString SelectedItem, TEnumAsByte<ESelectInfo> SelectionType); // [0x211c0a0] BlueprintEvent       
	...
	// void ExecuteUbergraph_WBP_Sparks_Dbg_VariantChannel(int32_t EntryPoint);                                              // [0x211c0a0] Final                
};
...
public:
	...
	// void RefreshChoices();                                                                                                // [0x211c0a0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /SparksCosmetics/Tools/WBP_Sparks_Dbg_CosmeticItem.WBP_Sparks_Dbg_CosmeticItem_C.ChildSetChoice
	// void ChildSetChoice(FGameplayTag Channel, FString Choice);                                                            // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /SparksCosmetics/Tools/WBP_Sparks_Dbg_CosmeticItem.WBP_Sparks_Dbg_CosmeticItem_C.RefreshData
	// void RefreshData(TMap<FGameplayTag, FString> Choices);                                                                // [0x211c0a0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /SparksCosmetics/Tools/WBP_Sparks_Dbg_CosmeticItem.WBP_Sparks_Dbg_CosmeticItem_C.SetTypes
	// void SetTypes(ESparksAccountItemSubtype Subtype, ESparksInstrumentType Instrument);                                   // [0x211c0a0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /SparksCosmetics/Tools/WBP_Sparks_Dbg_CosmeticItem.WBP_Sparks_Dbg_CosmeticItem_C.SetItemInfo
	// void SetItemInfo(class USparksAccountItemDefinition* Item);                                                           // [0x211c0a0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void BndEvt__WBP_Sparks_Dbg_CosmeticItem_cb_ItemList_K2Node_ComponentBoundEvent_0_OnSelectionChangedEvent__DelegateSignature(FString SelectedItem, TEnumAsByte<ESelectInfo> SelectionType); // [0x211c0a0] BlueprintEvent       
	...
	// void ExecuteUbergraph_WBP_Sparks_Dbg_CosmeticItem(int32_t EntryPoint);                                                // [0x211c0a0] Final|HasDefaults    
};
...
public:
	...
	SDK_UNDEFINED(80,12154) /* TMap<ESparksInstrumentType, UWBP_Sparks_Dbg_CosmeticItem_C*> */ __um(Items);        // 0x02F8   (0x0050)  


	/// Functions
	// Function /SparksCosmetics/Tools/WBP_Sparks_Dbg_Cosmetic_Group.WBP_Sparks_Dbg_Cosmetic_Group_C.OnChoiceChanged
	// void OnChoiceChanged(ESparksInstrumentType Instrument);                                                               // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /SparksCosmetics/Tools/WBP_Sparks_Dbg_Cosmetic_Group.WBP_Sparks_Dbg_Cosmetic_Group_C.SetItemInfo
	// void SetItemInfo(class USparksAccountItemDefinition* NewItem);                                                        // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /SparksCosmetics/Tools/WBP_Sparks_Dbg_Cosmetic_Group.WBP_Sparks_Dbg_Cosmetic_Group_C.RefreshAll
	// void RefreshAll();                                                                                                    // [0x211c0a0] Public|BlueprintCallable|BlueprintEvent 
	// Function /SparksCosmetics/Tools/WBP_Sparks_Dbg_Cosmetic_Group.WBP_Sparks_Dbg_Cosmetic_Group_C.SetGroupSubtype
	// void SetGroupSubtype(ESparksAccountItemSubtype ItemType);                                                             // [0x211c0a0] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void BndEvt__WBP_Sparks_Dbg_Cosmetic_Group_chk_Collapse_K2Node_ComponentBoundEvent_0_OnCheckBoxComponentStateChanged__DelegateSignature(bool bIsChecked); // [0x211c0a0] BlueprintEvent       
	...
	// void ExecuteUbergraph_WBP_Sparks_Dbg_Cosmetic_Group(int32_t EntryPoint);                                              // [0x211c0a0] Final                
};
