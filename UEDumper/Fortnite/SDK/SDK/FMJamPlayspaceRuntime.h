...
public:
	...
	SDK_UNDEFINED(16,13704) /* FString */              __um(LoopType);                                             // 0x0120   (0x0010)  
	SDK_UNDEFINED(16,13705) /* FString */              __um(LoopID);                                               // 0x0130   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(8,13706) /* TWeakObjectPtr<UJamMusicSlot*> */ __um(WeakOwningMusicSlotPtr);                      // 0x0030   (0x0008)  
...
{ 
	...
	SDK_UNDEFINED(8,13707) /* TWeakObjectPtr<APlayerState*> */ __um(PlayerState);                                  // 0x0008   (0x0008)  
	...
	SDK_UNDEFINED(8,13708) /* TWeakObjectPtr<UCatalogData*> */ __um(CMSCatalogEntry);                              // 0x0018   (0x0008)  
	SDK_UNDEFINED(8,13709) /* TWeakObjectPtr<UFMJamSong*> */ __um(Song);                                           // 0x0020   (0x0008)  
};
...
{ 
public:
	SDK_UNDEFINED(16,13710) /* FMulticastInlineDelegate */ __um(OnLoopStarted);                                    // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,13711) /* FMulticastInlineDelegate */ __um(OnLoopStopped);                                    // 0x0038   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,13712) /* FMulticastInlineDelegate */ __um(OnLoopStarted);                                    // 0x00A8   (0x0010)  
	SDK_UNDEFINED(16,13713) /* FMulticastInlineDelegate */ __um(OnLoopStopped);                                    // 0x00B8   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,13714) /* TMap<int32_t, FJamLoopReactiveFX> */ __um(LoopReactiveFX);                          // 0x00D0   (0x0050)  
...
{ 
	SDK_UNDEFINED(16,13715) /* TArray<TWeakObjectPtr<UNiagaraComponent*>> */ __um(NiagaraComponents);              // 0x0000   (0x0010)  
};
