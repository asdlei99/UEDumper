...
enum class EStateTreeUpdatePhase : uint8_t
{
	...
	EStateTreeUpdatePhase__EnterConditions                                           = 12,
	EStateTreeUpdatePhase__EnterStates                                               = 13,
	EStateTreeUpdatePhase__ExitStates                                                = 14,
	EStateTreeUpdatePhase__EStateTreeUpdatePhase_MAX                                 = 15
};
...
enum class EStateTreeTraceEventType : uint8_t
{
	...
	EStateTreeTraceEventType__OnEvaluating                                           = 14,
	EStateTreeTraceEventType__OnTransition                                           = 15,
	EStateTreeTraceEventType__OnTreeStarted                                          = 16,
	EStateTreeTraceEventType__OnTreeStopped                                          = 17,
	EStateTreeTraceEventType__EStateTreeTraceEventType_MAX                           = 18
};
...
enum class EStateTreeStateType : uint8_t
{
	...
	EStateTreeStateType__Subtree                                                     = 3,
	EStateTreeStateType__EStateTreeStateType_MAX                                     = 4
};
...
public:
	...
	// void SendEvent(FStateTreeEvent& Event);                                                                               // [0x6d5847c] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/StateTreeModule.StateTreeNodeBlueprintBase.RequestTransition
	// void RequestTransition(FStateTreeStateLink& TargetState, EStateTreeTransitionPriority Priority);                      // [0x6d582e8] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// bool ReceiveTestCondition();                                                                                          // [0x2047e54] Event|Public|BlueprintEvent|Const 
};
...
public:
	...
	// void ReceiveTreeStop();                                                                                               // [0x2047e54] Event|Public|BlueprintEvent 
	// Function /Script/StateTreeModule.StateTreeEvaluatorBlueprintBase.ReceiveTreeStart
	// void ReceiveTreeStart();                                                                                              // [0x2047e54] Event|Public|BlueprintEvent 
	// Function /Script/StateTreeModule.StateTreeEvaluatorBlueprintBase.ReceiveTick
	// void ReceiveTick(float DeltaTime);                                                                                    // [0x2047e54] Event|Public|BlueprintEvent 
};
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x1];                                       // 0x0040   (0x0001)  MISSED
	...
	// EStateTreeRunStatus ReceiveTick(float DeltaTime);                                                                     // [0x2047e54] Event|Public|BlueprintEvent 
	// Function /Script/StateTreeModule.StateTreeTaskBlueprintBase.ReceiveStateCompleted
	// void ReceiveStateCompleted(EStateTreeRunStatus CompletionStatus, FStateTreeActiveStates CompletedActiveStates);       // [0x2047e54] Event|Public|BlueprintEvent 
	// Function /Script/StateTreeModule.StateTreeTaskBlueprintBase.ReceiveLatentTick
	// void ReceiveLatentTick(float DeltaTime);                                                                              // [0x2047e54] Event|Public|BlueprintEvent 
	// Function /Script/StateTreeModule.StateTreeTaskBlueprintBase.ReceiveLatentEnterState
	// void ReceiveLatentEnterState(FStateTreeTransitionResult& TRANSITION);                                                 // [0x2047e54] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/StateTreeModule.StateTreeTaskBlueprintBase.ReceiveExitState
	// void ReceiveExitState(FStateTreeTransitionResult& TRANSITION);                                                        // [0x2047e54] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/StateTreeModule.StateTreeTaskBlueprintBase.ReceiveEnterState
	// EStateTreeRunStatus ReceiveEnterState(FStateTreeTransitionResult& TRANSITION);                                        // [0x2047e54] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/StateTreeModule.StateTreeTaskBlueprintBase.FinishTask
	// void FinishTask(bool bSucceeded);                                                                                     // [0x6d58228] Final|Native|Protected|BlueprintCallable 
};
...
{ 
	...
	FStateTreeStateHandle                              Parent;                                                     // 0x0006   (0x0002)  
	uint16_t                                           ChildrenBegin;                                              // 0x0008   (0x0002)  
	uint16_t                                           ChildrenEnd;                                                // 0x000A   (0x0002)  
	uint16_t                                           EnterConditionsBegin;                                       // 0x000C   (0x0002)  
	uint16_t                                           TransitionsBegin;                                           // 0x000E   (0x0002)  
	uint16_t                                           TasksBegin;                                                 // 0x0010   (0x0002)  
	FStateTreeIndex16                                  ParameterInstanceIndex;                                     // 0x0012   (0x0002)  
	FStateTreeIndex16                                  ParameterDataViewIndex;                                     // 0x0014   (0x0002)  
	char                                               EnterConditionsNum;                                         // 0x0016   (0x0001)  
	char                                               TransitionsNum;                                             // 0x0017   (0x0001)  
	char                                               TasksNum;                                                   // 0x0018   (0x0001)  
	char                                               TaskInstanceStructNum;                                      // 0x0019   (0x0001)  
	char                                               TaskInstanceObjectNum;                                      // 0x001A   (0x0001)  
	EStateTreeStateType                                Type;                                                       // 0x001B   (0x0001)  
	EStateTreeStateSelectionBehavior                   SelectionBehavior;                                          // 0x001C   (0x0001)  
	bool                                               bHasTransitionTasks : 1;                                    // 0x001D:0 (0x0001)  
	bool                                               bEnabled : 1;                                               // 0x001D:1 (0x0001)  
...
{ 
	FInstancedStruct                                   InstanceStorage;                                            // 0x0000   (0x0010)  
};
...
{ 
	FStateTreeIndex16                                  DataViewIndex;                                              // 0x0000   (0x0002)  
};
...
{ 
	...
	FStateTreeExternalDataHandle                       Handle;                                                     // 0x000C   (0x0002)  
	EStateTreeExternalDataRequirement                  Requirement;                                                // 0x000E   (0x0001)  
...
{ 
	class UStruct*                                     Struct;                                                     // 0x0000   (0x0008)  
	FName                                              Name;                                                       // 0x0008   (0x0004)  
	EStateTreeBindableStructSource                     DataSource;                                                 // 0x000C   (0x0001)  
...
{ 
	FStateTreeBindableStructDesc                       TargetStruct;                                               // 0x0000   (0x0010)  
	uint16_t                                           BindingsBegin;                                              // 0x0010   (0x0002)  
	uint16_t                                           BindingsEnd;                                                // 0x0012   (0x0002)  
...
{ 
	...
	FStateTreeIndex16                                  CompiledSourceStructIndex;                                  // 0x0020   (0x0002)  
...
{ 
	...
	int32_t                                            CopySize;                                                   // 0x0040   (0x0004)  
	FStateTreeIndex16                                  SourceStructIndex;                                          // 0x0044   (0x0002)  
	EStateTreePropertyCopyType                         Type;                                                       // 0x0046   (0x0001)  
...
{ 
	...
	TArray<FStateTreePropertyIndirection>              PropertyIndirections;                                       // 0x0040   (0x0010)  
...
public:
	...
	FStateTreePropertyBindings                         PropertyBindings;                                           // 0x00B8   (0x0058)  
	TArray<FStateTreeStateIdToHandle>                  IDToStateMappings;                                          // 0x0110   (0x0010)  
	TArray<FStateTreeNodeIdToIndex>                    IDToNodeMappings;                                           // 0x0120   (0x0010)  
	TArray<FStateTreeTransitionIdToIndex>              IDToTransitionMappings;                                     // 0x0130   (0x0010)  
	FInstancedPropertyBag                              Parameters;                                                 // 0x0140   (0x0010)  
	FStateTreeIndex8                                   ParametersDataViewIndex;                                    // 0x0150   (0x0001)  
	unsigned char                                      UnknownData02_5[0x1];                                       // 0x0151   (0x0001)  MISSED
	uint16_t                                           EvaluatorsBegin;                                            // 0x0152   (0x0002)  
	uint16_t                                           EvaluatorsNum;                                              // 0x0154   (0x0002)  
	uint16_t                                           GlobalTasksBegin;                                           // 0x0156   (0x0002)  
	uint16_t                                           GlobalTasksNum;                                             // 0x0158   (0x0002)  
	bool                                               bHasGlobalTransitionTasks;                                  // 0x015A   (0x0001)  
	unsigned char                                      UnknownData03_5[0x5];                                       // 0x015B   (0x0005)  MISSED
	TArray<FStateTreeExternalDataDesc>                 ExternalDataDescs;                                          // 0x0160   (0x0010)  
	int32_t                                            ExternalDataBaseIndex;                                      // 0x0170   (0x0004)  
	int32_t                                            NumDataViews;                                               // 0x0174   (0x0004)  
...
{ 
	...
	FStateTreeStateHandle                              TargetState;                                                // 0x0002   (0x0002)  
	EStateTreeTransitionPriority                       Priority;                                                   // 0x0004   (0x0001)  
	unsigned char                                      UnknownData00_6[0x1];                                       // 0x0005   (0x0001)  MISSED
};
...
{ 
	FStateTreeActiveStates                             CurrentActiveStates;                                        // 0x0000   (0x0012)  
	EStateTreeRunStatus                                CurrentRunStatus;                                           // 0x0012   (0x0001)  
	unsigned char                                      UnknownData00_5[0x1];                                       // 0x0013   (0x0001)  MISSED
	FStateTreeStateHandle                              SourceState;                                                // 0x0014   (0x0002)  
	FStateTreeStateHandle                              TargetState;                                                // 0x0016   (0x0002)  
	FStateTreeActiveStates                             NextActiveStates;                                           // 0x0018   (0x0012)  
	FStateTreeStateHandle                              CurrentState;                                               // 0x002A   (0x0002)  
	EStateTreeStateChangeType                          ChangeType;                                                 // 0x002C   (0x0001)  
	EStateTreeTransitionPriority                       Priority;                                                   // 0x002D   (0x0001)  
};
...
{ 
	...
	FStateTreeIndex16                                  DataViewIndex;                                              // 0x000E   (0x0002)  
	FStateTreeIndex16                                  InstanceIndex;                                              // 0x0010   (0x0002)  
	bool                                               bInstanceIsObject : 1;                                      // 0x0012:0 (0x0001)  
...
{ 
	FInstancedStructContainer                          InstanceStructs;                                            // 0x0000   (0x0010)  
	TArray<class UObject*>                             InstanceObjects;                                            // 0x0010   (0x0010)  
	FStateTreeEventQueue                               EventQueue;                                                 // 0x0020   (0x0010)  
	TArray<FStateTreeTransitionRequest>                TransitionRequests;                                         // 0x0030   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,2049) /* TArray<FString> */       __um(Path);                                                 // 0x0010   (0x0010)  
};
...
{ 
	FStateTreeIndex16                                  BindingsBatch;                                              // 0x0000   (0x0002)  
...
{ 
	SDK_UNDEFINED(16,2050) /* FString */               __um(Text);                                                 // 0x0020   (0x0010)  
