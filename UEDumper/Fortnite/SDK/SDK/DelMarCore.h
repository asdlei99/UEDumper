...
public:
	...
	SDK_UNDEFINED(16,12636) /* FMulticastInlineDelegate */ __um(OnLoadoutChanged);                                 // 0x03D8   (0x0010)  
	...
	SDK_UNDEFINED(8,12637) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(DelMarVehicle);                              // 0x0598   (0x0008)  
	...
	SDK_UNDEFINED(16,12638) /* FString */              __um(DelMarBotPlayerName);                                  // 0x05B8   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(32,12639) /* TWeakObjectPtr<UDelMarAIVehicleCosmeticLibraryData*> */ __um(VehicleCosmeticLibrary); // 0x0080   (0x0020)  
	...
	SDK_UNDEFINED(32,12640) /* TWeakObjectPtr<UFortAthenaAIBotNameDataAsset*> */ __um(BotNameDataAsset);           // 0x00A8   (0x0020)  
	class UClass*                                      AIControllerClass;                                          // 0x00C8   (0x0008)  
	SDK_UNDEFINED(32,12641) /* TWeakObjectPtr<UDataTable*> */ __um(MMRSpawnTablePtr);                              // 0x00D0   (0x0020)  
	TArray<class ADelMarAIController*>                 DelMarAIControllers;                                        // 0x00F0   (0x0010)  
	SDK_UNDEFINED(8,12642) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(RaceManager);                            // 0x0100   (0x0008)  
	SDK_UNDEFINED(8,12643) /* TWeakObjectPtr<UDelMarRespawnManagerComponent*> */ __um(RespawnManagerComponent);    // 0x0108   (0x0008)  
	SDK_UNDEFINED(80,12644) /* TSet<FString> */        __um(ReservedPlayerNames);                                  // 0x0110   (0x0050)  
...
{ 
	SDK_UNDEFINED(32,12645) /* TWeakObjectPtr<UCosmeticLoadoutSlotTemplate*> */ __um(SlotTemplate);                // 0x0000   (0x0020)  
	SDK_UNDEFINED(32,12646) /* TWeakObjectPtr<UDataTable*> */ __um(VehicleSlotCosmeticDataTable);                  // 0x0020   (0x0020)  
};
...
{ 
public:
	SDK_UNDEFINED(32,12647) /* TWeakObjectPtr<UDataTable*> */ __um(PredefineVehiclCosmeticSetsDataTable);          // 0x0030   (0x0020)  
...
{ 
public:
	SDK_UNDEFINED(8,12648) /* TWeakObjectPtr<AActor*> */ __um(Actor);                                              // 0x0028   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12649) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(DelMarVehicle);                              // 0x0098   (0x0008)  
};
...
public:
	...
	SDK_UNDEFINED(1,12650) /* TEnumAsByte<ECollisionChannel> */ __um(RaycastCollisionChannel);                     // 0x0164   (0x0001)  
	...
	SDK_UNDEFINED(8,12651) /* TWeakObjectPtr<UDelMarTrackPositionComponent*> */ __um(TrackPositionComponent);      // 0x03F0   (0x0008)  
	SDK_UNDEFINED(8,12652) /* TWeakObjectPtr<UDelMarTrackOobTubePositionalRenderingComponent*> */ __um(OobTubePositionalRenderingComponent); // 0x03F8   (0x0008)  
	SDK_UNDEFINED(80,12653) /* TMap<TWeakObjectPtr<AActor*>, UDriveHazardInfo*> */ __um(PrevFrameDriveHazardInfoMap); // 0x0400   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(8,12654) /* TWeakObjectPtr<UDelMarPlayerRaceDataComponent*> */ __um(PlayerRaceDataComponent);    // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12655) /* TWeakObjectPtr<UDelMarTrackPositionComponent*> */ __um(TrackPositionComponent);      // 0x00A8   (0x0008)  
...
public:
	FBlackboardKeySelector                             VehicleKey;                                                 // 0x0070   (0x0028)  
	SDK_UNDEFINED(8,12656) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(DelMarVehicle);                              // 0x0098   (0x0008)  
};
...
public:
	...
	SDK_UNDEFINED(8,12657) /* TWeakObjectPtr<UDelMarTrackPositionComponent*> */ __um(TrackPositionComponent);      // 0x0754   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12658) /* TWeakObjectPtr<UDelMarGhostPlaybackSessionComponent*> */ __um(CachedPlaybackSession); // 0x00B8   (0x0008)  
	SDK_UNDEFINED(8,12659) /* TWeakObjectPtr<UDelMarGhostRecordingSessionComponent*> */ __um(CachedRecordingSession); // 0x00C0   (0x0008)  
	SDK_UNDEFINED(8,12660) /* TWeakObjectPtr<ADelMarChallengeRaceManager*> */ __um(CachedRaceManager);             // 0x00C8   (0x0008)  
};
...
public:
	...
	SDK_UNDEFINED(16,12661) /* FMulticastInlineDelegate */ __um(OnRaceFinished);                                   // 0x0320   (0x0010)  
	SDK_UNDEFINED(16,12662) /* FMulticastInlineDelegate */ __um(OnRaceStarted);                                    // 0x0330   (0x0010)  
	SDK_UNDEFINED(16,12663) /* FMulticastInlineDelegate */ __um(OnRaceCountdownStarted);                           // 0x0340   (0x0010)  
	SDK_UNDEFINED(16,12664) /* FMulticastInlineDelegate */ __um(OnRaceReset);                                      // 0x0350   (0x0010)  
	SDK_UNDEFINED(16,12665) /* FMulticastInlineDelegate */ __um(OnPlayerFinishedRace);                             // 0x0360   (0x0010)  
	SDK_UNDEFINED(16,12666) /* FMulticastInlineDelegate */ __um(OnPlayerLapComplete);                              // 0x0370   (0x0010)  
	SDK_UNDEFINED(16,12667) /* FMulticastInlineDelegate */ __um(OnPlayerResetRun);                                 // 0x0380   (0x0010)  
	...
	SDK_UNDEFINED(8,12668) /* TWeakObjectPtr<ADelMarRaceLevelConfig*> */ __um(ActiveRaceLevelConfig);              // 0x03C0   (0x0008)  
	...
	SDK_UNDEFINED(80,12669) /* TSet<AFortPlayerState*> */ __um(ManagedPlayerStates);                               // 0x0400   (0x0050)  
	SDK_UNDEFINED(80,12670) /* TSet<TWeakObjectPtr<AFortPlayerState*>> */ __um(InactivePlayerStates);              // 0x0450   (0x0050)  
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0004   (0x0004)  MISSED
	SDK_UNDEFINED(32,12671) /* TWeakObjectPtr<UClass*> */ __um(StateClass);                                        // 0x0008   (0x0020)  
};
...
public:
	...
	SDK_UNDEFINED(80,12672) /* TMap<FGameplayTag, UClass*> */ __um(StateMappings);                                 // 0x00B0   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(8,12673) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(RaceManager);                            // 0x01A8   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12674) /* TWeakObjectPtr<UEnhancedInputComponent*> */ __um(InputComponent);                    // 0x00C0   (0x0008)  
	SDK_UNDEFINED(8,12675) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00C8   (0x0008)  
	SDK_UNDEFINED(8,12676) /* TWeakObjectPtr<UDelMarRequestComponent*> */ __um(SpectatorRequestComponent);         // 0x00D0   (0x0008)  
	SDK_UNDEFINED(8,12677) /* TWeakObjectPtr<AFortPlayerState*> */ __um(CurrentViewTarget);                        // 0x00D8   (0x0008)  
	SDK_UNDEFINED(8,12678) /* TWeakObjectPtr<AFortPlayerState*> */ __um(PrevValidViewTarget);                      // 0x00E0   (0x0008)  
	SDK_UNDEFINED(8,12679) /* TWeakObjectPtr<AFortPlayerState*> */ __um(SpectatorPlayerState);                     // 0x00E8   (0x0008)  
	SDK_UNDEFINED(8,12680) /* TWeakObjectPtr<AFortPlayerControllerZone*> */ __um(SpectatorController);             // 0x00F0   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12681) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedVehicle);                              // 0x00D8   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(8,12682) /* TWeakObjectPtr<APlayerState*> */ __um(ViewTargetPlayerState);                        // 0x0110   (0x0008)  
};
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0004   (0x0004)  MISSED
	SDK_UNDEFINED(24,12683) /* FText */                __um(SlotName);                                             // 0x0008   (0x0018)  
	SDK_UNDEFINED(24,12684) /* FText */                __um(ShortDescription);                                     // 0x0020   (0x0018)  
	bool                                               bCanBeEmpty;                                                // 0x0038   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0039   (0x0007)  MISSED
	SDK_UNDEFINED(32,12685) /* TWeakObjectPtr<UTexture2D*> */ __um(UnassignedPreviewImage);                        // 0x0040   (0x0020)  
};
...
{ 
public:
	SDK_UNDEFINED(8,12686) /* TWeakObjectPtr<ADelMarDeathRaceManager*> */ __um(DeathRaceManager);                  // 0x0030   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(8,12687) /* TWeakObjectPtr<AFortPlayerState*> */ __um(NewFirstPlace);                            // 0x0028   (0x0008)  
	SDK_UNDEFINED(8,12688) /* TWeakObjectPtr<AFortPlayerState*> */ __um(PrevFirstPlace);                           // 0x0030   (0x0008)  
};
...
{ 
public:
	SDK_UNDEFINED(16,12689) /* FString */              __um(LeaderboardEventId);                                   // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,12690) /* FString */              __um(LeaderboardWindowId);                                  // 0x0038   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,12691) /* FString */              __um(PlayerAccountId);                                      // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,12692) /* FString */              __um(PlayerName);                                           // 0x0018   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,12693) /* FString */              __um(FlowAnalyicsEventName);                                // 0x00A0   (0x0010)  
	SDK_UNDEFINED(8,12694) /* TWeakObjectPtr<AFortPlayerController*> */ __um(PlayerController);                    // 0x00B0   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(16,12695) /* FString */              __um(LastPlayedDelMarMnemonic);                             // 0x0030   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(8,12696) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedDelMarVehicle);                        // 0x00F8   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(16,12697) /* FString */              __um(LeaderboardEventId);                                   // 0x00A0   (0x0010)  
	SDK_UNDEFINED(16,12698) /* FString */              __um(LeaderboardWindowId);                                  // 0x00B0   (0x0010)  
...
{ 
	SDK_UNDEFINED(24,12699) /* FText */                __um(KBMText);                                              // 0x0000   (0x0018)  
	SDK_UNDEFINED(24,12700) /* FText */                __um(GamepadText);                                          // 0x0018   (0x0018)  
	SDK_UNDEFINED(24,12701) /* FText */                __um(TouchText);                                            // 0x0030   (0x0018)  
...
public:
	...
	SDK_UNDEFINED(8,12702) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(RaceManager);                            // 0x0398   (0x0008)  
	SDK_UNDEFINED(8,12703) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(ActiveVehicle);                              // 0x03A0   (0x0008)  
	SDK_UNDEFINED(8,12704) /* TWeakObjectPtr<AFortPlayerController*> */ __um(ActivePlayerController);              // 0x03A8   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(24,12705) /* FText */                __um(DisplayName);                                          // 0x0030   (0x0018)  
	SDK_UNDEFINED(24,12706) /* FText */                __um(LevelDescription);                                     // 0x0048   (0x0018)  
	SDK_UNDEFINED(32,12707) /* TWeakObjectPtr<UTexture2D*> */ __um(LevelBackgroundImage);                          // 0x0060   (0x0020)  
	SDK_UNDEFINED(16,12708) /* TArray<TWeakObjectPtr<UWorld*>> */ __um(Levels);                                    // 0x0080   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(80,12709) /* TMap<FGameplayTag, TWeakObjectPtr<UDelMarCosmeticItemDefinition*>> */ __um(EquippedLoadout); // 0x0028   (0x0050)  
};
...
{ 
public:
	SDK_UNDEFINED(8,12710) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12711) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedVehicle);                              // 0x00A8   (0x0008)  
	SDK_UNDEFINED(8,12712) /* TWeakObjectPtr<UDelMarPlayerRaceDataComponent*> */ __um(CachedPlayerRaceData);       // 0x00B0   (0x0008)  
	SDK_UNDEFINED(8,12713) /* TWeakObjectPtr<UDelMarRaceInfoComponent*> */ __um(CachedRaceInfo);                   // 0x00B8   (0x0008)  
	SDK_UNDEFINED(8,12714) /* TWeakObjectPtr<UDelMarPositionalTrackerComponent*> */ __um(CachedPositionalTracker); // 0x00C0   (0x0008)  
	SDK_UNDEFINED(8,12715) /* TWeakObjectPtr<UDelmarCompetitiveMatchmakeRatingComponent*> */ __um(MatchmakeRatingComponent); // 0x00C8   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(8,12716) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12717) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedDelMarVehicle);                        // 0x00A8   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(8,12718) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedVehicle);                              // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12719) /* TWeakObjectPtr<AFortPlayerState*> */ __um(CachedPlayerState);                        // 0x00A8   (0x0008)  
	SDK_UNDEFINED(8,12720) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00B0   (0x0008)  
	FTimerHandle                                       DistanceTraveledTimer;                                      // 0x00B8   (0x0008)  
	unsigned char                                      UnknownData00_5[0x28];                                      // 0x00C0   (0x0028)  MISSED
	SDK_UNDEFINED(8,12721) /* TWeakObjectPtr<UDelMarObjectiveProcessor_DistanceTraveled*> */ __um(DistanceTravelledObjectiveProcessor); // 0x00E8   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12722) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedVehicle);                              // 0x00A4   (0x0008)  
	SDK_UNDEFINED(8,12723) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00AC   (0x0008)  
	SDK_UNDEFINED(8,12724) /* TWeakObjectPtr<AFortPlayerState*> */ __um(CachedPlayerState);                        // 0x00B4   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12725) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(DelMarRaceManager);                      // 0x0308   (0x0008)  
};
...
{ 
public:
	SDK_UNDEFINED(8,12726) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedDelMarVehicle);                        // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12727) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00A8   (0x0008)  
	SDK_UNDEFINED(8,12728) /* TWeakObjectPtr<UDelMarTrackPositionComponent*> */ __um(CachedTrackPositionComp);     // 0x00B0   (0x0008)  
	SDK_UNDEFINED(8,12729) /* TWeakObjectPtr<UDelMarPlayerRaceDataComponent*> */ __um(CachedRaceData);             // 0x00B8   (0x0008)  
	SDK_UNDEFINED(8,12730) /* TWeakObjectPtr<UDelMarCheckpointManagerComponent*> */ __um(CachedCheckpointManager); // 0x00C0   (0x0008)  
	SDK_UNDEFINED(8,12731) /* TWeakObjectPtr<UDelMarTrackManager*> */ __um(CachedTrackManager);                    // 0x00C8   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(8,12732) /* TWeakObjectPtr<AFortAthenaVehicle*> */ __um(CachedVehicle);                          // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12733) /* TWeakObjectPtr<UVehicleCosmeticsAssembledMeshUserComponent*> */ __um(CachedVCAMUC);  // 0x00A8   (0x0008)  
	class UMaterialInterface*                          ProxyGhostMaterial;                                         // 0x00B0   (0x0008)  
	SDK_UNDEFINED(80,12734) /* TMap<FGameplayTag, FDelMarProxyMeshMaterialInfo> */ __um(VehicleMaterialInfoMap);   // 0x00B8   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(16,12735) /* FString */              __um(RaceGUID);                                             // 0x00A0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,12736) /* TMap<EDelMarRaceMode, UClass*> */ __um(RaceManagerClassMap);                        // 0x0C08   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(8,12737) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12738) /* TWeakObjectPtr<UDelMarPositionalTrackerComponent*> */ __um(PositionalTracker);       // 0x00A8   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(8,12739) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(Vehicle);                                    // 0x0030   (0x0008)  
};
...
{ 
public:
	SDK_UNDEFINED(8,12740) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(Vehicle);                                    // 0x0030   (0x0008)  
};
...
{ 
public:
	SDK_UNDEFINED(8,12741) /* TWeakObjectPtr<USplineComponent*> */ __um(MovementSpline);                           // 0x00A0   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(16,12742) /* FMulticastInlineDelegate */ __um(OnPlayerCountdownStarted);                         // 0x00A0   (0x0010)  
	...
	SDK_UNDEFINED(8,12743) /* TWeakObjectPtr<UDelMarRaceConfigComponent*> */ __um(RaceConfig);                     // 0x00C8   (0x0008)  
	SDK_UNDEFINED(8,12744) /* TWeakObjectPtr<ADelMarRaceLevelConfig*> */ __um(RaceLevelConfig);                    // 0x00D0   (0x0008)  
	SDK_UNDEFINED(8,12745) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00D8   (0x0008)  
...
{ 
	SDK_UNDEFINED(24,12746) /* FText */                __um(KBMText);                                              // 0x0000   (0x0018)  
	SDK_UNDEFINED(24,12747) /* FText */                __um(GamepadText);                                          // 0x0018   (0x0018)  
};
...
{ 
	...
	SDK_UNDEFINED(24,12748) /* FText */                __um(Title);                                                // 0x0060   (0x0018)  
...
public:
	...
	SDK_UNDEFINED(8,12749) /* TWeakObjectPtr<UEnhancedInputComponent*> */ __um(InputComponent);                    // 0x0120   (0x0008)  
	SDK_UNDEFINED(8,12750) /* TWeakObjectPtr<AFortPlayerState*> */ __um(PlayerState);                              // 0x0128   (0x0008)  
	SDK_UNDEFINED(8,12751) /* TWeakObjectPtr<AFortPlayerController*> */ __um(PlayerController);                    // 0x0130   (0x0008)  
	SDK_UNDEFINED(8,12752) /* TWeakObjectPtr<UDelMarPlayerPreferencesComponent*> */ __um(PlayerPreferences);       // 0x0138   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(16,12753) /* FMulticastInlineDelegate */ __um(OnActionPerformed);                                // 0x0028   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(80,12754) /* TMap<FName, UDelMarVehicleBodySetup*> */ __um(BodySetupMap);                        // 0x0030   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(1,12755) /* TEnumAsByte<ECollisionChannel> */ __um(PenetrationTraceChannel);                     // 0x0104   (0x0001)  
	...
	SDK_UNDEFINED(8,12756) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(VehicleTarget);                              // 0x27A0   (0x0008)  
	SDK_UNDEFINED(8,12757) /* TWeakObjectPtr<UDelMarCameraInputControllerComponent*> */ __um(CameraInputControllerComponent); // 0x27A8   (0x0008)  
...
{ 
	SDK_UNDEFINED(80,12758) /* TMap<FGameplayTag, UDelMarCosmeticItemDefinition*> */ __um(Items);                  // 0x0000   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(8,12759) /* TWeakObjectPtr<UPrimitiveComponent*> */ __um(Component);                             // 0x0064   (0x0008)  
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x50];                                      // 0x1EF0   (0x0050)  MISSED
	...
	SDK_UNDEFINED(8,12760) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(RaceManager);                            // 0x2124   (0x0008)  
	...
	SDK_UNDEFINED(8,12761) /* TWeakObjectPtr<UDelMarRaceConfigComponent*> */ __um(ActiveRaceConfig);               // 0x2228   (0x0008)  
	SDK_UNDEFINED(8,12762) /* TWeakObjectPtr<UDelMarTimeManagerComponent*> */ __um(RaceTimeManager);               // 0x2230   (0x0008)  
	SDK_UNDEFINED(8,12763) /* TWeakObjectPtr<UDelMarGlobalInputDisabler*> */ __um(GlobalInputDisabler);            // 0x2238   (0x0008)  
	unsigned char                                      UnknownData07_5[0x10];                                      // 0x2240   (0x0010)  MISSED
	SDK_UNDEFINED(16,12764) /* FMulticastInlineDelegate */ __um(OnVehicleWheelsLeftGround);                        // 0x2250   (0x0010)  
	SDK_UNDEFINED(16,12765) /* FMulticastInlineDelegate */ __um(OnSpeedometerSpeedChanged);                        // 0x2260   (0x0010)  
	...
	SDK_UNDEFINED(16,12766) /* FMulticastInlineDelegate */ __um(OnBonusSpeedActivated);                            // 0x22C0   (0x0010)  
	SDK_UNDEFINED(16,12767) /* FMulticastInlineDelegate */ __um(OnBonusSpeedDeactivated);                          // 0x22D0   (0x0010)  
	SDK_UNDEFINED(16,12768) /* FMulticastInlineDelegate */ __um(OnBonusSpeedChanged);                              // 0x22E0   (0x0010)  
	SDK_UNDEFINED(16,12769) /* FMulticastInlineDelegate */ __um(OnAnyWheelsOnGroundChanged);                       // 0x22F0   (0x0010)  
	SDK_UNDEFINED(16,12770) /* FMulticastInlineDelegate */ __um(OnWheelsOnGroundChanged);                          // 0x2300   (0x0010)  
	SDK_UNDEFINED(16,12771) /* FMulticastInlineDelegate */ __um(OnVehicleForwardStateChanged);                     // 0x2310   (0x0010)  
	unsigned char                                      UnknownData09_5[0xC0];                                      // 0x2320   (0x00C0)  MISSED
	SDK_UNDEFINED(16,12772) /* FMulticastInlineDelegate */ __um(OnDelMarVehicleHitWall);                           // 0x23E0   (0x0010)  
	SDK_UNDEFINED(16,12773) /* FMulticastInlineDelegate */ __um(OnDelMarVehicleHitVehicle);                        // 0x23F0   (0x0010)  
	SDK_UNDEFINED(16,12774) /* FMulticastInlineDelegate */ __um(OnDelMarVehicleHitByVehicle);                      // 0x2400   (0x0010)  
	SDK_UNDEFINED(16,12775) /* FMulticastInlineDelegate */ __um(OnVehicleLanded);                                  // 0x2410   (0x0010)  
	unsigned char                                      UnknownData10_5[0x10];                                      // 0x2420   (0x0010)  MISSED
	SDK_UNDEFINED(16,12776) /* FMulticastInlineDelegate */ __um(OnWorldBonusSpeedStackGained);                     // 0x2430   (0x0010)  
	SDK_UNDEFINED(16,12777) /* FMulticastInlineDelegate */ __um(OnWorldBonusSpeedStackLost);                       // 0x2440   (0x0010)  
	unsigned char                                      UnknownData11_5[0x70];                                      // 0x2450   (0x0070)  MISSED
	SDK_UNDEFINED(16,12778) /* FMulticastInlineDelegate */ __um(OnVehicleStartedSkydiving);                        // 0x24C0   (0x0010)  
	SDK_UNDEFINED(16,12779) /* FMulticastInlineDelegate */ __um(OnVehicleStoppedSkydiving);                        // 0x24D0   (0x0010)  
	unsigned char                                      UnknownData12_5[0x8];                                       // 0x24E0   (0x0008)  MISSED
	SDK_UNDEFINED(16,12780) /* FMulticastInlineDelegate */ __um(OnDriftActivated);                                 // 0x24E8   (0x0010)  
	SDK_UNDEFINED(16,12781) /* FMulticastInlineDelegate */ __um(OnDriftDeactivated);                               // 0x24F8   (0x0010)  
	SDK_UNDEFINED(16,12782) /* FMulticastInlineDelegate */ __um(OnDriftSlipAngleRatioChanged);                     // 0x2508   (0x0010)  
	SDK_UNDEFINED(16,12783) /* FMulticastInlineDelegate */ __um(OnDriftKickActivated);                             // 0x2518   (0x0010)  
	SDK_UNDEFINED(16,12784) /* FMulticastInlineDelegate */ __um(OnDriftKickDeactivated);                           // 0x2528   (0x0010)  
	SDK_UNDEFINED(16,12785) /* FMulticastInlineDelegate */ __um(OnDriftControlChanged);                            // 0x2538   (0x0010)  
	SDK_UNDEFINED(16,12786) /* FMulticastInlineDelegate */ __um(OnDriftDurationChanged);                           // 0x2548   (0x0010)  
	unsigned char                                      UnknownData13_5[0x40];                                      // 0x2558   (0x0040)  MISSED
	SDK_UNDEFINED(16,12787) /* FMulticastInlineDelegate */ __um(OnEnteredDriftBoostRange);                         // 0x2598   (0x0010)  
	SDK_UNDEFINED(16,12788) /* FMulticastInlineDelegate */ __um(OnExitedDriftBoostRange);                          // 0x25A8   (0x0010)  
	SDK_UNDEFINED(16,12789) /* FMulticastInlineDelegate */ __um(OnStartedLosingAppliedDriftBoost);                 // 0x25B8   (0x0010)  
	SDK_UNDEFINED(16,12790) /* FMulticastInlineDelegate */ __um(OnDriftBoostActivated);                            // 0x25C8   (0x0010)  
	SDK_UNDEFINED(16,12791) /* FMulticastInlineDelegate */ __um(OnDriftBoostDeactivated);                          // 0x25D8   (0x0010)  
	SDK_UNDEFINED(16,12792) /* FMulticastInlineDelegate */ __um(OnMaxPotentialReached);                            // 0x25E8   (0x0010)  
	SDK_UNDEFINED(16,12793) /* FMulticastInlineDelegate */ __um(OnMaxPotentialLost);                               // 0x25F8   (0x0010)  
	SDK_UNDEFINED(16,12794) /* FMulticastInlineDelegate */ __um(OnAllPotentialLost);                               // 0x2608   (0x0010)  
	SDK_UNDEFINED(16,12795) /* FMulticastInlineDelegate */ __um(OnEarnedDriftBoost);                               // 0x2618   (0x0010)  
	SDK_UNDEFINED(16,12796) /* FMulticastInlineDelegate */ __um(OnPotentialDriftBoostChanged);                     // 0x2628   (0x0010)  
	unsigned char                                      UnknownData14_5[0x38];                                      // 0x2638   (0x0038)  MISSED
	SDK_UNDEFINED(16,12797) /* FMulticastInlineDelegate */ __um(OnDraftActivated);                                 // 0x2670   (0x0010)  
	SDK_UNDEFINED(16,12798) /* FMulticastInlineDelegate */ __um(OnDraftDeactivated);                               // 0x2680   (0x0010)  
	SDK_UNDEFINED(16,12799) /* FMulticastInlineDelegate */ __um(OnDraftStateChanged);                              // 0x2690   (0x0010)  
	SDK_UNDEFINED(16,12800) /* FMulticastInlineDelegate */ __um(OnReachedMaxBonusSpeed);                           // 0x26A0   (0x0010)  
	...
	SDK_UNDEFINED(16,12801) /* FMulticastInlineDelegate */ __um(OnStartlineBoostActivated);                        // 0x2738   (0x0010)  
	SDK_UNDEFINED(16,12802) /* FMulticastInlineDelegate */ __um(OnStartlineBoostDeactivated);                      // 0x2748   (0x0010)  
	SDK_UNDEFINED(16,12803) /* FMulticastInlineDelegate */ __um(OnStartlineBoostFailed);                           // 0x2758   (0x0010)  
	FDelMarStartlineBoostData                          StartlineBoostData;                                         // 0x2768   (0x0010)  
	unsigned char                                      UnknownData17_5[0x20];                                      // 0x2778   (0x0020)  MISSED
	SDK_UNDEFINED(16,12804) /* FMulticastInlineDelegate */ __um(OnStrafeActivated);                                // 0x2798   (0x0010)  
	SDK_UNDEFINED(16,12805) /* FMulticastInlineDelegate */ __um(OnStrafeDeactivated);                              // 0x27A8   (0x0010)  
	SDK_UNDEFINED(16,12806) /* FMulticastInlineDelegate */ __um(OnStrafeCooldownChanged);                          // 0x27B8   (0x0010)  
	SDK_UNDEFINED(16,12807) /* FMulticastInlineDelegate */ __um(OnStrafeUsabilityChanged);                         // 0x27C8   (0x0010)  
	SDK_UNDEFINED(16,12808) /* FMulticastInlineDelegate */ __um(OnStrafeDisabledChanged);                          // 0x27D8   (0x0010)  
	unsigned char                                      UnknownData18_5[0x20];                                      // 0x27E8   (0x0020)  MISSED
	SDK_UNDEFINED(16,12809) /* FMulticastInlineDelegate */ __um(OnTurboActivated);                                 // 0x2808   (0x0010)  
	SDK_UNDEFINED(16,12810) /* FMulticastInlineDelegate */ __um(OnTurboDeactivated);                               // 0x2818   (0x0010)  
	SDK_UNDEFINED(16,12811) /* FMulticastInlineDelegate */ __um(OnTurboChargesUpdated);                            // 0x2828   (0x0010)  
	SDK_UNDEFINED(16,12812) /* FMulticastInlineDelegate */ __um(OnTurboBonusZoneStateChanged);                     // 0x2838   (0x0010)  
	SDK_UNDEFINED(16,12813) /* FMulticastInlineDelegate */ __um(OnTurboChargeUsed);                                // 0x2848   (0x0010)  
	unsigned char                                      UnknownData19_5[0x38];                                      // 0x2858   (0x0038)  MISSED
	SDK_UNDEFINED(16,12814) /* FMulticastInlineDelegate */ __um(OnKickflipActivated);                              // 0x2890   (0x0010)  
	SDK_UNDEFINED(16,12815) /* FMulticastInlineDelegate */ __um(OnKickflipDeactivated);                            // 0x28A0   (0x0010)  
	SDK_UNDEFINED(16,12816) /* FMulticastInlineDelegate */ __um(OnKickflipSuctionActivated);                       // 0x28B0   (0x0010)  
	SDK_UNDEFINED(16,12817) /* FMulticastInlineDelegate */ __um(OnKickflipSuctionDeactivated);                     // 0x28C0   (0x0010)  
	SDK_UNDEFINED(16,12818) /* FMulticastInlineDelegate */ __um(OnKickflipDistanceToSuctionSurfaceChanged);        // 0x28D0   (0x0010)  
	SDK_UNDEFINED(16,12819) /* FMulticastInlineDelegate */ __um(OnKickflipDurationChanged);                        // 0x28E0   (0x0010)  
	SDK_UNDEFINED(16,12820) /* FMulticastInlineDelegate */ __um(OnKickflipActivationChargesChanged);               // 0x28F0   (0x0010)  
	unsigned char                                      UnknownData20_5[0x88];                                      // 0x2900   (0x0088)  MISSED
	SDK_UNDEFINED(16,12821) /* FMulticastInlineDelegate */ __um(OnReattachmentActivated);                          // 0x2988   (0x0010)  
	SDK_UNDEFINED(16,12822) /* FMulticastInlineDelegate */ __um(OnReattachmentDeactivated);                        // 0x2998   (0x0010)  
	FVector                                            ForcedReattachmentDirection;                                // 0x29A8   (0x0018)  
	unsigned char                                      UnknownData21_5[0x28];                                      // 0x29C0   (0x0028)  MISSED
	SDK_UNDEFINED(16,12823) /* FMulticastInlineDelegate */ __um(OnUnderthrustActivated);                           // 0x29E8   (0x0010)  
	SDK_UNDEFINED(16,12824) /* FMulticastInlineDelegate */ __um(OnUnderthrustDeactivated);                         // 0x29F8   (0x0010)  
	SDK_UNDEFINED(16,12825) /* FMulticastInlineDelegate */ __um(OnUnderthrustPercentChanged);                      // 0x2A08   (0x0010)  
	unsigned char                                      UnknownData22_5[0x18];                                      // 0x2A18   (0x0018)  MISSED
	SDK_UNDEFINED(16,12826) /* FMulticastInlineDelegate */ __um(OnJumpActivated);                                  // 0x2A30   (0x0010)  
	SDK_UNDEFINED(16,12827) /* FMulticastInlineDelegate */ __um(OnJumpDeactivated);                                // 0x2A40   (0x0010)  
	...
	SDK_UNDEFINED(16,12828) /* FMulticastInlineDelegate */ __um(OnVehicleDemolished);                              // 0x2A60   (0x0010)  
	SDK_UNDEFINED(16,12829) /* FMulticastInlineDelegate */ __um(OnDemolishPressDurationUpdated);                   // 0x2A70   (0x0010)  
	unsigned char                                      UnknownData25_5[0x18];                                      // 0x2A80   (0x0018)  MISSED
	SDK_UNDEFINED(16,12830) /* FMulticastInlineDelegate */ __um(OnHazardHit);                                      // 0x2A98   (0x0010)  
	SDK_UNDEFINED(16,12831) /* FMulticastInlineDelegate */ __um(OnInvulnerabilityActivated);                       // 0x2AA8   (0x0010)  
	SDK_UNDEFINED(16,12832) /* FMulticastInlineDelegate */ __um(OnInvulnerabilityDeactivated);                     // 0x2AB8   (0x0010)  
	...
	SDK_UNDEFINED(16,12833) /* FMulticastInlineDelegate */ __um(OnDelMarVehicleSpawned);                           // 0x2AE0   (0x0010)  
	bool                                               bAllowExitingVehicle;                                       // 0x2AF0   (0x0001)  
	unsigned char                                      UnknownData27_5[0x7];                                       // 0x2AF1   (0x0007)  MISSED
	SDK_UNDEFINED(16,12834) /* FMulticastInlineDelegate */ __um(OnVehicleTeleportEntered);                         // 0x2AF8   (0x0010)  
	SDK_UNDEFINED(16,12835) /* FMulticastInlineDelegate */ __um(OnVehicleTeleportExit);                            // 0x2B08   (0x0010)  
	SDK_UNDEFINED(16,12836) /* FMulticastInlineDelegate */ __um(OnVehicleAppliedTeleportRotation);                 // 0x2B18   (0x0010)  
	SDK_UNDEFINED(16,12837) /* FMulticastInlineDelegate */ __um(OnAirFreestyleActivated);                          // 0x2B28   (0x0010)  
	SDK_UNDEFINED(16,12838) /* FMulticastInlineDelegate */ __um(OnAirFreestyleDeactivated);                        // 0x2B38   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(8,12839) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedVehicle);                              // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12840) /* TWeakObjectPtr<UAbilitySystemComponent*> */ __um(CachedASC);                         // 0x00A8   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(32,12841) /* TWeakObjectPtr<UAthenaAISettings*> */ __um(AISettings);                             // 0x0028   (0x0020)  
};
...
public:
	...
	SDK_UNDEFINED(16,12842) /* FMulticastInlineDelegate */ __um(OnBigAirStarted);                                  // 0x0350   (0x0010)  
	SDK_UNDEFINED(16,12843) /* FMulticastInlineDelegate */ __um(OnBigAirStopped);                                  // 0x0360   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,12844) /* FMulticastInlineDelegate */ __um(OnCheckpointTirggeredEvent);                       // 0x0BD8   (0x0010)  
	...
	SDK_UNDEFINED(80,12845) /* TSet<TWeakObjectPtr<ADelMarCheckpoint*>> */ __um(NextCheckpoints);                  // 0x0C08   (0x0050)  
	SDK_UNDEFINED(80,12846) /* TSet<TWeakObjectPtr<ADelMarCheckpoint*>> */ __um(PreviousCheckpoints);              // 0x0C58   (0x0050)  
	...
	SDK_UNDEFINED(8,12847) /* TWeakObjectPtr<ADelMarCheckpoint*> */ __um(CheckpointToTeleportTo);                  // 0x0CBC   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(16,12848) /* TArray<FString> */      __um(SafePlayerNames);                                      // 0x0028   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,12849) /* TMap<FGameplayTag, UNiagaraSystem*> */ __um(ParticleClassMap);                      // 0x00A8   (0x0050)  
	...
	SDK_UNDEFINED(80,12850) /* TMap<FGameplayTag, UNiagaraComponent*> */ __um(ParticleComponentMap);               // 0x0178   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(16,12851) /* FMulticastInlineDelegate */ __um(OnCurrentStateChanged);                            // 0x0290   (0x0010)  
	SDK_UNDEFINED(16,12852) /* FMulticastInlineDelegate */ __um(OnEnabledChanged);                                 // 0x02A0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,12853) /* TScriptInterface<Class> */ __um(Vehicle);                                           // 0x02A8   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,12854) /* TArray<TWeakObjectPtr<UClass*>> */ __um(CosmeticActorClasses);                      // 0x03C0   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(16,12855) /* FString */              __um(VariableName);                                         // 0x0340   (0x0010)  
	SDK_UNDEFINED(16,12856) /* FString */              __um(Value);                                                // 0x0350   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(80,12857) /* TMap<UPhysicalMaterial*, FPhysicalMaterialAttributes_X> */ __um(MaterialAttributesMap); // 0x0030   (0x0050)  
};
...
{ 
public:
	SDK_UNDEFINED(8,12858) /* TWeakObjectPtr<UDelMarVehicleManager*> */ __um(VehicleManager);                      // 0x00A0   (0x0008)  
};
...
public:
	...
	SDK_UNDEFINED(8,12859) /* TWeakObjectPtr<UEnhancedInputComponent*> */ __um(InputComponent);                    // 0x00D8   (0x0008)  
	SDK_UNDEFINED(8,12860) /* TWeakObjectPtr<UFortClientSettingsRecord*> */ __um(FortSettings);                    // 0x00E0   (0x0008)  
...
{ 
	SDK_UNDEFINED(24,12861) /* FText */                __um(KBMText);                                              // 0x0000   (0x0018)  
	SDK_UNDEFINED(24,12862) /* FText */                __um(GamepadText);                                          // 0x0018   (0x0018)  
	SDK_UNDEFINED(24,12863) /* FText */                __um(TouchText);                                            // 0x0030   (0x0018)  
...
public:
	...
	SDK_UNDEFINED(80,12864) /* TMap<FGameplayTag, FDelMarEvent_SetTutorialHint> */ __um(DemolishedByHints);        // 0x0100   (0x0050)  
	FDelMarEvent_SetTutorialHint                       SlowerTerrainHint;                                          // 0x0150   (0x0060)  
	SDK_UNDEFINED(8,12865) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(Vehicle);                                    // 0x01B0   (0x0008)  
	SDK_UNDEFINED(8,12866) /* TWeakObjectPtr<APlayerController*> */ __um(CachedPlayerController);                  // 0x01B8   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(8,12867) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12868) /* TWeakObjectPtr<UDelMarCheckpointManagerComponent*> */ __um(CachedCheckpointManager); // 0x00A8   (0x0008)  
	SDK_UNDEFINED(8,12869) /* TWeakObjectPtr<AFortPlayerState*> */ __um(ViewTargetPlayerState);                    // 0x00B0   (0x0008)  
	SDK_UNDEFINED(80,12870) /* TSet<TWeakObjectPtr<ADelMarCheckpoint*>> */ __um(CurrentlyActiveCheckpoints);       // 0x00B8   (0x0050)  
...
public:
	unsigned char                                      UnknownData00_2[0x18];                                      // 0x00A0   (0x0018)  MISSED
	SDK_UNDEFINED(80,12871) /* TSet<int32_t> */        __um(VisitedCheckpoints);                                   // 0x00B8   (0x0050)  
	SDK_UNDEFINED(80,12872) /* TSet<TWeakObjectPtr<ADelMarCheckpoint*>> */ __um(VisitedCheckpoints_ParallelPath);  // 0x0108   (0x0050)  
	...
	SDK_UNDEFINED(8,12873) /* TWeakObjectPtr<ADelMarCheckpoint*> */ __um(MostRecentlyVisitedCheckpoint);           // 0x01A0   (0x0008)  
	SDK_UNDEFINED(8,12874) /* TWeakObjectPtr<UDelMarCheckpointManagerComponent*> */ __um(CachedCheckpointManager); // 0x01A8   (0x0008)  
	SDK_UNDEFINED(8,12875) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x01B0   (0x0008)  
	SDK_UNDEFINED(8,12876) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedDelMarVehicle);                        // 0x01B8   (0x0008)  
	SDK_UNDEFINED(8,12877) /* TWeakObjectPtr<UDelMarPositionalTrackerComponent*> */ __um(CachedPositionalTracker); // 0x01C0   (0x0008)  
	SDK_UNDEFINED(8,12878) /* TWeakObjectPtr<UDelMarTrackPositionComponent*> */ __um(CachedLapTracker);            // 0x01C8   (0x0008)  
	SDK_UNDEFINED(80,12879) /* TSet<TWeakObjectPtr<ADelMarCheckpoint*>> */ __um(CheckpointsVisitedThisLap);        // 0x01D0   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(80,12880) /* TMap<FGameplayTag, FDelMarInputMappingContextData> */ __um(InputMappingContextMap); // 0x00A0   (0x0050)  
	SDK_UNDEFINED(8,12881) /* TWeakObjectPtr<AFortPlayerController*> */ __um(CachedController);                    // 0x00F0   (0x0008)  
	SDK_UNDEFINED(8,12882) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedVehicle);                              // 0x00F8   (0x0008)  
	SDK_UNDEFINED(8,12883) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x0100   (0x0008)  
};
...
{ 
public:
	SDK_UNDEFINED(16,12884) /* FMulticastInlineDelegate */ __um(OnUseToggleOnExpandableHudWidgetChanged);          // 0x00A0   (0x0010)  
	SDK_UNDEFINED(16,12885) /* FMulticastInlineDelegate */ __um(OnUseIconOnlyPlayerNameplatesChanged);             // 0x00B0   (0x0010)  
	...
	SDK_UNDEFINED(8,12886) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedDelMarVehicle);                        // 0x00C8   (0x0008)  
	SDK_UNDEFINED(8,12887) /* TWeakObjectPtr<UFortClientSettingsRecord*> */ __um(FortSettings);                    // 0x00D0   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12888) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(RaceManager);                            // 0x00F8   (0x0008)  
	SDK_UNDEFINED(8,12889) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(DelMarVehicle);                              // 0x0100   (0x0008)  
	SDK_UNDEFINED(8,12890) /* TWeakObjectPtr<UDelMarCheckpointManagerComponent*> */ __um(CheckpointManager);       // 0x0108   (0x0008)  
	SDK_UNDEFINED(8,12891) /* TWeakObjectPtr<UDelMarPlayerRaceDataComponent*> */ __um(PlayerRaceData);             // 0x0110   (0x0008)  
	SDK_UNDEFINED(8,12892) /* TWeakObjectPtr<UDelMarRaceConfigComponent*> */ __um(RaceConfig);                     // 0x0118   (0x0008)  
	SDK_UNDEFINED(8,12893) /* TWeakObjectPtr<ADelMarTrack*> */ __um(LastActiveTrack);                              // 0x0120   (0x0008)  
	SDK_UNDEFINED(8,12894) /* TWeakObjectPtr<UDelMarTrackPositionComponent*> */ __um(TrackPosition);               // 0x0128   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12895) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(DelMarVehicle);                              // 0x00A4   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12896) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedDelMarVehicle);                        // 0x00B4   (0x0008)  
	SDK_UNDEFINED(8,12897) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00BC   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12898) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x010C   (0x0008)  
	SDK_UNDEFINED(8,12899) /* TWeakObjectPtr<UDelMarRespawnManagerComponent*> */ __um(CachedRespawnManager);       // 0x0114   (0x0008)  
	SDK_UNDEFINED(8,12900) /* TWeakObjectPtr<AFortPlayerState*> */ __um(PlayerState);                              // 0x011C   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12901) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(RaceManager);                            // 0x0108   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(8,12902) /* TWeakObjectPtr<AFortPlayerState*> */ __um(PlayerState);                              // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12903) /* TWeakObjectPtr<ADelMarTutorialRaceManager*> */ __um(TutorialRaceManager);            // 0x00A8   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12904) /* TWeakObjectPtr<UDelMarLevelDataAsset*> */ __um(CurrentLevelData);                    // 0x00D0   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12905) /* TWeakObjectPtr<UFortPlaylistAthena*> */ __um(MRSPlaylistData);                       // 0x0708   (0x0008)  
	...
	SDK_UNDEFINED(8,12906) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(ActiveRaceManager);                      // 0x071C   (0x0008)  
	SDK_UNDEFINED(8,12907) /* TWeakObjectPtr<UFortPlaylistAthena*> */ __um(PlaylistData);                          // 0x0724   (0x0008)  
	SDK_UNDEFINED(8,12908) /* TWeakObjectPtr<UDelMarLevelManagerComponent*> */ __um(LevelManager);                 // 0x072C   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12909) /* TWeakObjectPtr<UDelMarPlayerInputManagerComponent*> */ __um(InputManager);           // 0x00E0   (0x0008)  
	SDK_UNDEFINED(8,12910) /* TWeakObjectPtr<UEnhancedInputComponent*> */ __um(InputComponent);                    // 0x00E8   (0x0008)  
	SDK_UNDEFINED(8,12911) /* TWeakObjectPtr<UDelMarPositionalTrackerComponent*> */ __um(PositionTracker);         // 0x00F0   (0x0008)  
	SDK_UNDEFINED(8,12912) /* TWeakObjectPtr<AFortPlayerState*> */ __um(CurrentViewTarget);                        // 0x00F8   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12913) /* TWeakObjectPtr<ADelMarCheckpoint*> */ __um(StartingLineCheckpoint);                  // 0x00A4   (0x0008)  
	SDK_UNDEFINED(8,12914) /* TWeakObjectPtr<ADelMarCheckpoint*> */ __um(FinishLineCheckpoint);                    // 0x00AC   (0x0008)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x00B4   (0x0004)  MISSED
	SDK_UNDEFINED(80,12915) /* TSet<TWeakObjectPtr<ADelMarCheckpoint*>> */ __um(LevelCheckpoints);                 // 0x00B8   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(80,12916) /* TSet<AFortPlayerState*> */ __um(PlayersGivenMMR);                                   // 0x00A0   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(8,12917) /* TWeakObjectPtr<AFortPlayerState*> */ __um(PlayerState);                              // 0x0000   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(80,12918) /* TMap<AFortPlayerState*, FDelMarPositionValue> */ __um(SplinePositions);             // 0x00D8   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(32,12919) /* TWeakObjectPtr<UClass*> */ __um(DefaultVehicleClass);                               // 0x00C0   (0x0020)  
...
{ 
	SDK_UNDEFINED(16,12920) /* TArray<TWeakObjectPtr<AFortPlayerState*>> */ __um(ReadyPlayers);                    // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,12921) /* TArray<TWeakObjectPtr<AFortPlayerState*>> */ __um(UnreadyPlayers);                  // 0x0010   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(8,12922) /* TWeakObjectPtr<UDelMarCheckpointManagerComponent*> */ __um(CachedCheckpointManager); // 0x00B8   (0x0008)  
	SDK_UNDEFINED(8,12923) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x00C0   (0x0008)  
	SDK_UNDEFINED(8,12924) /* TWeakObjectPtr<ADelMarPlayerStart*> */ __um(CachedChallengeStartSpawnPoint);         // 0x00C8   (0x0008)  
	SDK_UNDEFINED(16,12925) /* TArray<TWeakObjectPtr<AController*>> */ __um(RespawnRetryQueue);                    // 0x00D0   (0x0010)  
	SDK_UNDEFINED(80,12926) /* TMap<TWeakObjectPtr<AFortPlayerState*>, TWeakObjectPtr<ADelMarVehicle*>> */ __um(LastSpawnedVehicleMap); // 0x00E0   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(80,12927) /* TSet<TWeakObjectPtr<AFortPlayerState*>> */ __um(ReadyPlayers);                      // 0x0040   (0x0050)  
	SDK_UNDEFINED(8,12928) /* TWeakObjectPtr<ADelMarPlayspace*> */ __um(CachedPlayspace);                          // 0x0090   (0x0008)  
	SDK_UNDEFINED(8,12929) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(CachedRaceManager);                      // 0x0098   (0x0008)  
	unsigned char                                      UnknownData01_5[0x30];                                      // 0x00A0   (0x0030)  MISSED
	SDK_UNDEFINED(16,12930) /* FString */              __um(EliminationList);                                      // 0x00D0   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(8,12931) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(RaceManager);                            // 0x0030   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12932) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(RaceManager);                            // 0x0034   (0x0008)  
	FDelMarEvent_LoadedPlayerStates                    LoadedPlayerStates;                                         // 0x003C   (0x0008)  
	SDK_UNDEFINED(8,12933) /* TWeakObjectPtr<AFortPartyBeaconHost*> */ __um(FortPartyBeacon);                      // 0x0044   (0x0008)  
...
{ 
	...
	SDK_UNDEFINED(8,12934) /* TWeakObjectPtr<UCameraShakeBase*> */ __um(CameraShakeInstance);                      // 0x0008   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(80,12935) /* TMap<EBrelmarCameraShake, float> */ __um(ShakeIntensitySettingMap);                 // 0x00A0   (0x0050)  
	...
	SDK_UNDEFINED(16,12936) /* TScriptInterface<Class> */ __um(Vehicle);                                           // 0x0550   (0x0010)  
	SDK_UNDEFINED(8,12937) /* TWeakObjectPtr<AFortPlayerController*> */ __um(CachedPlayerController);              // 0x0560   (0x0008)  
...
{ 
	...
	SDK_UNDEFINED(1,12938) /* TEnumAsByte<ECollisionChannel> */ __um(TrackTraceChannel);                           // 0x0208   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(1,12939) /* TEnumAsByte<ECollisionChannel> */ __um(LandingCollisionChannel);                     // 0x0089   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(1,12940) /* TEnumAsByte<ECollisionChannel> */ __um(LineOfSightChannel);                          // 0x0010   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x0011   (0x0003)  MISSED
...
{ 
	...
	SDK_UNDEFINED(1,12941) /* TEnumAsByte<ECollisionChannel> */ __um(SuctionChannel);                              // 0x013C   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(1,12942) /* TEnumAsByte<ECollisionChannel> */ __um(ReattachmentChannel);                         // 0x0098   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(1,12943) /* TEnumAsByte<EDelMarFloatOperation> */ __um(Operation);                               // 0x000C   (0x0001)  
	SDK_UNDEFINED(1,12944) /* TEnumAsByte<EDelMarModifierStackingPolicy> */ __um(StackingPolicy);                  // 0x000D   (0x0001)  
...
{ 
public:
	SDK_UNDEFINED(16,12945) /* FMulticastInlineDelegate */ __um(OnCosmeticActorSpawned);                           // 0x00A0   (0x0010)  
	SDK_UNDEFINED(16,12946) /* FMulticastInlineDelegate */ __um(OnAllCosmeticActorsSpawned);                       // 0x00B0   (0x0010)  
	SDK_UNDEFINED(16,12947) /* TArray<TWeakObjectPtr<UClass*>> */ __um(StaticCosmeticActorClasses);                // 0x00C0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,12948) /* TScriptInterface<Class> */ __um(Vehicle);                                           // 0x03D0   (0x0010)  
	SDK_UNDEFINED(8,12949) /* TWeakObjectPtr<APlayerController*> */ __um(CachedPlayerController);                  // 0x03E0   (0x0008)  
	SDK_UNDEFINED(8,12950) /* TWeakObjectPtr<UForceFeedbackEffect*> */ __um(CurrentOversteerForceFeedbackEffect);  // 0x03E8   (0x0008)  
...
{ 
	SDK_UNDEFINED(32,12951) /* TWeakObjectPtr<UCosmeticLoadoutSlotTemplate*> */ __um(SlotTemplate);                // 0x0000   (0x0020)  
	SDK_UNDEFINED(32,12952) /* TWeakObjectPtr<UObject*> */ __um(EquippedItemDefinitionObject);                     // 0x0020   (0x0020)  
};
...
{ 
	SDK_UNDEFINED(32,12953) /* TWeakObjectPtr<UObject*> */ __um(EquippedItemDefinitionObject);                     // 0x0008   (0x0020)  
...
{ 
	SDK_UNDEFINED(80,12954) /* TMap<TWeakObjectPtr<AActor*>, UDriveHazardInfo*> */ __um(DriveHazardInfoMap);       // 0x0000   (0x0050)  
...
{ 
	SDK_UNDEFINED(8,12955) /* TWeakObjectPtr<ADelMarCheckpoint*> */ __um(CurrentCheckPoint);                       // 0x0000   (0x0008)  
...
{ 
	SDK_UNDEFINED(8,12956) /* TWeakObjectPtr<ADelMarCheckpoint*> */ __um(CurrentCheckPoint);                       // 0x0000   (0x0008)  
};
...
{ 
	SDK_UNDEFINED(8,12957) /* TWeakObjectPtr<ADelMarCheckpoint*> */ __um(CheckpointEntered);                       // 0x0000   (0x0008)  
...
{ 
	SDK_UNDEFINED(8,12958) /* TWeakObjectPtr<ADelMarCheckpoint*> */ __um(CheckpointExited);                        // 0x0000   (0x0008)  
};
...
{ 
	...
	SDK_UNDEFINED(8,12959) /* TWeakObjectPtr<ADelMarCheckpoint*> */ __um(CompletedCheckpoint);                     // 0x0008   (0x0008)  
	SDK_UNDEFINED(8,12960) /* TWeakObjectPtr<ADelMarCheckpoint*> */ __um(CurrentCheckPoint);                       // 0x0010   (0x0008)  
...
{ 
	SDK_UNDEFINED(8,12961) /* TWeakObjectPtr<AFortPlayerState*> */ __um(Player);                                   // 0x0000   (0x0008)  
...
{ 
	...
	SDK_UNDEFINED(16,12962) /* TArray<TWeakObjectPtr<UDelMarCosmeticItemDefinition*>> */ __um(RequiredCosmetics);  // 0x0180   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(24,12963) /* FText */                __um(KBMText);                                              // 0x0000   (0x0018)  
	SDK_UNDEFINED(24,12964) /* FText */                __um(GamepadText);                                          // 0x0018   (0x0018)  
	SDK_UNDEFINED(24,12965) /* FText */                __um(TouchText);                                            // 0x0030   (0x0018)  
};
...
{ 
	SDK_UNDEFINED(16,12966) /* FString */              __um(RankType);                                             // 0x0000   (0x0010)  
