...
public:
	...
	// void OnPlayerControllerEndPlay(class AActor* Actor, TEnumAsByte<EEndPlayReason> EndPlayReason);                       // [0xa6fb1b4] Final|Native|Protected 
};
...
{ 
public:
	unsigned char                                      UnknownData00_2[0xD20];                                     // 0x00C0   (0x0D20)  MISSED
...
{ 
	unsigned char                                      UnknownData00_1[0x201F];                                    // 0x0001   (0x201F)  MISSED
};
...
{ 
	unsigned char                                      UnknownData00_1[0x2F];                                      // 0x0001   (0x002F)  MISSED
};
