...
{ 
public:
	unsigned char                                      UnknownData00_2[0x7E8];                                     // 0x00C0   (0x07E8)  MISSED
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x2A0];                                     // 0x00C0   (0x02A0)  MISSED
...
{ 
public:
	unsigned char                                      UnknownData00_2[0xA88];                                     // 0x00C0   (0x0A88)  MISSED
...
{ 
	SDK_UNDEFINED(1,14263) /* TEnumAsByte<EMassLOD> */ __um(LOD);                                                  // 0x0000   (0x0001)  
	SDK_UNDEFINED(1,14264) /* TEnumAsByte<EMassLOD> */ __um(PrevLOD);                                              // 0x0001   (0x0001)  
...
{ 
	unsigned char                                      UnknownData00_2[0x201F];                                    // 0x0001   (0x201F)  MISSED
...
{ 
	unsigned char                                      UnknownData00_2[0x2017];                                    // 0x0001   (0x2017)  MISSED
