...
public:
	...
	// bool IsRequirementMetInternal(FControllerRequirementTestContext& RequestContext);                                     // [0x2177018] Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent|Const 
};
