...
public:
	...
	// void GetCachedAchievementProgress(class UObject* WorldContextObject, class APlayerController* PlayerController, FName AchievementID, bool& bFoundID, float& Progress); // [0x6a589b8] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.AchievementBlueprintLibrary.GetCachedAchievementDescription
	// void GetCachedAchievementDescription(class UObject* WorldContextObject, class APlayerController* PlayerController, FName AchievementID, bool& bFoundID, FText& Title, FText& LockedDescription, FText& UnlockedDescription, bool& bHidden); // [0x6a586ec] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,2506) /* FMulticastInlineDelegate */ __um(OnSuccess);                                         // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,2507) /* FMulticastInlineDelegate */ __um(OnFailure);                                         // 0x0040   (0x0010)  
	...
	// class UAchievementQueryCallbackProxy* CacheAchievements(class UObject* WorldContextObject, class APlayerController* PlayerController); // [0x6a54828] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.AchievementQueryCallbackProxy.CacheAchievementDescriptions
	// class UAchievementQueryCallbackProxy* CacheAchievementDescriptions(class UObject* WorldContextObject, class APlayerController* PlayerController); // [0x6a546cc] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class UAchievementWriteCallbackProxy* WriteAchievementProgress(class UObject* WorldContextObject, class APlayerController* PlayerController, FName AchievementName, float Progress, int32_t UserTag); // [0x6a591cc] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class UConnectionCallbackProxy* ConnectToService(class UObject* WorldContextObject, class APlayerController* PlayerController); // [0x6a54984] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class UCreateSessionCallbackProxy* CreateSession(class UObject* WorldContextObject, class APlayerController* PlayerController, int32_t PublicConnections, bool bUseLAN); // [0x6a5703c] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class UDestroySessionCallbackProxy* DestroySession(class UObject* WorldContextObject, class APlayerController* PlayerController); // [0x6a57220] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class UEndTurnCallbackProxy* EndTurn(class UObject* WorldContextObject, class APlayerController* PlayerController, FString MatchID, TScriptInterface<Class> TurnBasedMatchInterface); // [0x6a577d8] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// FString GetServerName(FBlueprintSessionResult& Result);                                                               // [0x6a58d98] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/OnlineSubsystemUtils.FindSessionsCallbackProxy.GetPingInMs
	// int32_t GetPingInMs(FBlueprintSessionResult& Result);                                                                 // [0x6a58cd4] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/OnlineSubsystemUtils.FindSessionsCallbackProxy.GetMaxPlayers
	// int32_t GetMaxPlayers(FBlueprintSessionResult& Result);                                                               // [0x6a58c10] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/OnlineSubsystemUtils.FindSessionsCallbackProxy.GetCurrentPlayers
	// int32_t GetCurrentPlayers(FBlueprintSessionResult& Result);                                                           // [0x6a58b48] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/OnlineSubsystemUtils.FindSessionsCallbackProxy.FindSessions
	// class UFindSessionsCallbackProxy* FindSessions(class UObject* WorldContextObject, class APlayerController* PlayerController, int32_t MaxResults, bool bUseLAN); // [0x6a57ff4] Final|Native|Static|Public|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,2524) /* FMulticastInlineDelegate */ __um(OnSuccess);                                         // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,2525) /* FMulticastInlineDelegate */ __um(OnFailure);                                         // 0x0038   (0x0010)  
	...
	// class UInAppPurchaseCallbackProxy2* CreateProxyObjectForInAppPurchaseUnprocessedPurchases(class APlayerController* PlayerController); // [0x6a56cb4] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.InAppPurchaseCallbackProxy2.CreateProxyObjectForInAppPurchaseQueryOwned
	// class UInAppPurchaseCallbackProxy2* CreateProxyObjectForInAppPurchaseQueryOwned(class APlayerController* PlayerController); // [0x6a56778] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.InAppPurchaseCallbackProxy2.CreateProxyObjectForInAppPurchase
	// class UInAppPurchaseCallbackProxy2* CreateProxyObjectForInAppPurchase(class APlayerController* PlayerController, FInAppPurchaseProductRequest2& ProductRequest); // [0x6a54cec] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// class UInAppPurchaseCheckoutCallbackProxy* CreateProxyObjectForInAppPurchaseCheckout(class APlayerController* PlayerController, FInAppPurchaseProductRequest2& ProductRequest); // [0x6a553ec] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// class UInAppPurchaseFinalizeProxy* CreateProxyObjectForInAppPurchaseFinalize(FInAppPurchaseReceiptInfo2& InAppPurchaseReceipt, class APlayerController* PlayerController); // [0x6a55aec] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// class UInAppPurchaseQueryCallbackProxy2* CreateProxyObjectForInAppPurchaseQuery(class APlayerController* PlayerController, TArray<FString>& ProductIdentifiers); // [0x6a564c0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// class UInAppPurchaseReceiptsCallbackProxy* CreateProxyObjectForInAppPurchaseRestoreOwnedProducts(class APlayerController* PlayerController); // [0x6a56c10] Final|Native|Static|Public|BlueprintCallable 
	...
	// class UInAppPurchaseReceiptsCallbackProxy* CreateProxyObjectForInAppPurchaseQueryOwnedProducts(class APlayerController* PlayerController); // [0x6a569ec] Final|Native|Static|Public|BlueprintCallable 
	...
	// class UInAppPurchaseReceiptsCallbackProxy* CreateProxyObjectForInAppPurchaseGetKnownReceipts(class APlayerController* PlayerController); // [0x6a562d0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class UInAppPurchaseRestoreCallbackProxy2* CreateProxyObjectForInAppPurchaseRestore(TArray<FInAppPurchaseProductRequest2>& ConsumableProductFlags, class APlayerController* PlayerController); // [0x6a56a90] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x74];                                      // 0x1E00   (0x0074)  MISSED
...
{ 
public:
	SDK_UNDEFINED(16,2534) /* FMulticastInlineDelegate */ __um(OnSuccess);                                         // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,2535) /* FMulticastInlineDelegate */ __um(OnFailure);                                         // 0x0040   (0x0010)  
	...
	// class UJoinSessionCallbackProxy* JoinSession(class UObject* WorldContextObject, class APlayerController* PlayerController, FBlueprintSessionResult& SearchResult); // [0x6a58e78] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// bool WriteLeaderboardInteger(class APlayerController* PlayerController, FName StatName, int32_t StatValue);           // [0x6a59348] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class ULeaderboardFlushCallbackProxy* CreateProxyObjectForFlush(class APlayerController* PlayerController, FName SessionName); // [0x6a54adc] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class ULeaderboardQueryCallbackProxy* CreateProxyObjectForIntQuery(class APlayerController* PlayerController, FName StatName); // [0x6a56f5c] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class ULogoutCallbackProxy* Logout(class UObject* WorldContextObject, class APlayerController* PlayerController);     // [0x6a59074] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void ClientOnConnected();                                                                                             // [0x1b77684] Final|Net|NetReliableNative|Event|Private|NetClient 
};
...
{ 
public:
	SDK_UNDEFINED(16,2542) /* FString */               __um(BeaconTypeName);                                       // 0x0290   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(80,2543) /* TMap<FName, FName> */    __um(MappedUniqueNetIdTypes);                               // 0x0028   (0x0050)  
...
{ 
	SDK_UNDEFINED(16,2544) /* FString */               __um(ID);                                                   // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2545) /* FString */               __um(Token);                                                // 0x0010   (0x0010)  
	SDK_UNDEFINED(16,2546) /* FString */               __um(Type);                                                 // 0x0020   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,2547) /* FString */               __um(ValidationStr);                                        // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,2548) /* FString */               __um(Platform);                                             // 0x0040   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,2549) /* FString */               __um(DestSessionId);                                        // 0x0350   (0x0010)  
	...
	// void ServerUpdateReservationRequest(FString SessionId, FPartyReservation ReservationUpdate);                          // [0x6a7a3a0] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ServerReservationRequest
	// void ServerReservationRequest(FString SessionId, FPartyReservation Reservation);                                      // [0x6a79fc4] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ServerRemoveMemberFromReservationRequest
	// void ServerRemoveMemberFromReservationRequest(FString SessionId, FPartyReservation ReservationUpdate);                // [0x6a79dc4] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ServerCancelReservationRequest
	// void ServerCancelReservationRequest(FUniqueNetIdRepl PartyLeader);                                                    // [0x6a79be0] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ServerAddOrUpdateReservationRequest
	// void ServerAddOrUpdateReservationRequest(FString SessionId, FPartyReservation Reservation);                           // [0x6a799e0] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ClientSendReservationUpdates
	// void ClientSendReservationUpdates(int32_t NumRemainingReservations);                                                  // [0x6a779c4] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ClientSendReservationFull
	// void ClientSendReservationFull();                                                                                     // [0x6a779ac] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ClientReservationResponse
	// void ClientReservationResponse(TEnumAsByte<EPartyReservationResult> ReservationResponse);                             // [0x6a778a4] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ClientCancelReservationResponse
	// void ClientCancelReservationResponse(TEnumAsByte<EPartyReservationResult> ReservationResponse);                       // [0x6a7779c] Net|NetReliableNative|Event|Public|NetClient 
};
...
{ 
	SDK_UNDEFINED(16,2550) /* FString */               __um(PlatformName);                                         // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2551) /* FString */               __um(PlatformType);                                         // 0x0010   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(16,2552) /* TArray<FString> */       __um(PlatformCrossplayRestrictions);                        // 0x0050   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,2553) /* FMulticastInlineDelegate */ __um(OnSuccess);                                         // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,2554) /* FMulticastInlineDelegate */ __um(OnFailure);                                         // 0x0040   (0x0010)  
	unsigned char                                      UnknownData00_6[0x28];                                      // 0x0050   (0x0028)  MISSED


	/// Functions
	// Function /Script/OnlineSubsystemUtils.QuitMatchCallbackProxy.QuitMatch
	// class UQuitMatchCallbackProxy* QuitMatch(class UObject* WorldContextObject, class APlayerController* PlayerController, FString MatchID, TEnumAsByte<EMPMatchOutcome> Outcome, int32_t TurnTimeoutInSeconds); // [0x6a79154] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class UShowLoginUICallbackProxy* ShowExternalLoginUI(class UObject* WorldContextObject, class APlayerController* InPlayerController); // [0x6a7a5a0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	unsigned char                                      UnknownData00_2[0x30];                                      // 0x0320   (0x0030)  MISSED
	SDK_UNDEFINED(16,2557) /* FString */               __um(DestSessionId);                                        // 0x0350   (0x0010)  
	...
	// void ServerReservationRequest(FString SessionId, FSpectatorReservation Reservation);                                  // [0x6a7a1c4] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ServerCancelReservationRequest
	// void ServerCancelReservationRequest(FUniqueNetIdRepl Spectator);                                                      // [0x6a79be0] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ClientSendReservationUpdates
	// void ClientSendReservationUpdates(int32_t NumRemainingReservations);                                                  // [0x6a77a48] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ClientSendReservationFull
	// void ClientSendReservationFull();                                                                                     // [0x2ef140c] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ClientReservationResponse
	// void ClientReservationResponse(TEnumAsByte<ESpectatorReservationResult> ReservationResponse);                         // [0x6a77928] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ClientCancelReservationResponse
	// void ClientCancelReservationResponse(TEnumAsByte<ESpectatorReservationResult> ReservationResponse);                   // [0x6a77820] Net|NetReliableNative|Event|Public|NetClient 
};
...
public:
	...
	// void ServerPong();                                                                                                    // [0x6a79d78] Net|NetReliableNative|Event|Public|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.TestBeaconClient.ClientPing
	// void ClientPing();                                                                                                    // [0x20abc64] Net|NetReliableNative|Event|Public|NetClient 
};
...
public:
	...
	// void RegisterTurnBasedMatchInterfaceObject(class UObject* WorldContextObject, class APlayerController* PlayerController, class UObject* Object); // [0x6a798e8] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.TurnBasedBlueprintLibrary.GetPlayerDisplayName
	// void GetPlayerDisplayName(class UObject* WorldContextObject, class APlayerController* PlayerController, FString MatchID, int32_t PlayerIndex, FString& PlayerDisplayName); // [0x6a7899c] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.TurnBasedBlueprintLibrary.GetMyPlayerIndex
	// void GetMyPlayerIndex(class UObject* WorldContextObject, class APlayerController* PlayerController, FString MatchID, int32_t& PlayerIndex); // [0x6a78234] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.TurnBasedBlueprintLibrary.GetIsMyTurn
	// void GetIsMyTurn(class UObject* WorldContextObject, class APlayerController* PlayerController, FString MatchID, bool& bIsMyTurn); // [0x6a77acc] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
{ 
public:
	unsigned char                                      UnknownData00_1[0x60];                                      // 0x08F0   (0x0060)  MISSED


	/// Functions
	// Function /Script/OnlineSubsystemUtils.VoipListenerSynthComponent.IsIdling
	// bool IsIdling();                                                                                                      // [0x6a7bc04] Final|Native|Public|BlueprintCallable 
};
...
{ 
	SDK_UNDEFINED(16,2558) /* FString */               __um(OfferId);                                              // 0x0000   (0x0010)  
	SDK_UNDEFINED(24,2559) /* FText */                 __um(Title);                                                // 0x0010   (0x0018)  
	SDK_UNDEFINED(24,2560) /* FText */                 __um(Description);                                          // 0x0028   (0x0018)  
	SDK_UNDEFINED(24,2561) /* FText */                 __um(LongDescription);                                      // 0x0040   (0x0018)  
	SDK_UNDEFINED(24,2562) /* FText */                 __um(RegularPriceText);                                     // 0x0058   (0x0018)  
	int32_t                                            RegularPrice;                                               // 0x0070   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0074   (0x0004)  MISSED
	SDK_UNDEFINED(24,2563) /* FText */                 __um(PriceText);                                            // 0x0078   (0x0018)  
	int32_t                                            NumericPrice;                                               // 0x0090   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x0094   (0x0004)  MISSED
	SDK_UNDEFINED(16,2564) /* FString */               __um(CurrencyCode);                                         // 0x0098   (0x0010)  
	...
	SDK_UNDEFINED(80,2565) /* TMap<FString, FString> */ __um(DynamicFields);                                       // 0x00C0   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(16,2566) /* FString */               __um(ItemName);                                             // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2567) /* FString */               __um(ItemId);                                               // 0x0010   (0x0010)  
	SDK_UNDEFINED(16,2568) /* FString */               __um(ValidationInfo);                                       // 0x0020   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2569) /* FString */               __um(ItemName);                                             // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2570) /* FString */               __um(ItemId);                                               // 0x0010   (0x0010)  
	SDK_UNDEFINED(16,2571) /* FString */               __um(ValidationInfo);                                       // 0x0020   (0x0010)  
	SDK_UNDEFINED(16,2572) /* FString */               __um(TransactionIdentifier);                                // 0x0030   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2573) /* FString */               __um(ProductIdentifier);                                    // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2574) /* FString */               __um(Identifier);                                           // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2575) /* FString */               __um(TransactionIdentifier);                                // 0x0010   (0x0010)  
	SDK_UNDEFINED(16,2576) /* FString */               __um(DisplayName);                                          // 0x0020   (0x0010)  
	SDK_UNDEFINED(16,2577) /* FString */               __um(DisplayDescription);                                   // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,2578) /* FString */               __um(DisplayPrice);                                         // 0x0040   (0x0010)  
	float                                              RawPrice;                                                   // 0x0050   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0054   (0x0004)  MISSED
	SDK_UNDEFINED(16,2579) /* FString */               __um(CurrencyCode);                                         // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,2580) /* FString */               __um(CurrencySymbol);                                       // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,2581) /* FString */               __um(DecimalSeparator);                                     // 0x0078   (0x0010)  
	SDK_UNDEFINED(16,2582) /* FString */               __um(GroupingSeparator);                                    // 0x0088   (0x0010)  
	SDK_UNDEFINED(16,2583) /* FString */               __um(ReceiptData);                                          // 0x0098   (0x0010)  
	SDK_UNDEFINED(80,2584) /* TMap<FString, FString> */ __um(DynamicFields);                                       // 0x00A8   (0x0050)  
};
