...
{ 
	SDK_UNDEFINED(16,15375) /* FString */              __um(Label);                                                // 0x0000   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,15376) /* FString */              __um(Path);                                                 // 0x0000   (0x0010)  
};
...
struct FSCCUserInfo
{ 
	SDK_UNDEFINED(16,15377) /* FString */              __um(Name);                                                 // 0x0000   (0x0010)  
};
