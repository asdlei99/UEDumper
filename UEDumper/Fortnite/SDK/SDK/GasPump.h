...
public:
	...
	// void RemoveGasPump(class UB_GasPump_Valet_Component_C* Gas Pump);                                                     // [0x2177018] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Valet/GasPump/Valet_GasPumpIndicatorManagerV2.Valet_GasPumpIndicatorManagerV2_C.AddGasPump
	// void AddGasPump(class UB_GasPump_Valet_Component_C* Gas Pump);                                                        // [0x2177018] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void ExecuteUbergraph_B_GasPump_Valet_Component(int32_t EntryPoint);                                                  // [0x2177018] Final                
};
