...
public:
	...
	unsigned char                                      UnknownData08_4[0x7];                                       // 0x0101   (0x0007)  MISSED
	...
	unsigned char                                      UnknownData14_5[0x3];                                       // 0x0191   (0x0003)  MISSED
	int32_t                                            OverriddenLightMapRes;                                      // 0x0194   (0x0004)  
	ELightmapType                                      LightmapType;                                               // 0x0198   (0x0001)  
	unsigned char                                      UnknownData15_5[0x3];                                       // 0x0199   (0x0003)  MISSED
...
public:
	...
	// int32_t FoliageOverlappingSphereCount(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, FVector CenterPosition, float Radius); // [0x5fd80cc] Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Foliage.FoliageStatistics.FoliageOverlappingBoxTransforms
	// void FoliageOverlappingBoxTransforms(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, FBox Box, TArray<FTransform>& OutTransforms); // [0x5fd7e9c] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/Foliage.FoliageStatistics.FoliageOverlappingBoxCount
	// int32_t FoliageOverlappingBoxCount(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, FBox Box);       // [0x5fd7cd4] Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void CapsuleTouched(class UPrimitiveComponent* OverlappedComp, class AActor* Other, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& OverlapInfo); // [0x5fd7980] Final|Native|Protected|HasOutParms 
};
...
public:
	...
	// void Simulate(int32_t NumSteps);                                                                                      // [0x5fd8348] Final|RequiredAPI|Native|Public|BlueprintCallable 
};
