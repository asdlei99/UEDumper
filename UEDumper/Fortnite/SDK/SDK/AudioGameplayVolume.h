...
public:
	...
	// void SetPriority(int32_t InPriority);                                                                                 // [0x7ce9a7c] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetInteriorVolume(float Volume, float InterpolateTime);                                                          // [0x7ce99a8] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioGameplayVolume.AttenuationVolumeComponent.SetExteriorVolume
	// void SetExteriorVolume(float Volume, float InterpolateTime);                                                          // [0x7ce98d4] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetEnabled(bool bEnable);                                                                                        // [0x7ce983c] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioGameplayVolume.AudioGameplayVolume.OnRep_bEnabled
	// void OnRep_bEnabled();                                                                                                // [0x305e6b0] Native|Protected     
	// Function /Script/AudioGameplayVolume.AudioGameplayVolume.OnListenerExit
	// void OnListenerExit();                                                                                                // [0x32586a0] Native|Event|Public|BlueprintEvent 
	// Function /Script/AudioGameplayVolume.AudioGameplayVolume.OnListenerEnter
	// void OnListenerEnter();                                                                                               // [0x32586c8] Native|Event|Public|BlueprintEvent 
};
...
public:
	...
	// void SetInteriorLPF(float Volume, float InterpolateTime);                                                             // [0x7ce99a8] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioGameplayVolume.FilterVolumeComponent.SetExteriorLPF
	// void SetExteriorLPF(float Volume, float InterpolateTime);                                                             // [0x7ce98d4] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetReverbSettings(FReverbSettings& NewReverbSettings);                                                           // [0x7ce9b08] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void SetSubmixOverrideSettings(TArray<FAudioVolumeSubmixOverrideSettings>& NewSubmixOverrideSettings);                // [0x7ce9bb4] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void SetSubmixSendSettings(TArray<FAudioVolumeSubmixSendSettings>& NewSubmixSendSettings);                            // [0x7ce9c78] Final|Native|Public|HasOutParms|BlueprintCallable 
};
