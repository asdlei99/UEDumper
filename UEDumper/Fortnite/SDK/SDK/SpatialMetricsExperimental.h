...
{ 
public:
	unsigned char                                      UnknownData00_1[0x2D8];                                     // 0x0040   (0x02D8)  MISSED
};
...
{ 
public:
	unsigned char                                      UnknownData00_1[0x2D0];                                     // 0x0040   (0x02D0)  MISSED
};
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x2D8];                                     // 0x0040   (0x02D8)  MISSED
	EIoDispatcherChunkTypeFlags                        ChunkTypeFlags;                                             // 0x0318   (0x0004)  
...
public:
	unsigned char                                      UnknownData00_2[0x2D8];                                     // 0x0040   (0x02D8)  MISSED
	EResourceSizeMemoryCategory                        MemoryCategoryFlags;                                        // 0x0318   (0x0001)  
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x358];                                     // 0x0040   (0x0358)  MISSED
	EIoDispatcherChunkTypeFlags                        ChunkTypeFlags;                                             // 0x0398   (0x0004)  
