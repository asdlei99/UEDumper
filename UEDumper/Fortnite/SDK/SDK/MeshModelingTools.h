...
public:
	...
	unsigned char                                      UnknownData02_6[0xA8];                                      // 0x0078   (0x00A8)  MISSED
};
...
public:
	...
	SDK_UNDEFINED(16,14672) /* FString */              __um(AssetName);                                            // 0x00F0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,14673) /* FString */              __um(OutputNewName);                                        // 0x00B0   (0x0010)  
	SDK_UNDEFINED(16,14674) /* FString */              __um(OutputExistingName);                                   // 0x00C0   (0x0010)  
};
...
public:
	...
	unsigned char                                      UnknownData01_6[0x240];                                     // 0x0140   (0x0240)  MISSED
};
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x98];                                      // 0x00A0   (0x0098)  MISSED
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x20];                                      // 0x0128   (0x0020)  MISSED
	...
	class UEditMeshPolygonsToolCancelAction*           CancelAction;                                               // 0x0180   (0x0008)  
	class UEditMeshPolygonsToolAcceptCancelAction*     AcceptCancelAction;                                         // 0x0188   (0x0008)  
	class UPolyEditTopologyProperties*                 TopologyProperties;                                         // 0x0190   (0x0008)  
	class UPolyEditExtrudeActivity*                    ExtrudeActivity;                                            // 0x0198   (0x0008)  
	class UPolyEditInsetOutsetActivity*                InsetOutsetActivity;                                        // 0x01A0   (0x0008)  
	class UPolyEditCutFacesActivity*                   CutFacesActivity;                                           // 0x01A8   (0x0008)  
	class UPolyEditPlanarProjectionUVActivity*         PlanarProjectionUVActivity;                                 // 0x01B0   (0x0008)  
	class UPolyEditInsertEdgeActivity*                 InsertEdgeActivity;                                         // 0x01B8   (0x0008)  
	class UPolyEditInsertEdgeLoopActivity*             InsertEdgeLoopActivity;                                     // 0x01C0   (0x0008)  
	class UPolyEditBevelEdgeActivity*                  BevelEdgeActivity;                                          // 0x01C8   (0x0008)  
	unsigned char                                      UnknownData01_5[0x38];                                      // 0x01D0   (0x0038)  MISSED
	class UPolyEditActivityContext*                    ActivityContext;                                            // 0x0208   (0x0008)  
	class UPolygonSelectionMechanic*                   SelectionMechanic;                                          // 0x0210   (0x0008)  
	class UDragAlignmentMechanic*                      DragAlignmentMechanic;                                      // 0x0218   (0x0008)  
	class UCombinedTransformGizmo*                     TransformGizmo;                                             // 0x0220   (0x0008)  
	class UTransformProxy*                             TransformProxy;                                             // 0x0228   (0x0008)  
	unsigned char                                      UnknownData02_6[0x650];                                     // 0x0230   (0x0650)  MISSED
};
...
{ 
public:
	SDK_UNDEFINED(8,14675) /* TWeakObjectPtr<UMaterialInterface*> */ __um(Material);                               // 0x00A8   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(16,14676) /* FString */              __um(UVChannel);                                            // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,14677) /* TArray<FString> */      __um(UVChannelNamesList);                                   // 0x00C8   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(8,14678) /* TWeakObjectPtr<UMaterialInterface*> */ __um(CustomMaterial);                         // 0x00EC   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(16,14679) /* FString */              __um(UVChannel);                                            // 0x00A8   (0x0010)  
	SDK_UNDEFINED(16,14680) /* TArray<FString> */      __um(UVChannelNamesList);                                   // 0x00B8   (0x0010)  
...
public:
	...
	unsigned char                                      UnknownData01_6[0x20];                                      // 0x0100   (0x0020)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData00_5[0x68];                                      // 0x00F8   (0x0068)  MISSED
