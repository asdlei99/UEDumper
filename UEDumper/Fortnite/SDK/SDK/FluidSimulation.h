...
public:
	...
	SDK_UNDEFINED(1,11164) /* TEnumAsByte<FluidBoundary> */ __um(Boundary_Condition);                              // 0x031C   (0x0001)  
	...
	SDK_UNDEFINED(80,11165) /* TMap<UActorComponent*, FFluidForceDynamicPerInstanceData> */ __um(DynamicForces);   // 0x0408   (0x0050)  
	SDK_UNDEFINED(80,11166) /* TMap<UMaterialInterface*, UMaterialInstanceDynamic*> */ __um(ForceParentAndMIDMap); // 0x0458   (0x0050)  
	...
	SDK_UNDEFINED(80,11167) /* TMap<UActorComponent*, FFluidForceDynamicPerInstanceData> */ __um(ProjectileForces); // 0x04D0   (0x0050)  
	...
	SDK_UNDEFINED(32,11168) /* TWeakObjectPtr<AWaterZone*> */ __um(WaterZone);                                     // 0x0548   (0x0020)  
	...
	// void SetSingleWaterBodyMIDTexture(class AWaterBody* WaterBody);                                                       // [0x2177018] Public|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.CycleDebugRenderTargets
	// void CycleDebugRenderTargets();                                                                                       // [0x2177018] Public|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Get Frames Since Last Active Forces
	// void Get Frames Since Last Active Forces();                                                                           // [0x2177018] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Clear Sim from Waterbody MIDs
	// void Clear Sim from Waterbody MIDs();                                                                                 // [0x2177018] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Remove Projectile Force
	// void Remove Projectile Force(class UActorComponent* Component);                                                       // [0x2177018] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Register Projectile Force
	// void Register Projectile Force(FFluidForceDynamic Dynamic Fluid Force, class USceneComponent* Tracked Component);     // [0x2177018] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.GetPlayerPawnForces
	// void GetPlayerPawnForces();                                                                                           // [0x2177018] Public|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Validate RTs
	// void Validate RTs(bool& RTs All Valid);                                                                               // [0x2177018] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Set Waterbody MID Params
	// void Set Waterbody MID Params();                                                                                      // [0x2177018] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.GetLocalPawn
	// void GetLocalPawn(class APawn*& Pawn);                                                                                // [0x2177018] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Draw Dynamic Force
	// void Draw Dynamic Force(class UCanvas*& Canvas, FVector2D& Canvas Size, FFluidForceDynamicPerInstanceData& Dynamic Force Settings); // [0x2177018] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Remove Dynamic Force
	// void Remove Dynamic Force(class UActorComponent* Component);                                                          // [0x2177018] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Register Dynamic Force
	// void Register Dynamic Force(FFluidForceDynamic Dynamic Fluid Force, class USceneComponent* Tracked Component, double WaterLevel); // [0x2177018] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Update Dynamic Forces
	// void Update Dynamic Forces();                                                                                         // [0x2177018] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Draw Impulse Force
	// void Draw Impulse Force(class UCanvas* Canvas, FVector2D Canvas Size, FFluidForceImpulsePerInstanceData Impulse Settings); // [0x2177018] Public|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Update Impulse Lifetimes
	// void Update Impulse Lifetimes();                                                                                      // [0x2177018] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Apply Fluid Force Impulse
	// void Apply Fluid Force Impulse(FFluidForceImpulse Impulse Settings);                                                  // [0x2177018] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Get LandscapeWaterInfo
	// void Get LandscapeWaterInfo(class AWaterZone* WaterZone);                                                             // [0x2177018] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Get Force MID
	// void Get Force MID(class UMaterialInterface*& Parent, class UMaterialInstanceDynamic*& Mid);                          // [0x2177018] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.GridMovement
	// void GridMovement();                                                                                                  // [0x2177018] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.SetupSimMIDs
	// void SetupSimMIDs();                                                                                                  // [0x2177018] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.SetupDisplayMIDs
	// void SetupDisplayMIDs();                                                                                              // [0x2177018] Public|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Convert Force Position
	// void Convert Force Position(FVector Force Location, double Sine Bob, FVector& UV Location);                           // [0x2177018] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Cycle Render Targets
	// void Cycle Render Targets(class UTextureRenderTarget2D*& Current Target);                                             // [0x2177018] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
...
{ 
	SDK_UNDEFINED(80,11169) /* TMap<FName, FName> */   __um(SocketsandEndpoints_6_B3EDD8FC43A7C681151F46BE0AA158C5); // 0x0000   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(1,11170) /* TEnumAsByte<FluidDynamicForceMeshType> */ __um(ForceType_28_DDC16EE543D2DFD3BA29C49D32198C9C); // 0x0000   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x0001   (0x0003)  MISSED
...
{ 
	...
	SDK_UNDEFINED(80,11171) /* TMap<FName, FVector> */ __um(SocketLocationMap_21_ABF6AA244A5F84728A5E83BE2328C7FA); // 0x00A8   (0x0050)  
	SDK_UNDEFINED(80,11172) /* TMap<FName, FVector> */ __um(SocketVelocityMap_26_82B0E24B45935A12E1949F918A59A537); // 0x00F8   (0x0050)  
};
