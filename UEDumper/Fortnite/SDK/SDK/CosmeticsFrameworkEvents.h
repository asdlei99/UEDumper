...
public:
	...
	// FCosmeticsEventHandle RegisterOnCosmeticApplicationCompleted_BP(FDelegateProperty& Delegate, int32_t Flags);          // [0x7c26c18] Native|Public|HasOutParms|BlueprintCallable 
};
