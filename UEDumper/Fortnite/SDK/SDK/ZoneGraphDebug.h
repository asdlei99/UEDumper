...
public:
	...
	// void EnableCustomTests();                                                                                             // [0xa8a6150] Final|Native|Public|BlueprintCallable 
	// Function /Script/ZoneGraphDebug.ZoneGraphTestingComponent.DisableCustomTests
	// void DisableCustomTests();                                                                                            // [0xa8a6114] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void EnableCustomTests();                                                                                             // [0xa8a6128] Final|Native|Public|BlueprintCallable 
	// Function /Script/ZoneGraphDebug.ZoneGraphTestingActor.DisableCustomTests
	// void DisableCustomTests();                                                                                            // [0xa8a60ec] Final|Native|Public|BlueprintCallable 
};
