...
public:
	...
	SDK_UNDEFINED(16,2321) /* FString */               __um(DebugName);                                            // 0x00A0   (0x0010)  
	...
	unsigned char                                      UnknownData01_5[0x15];                                      // 0x00B3   (0x0015)  MISSED
	class UMcpProfileGroup*                            ProfileGroup;                                               // 0x00C8   (0x0008)  
	SDK_UNDEFINED(16,2322) /* FString */               __um(ProfileId);                                            // 0x00D0   (0x0010)  
	...
	unsigned char                                      UnknownData03_6[0x47];                                      // 0x00F9   (0x0047)  MISSED


	/// Functions
	// Function /Script/McpProfileSys.McpProfile.UnlockProfileForWrite
	// void UnlockProfileForWrite(FString Code, FDedicatedServerUrlContext& Context);                                        // [0xffff8009b6310000] Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms 
	// Function /Script/McpProfileSys.McpProfile.QueryPublicProfile
	// void QueryPublicProfile(FBaseUrlContext& Context);                                                                    // [0xffff8009b6310000] Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms 
	// Function /Script/McpProfileSys.McpProfile.QueryProfile
	// void QueryProfile(FBaseUrlContext& Context);                                                                          // [0xffff8009b6310000] Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms 
	// Function /Script/McpProfileSys.McpProfile.LockProfileForWrite
	// void LockProfileForWrite(FString Code, int32_t Timeout, FDedicatedServerUrlContext& Context);                         // [0xffff8009b6310000] Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms 
	// Function /Script/McpProfileSys.McpProfile.DeleteProfile
	// void DeleteProfile(FClientUrlContext& Context);                                                                       // [0xffff8009b6310000] Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms 
	// Function /Script/McpProfileSys.McpProfile.DeleteAllProfiles
	// void DeleteAllProfiles(FClientUrlContext& Context);                                                                   // [0xffff8009b6310000] Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms 
};
...
{ 
	SDK_UNDEFINED(16,2323) /* FString */               __um(ProfileId);                                            // 0x0000   (0x0010)  
...
{ 
public:
	unsigned char                                      UnknownData00_2[0xB4];                                      // 0x0028   (0x00B4)  MISSED
	...
	SDK_UNDEFINED(16,2324) /* FString */               __um(PlayerName);                                           // 0x0100   (0x0010)  
	bool                                               bIsServer;                                                  // 0x0110   (0x0001)  
	unsigned char                                      UnknownData03_5[0x7];                                       // 0x0111   (0x0007)  MISSED
	SDK_UNDEFINED(16,2325) /* FString */               __um(ProfileNotificationsStompTopic);                       // 0x0118   (0x0010)  
	unsigned char                                      UnknownData04_5[0x50];                                      // 0x0128   (0x0050)  MISSED
	SDK_UNDEFINED(16,2326) /* FString */               __um(LastMcpVersion);                                       // 0x0178   (0x0010)  
	SDK_UNDEFINED(16,2327) /* FString */               __um(LastContentVersion);                                   // 0x0188   (0x0010)  
	SDK_UNDEFINED(16,2328) /* FString */               __um(LastMinBuild);                                         // 0x0198   (0x0010)  
	FTimespan                                          LocalTimeOffset;                                            // 0x01A8   (0x0008)  
	unsigned char                                      UnknownData05_5[0x8];                                       // 0x01B0   (0x0008)  MISSED
	SDK_UNDEFINED(16,2329) /* FString */               __um(LockCode);                                             // 0x01B8   (0x0010)  
	TArray<class UMcpProfile*>                         LockedProfiles;                                             // 0x01C8   (0x0010)  
	SDK_UNDEFINED(16,2330) /* FString */               __um(LockedProfilesString);                                 // 0x01D8   (0x0010)  
	...
	SDK_UNDEFINED(16,2331) /* FString */               __um(ApplyStashEndPoint);                                   // 0x01F0   (0x0010)  
	...
	SDK_UNDEFINED(16,2332) /* TArray<FString> */       __um(ForwardToClientExclusions);                            // 0x0268   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,2333) /* FString */               __um(ProfileId);                                            // 0x0008   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2334) /* FString */               __um(ItemType);                                             // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2335) /* FString */               __um(ItemGuid);                                             // 0x0010   (0x0010)  
	int32_t                                            Quantity;                                                   // 0x0020   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0024   (0x0004)  MISSED
	FJsonObjectWrapper                                 Attributes;                                                 // 0x0028   (0x0020)  
	SDK_UNDEFINED(16,2336) /* FString */               __um(ItemProfile);                                          // 0x0048   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2337) /* FString */               __um(ItemId);                                               // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2338) /* FString */               __um(TemplateId);                                           // 0x0010   (0x0010)  
	int32_t                                            Quantity;                                                   // 0x0020   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0024   (0x0004)  MISSED
	FJsonObjectWrapper                                 Attributes;                                                 // 0x0028   (0x0020)  
};
...
{ 
	SDK_UNDEFINED(16,2339) /* FString */               __um(ItemId);                                               // 0x0000   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2340) /* FString */               __um(ItemId);                                               // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2341) /* FString */               __um(ItemId);                                               // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2342) /* FString */               __um(AccountId);                                            // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2343) /* FString */               __um(TierGroupName);                                        // 0x0000   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,2344) /* FString */               __um(FromAccountId);                                        // 0x0008   (0x0010)  
