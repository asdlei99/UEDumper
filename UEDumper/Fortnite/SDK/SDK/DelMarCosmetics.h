...
{ 
public:
	unsigned char                                      UnknownData00_2[0x8];                                       // 0x1E60   (0x0008)  MISSED
	...
	SDK_UNDEFINED(16,12975) /* FMulticastInlineDelegate */ __um(OnDelMarVehicleHitWall);                           // 0x2070   (0x0010)  
	SDK_UNDEFINED(16,12976) /* FMulticastInlineDelegate */ __um(OnDelMarVehicleHitVehicle);                        // 0x2080   (0x0010)  
	SDK_UNDEFINED(16,12977) /* FMulticastInlineDelegate */ __um(OnDelMarVehicleHitByVehicle);                      // 0x2090   (0x0010)  
	unsigned char                                      UnknownData03_5[0x388];                                     // 0x20A0   (0x0388)  MISSED
	SDK_UNDEFINED(16,12978) /* FMulticastInlineDelegate */ __um(OnHazardHit);                                      // 0x2428   (0x0010)  
	SDK_UNDEFINED(16,12979) /* FMulticastInlineDelegate */ __um(OnVehicleTeleportEntered);                         // 0x2438   (0x0010)  
	SDK_UNDEFINED(16,12980) /* FMulticastInlineDelegate */ __um(OnVehicleTeleportExit);                            // 0x2448   (0x0010)  
	SDK_UNDEFINED(16,12981) /* FMulticastInlineDelegate */ __um(OnVehicleAppliedTeleportRotation);                 // 0x2458   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,12982) /* FMulticastInlineDelegate */ __um(OnActiveCameraUpdatedDelegate);                    // 0x24A0   (0x0010)  
	SDK_UNDEFINED(16,12983) /* FMulticastInlineDelegate */ __um(OnRotationTransitionStateChanged);                 // 0x24B0   (0x0010)  
	...
	SDK_UNDEFINED(80,12984) /* TMap<FGameplayTag, FRotator> */ __um(SlotPreviewRotations);                         // 0x2588   (0x0050)  
	SDK_UNDEFINED(80,12985) /* TMap<FGameplayTag, FDelMarPreviewConfigs> */ __um(SlotPreviewConfigs);              // 0x25D8   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(80,12986) /* TMap<UClass*, FDelMarParameterOverrides> */ __um(CosmeticActorsParamterOverrides);  // 0x02C8   (0x0050)  
};
