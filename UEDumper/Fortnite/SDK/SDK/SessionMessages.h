...
{ 
	SDK_UNDEFINED(16,15149) /* FString */              __um(UserName);                                             // 0x0000   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,15150) /* FString */              __um(BuildDate);                                            // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,15151) /* FString */              __um(DeviceName);                                           // 0x0018   (0x0010)  
	FGuid                                              InstanceID;                                                 // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,15152) /* FString */              __um(InstanceName);                                         // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,15153) /* FString */              __um(PlatformName);                                         // 0x0048   (0x0010)  
	FGuid                                              SessionId;                                                  // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,15154) /* FString */              __um(SessionName);                                          // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,15155) /* FString */              __um(SessionOwner);                                         // 0x0078   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,15156) /* FString */              __um(Data);                                                 // 0x0008   (0x0010)  
