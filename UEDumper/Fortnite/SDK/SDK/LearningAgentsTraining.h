...
public:
	...
	// void SetConditionalCompletion(int32_t AgentId, bool bIsCompleted);                                                    // [0xc0e6524] Final|Native|Public|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.ConditionalCompletion.AddConditionalCompletion
	// class UConditionalCompletion* AddConditionalCompletion(class ULearningAgentsTrainer* InAgentTrainer, FName Name, ELearningAgentsCompletion InCompletionMode); // [0xc0e15cc] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void SetTimeElapsedCompletion(int32_t AgentId, float Time);                                                           // [0xc0e77d4] Final|Native|Public|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.TimeElapsedCompletion.AddTimeElapsedCompletion
	// class UTimeElapsedCompletion* AddTimeElapsedCompletion(class ULearningAgentsTrainer* InAgentTrainer, FName Name, float Threshold, ELearningAgentsCompletion InCompletionMode); // [0xc0e2760] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void SetPlanarPositionDifferenceCompletion(int32_t AgentId, FVector Position0, FVector Position1);                    // [0xc0e69e0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.PlanarPositionDifferenceCompletion.AddPlanarPositionDifferenceCompletion
	// class UPlanarPositionDifferenceCompletion* AddPlanarPositionDifferenceCompletion(class ULearningAgentsTrainer* InAgentTrainer, FName Name, float Threshold, ELearningAgentsCompletion InCompletionMode, FVector Axis0, FVector Axis1); // [0xc0e1b04] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void SetPlanarPositionSimilarityCompletion(int32_t AgentId, FVector Position0, FVector Position1);                    // [0xc0e6ec0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.PlanarPositionSimilarityCompletion.AddPlanarPositionSimilarityCompletion
	// class UPlanarPositionSimilarityCompletion* AddPlanarPositionSimilarityCompletion(class ULearningAgentsTrainer* InAgentTrainer, FName Name, float Threshold, ELearningAgentsCompletion InCompletionMode, FVector Axis0, FVector Axis1); // [0xc0e2158] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void UseRecordingAsset(class ULearningAgentsRecording* RecordingAsset);                                               // [0xc0e7bc8] Final|Native|Public|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.LearningAgentsRecorder.SetupRecorder
	// void SetupRecorder(class ULearningAgentsInteractor* InInteractor, FLearningAgentsRecorderPathSettings& RecorderPathSettings, class ULearningAgentsRecording* RecordingAsset); // [0xc0e7898] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.LearningAgentsRecorder.SaveRecordingToFile
	// void SaveRecordingToFile(FFilePath& File);                                                                            // [0xc0e5704] Final|Native|Public|HasOutParms|BlueprintCallable|Const 
	// Function /Script/LearningAgentsTraining.LearningAgentsRecorder.SaveRecordingToAsset
	// void SaveRecordingToAsset(class ULearningAgentsRecording* RecordingAsset);                                            // [0xc0e5604] Final|Native|Public|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.LearningAgentsRecorder.LoadRecordingFromFile
	// void LoadRecordingFromFile(FFilePath& File);                                                                          // [0xc0e4180] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.LearningAgentsRecorder.LoadRecordingFromAsset
	// void LoadRecordingFromAsset(class ULearningAgentsRecording* RecordingAsset);                                          // [0xc0e4080] Final|Native|Public|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.LearningAgentsRecorder.IsRecording
	// bool IsRecording();                                                                                                   // [0x97211fc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/LearningAgentsTraining.LearningAgentsRecorder.GetCurrentRecording
	// class ULearningAgentsRecording* GetCurrentRecording();                                                                // [0xc0e3eec] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/LearningAgentsTraining.LearningAgentsRecorder.EndRecording
	// void EndRecording();                                                                                                  // [0xc0e3e88] Final|Native|Public|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.LearningAgentsRecorder.BeginRecording
	// void BeginRecording(bool bReinitializeRecording);                                                                     // [0xc0e3718] Final|Native|Public|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.LearningAgentsRecorder.AppendRecordingToAsset
	// void AppendRecordingToAsset(class ULearningAgentsRecording* RecordingAsset);                                          // [0xc0e3618] Final|Native|Public|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.LearningAgentsRecorder.AppendRecordingFromFile
	// void AppendRecordingFromFile(FFilePath& File);                                                                        // [0xc0e2898] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.LearningAgentsRecorder.AddExperience
	// void AddExperience();                                                                                                 // [0xc0e17d4] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SaveRecordingToFile(FFilePath& File);                                                                            // [0xc0e5dc4] Final|Native|Public|HasOutParms|BlueprintCallable|Const 
	// Function /Script/LearningAgentsTraining.LearningAgentsRecording.SaveRecordingToAsset
	// void SaveRecordingToAsset(class ULearningAgentsRecording* RecordingAsset);                                            // [0xc0e5684] Final|Native|Public|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.LearningAgentsRecording.LoadRecordingFromFile
	// void LoadRecordingFromFile(FFilePath& File);                                                                          // [0xc0e4840] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.LearningAgentsRecording.LoadRecordingFromAsset
	// void LoadRecordingFromAsset(class ULearningAgentsRecording* RecordingAsset);                                          // [0xc0e4100] Final|Native|Public|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.LearningAgentsRecording.AppendRecordingToAsset
	// void AppendRecordingToAsset(class ULearningAgentsRecording* RecordingAsset);                                          // [0xc0e3698] Final|Native|Public|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.LearningAgentsRecording.AppendRecordingFromFile
	// void AppendRecordingFromFile(FFilePath& File);                                                                        // [0xc0e2f58] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void SetFloatReward(int32_t AgentId, float Reward);                                                                   // [0xc0e66ac] Final|Native|Public|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.FloatReward.AddFloatReward
	// class UFloatReward* AddFloatReward(class ULearningAgentsTrainer* InAgentTrainer, FName Name, float Weight);           // [0xc0e17e8] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void SetConditionalReward(int32_t AgentId, bool bCondition);                                                          // [0xc0e65e8] Final|Native|Public|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.ConditionalReward.AddConditionalReward
	// class UConditionalReward* AddConditionalReward(class ULearningAgentsTrainer* InAgentTrainer, FName Name, float Value); // [0xc0e16d4] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void SetScalarVelocityReward(int32_t AgentId, float Velocity);                                                        // [0xc0e7710] Final|Native|Public|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.ScalarVelocityReward.AddScalarVelocityReward
	// class UScalarVelocityReward* AddScalarVelocityReward(class ULearningAgentsTrainer* InAgentTrainer, FName Name, float Weight, float Scale); // [0xc0e2610] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void SetLocalDirectionalVelocityReward(int32_t AgentId, FVector Velocity, FRotator RelativeRotation);                 // [0xc0e6770] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.LocalDirectionalVelocityReward.AddLocalDirectionalVelocityReward
	// class ULocalDirectionalVelocityReward* AddLocalDirectionalVelocityReward(class ULearningAgentsTrainer* InAgentTrainer, FName Name, float Weight, float Scale, FVector Axis); // [0xc0e18e8] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void SetPlanarPositionDifferencePenalty(int32_t AgentId, FVector Position0, FVector Position1);                       // [0xc0e6c50] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.PlanarPositionDifferencePenalty.AddPlanarPositionDifferencePenalty
	// class UPlanarPositionDifferencePenalty* AddPlanarPositionDifferencePenalty(class ULearningAgentsTrainer* InAgentTrainer, FName Name, float Weight, float Scale, float Threshold, FVector Axis0, FVector Axis1); // [0xc0e1e10] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void SetPositionArraySimilarityReward(int32_t AgentId, TArray<FVector>& Positions0, TArray<FVector>& Positions1, FVector RelativePosition0, FVector RelativePosition1, FRotator RelativeRotation0, FRotator RelativeRotation1); // [0xc0e7130] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/LearningAgentsTraining.PositionArraySimilarityReward.AddPositionArraySimilarityReward
	// class UPositionArraySimilarityReward* AddPositionArraySimilarityReward(class ULearningAgentsTrainer* InAgentTrainer, FName Name, int32_t PositionNum, float Scale, float Weight); // [0xc0e2464] Final|Native|Static|Public|BlueprintCallable 
};
