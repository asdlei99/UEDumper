...
enum class ERewardWarningTooltipType28 : uint8_t
{
	...
	ERewardWarningTooltipType28__Sparks                                              = 3,
	ERewardWarningTooltipType28__DelMar                                              = 4,
	ERewardWarningTooltipType28__Juno                                                = 5,
	ERewardWarningTooltipType28__Max                                                 = 6
};
...
{ 
public:
	SDK_UNDEFINED(16,11704) /* FString */              __um(ClaimBaseItemTooltip_ClaimCheckTemplateId);            // 0x05C8   (0x0010)  
