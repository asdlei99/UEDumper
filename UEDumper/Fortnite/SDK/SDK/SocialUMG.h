...
public:
	...
	// void SendCurrentMessage();                                                                                            // [0x9e7a02c] Final|Native|Public|BlueprintCallable 
	// Function /Script/SocialUMG.SocialChatContainer.OnChatOpenChanged
	// void OnChatOpenChanged(bool bShouldBeOpen);                                                                           // [0x2047e54] Event|Protected|BlueprintEvent 
	// Function /Script/SocialUMG.SocialChatContainer.HandleRightTabPressed
	// void HandleRightTabPressed();                                                                                         // [0x9e79fa4] Final|Native|Public|BlueprintCallable 
	// Function /Script/SocialUMG.SocialChatContainer.HandleLeftTabPressed
	// void HandleLeftTabPressed();                                                                                          // [0x9e79e00] Final|Native|Public|BlueprintCallable 
	// Function /Script/SocialUMG.SocialChatContainer.FocusEditableText
	// void FocusEditableText();                                                                                             // [0x9e79d50] Final|Native|Public|BlueprintCallable 
	// Function /Script/SocialUMG.SocialChatContainer.DynamicHandleMessageTextCommitted
	// void DynamicHandleMessageTextCommitted(FText& MessageText, TEnumAsByte<ETextCommit> CommitMethod);                    // [0x9e79c3c] Final|Native|Private|HasOutParms 
};
...
public:
	...
	// void OnMessageSet();                                                                                                  // [0x2047e54] Event|Protected|BlueprintEvent 
	// Function /Script/SocialUMG.SocialChatMessageEntry.CanInteract
	// bool CanInteract();                                                                                                   // [0x2e9f56c] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// class UUserWidget* HandleGetMenuContent();                                                                            // [0x9e79db8] Final|Native|Protected 
};
...
public:
	...
	// void OnInteractionSet();                                                                                              // [0x2047e54] Event|Protected|BlueprintEvent 
	// Function /Script/SocialUMG.SocialInteractionButton.IsPlatformOnlyFriend
	// bool IsPlatformOnlyFriend();                                                                                          // [0x9e79fb8] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SocialUMG.SocialInteractionButton.GetInteractionName
	// FName GetInteractionName();                                                                                           // [0x9e79d84] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnOpened();                                                                                                      // [0x2047e54] Event|Protected|BlueprintEvent 
	// Function /Script/SocialUMG.SocialActionMenu.HandleMenuAnchorOpenChanged
	// void HandleMenuAnchorOpenChanged(bool bIsOpen);                                                                       // [0x9e79e14] Final|Native|Protected 
};
...
public:
	...
	// void OnToggleConfirmation(bool bIsVisible);                                                                           // [0x2047e54] Event|Protected|BlueprintEvent 
	// Function /Script/SocialUMG.SocialInteractionMenu.GetFirstEntryToCenter
	// class UWidget* GetFirstEntryToCenter();                                                                               // [0x9e79d64] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void HandleMenuOpenChanged(bool bIsMenuOpen);                                                                         // [0x9e79edc] Final|Native|Private 
	// Function /Script/SocialUMG.SocialListInteractableEntryBase.HandleGetMenuContent
	// class UUserWidget* HandleGetMenuContent();                                                                            // [0x9e79ddc] Final|Native|Protected 
};
...
public:
	...
	SDK_UNDEFINED(80,9409) /* TMap<UClass*, USocialActionMenu*> */ __um(CachedActionMenuPool);                     // 0x03F8   (0x0050)  
};
