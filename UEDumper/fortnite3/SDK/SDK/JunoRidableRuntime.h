...
{ 
public:
	SDK_UNDEFINED(32,14488) /* TWeakObjectPtr<UClass*> */ __um(CreatureRidableComponentClass);                     // 0x0028   (0x0020)  
	SDK_UNDEFINED(32,14489) /* TWeakObjectPtr<UClass*> */ __um(PlayerRidingComponentClass);                        // 0x0048   (0x0020)  
