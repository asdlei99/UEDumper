...
{ 
public:
	SDK_UNDEFINED(16,13153) /* FMulticastInlineDelegate */ __um(OnStartChargingJumpDelegate);                      // 0x1F68   (0x0010)  
	SDK_UNDEFINED(16,13154) /* FMulticastInlineDelegate */ __um(OnCancelChargingJumpDelegate);                     // 0x1F78   (0x0010)  
	SDK_UNDEFINED(16,13155) /* FMulticastInlineDelegate */ __um(OnJumpDelegate);                                   // 0x1F88   (0x0010)  
	SDK_UNDEFINED(16,13156) /* FMulticastInlineDelegate */ __um(OnChargingJumpDelegate);                           // 0x1F98   (0x0010)  
	SDK_UNDEFINED(16,13157) /* FMulticastInlineDelegate */ __um(OnStartAirTrickDelegate);                          // 0x1FA8   (0x0010)  
	SDK_UNDEFINED(16,13158) /* FMulticastInlineDelegate */ __um(OnFinishAirTrickDelegate);                         // 0x1FB8   (0x0010)  
	SDK_UNDEFINED(16,13159) /* FMulticastInlineDelegate */ __um(OnStartWheelieDelegate);                           // 0x1FC8   (0x0010)  
	SDK_UNDEFINED(16,13160) /* FMulticastInlineDelegate */ __um(OnReleaseWheelieDelegate);                         // 0x1FD8   (0x0010)  
	SDK_UNDEFINED(16,13161) /* FMulticastInlineDelegate */ __um(OnLandWheelieDelegate);                            // 0x1FE8   (0x0010)  
	SDK_UNDEFINED(16,13162) /* FMulticastInlineDelegate */ __um(OnFailWheelieDelegate);                            // 0x1FF8   (0x0010)  
	SDK_UNDEFINED(16,13163) /* FMulticastInlineDelegate */ __um(OnStartStoppieDelegate);                           // 0x2008   (0x0010)  
	SDK_UNDEFINED(16,13164) /* FMulticastInlineDelegate */ __um(OnReleaseStoppieDelegate);                         // 0x2018   (0x0010)  
	SDK_UNDEFINED(16,13165) /* FMulticastInlineDelegate */ __um(OnLandStoppieDelegate);                            // 0x2028   (0x0010)  
	SDK_UNDEFINED(16,13166) /* FMulticastInlineDelegate */ __um(OnInventoryModeChangedDelegate);                   // 0x2038   (0x0010)  
	SDK_UNDEFINED(16,13167) /* FMulticastInlineDelegate */ __um(OnSuperSlidingChangedDelegate);                    // 0x2048   (0x0010)  
	...
	SDK_UNDEFINED(16,13168) /* FString */              __um(RoadAndExhaustNiagaraComponentName);                   // 0x2198   (0x0010)  
	...
	SDK_UNDEFINED(16,13169) /* TArray<TEnumAsByte<EPhysicalSurface>> */ __um(RoadAndExhaustSurfaceTypeArrayForFX); // 0x21E8   (0x0010)  
	...
	SDK_UNDEFINED(16,13170) /* TArray<TEnumAsByte<EObjectTypeQuery>> */ __um(DoorBashCollisionTypesForDoor);       // 0x22C0   (0x0010)  
	SDK_UNDEFINED(16,13171) /* TArray<TEnumAsByte<EObjectTypeQuery>> */ __um(DoorBashCollisionTypesForPawn);       // 0x22D0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,13172) /* TSet<FName> */          __um(BoostAttackShapes);                                    // 0x0B70   (0x0050)  
