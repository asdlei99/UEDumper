...
{ 
public:
	SDK_UNDEFINED(32,15384) /* TWeakObjectPtr<UStyleThemeConfig*> */ __um(StyleThemeConfig);                       // 0x0028   (0x0020)  
};
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(80,15385) /* TMap<FWidgetProperty, int32_t> */ __um(WidgetPropertyTweens);                       // 0x0028   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(8,15386) /* TWeakObjectPtr<UStyleRuleTree*> */ __um(StyleRuleTree);                              // 0x0048   (0x0008)  
	SDK_UNDEFINED(8,15387) /* TWeakObjectPtr<UStyleAnimationProvider*> */ __um(StyleAnimationProvider);            // 0x0050   (0x0008)  
...
{ 
	...
	SDK_UNDEFINED(80,15388) /* TMap<FName, FStyleAnimationData> */ __um(PropertyAnimations);                       // 0x0010   (0x0050)  
	SDK_UNDEFINED(80,15389) /* TMap<FName, FInstancedPropertyBag> */ __um(MaterialParameters);                     // 0x0060   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(8,15390) /* TWeakObjectPtr<UStyleRule*> */ __um(Parent);                                         // 0x0048   (0x0008)  
...
{ 
	SDK_UNDEFINED(16,15391) /* FString */              __um(Description);                                          // 0x0000   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(32,15392) /* TWeakObjectPtr<UStyleSheetCollection*> */ __um(Theme);                              // 0x0008   (0x0020)  
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(8,15393) /* TWeakObjectPtr<UStyleRuleTree*> */ __um(StyleRuleTree);                              // 0x0028   (0x0008)  
	SDK_UNDEFINED(80,15394) /* TMap<FStyleThemeConfigKey, UStyleThemeConfig*> */ __um(ThemeConfigSourceMap);       // 0x0030   (0x0050)  
	SDK_UNDEFINED(80,15395) /* TSet<FName> */          __um(ActiveThemeNames);                                     // 0x0080   (0x0050)  
};
...
{ 
public:
	SDK_UNDEFINED(80,15396) /* TMap<FName, FStyleTag> */ __um(WidgetStyleTagMap);                                  // 0x0028   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(32,15397) /* TWeakObjectPtr<UStyleThemeConfig*> */ __um(StyleThemeConfig);                       // 0x0038   (0x0020)  
...
{ 
	SDK_UNDEFINED(8,15398) /* TWeakObjectPtr<UWidget*> */ __um(Widget);                                            // 0x0000   (0x0008)  
...
{ 
	SDK_UNDEFINED(80,15399) /* TMap<UWidget*, FInstancedPropertyBag> */ __um(WidgetToPropertyBagMap);              // 0x0000   (0x0050)  
};
