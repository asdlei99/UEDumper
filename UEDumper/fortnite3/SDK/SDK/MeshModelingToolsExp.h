...
public:
	...
	SDK_UNDEFINED(16,14734) /* FString */              __um(TargetUVLayer);                                        // 0x00C0   (0x0010)  
	...
	SDK_UNDEFINED(16,14735) /* FString */              __um(SourceNormalMapUVLayer);                               // 0x0100   (0x0010)  
	...
	SDK_UNDEFINED(16,14736) /* TArray<FString> */      __um(TargetUVLayerNamesList);                               // 0x0120   (0x0010)  
	SDK_UNDEFINED(16,14737) /* TArray<FString> */      __um(SourceUVLayerNamesList);                               // 0x0130   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,14738) /* FString */              __um(UVLayer);                                              // 0x00B0   (0x0010)  
	SDK_UNDEFINED(16,14739) /* TArray<FString> */      __um(UVLayerNamesList);                                     // 0x00C0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,14740) /* FString */              __um(UVLayer);                                              // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,14741) /* TArray<FString> */      __um(UVLayerNamesList);                                     // 0x00C8   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,14742) /* TSet<UPrimitiveComponent*> */ __um(AllComponents);                                  // 0x03C8   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(16,14743) /* FString */              __um(MapPreview);                                           // 0x00B0   (0x0010)  
	...
	SDK_UNDEFINED(16,14744) /* TArray<FString> */      __um(MapPreviewNamesList);                                  // 0x00D8   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,14745) /* TMap<EBakeMapType, UTexture2D*> */ __um(CachedMaps);                                // 0x0220   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(80,14746) /* TMap<EBakeMapType, UTexture2D*> */ __um(Result);                                    // 0x00A8   (0x0050)  
};
...
public:
	int32_t                                            MapTypes;                                                   // 0x00A8   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00AC   (0x0004)  MISSED
	SDK_UNDEFINED(16,14747) /* FString */              __um(MapPreview);                                           // 0x00B0   (0x0010)  
	EBakeTextureResolution                             Resolution;                                                 // 0x00C0   (0x0004)  
	EBakeTextureBitDepth                               BitDepth;                                                   // 0x00C4   (0x0004)  
	EBakeTextureSamplesPerPixel                        SamplesPerPixel;                                            // 0x00C8   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x00CC   (0x0004)  MISSED
	class UTexture2D*                                  SampleFilterMask;                                           // 0x00D0   (0x0008)  
	SDK_UNDEFINED(16,14748) /* TArray<FString> */      __um(MapPreviewNamesList);                                  // 0x00D8   (0x0010)  
	unsigned char                                      UnknownData02_6[0x50];                                      // 0x00E8   (0x0050)  MISSED
...
public:
	...
	class USkeletalMesh*                               TargetSkeletalMesh;                                         // 0x00B0   (0x0008)  
	class AActor*                                      TargetDynamicMesh;                                          // 0x00B8   (0x0008)  
	SDK_UNDEFINED(16,14749) /* FString */              __um(TargetUVLayer);                                        // 0x00C0   (0x0010)  
	...
	SDK_UNDEFINED(16,14750) /* TArray<FString> */      __um(TargetUVLayerNamesList);                               // 0x00E8   (0x0010)  
...
public:
	...
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x00AC   (0x0004)  MISSED
	SDK_UNDEFINED(16,14751) /* TArray<FString> */      __um(OptionsList);                                          // 0x00B0   (0x0010)  
	bool                                               bShowNewLayerName;                                          // 0x00C0   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x00C1   (0x0007)  MISSED
	SDK_UNDEFINED(16,14752) /* FString */              __um(NewLayerName);                                         // 0x00C8   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,14753) /* FString */              __um(ToggleCornerMode);                                     // 0x0120   (0x0010)  
	SDK_UNDEFINED(16,14754) /* FString */              __um(PushPull);                                             // 0x0130   (0x0010)  
	SDK_UNDEFINED(16,14755) /* FString */              __um(ResizeGrid);                                           // 0x0140   (0x0010)  
	unsigned char                                      UnknownData05_5[0x10];                                      // 0x0150   (0x0010)  MISSED
	SDK_UNDEFINED(16,14756) /* FString */              __um(FlipSelection);                                        // 0x0160   (0x0010)  
	SDK_UNDEFINED(16,14757) /* FString */              __um(GridGizmo);                                            // 0x0170   (0x0010)  
	SDK_UNDEFINED(16,14758) /* FString */              __um(QuickShiftGizmo);                                      // 0x0180   (0x0010)  
	SDK_UNDEFINED(16,14759) /* FString */              __um(AlignGizmo);                                           // 0x0190   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,14760) /* TArray<FString> */      __um(WeightMapsList);                                       // 0x00C0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,14761) /* TArray<FString> */      __um(MaterialIDList);                                       // 0x00B0   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,14762) /* FString */              __um(InitialHoles);                                         // 0x00A8   (0x0010)  
	SDK_UNDEFINED(16,14763) /* FString */              __um(SelectedHoles);                                        // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,14764) /* FString */              __um(SuccessfulFills);                                      // 0x00C8   (0x0010)  
	SDK_UNDEFINED(16,14765) /* FString */              __um(FailedFills);                                          // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,14766) /* FString */              __um(RemainingHoles);                                       // 0x00E8   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(16,14767) /* FString */              __um(Attribute);                                            // 0x00A8   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,14768) /* TMap<int32_t, UMeshSculptBrushOpProps*> */ __um(BrushOpPropSets);                   // 0x0230   (0x0050)  
	unsigned char                                      UnknownData01_5[0x50];                                      // 0x0280   (0x0050)  MISSED
	SDK_UNDEFINED(80,14769) /* TMap<int32_t, UMeshSculptBrushOpProps*> */ __um(SecondaryBrushOpPropSets);          // 0x02D0   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(16,14770) /* FString */              __um(UVChannel);                                            // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,14771) /* TArray<FString> */      __um(UVChannelNamesList);                                   // 0x00C8   (0x0010)  
...
public:
	...
	FName                                              WeightMap;                                                  // 0x00BC   (0x0004)  
	SDK_UNDEFINED(16,14772) /* TArray<FString> */      __um(WeightMapsList);                                       // 0x00C0   (0x0010)  
	...
	SDK_UNDEFINED(16,14773) /* FString */              __um(CopyToLODName);                                        // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,14774) /* TArray<FString> */      __um(LODNamesList);                                         // 0x00E8   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(8,14775) /* TWeakObjectPtr<UMeshVertexSculptTool*> */ __um(Tool);                                // 0x00AC   (0x0008)  
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x00B4   (0x0004)  MISSED
};
...
public:
	...
	SDK_UNDEFINED(8,14776) /* TWeakObjectPtr<UMeshVertexSculptTool*> */ __um(Tool);                                // 0x00BC   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(16,14777) /* FString */              __um(ObjectName);                                           // 0x00A8   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,14778) /* FString */              __um(SurfaceArea);                                          // 0x00A8   (0x0010)  
	SDK_UNDEFINED(16,14779) /* FString */              __um(Volume);                                               // 0x00B8   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(16,14780) /* FString */              __um(Mesh);                                                 // 0x00A8   (0x0010)  
	SDK_UNDEFINED(16,14781) /* FString */              __um(UV);                                                   // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,14782) /* FString */              __um(Attributes);                                           // 0x00C8   (0x0010)  
};
...
public:
	...
	unsigned char                                      UnknownData00_5[0x6];                                       // 0x00AA   (0x0006)  MISSED
	SDK_UNDEFINED(16,14783) /* FString */              __um(SourceLOD);                                            // 0x00B0   (0x0010)  
	SDK_UNDEFINED(16,14784) /* FString */              __um(TargetLod);                                            // 0x00C0   (0x0010)  
	bool                                               bIsStaticMeshSource;                                        // 0x00D0   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x00D1   (0x0007)  MISSED
	SDK_UNDEFINED(16,14785) /* TArray<FString> */      __um(SourceLODNamesList);                                   // 0x00D8   (0x0010)  
	unsigned char                                      UnknownData02_5[0x10];                                      // 0x00E8   (0x0010)  MISSED
	SDK_UNDEFINED(16,14786) /* TArray<FString> */      __um(TargetLODNamesList);                                   // 0x00F8   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(8,14787) /* TWeakObjectPtr<UWorld*> */ __um(TargetWorld);                                        // 0x00C8   (0x0008)  
	SDK_UNDEFINED(16,14788) /* TArray<TWeakObjectPtr<AActor*>> */ __um(ActorsWithSplines);                         // 0x00D0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(24,14789) /* TLazyObjectPtr<AVolume*> */ __um(TargetVolume);                                     // 0x00B8   (0x0018)  
