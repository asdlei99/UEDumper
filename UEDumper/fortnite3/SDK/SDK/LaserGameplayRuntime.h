...
{ 
public:
	SDK_UNDEFINED(1,14608) /* TEnumAsByte<ECollisionEnabled> */ __um(CollisionWhenEnabled);                        // 0x0530   (0x0001)  
	SDK_UNDEFINED(1,14609) /* TEnumAsByte<ECollisionEnabled> */ __um(CollisionWhenDisabled);                       // 0x0531   (0x0001)  
...
{ 
public:
	SDK_UNDEFINED(16,14610) /* FMulticastInlineDelegate */ __um(OnLaserGridTriggered);                             // 0x0980   (0x0010)  
	SDK_UNDEFINED(16,14611) /* FMulticastInlineDelegate */ __um(OnLaserGridOutletDestroyed);                       // 0x0990   (0x0010)  
	...
	SDK_UNDEFINED(80,14612) /* TMap<int32_t, ABuildingActor*> */ __um(LaserOutletToBuildingAttachmentMap);         // 0x09B8   (0x0050)  
