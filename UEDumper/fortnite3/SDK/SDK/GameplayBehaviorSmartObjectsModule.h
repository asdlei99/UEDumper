...
{ 
public:
	SDK_UNDEFINED(16,13880) /* FMulticastInlineDelegate */ __um(OnSucceeded);                                      // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,13881) /* FMulticastInlineDelegate */ __um(OnFailed);                                         // 0x0078   (0x0010)  
	SDK_UNDEFINED(16,13882) /* FMulticastInlineDelegate */ __um(OnMoveToFailed);                                   // 0x0088   (0x0010)  
