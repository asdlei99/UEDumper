...
/// Size: 0x04
enum class ERedirectorTileDisplayMode : uint32_t
{
...
{ 
	class UFortItemDefinition*                         LoadedEmote;                                                // 0x0000   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(32,14700) /* TWeakObjectPtr<UClass*> */ __um(SprayCustomizerClass);                              // 0x03D0   (0x0020)  
	...
	SDK_UNDEFINED(8,14701) /* TWeakObjectPtr<UAthenaCosmeticItemDefinition*> */ __um(ItemDefinition);              // 0x0418   (0x0008)  
	TArray<FFortVariantRedirectorTileLoadedEmoteToRandomize> LoadedEmotesToRandomize;                              // 0x0420   (0x0010)  
	SDK_UNDEFINED(16,14702) /* FMulticastInlineDelegate */ __um(OnVariantEngagedEvent);                            // 0x0430   (0x0010)  
	...
	// void OnVariantChangedEvent__DelegateSignature(FMcpVariantChannelInfo& InChannelInfo);                                 // [0x2047e54] MulticastDelegate|Public|Delegate|HasOutParms 
	// Function /Script/MeshCosmeticsUI.FortVariantRedirectorTile.HandleBoundaryNavigation
	// class UWidget* HandleBoundaryNavigation(EUINavigation InNavigation);                                                  // [0xb45e878] Final|Native|Private 
	// Function /Script/MeshCosmeticsUI.FortVariantRedirectorTile.GetButtonToFocus
	// class UWidget* GetButtonToFocus();                                                                                    // [0xb45e850] Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
public:
	SDK_UNDEFINED(80,14703) /* TMap<FGameplayTag, FFortVariantSprayCustomizerCosmeticOptions> */ __um(SprayCustomizerOptions); // 0x0030   (0x0050)  
};
...
public:
	...
	ERedirectorTileDisplayMode                         DisplayMode;                                                // 0x14A0   (0x0004)  
	float                                              SlotOpacitySprayAssigned;                                   // 0x14A4   (0x0004)  
	float                                              SlotOpacitySprayNotAssigned;                                // 0x14A8   (0x0004)  
	unsigned char                                      UnknownData00_6[0x44];                                      // 0x14AC   (0x0044)  MISSED
};
...
public:
	...
	// void BP_SetVariantEditorMode(bool bIsLockerMode);                                                                     // [0x2047e54] Event|Protected|BlueprintEvent 
	// Function /Script/MeshCosmeticsUI.FortVariantSprayCustomizer.BP_SetChannelSlotIcon
	// void BP_SetChannelSlotIcon(TWeakObjectPtr<UObject*>& ChannelSlotIcon);                                                // [0x2047e54] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void HandleSliderValueChanged(float NormalizedValue);                                                                 // [0xb45e948] Final|Native|Private 
	// Function /Script/MeshCosmeticsUI.FortVariantSprayCustomizerSetting.BP_OnSetConstraints
	// void BP_OnSetConstraints(FFloatRange& Constraints);                                                                   // [0x2047e54] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/MeshCosmeticsUI.FortVariantSprayCustomizerSetting.BP_OnChangeValue
	// void BP_OnChangeValue(float Value, float NormalizedValue);                                                            // [0x2047e54] Event|Protected|BlueprintEvent 
};
...
{ 
	SDK_UNDEFINED(16,14704) /* TArray<TWeakObjectPtr<UFortItemDefinition*>> */ __um(ItemShopPreviewStyles);        // 0x0000   (0x0010)  
	SDK_UNDEFINED(80,14705) /* TMap<FGameplayTag, FFortVariantSprayCustomizerChannelOptions> */ __um(ChannelOptions); // 0x0010   (0x0050)  
};
