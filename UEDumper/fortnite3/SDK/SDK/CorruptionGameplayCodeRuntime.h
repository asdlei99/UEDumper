...
{ 
	SDK_UNDEFINED(16,12444) /* FString */              __um(EventName);                                            // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,12445) /* FString */              __um(EventName);                                            // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(80,12446) /* TMap<FString, float> */ __um(PointGroupStepPercentOverrides);                       // 0x0000   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(16,12447) /* TArray<TWeakObjectPtr<UFortItemDefinition*>> */ __um(SoftRefsToLoad);               // 0x0008   (0x0010)  
	SDK_UNDEFINED(80,12448) /* TMap<FName, FScalableFloat> */ __um(LootTableMods);                                 // 0x0018   (0x0050)  
};
