...
public:
	...
	SDK_UNDEFINED(16,11854) /* FString */              __um(DeviceProfileSuffix);                                  // 0x0038   (0x0010)  
...
{ 
public:
	unsigned char                                      UnknownData00_3[0x30];                                      // 0x0140   (0x0030)  MISSED
	SDK_UNDEFINED(80,11855) /* TMap<FString, UJunoUserWorldView*> */ __um(WorldViewMap);                           // 0x0170   (0x0050)  


	/// Functions
	// Function /Script/JunoWorldManagement.JunoWorldMCPProto_Profile.ProtoJuno_UpdateWorldSysMetadata
	// void ProtoJuno_UpdateWorldSysMetadata(FString WorldId, FJsonObjectWrapper SysMetadata, FDedicatedServerUrlContext& Context); // [0xffff800844bd0000] Net|NetReliableNetRequest|Native|Event|Public|HasOutParms 
	// Function /Script/JunoWorldManagement.JunoWorldMCPProto_Profile.ProtoJuno_UpdateWorldMetadata
	// void ProtoJuno_UpdateWorldMetadata(FString WorldId, FJsonObjectWrapper WorldMetadata, FClientUrlContext& Context);    // [0xffff800844bd0000] Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms 
	// Function /Script/JunoWorldManagement.JunoWorldMCPProto_Profile.ProtoJuno_UpdateWorldLastAccessTime
	// void ProtoJuno_UpdateWorldLastAccessTime(FString WorldId, FClientUrlContext& Context);                                // [0xffff800844bd0000] Net|NetReliableNetRequest|Native|Event|Public|HasOutParms 
	// Function /Script/JunoWorldManagement.JunoWorldMCPProto_Profile.ProtoJuno_SetWorldName
	// void ProtoJuno_SetWorldName(FString WorldId, FString Name, FClientUrlContext& Context);                               // [0xffff800844bd0000] Net|NetReliableNetRequest|Native|Event|Public|HasOutParms 
	// Function /Script/JunoWorldManagement.JunoWorldMCPProto_Profile.ProtoJuno_MarkWorldDeleted
	// void ProtoJuno_MarkWorldDeleted(FString WorldId, FClientUrlContext& Context);                                         // [0xffff800844bd0000] Net|NetReliableNetRequest|Native|Event|Public|HasOutParms 
	// Function /Script/JunoWorldManagement.JunoWorldMCPProto_Profile.ProtoJuno_DeleteWorld
	// void ProtoJuno_DeleteWorld(FString WorldId, FClientUrlContext& Context);                                              // [0xffff800844bd0000] Net|NetReliableNetRequest|Native|Event|Public|HasOutParms 
	// Function /Script/JunoWorldManagement.JunoWorldMCPProto_Profile.ProtoJuno_DeleteAllWorlds
	// void ProtoJuno_DeleteAllWorlds(FClientUrlContext& Context);                                                           // [0xffff800844bd0000] Net|NetReliableNetRequest|Native|Event|Public|HasOutParms 
	// Function /Script/JunoWorldManagement.JunoWorldMCPProto_Profile.ProtoJuno_CreateWorld
	// void ProtoJuno_CreateWorld(FJsonObjectWrapper world_metadata, FClientUrlContext& Context);                            // [0xffff800844bd0000] Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms 
};
...
{ 
public:
	SDK_UNDEFINED(80,11856) /* TMap<FString, UJunoUserWorldView*> */ __um(WorldViewMap);                           // 0x0028   (0x0050)  
...
{ 
	SDK_UNDEFINED(16,11857) /* FString */              __um(McpBackend);                                           // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,11858) /* FString */              __um(ID);                                                   // 0x0000   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,11859) /* FString */              __um(Title);                                                // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,11860) /* FString */              __um(MapName);                                              // 0x0018   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,11861) /* FString */              __um(ID);                                                   // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(80,11862) /* TMap<FString, FName> */ __um(GameplayProperties);                                   // 0x0000   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(16,11863) /* FString */              __um(WorldId);                                              // 0x0000   (0x0010)  
};
