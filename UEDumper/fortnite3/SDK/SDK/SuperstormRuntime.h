...
{ 
	SDK_UNDEFINED(8,15400) /* TWeakObjectPtr<AActor*> */ __um(Actor);                                              // 0x000C   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(16,15401) /* FMulticastInlineDelegate */ __um(OnActorAddedToTornadoForces);                      // 0x00A0   (0x0010)  
	SDK_UNDEFINED(16,15402) /* FMulticastInlineDelegate */ __um(OnActorRemovedFromTornadoForces);                  // 0x00B0   (0x0010)  
	...
	SDK_UNDEFINED(80,15403) /* TMap<EFortPhysicsObjectType, FScalableFloat> */ __um(ObjectTypeToMaxCapCount);      // 0x0110   (0x0050)  
	...
	SDK_UNDEFINED(80,15404) /* TSet<AFortPlayerPawn*> */ __um(PreviouslyNearPlayers);                              // 0x0438   (0x0050)  
...
{ 
	...
	SDK_UNDEFINED(80,15405) /* TMap<EFortPhysicsSimSize, FTornadoObjectForceModifiers> */ __um(SizeForceModifiers); // 0x0070   (0x0050)  
	SDK_UNDEFINED(80,15406) /* TMap<EFortPhysicsObjectType, FTornadoObjectForceModifiers> */ __um(ObjectTypeForceModifiers); // 0x00C0   (0x0050)  
...
{ 
	SDK_UNDEFINED(80,15407) /* TMap<EFortPhysicsObjectType, int32_t> */ __um(NumActorsEnteredByType);              // 0x0000   (0x0050)  
	SDK_UNDEFINED(80,15408) /* TSet<FUniqueNetIdRepl> */ __um(EnteredPlayerAccountIds);                            // 0x0050   (0x0050)  
