...
{ 
public:
	SDK_UNDEFINED(32,12303) /* TWeakObjectPtr<UClass*> */ __um(VehiclePreviewActorClass);                          // 0x0030   (0x0020)  
	SDK_UNDEFINED(32,12304) /* TWeakObjectPtr<UClass*> */ __um(DefaultBoostPreviewActorClass);                     // 0x0050   (0x0020)  
	SDK_UNDEFINED(32,12305) /* TWeakObjectPtr<UClass*> */ __um(DefaultTrailPreviewActorClass);                     // 0x0070   (0x0020)  
	SDK_UNDEFINED(32,12306) /* TWeakObjectPtr<UClass*> */ __um(VehiclePreviewPrefabAssetClass);                    // 0x0090   (0x0020)  
	SDK_UNDEFINED(32,12307) /* TWeakObjectPtr<UFortVehicleCosmeticsItemDefinition_Body*> */ __um(VehiclePreviewDefaultPreviewBody); // 0x00B0   (0x0020)  
};
...
{ 
	...
	SDK_UNDEFINED(24,12308) /* FText */                __um(ItemLockerRestrictedText);                             // 0x0048   (0x0018)  
};
...
public:
	...
	SDK_UNDEFINED(32,12309) /* TWeakObjectPtr<UVehicleCosmeticsItemDefinition*> */ __um(VehicleCosmeticsItemDef);  // 0x0778   (0x0020)  
	FGameplayTag                                       ItemTypeTag;                                                // 0x0798   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x079C   (0x0004)  MISSED
	SDK_UNDEFINED(32,12310) /* TWeakObjectPtr<UVehicleCosmeticsPreviewConfigs*> */ __um(PreviewConfig);            // 0x07A0   (0x0020)  
	TArray<FVehicleCosmeticsRestrictionDefinition>     RestrictionDefinitions;                                     // 0x07C0   (0x0010)  
	SDK_UNDEFINED(32,12311) /* TWeakObjectPtr<UFortVehicleCosmeticsItemDefinition*> */ __um(ItemPreviewVehicleBody); // 0x07D0   (0x0020)  
};
...
{ 
public:
	SDK_UNDEFINED(80,12312) /* TMap<UClass*, UCustomizableObjectInstance*> */ __um(CachedInstanceMap);             // 0x00A0   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(16,12313) /* TScriptInterface<Class> */ __um(VehicleInterface);                                  // 0x02A8   (0x0010)  
	SDK_UNDEFINED(16,12314) /* TScriptInterface<Class> */ __um(VehicleCosmeticsInterface);                         // 0x02B8   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,12315) /* TMap<FName, bool> */    __um(HasBeenCustomizedMap);                                 // 0x01A8   (0x0050)  
	SDK_UNDEFINED(80,12316) /* TMap<int32_t, UAssembledMeshSchema*> */ __um(MeshPartDataMap);                      // 0x01F8   (0x0050)  
	unsigned char                                      UnknownData05_5[0x338];                                     // 0x0248   (0x0338)  MISSED
	SDK_UNDEFINED(16,12317) /* FMulticastInlineDelegate */ __um(OnCosmeticActorSpawned);                           // 0x0580   (0x0010)  
	...
	SDK_UNDEFINED(16,12318) /* FMulticastInlineDelegate */ __um(OnEngineAudioUpdated);                             // 0x05F8   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,12319) /* TArray<TWeakObjectPtr<UClass*>> */ __um(CosmeticAttachments);                       // 0x01C0   (0x0010)  
	SDK_UNDEFINED(16,12320) /* TArray<FString> */      __um(CheatNames);                                           // 0x01D0   (0x0010)  
	SDK_UNDEFINED(16,12321) /* FString */              __um(CheatLoadoutSlotName);                                 // 0x01E0   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(32,12322) /* TWeakObjectPtr<UPhysicsAsset*> */ __um(PhysicsAssetOverride);                       // 0x0018   (0x0020)  
};
...
{ 
	FGameplayTagQuery                                  VehicleTagQuery;                                            // 0x0000   (0x0048)  
	SDK_UNDEFINED(32,12323) /* TWeakObjectPtr<UClass*> */ __um(AnimClass);                                         // 0x0048   (0x0020)  
};
...
public:
	...
	SDK_UNDEFINED(80,12324) /* TMap<FGameplayTag, FVehicleCosmeticsAdditionalParameterInfos> */ __um(AdditionalVariantInfos); // 0x0210   (0x0050)  
	...
	SDK_UNDEFINED(32,12325) /* TWeakObjectPtr<USkeleton*> */ __um(WheelAttachSkeletonReference);                   // 0x0280   (0x0020)  
	TArray<FWheelAttachInfo>                           WheelAttachInfos;                                           // 0x02A0   (0x0010)  
	TArray<FBoosterAttachInfo>                         BoosterAttachInfos;                                         // 0x02B0   (0x0010)  
	SDK_UNDEFINED(32,12326) /* TWeakObjectPtr<UVehicleCosmeticsItemDefinition_Wheel*> */ __um(DefaultWheelItemDef); // 0x02C0   (0x0020)  
	FDataTableRowHandle                                DefaultSkinRow;                                             // 0x02E0   (0x0010)  
	SDK_UNDEFINED(32,12327) /* TWeakObjectPtr<UVehicleCosmeticsItemDefinition_EngineAudio*> */ __um(AudioData);    // 0x02F0   (0x0020)  
...
{ 
public:
	SDK_UNDEFINED(80,12328) /* TMap<FGameplayTag, FVehicleCosmeticsAdditionalParameterInfos> */ __um(AdditionalVariantInfos); // 0x01F0   (0x0050)  
};
...
{ 
public:
	SDK_UNDEFINED(32,12330) /* TWeakObjectPtr<USoundBase*> */ __um(EngineSound);                                   // 0x0030   (0x0020)  
	SDK_UNDEFINED(32,12331) /* TWeakObjectPtr<USoundBase*> */ __um(EngineSound_LowSpec);                           // 0x0050   (0x0020)  
...
{ 
public:
	SDK_UNDEFINED(32,12332) /* TWeakObjectPtr<UVehicleAudioCosmeticData*> */ __um(Data);                           // 0x01F0   (0x0020)  
};
...
public:
	...
	SDK_UNDEFINED(80,12333) /* TMap<FGameplayTag, FVehicleCosmeticsAdditionalParameterInfos> */ __um(AdditionalVariantInfos); // 0x0218   (0x0050)  
...
{ 
	SDK_UNDEFINED(32,12334) /* TWeakObjectPtr<USkeleton*> */ __um(WheelSkeletonReference);                         // 0x0000   (0x0020)  
