...
public:
	...
	SDK_UNDEFINED(16,40) /* FString */                 __um(PerObjectConfigSection);                               // 0x0050   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,41) /* TArray<FString> */         __um(EscalationSeverity);                                   // 0x0068   (0x0010)  
...
struct FStateStruct
{ 
	SDK_UNDEFINED(16,42) /* FString */                 __um(StateName);                                            // 0x0008   (0x0010)  
};
