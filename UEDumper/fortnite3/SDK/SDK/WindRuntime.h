...
{ 
	SDK_UNDEFINED(8,15502) /* TWeakObjectPtr<AActor*> */ __um(Target);                                             // 0x000C   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(1,15503) /* TEnumAsByte<ESplineMeshAxis> */ __um(MeshForwardAxis);                               // 0x0660   (0x0001)  
	...
	SDK_UNDEFINED(16,15504) /* TArray<TEnumAsByte<EObjectTypeQuery>> */ __um(TargetObjectTypes);                   // 0x06E8   (0x0010)  
	...
	SDK_UNDEFINED(80,15505) /* TMap<EFortPhysicsObjectType, FScalableFloat> */ __um(ObjectTypeToMaxTargetCount);   // 0x07C0   (0x0050)  
	...
	SDK_UNDEFINED(80,15506) /* TMap<EFortPhysicsSimSize, FWindSplineForceModifiers> */ __um(SizeForceModifiers);   // 0x0B30   (0x0050)  
	SDK_UNDEFINED(80,15507) /* TMap<EFortPhysicsObjectType, FWindSplineForceModifiers> */ __um(ObjectTypeForceModifiers); // 0x0B80   (0x0050)  
	...
	SDK_UNDEFINED(16,15508) /* FMulticastInlineDelegate */ __um(OnWindSplineDisabled);                             // 0x0D20   (0x0010)  
	SDK_UNDEFINED(16,15509) /* FMulticastInlineDelegate */ __um(OnWindSplineEnabled);                              // 0x0D30   (0x0010)  
