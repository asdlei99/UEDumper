...
public:
	...
	SDK_UNDEFINED(1,13883) /* TEnumAsByte<ETimelineDirection> */ __um(TFX_ResOutCharacterMesh__Direction_81C5527F43A6972D94623590BA582E8C); // 0x0564   (0x0001)  
	...
	SDK_UNDEFINED(1,13884) /* TEnumAsByte<ETimelineDirection> */ __um(TFX_GlowCharacterMesh__Direction_9EA15145493A8F1A5915938D5529A028); // 0x0574   (0x0001)  
	...
	SDK_UNDEFINED(80,13885) /* TSet<USkeletalMeshComponent*> */ __um(Dissolve);                                    // 0x05F0   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(1,13886) /* TEnumAsByte<ETimelineDirection> */ __um(TFX_ResOutCharacterMesh__Direction_E9C2D3554642468472CCCFA609A39FBC); // 0x0564   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x0565   (0x0003)  MISSED
	class UTimelineComponent*                          TFX_ResOutCharacterMesh;                                    // 0x0568   (0x0008)  
	float                                              TFX_GlowCharacterMesh_EmissiveWarp_39A37BC9407CF090A09ABDA5A488F776; // 0x0570   (0x0004)  
	SDK_UNDEFINED(1,13887) /* TEnumAsByte<ETimelineDirection> */ __um(TFX_GlowCharacterMesh__Direction_39A37BC9407CF090A09ABDA5A488F776); // 0x0574   (0x0001)  
	unsigned char                                      UnknownData01_5[0x3];                                       // 0x0575   (0x0003)  MISSED
	class UTimelineComponent*                          TFX_GlowCharacterMesh;                                      // 0x0578   (0x0008)  
	bool                                               DEBUG_ANIMATION;                                            // 0x0580   (0x0001)  
	bool                                               SpawnDrone;                                                 // 0x0581   (0x0001)  
	...
	class UMaterialInterface*                          Mat_Chracter_Dissolve;                                      // 0x05E0   (0x0008)  
	class APlayerPawn_Athena_C*                        Pawn;                                                       // 0x05E8   (0x0008)  
	SDK_UNDEFINED(80,13888) /* TSet<USkeletalMeshComponent*> */ __um(Dissolve);                                    // 0x05F0   (0x0050)  
	FName                                              Socket_Mesh_Top;                                            // 0x0640   (0x0004)  
	unsigned char                                      UnknownData03_5[0x4];                                       // 0x0644   (0x0004)  MISSED
	double                                             Max_Light_Intensity;                                        // 0x0648   (0x0008)  
	FName                                              Socket_Mesh_Bottom;                                         // 0x0650   (0x0004)  
...
public:
	...
	SDK_UNDEFINED(1,13889) /* TEnumAsByte<ETimelineDirection> */ __um(CapsuleFadeTL__Direction_D18D776D462C2233B7D3E1B7577403C1); // 0x055C   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(1,13890) /* TEnumAsByte<ETimelineDirection> */ __um(CapsuleFadeTL__Direction_B48F4431426ECD264BA37C992B6887C3); // 0x055C   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x055D   (0x0003)  MISSED
	class UTimelineComponent*                          CapsuleFadeTL;                                              // 0x0560   (0x0008)  
	double                                             Starting_Min_Capsule_Shadow_Vis;                            // 0x0568   (0x0008)  
	TArray<class USkeletalMeshComponent*>              SkeletalMesh;                                               // 0x0570   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(1,13891) /* TEnumAsByte<ETimelineDirection> */ __um(TFX_ResOutCharacterMesh__Direction_43B69932442AE90AB9E7D9819F3D3E71); // 0x0564   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x0565   (0x0003)  MISSED
	class UTimelineComponent*                          TFX_ResOutCharacterMesh;                                    // 0x0568   (0x0008)  
	float                                              TFX_GlowCharacterMesh_EmissiveWarp_580AB4094AE6911DB445A58F9580C544; // 0x0570   (0x0004)  
	SDK_UNDEFINED(1,13892) /* TEnumAsByte<ETimelineDirection> */ __um(TFX_GlowCharacterMesh__Direction_580AB4094AE6911DB445A58F9580C544); // 0x0574   (0x0001)  
	unsigned char                                      UnknownData01_5[0x3];                                       // 0x0575   (0x0003)  MISSED
	class UTimelineComponent*                          TFX_GlowCharacterMesh;                                      // 0x0578   (0x0008)  
	bool                                               DEBUG_ANIMATION;                                            // 0x0580   (0x0001)  
	bool                                               SpawnDrone;                                                 // 0x0581   (0x0001)  
	...
	class UMaterialInterface*                          Mat_Chracter_Dissolve;                                      // 0x05E0   (0x0008)  
	class APlayerPawn_Athena_C*                        Pawn;                                                       // 0x05E8   (0x0008)  
	SDK_UNDEFINED(80,13893) /* TSet<USkeletalMeshComponent*> */ __um(Dissolve);                                    // 0x05F0   (0x0050)  
	FName                                              Socket_Mesh_Top;                                            // 0x0640   (0x0004)  
	unsigned char                                      UnknownData03_5[0x4];                                       // 0x0644   (0x0004)  MISSED
	double                                             Max_Light_Intensity;                                        // 0x0648   (0x0008)  
	FName                                              Socket_Mesh_Bottom;                                         // 0x0650   (0x0004)  
