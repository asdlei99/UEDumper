...
public:
	...
	SDK_UNDEFINED(1,13894) /* TEnumAsByte<EFortTeamAffiliation> */ __um(TeamAffiliation);                          // 0x09E0   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(1,13895) /* TEnumAsByte<ETimelineDirection> */ __um(Sweep_Car_to_Normal__Direction_E45E3F1947E3780C879AA7B0F67B8AA0); // 0x09BC   (0x0001)  
	...
	SDK_UNDEFINED(16,13896) /* TScriptInterface<Class> */ __um(LocalFortVehicleInterface);                         // 0x09D0   (0x0010)  
	FTimerHandle                                       KeepCheckingTimer;                                          // 0x09E0   (0x0008)  
	TArray<class UMaterialInterface*>                  OG_Vehicle_Mats;                                            // 0x09E8   (0x0010)  
	SDK_UNDEFINED(80,13897) /* TSet<UMaterialInterface*> */ __um(OG_Wheel_Mats);                                   // 0x09F8   (0x0050)  
