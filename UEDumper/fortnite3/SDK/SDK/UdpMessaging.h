...
public:
	...
	SDK_UNDEFINED(16,15431) /* FString */              __um(UnicastEndpoint);                                      // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,15432) /* FString */              __um(MulticastEndpoint);                                    // 0x0048   (0x0010)  
	...
	SDK_UNDEFINED(16,15433) /* TArray<FString> */      __um(StaticEndpoints);                                      // 0x0060   (0x0010)  
	SDK_UNDEFINED(16,15434) /* TArray<FString> */      __um(ExcludedEndpoints);                                    // 0x0070   (0x0010)  
	...
	SDK_UNDEFINED(16,15435) /* FString */              __um(TunnelUnicastEndpoint);                                // 0x0088   (0x0010)  
	SDK_UNDEFINED(16,15436) /* FString */              __um(TunnelMulticastEndpoint);                              // 0x0098   (0x0010)  
	SDK_UNDEFINED(16,15437) /* TArray<FString> */      __um(RemoteTunnelEndpoints);                                // 0x00A8   (0x0010)  
};
