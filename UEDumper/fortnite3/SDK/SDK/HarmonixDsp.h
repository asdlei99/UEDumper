...
{
	EAdsrTarget__None                                                                = 0,
	EAdsrTarget__Volume                                                              = 1,
	EAdsrTarget__FilterFreq                                                          = 2,
	EAdsrTarget__Num                                                                 = 3,
	EAdsrTarget__Invalid                                                             = 4,
	EAdsrTarget__EAdsrTarget_MAX                                                     = 5
};
...
{ 
	...
	SDK_UNDEFINED(80,13462) /* TMap<FName, FTypedParameter> */ __um(PitchShifterOptions);                          // 0x0008   (0x0050)  
...
{ 
	...
	SDK_UNDEFINED(80,13463) /* TMap<FName, FStreamingChannelParamsArray> */ __um(PresetChannels);                  // 0x0020   (0x0050)  
};
...
{ 
	bool                                               IsEnabled;                                                  // 0x0000   (0x0001)  
	EAdsrTarget                                        Target;                                                     // 0x0001   (0x0001)  
	unsigned char                                      UnknownData00_5[0x2];                                       // 0x0002   (0x0002)  MISSED
...
{ 
	FAdsrSettings                                      Array;                                                      // 0x0010   (0x0240)  
};
...
{ 
	bool                                               IsEnabled;                                                  // 0x0000   (0x0001)  
	EWaveShape                                         Shape;                                                      // 0x0001   (0x0001)  
	ELfoTarget                                         Target;                                                     // 0x0002   (0x0001)  
...
{ 
	FLfoSettings                                       Array;                                                      // 0x0010   (0x0030)  
};
...
{ 
	FModulatorSettings                                 Array;                                                      // 0x0010   (0x0018)  
};
...
{ 
	FName                                              Name;                                                       // 0x0000   (0x0004)  
	float                                              VolumeDb;                                                   // 0x0004   (0x0004)  
	FPannerDetails                                     PannerDetails;                                              // 0x0008   (0x000C)  
	float                                              DownPitchBendCents;                                         // 0x0014   (0x0004)  
	float                                              UpPitchBendCents;                                           // 0x0018   (0x0004)  
	float                                              FineTuneCents;                                              // 0x001C   (0x0004)  
	float                                              StartPointOffsetMs;                                         // 0x0020   (0x0004)  
	int32_t                                            MaxVoices;                                                  // 0x0024   (0x0004)  
	EKeyzoneSelectMode                                 KeyzoneSelectMode;                                          // 0x0028   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x0029   (0x0003)  MISSED
	FPortamentoSettings                                Portamento;                                                 // 0x002C   (0x0008)  
	FBiquadFilterSettings                              Filter;                                                     // 0x0034   (0x0018)  
	FDelaySettings                                     Delay;                                                      // 0x004C   (0x003C)  
	FDistortionSettingsV1                              Distortion;                                                 // 0x0088   (0x0078)  
	FBitCrusherSettings                                BitCrusher;                                                 // 0x0100   (0x0014)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x0114   (0x0004)  MISSED
	FVocoderSettings                                   Vocoder;                                                    // 0x0118   (0x0050)  
	FAdsrSettingsArray                                 Adsrs;                                                      // 0x0168   (0x0250)  
	FLfoSettingsArray                                  Lfos;                                                       // 0x03B8   (0x0040)  
	FModulatorSettingsArray                            Randomizers;                                                // 0x03F8   (0x0028)  
	FModulatorSettingsArray                            VelocityModulators;                                         // 0x0420   (0x0028)  
};
...
{ 
	...
	TArray<FFusionPatchSettings>                       Presets;                                                    // 0x0010   (0x0010)  
	int32_t                                            CurrentPresetIndex;                                         // 0x0020   (0x0004)  
