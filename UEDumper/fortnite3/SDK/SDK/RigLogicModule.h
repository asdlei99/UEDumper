...
{ 
public:
	SDK_UNDEFINED(16,15094) /* FString */              __um(DnaFileName);                                          // 0x0028   (0x0010)  
...
{ 
	SDK_UNDEFINED(8,15095) /* TWeakObjectPtr<USkeletalMeshComponent*> */ __um(SkelMeshComponent);                  // 0x0000   (0x0008)  
