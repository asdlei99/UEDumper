...
{ 
	...
	SDK_UNDEFINED(32,13968) /* TWeakObjectPtr<UNiagaraSystem*> */ __um(CustomSystem);                              // 0x0008   (0x0020)  
...
{ 
	...
	SDK_UNDEFINED(16,13969) /* FString */              __um(ImportedMeshKey);                                      // 0x0070   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,13970) /* FString */              __um(ImportedMeshKey);                                      // 0x0058   (0x0010)  
};
...
{ 
	...
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x000C   (0x0004)  MISSED
	SDK_UNDEFINED(16,13971) /* FString */              __um(LocalBone);                                            // 0x0010   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,13972) /* FString */              __um(AttachmentName);                                       // 0x0668   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(8,13973) /* TWeakObjectPtr<UGroomAsset*> */ __um(GroomAsset);                                    // 0x0028   (0x0008)  
