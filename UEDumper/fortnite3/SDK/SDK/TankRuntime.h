...
{ 
	...
	SDK_UNDEFINED(1,15415) /* TEnumAsByte<ETankAimingMode> */ __um(AimingMode);                                    // 0x0140   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(24,15416) /* FText */                __um(SecondInteractText);                                   // 0x0A30   (0x0018)  
	SDK_UNDEFINED(1,15417) /* TEnumAsByte<TInteractionType> */ __um(SecondInteractType);                           // 0x0A48   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(16,15418) /* FMulticastInlineDelegate */ __um(OnTankRepairedDelegate);                           // 0x1F10   (0x0010)  
	...
	SDK_UNDEFINED(80,15419) /* TMap<FName, FTransform> */ __um(SocketTransformOverrideMap);                        // 0x1F48   (0x0050)  
	...
	SDK_UNDEFINED(16,15420) /* FString */              __um(RoadAndExhaustNiagaraComponentName);                   // 0x1FD8   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,15421) /* TMap<EVehicleSeats, FTankAnimAimingData> */ __um(AimingData);                       // 0x0790   (0x0050)  
