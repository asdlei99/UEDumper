...
{ 
public:
	SDK_UNDEFINED(16,13974) /* FString */              __um(Source);                                               // 0x0098   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(8,13975) /* TWeakObjectPtr<UObject*> */ __um(TypeObject);                                        // 0x0004   (0x0008)  
};
...
{ 
	SDK_UNDEFINED(16,13976) /* FString */              __um(Name);                                                 // 0x0000   (0x0010)  
	...
	SDK_UNDEFINED(16,13977) /* FString */              __um(HlslId);                                               // 0x0028   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(8,13978) /* TWeakObjectPtr<UOptimusComponentSourceBinding*> */ __um(ComponentSourceBinding);     // 0x0030   (0x0008)  
	SDK_UNDEFINED(16,13979) /* FString */              __um(NumThreadsExpression);                                 // 0x0038   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,13980) /* FString */              __um(Name);                                                 // 0x0000   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,13981) /* FString */              __um(Expression);                                           // 0x0020   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(8,13982) /* TWeakObjectPtr<UOptimusComponentSourceBinding*> */ __um(ComponentSourceBinding);     // 0x0070   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(24,13983) /* FText */                __um(DisplayName);                                          // 0x0030   (0x0018)  
	FVector2D                                          GraphPosition;                                              // 0x0048   (0x0010)  
	TArray<class UOptimusNodePin*>                     Pins;                                                       // 0x0058   (0x0010)  
	SDK_UNDEFINED(80,13984) /* TSet<FName> */          __um(ExpandedPins);                                         // 0x0068   (0x0050)  
...
{ 
	...
	SDK_UNDEFINED(16,13985) /* FString */              __um(Expression);                                           // 0x0008   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(16,13986) /* FString */              __um(ShaderSource);                                         // 0x0250   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,13987) /* FString */              __um(Declarations);                                         // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,13988) /* FString */              __um(ShaderText);                                           // 0x0010   (0x0010)  
};
...
public:
	unsigned char                                      UnknownData00_3[0x18];                                      // 0x0110   (0x0018)  MISSED
	SDK_UNDEFINED(8,13989) /* TWeakObjectPtr<UOptimusResourceDescription*> */ __um(ResourceDesc);                  // 0x0128   (0x0008)  
...
{ 
	...
	FOptimusDataTypeRef                                DataType;                                                   // 0x0004   (0x000C)  
	SDK_UNDEFINED(16,13990) /* FString */              __um(DefaultValue);                                         // 0x0010   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(8,13991) /* TWeakObjectPtr<UOptimusVariableDescription*> */ __um(VariableDesc);                  // 0x0120   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,13992) /* TWeakObjectPtr<UOptimusNodeSubGraph*> */ __um(OwningGraph);                          // 0x011C   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(16,13993) /* TArray<TWeakObjectPtr<UOptimusNode*>> */ __um(KernelToNode);                        // 0x0090   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,13994) /* FString */              __um(Expression);                                           // 0x0010   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(80,13995) /* TMap<FName, int32_t> */ __um(GroupNameToBindingIndex);                              // 0x0020   (0x0050)  
};
...
{ 
public:
	SDK_UNDEFINED(8,13996) /* TWeakObjectPtr<UOptimusDeformer*> */ __um(Deformer);                                 // 0x0028   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(8,13997) /* TWeakObjectPtr<UMeshComponent*> */ __um(MeshComponent);                              // 0x0028   (0x0008)  
	SDK_UNDEFINED(8,13998) /* TWeakObjectPtr<UOptimusDeformerInstanceSettings*> */ __um(InstanceSettings);         // 0x0030   (0x0008)  
	...
	SDK_UNDEFINED(16,13999) /* TArray<TWeakObjectPtr<UActorComponent*>> */ __um(WeakBoundComponents);              // 0x0050   (0x0010)  
	SDK_UNDEFINED(16,14000) /* TArray<TWeakObjectPtr<UOptimusComponentSource*>> */ __um(WeakComponentSources);     // 0x0060   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(8,14001) /* TWeakObjectPtr<UOptimusNode_GraphTerminal*> */ __um(EntryNode);                      // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,14002) /* TWeakObjectPtr<UOptimusNode_GraphTerminal*> */ __um(ReturnNode);                     // 0x00A8   (0x0008)  
};
...
public:
	...
	SDK_UNDEFINED(8,14003) /* TWeakObjectPtr<UOptimusComponentSourceBinding*> */ __um(ComponentBinding);           // 0x0038   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(16,14004) /* FString */              __um(SourceText);                                           // 0x0040   (0x0010)  
};
...
{ 
	FName                                              TypeName;                                                   // 0x0000   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0004   (0x0004)  MISSED
	SDK_UNDEFINED(24,14005) /* FText */                __um(DisplayName);                                          // 0x0008   (0x0018)  
	...
	SDK_UNDEFINED(8,14006) /* TWeakObjectPtr<UObject*> */ __um(TypeObject);                                        // 0x0030   (0x0008)  
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0004   (0x0004)  MISSED
	SDK_UNDEFINED(16,14007) /* FString */              __um(Value);                                                // 0x0008   (0x0010)  
};
