...
public:
	...
	unsigned char                                      UnknownData02_5[0x38];                                      // 0x00B8   (0x0038)  MISSED
	...
	unsigned char                                      UnknownData03_5[0x60];                                      // 0x0110   (0x0060)  MISSED
	...
	unsigned char                                      UnknownData04_5[0x10];                                      // 0x0200   (0x0010)  MISSED
	TArray<class UTexture*>                            LoadedPassThroughTexturesPendingSetMaterial;                // 0x0210   (0x0010)  
	unsigned char                                      UnknownData05_6[0x50];                                      // 0x0220   (0x0050)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData03_5[0x50];                                      // 0x0148   (0x0050)  MISSED
...
public:
	...
	unsigned char                                      UnknownData03_5[0x8];                                       // 0x0210   (0x0008)  MISSED
	...
	unsigned char                                      UnknownData04_6[0x8];                                       // 0x02D0   (0x0008)  MISSED
...
public:
	...
	unsigned char                                      UnknownData01_6[0xE8];                                      // 0x0060   (0x00E8)  MISSED
