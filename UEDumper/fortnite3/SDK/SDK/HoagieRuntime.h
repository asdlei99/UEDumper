...
public:
	...
	SDK_UNDEFINED(8,14017) /* TWeakObjectPtr<AFortHoagieVehicle*> */ __um(Vehicle);                                // 0x029C   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(16,14018) /* FMulticastInlineDelegate */ __um(OnBoostStateChanged);                              // 0x1F00   (0x0010)  
	SDK_UNDEFINED(16,14019) /* FMulticastInlineDelegate */ __um(OnAltimeterTraceUpdated);                          // 0x1F10   (0x0010)  
	SDK_UNDEFINED(16,14020) /* FMulticastInlineDelegate */ __um(OnCrashingStateEntered);                           // 0x1F20   (0x0010)  
	...
	SDK_UNDEFINED(16,14021) /* TArray<TEnumAsByte<EObjectTypeQuery>> */ __um(RotorWashObjectsTypes);               // 0x1F70   (0x0010)  
