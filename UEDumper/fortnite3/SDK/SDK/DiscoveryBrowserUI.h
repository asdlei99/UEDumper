...
public:
	...
	SDK_UNDEFINED(24,13173) /* FText */                __um(RichPresenceText);                                     // 0x0070   (0x0018)  
...
{ 
public:
	SDK_UNDEFINED(80,13174) /* TMap<UMaterialParameterCollection*, FColorSchemeParamaterValues> */ __um(MaterialCollectionOverrides); // 0x0030   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(80,13175) /* TMap<FName, UClass*> */ __um(RowTypes);                                             // 0x03A0   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(8,13176) /* TWeakObjectPtr<USocialUser*> */ __um(CachedTargetSocialUser);                        // 0x1538   (0x0008)  
	SDK_UNDEFINED(24,13177) /* FText */                __um(CurrentCTAButtonText);                                 // 0x1540   (0x0018)  
	SDK_UNDEFINED(24,13178) /* FText */                __um(JoinPartyText);                                        // 0x1558   (0x0018)  
	SDK_UNDEFINED(24,13179) /* FText */                __um(RequestToJoinText);                                    // 0x1570   (0x0018)  
...
{ 
public:
	SDK_UNDEFINED(16,13180) /* FMulticastInlineDelegate */ __um(OnActivityRequested);                              // 0x06C0   (0x0010)  
	...
	SDK_UNDEFINED(32,13181) /* TWeakObjectPtr<UClass*> */ __um(SoftCustomMatchmakingModalClass);                   // 0x0708   (0x0020)  
	SDK_UNDEFINED(32,13182) /* TWeakObjectPtr<UClass*> */ __um(SoftSpectateMatchModalClass);                       // 0x0728   (0x0020)  
...
public:
	unsigned char                                      UnknownData00_3[0xE8];                                      // 0x0298   (0x00E8)  MISSED
	float                                              DirectionalNavigationTimeThreshold;                         // 0x0380   (0x0004)  
	SDK_UNDEFINED(1,13183) /* TEnumAsByte<EOrientation> */ __um(orientation);                                      // 0x0384   (0x0001)  
	...
	SDK_UNDEFINED(80,13184) /* TMap<EActivityBrowserTileStyle, UClass*> */ __um(TileTypes);                        // 0x0390   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(80,13185) /* TMap<FName, UFortActivityBrowserColorSchemeAsset*> */ __um(ColorSchemes);           // 0x0078   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(16,13186) /* FMulticastInlineDelegate */ __um(OnActivitySelectedDelegate);                       // 0x1588   (0x0010)  
	SDK_UNDEFINED(16,13187) /* FMulticastInlineDelegate */ __um(OnActivityUnSelectedDelegate);                     // 0x1598   (0x0010)  
	...
	SDK_UNDEFINED(80,13188) /* TMap<uint32_t, ECreativeLinkPreviewSize> */ __um(MinColumnSizeToImageSize);         // 0x15E8   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(1,13189) /* TEnumAsByte<EOrientation> */ __um(orientation);                                      // 0x0398   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(80,13190) /* TMap<FName, float> */   __um(ScalarParameterValues);                                // 0x0008   (0x0050)  
	SDK_UNDEFINED(80,13191) /* TMap<FName, FLinearColor> */ __um(VectorParameterValues);                           // 0x0058   (0x0050)  
};
