...
{ 
public:
	SDK_UNDEFINED(80,15310) /* TMap<ESlatePostRT, USlateRHIPostBufferProcessor*> */ __um(SlatePostBufferProcessors); // 0x0030   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(80,15311) /* TMap<ESlatePostRT, FSlatePostSettings> */ __um(SlatePostSettings);                  // 0x0030   (0x0050)  
...
{ 
	...
	SDK_UNDEFINED(16,15312) /* FString */              __um(PathToSlatePostRT);                                    // 0x0010   (0x0010)  
