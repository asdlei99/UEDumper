...
{ 
public:
	SDK_UNDEFINED(32,15072) /* TWeakObjectPtr<UClass*> */ __um(EmotePickerClass);                                  // 0x0440   (0x0020)  
...
public:
	...
	SDK_UNDEFINED(80,15073) /* TMap<FString, TWeakObjectPtr<UPilgrimQuestNotificationEntry*>> */ __um(QuestWidgetMap); // 0x02F0   (0x0050)  
