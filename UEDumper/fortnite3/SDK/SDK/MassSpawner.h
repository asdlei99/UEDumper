...
{ 
	SDK_UNDEFINED(32,14307) /* TWeakObjectPtr<UMassEntityConfigAsset*> */ __um(EntityConfig);                      // 0x0000   (0x0020)  
...
{ 
public:
	SDK_UNDEFINED(16,14308) /* FMulticastInlineDelegate */ __um(OnSpawningFinishedEvent);                          // 0x0290   (0x0010)  
	SDK_UNDEFINED(16,14309) /* FMulticastInlineDelegate */ __um(OnDespawningFinishedEvent);                        // 0x02A0   (0x0010)  
