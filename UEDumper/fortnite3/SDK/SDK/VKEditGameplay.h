...
{ 
public:
	SDK_UNDEFINED(16,15470) /* TArray<TWeakObjectPtr<UObject*>> */ __um(Assets);                                   // 0x0030   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(32,15471) /* TWeakObjectPtr<UClass*> */ __um(EditorOnlyMinigameSettingsMachineClassToSpawn);     // 0x0710   (0x0020)  
	SDK_UNDEFINED(32,15472) /* TWeakObjectPtr<UClass*> */ __um(EditorOnlyWorldManagerClassToSpawn);                // 0x0730   (0x0020)  
