...
{ 
	SDK_UNDEFINED(32,12646) /* TWeakObjectPtr<UObject*> */ __um(Object);                                           // 0x0000   (0x0020)  
...
{ 
	...
	SDK_UNDEFINED(80,12647) /* TMap<FName, FString> */ __um(EventHandlerFunctionDefaultValues);                    // 0x0030   (0x0050)  
};
