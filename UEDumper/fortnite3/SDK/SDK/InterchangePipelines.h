...
public:
	...
	SDK_UNDEFINED(8,14126) /* TWeakObjectPtr<USkeleton*> */ __um(Skeleton);                                        // 0x00FC   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(80,14127) /* TMap<FString, FSoftObjectPath> */ __um(MaterialParents);                            // 0x0030   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(80,14128) /* TMap<EInterchangeMaterialXShaders, FSoftObjectPath> */ __um(PredefinedSurfaceShaders); // 0x0030   (0x0050)  
	SDK_UNDEFINED(80,14129) /* TMap<EInterchangeMaterialXBSDF, FSoftObjectPath> */ __um(PredefinedBSDF);           // 0x0080   (0x0050)  
	SDK_UNDEFINED(80,14130) /* TMap<EInterchangeMaterialXEDF, FSoftObjectPath> */ __um(PredefinedEDF);             // 0x00D0   (0x0050)  
	SDK_UNDEFINED(80,14131) /* TMap<EInterchangeMaterialXVDF, FSoftObjectPath> */ __um(PredefinedVDF);             // 0x0120   (0x0050)  
};
...
{ 
public:
	SDK_UNDEFINED(8,14132) /* TWeakObjectPtr<UInterchangeGenericCommonSkeletalMeshesAndAnimationsProperties*> */ __um(CommonSkeletalMeshesAndAnimationsProperties); // 0x00F8   (0x0008)  
	SDK_UNDEFINED(8,14133) /* TWeakObjectPtr<UInterchangeGenericCommonMeshesProperties*> */ __um(CommonMeshesProperties); // 0x0100   (0x0008)  
	...
	SDK_UNDEFINED(16,14134) /* TArray<FString> */      __um(MaterialCurveSuffixes);                                // 0x0120   (0x0010)  
	...
	SDK_UNDEFINED(16,14135) /* FString */              __um(SourceAnimationName);                                  // 0x0138   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,14136) /* FString */              __um(AssetName);                                            // 0x0100   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(8,14138) /* TWeakObjectPtr<UInterchangeGenericCommonMeshesProperties*> */ __um(CommonMeshesProperties); // 0x00F8   (0x0008)  
	SDK_UNDEFINED(8,14139) /* TWeakObjectPtr<UInterchangeGenericCommonSkeletalMeshesAndAnimationsProperties*> */ __um(CommonSkeletalMeshesAndAnimationsProperties); // 0x0100   (0x0008)  
	...
	SDK_UNDEFINED(8,14140) /* TWeakObjectPtr<UStaticMesh*> */ __um(DistanceFieldReplacementMesh);                  // 0x0144   (0x0008)  
	...
	SDK_UNDEFINED(8,14141) /* TWeakObjectPtr<UPhysicsAsset*> */ __um(PhysicsAsset);                                // 0x0158   (0x0008)  
...
public:
	...
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x00F9   (0x0007)  MISSED
	SDK_UNDEFINED(16,14142) /* FString */              __um(AssetName);                                            // 0x0100   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,14143) /* FString */              __um(MeshInstanceUid);                                      // 0x0000   (0x0010)  
	...
	SDK_UNDEFINED(80,14144) /* TMap<int32_t, FInterchangeLodSceneNodeContainer> */ __um(SceneNodePerLodIndex);     // 0x0020   (0x0050)  
	SDK_UNDEFINED(16,14145) /* TArray<FString> */      __um(ReferencingMeshGeometryUids);                          // 0x0070   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,14146) /* FString */              __um(MeshUid);                                              // 0x0000   (0x0010)  
	class UInterchangeMeshNode*                        MeshNode;                                                   // 0x0010   (0x0008)  
	SDK_UNDEFINED(16,14147) /* TArray<FString> */      __um(ReferencingMeshInstanceUids);                          // 0x0018   (0x0010)  
	SDK_UNDEFINED(16,14148) /* TArray<FString> */      __um(AttachedSocketUids);                                   // 0x0028   (0x0010)  
};
