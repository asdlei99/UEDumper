...
{ 
public:
	SDK_UNDEFINED(80,12681) /* TMap<FName, UCurveFloat*> */ __um(Surfaces);                                        // 0x00B0   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(8,12682) /* TWeakObjectPtr<AFortVehicleAudioController*> */ __um(AudioController);               // 0x00A8   (0x0008)  
...
{ 
	SDK_UNDEFINED(1,12683) /* TEnumAsByte<EPhysicalSurface> */ __um(Surface);                                      // 0x0000   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(80,12684) /* TMap<TEnumAsByte<EPhysicalSurface>, TEnumAsByte<EPhysicalSurface>> */ __um(SurfaceMap); // 0x0010   (0x0050)  
	...
	SDK_UNDEFINED(1,12685) /* TEnumAsByte<EPhysicalSurface> */ __um(CurrentSurface);                               // 0x0084   (0x0001)  
