...
public:
	...
	SDK_UNDEFINED(16,15468) /* FString */              __um(AddProjectsWithMnemonicEntitlementName);               // 0x0490   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,15469) /* FString */              __um(EntitlementName);                                      // 0x0028   (0x0010)  
};
