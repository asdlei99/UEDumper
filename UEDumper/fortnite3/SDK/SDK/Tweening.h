...
public:
	...
	SDK_UNDEFINED(8,15382) /* TWeakObjectPtr<USplineComponent*> */ __um(Spline);                                   // 0x0028   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(80,15383) /* TMap<int32_t, UObject*> */ __um(TweenContexts);                                     // 0x0038   (0x0050)  
