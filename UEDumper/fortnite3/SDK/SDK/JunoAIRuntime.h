...
public:
	...
	SDK_UNDEFINED(80,14187) /* TMap<FGameplayTag, UDataTable*> */ __um(ValidItemsTablePerType);                    // 0x18C0   (0x0050)  
...
{ 
public:
	unsigned char                                      UnknownData00_3[0x18];                                      // 0x01A8   (0x0018)  MISSED
...
{ 
	...
	SDK_UNDEFINED(1,14188) /* TEnumAsByte<EEnvQueryRunMode> */ __um(TeleportToPlayerRunMode);                      // 0x0080   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(16,14189) /* TArray<TEnumAsByte<EObjectTypeQuery>> */ __um(ShelterQueryTypes);                   // 0x0230   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(1,14190) /* TEnumAsByte<EEnvQueryRunMode> */ __um(TeleportToLandscapeRunMode);                   // 0x0080   (0x0001)  
	...
	SDK_UNDEFINED(1,14191) /* TEnumAsByte<EEnvQueryRunMode> */ __um(TeleportToNavmeshRunMode);                     // 0x00E0   (0x0001)  
...
{ 
public:
	SDK_UNDEFINED(16,14192) /* FMulticastInlineDelegate */ __um(OnJunoAICampPawnComponentChangedSoftRemovedReason); // 0x00A8   (0x0010)  
	...
	SDK_UNDEFINED(80,14193) /* TMap<FGameplayTag, FText> */ __um(AIRoleToDisplayText);                             // 0x0200   (0x0050)  
...
{ 
	...
	SDK_UNDEFINED(32,14194) /* TWeakObjectPtr<UFortAthenaLivingWorldEncounter*> */ __um(Encounter);                // 0x0368   (0x0020)  
...
public:
	...
	SDK_UNDEFINED(16,14195) /* TArray<TScriptInterface<Class>> */ __um(PointProviders);                            // 0x01B8   (0x0010)  
	...
	SDK_UNDEFINED(80,14196) /* TMap<int32_t, FDataTableRowHandle> */ __um(AwesomenessLevelToVisitorsPickingConfiguration); // 0x05E0   (0x0050)  
	SDK_UNDEFINED(80,14197) /* TMap<int32_t, UDataTable*> */ __um(AwesomenessLevelToNPCRewards);                   // 0x0630   (0x0050)  
...
{ 
	...
	FFortAthenaLivingWorldEventDataActorSpawnDescription SpawnDescriptionTemplate;                                 // 0x01B0   (0x0130)  
	FPointProviderFilterEntry                          FilterEntry;                                                // 0x02E0   (0x0088)  
	SDK_UNDEFINED(32,14198) /* TWeakObjectPtr<UFortAthenaLivingWorldEncounter*> */ __um(Encounter);                // 0x0368   (0x0020)  
...
{ 
	...
	SDK_UNDEFINED(16,14199) /* TArray<TScriptInterface<Class>> */ __um(PointProviders);                            // 0x0038   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,14200) /* TScriptInterface<Class> */ __um(TemporaryGlobalEncounterPointProvider);             // 0x0DA8   (0x0010)  
	class UFortAthenaLivingWorldEncounterInstance*     TemporaryGlobalEncounter;                                   // 0x0DB8   (0x0008)  
	SDK_UNDEFINED(16,14201) /* TScriptInterface<Class> */ __um(FTUEEncounterPointProvider);                        // 0x0DC0   (0x0010)  
	...
	SDK_UNDEFINED(80,14202) /* TMap<FGameplayTag, FJunoAIWorldNPCSpawningData> */ __um(WorldAssignedNPCs);         // 0x0EB8   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(8,14203) /* TWeakObjectPtr<AActor*> */ __um(BlockedByActor);                                     // 0x0124   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(1,14204) /* TEnumAsByte<EPathObstacleAction> */ __um(PathObstacleAction);                        // 0x0168   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(16,14205) /* FString */              __um(ValidItemPersistentName);                              // 0x0010   (0x0010)  
...
{ 
	SDK_UNDEFINED(32,14206) /* TWeakObjectPtr<UJunoBuildInstructionsItemDefinition*> */ __um(KnowledgeItemDefinition); // 0x0000   (0x0020)  
...
{ 
	SDK_UNDEFINED(8,14207) /* TWeakObjectPtr<AFortAthenaLivingWorldStaticPointProvider*> */ __um(VillagerProvider); // 0x0000   (0x0008)  
...
{ 
	...
	SDK_UNDEFINED(8,14209) /* TWeakObjectPtr<AActor*> */ __um(Villager);                                           // 0x0008   (0x0008)  
...
{ 
	SDK_UNDEFINED(8,14210) /* TWeakObjectPtr<UObject*> */ __um(AssignedPointProvider);                             // 0x0000   (0x0008)  
	unsigned char                                      UnknownData00_5[0x10];                                      // 0x0008   (0x0010)  MISSED
	SDK_UNDEFINED(8,14211) /* TWeakObjectPtr<UFortAthenaLivingWorldEventData*> */ __um(EventData);                 // 0x0018   (0x0008)  
...
{ 
	...
	SDK_UNDEFINED(8,14212) /* TWeakObjectPtr<UFortAthenaLivingWorldEventData*> */ __um(EventData);                 // 0x0060   (0x0008)  
	SDK_UNDEFINED(8,14213) /* TWeakObjectPtr<UPlayspaceComponent_Root_JunoAIManagement*> */ __um(CachedRootJunoAIManagement); // 0x0068   (0x0008)  
...
{ 
	SDK_UNDEFINED(8,14214) /* TWeakObjectPtr<UPlayspaceComponent_JunoAIPersistence*> */ __um(CachedRootAIPersistence); // 0x0008   (0x0008)  
