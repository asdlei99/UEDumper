...
{ 
public:
	SDK_UNDEFINED(24,13467) /* FText */                __um(Label);                                                // 0x0068   (0x0018)  
	SDK_UNDEFINED(24,13468) /* FText */                __um(Value);                                                // 0x0080   (0x0018)  
...
public:
	...
	SDK_UNDEFINED(1,13469) /* TEnumAsByte<EHorizontalAlignment> */ __um(HorizontalAlignment);                      // 0x0038   (0x0001)  
	SDK_UNDEFINED(1,13470) /* TEnumAsByte<EVerticalAlignment> */ __um(VerticalAlignment);                          // 0x0039   (0x0001)  
