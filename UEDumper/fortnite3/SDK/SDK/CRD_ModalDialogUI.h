...
{ 
public:
	SDK_UNDEFINED(24,12461) /* FText */                __um(Title);                                                // 0x0068   (0x0018)  
	SDK_UNDEFINED(24,12462) /* FText */                __um(Body);                                                 // 0x0080   (0x0018)  
	class UDataTable*                                  TextStyleSet;                                               // 0x0098   (0x0008)  
	SDK_UNDEFINED(24,12463) /* FText */                __um(Button01_MainText);                                    // 0x00A0   (0x0018)  
	SDK_UNDEFINED(24,12464) /* FText */                __um(Button02_MainText);                                    // 0x00B8   (0x0018)  
	SDK_UNDEFINED(24,12465) /* FText */                __um(Button03_MainText);                                    // 0x00D0   (0x0018)  
	SDK_UNDEFINED(24,12466) /* FText */                __um(Button04_MainText);                                    // 0x00E8   (0x0018)  
	SDK_UNDEFINED(24,12467) /* FText */                __um(Button05_MainText);                                    // 0x0100   (0x0018)  
	SDK_UNDEFINED(24,12468) /* FText */                __um(Button06_MainText);                                    // 0x0118   (0x0018)  
	SDK_UNDEFINED(24,12469) /* FText */                __um(Button01_SubText);                                     // 0x0130   (0x0018)  
	SDK_UNDEFINED(24,12470) /* FText */                __um(Button02_SubText);                                     // 0x0148   (0x0018)  
	SDK_UNDEFINED(24,12471) /* FText */                __um(Button03_SubText);                                     // 0x0160   (0x0018)  
	SDK_UNDEFINED(24,12472) /* FText */                __um(Button04_SubText);                                     // 0x0178   (0x0018)  
	SDK_UNDEFINED(24,12473) /* FText */                __um(Button05_SubText);                                     // 0x0190   (0x0018)  
	SDK_UNDEFINED(24,12474) /* FText */                __um(Button06_SubText);                                     // 0x01A8   (0x0018)  
