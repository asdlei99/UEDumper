...
{ 
	...
	SDK_UNDEFINED(16,14879) /* FString */              __um(EventName);                                            // 0x0010   (0x0010)  
	int64_t                                            Time;                                                       // 0x0020   (0x0008)  
	SDK_UNDEFINED(16,14880) /* FString */              __um(Parameter);                                            // 0x0028   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(80,14881) /* TMap<FString, UMediaPlayer*> */ __um(MediaPlayerMap);                               // 0x0290   (0x0050)  
	...
	SDK_UNDEFINED(16,14882) /* FString */              __um(ScreenName);                                           // 0x0430   (0x0010)  
