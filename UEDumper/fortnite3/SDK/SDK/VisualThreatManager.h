...
public:
	...
	// void OnWindImpulseCylinderDeath(FFortWindImpulseCylinder& WindImpulseCylinder);                                       // [0x2047e54] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Game/VisualThreatManager/WindManager.WindManager_C.OnWindImpulseCylinderDeltaComplete
	// void OnWindImpulseCylinderDeltaComplete(FFortWindImpulseCylinder& WindImpulseCylinder);                               // [0x2047e54] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Game/VisualThreatManager/WindManager.WindManager_C.OnWindImpulseCylinderCreation
	// void OnWindImpulseCylinderCreation(FFortWindImpulseCylinder& WindImpulseCylinder, FFortWindImpulseCylinderDelta& WindImpulseCylinderDelta); // [0x2047e54] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Game/VisualThreatManager/WindManager.WindManager_C.SpawnTestWind
	// void SpawnTestWind(double Radius, double ImpulseMagnitude);                                                           // [0x2047e54] BlueprintCallable|BlueprintEvent 
	// Function /Game/VisualThreatManager/WindManager.WindManager_C.Play Water Splash Particle System At Location
	// void Play Water Splash Particle System At Location(FTransform Particle Transform);                                    // [0x2047e54] BlueprintCallable|BlueprintEvent 
	// Function /Game/VisualThreatManager/WindManager.WindManager_C.AddWindParticleSystemComponent
	// void AddWindParticleSystemComponent(class UParticleSystemComponent* ParticleSystemComponent);                         // [0x2047e54] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/VisualThreatManager/WindManager.WindManager_C.Register player for render to texture purposes
	// void Register player for render to texture purposes(class UPrimitiveComponent* Effect Water Interaction FX, class UPrimitiveComponent* Gameplay Wind INteraction Effects); // [0x2047e54] BlueprintCallable|BlueprintEvent 
	// Function /Game/VisualThreatManager/WindManager.WindManager_C.Add Wind Component
	// void Add Wind Component(class UPrimitiveComponent* InComponent);                                                      // [0x2047e54] BlueprintCallable|BlueprintEvent 
	...
	// void Update Test(double NewMagnitude);                                                                                // [0x2047e54] BlueprintCallable|BlueprintEvent 
	// Function /Game/VisualThreatManager/WindManager.WindManager_C.Add Render To Texture Particle
	// void Add Render To Texture Particle(class UParticleSystem* EmitterTemplate, FTransform& InTransform);                 // [0x2047e54] HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/VisualThreatManager/WindManager.WindManager_C.ExecuteUbergraph_WindManager
	// void ExecuteUbergraph_WindManager(int32_t EntryPoint);                                                                // [0x2047e54] Final|HasDefaults    
};
...
public:
	...
	SDK_UNDEFINED(1,15462) /* TEnumAsByte<ETimelineDirection> */ __um(Ramp_Up_down_values_on_death__Direction_1CA080D642E9F1C3CB297DBE1BD2C9A4); // 0x02BC   (0x0001)  
	...
	SDK_UNDEFINED(16,15463) /* FMulticastInlineDelegate */ __um(NewEventDispatcher);                               // 0x02C8   (0x0010)  
	SDK_UNDEFINED(16,15464) /* FMulticastInlineDelegate */ __um(NewEventDispatcher0);                              // 0x02D8   (0x0010)  
	...
	SDK_UNDEFINED(16,15465) /* TScriptInterface<Class> */ __um(CameraLensEffectInterface);                         // 0x0400   (0x0010)  
	...
	// void SetForceOff(bool bForceOff);                                                                                     // [0x2047e54] Public|BlueprintCallable|BlueprintEvent 
	...
	// void CalculatePlayerPositionNearBox(FVector BoxMin, FVector BoxMax, double& VolumePlayerCoveragePercentage);          // [0x2047e54] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void Ramp Up down values on death__FinishedFunc();                                                                    // [0x2047e54] BlueprintEvent       
	...
	// void Ramp Up down values on death__UpdateFunc();                                                                      // [0x2047e54] BlueprintEvent       
	...
	// void OnThreatCloudsChanged(TArray<FThreatLocationInfo>& ThreatLocationInfo);                                          // [0x2047e54] Event|Public|HasOutParms|BlueprintEvent 
	...
	// void OnWorldReady();                                                                                                  // [0x2047e54] Event|Protected|BlueprintEvent 
	...
	// void VFX_RainTracePeriodic();                                                                                         // [0x2047e54] BlueprintCallable|BlueprintEvent 
	...
	// void StartTraceTimer();                                                                                               // [0x2047e54] BlueprintCallable|BlueprintEvent 
	...
	// void ForceUpdateLensEffect();                                                                                         // [0x2047e54] BlueprintCallable|BlueprintEvent 
	...
	// void OnThreatOverrideChanged(bool bForceThreatOn);                                                                    // [0x2047e54] Event|Public|BlueprintEvent 
	...
	// void ExecuteUbergraph_ThreatPostProcessManagerAndParticleBlueprint(int32_t EntryPoint);                               // [0x2047e54] Final|HasDefaults    
	...
	// void NewEventDispatcher0__DelegateSignature();                                                                        // [0x2047e54] Public|Delegate|BlueprintCallable|BlueprintEvent 
...
public:
	...
	SDK_UNDEFINED(1,15466) /* TEnumAsByte<ETimelineDirection> */ __um(Alpha__Direction_06897833405CC2B231B02C93C4E725A3); // 0x038C   (0x0001)  
	...
	// void ExecuteUbergraph_B_CameraRainDrops_01(int32_t EntryPoint);                                                       // [0x2047e54] Final                
};
