...
public:
	...
	SDK_UNDEFINED(8,15487) /* TWeakObjectPtr<UMeshComponent*> */ __um(MeshComponentPtr);                           // 0x0294   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(16,15488) /* FMulticastInlineDelegate */ __um(OnWeaponModSlotsChanged);                          // 0x00A8   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,15489) /* TMap<FGameplayTag, FFortModSlotPurchaseList> */ __um(ModSlotPurchaseLists);         // 0x00A8   (0x0050)  
	SDK_UNDEFINED(80,15490) /* TMap<FPrimaryAssetId, FFortModStationDataRow> */ __um(ModCostMap);                  // 0x00F8   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(16,15491) /* FMulticastInlineDelegate */ __um(OnLocalModPurchaseStarted);                        // 0x00A8   (0x0010)  
	SDK_UNDEFINED(16,15492) /* FMulticastInlineDelegate */ __um(OnStartInteractWithWorkbenchActor);                // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,15493) /* FMulticastInlineDelegate */ __um(OnStopInteractWithWorkbenchActor);                 // 0x00C8   (0x0010)  
