...
public:
	...
	SDK_UNDEFINED(16,14818) /* FMulticastInlineDelegate */ __um(FoundTargetDelegate);                              // 0x0240   (0x0010)  
	SDK_UNDEFINED(16,14819) /* FMulticastInlineDelegate */ __um(DeactivateReticleDelegate);                        // 0x0250   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(1,14820) /* TEnumAsByte<ECollisionChannel> */ __um(TraceChannel);                                // 0x0A2C   (0x0001)  
...
{ 
	SDK_UNDEFINED(24,14821) /* FText */                __um(CategoryLabelText);                                    // 0x0000   (0x0018)  
	...
	SDK_UNDEFINED(8,14822) /* TWeakObjectPtr<APlayerState*> */ __um(Sender);                                       // 0x0028   (0x0008)  
};
