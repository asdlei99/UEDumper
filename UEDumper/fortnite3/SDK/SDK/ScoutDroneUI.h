...
public:
	...
	SDK_UNDEFINED(8,15277) /* TWeakObjectPtr<UFortControllerComponent_Interaction*> */ __um(InteractionComponent); // 0x0068   (0x0008)  
...
{ 
	...
	SDK_UNDEFINED(8,15278) /* TWeakObjectPtr<UWidget*> */ __um(WeakWdiget);                                        // 0x0020   (0x0008)  
};
