...
{ 
	SDK_UNDEFINED(16,15085) /* FString */              __um(address);                                              // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,15086) /* FString */              __um(ID);                                                   // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,15087) /* FString */              __um(RegionId);                                             // 0x0010   (0x0010)  
...
{ 
	SDK_UNDEFINED(24,15088) /* FText */                __um(DisplayName);                                          // 0x0000   (0x0018)  
	SDK_UNDEFINED(16,15089) /* FString */              __um(RegionId);                                             // 0x0018   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,15090) /* FString */              __um(SubspaceDelimiter);                                    // 0x0038   (0x0010)  
	...
	SDK_UNDEFINED(16,15091) /* FString */              __um(ForceRegionId);                                        // 0x0090   (0x0010)  
	bool                                               bRegionForcedViaCommandline;                                // 0x00A0   (0x0001)  
	unsigned char                                      UnknownData03_5[0x7];                                       // 0x00A1   (0x0007)  MISSED
	SDK_UNDEFINED(16,15092) /* FString */              __um(SelectedRegionId);                                     // 0x00A8   (0x0010)  
