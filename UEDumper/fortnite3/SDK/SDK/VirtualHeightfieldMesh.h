...
public:
	...
	SDK_UNDEFINED(1,15460) /* TEnumAsByte<EMaterialSamplerType> */ __um(SamplerType);                              // 0x00B8   (0x0001)  
...
{ 
public:
	SDK_UNDEFINED(32,15461) /* TWeakObjectPtr<ARuntimeVirtualTextureVolume*> */ __um(VirtualTexture);              // 0x0500   (0x0020)  
