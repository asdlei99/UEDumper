...
public:
	...
	SDK_UNDEFINED(16,14663) /* TArray<TScriptInterface<Class>> */ __um(QuestOffering);                             // 0x00B8   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_3[0x18];                                      // 0x00A0   (0x0018)  MISSED
	SDK_UNDEFINED(80,14664) /* TMap<char, FSquadMatchQuests> */ __um(SquadQuestsMap);                              // 0x00B8   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(16,14665) /* TArray<TScriptInterface<Class>> */ __um(QuestOffering);                             // 0x00D0   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,14666) /* TArray<TScriptInterface<Class>> */ __um(SquadOffer);                                // 0x0000   (0x0010)  
