...
{ 
	...
	SDK_UNDEFINED(80,12363) /* TMap<FRigElementKey, int32_t> */ __um(KeyToIndex);                                  // 0x0018   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(80,12364) /* TMap<FName, int32_t> */ __um(EventToIndex);                                         // 0x0010   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(16,12365) /* FString */              __um(Name);                                                 // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,12366) /* FString */              __um(Type);                                                 // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,12367) /* FString */              __um(ScriptStructPath);                                     // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,12368) /* FString */              __um(ExportedText);                                         // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,12369) /* FString */              __um(Description);                                          // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,12370) /* FString */              __um(Name);                                                 // 0x0000   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,12371) /* TMap<FRigElementKey, FRigControlElementCustomization> */ __um(ControlCustomizations); // 0x0290   (0x0050)  
	class URigHierarchy*                               DynamicHierarchy;                                           // 0x02E0   (0x0008)  
	SDK_UNDEFINED(16,12372) /* TArray<TWeakObjectPtr<UControlRigShapeLibrary*>> */ __um(ShapeLibraries);           // 0x02E8   (0x0010)  
	SDK_UNDEFINED(80,12373) /* TMap<FString, FString> */ __um(ShapeLibraryNameMap);                                // 0x02F8   (0x0050)  
	...
	SDK_UNDEFINED(80,12374) /* TMap<FName, UDataAssetLink*> */ __um(ExternalVariableDataAssetLinks);               // 0x0750   (0x0050)  
	unsigned char                                      UnknownData06_5[0xD0];                                      // 0x07A0   (0x00D0)  MISSED
	SDK_UNDEFINED(1,12375) /* FMulticastSparseDelegate */ __um(OnControlSelected_BP);                              // 0x0870   (0x0001)  
	...
	SDK_UNDEFINED(16,12376) /* FString */              __um(RigModuleNameSpace);                                   // 0x0A10   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,12377) /* FString */              __um(ParentPath);                                           // 0x0010   (0x0010)  
	SDK_UNDEFINED(80,12378) /* TMap<FName, FRigVMExternalVariable> */ __um(VariableBindings);                      // 0x0020   (0x0050)  
...
{ 
	FName                                              Name;                                                       // 0x0000   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0004   (0x0004)  MISSED
	SDK_UNDEFINED(16,12379) /* FString */              __um(ShortName);                                            // 0x0008   (0x0010)  
	bool                                               bShortNameBasedOnPath;                                      // 0x0018   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0019   (0x0007)  MISSED
	SDK_UNDEFINED(16,12380) /* FString */              __um(ParentPath);                                           // 0x0020   (0x0010)  
	SDK_UNDEFINED(32,12381) /* TWeakObjectPtr<UClass*> */ __um(Class);                                             // 0x0030   (0x0020)  
	SDK_UNDEFINED(80,12382) /* TMap<FRigElementKey, FRigElementKey> */ __um(Connections);                          // 0x0050   (0x0050)  
	SDK_UNDEFINED(80,12383) /* TMap<FName, FString> */ __um(ConfigValues);                                         // 0x00A0   (0x0050)  
	SDK_UNDEFINED(80,12384) /* TMap<FName, FString> */ __um(Bindings);                                             // 0x00F0   (0x0050)  
	FName                                              PreviousName;                                               // 0x0140   (0x0004)  
	unsigned char                                      UnknownData02_5[0x4];                                       // 0x0144   (0x0004)  MISSED
	SDK_UNDEFINED(16,12385) /* FString */              __um(PreviousParentPath);                                   // 0x0148   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,12386) /* FString */              __um(ModulePath);                                           // 0x0000   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,12387) /* FMulticastInlineDelegate */ __um(ModifiedEventDynamic);                             // 0x0040   (0x0010)  
	...
	SDK_UNDEFINED(80,12388) /* TMap<FRigElementKey, FRigElementKey> */ __um(PreviousNameMap);                      // 0x02B0   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(32,12389) /* TWeakObjectPtr<UControlRig*> */ __um(ControlRig);                                   // 0x0058   (0x0020)  
...
public:
	...
	SDK_UNDEFINED(16,12390) /* FMulticastInlineDelegate */ __um(OnPreInitializeDelegate);                          // 0x0508   (0x0010)  
	SDK_UNDEFINED(16,12391) /* FMulticastInlineDelegate */ __um(OnPostInitializeDelegate);                         // 0x0518   (0x0010)  
	SDK_UNDEFINED(16,12392) /* FMulticastInlineDelegate */ __um(OnPreConstructionDelegate);                        // 0x0528   (0x0010)  
	SDK_UNDEFINED(16,12393) /* FMulticastInlineDelegate */ __um(OnPostConstructionDelegate);                       // 0x0538   (0x0010)  
	SDK_UNDEFINED(16,12394) /* FMulticastInlineDelegate */ __um(OnPreForwardsSolveDelegate);                       // 0x0548   (0x0010)  
	SDK_UNDEFINED(16,12395) /* FMulticastInlineDelegate */ __um(OnPostForwardsSolveDelegate);                      // 0x0558   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,12396) /* FString */              __um(ColorParameter);                                       // 0x02B0   (0x0010)  
	...
	SDK_UNDEFINED(32,12397) /* TWeakObjectPtr<UControlRig*> */ __um(ControlRig);                                   // 0x02D0   (0x0020)  
...
public:
	...
	SDK_UNDEFINED(8,12398) /* TWeakObjectPtr<UControlRig*> */ __um(ControlRig);                                    // 0x02A4   (0x0008)  
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0004   (0x0004)  MISSED
	SDK_UNDEFINED(32,12399) /* TWeakObjectPtr<UStaticMesh*> */ __um(StaticMesh);                                   // 0x0008   (0x0020)  
...
public:
	...
	SDK_UNDEFINED(32,12400) /* TWeakObjectPtr<UMaterial*> */ __um(DefaultMaterial);                                // 0x00D0   (0x0020)  
	SDK_UNDEFINED(32,12401) /* TWeakObjectPtr<UMaterial*> */ __um(XRayMaterial);                                   // 0x00F0   (0x0020)  
...
{ 
	...
	SDK_UNDEFINED(16,12402) /* FString */              __um(Value);                                                // 0x0008   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(8,12403) /* TWeakObjectPtr<URigHierarchy*> */ __um(WeakHierarchy);                               // 0x002C   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(80,12404) /* TMap<FName, FChannelMapInfo> */ __um(ControlChannelMap);                            // 0x02D8   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(80,12405) /* TMap<FName, FControlRotationOrder> */ __um(ControlsRotationOrder);                  // 0x0100   (0x0050)  
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(16,12406) /* FString */              __um(RightSide);                                            // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,12407) /* FString */              __um(LeftSide);                                             // 0x0038   (0x0010)  
	SDK_UNDEFINED(1,12408) /* TEnumAsByte<EAxis> */    __um(MirrorAxis);                                           // 0x0048   (0x0001)  
	SDK_UNDEFINED(1,12409) /* TEnumAsByte<EAxis> */    __um(AxisToFlip);                                           // 0x0049   (0x0001)  
...
{ 
public:
	SDK_UNDEFINED(1,12410) /* TEnumAsByte<ERigTransformType> */ __um(TransformType);                               // 0x00B0   (0x0001)  
...
{ 
	FRigElementKey                                     Key;                                                        // 0x0000   (0x0008)  
	SDK_UNDEFINED(1,12411) /* TEnumAsByte<ERigTransformStackEntryType> */ __um(EntryType);                         // 0x0008   (0x0001)  
	SDK_UNDEFINED(1,12412) /* TEnumAsByte<ERigTransformType> */ __um(TransformType);                               // 0x0009   (0x0001)  
	unsigned char                                      UnknownData00_5[0x6];                                       // 0x000A   (0x0006)  MISSED
	...
	SDK_UNDEFINED(16,12413) /* TArray<FString> */      __um(Callstack);                                            // 0x00D8   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,12414) /* FString */              __um(Description);                                          // 0x0080   (0x0010)  
};
...
{ 
	FRigElementKey                                     Key;                                                        // 0x0000   (0x0008)  
	SDK_UNDEFINED(16,12415) /* FString */              __um(Content);                                              // 0x0008   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,12416) /* TArray<FString> */      __um(Contents);                                             // 0x0020   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(8,12417) /* TWeakObjectPtr<UNodeMappingContainer*> */ __um(NodeMappingContainer);                // 0x0210   (0x0008)  
...
{ 
	...
	SDK_UNDEFINED(80,12418) /* TMap<FName, FName> */   __um(InputMapping);                                         // 0x02E8   (0x0050)  
	SDK_UNDEFINED(80,12419) /* TMap<FName, FName> */   __um(OutputMapping);                                        // 0x0338   (0x0050)  
...
{ 
	SDK_UNDEFINED(8,12420) /* TWeakObjectPtr<UControlRig*> */ __um(ControlRig);                                    // 0x0248   (0x0008)  
};
...
{ 
	...
	SDK_UNDEFINED(24,12421) /* FText */                __um(Message);                                              // 0x0010   (0x0018)  
};
...
{ 
	...
	SDK_UNDEFINED(24,12422) /* FText */                __um(Message);                                              // 0x0030   (0x0018)  
};
...
{ 
	SDK_UNDEFINED(80,12423) /* TMap<FString, bool> */  __um(Values);                                               // 0x0000   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(1,12424) /* TEnumAsByte<ECollisionChannel> */ __um(Channel);                                     // 0x0038   (0x0001)  
...
{ 
	FVector                                            Start;                                                      // 0x0008   (0x0018)  
	FVector                                            End;                                                        // 0x0020   (0x0018)  
	SDK_UNDEFINED(1,12425) /* TEnumAsByte<ETraceTypeQuery> */ __um(TraceChannel);                                  // 0x0038   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x0039   (0x0003)  MISSED
	float                                              Radius;                                                     // 0x003C   (0x0004)  
	bool                                               bHit;                                                       // 0x0040   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0041   (0x0007)  MISSED
...
{ 
	FVector                                            Start;                                                      // 0x0008   (0x0018)  
	FVector                                            End;                                                        // 0x0020   (0x0018)  
	SDK_UNDEFINED(16,12426) /* TArray<TEnumAsByte<EObjectTypeQuery>> */ __um(ObjectTypes);                         // 0x0038   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,12427) /* FString */              __um(NameSpace);                                            // 0x01D0   (0x0010)  
	SDK_UNDEFINED(16,12428) /* FString */              __um(Path);                                                 // 0x01E0   (0x0010)  
	SDK_UNDEFINED(16,12429) /* FString */              __um(LibraryName);                                          // 0x01F0   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,12430) /* FString */              __um(Prefix);                                               // 0x0108   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,12431) /* FString */              __um(Description);                                          // 0x0268   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,12432) /* FString */              __um(NameSpace);                                            // 0x0008   (0x0010)  
};
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x0011   (0x0007)  MISSED
	SDK_UNDEFINED(16,12433) /* FString */              __um(NameSpace);                                            // 0x0018   (0x0010)  
};
...
{ 
	FRigElementKey                                     Item;                                                       // 0x01D0   (0x0008)  
	SDK_UNDEFINED(16,12434) /* FString */              __um(Pattern);                                              // 0x01D8   (0x0010)  
...
{ 
	TArray<FConstraintData>                            ConstraintData;                                             // 0x0000   (0x0010)  
	SDK_UNDEFINED(80,12435) /* TMap<int32_t, int32_t> */ __um(ConstraintDataToTargets);                            // 0x0010   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(16,12436) /* FString */              __um(Message);                                              // 0x01E0   (0x0010)  
};
