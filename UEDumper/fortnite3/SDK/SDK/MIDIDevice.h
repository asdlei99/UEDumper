...
{ 
public:
	SDK_UNDEFINED(16,14794) /* FMulticastInlineDelegate */ __um(OnMIDIEvent);                                      // 0x0028   (0x0010)  
	int32_t                                            DeviceID;                                                   // 0x0038   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x003C   (0x0004)  MISSED
	SDK_UNDEFINED(16,14795) /* FString */              __um(DeviceName);                                           // 0x0040   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,14796) /* FMulticastInlineDelegate */ __um(OnMIDINoteOn);                                     // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,14797) /* FMulticastInlineDelegate */ __um(OnMIDINoteOff);                                    // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,14798) /* FMulticastInlineDelegate */ __um(OnMIDIPitchBend);                                  // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,14799) /* FMulticastInlineDelegate */ __um(OnMIDIAftertouch);                                 // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,14800) /* FMulticastInlineDelegate */ __um(OnMIDIControlChange);                              // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,14801) /* FMulticastInlineDelegate */ __um(OnMIDIProgramChange);                              // 0x0078   (0x0010)  
	SDK_UNDEFINED(16,14802) /* FMulticastInlineDelegate */ __um(OnMIDIChannelAftertouch);                          // 0x0088   (0x0010)  
	...
	SDK_UNDEFINED(16,14803) /* FString */              __um(DeviceName);                                           // 0x00B8   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,14804) /* FString */              __um(DeviceName);                                           // 0x0030   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,14805) /* FString */              __um(DeviceName);                                           // 0x0008   (0x0010)  
...
{ 
	int32_t                                            DeviceID;                                                   // 0x0000   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0004   (0x0004)  MISSED
	SDK_UNDEFINED(16,14806) /* FString */              __um(DeviceName);                                           // 0x0008   (0x0010)  
