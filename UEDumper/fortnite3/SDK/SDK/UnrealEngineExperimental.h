...
{ 
	SDK_UNDEFINED(16,15438) /* FString */              __um(FilePath);                                             // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(1,15439) /* TEnumAsByte<EScriptDiagnosticMessageType> */ __um(MessageType);                      // 0x0000   (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x0001   (0x0007)  MISSED
	FDateTime                                          Timestamp;                                                  // 0x0008   (0x0008)  
	SDK_UNDEFINED(16,15440) /* FString */              __um(Channel);                                              // 0x0010   (0x0010)  
	SDK_UNDEFINED(24,15441) /* FText */                __um(MessageStr);                                           // 0x0020   (0x0018)  
...
{ 
	...
	SDK_UNDEFINED(16,15442) /* FString */              __um(Prefix);                                               // 0x0038   (0x0010)  
