...
class alignas(0x10) 
UMassDistanceVisualizationTrait : public UMassEntityTraitBase
{ 
public:
...
{ 
	SDK_UNDEFINED(1,14316) /* TEnumAsByte<EMassLOD> */ __um(LOD);                                                  // 0x0000   (0x0001)  
	SDK_UNDEFINED(1,14317) /* TEnumAsByte<EMassLOD> */ __um(PrevLOD);                                              // 0x0001   (0x0001)  
