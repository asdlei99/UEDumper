...
public:
	...
	SDK_UNDEFINED(80,14043) /* TSet<UFortCurieComponent*> */ __um(PendingUpdateComponents);                        // 0x0070   (0x0050)  
	SDK_UNDEFINED(80,14044) /* TSet<UFortCurieComponent*> */ __um(PendingRemoveComponents);                        // 0x00C0   (0x0050)  
	...
	SDK_UNDEFINED(80,14045) /* TSet<FFortSpatialCellIndex> */ __um(CachedBurningGrassGridCells);                   // 0x0258   (0x0050)  
	SDK_UNDEFINED(80,14046) /* TMap<FFortSpatialCellIndex, UAudioComponent*> */ __um(GrassAudioMap);               // 0x02A8   (0x0050)  
	...
	// void OnUserSettingsEffectQualityChanged();                                                                            // [0xb457974] Final|Native|Private 
};
