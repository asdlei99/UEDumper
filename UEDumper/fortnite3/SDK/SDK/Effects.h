...
public:
	...
	SDK_UNDEFINED(1,9369) /* TEnumAsByte<ETimelineDirection> */ __um(Timeline_0__Direction_0C9ACFAF463718824428D0A86CC5D789); // 0x038C   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(1,9370) /* TEnumAsByte<ETimelineDirection> */ __um(ScaleDownParticleTL__Direction_544AE05F40294D09C3C361AB7BCF6C4E); // 0x032C   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(1,9371) /* TEnumAsByte<ETimelineDirection> */ __um(CharacterSpawnInTimeline__Direction_2AB89084476E64255664E9B2D45E14C1); // 0x02AC   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(1,9372) /* TEnumAsByte<ETimelineDirection> */ __um(MobileSelectedTL__Direction_FF208F9641BE589B76EF698B94309EA7); // 0x0478   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(1,9373) /* TEnumAsByte<EFieldFalloffType> */ __um(Falloff_Type);                                 // 0x0328   (0x0001)  
...
{ 
public:
	SDK_UNDEFINED(1,9374) /* TEnumAsByte<EFortCustomPartType> */ __um(Part_Type);                                  // 0x0088   (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x0089   (0x0007)  MISSED
	SDK_UNDEFINED(16,9375) /* FString */               __um(Skeletal_Mesh_User_Name);                              // 0x0090   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(1,9376) /* TEnumAsByte<ETimelineDirection> */ __um(Timeline_0__Direction_3D5AA2144E9B8D6D3B409B845315B143); // 0x038C   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x038D   (0x0003)  MISSED
	class UTimelineComponent*                          Timeline;                                                   // 0x0390   (0x0008)  
...
{ 
	SDK_UNDEFINED(1,9377) /* TEnumAsByte<ENUM_NiagaraParameterSetup> */ __um(ParameterSelection_14_A6D4854946F722970AD7D0AEC96E4705); // 0x0000   (0x0001)  
