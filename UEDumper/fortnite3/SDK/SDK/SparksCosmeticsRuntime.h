...
{ 
public:
	SDK_UNDEFINED(32,12223) /* TWeakObjectPtr<UNiagaraSystem*> */ __um(StartSystem);                               // 0x0760   (0x0020)  
	FName                                              StartSystemAttachPoint;                                     // 0x0780   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0784   (0x0004)  MISSED
	SDK_UNDEFINED(32,12224) /* TWeakObjectPtr<UNiagaraSystem*> */ __um(SustainSystem);                             // 0x0788   (0x0020)  
	FName                                              SustainSystemAttachPoint;                                   // 0x07A8   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x07AC   (0x0004)  MISSED
	SDK_UNDEFINED(32,12225) /* TWeakObjectPtr<UNiagaraSystem*> */ __um(StopSystem);                                // 0x07B0   (0x0020)  
...
public:
	...
	SDK_UNDEFINED(80,12226) /* TMap<FName, USparksAccountItemDefinition*> */ __um(ItemDefinitionMap);              // 0x00A8   (0x0050)  
	SDK_UNDEFINED(80,12227) /* TMap<FPrimaryAssetId, USparksAccountItemDefinition*> */ __um(AssetIDMap);           // 0x00F8   (0x0050)  
...
{ 
	...
	SDK_UNDEFINED(80,12228) /* TMap<ESparksInstrumentType, FSparksVariantChoices> */ __um(InstrumentVariantChoices); // 0x0090   (0x0050)  
	SDK_UNDEFINED(16,12229) /* TArray<FString> */      __um(JamSongChoices);                                       // 0x00E0   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(16,12230) /* FMulticastInlineDelegate */ __um(CosmeticItemChanged);                              // 0x00A0   (0x0010)  
	SDK_UNDEFINED(16,12231) /* FMulticastInlineDelegate */ __um(CosmeticChoiceChanged);                            // 0x00B0   (0x0010)  
	SDK_UNDEFINED(16,12232) /* FMulticastInlineDelegate */ __um(OnLoadoutFilled);                                  // 0x00C0   (0x0010)  
	...
	SDK_UNDEFINED(80,12233) /* TMap<ESparksInstrumentType, FPrimaryAssetId> */ __um(DefaultInstrumentDefIDs);      // 0x0238   (0x0050)  
	SDK_UNDEFINED(80,12234) /* TMap<ESparksInstrumentType, USparksInstrumentItemDefBase*> */ __um(InstrumentDefs); // 0x0288   (0x0050)  
	unsigned char                                      UnknownData02_5[0x80];                                      // 0x02D8   (0x0080)  MISSED
	SDK_UNDEFINED(80,12235) /* TMap<ESparksInstrumentType, FPrimaryAssetId> */ __um(DefaultSpotlightAnimDefIDs);   // 0x0358   (0x0050)  
	SDK_UNDEFINED(80,12236) /* TMap<ESparksInstrumentType, USparksSpotlightAnimDefinition*> */ __um(SpotlightAnimDefs); // 0x03A8   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(32,12237) /* TWeakObjectPtr<USkeletalMesh*> */ __um(Mesh);                                       // 0x0760   (0x0020)  
	SDK_UNDEFINED(32,12238) /* TWeakObjectPtr<USkeletalMesh*> */ __um(LeftHandMesh);                               // 0x0780   (0x0020)  
	SDK_UNDEFINED(32,12239) /* TWeakObjectPtr<USkeletalMesh*> */ __um(AuxiliaryMesh);                              // 0x07A0   (0x0020)  
	SDK_UNDEFINED(32,12240) /* TWeakObjectPtr<UMaterialInstance*> */ __um(Material);                               // 0x07C0   (0x0020)  
	SDK_UNDEFINED(32,12241) /* TWeakObjectPtr<UMaterialInstance*> */ __um(LeftHandMaterial);                       // 0x07E0   (0x0020)  
	SDK_UNDEFINED(32,12242) /* TWeakObjectPtr<UMaterialInstance*> */ __um(AuxiliaryMaterial);                      // 0x0800   (0x0020)  
	SDK_UNDEFINED(32,12243) /* TWeakObjectPtr<UMaterialInstance*> */ __um(AuxiliaryMaterial2);                     // 0x0820   (0x0020)  
	SDK_UNDEFINED(32,12244) /* TWeakObjectPtr<UFXSystemAsset*> */ __um(MainFXSystem);                              // 0x0840   (0x0020)  
	SDK_UNDEFINED(32,12245) /* TWeakObjectPtr<UFXSystemAsset*> */ __um(LHFXSystem);                                // 0x0860   (0x0020)  
	SDK_UNDEFINED(32,12246) /* TWeakObjectPtr<UFXSystemAsset*> */ __um(AuxFXSystem);                               // 0x0880   (0x0020)  
...
public:
	...
	SDK_UNDEFINED(32,12247) /* TWeakObjectPtr<USparksInstrumentItemDefBase*> */ __um(ItemDef);                     // 0x0440   (0x0020)  
	SDK_UNDEFINED(12,12248) /* FDelegateProperty */    __um(OnSettingsChangedDelegate);                            // 0x0460   (0x000C)  
...
{ 
public:
	SDK_UNDEFINED(32,12249) /* TWeakObjectPtr<ULevelSequence*> */ __um(SpotlightSequence);                         // 0x0760   (0x0020)  
...
{ 
	SDK_UNDEFINED(8,12250) /* TWeakObjectPtr<AFortPlayerPawn*> */ __um(ForPlayer);                                 // 0x0000   (0x0008)  
