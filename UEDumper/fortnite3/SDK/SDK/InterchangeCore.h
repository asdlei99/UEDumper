...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(16,14086) /* FString */              __um(Filename);                                             // 0x0028   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,14087) /* TMap<FName, FInterchangePipelinePropertyStates> */ __um(PropertiesStates);          // 0x0048   (0x0050)  
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(16,14088) /* FString */              __um(SourceAssetName);                                      // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,14089) /* FString */              __um(DestinationAssetName);                                 // 0x0038   (0x0010)  
	class UClass*                                      AssetType;                                                  // 0x0048   (0x0008)  
	SDK_UNDEFINED(16,14090) /* FString */              __um(InterchangeKey);                                       // 0x0050   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(24,14091) /* FText */                __um(Text);                                                 // 0x0060   (0x0018)  
};
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(80,14094) /* TMap<FString, UInterchangeBaseNode*> */ __um(Nodes);                                // 0x0028   (0x0050)  
...
{ 
	SDK_UNDEFINED(16,14095) /* FString */              __um(Name);                                                 // 0x0000   (0x0010)  
