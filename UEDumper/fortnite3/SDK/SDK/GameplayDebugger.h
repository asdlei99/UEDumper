...
{ 
	...
	SDK_UNDEFINED(16,13898) /* FString */              __um(Description);                                          // 0x0010   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,13899) /* TArray<FString> */      __um(TextLines);                                            // 0x0008   (0x0010)  
...
{ 
	SDK_UNDEFINED(8,13900) /* TWeakObjectPtr<AActor*> */ __um(Actor);                                              // 0x0000   (0x0008)  
...
{ 
	SDK_UNDEFINED(16,13901) /* FString */              __um(DeviceIDs);                                            // 0x0000   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,13902) /* FString */              __um(ConfigName);                                           // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,13903) /* FString */              __um(CategoryName);                                         // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,13904) /* FString */              __um(ExtensionName);                                        // 0x0000   (0x0010)  
