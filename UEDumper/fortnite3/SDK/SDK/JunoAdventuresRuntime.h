...
{ 
	SDK_UNDEFINED(24,14163) /* FText */                __um(Message);                                              // 0x0000   (0x0018)  
...
{ 
public:
	SDK_UNDEFINED(80,14164) /* TMap<FGameplayTag, UFortControllerRequirement*> */ __um(ConversationRequirementMappings); // 0x0030   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(24,14165) /* FText */                __um(GetTextFormat);                                        // 0x0198   (0x0018)  
	SDK_UNDEFINED(24,14166) /* FText */                __um(FinishedTextFormat);                                   // 0x01B0   (0x0018)  
};
...
{ 
public:
	SDK_UNDEFINED(24,14167) /* FText */                __um(GiftTextFormat);                                       // 0x0170   (0x0018)  
...
public:
	...
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0194   (0x0004)  MISSED
	SDK_UNDEFINED(24,14168) /* FText */                __um(JoinCampTextFormat);                                   // 0x0198   (0x0018)  
...
{ 
public:
	SDK_UNDEFINED(16,14169) /* FString */              __um(MetaIdentifier_Animations);                            // 0x0170   (0x0010)  
	...
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x018C   (0x0004)  MISSED
	SDK_UNDEFINED(24,14170) /* FText */                __um(StyledParticipantNameFormat);                          // 0x0190   (0x0018)  
...
{ 
public:
	SDK_UNDEFINED(24,14171) /* FText */                __um(TradeTextFormat_Single);                               // 0x0170   (0x0018)  
	SDK_UNDEFINED(24,14172) /* FText */                __um(TradeTextFormat_Plural);                               // 0x0188   (0x0018)  
	SDK_UNDEFINED(24,14173) /* FText */                __um(NotEnoughForTradeTextFormat_Single);                   // 0x01A0   (0x0018)  
	SDK_UNDEFINED(24,14174) /* FText */                __um(NotEnoughForTradeTextFormat_Plural);                   // 0x01B8   (0x0018)  
...
{ 
public:
	SDK_UNDEFINED(16,14175) /* FMulticastInlineDelegate */ __um(OnJunoConversationParticipantIconChangedDelegate); // 0x0618   (0x0010)  
	SDK_UNDEFINED(32,14176) /* TWeakObjectPtr<UTexture2D*> */ __um(ParticipantIconSmall);                          // 0x0628   (0x0020)  
...
{ 
public:
	SDK_UNDEFINED(32,14177) /* TWeakObjectPtr<UFortQuestItemDefinition_Athena*> */ __um(QuestToProgress);          // 0x0170   (0x0020)  
...
{ 
public:
	SDK_UNDEFINED(32,14178) /* TWeakObjectPtr<UFortQuestItemDefinition_Athena*> */ __um(QuestToGrant);             // 0x0170   (0x0020)  
};
...
{ 
public:
	SDK_UNDEFINED(32,14179) /* TWeakObjectPtr<UFortQuestItemDefinition_Athena*> */ __um(QuestToTurnIn);            // 0x0170   (0x0020)  
};
...
{ 
public:
	SDK_UNDEFINED(16,14180) /* FString */              __um(GrantableQuestID);                                     // 0x00A0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,14181) /* TMap<FGameplayTag, FMappedJunoActions> */ __um(JunoTokenToJunoActions);             // 0x0028   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(80,14182) /* TMap<FName, FQuestTokenMappingContainer> */ __um(ObjectiveQuestTokensToGrant);      // 0x0000   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(80,14183) /* TMap<FName, FQuestPropSpawnInfoContainer> */ __um(ObjectiveQuestPropActorsToSpawn); // 0x0000   (0x0050)  
...
{ 
	SDK_UNDEFINED(24,14184) /* FText */                __um(Message);                                              // 0x0000   (0x0018)  
...
{ 
	SDK_UNDEFINED(32,14185) /* TWeakObjectPtr<UClass*> */ __um(ClassToSpawn);                                      // 0x0000   (0x0020)  
...
{ 
	SDK_UNDEFINED(80,14186) /* TMap<EJunoTokenReceiverType, FGameplayTagContainer> */ __um(QuestTokens);           // 0x0000   (0x0050)  
};
