...
{ 
public:
	SDK_UNDEFINED(32,12287) /* TWeakObjectPtr<UPBWLedgeConfigurationData*> */ __um(ConfigurationData);             // 0x0030   (0x0020)  
	SDK_UNDEFINED(32,12288) /* TWeakObjectPtr<UClass*> */ __um(InstancedLedgeActorClass);                          // 0x0050   (0x0020)  
	...
	SDK_UNDEFINED(80,12289) /* TMap<UClass*, FLedgeLaunchConfigEntry> */ __um(CachedLedgeLaunchMap);               // 0x0080   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(80,12290) /* TMap<EPlayerBuiltWallType, TWeakObjectPtr<UClass*>> */ __um(MetalWalls);            // 0x0030   (0x0050)  
	SDK_UNDEFINED(80,12291) /* TMap<EPlayerBuiltWallType, TWeakObjectPtr<UClass*>> */ __um(StoneWalls);            // 0x0080   (0x0050)  
	SDK_UNDEFINED(80,12292) /* TMap<EPlayerBuiltWallType, TWeakObjectPtr<UClass*>> */ __um(WoodWalls);             // 0x00D0   (0x0050)  
	SDK_UNDEFINED(80,12293) /* TMap<EPlayerBuiltWallType, FLedgeLaunchConfigEntry> */ __um(Transforms);            // 0x0120   (0x0050)  
	SDK_UNDEFINED(80,12294) /* TMap<EPlayerBuiltWallMaterialType, FLedgeLaunchTransformConfigEntry> */ __um(PerMaterialTransforms); // 0x0170   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(16,12295) /* TArray<TWeakObjectPtr<ABuildingWall*>> */ __um(CurrentWalls);                       // 0x0490   (0x0010)  
...
{ 
	SDK_UNDEFINED(80,12296) /* TMap<EPlayerBuiltWallType, FLedgeLaunchConfigEntry> */ __um(Transforms);            // 0x0000   (0x0050)  
};
