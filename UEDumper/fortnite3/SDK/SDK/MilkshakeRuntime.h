...
public:
	...
	SDK_UNDEFINED(80,14808) /* TMap<ABuildingActor*, float> */ __um(RecentDamageFXBuildings);                      // 0x0240   (0x0050)  
	SDK_UNDEFINED(80,14809) /* TMap<TEnumAsByte<EFortResourceType>, USoundBase*> */ __um(BuildingDamageSoundCueByResourceType); // 0x0290   (0x0050)  
