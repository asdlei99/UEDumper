...
{ 
	...
	SDK_UNDEFINED(8,13723) /* TWeakObjectPtr<AActor*> */ __um(PreferredTarget);                                    // 0x000C   (0x0008)  
	float                                              StartTimeMS;                                                // 0x0014   (0x0004)  
	float                                              LengthMS;                                                   // 0x0018   (0x0004)  
	SDK_UNDEFINED(8,13724) /* TWeakObjectPtr<AActor*> */ __um(TargetActor);                                        // 0x001C   (0x0008)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x0024   (0x0004)  MISSED
	...
	SDK_UNDEFINED(8,13725) /* TWeakObjectPtr<AActor*> */ __um(GeneratedTargetActor);                               // 0x0074   (0x0008)  
...
{ 
	SDK_UNDEFINED(16,13726) /* FString */              __um(SectionName);                                          // 0x0000   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(8,13727) /* TWeakObjectPtr<AActor*> */ __um(PreferredTarget);                                    // 0x000C   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,13728) /* TWeakObjectPtr<USparksCameraPluginDataProvider*> */ __um(DataProvider);              // 0x0134   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,13729) /* TWeakObjectPtr<USparksCameraPluginDataProvider*> */ __um(DataProvider);              // 0x0110   (0x0008)  
	class UClass*                                      DebugWidgetClass;                                           // 0x0118   (0x0008)  
	SDK_UNDEFINED(80,13730) /* TMap<ULevelSequence*, FSparksCameraShotUses> */ __um(ShotTimestamps);               // 0x0120   (0x0050)  
...
{ 
	SDK_UNDEFINED(16,13731) /* FString */              __um(Data);                                                 // 0x0000   (0x0010)  
