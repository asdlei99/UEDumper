...
{ 
	SDK_UNDEFINED(16,13373) /* FString */              __um(FilePath);                                             // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,13374) /* FString */              __um(SourceUrl);                                            // 0x0010   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(80,13375) /* TMap<FString, FDownloadCacheEntry> */ __um(Cache);                                  // 0x0008   (0x0050)  
};
