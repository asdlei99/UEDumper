...
{ 
	SDK_UNDEFINED(16,14847) /* FString */              __um(AppName);                                              // 0x0000   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,14848) /* FString */              __um(NVIDIAGfeVersion);                                     // 0x0008   (0x0010)  
	SDK_UNDEFINED(80,14849) /* TMap<EGfeSDKScope, EGfeSDKPermission> */ __um(ScopePermissions);                    // 0x0018   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(16,14850) /* FString */              __um(ID);                                                   // 0x0000   (0x0010)  
	...
	SDK_UNDEFINED(80,14851) /* TMap<FString, FString> */ __um(NameTranslationTable);                               // 0x0018   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(16,14852) /* FString */              __um(DefaultLocale);                                        // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(80,14853) /* TMap<EGfeSDKScope, EGfeSDKPermission> */ __um(ScopePermissions);                    // 0x0000   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(16,14854) /* FString */              __um(GroupId);                                              // 0x0000   (0x0010)  
	SDK_UNDEFINED(80,14855) /* TMap<FString, FString> */ __um(GroupDescriptionTranslationTable);                   // 0x0010   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(16,14856) /* FString */              __um(GroupId);                                              // 0x0000   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,14858) /* FString */              __um(HighlightId);                                          // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,14859) /* FString */              __um(GroupId);                                              // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,14860) /* FString */              __um(HighlightId);                                          // 0x0010   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,14861) /* FString */              __um(GroupId);                                              // 0x0000   (0x0010)  
