...
{ 
	...
	SDK_UNDEFINED(8,14833) /* TWeakObjectPtr<AActor*> */ __um(Actor);                                              // 0x0028   (0x0008)  
	SDK_UNDEFINED(8,14834) /* TWeakObjectPtr<APlayerState*> */ __um(InstigatorPlayerState);                        // 0x0030   (0x0008)  
...
{ 
	...
	SDK_UNDEFINED(8,14835) /* TWeakObjectPtr<UMusicSequencerHitComponent*> */ __um(OwningComponent);               // 0x0118   (0x0008)  
};
...
public:
	...
	SDK_UNDEFINED(8,14836) /* TWeakObjectPtr<AMusicSequencerHitActor*> */ __um(MusicSequencerHitActor);            // 0x00A8   (0x0008)  
