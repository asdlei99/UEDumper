...
public:
	...
	SDK_UNDEFINED(1,13915) /* TEnumAsByte<TextureFilter> */ __um(DefaultMaterialBakeFilter);                       // 0x0044   (0x0001)  
	SDK_UNDEFINED(1,13916) /* TEnumAsByte<TextureAddress> */ __um(DefaultMaterialBakeTiling);                      // 0x0045   (0x0001)  
	unsigned char                                      UnknownData02_5[0x2];                                       // 0x0046   (0x0002)  MISSED
	SDK_UNDEFINED(80,13917) /* TMap<EGLTFMaterialPropertyGroup, FGLTFOverrideMaterialBakeSettings> */ __um(DefaultInputBakeSettings); // 0x0048   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(1,13918) /* TEnumAsByte<TextureFilter> */ __um(DefaultMaterialBakeFilter);                       // 0x0038   (0x0001)  
	SDK_UNDEFINED(1,13919) /* TEnumAsByte<TextureAddress> */ __um(DefaultMaterialBakeTiling);                      // 0x0039   (0x0001)  
	unsigned char                                      UnknownData02_5[0x6];                                       // 0x003A   (0x0006)  MISSED
	SDK_UNDEFINED(80,13920) /* TMap<EGLTFMaterialPropertyGroup, FGLTFOverrideMaterialBakeSettings> */ __um(DefaultInputBakeSettings); // 0x0040   (0x0050)  
...
{ 
	...
	SDK_UNDEFINED(1,13921) /* TEnumAsByte<TextureFilter> */ __um(Filter);                                          // 0x0011   (0x0001)  
	bool                                               bOverrideTiling;                                            // 0x0012   (0x0001)  
	SDK_UNDEFINED(1,13922) /* TEnumAsByte<TextureAddress> */ __um(Tiling);                                         // 0x0013   (0x0001)  
};
...
public:
	...
	SDK_UNDEFINED(80,13923) /* TMap<EGLTFMaterialPropertyGroup, FGLTFOverrideMaterialBakeSettings> */ __um(Inputs); // 0x0048   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(16,13924) /* TArray<FString> */      __um(Suggestions);                                          // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,13925) /* TArray<FString> */      __um(Warnings);                                             // 0x0010   (0x0010)  
	SDK_UNDEFINED(16,13926) /* TArray<FString> */      __um(Errors);                                               // 0x0020   (0x0010)  
};
