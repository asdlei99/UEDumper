...
{ 
public:
	SDK_UNDEFINED(32,13394) /* TWeakObjectPtr<UFortMontageItemDefinitionBase*> */ __um(Emote1);                    // 0x0328   (0x0020)  
	SDK_UNDEFINED(32,13395) /* TWeakObjectPtr<UFortMontageItemDefinitionBase*> */ __um(Emote2);                    // 0x0348   (0x0020)  
	SDK_UNDEFINED(32,13396) /* TWeakObjectPtr<UFortMontageItemDefinitionBase*> */ __um(Emote3);                    // 0x0368   (0x0020)  
	SDK_UNDEFINED(16,13397) /* TArray<TWeakObjectPtr<UFortMontageItemDefinitionBase*>> */ __um(RandomEmotes);      // 0x0388   (0x0010)  
