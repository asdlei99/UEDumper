...
public:
	...
	SDK_UNDEFINED(80,14877) /* TMap<UClass*, FORSClassTupleList> */ __um(ClassMap);                                // 0x0038   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(16,14878) /* TScriptInterface<Class> */ __um(Object);                                            // 0x0000   (0x0010)  
