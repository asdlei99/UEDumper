...
public:
	...
	SDK_UNDEFINED(16,14597) /* FString */              __um(QRCodeURL);                                            // 0x0428   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(32,14598) /* TWeakObjectPtr<UClass*> */ __um(KoalaGraphicsModalClass);                           // 0x0030   (0x0020)  
...
public:
	...
	SDK_UNDEFINED(80,14599) /* TMap<int32_t, FKoalaClipInfo> */ __um(ClipTracker);                                 // 0x0448   (0x0050)  
