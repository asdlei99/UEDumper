...
public:
	...
	SDK_UNDEFINED(16,15270) /* TArray<TEnumAsByte<EObjectTypeQuery>> */ __um(DoorBashCollisionTypesForPawn);       // 0x0C38   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,15271) /* TArray<FString> */      __um(DBNOCarriedPlayers);                                   // 0x00E8   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(1,15272) /* TEnumAsByte<EPhysicalSurface> */ __um(PrimarySurfaceType);                           // 0x07A4   (0x0001)  
	SDK_UNDEFINED(1,15273) /* TEnumAsByte<EFortBaseWeaponDamage> */ __um(WeaponResponseType);                      // 0x07A5   (0x0001)  
	...
	SDK_UNDEFINED(16,15274) /* FMulticastInlineDelegate */ __um(OnTeamIndexChanged);                               // 0x07C8   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(8,15275) /* TWeakObjectPtr<AFortScoutDrone*> */ __um(ControlledDrone);                           // 0x00A8   (0x0008)  
};
...
{ 
	SDK_UNDEFINED(8,15276) /* TWeakObjectPtr<AFortScoutDrone*> */ __um(DeployedDrone);                             // 0x0000   (0x0008)  
};
