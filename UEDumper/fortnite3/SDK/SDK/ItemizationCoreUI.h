...
{ 
public:
	SDK_UNDEFINED(16,14149) /* FMulticastInlineDelegate */ __um(OnGridItemsSet);                                   // 0x01B8   (0x0010)  
	SDK_UNDEFINED(16,14150) /* FMulticastInlineDelegate */ __um(OnGridEntryAdded);                                 // 0x01C8   (0x0010)  
	SDK_UNDEFINED(16,14151) /* FMulticastInlineDelegate */ __um(OnGridEntryRemoved);                               // 0x01D8   (0x0010)  
	class UClass*                                      EntryWidgetClass;                                           // 0x01E8   (0x0008)  
	int32_t                                            NumColumns;                                                 // 0x01F0   (0x0004)  
	SDK_UNDEFINED(1,14152) /* TEnumAsByte<EHorizontalAlignment> */ __um(SlotHorizontalAlignment);                  // 0x01F4   (0x0001)  
	SDK_UNDEFINED(1,14153) /* TEnumAsByte<EVerticalAlignment> */ __um(SlotVerticalAlignment);                      // 0x01F5   (0x0001)  
