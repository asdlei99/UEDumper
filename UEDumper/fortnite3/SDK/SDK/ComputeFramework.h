...
{ 
	SDK_UNDEFINED(16,12346) /* FString */              __um(Name);                                                 // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,12347) /* FString */              __um(Symbol);                                               // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,12348) /* FString */              __um(Define);                                               // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,12349) /* FString */              __um(TypeDeclaration);                                      // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,12350) /* FString */              __um(Name);                                                 // 0x0010   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,12351) /* FString */              __um(Name);                                                 // 0x0000   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,12352) /* FString */              __um(EntryPoint);                                           // 0x0028   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,12353) /* FString */              __um(BindingFunctionNameOverride);                          // 0x0018   (0x0010)  
	SDK_UNDEFINED(16,12354) /* FString */              __um(BindingFunctionNamespace);                             // 0x0028   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(80,12355) /* TMap<FString, uint32_t> */ __um(Permutations);                                      // 0x0000   (0x0050)  
