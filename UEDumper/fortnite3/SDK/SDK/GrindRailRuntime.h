...
public:
	...
	SDK_UNDEFINED(32,13939) /* TWeakObjectPtr<AFortGrindRail*> */ __um(HeadConnectedRail);                         // 0x0BB0   (0x0020)  
	SDK_UNDEFINED(32,13940) /* TWeakObjectPtr<AFortGrindRail*> */ __um(TailConnectedRail);                         // 0x0BD0   (0x0020)  
...
public:
	...
	SDK_UNDEFINED(80,13941) /* TMap<FName, float> */   __um(SlopeWarpingCurveMap);                                 // 0x0490   (0x0050)  
	...
	SDK_UNDEFINED(8,13942) /* TWeakObjectPtr<UFortPawnComponent_GrindingProvider*> */ __um(GrindingProvider);      // 0x0638   (0x0008)  
	SDK_UNDEFINED(8,13943) /* TWeakObjectPtr<UCharacterMovementComponent*> */ __um(MovementComponent);             // 0x0640   (0x0008)  
	SDK_UNDEFINED(8,13944) /* TWeakObjectPtr<AFortPlayerPawn*> */ __um(FortPlayerPawn);                            // 0x0648   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,13945) /* TWeakObjectPtr<UFortPawnComponent_GrindingProvider*> */ __um(GrindingProvider);      // 0x0128   (0x0008)  
	...
	SDK_UNDEFINED(8,13946) /* TWeakObjectPtr<UForceFeedbackEffect*> */ __um(JumpOffFeedbackEffect);                // 0x0198   (0x0008)  
	SDK_UNDEFINED(8,13947) /* TWeakObjectPtr<UFortComponent_Energy*> */ __um(TacticalSprintEnergyComponent);       // 0x01A0   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(16,13948) /* FMulticastInlineDelegate */ __um(GrindRailChangedDelegate);                         // 0x00E0   (0x0010)  
	SDK_UNDEFINED(16,13949) /* FMulticastInlineDelegate */ __um(FeetLandedDelegate);                               // 0x00F0   (0x0010)  
	SDK_UNDEFINED(16,13950) /* FMulticastInlineDelegate */ __um(BegunGrindingDelegate);                            // 0x0100   (0x0010)  
	SDK_UNDEFINED(16,13951) /* FMulticastInlineDelegate */ __um(HitObstacleWhenGrindingDelegate);                  // 0x0110   (0x0010)  
	SDK_UNDEFINED(16,13952) /* FMulticastInlineDelegate */ __um(BoosterModeChangedDelegate);                       // 0x0120   (0x0010)  
	SDK_UNDEFINED(16,13953) /* FMulticastInlineDelegate */ __um(SprintingStateChangedDelegate);                    // 0x0130   (0x0010)  
	SDK_UNDEFINED(16,13954) /* FMulticastInlineDelegate */ __um(EndedGrindingDelegate);                            // 0x0140   (0x0010)  
	SDK_UNDEFINED(16,13955) /* FMulticastInlineDelegate */ __um(ADSPressedDelegate);                               // 0x0150   (0x0010)  
	SDK_UNDEFINED(16,13956) /* FMulticastInlineDelegate */ __um(ADSReleasedDelegate);                              // 0x0160   (0x0010)  
	SDK_UNDEFINED(16,13957) /* FMulticastInlineDelegate */ __um(ApplyDamageToDeviceDelegate);                      // 0x0170   (0x0010)  
	SDK_UNDEFINED(16,13958) /* FMulticastInlineDelegate */ __um(DismountPlayerDelegate);                           // 0x0180   (0x0010)  
	SDK_UNDEFINED(8,13959) /* TWeakObjectPtr<AFortPlayerPawn*> */ __um(OwnerPawn);                                 // 0x0190   (0x0008)  
	SDK_UNDEFINED(8,13960) /* TWeakObjectPtr<UFortMovementComp_Character*> */ __um(MovementComponent);             // 0x0198   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,13961) /* TWeakObjectPtr<UFXSystemComponent*> */ __um(EffectsComponent);                       // 0x0B14   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,13962) /* TWeakObjectPtr<AFortGrindRail*> */ __um(ReplicatedGrindingRail);                     // 0x0150   (0x0008)  
	SDK_UNDEFINED(8,13963) /* TWeakObjectPtr<AFortGrindRail*> */ __um(PreviousGrindingRail);                       // 0x0158   (0x0008)  
	SDK_UNDEFINED(8,13964) /* TWeakObjectPtr<AFortGrindRail*> */ __um(GrindingRail);                               // 0x0160   (0x0008)  
	SDK_UNDEFINED(8,13965) /* TWeakObjectPtr<AFortGrindRail*> */ __um(NextGrindingRail);                           // 0x0168   (0x0008)  
	...
	SDK_UNDEFINED(8,13966) /* TWeakObjectPtr<UFortPawnComponent_GrindingProvider*> */ __um(GrindingProvider);      // 0x09E8   (0x0008)  
...
{ 
	SDK_UNDEFINED(8,13967) /* TWeakObjectPtr<AFortGrindRail*> */ __um(GrindingRail);                               // 0x0000   (0x0008)  
