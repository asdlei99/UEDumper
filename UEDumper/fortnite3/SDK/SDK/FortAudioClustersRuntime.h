...
{ 
public:
	SDK_UNDEFINED(80,13782) /* TMap<FGameplayTag, double> */ __um(ParameterDefaults);                              // 0x0030   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(16,13783) /* TArray<TWeakObjectPtr<UClass*>> */ __um(ActorClasses);                              // 0x0008   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(80,13784) /* TMap<FName, FGameplayTag> */ __um(OverrideTable);                                   // 0x0038   (0x0050)  
	...
	// void HandleRegisteredActorDeath(float Damage, FGameplayTagContainer& DamageTags, FVector Momentum, FHitResult& HitInfo, class AFortPawn* InstigatedBy, class AActor* DamageCauser, FGameplayEffectContextHandle EffectContext); // [0x288b770] Final|Native|Private|HasOutParms|HasDefaults 
};
...
{ 
public:
	SDK_UNDEFINED(16,13785) /* TArray<TWeakObjectPtr<UAudioClusterConfigMap*>> */ __um(ConfigMaps);                // 0x0028   (0x0010)  
