...
{ 
	...
	SDK_UNDEFINED(32,15279) /* TWeakObjectPtr<UClass*> */ __um(SoftClass);                                         // 0x0018   (0x0020)  
	class UObject*                                     RawObject;                                                  // 0x0038   (0x0008)  
	class UObject*                                     WrappedObject;                                              // 0x0040   (0x0008)  
	SDK_UNDEFINED(8,15280) /* TWeakObjectPtr<UMetaData*> */ __um(WeakObject);                                      // 0x0048   (0x0008)  
	SDK_UNDEFINED(32,15281) /* TWeakObjectPtr<UMetaData*> */ __um(SoftObject);                                     // 0x0050   (0x0020)  
...
{ 
	...
	SDK_UNDEFINED(16,15282) /* FString */              __um(String);                                               // 0x0018   (0x0010)  
	SDK_UNDEFINED(24,15283) /* FText */                __um(Text);                                                 // 0x0028   (0x0018)  
...
{ 
	...
	SDK_UNDEFINED(80,15284) /* TMap<FString, FVector> */ __um(StrToVec);                                           // 0x02C0   (0x0050)  
	SDK_UNDEFINED(80,15285) /* TSet<FVector> */        __um(VectorSet);                                            // 0x0310   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(80,15286) /* TMap<FString, FVector3f> */ __um(StrToVec);                                         // 0x0178   (0x0050)  
	SDK_UNDEFINED(80,15287) /* TSet<FVector3f> */      __um(VectorSet);                                            // 0x01C8   (0x0050)  
...
{ 
	SDK_UNDEFINED(80,15288) /* TMap<int32_t, FString> */ __um(IntToStr);                                           // 0x0000   (0x0050)  
	SDK_UNDEFINED(80,15289) /* TMap<FString, FString> */ __um(StrToStr);                                           // 0x0050   (0x0050)  
	SDK_UNDEFINED(80,15290) /* TMap<FString, FVector> */ __um(StrToVec);                                           // 0x00A0   (0x0050)  
	SDK_UNDEFINED(80,15291) /* TMap<FString, FStructSerializerBuiltinTestStruct> */ __um(StrToStruct);             // 0x00F0   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(80,15292) /* TSet<FString> */        __um(StrSet);                                               // 0x0000   (0x0050)  
	SDK_UNDEFINED(80,15293) /* TSet<int32_t> */        __um(IntSet);                                               // 0x0050   (0x0050)  
	SDK_UNDEFINED(80,15294) /* TSet<FName> */          __um(NameSet);                                              // 0x00A0   (0x0050)  
	SDK_UNDEFINED(80,15295) /* TSet<FStructSerializerBuiltinTestStruct> */ __um(StructSet);                        // 0x00F0   (0x0050)  
};
