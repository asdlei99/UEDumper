...
public:
	...
	SDK_UNDEFINED(24,14653) /* FText */                __um(MatchmakingStatusText);                                // 0x0468   (0x0018)  
...
public:
	...
	SDK_UNDEFINED(16,14654) /* FMulticastInlineDelegate */ __um(OnFinishedCountdown);                              // 0x0420   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(24,14655) /* FText */                __um(CreatorNameTextFormat);                                // 0x0440   (0x0018)  
	SDK_UNDEFINED(8,14656) /* TWeakObjectPtr<UHeaderDescriptionHUDComponent*> */ __um(CachedHUDComponent);         // 0x0458   (0x0008)  
	class UClass*                                      IslandModal;                                                // 0x0460   (0x0008)  
	FMatchmakingPortalPopupData                        CachedIslandData;                                           // 0x0468   (0x0060)  
	SDK_UNDEFINED(24,14657) /* FText */                __um(InvalidLinkCodeWarningText);                           // 0x04C8   (0x0018)  
	...
	SDK_UNDEFINED(24,14658) /* FText */                __um(InteractionMessage);                                   // 0x0530   (0x0018)  
	SDK_UNDEFINED(24,14659) /* FText */                __um(InteractionMessage_Cancel);                            // 0x0548   (0x0018)  
	SDK_UNDEFINED(24,14660) /* FText */                __um(InteractionMessage_Disabled);                          // 0x0560   (0x0018)  
	SDK_UNDEFINED(24,14661) /* FText */                __um(InteractionMessage_PartyLeadOnly);                     // 0x0578   (0x0018)  
...
{ 
public:
	SDK_UNDEFINED(32,14662) /* TWeakObjectPtr<UClass*> */ __um(SoftPortalHUDDetailsClass);                         // 0x0028   (0x0020)  
};
