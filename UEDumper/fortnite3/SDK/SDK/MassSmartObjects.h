...
{ 
	...
	SDK_UNDEFINED(80,14648) /* TMap<FSmartObjectHandle, int32_t> */ __um(SmartObjectToLaneLocationIndexLookup);    // 0x0028   (0x0050)  
	SDK_UNDEFINED(80,14649) /* TMap<int32_t, FSmartObjectLaneLocationIndices> */ __um(LaneToLaneLocationIndicesLookup); // 0x0078   (0x0050)  
