...
{ 
public:
	SDK_UNDEFINED(16,13596) /* FMulticastInlineDelegate */ __um(OnCalibrationDataLoaded);                          // 0x00A0   (0x0010)  
	SDK_UNDEFINED(16,13597) /* FMulticastInlineDelegate */ __um(OnCalibrationDataSaved);                           // 0x00B0   (0x0010)  
	SDK_UNDEFINED(16,13598) /* FMulticastInlineDelegate */ __um(OnAudioLatencyMsUpdated);                          // 0x00C0   (0x0010)  
	SDK_UNDEFINED(16,13599) /* FMulticastInlineDelegate */ __um(OnVideoLatencyMsUpdated);                          // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,13600) /* FMulticastInlineDelegate */ __um(OnIsCalibratedUpdated);                            // 0x00E0   (0x0010)  
	SDK_UNDEFINED(16,13601) /* FMulticastInlineDelegate */ __um(OnIsPreambleDisabledUpdated);                      // 0x00F0   (0x0010)  
	SDK_UNDEFINED(16,13602) /* FMulticastInlineDelegate */ __um(OnIsAutolaunchDisabledUpdated);                    // 0x0100   (0x0010)  
	SDK_UNDEFINED(16,13603) /* FMulticastInlineDelegate */ __um(OnIsCalibrationDebugEnabled);                      // 0x0110   (0x0010)  
	SDK_UNDEFINED(16,13604) /* FMulticastInlineDelegate */ __um(OnHasTalkedWithRoadie);                            // 0x0120   (0x0010)  
	SDK_UNDEFINED(16,13605) /* FMulticastInlineDelegate */ __um(OnCalibrationRequestOpenModal);                    // 0x0130   (0x0010)  
	SDK_UNDEFINED(16,13606) /* FMulticastInlineDelegate */ __um(OnCalibrationRegisterPreamble);                    // 0x0140   (0x0010)  
