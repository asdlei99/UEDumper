...
{ 
	...
	SDK_UNDEFINED(24,15474) /* FText */                __um(VoteSelectionText);                                    // 0x0008   (0x0018)  
};
...
{ 
	...
	SDK_UNDEFINED(24,15475) /* FText */                __um(VoteText);                                             // 0x0008   (0x0018)  
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0004   (0x0004)  MISSED
	SDK_UNDEFINED(24,15476) /* FText */                __um(VoteSessionText);                                      // 0x0008   (0x0018)  
...
public:
	...
	SDK_UNDEFINED(80,15477) /* TMap<FUniqueNetIdRepl, FCastedVote> */ __um(PlayerCastedVotesMap);                  // 0x04C0   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(16,15478) /* FMulticastInlineDelegate */ __um(OnVoteSessionSetupEvent);                          // 0x00A0   (0x0010)  
	SDK_UNDEFINED(16,15479) /* FMulticastInlineDelegate */ __um(OnVoteSessionVotingEvent);                         // 0x00B0   (0x0010)  
	SDK_UNDEFINED(16,15480) /* FMulticastInlineDelegate */ __um(OnVoteSetupEvent);                                 // 0x00C0   (0x0010)  
	SDK_UNDEFINED(16,15481) /* FMulticastInlineDelegate */ __um(OnVoteStartEvent);                                 // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,15482) /* FMulticastInlineDelegate */ __um(OnVoteChangeEvent);                                // 0x00E0   (0x0010)  
	SDK_UNDEFINED(16,15483) /* FMulticastInlineDelegate */ __um(OnVoteEndEvent);                                   // 0x00F0   (0x0010)  
	SDK_UNDEFINED(16,15484) /* FMulticastInlineDelegate */ __um(OnVoteSessionCompleteEvent);                       // 0x0100   (0x0010)  
	SDK_UNDEFINED(16,15485) /* FMulticastInlineDelegate */ __um(OnVoteSessionShutdownEvent);                       // 0x0110   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,15486) /* TMap<FUniqueNetIdRepl, FCastedVote> */ __um(PlayerCastedVotesMap);                  // 0x0198   (0x0050)  
