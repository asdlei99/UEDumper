...
{ 
public:
	SDK_UNDEFINED(16,13471) /* FMulticastInlineDelegate */ __um(OnTempoChangedDelegate);                           // 0x00A0   (0x0010)  
	SDK_UNDEFINED(16,13472) /* FMulticastInlineDelegate */ __um(OnSpeedChangedDelegate);                           // 0x00B0   (0x0010)  
	SDK_UNDEFINED(16,13473) /* FMulticastInlineDelegate */ __um(OnKeyChangedDelegate);                             // 0x00C0   (0x0010)  
	SDK_UNDEFINED(16,13474) /* FMulticastInlineDelegate */ __um(OnModeChangedDelegate);                            // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,13475) /* FMulticastInlineDelegate */ __um(OnTimeSignatureChanged);                           // 0x00E0   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,13476) /* FMulticastInlineDelegate */ __um(OnAddedToPlayspaceSystemManager);                  // 0x00A0   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(80,13477) /* TMap<UClass*, UClass*> */ __um(VKClassRedirects);                                   // 0x00A0   (0x0050)  
	SDK_UNDEFINED(16,13478) /* TArray<TWeakObjectPtr<UClass*>> */ __um(UEFNNotableActors);                         // 0x00F0   (0x0010)  
	SDK_UNDEFINED(80,13479) /* TMap<AActor*, FFMPlayspaceSystemInfo> */ __um(PlayspacesSystemInfo);                // 0x0100   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(80,13480) /* TSet<FString> */        __um(DownloadingLinkCodes);                                 // 0x00D0   (0x0050)  
	SDK_UNDEFINED(80,13481) /* TMap<FString, FString> */ __um(DownloadedLinkCodes);                                // 0x0120   (0x0050)  
	SDK_UNDEFINED(16,13482) /* TArray<FString> */      __um(DownloadedLinkCodesInOrder);                           // 0x0170   (0x0010)  
	SDK_UNDEFINED(80,13483) /* TSet<FString> */        __um(PersistentResolves);                                   // 0x0180   (0x0050)  
