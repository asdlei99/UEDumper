...
public:
	...
	SDK_UNDEFINED(80,14591) /* TSet<UClass*> */        __um(DashBlockingBuildingClasses);                          // 0x01C0   (0x0050)  
	FFortAbilityTargetSelectionList                    PawnTargetSelectionList;                                    // 0x0210   (0x0048)  
	SDK_UNDEFINED(1,14592) /* TEnumAsByte<ECollisionChannel> */ __um(DashTraceChannel);                            // 0x0258   (0x0001)  
	...
	SDK_UNDEFINED(80,14593) /* TMap<EFortKatanaPrimaryAttackVariation, FFortKatanaPrimaryAttackVariationInfo> */ __um(PrimaryAttackVariationInfos); // 0x02B8   (0x0050)  
	float                                              PrimaryAttackMinForwardMovement;                            // 0x0308   (0x0004)  
	SDK_UNDEFINED(1,14594) /* TEnumAsByte<ECollisionChannel> */ __um(PrimaryAttackObstructionTraceChannel);        // 0x030C   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(8,14595) /* TWeakObjectPtr<AActor*> */ __um(DashBlockingActor);                                  // 0x001C   (0x0008)  
