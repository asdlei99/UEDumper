...
public:
	...
	SDK_UNDEFINED(16,12634) /* FString */              __um(Name);                                                 // 0x0028   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,12635) /* FString */              __um(DiscreteValue);                                        // 0x0010   (0x0010)  
	FLinearColor                                       DiscreteColor;                                              // 0x0020   (0x0010)  
	SDK_UNDEFINED(16,12636) /* TArray<FString> */      __um(AllowList);                                            // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,12637) /* TArray<FString> */      __um(Blocklist);                                            // 0x0040   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,12638) /* FString */              __um(ParameterName);                                        // 0x0000   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(16,12639) /* FString */              __um(Name);                                                 // 0x0028   (0x0010)  
	class UCustomizableObject*                         CustomizableObject;                                         // 0x0038   (0x0008)  
	SDK_UNDEFINED(16,12640) /* TArray<FString> */      __um(AllowList);                                            // 0x0040   (0x0010)  
	SDK_UNDEFINED(16,12641) /* TArray<FString> */      __um(Blocklist);                                            // 0x0050   (0x0010)  
	TArray<FCustomizableObjectPopulationCharacteristic> Characteristics;                                           // 0x0060   (0x0010)  
	SDK_UNDEFINED(16,12642) /* TArray<FString> */      __um(Tags);                                                 // 0x0070   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,12643) /* TArray<FString> */      __um(Tags);                                                 // 0x0000   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(80,12645) /* TMap<FString, FPopulationClassParameterOptions> */ __um(ParameterOptions);          // 0x0010   (0x0050)  
};
