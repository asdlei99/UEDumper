...
{ 
public:
	SDK_UNDEFINED(16,11638) /* FMulticastInlineDelegate */ __um(OnAscenderSetupComplete);                          // 0x0C98   (0x0010)  
	...
	SDK_UNDEFINED(1,11639) /* TEnumAsByte<ESplineMeshAxis> */ __um(MeshForwardAxis);                               // 0x0CC8   (0x0001)  
	...
	SDK_UNDEFINED(8,11640) /* TWeakObjectPtr<UPrimitiveComponent*> */ __um(CurrentInteractComponent);              // 0x0F38   (0x0008)  
	SDK_UNDEFINED(8,11641) /* TWeakObjectPtr<AFortPlayerPawn*> */ __um(PawnUsingHandle);                           // 0x0F40   (0x0008)  
	SDK_UNDEFINED(8,11642) /* TWeakObjectPtr<AFortPlayerPawn*> */ __um(PreviousPawnUsingHandle);                   // 0x0F48   (0x0008)  
	class USplineMeshComponent*                        SplineMesh;                                                 // 0x0F50   (0x0008)  
	class UCapsuleComponent*                           SimpleSplineMeshCollision;                                  // 0x0F58   (0x0008)  
	SDK_UNDEFINED(8,11643) /* TWeakObjectPtr<ABuildingActor*> */ __um(FloorActor);                                 // 0x0F60   (0x0008)  
	SDK_UNDEFINED(16,11644) /* TArray<TWeakObjectPtr<AFortPlayerPawn*>> */ __um(RotationLockedPawns);              // 0x0F68   (0x0010)  
