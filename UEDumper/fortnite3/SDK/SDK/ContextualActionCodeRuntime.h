...
public:
	...
	SDK_UNDEFINED(24,12356) /* FText */                __um(StartHijackInteractText);                              // 0x00C0   (0x0018)  
	SDK_UNDEFINED(24,12357) /* FText */                __um(StartHijackInteractSubText);                           // 0x00D8   (0x0018)  
	SDK_UNDEFINED(24,12358) /* FText */                __um(CompleteHijackInteractText);                           // 0x00F0   (0x0018)  
	SDK_UNDEFINED(24,12359) /* FText */                __um(CompleteHijackInteractSubText);                        // 0x0108   (0x0018)  
...
public:
	...
	SDK_UNDEFINED(8,12360) /* TWeakObjectPtr<AFortSwingingObject*> */ __um(ReplicatedSwingingObject);              // 0x00E4   (0x0008)  
...
{ 
	...
	SDK_UNDEFINED(8,12361) /* TWeakObjectPtr<AFortSwingingObject*> */ __um(TargetSwingingObject);                  // 0x0020   (0x0008)  
};
...
{ 
	FVector                                            AttachLocation;                                             // 0x0008   (0x0018)  
	SDK_UNDEFINED(8,12362) /* TWeakObjectPtr<AFortSwingingObject*> */ __um(TargetSwingingRope);                    // 0x0020   (0x0008)  
};
