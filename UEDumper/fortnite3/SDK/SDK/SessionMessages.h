...
{ 
	SDK_UNDEFINED(16,15297) /* FString */              __um(UserName);                                             // 0x0000   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,15298) /* FString */              __um(BuildDate);                                            // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,15299) /* FString */              __um(DeviceName);                                           // 0x0018   (0x0010)  
	FGuid                                              InstanceID;                                                 // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,15300) /* FString */              __um(InstanceName);                                         // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,15301) /* FString */              __um(PlatformName);                                         // 0x0048   (0x0010)  
	FGuid                                              SessionId;                                                  // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,15302) /* FString */              __um(SessionName);                                          // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,15303) /* FString */              __um(SessionOwner);                                         // 0x0078   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,15304) /* FString */              __um(Data);                                                 // 0x0008   (0x0010)  
