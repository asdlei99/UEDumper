...
class alignas(0x10) 
USocialListEntryBase : public UCommonButtonLegacy
{ 
public:
...
#pragma pack(push, 0x1)
class alignas(0x10) 
USocialListInteractableEntryBase : public USocialListEntryBase
{ 
public:
...
#pragma pack(push, 0x1)
class alignas(0x10) 
USocialUserListHeaderEntry : public USocialListEntryBase
{ 
public:
...
public:
	...
	SDK_UNDEFINED(80,9413) /* TMap<UClass*, USocialActionMenu*> */ __um(CachedActionMenuPool);                     // 0x03F8   (0x0050)  
};
