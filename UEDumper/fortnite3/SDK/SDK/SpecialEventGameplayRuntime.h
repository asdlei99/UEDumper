...
public:
	...
	SDK_UNDEFINED(16,15326) /* TScriptInterface<Class> */ __um(SpawnedTODM);                                       // 0x0360   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,15327) /* FString */              __um(ComponentName);                                        // 0x0000   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(32,15328) /* TWeakObjectPtr<UClass*> */ __um(SoftActorClass);                                    // 0x0020   (0x0020)  
...
public:
	...
	SDK_UNDEFINED(80,15329) /* TMap<AFortPlayerStateAthena*, EFakeKillRelevancyPlayerKillStep> */ __um(ClientPlayerStateKillStepMap); // 0x01C8   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(16,15330) /* FString */              __um(GameFeatureToLoad);                                    // 0x0338   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,15331) /* TArray<FString> */      __um(AllowedGameFeatures);                                  // 0x0338   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,15332) /* FMulticastInlineDelegate */ __um(TeleportAllPlayersFinished);                       // 0x0338   (0x0010)  
	SDK_UNDEFINED(16,15333) /* FMulticastInlineDelegate */ __um(OnPawnLoaded);                                     // 0x0348   (0x0010)  
	SDK_UNDEFINED(16,15334) /* FMulticastInlineDelegate */ __um(OnInitController);                                 // 0x0358   (0x0010)  
	SDK_UNDEFINED(16,15335) /* FMulticastInlineDelegate */ __um(OnResumeGame);                                     // 0x0368   (0x0010)  
	SDK_UNDEFINED(16,15336) /* FMulticastInlineDelegate */ __um(OnSpecialClientEvent);                             // 0x0378   (0x0010)  
	SDK_UNDEFINED(16,15337) /* FMulticastInlineDelegate */ __um(OnHandleLogout);                                   // 0x0388   (0x0010)  
	SDK_UNDEFINED(16,15338) /* FMulticastInlineDelegate */ __um(OnClientInitialLoadingFinished);                   // 0x0398   (0x0010)  
	...
	SDK_UNDEFINED(16,15339) /* FString */              __um(LastCSVEventName);                                     // 0x0588   (0x0010)  
	...
	SDK_UNDEFINED(80,15340) /* TMap<FUniqueNetIdRepl, int32_t> */ __um(OverridePartsArrayIndexMap);                // 0x0650   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(16,15341) /* FMulticastInlineDelegate */ __um(BP_OnStartGameplayOutro);                          // 0x00D8   (0x0010)  
	SDK_UNDEFINED(16,15342) /* FMulticastInlineDelegate */ __um(BP_OnGameplayIntroFinished);                       // 0x00E8   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(8,15343) /* TWeakObjectPtr<AFortAthenaMutator_SpecialEvent*> */ __um(SpecialEventMutator);       // 0x00AC   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(80,15344) /* TMap<ECommonPlatformType, FGameplayTag> */ __um(ClientPlatformQualitySettingsTagMap); // 0x00B0   (0x0050)  
	SDK_UNDEFINED(80,15345) /* TMap<FGameplayTag, FCustomTickComonentQualitySettings> */ __um(QualitySettingsMap); // 0x0100   (0x0050)  
	float                                              WasRecentlyRenderedTolerance;                               // 0x0150   (0x0004)  
	unsigned char                                      UnknownData02_5[0x4];                                       // 0x0154   (0x0004)  MISSED
	SDK_UNDEFINED(16,15346) /* FMulticastInlineDelegate */ __um(OnCustomTick);                                     // 0x0158   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(8,15347) /* TWeakObjectPtr<UObject*> */ __um(InstigatingObject);                                 // 0x0004   (0x0008)  
};
...
public:
	...
	SDK_UNDEFINED(16,15348) /* FMulticastInlineDelegate */ __um(OnDesiredVisibilityChanged);                       // 0x00A8   (0x0010)  
	...
	SDK_UNDEFINED(16,15349) /* FMulticastInlineDelegate */ __um(OnCursorModeChanged);                              // 0x00E0   (0x0010)  
	...
	SDK_UNDEFINED(80,15350) /* TMap<FGameplayTag, FSpecialEventCursorMode> */ __um(CursorModes);                   // 0x00F8   (0x0050)  
	...
	SDK_UNDEFINED(16,15351) /* FMulticastInlineDelegate */ __um(OnViewportLocationChanged);                        // 0x01C8   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_3[0x8];                                       // 0x00A0   (0x0008)  MISSED
	SDK_UNDEFINED(16,15352) /* FMulticastInlineDelegate */ __um(OnCursorPawnComponentSet);                         // 0x00A8   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,15353) /* FMulticastInlineDelegate */ __um(OnReady);                                          // 0x0030   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,15354) /* FMulticastInlineDelegate */ __um(OnLoaded);                                         // 0x00A0   (0x0010)  
	SDK_UNDEFINED(16,15355) /* FString */              __um(Version);                                              // 0x00B0   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,15356) /* FMulticastInlineDelegate */ __um(OnReady);                                          // 0x0030   (0x0010)  
	unsigned char                                      UnknownData00_6[0x8];                                       // 0x0040   (0x0008)  MISSED
...
public:
	...
	SDK_UNDEFINED(32,15357) /* TWeakObjectPtr<ULevelSequence*> */ __um(LevelSequence);                             // 0x02B0   (0x0020)  
...
{ 
	SDK_UNDEFINED(32,15358) /* TWeakObjectPtr<UWorld*> */ __um(LevelToLoad);                                       // 0x0060   (0x0020)  
	SDK_UNDEFINED(16,15359) /* FString */              __um(LevelName);                                            // 0x0080   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,15360) /* FMulticastInlineDelegate */ __um(OnSpecialEventPhaseActivated);                     // 0x0290   (0x0010)  
	SDK_UNDEFINED(16,15361) /* FMulticastInlineDelegate */ __um(OnSpecialEventPhaseDeactivated);                   // 0x02A0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,15362) /* FString */              __um(CalendarEventName);                                    // 0x0298   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,15363) /* FMulticastInlineDelegate */ __um(OnValueChangedDelegate);                           // 0x00A0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,15364) /* FMulticastInlineDelegate */ __um(OnSpecialRelevancyDeath);                          // 0x00E0   (0x0010)  
	SDK_UNDEFINED(16,15365) /* FMulticastInlineDelegate */ __um(OnSpecialRelevancyDamage);                         // 0x00F0   (0x0010)  
...
{ 
	SDK_UNDEFINED(1,15366) /* TEnumAsByte<EEasingFunc> */ __um(EasingFunc);                                        // 0x0000   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x0001   (0x0003)  MISSED
...
{ 
	...
	SDK_UNDEFINED(1,15367) /* TEnumAsByte<ECollisionChannel> */ __um(TraceChannel);                                // 0x0211   (0x0001)  
