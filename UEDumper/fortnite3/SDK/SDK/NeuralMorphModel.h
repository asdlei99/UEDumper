...
public:
	...
	SDK_UNDEFINED(80,14839) /* TMap<FName, FNeuralMorphMaskInfo> */ __um(BoneMaskInfos);                           // 0x01B0   (0x0050)  
	SDK_UNDEFINED(80,14840) /* TMap<FName, FNeuralMorphMaskInfo> */ __um(BoneGroupMaskInfos);                      // 0x0200   (0x0050)  
