...
public:
	...
	SDK_UNDEFINED(80,14312) /* TMap<FMassEntityTemplateID, FMassAgentInitializationQueue> */ __um(PendingAgentEntities); // 0x0058   (0x0050)  
	SDK_UNDEFINED(80,14313) /* TMap<FMassEntityTemplateID, FMassAgentInitializationQueue> */ __um(PendingPuppets); // 0x00A8   (0x0050)  
	class UMassReplicationSubsystem*                   ReplicationSubsystem;                                       // 0x00F8   (0x0008)  
	SDK_UNDEFINED(80,14314) /* TMap<FMassNetworkID, UMassAgentComponent*> */ __um(ReplicatedAgentComponents);      // 0x0100   (0x0050)  
...
{ 
	SDK_UNDEFINED(8,14315) /* TWeakObjectPtr<AActor*> */ __um(Actor);                                              // 0x0000   (0x0008)  
