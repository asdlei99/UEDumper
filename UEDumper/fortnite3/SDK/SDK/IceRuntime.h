...
public:
	...
	SDK_UNDEFINED(80,14024) /* TMap<ABuildingActor*, float> */ __um(AggregateDamagePerActor);                      // 0x0098   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(1,14025) /* TEnumAsByte<ESplineMeshAxis> */ __um(ForwardAxis);                                   // 0x02A0   (0x0001)  
