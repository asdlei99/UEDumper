...
{ 
	SDK_UNDEFINED(1,14672) /* TEnumAsByte<EFortCustomPartType> */ __um(LegacyPartType);                            // 0x0000   (0x0001)  
...
{ 
	SDK_UNDEFINED(16,14673) /* FString */              __um(GroupName);                                            // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,14674) /* FString */              __um(ValueName);                                            // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(32,14675) /* TWeakObjectPtr<UCustomizableObject*> */ __um(ObjectToModify);                       // 0x0000   (0x0020)  
};
...
{ 
	SDK_UNDEFINED(16,14676) /* FString */              __um(ParameterName);                                        // 0x0000   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,14677) /* FString */              __um(NamedValue);                                           // 0x0020   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(80,14678) /* TMap<FName, FCustomizableObjectMultilayerProjectors> */ __um(MultilayerProjectors); // 0x0020   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(16,14679) /* FString */              __um(NewState);                                             // 0x0018   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(32,14680) /* TWeakObjectPtr<UTexture2D*> */ __um(SprayNotAssignedImage);                         // 0x0000   (0x0020)  
	SDK_UNDEFINED(32,14681) /* TWeakObjectPtr<UTexture2D*> */ __um(SprayAssignedImage);                            // 0x0020   (0x0020)  
};
...
public:
	...
	SDK_UNDEFINED(16,14682) /* FString */              __um(EnabledParamName);                                     // 0x0078   (0x0010)  
	SDK_UNDEFINED(16,14683) /* FString */              __um(ProjectorParamName);                                   // 0x0088   (0x0010)  
	SDK_UNDEFINED(16,14684) /* FString */              __um(TextureParamName);                                     // 0x0098   (0x0010)  
	SDK_UNDEFINED(16,14685) /* FString */              __um(SaturationParamName);                                  // 0x00A8   (0x0010)  
	SDK_UNDEFINED(16,14686) /* FString */              __um(WearParamName);                                        // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,14687) /* FString */              __um(ScaleParamName);                                       // 0x00C8   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(80,14688) /* TMap<FCosmeticSlotSelector, FCosmeticsLayoutSlot> */ __um(SlotDataConfig);          // 0x0338   (0x0050)  
	SDK_UNDEFINED(80,14689) /* TMap<FCosmeticSlotSelector, TWeakObjectPtr<UCustomizableObject*>> */ __um(SlottedCustomizableObjects); // 0x0388   (0x0050)  
};
...
{ 
public:
	SDK_UNDEFINED(32,14690) /* TWeakObjectPtr<UMeshCosmeticsLayoutSchema*> */ __um(SchemaAsset);                   // 0x0028   (0x0020)  
};
...
{ 
public:
	SDK_UNDEFINED(16,14691) /* TArray<TWeakObjectPtr<UMeshCosmeticsLayoutSchema*>> */ __um(SupportedSchemas);      // 0x0028   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,14692) /* FString */              __um(Image);                                                // 0x0070   (0x0010)  
...
{ 
	SDK_UNDEFINED(80,14693) /* TMap<FName, FCustomizableObjectMultilayerProjectsVirtualLayer> */ __um(VirtualLayers); // 0x0000   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(80,14694) /* TMap<FCosmeticSlotSelector, FCosmeticsLayoutSlot> */ __um(AllSlotDataConfigs);      // 0x0000   (0x0050)  
	SDK_UNDEFINED(80,14695) /* TMap<FCosmeticSlotSelector, UMeshCosmeticsLayoutSchema*> */ __um(ProvidedSlotsToSchemaData); // 0x0050   (0x0050)  
	...
	SDK_UNDEFINED(80,14696) /* TMap<UCustomizableSkeletalComponent*, FSkeletalComponentData> */ __um(SkeletalComponentData); // 0x00C0   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(32,14697) /* TWeakObjectPtr<UCustomizableObject*> */ __um(SlottedObject);                        // 0x0000   (0x0020)  
	...
	SDK_UNDEFINED(32,14698) /* TWeakObjectPtr<UClass*> */ __um(ProportionalLayerAnimBP);                           // 0x0028   (0x0020)  
	SDK_UNDEFINED(80,14699) /* TMap<int32_t, FName> */ __um(LinkedAnimGraphTag);                                   // 0x0048   (0x0050)  
};
