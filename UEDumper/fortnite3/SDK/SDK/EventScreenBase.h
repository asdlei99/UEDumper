...
{ 
	SDK_UNDEFINED(32,13398) /* TWeakObjectPtr<UFortItemDefinition*> */ __um(ItemDefinition);                       // 0x0000   (0x0020)  
	SDK_UNDEFINED(32,13399) /* TWeakObjectPtr<UTexture2D*> */ __um(CustomItemTexture);                             // 0x0020   (0x0020)  
	SDK_UNDEFINED(32,13400) /* TWeakObjectPtr<UTexture2D*> */ __um(CustomItemTextureMobile);                       // 0x0040   (0x0020)  
...
{ 
	SDK_UNDEFINED(24,13401) /* FText */                __um(Header);                                               // 0x0000   (0x0018)  
	SDK_UNDEFINED(24,13402) /* FText */                __um(Body);                                                 // 0x0018   (0x0018)  
	SDK_UNDEFINED(32,13403) /* TWeakObjectPtr<UObject*> */ __um(Icon);                                             // 0x0030   (0x0020)  
};
...
{ 
public:
	SDK_UNDEFINED(16,13404) /* FString */              __um(EventCMSId);                                           // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,13405) /* FString */              __um(AccountResourceName);                                  // 0x0040   (0x0010)  
	SDK_UNDEFINED(16,13406) /* FString */              __um(LevelOfferId);                                         // 0x0050   (0x0010)  
	SDK_UNDEFINED(16,13407) /* FString */              __um(PremiumTrackOfferId);                                  // 0x0060   (0x0010)  
	...
	SDK_UNDEFINED(32,13408) /* TWeakObjectPtr<UFortChallengeBundleItemDefinition*> */ __um(QuestBundle);           // 0x00D8   (0x0020)  
	SDK_UNDEFINED(32,13409) /* TWeakObjectPtr<UFortItemDefinition*> */ __um(SpecialRewardItem);                    // 0x00F8   (0x0020)  
	SDK_UNDEFINED(32,13410) /* TWeakObjectPtr<UFortItemDefinition*> */ __um(SpecialPremiumRewardItem);             // 0x0118   (0x0020)  
	...
	SDK_UNDEFINED(80,13411) /* TMap<FName, FLinearColor> */ __um(RewardTileBackgroundColors);                      // 0x0530   (0x0050)  
	SDK_UNDEFINED(24,13412) /* FText */                __um(TimeRemainingFormat);                                  // 0x0580   (0x0018)  
	SDK_UNDEFINED(24,13413) /* FText */                __um(CurrencyFormat);                                       // 0x0598   (0x0018)  
	...
	SDK_UNDEFINED(32,13414) /* TWeakObjectPtr<UClass*> */ __um(MoreInfoModalClass);                                // 0x0628   (0x0020)  
	SDK_UNDEFINED(32,13415) /* TWeakObjectPtr<UClass*> */ __um(PurchaseLevelsModalClass);                          // 0x0648   (0x0020)  
	SDK_UNDEFINED(32,13416) /* TWeakObjectPtr<UClass*> */ __um(PurchasePremiumTrackModalClass);                    // 0x0668   (0x0020)  
	SDK_UNDEFINED(16,13417) /* TArray<FString> */      __um(CalendarEvents);                                       // 0x0688   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,13418) /* FMulticastInlineDelegate */ __um(OnProgressBarAnimationStartedEvent);               // 0x0380   (0x0010)  
	SDK_UNDEFINED(16,13419) /* FMulticastInlineDelegate */ __um(OnProgressBarAnimationCompletedEvent);             // 0x0390   (0x0010)  
	SDK_UNDEFINED(16,13420) /* FMulticastInlineDelegate */ __um(OnProgressBarAnimationInterruptedEvent);           // 0x03A0   (0x0010)  
	SDK_UNDEFINED(16,13421) /* FMulticastInlineDelegate */ __um(OnResourcePreviewOffsetAnimationEvent);            // 0x03B0   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,13422) /* FString */              __um(CountdownCalendarEventFlag);                           // 0x0570   (0x0010)  
	SDK_UNDEFINED(16,13423) /* TArray<FString> */      __um(CalendarEvents);                                       // 0x0580   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(32,13424) /* TWeakObjectPtr<UTexture2D*> */ __um(FallbackBrush);                                 // 0x02D8   (0x0020)  
	SDK_UNDEFINED(32,13425) /* TWeakObjectPtr<UFortTokenType*> */ __um(TokenDefinition);                           // 0x02F8   (0x0020)  
...
public:
	...
	SDK_UNDEFINED(24,13426) /* FText */                __um(PromptTextUnowned);                                    // 0x02D0   (0x0018)  
	SDK_UNDEFINED(24,13427) /* FText */                __um(PromptTextOwned);                                      // 0x02E8   (0x0018)  
...
{ 
	SDK_UNDEFINED(24,13428) /* FText */                __um(Header);                                               // 0x0000   (0x0018)  
	SDK_UNDEFINED(24,13429) /* FText */                __um(Body);                                                 // 0x0018   (0x0018)  
	SDK_UNDEFINED(16,13430) /* FString */              __um(IconURL);                                              // 0x0030   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,13431) /* FString */              __um(KeyArtOverrideURL);                                    // 0x0008   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,13432) /* FString */              __um(EventCMSId);                                           // 0x0000   (0x0010)  
	SDK_UNDEFINED(24,13433) /* FText */                __um(EventName);                                            // 0x0010   (0x0018)  
	SDK_UNDEFINED(24,13434) /* FText */                __um(EventDescription);                                     // 0x0028   (0x0018)  
	SDK_UNDEFINED(24,13435) /* FText */                __um(ResourceHeader);                                       // 0x0040   (0x0018)  
	SDK_UNDEFINED(24,13436) /* FText */                __um(StarterHeader);                                        // 0x0058   (0x0018)  
	SDK_UNDEFINED(24,13437) /* FText */                __um(CompletionHeader);                                     // 0x0070   (0x0018)  
	SDK_UNDEFINED(24,13438) /* FText */                __um(EventCTA);                                             // 0x0088   (0x0018)  
	SDK_UNDEFINED(24,13439) /* FText */                __um(EventCTACompleted);                                    // 0x00A0   (0x0018)  
	SDK_UNDEFINED(24,13440) /* FText */                __um(HeaderCTA);                                            // 0x00B8   (0x0018)  
	SDK_UNDEFINED(24,13441) /* FText */                __um(ItemShopCallout);                                      // 0x00D0   (0x0018)  
	SDK_UNDEFINED(16,13442) /* FString */              __um(CTAIconURL);                                           // 0x00E8   (0x0010)  
	SDK_UNDEFINED(16,13443) /* FString */              __um(KeyArtURL);                                            // 0x00F8   (0x0010)  
	SDK_UNDEFINED(24,13444) /* FText */                __um(MoreInfoHeader);                                       // 0x0108   (0x0018)  
	SDK_UNDEFINED(24,13445) /* FText */                __um(MoreInfoSubHeader);                                    // 0x0120   (0x0018)  
	SDK_UNDEFINED(24,13446) /* FText */                __um(MoreInfoLegal);                                        // 0x0138   (0x0018)  
	TArray<FEventScreenCMSMoreInfoGroup>               MoreInfoGroups;                                             // 0x0150   (0x0010)  
	SDK_UNDEFINED(24,13447) /* FText */                __um(PurchaseLegal);                                        // 0x0160   (0x0018)  
	SDK_UNDEFINED(24,13448) /* FText */                __um(RewardTrackLegal);                                     // 0x0178   (0x0018)  
	SDK_UNDEFINED(16,13449) /* FString */              __um(ItemShopOfferId);                                      // 0x0190   (0x0010)  
	SDK_UNDEFINED(24,13450) /* FText */                __um(PremiumUpsellUnownedHeader);                           // 0x01A0   (0x0018)  
	SDK_UNDEFINED(24,13451) /* FText */                __um(PremiumUpsellUnownedBody);                             // 0x01B8   (0x0018)  
	SDK_UNDEFINED(24,13452) /* FText */                __um(PremiumUpsellOwnedHeader);                             // 0x01D0   (0x0018)  
	SDK_UNDEFINED(24,13453) /* FText */                __um(PremiumUpsellOwnedBody);                               // 0x01E8   (0x0018)  
	SDK_UNDEFINED(16,13454) /* FString */              __um(PremiumUpsellIconURL);                                 // 0x0200   (0x0010)  
	SDK_UNDEFINED(24,13455) /* FText */                __um(PurchasePremiumTrackHeader);                           // 0x0210   (0x0018)  
	SDK_UNDEFINED(16,13456) /* TArray<FText> */        __um(PurchasePremiumTrackBodyList);                         // 0x0228   (0x0010)  
	SDK_UNDEFINED(24,13457) /* FText */                __um(InspectSpecialItemUnowned);                            // 0x0238   (0x0018)  
	SDK_UNDEFINED(24,13458) /* FText */                __um(InspectSpecialItemOwned);                              // 0x0250   (0x0018)  
	SDK_UNDEFINED(24,13459) /* FText */                __um(InspectSpecialPremiumItemUnowned);                     // 0x0268   (0x0018)  
	SDK_UNDEFINED(24,13460) /* FText */                __um(InspectSpecialPremiumItemOwned);                       // 0x0280   (0x0018)  
