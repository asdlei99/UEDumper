...
{ 
	SDK_UNDEFINED(16,13353) /* FString */              __um(Command);                                              // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,13354) /* FString */              __um(Desc);                                                 // 0x0010   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,13355) /* TArray<FString> */      __um(AutoCompleteMapPaths);                                 // 0x0040   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,13356) /* FString */              __um(Name);                                                 // 0x0000   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(16,13357) /* FString */              __um(LocalMapOptions);                                      // 0x0028   (0x0010)  
	FSoftObjectPath                                    TransitionMap;                                              // 0x0038   (0x0018)  
	bool                                               bUseSplitscreen;                                            // 0x0050   (0x0001)  
	SDK_UNDEFINED(1,13358) /* TEnumAsByte<ETwoPlayerSplitScreenType> */ __um(TwoPlayerSplitscreenLayout);          // 0x0051   (0x0001)  
	SDK_UNDEFINED(1,13359) /* TEnumAsByte<EThreePlayerSplitScreenType> */ __um(ThreePlayerSplitscreenLayout);      // 0x0052   (0x0001)  
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(16,13360) /* FString */              __um(CompanyName);                                          // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,13361) /* FString */              __um(CompanyDistinguishedName);                             // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,13362) /* FString */              __um(CopyrightNotice);                                      // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,13363) /* FString */              __um(Description);                                          // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,13364) /* FString */              __um(Homepage);                                             // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,13365) /* FString */              __um(LicensingTerms);                                       // 0x0078   (0x0010)  
	SDK_UNDEFINED(16,13366) /* FString */              __um(PrivacyPolicy);                                        // 0x0088   (0x0010)  
	FGuid                                              ProjectID;                                                  // 0x0098   (0x0010)  
	SDK_UNDEFINED(16,13367) /* FString */              __um(ProjectName);                                          // 0x00A8   (0x0010)  
	SDK_UNDEFINED(16,13368) /* FString */              __um(ProjectVersion);                                       // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,13369) /* FString */              __um(SupportContact);                                       // 0x00C8   (0x0010)  
	SDK_UNDEFINED(24,13370) /* FText */                __um(ProjectDisplayedTitle);                                // 0x00D8   (0x0018)  
	SDK_UNDEFINED(24,13371) /* FText */                __um(ProjectDebugTitleInfo);                                // 0x00F0   (0x0018)  
...
{ 
	...
	SDK_UNDEFINED(24,13372) /* FText */                __um(DisplayName);                                          // 0x0030   (0x0018)  
};
