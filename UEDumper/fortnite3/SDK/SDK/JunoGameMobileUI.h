...
public:
	...
	SDK_UNDEFINED(24,14258) /* FText */                __um(ForcedPresetName);                                     // 0x04B8   (0x0018)  
	FGameplayTag                                       ForcedProfile;                                              // 0x04D0   (0x0004)  
	FGameplayTag                                       ForcedProfileContainer;                                     // 0x04D4   (0x0004)  
	SDK_UNDEFINED(80,14259) /* TMap<FGameplayTag, UDynamicUIScene*> */ __um(HUDContextVisibilityTagToScene);       // 0x04D8   (0x0050)  
