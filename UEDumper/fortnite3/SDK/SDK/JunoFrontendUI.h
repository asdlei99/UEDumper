...
public:
	...
	SDK_UNDEFINED(32,14254) /* TWeakObjectPtr<UClass*> */ __um(VideoPlayerClass);                                  // 0x0050   (0x0020)  
	SDK_UNDEFINED(16,14255) /* TArray<FString> */      __um(FlowStepArray);                                        // 0x0070   (0x0010)  
	bool                                               bEnableTrailer;                                             // 0x0080   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0081   (0x0007)  MISSED
	SDK_UNDEFINED(16,14256) /* FString */              __um(CinematicTrailerVUID);                                 // 0x0088   (0x0010)  
	FName                                              CinematicTrailerString;                                     // 0x0098   (0x0004)  
	unsigned char                                      UnknownData02_5[0x4];                                       // 0x009C   (0x0004)  MISSED
	SDK_UNDEFINED(80,14257) /* TMap<FString, FString> */ __um(CinematicTrailerRating);                             // 0x00A0   (0x0050)  
