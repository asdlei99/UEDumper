...
{ 
	...
	SDK_UNDEFINED(80,12267) /* TMap<FName, FRichCurve> */ __um(CurveData);                                         // 0x0048   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(80,12268) /* TMap<FName, FRichCurves> */ __um(ChannelsTracks);                                   // 0x0060   (0x0050)  
	SDK_UNDEFINED(80,12269) /* TMap<FName, FCompressedRichCurves> */ __um(CompressedChannelsTracks);               // 0x00B0   (0x0050)  
	SDK_UNDEFINED(80,12270) /* TMap<FName, FRichCurve> */ __um(CurveData);                                         // 0x0100   (0x0050)  
	SDK_UNDEFINED(80,12271) /* TMap<FName, FParticleTransformTrack> */ __um(NamedTransformTracks);                 // 0x0150   (0x0050)  
	...
	SDK_UNDEFINED(80,12272) /* TMap<FName, FCacheEventTrack> */ __um(EventTracks);                                 // 0x01B0   (0x0050)  
