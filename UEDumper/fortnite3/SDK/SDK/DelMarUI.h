...
public:
	...
	SDK_UNDEFINED(16,13084) /* FMulticastInlineDelegate */ __um(OnCountdownTimeChanged);                           // 0x0370   (0x0010)  
	SDK_UNDEFINED(16,13085) /* FMulticastInlineDelegate */ __um(OnCountdownTimeSet);                               // 0x0380   (0x0010)  
	SDK_UNDEFINED(16,13086) /* FMulticastInlineDelegate */ __um(OnCountdownTimeEnded);                             // 0x0390   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,13087) /* TMap<FGameplayTag, FName> */ __um(MainChannelAnimationTagTable);                    // 0x0378   (0x0050)  
	SDK_UNDEFINED(80,13088) /* TMap<int32_t, FDelMarReactiveWidgetAnimation> */ __um(ReactiveAnimationTable);      // 0x03C8   (0x0050)  
	SDK_UNDEFINED(80,13089) /* TMap<FName, UWidgetAnimation*> */ __um(AnimationNameTable);                         // 0x0418   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(8,13090) /* TWeakObjectPtr<ULocalPlayer*> */ __um(OwningLocalPlayer);                            // 0x0118   (0x0008)  
	SDK_UNDEFINED(8,13091) /* TWeakObjectPtr<UCommonInputSubsystem*> */ __um(CommonInputSubsystem);                // 0x0120   (0x0008)  
	SDK_UNDEFINED(8,13092) /* TWeakObjectPtr<UEnhancedInputLocalPlayerSubsystem*> */ __um(EnhancedInputSubsystem); // 0x0128   (0x0008)  
};
...
{ 
	SDK_UNDEFINED(8,13093) /* TWeakObjectPtr<AFortPlayerState*> */ __um(PlayerState);                              // 0x0000   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,13094) /* TWeakObjectPtr<UDelMarVehicleManager*> */ __um(VehicleManager);                      // 0x0408   (0x0008)  
	SDK_UNDEFINED(8,13095) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(ViewingVehicle);                             // 0x0410   (0x0008)  
	SDK_UNDEFINED(8,13096) /* TWeakObjectPtr<AFortPlayerState*> */ __um(ViewingPlayerState);                       // 0x0418   (0x0008)  
	TArray<FDelMarPlayerIndicatorData>                 IndicatorsData;                                             // 0x0420   (0x0010)  
	SDK_UNDEFINED(80,13097) /* TMap<AFortPlayerState*, UDelMarPlayerIndicatorWidget*> */ __um(IndicatorWidgets);   // 0x0430   (0x0050)  
	TArray<class UDelMarPlayerIndicatorWidget*>        IndicatorPool;                                              // 0x0480   (0x0010)  
	SDK_UNDEFINED(8,13098) /* TWeakObjectPtr<UDelMarPositionalTrackerComponent*> */ __um(PositionalTrackerComponent); // 0x0490   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(16,13099) /* FMulticastInlineDelegate */ __um(OnExpandToggled);                                  // 0x03C8   (0x0010)  
	SDK_UNDEFINED(16,13100) /* FMulticastInlineDelegate */ __um(OnNavigationEnabledChanged);                       // 0x03D8   (0x0010)  
	SDK_UNDEFINED(16,13101) /* FMulticastInlineDelegate */ __um(OnExpandableChanged);                              // 0x03E8   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(24,13102) /* FText */                __um(TextFormat);                                           // 0x02C8   (0x0018)  
	SDK_UNDEFINED(80,13103) /* TMap<FString, FDelMarKeyPair> */ __um(Args);                                        // 0x02E0   (0x0050)  
	SDK_UNDEFINED(24,13104) /* FText */                __um(TextKBM);                                              // 0x0330   (0x0018)  
	SDK_UNDEFINED(24,13105) /* FText */                __um(TextGamepad);                                          // 0x0348   (0x0018)  
	SDK_UNDEFINED(24,13106) /* FText */                __um(TextTouch);                                            // 0x0360   (0x0018)  
...
public:
	...
	SDK_UNDEFINED(80,13107) /* TMap<EDelMarTouchActionButtonState, FDelMarTouchActionButtonStateData> */ __um(ButtonStateData); // 0x0390   (0x0050)  
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(16,13108) /* FMulticastInlineDelegate */ __um(OnTransitionerStatusChanged);                      // 0x0028   (0x0010)  
	...
	SDK_UNDEFINED(80,13109) /* TMap<FGameplayTag, UUIAnimationControllerEntry*> */ __um(HintedTransitionsIn);      // 0x0058   (0x0050)  
	SDK_UNDEFINED(80,13110) /* TMap<FGameplayTag, UUIAnimationControllerEntry*> */ __um(HintedTransitionsOut);     // 0x00A8   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(16,13111) /* FMulticastInlineDelegate */ __um(OnInputMethodChanged);                             // 0x0178   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(80,13112) /* TMap<FGameplayTag, TWeakObjectPtr<UClass*>> */ __um(DialogMapping);                 // 0x0028   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(32,13113) /* TWeakObjectPtr<UClass*> */ __um(CustomLoadingWidget);                               // 0x0038   (0x0020)  
...
{ 
public:
	SDK_UNDEFINED(8,13114) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedDelMarVehicle);                        // 0x0360   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(8,13115) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CachedDelMarVehicle);                        // 0x0360   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(16,13116) /* FMulticastInlineDelegate */ __um(OnDisplayedPlayerSet);                             // 0x0360   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,13117) /* TArray<FText> */        __um(LoadingScreenTips);                                    // 0x02F0   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(80,13118) /* TMap<FGameplayTag, FString> */ __um(GameStateToUITagMap);                           // 0x0048   (0x0050)  
	...
	SDK_UNDEFINED(8,13119) /* TWeakObjectPtr<AFortPlayerState*> */ __um(OwnerPlayerState);                         // 0x00A4   (0x0008)  
	SDK_UNDEFINED(8,13120) /* TWeakObjectPtr<AFortPlayerState*> */ __um(SpectatedPlayerState);                     // 0x00AC   (0x0008)  
	SDK_UNDEFINED(8,13121) /* TWeakObjectPtr<AFortPlayerController*> */ __um(OwnerPlayerController);               // 0x00B4   (0x0008)  
	SDK_UNDEFINED(8,13122) /* TWeakObjectPtr<UDelMarLevelManagerComponent*> */ __um(LevelManager);                 // 0x00BC   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(24,13123) /* FText */                __um(MapName);                                              // 0x0070   (0x0018)  
	SDK_UNDEFINED(24,13124) /* FText */                __um(MapCreator);                                           // 0x0088   (0x0018)  
	SDK_UNDEFINED(24,13125) /* FText */                __um(MapDescription);                                       // 0x00A0   (0x0018)  
	FGameplayTag                                       RaceMode;                                                   // 0x00B8   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x00BC   (0x0004)  MISSED
	SDK_UNDEFINED(32,13126) /* TWeakObjectPtr<UTexture2D*> */ __um(LoadingBackgroundImage);                        // 0x00C0   (0x0020)  
};
...
public:
	...
	SDK_UNDEFINED(8,13127) /* TWeakObjectPtr<UDelMarPlayerPreferencesComponent*> */ __um(CachedPreferences);       // 0x006C   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,13128) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(RaceManager);                            // 0x00D4   (0x0008)  
	SDK_UNDEFINED(8,13129) /* TWeakObjectPtr<AFortPlayerState*> */ __um(PlayerState);                              // 0x00DC   (0x0008)  
	SDK_UNDEFINED(8,13130) /* TWeakObjectPtr<UDelMarPositionalTrackerComponent*> */ __um(PositionalTrackerComponent); // 0x00E4   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(24,13131) /* FText */                __um(DisplayName);                                          // 0x0068   (0x0018)  
	SDK_UNDEFINED(32,13132) /* TWeakObjectPtr<UTexture2D*> */ __um(AvatarLargeImage);                              // 0x0080   (0x0020)  
	SDK_UNDEFINED(32,13133) /* TWeakObjectPtr<UTexture2D*> */ __um(AvatarSmallImage);                              // 0x00A0   (0x0020)  
	...
	SDK_UNDEFINED(8,13134) /* TWeakObjectPtr<AFortPlayerState*> */ __um(PlayerState);                              // 0x00D8   (0x0008)  
	SDK_UNDEFINED(8,13135) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(RaceManager);                            // 0x00E0   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(24,13136) /* FText */                __um(MapName);                                              // 0x0080   (0x0018)  
	SDK_UNDEFINED(24,13137) /* FText */                __um(MapCreator);                                           // 0x0098   (0x0018)  
	SDK_UNDEFINED(24,13138) /* FText */                __um(MapDescription);                                       // 0x00B0   (0x0018)  
	FGameplayTag                                       RaceMode;                                                   // 0x00C8   (0x0004)  
	FGameplayTag                                       DelMarGameplayState;                                        // 0x00CC   (0x0004)  
	SDK_UNDEFINED(32,13139) /* TWeakObjectPtr<UTexture2D*> */ __um(LoadingBackgroundImage);                        // 0x00D0   (0x0020)  
	...
	SDK_UNDEFINED(80,13140) /* TMap<int32_t, UDelMarPlayerViewModel*> */ __um(RacePlayers);                        // 0x0158   (0x0050)  
	SDK_UNDEFINED(8,13141) /* TWeakObjectPtr<ADelMarRaceManager*> */ __um(RaceManager);                            // 0x01A8   (0x0008)  
	SDK_UNDEFINED(8,13142) /* TWeakObjectPtr<AFortPlayerController*> */ __um(LocalPlayerController);               // 0x01B0   (0x0008)  
	SDK_UNDEFINED(8,13143) /* TWeakObjectPtr<AFortPlayerState*> */ __um(ViewTargetPlayerState);                    // 0x01B8   (0x0008)  
	SDK_UNDEFINED(8,13144) /* TWeakObjectPtr<UDelMarPositionalTrackerComponent*> */ __um(PositionalTrackerComponent); // 0x01C0   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(24,13145) /* FText */                __um(SectionTitle);                                         // 0x0068   (0x0018)  
...
public:
	...
	SDK_UNDEFINED(8,13146) /* TWeakObjectPtr<AFortPlayerState*> */ __um(PlayerState);                              // 0x00CC   (0x0008)  
	SDK_UNDEFINED(8,13147) /* TWeakObjectPtr<ADelMarVehicle*> */ __um(CurrentVehicle);                             // 0x00D4   (0x0008)  
	SDK_UNDEFINED(8,13148) /* TWeakObjectPtr<UDelMarGlobalInputDisabler*> */ __um(GlobalInputDisabler);            // 0x00DC   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(16,13149) /* FString */              __um(OptionalErrorText);                                    // 0x0078   (0x0010)  
	SDK_UNDEFINED(8,13150) /* TWeakObjectPtr<ULocalPlayer*> */ __um(OwningLocalPlayer);                            // 0x0088   (0x0008)  
	SDK_UNDEFINED(8,13151) /* TWeakObjectPtr<AFortPlayerControllerAthena*> */ __um(OwningPlayerController);        // 0x0090   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(16,13152) /* FString */              __um(DevelopmentRankedKey);                                 // 0x0030   (0x0010)  
};
