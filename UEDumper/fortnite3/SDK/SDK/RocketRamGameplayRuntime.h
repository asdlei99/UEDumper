...
{ 
public:
	FVector                                            InitialDirection;                                           // 0x0100   (0x0018)  
	float                                              MinSpeed;                                                   // 0x0118   (0x0004)  
	float                                              MaxSpeed;                                                   // 0x011C   (0x0004)  
	class UCurveFloat*                                 SpeedCurve;                                                 // 0x0120   (0x0008)  
	float                                              FloorTraceHeight;                                           // 0x0128   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x012C   (0x0004)  MISSED
	class UCurveVector*                                PathOffsetCurve;                                            // 0x0130   (0x0008)  
...
struct FRootMotionSource_RocketRam : FRootMotionSource
{ 
	FVector                                            InitialDirection;                                           // 0x00D8   (0x0018)  
	float                                              MinSpeed;                                                   // 0x00F0   (0x0004)  
	float                                              MaxSpeed;                                                   // 0x00F4   (0x0004)  
	class UCurveFloat*                                 SpeedCurve;                                                 // 0x00F8   (0x0008)  
	float                                              FloorTraceHeight;                                           // 0x0100   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0104   (0x0004)  MISSED
	class UCurveVector*                                PathOffsetCurve;                                            // 0x0108   (0x0008)  
	FVector                                            PreviousEndLocationWithoutOffset;                           // 0x0110   (0x0018)  
