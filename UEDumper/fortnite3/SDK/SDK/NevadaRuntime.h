...
public:
	...
	SDK_UNDEFINED(8,14841) /* TWeakObjectPtr<ALandscapeProxy*> */ __um(CachedLandscapeProxy);                      // 0x1FF0   (0x0008)  
	...
	SDK_UNDEFINED(8,14842) /* TWeakObjectPtr<UPrimitiveComponent*> */ __um(TractorBeamAttachedPrimitive);          // 0x20E0   (0x0008)  
	class AFortAthenaVehicle*                          SpawnedTractorBeamVictimVehicle;                            // 0x20E8   (0x0008)  
	SDK_UNDEFINED(8,14843) /* TWeakObjectPtr<UPrimitiveComponent*> */ __um(PreviousTractorBeamAttachedPrimitive);  // 0x20F0   (0x0008)  
	...
	SDK_UNDEFINED(16,14844) /* TArray<TEnumAsByte<EObjectTypeQuery>> */ __um(TractorBeamObjectsTypes);             // 0x2148   (0x0010)  
	...
	SDK_UNDEFINED(1,14845) /* TEnumAsByte<ETractorBeamState> */ __um(TractorBeamState);                            // 0x2298   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(32,14846) /* TWeakObjectPtr<UAnimMontage*> */ __um(CannonFiringMontage);                         // 0x06B0   (0x0020)  
