...
{ 
	...
	SDK_UNDEFINED(8,13937) /* TWeakObjectPtr<AActor*> */ __um(TargetActor);                                        // 0x0004   (0x0008)  
	SDK_UNDEFINED(8,13938) /* TWeakObjectPtr<USceneComponent*> */ __um(TargetComponent);                           // 0x000C   (0x0008)  
