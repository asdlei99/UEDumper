...
public:
	...
	SDK_UNDEFINED(80,12275) /* TMap<FGameplayTag, UAthenaMapCollectionIcon*> */ __um(MapCollectionIcons);          // 0x0678   (0x0050)  
...
public:
	...
	// void SetSecondaryIcon(TWeakObjectPtr<UObject*>& SecondaryIcon);                                                       // [0x2047e54] RequiredAPI|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/CollectionMapShared.AthenaMapCollectionIcon.SetIsKnown
	// void SetIsKnown(bool bIsKnown);                                                                                       // [0x2047e54] RequiredAPI|Event|Public|BlueprintEvent 
};
