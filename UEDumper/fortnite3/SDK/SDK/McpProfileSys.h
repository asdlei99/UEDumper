...
public:
	...
	// void UnlockProfileForWrite(FString Code, FDedicatedServerUrlContext& Context);                                        // [0xffff800844bd0000] Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms 
	// Function /Script/McpProfileSys.McpProfile.QueryPublicProfile
	// void QueryPublicProfile(FBaseUrlContext& Context);                                                                    // [0xffff800844bd0000] Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms 
	// Function /Script/McpProfileSys.McpProfile.QueryProfile
	// void QueryProfile(FBaseUrlContext& Context);                                                                          // [0xffff800844bd0000] Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms 
	// Function /Script/McpProfileSys.McpProfile.LockProfileForWrite
	// void LockProfileForWrite(FString Code, int32_t Timeout, FDedicatedServerUrlContext& Context);                         // [0xffff800844bd0000] Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms 
	// Function /Script/McpProfileSys.McpProfile.DeleteProfile
	// void DeleteProfile(FClientUrlContext& Context);                                                                       // [0xffff800844bd0000] Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms 
	// Function /Script/McpProfileSys.McpProfile.DeleteAllProfiles
	// void DeleteAllProfiles(FClientUrlContext& Context);                                                                   // [0xffff800844bd0000] Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms 
};
