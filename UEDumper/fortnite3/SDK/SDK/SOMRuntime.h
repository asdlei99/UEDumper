...
{ 
	...
	SDK_UNDEFINED(16,12437) /* TScriptInterface<Class> */ __um(GridProvider);                                      // 0x0010   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,12438) /* FString */              __um(EventName);                                            // 0x0000   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,12439) /* FString */              __um(CalendarEvent);                                        // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,12440) /* FString */              __um(PauseCalendarEvent);                                   // 0x0018   (0x0010)  
};
...
class alignas(0x10) 
AScriptedObjectMovement_StaticPath : public AActor
{ 
public:
	...
	SDK_UNDEFINED(32,12441) /* TWeakObjectPtr<UScriptedObjectMovement_CalendarCheatDefinition*> */ __um(CheatCalendarEventDefinition); // 0x02D8   (0x0020)  
	FGameplayTag                                       MovementStyleTag;                                           // 0x02F8   (0x0004)  
	unsigned char                                      UnknownData02_5[0x7C];                                      // 0x02FC   (0x007C)  MISSED
	SDK_UNDEFINED(16,12442) /* FString */              __um(EnterSplineCalendarEvent);                             // 0x0378   (0x0010)  
	SDK_UNDEFINED(16,12443) /* FString */              __um(ExitSplineCalendarEvent);                              // 0x0388   (0x0010)  
