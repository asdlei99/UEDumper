...
{ 
public:
	SDK_UNDEFINED(24,15369) /* FText */                __um(WeaponLabelText);                                      // 0x0308   (0x0018)  
	SDK_UNDEFINED(24,15370) /* FText */                __um(GameModeLabelText);                                    // 0x0320   (0x0018)  
...
{ 
	...
	SDK_UNDEFINED(32,15371) /* TWeakObjectPtr<UClass*> */ __um(WidgetClass);                                       // 0x0008   (0x0020)  
};
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x0001   (0x0007)  MISSED
	SDK_UNDEFINED(24,15372) /* FText */                __um(DesiredText);                                          // 0x0008   (0x0018)  
};
...
public:
	...
	SDK_UNDEFINED(32,15373) /* TWeakObjectPtr<UClass*> */ __um(SqueegeeIntroModalClass);                           // 0x0048   (0x0020)  
};
