...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(1,15074) /* TEnumAsByte<EComponentMobility> */ __um(Mobility);                                   // 0x0028   (0x0001)  
	unsigned char                                      UnknownData01_5[0x3];                                       // 0x0029   (0x0003)  MISSED
	...
	SDK_UNDEFINED(1,15075) /* TEnumAsByte<EHasCustomNavigableGeometry> */ __um(CustomNavigableGeometry);           // 0x01D8   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(80,15076) /* TMap<FGuid, UProceduralGeneratorContext*> */ __um(GeneratorContexts);               // 0x0050   (0x0050)  
...
{ 
	...
	SDK_UNDEFINED(8,15077) /* TWeakObjectPtr<UPrimitiveComponent*> */ __um(Component);                             // 0x0038   (0x0008)  
};
