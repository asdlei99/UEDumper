...
{ 
public:
	unsigned char                                      UnknownData00_3[0x30];                                      // 0x0118   (0x0030)  MISSED
	FGameplayTag                                       SynchedActionTag;                                           // 0x0148   (0x0004)  
	unsigned char                                      UnknownData01_5[0x4];                                       // 0x014C   (0x0004)  MISSED
	class UClass*                                      CameraMode;                                                 // 0x0150   (0x0008)  
	FGameplayTag                                       CameraModeTag;                                              // 0x0158   (0x0004)  
	FName                                              MontageStartSectionName;                                    // 0x015C   (0x0004)  
	bool                                               bUseNextSectionAnimName;                                    // 0x0160   (0x0001)  
	unsigned char                                      UnknownData02_5[0x3];                                       // 0x0161   (0x0003)  MISSED
	float                                              OverrideServerAllowablePositionError;                       // 0x0164   (0x0004)  
	float                                              OverrideAnimBlendOutTimeWhenLanding;                        // 0x0168   (0x0004)  
...
struct alignas(0x10) 
FFortMovementMode_TraversalBaseRuntimeData : FFortMovementMode_BaseExtRuntimeData
{ 
...
#pragma pack(push, 0x1)
struct alignas(0x10) 
FFortMovementMode_TraversalBaseCreationData : FFortMovementMode_BaseExtCreationData
{ 
	...
	SDK_UNDEFINED(8,12285) /* TWeakObjectPtr<AActor*> */ __um(RefActor);                                           // 0x0110   (0x0008)  
	SDK_UNDEFINED(8,12286) /* TWeakObjectPtr<UPrimitiveComponent*> */ __um(RefActorComponent);                     // 0x0118   (0x0008)  
