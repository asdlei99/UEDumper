...
{ 
	...
	SDK_UNDEFINED(16,14303) /* FString */              __um(Comment);                                              // 0x0008   (0x0010)  
...
{ 
	SDK_UNDEFINED(8,14304) /* TWeakObjectPtr<UZoneShapeComponent*> */ __um(ShapeComponent);                        // 0x0000   (0x0008)  
...
{ 
	SDK_UNDEFINED(80,14305) /* TMap<UZoneShapeComponent*, FZoneShapeComponentBuildData> */ __um(ZoneShapeComponentBuildData); // 0x0000   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(80,14306) /* TMap<UZoneShapeComponent*, int32_t> */ __um(ShapeComponentToIndex);                 // 0x0020   (0x0050)  
