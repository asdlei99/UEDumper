...
{ 
	SDK_UNDEFINED(32,12651) /* TWeakObjectPtr<USkeletalMesh*> */ __um(SkeletalMesh);                               // 0x0000   (0x0020)  
	SDK_UNDEFINED(32,12652) /* TWeakObjectPtr<UStaticMesh*> */ __um(StaticMesh);                                   // 0x0020   (0x0020)  
	SDK_UNDEFINED(32,12653) /* TWeakObjectPtr<UClass*> */ __um(Blueprint);                                         // 0x0040   (0x0020)  
...
{ 
	...
	SDK_UNDEFINED(16,12654) /* FString */              __um(RangesToApplyToEditorString);                          // 0x00E0   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(8,12655) /* TWeakObjectPtr<ADelMarTrackOobTube*> */ __um(AttachedOobTube);                       // 0x0350   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,12656) /* TWeakObjectPtr<ADelMarTrackBase*> */ __um(Track);                                    // 0x029C   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(8,12657) /* TWeakObjectPtr<UStaticMeshComponent*> */ __um(RoadMesh);                             // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,12658) /* TWeakObjectPtr<ADelMarTrackBase*> */ __um(Track);                                    // 0x00A8   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(32,12659) /* TWeakObjectPtr<UClass*> */ __um(TubeMeshComponentClass);                            // 0x02A8   (0x0020)  
	TArray<FDelMarTrackOobTubeMeshSection>             OobTubeMeshSections;                                        // 0x02C8   (0x0010)  
	SDK_UNDEFINED(32,12660) /* TWeakObjectPtr<UStaticMesh*> */ __um(TubeMesh);                                     // 0x02D8   (0x0020)  
	SDK_UNDEFINED(80,12661) /* TMap<EDelMarTrackOobTubeTransitionType, TWeakObjectPtr<UStaticMesh*>> */ __um(TransitionMeshes); // 0x02F8   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(8,12662) /* TWeakObjectPtr<UDelMarTrackPositionComponent*> */ __um(PlayerPositionComponent);     // 0x00A0   (0x0008)  
	SDK_UNDEFINED(80,12663) /* TSet<USplineMeshComponent*> */ __um(ActiveOOBTubeMeshes);                           // 0x00A8   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(16,12664) /* FString */              __um(ThemeDescription);                                     // 0x0040   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(8,12665) /* TWeakObjectPtr<UDelMarTrackSplineComponent*> */ __um(Spline);                        // 0x0298   (0x0008)  
	SDK_UNDEFINED(16,12666) /* FString */              __um(SplineSelection);                                      // 0x02A0   (0x0010)  
	...
	SDK_UNDEFINED(80,12667) /* TMap<FString, UDelMarTrackSplineComponent*> */ __um(StringToSplineMap);             // 0x02E8   (0x0050)  
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0004   (0x0004)  MISSED
	SDK_UNDEFINED(32,12668) /* TWeakObjectPtr<UClass*> */ __um(TrackSegmentClass);                                 // 0x0008   (0x0020)  
	SDK_UNDEFINED(16,12669) /* TArray<FString> */      __um(MeshCustomizations);                                   // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,12670) /* FString */              __um(Title);                                                // 0x0038   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(32,12671) /* TWeakObjectPtr<UClass*> */ __um(AtoB);                                              // 0x0008   (0x0020)  
	SDK_UNDEFINED(32,12672) /* TWeakObjectPtr<UClass*> */ __um(BtoA);                                              // 0x0028   (0x0020)  
	SDK_UNDEFINED(16,12673) /* FString */              __um(Title);                                                // 0x0048   (0x0010)  
};
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0004   (0x0004)  MISSED
	SDK_UNDEFINED(32,12674) /* TWeakObjectPtr<UClass*> */ __um(StartCap);                                          // 0x0008   (0x0020)  
	SDK_UNDEFINED(32,12675) /* TWeakObjectPtr<UClass*> */ __um(EndCap);                                            // 0x0028   (0x0020)  
};
...
{ 
	FGameplayTag                                       TrackTypeTag;                                               // 0x0000   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0004   (0x0004)  MISSED
	SDK_UNDEFINED(32,12676) /* TWeakObjectPtr<UClass*> */ __um(SegmentClass);                                      // 0x0008   (0x0020)  
	SDK_UNDEFINED(80,12677) /* TMap<FString, bool> */  __um(EnabledMeshCustomizations);                            // 0x0028   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(80,12678) /* TMap<int32_t, UStaticMesh*> */ __um(VariableStaticMeshes);                          // 0x02D0   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(8,12679) /* TWeakObjectPtr<ADelMarTrackBase*> */ __um(Track);                                    // 0x0000   (0x0008)  
};
...
{ 
	SDK_UNDEFINED(8,12680) /* TWeakObjectPtr<ADelMarTrackBase*> */ __um(Track);                                    // 0x0000   (0x0008)  
