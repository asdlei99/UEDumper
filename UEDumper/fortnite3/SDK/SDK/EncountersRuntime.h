...
{ 
	...
	SDK_UNDEFINED(16,13284) /* TArray<TScriptInterface<Class>> */ __um(CurrentPointProviders);                     // 0x0030   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(8,13285) /* TWeakObjectPtr<AEncounterMobAnchor*> */ __um(EncounterAnchorPoint);                  // 0x0050   (0x0008)  
	...
	SDK_UNDEFINED(16,13286) /* TArray<TWeakObjectPtr<AFortAthenaLivingWorldStaticPointProvider*>> */ __um(StaticPointProviders); // 0x0080   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,13287) /* FString */              __um(DevNotes);                                             // 0x0000   (0x0010)  
	...
	SDK_UNDEFINED(32,13288) /* TWeakObjectPtr<UFortAthenaLivingWorldEncounter*> */ __um(MobEncounterData);         // 0x0018   (0x0020)  
...
public:
	...
	SDK_UNDEFINED(16,13289) /* FMulticastInlineDelegate */ __um(OnEncounterStarted);                               // 0x01B0   (0x0010)  
	SDK_UNDEFINED(16,13290) /* FMulticastInlineDelegate */ __um(OnEncounterPaused);                                // 0x01C0   (0x0010)  
	SDK_UNDEFINED(16,13291) /* FMulticastInlineDelegate */ __um(OnEncounterResumed);                               // 0x01D0   (0x0010)  
	SDK_UNDEFINED(16,13292) /* FMulticastInlineDelegate */ __um(OnEncounterActorSpawned);                          // 0x01E0   (0x0010)  
	SDK_UNDEFINED(16,13293) /* FMulticastInlineDelegate */ __um(OnEncounterActorDead);                             // 0x01F0   (0x0010)  
	SDK_UNDEFINED(16,13294) /* FMulticastInlineDelegate */ __um(OnEncounterEnded);                                 // 0x0200   (0x0010)  
	SDK_UNDEFINED(8,13295) /* TWeakObjectPtr<ALivingWorldEncounterPrefab*> */ __um(EncounterPrefab);               // 0x0210   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,13296) /* TWeakObjectPtr<UFortAthenaLivingWorldEncounterInstance*> */ __um(LWMInstance);       // 0x0028   (0x0008)  
	SDK_UNDEFINED(16,13297) /* TArray<TWeakObjectPtr<AFortPawn*>> */ __um(SpawnedMobPawns);                        // 0x0030   (0x0010)  
	unsigned char                                      UnknownData01_5[0x58];                                      // 0x0040   (0x0058)  MISSED
	SDK_UNDEFINED(8,13298) /* TWeakObjectPtr<AActor*> */ __um(EncounterAnchorPoint);                               // 0x0098   (0x0008)  
	SDK_UNDEFINED(8,13299) /* TWeakObjectPtr<AActor*> */ __um(UserActor);                                          // 0x00A0   (0x0008)  
	SDK_UNDEFINED(16,13300) /* TArray<TScriptInterface<Class>> */ __um(ActivePointProviderInterfaces);             // 0x00A8   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,13301) /* TArray<TScriptInterface<Class>> */ __um(EncounterPointProviders);                   // 0x0358   (0x0010)  
	SDK_UNDEFINED(16,13302) /* TArray<TWeakObjectPtr<AEncounterMobAnchor*>> */ __um(EncounterAnchors);             // 0x0368   (0x0010)  
	SDK_UNDEFINED(16,13303) /* TArray<TWeakObjectPtr<ABuildingActor*>> */ __um(BuildingActors);                    // 0x0378   (0x0010)  
	SDK_UNDEFINED(16,13304) /* TArray<TWeakObjectPtr<AFortPlayerController*>> */ __um(Players);                    // 0x0388   (0x0010)  
	SDK_UNDEFINED(80,13305) /* TMap<FString, FString> */ __um(AllVisitedPlayersMap);                               // 0x0398   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(8,13306) /* TWeakObjectPtr<ALivingWorldEncounterPrefab*> */ __um(EncounterPrefab);               // 0x0090   (0x0008)  
	SDK_UNDEFINED(8,13307) /* TWeakObjectPtr<UEncounterManagerComponent*> */ __um(EncounterManager);               // 0x0098   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(32,13308) /* TWeakObjectPtr<UWorld*> */ __um(Level);                                             // 0x0340   (0x0020)  
	SDK_UNDEFINED(32,13309) /* TWeakObjectPtr<UStateTree*> */ __um(StateTreeOverride);                             // 0x0360   (0x0020)  
...
{ 
	...
	SDK_UNDEFINED(8,13310) /* TWeakObjectPtr<AActor*> */ __um(TargetActor);                                        // 0x0020   (0x0008)  
};
...
{ 
	SDK_UNDEFINED(8,13311) /* TWeakObjectPtr<AActor*> */ __um(TrackedActor);                                       // 0x0000   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(8,13312) /* TWeakObjectPtr<AEncounterGameplayVolume*> */ __um(EncounterVolume);                  // 0x00A0   (0x0008)  
	SDK_UNDEFINED(8,13313) /* TWeakObjectPtr<AActor*> */ __um(CenterActorOverride);                                // 0x00A8   (0x0008)  
	SDK_UNDEFINED(16,13314) /* TArray<TWeakObjectPtr<ABuildingActor*>> */ __um(ActorsToRemainAfterEncounter);      // 0x00B0   (0x0010)  
	FDataTableRowHandle                                PostEncounterLWMEvent;                                      // 0x00C0   (0x0010)  
	FDataTableRowHandle                                PostEncounterLWMCategory;                                   // 0x00D0   (0x0010)  
	SDK_UNDEFINED(80,13315) /* TSet<AFortPlayerController*> */ __um(ExplicitContributors);                         // 0x00E0   (0x0050)  
	...
	SDK_UNDEFINED(8,13316) /* TWeakObjectPtr<UEncounterItem*> */ __um(EncounterItem);                              // 0x0160   (0x0008)  
	SDK_UNDEFINED(8,13317) /* TWeakObjectPtr<ALivingWorldEncounterPrefab*> */ __um(EncounterPrefab);               // 0x0168   (0x0008)  
	SDK_UNDEFINED(32,13318) /* TWeakObjectPtr<UDataTable*> */ __um(LWMEncounterTable);                             // 0x0170   (0x0020)  
	unsigned char                                      UnknownData00_5[0x100];                                     // 0x0190   (0x0100)  MISSED
	SDK_UNDEFINED(8,13319) /* TWeakObjectPtr<AActor*> */ __um(LastThreat);                                         // 0x0290   (0x0008)  
	SDK_UNDEFINED(8,13320) /* TWeakObjectPtr<AActor*> */ __um(ReservoirActor);                                     // 0x0298   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(8,13321) /* TWeakObjectPtr<AActor*> */ __um(ReservoirActorOverride);                             // 0x09B8   (0x0008)  
	SDK_UNDEFINED(8,13322) /* TWeakObjectPtr<UEncounterManagerComponent*> */ __um(EncounterManager);               // 0x09C0   (0x0008)  
...
{ 
	SDK_UNDEFINED(8,13323) /* TWeakObjectPtr<AActor*> */ __um(InActor);                                            // 0x0000   (0x0008)  
...
{ 
	...
	SDK_UNDEFINED(8,13324) /* TWeakObjectPtr<AActor*> */ __um(TargetActor);                                        // 0x0004   (0x0008)  
...
{ 
	...
	SDK_UNDEFINED(32,13325) /* TWeakObjectPtr<UClass*> */ __um(Value);                                             // 0x0008   (0x0020)  
	class AActor*                                      UserActor;                                                  // 0x0028   (0x0008)  
};
...
{ 
	FGameplayTag                                       VariableIdentifier;                                         // 0x0000   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0004   (0x0004)  MISSED
	SDK_UNDEFINED(32,13326) /* TWeakObjectPtr<UFortWorldItemDefinition*> */ __um(Value);                           // 0x0008   (0x0020)  
	class AActor*                                      UserActor;                                                  // 0x0028   (0x0008)  
};
...
{ 
	FGameplayTag                                       VariableIdentifier;                                         // 0x0000   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0004   (0x0004)  MISSED
	SDK_UNDEFINED(32,13327) /* TWeakObjectPtr<UFortAthenaLivingWorldEncounter*> */ __um(Value);                    // 0x0008   (0x0020)  
	class AActor*                                      UserActor;                                                  // 0x0028   (0x0008)  
};
...
{ 
	...
	SDK_UNDEFINED(32,13328) /* TWeakObjectPtr<UFortAthenaLivingWorldEncounter*> */ __um(LWMEncounter);             // 0x0078   (0x0020)  
...
{ 
	SDK_UNDEFINED(8,13329) /* TWeakObjectPtr<AActor*> */ __um(CenterActor);                                        // 0x0000   (0x0008)  
	class AActor*                                      UserActor;                                                  // 0x0008   (0x0008)  
};
...
{ 
	SDK_UNDEFINED(32,13330) /* TWeakObjectPtr<UClass*> */ __um(Value);                                             // 0x0008   (0x0020)  
};
...
{ 
	SDK_UNDEFINED(32,13331) /* TWeakObjectPtr<UFortWorldItemDefinition*> */ __um(Value);                           // 0x0008   (0x0020)  
};
...
{ 
	SDK_UNDEFINED(32,13332) /* TWeakObjectPtr<UFortAthenaLivingWorldEncounter*> */ __um(Value);                    // 0x0008   (0x0020)  
};
...
{ 
	...
	SDK_UNDEFINED(8,13333) /* TWeakObjectPtr<AActor*> */ __um(AnchorActor);                                        // 0x0048   (0x0008)  
	class AActor*                                      UserActor;                                                  // 0x0050   (0x0008)  
};
...
{ 
	FGameplayTagQuery                                  ActorQuery;                                                 // 0x0000   (0x0048)  
	SDK_UNDEFINED(8,13334) /* TWeakObjectPtr<AActor*> */ __um(ChosenActor);                                        // 0x0048   (0x0008)  
	class AActor*                                      UserActor;                                                  // 0x0050   (0x0008)  
};
...
{ 
	...
	SDK_UNDEFINED(32,13335) /* TWeakObjectPtr<UFortAthenaLivingWorldEncounter*> */ __um(DynamicEmptyEncounter);    // 0x0148   (0x0020)  
	SDK_UNDEFINED(8,13336) /* TWeakObjectPtr<ULWMEncounterInstance*> */ __um(EncounterInstance);                   // 0x0168   (0x0008)  
};
...
{ 
	SDK_UNDEFINED(32,13337) /* TWeakObjectPtr<UFortAthenaLivingWorldEncounter*> */ __um(Encounter);                // 0x0008   (0x0020)  
...
{ 
	...
	SDK_UNDEFINED(8,13338) /* TWeakObjectPtr<AActor*> */ __um(TargetActor);                                        // 0x0064   (0x0008)  
...
{ 
	...
	SDK_UNDEFINED(32,13339) /* TWeakObjectPtr<UFortAthenaLivingWorldEncounter*> */ __um(LWMEncounter);             // 0x0188   (0x0020)  
	SDK_UNDEFINED(8,13340) /* TWeakObjectPtr<ULWMEncounterInstance*> */ __um(EncounterInstance);                   // 0x01A8   (0x0008)  
};
...
{ 
	SDK_UNDEFINED(32,13341) /* TWeakObjectPtr<UClass*> */ __um(ActorClass);                                        // 0x0000   (0x0020)  
	...
	SDK_UNDEFINED(8,13342) /* TWeakObjectPtr<AActor*> */ __um(SpawnedActor);                                       // 0x00CC   (0x0008)  
