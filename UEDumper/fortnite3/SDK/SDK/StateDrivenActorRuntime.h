...
public:
	...
	SDK_UNDEFINED(8,14154) /* TWeakObjectPtr<UStaticMeshComponent*> */ __um(MeshComponentPtr);                     // 0x01E0   (0x0008)  
	SDK_UNDEFINED(8,14155) /* TWeakObjectPtr<USphereComponent*> */ __um(OverlapComponentPtr);                      // 0x01E8   (0x0008)  
...
{ 
	SDK_UNDEFINED(16,14156) /* FString */              __um(DevNotes);                                             // 0x0000   (0x0010)  
	...
	SDK_UNDEFINED(16,14157) /* TArray<TWeakObjectPtr<UMaterialInstance*>> */ __um(MaterialInstances);              // 0x0080   (0x0010)  
	FGameplayCueTag                                    LoopingGameplayCueTag;                                      // 0x0090   (0x0004)  
	float                                              OverlapRadius;                                              // 0x0094   (0x0004)  
	SDK_UNDEFINED(24,14158) /* FText */                __um(InteractionStringOverride);                            // 0x0098   (0x0018)  
	SDK_UNDEFINED(24,14159) /* FText */                __um(InteractionFailedStringOverride);                      // 0x00B0   (0x0018)  
...
{ 
	...
	SDK_UNDEFINED(24,14160) /* FText */                __um(InteractionStringOverride);                            // 0x0040   (0x0018)  
};
...
{ 
	...
	SDK_UNDEFINED(8,14161) /* TWeakObjectPtr<UFortNonPlayerConversationParticipantComponent*> */ __um(ConversationComponentPtr); // 0x005C   (0x0008)  
...
{ 
	SDK_UNDEFINED(32,14162) /* TWeakObjectPtr<UFortItemDefinition*> */ __um(DepositItem);                          // 0x0058   (0x0020)  
