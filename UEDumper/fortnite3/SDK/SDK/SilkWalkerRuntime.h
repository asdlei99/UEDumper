...
public:
	...
	SDK_UNDEFINED(8,15308) /* TWeakObjectPtr<AFortGameModeAthena*> */ __um(CachedGameMode);                        // 0x0100   (0x0008)  
	SDK_UNDEFINED(8,15309) /* TWeakObjectPtr<UFortGameStateComponent_AffiliationManager*> */ __um(CachedAffiliationManager); // 0x0108   (0x0008)  
};
