...
{ 
	...
	SDK_UNDEFINED(16,13063) /* FString */              __um(Value);                                                // 0x0008   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(80,13064) /* TSet<FGameplayTag> */   __um(ConditionContextKeys);                                 // 0x0050   (0x0050)  
...
{ 
	...
	SDK_UNDEFINED(16,13065) /* FString */              __um(ComparisonConstant);                                   // 0x0008   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(80,13066) /* TSet<FGameplayTag> */   __um(ConditionContextKeys);                                 // 0x0050   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(80,13067) /* TMap<ULocalPlayer*, int32_t> */ __um(ChildStateCharts);                             // 0x0050   (0x0050)  
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(80,13068) /* TMap<UClass*, FUIStateComponentInstanceStack> */ __um(InstanceStacks);              // 0x0028   (0x0050)  
};
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(16,13069) /* FString */              __um(Name);                                                 // 0x0028   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(80,13070) /* TSet<FGameplayTag> */   __um(ContinualAutomationContextKeys);                       // 0x0090   (0x0050)  
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(80,13071) /* TMap<FGameplayTag, UUIStateChartContextEntry*> */ __um(Store);                      // 0x0028   (0x0050)  
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(16,13072) /* FString */              __um(CommonValue);                                          // 0x0028   (0x0010)  
	SDK_UNDEFINED(80,13073) /* TMap<ULocalPlayer*, FUIStateChartContextEntryOverride> */ __um(PlayerOverrides);    // 0x0038   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(80,13074) /* TMap<ULocalPlayer*, UUIStateChartManagerPlayer*> */ __um(PlayerEntries);            // 0x0038   (0x0050)  
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(80,13075) /* TMap<int32_t, UUIStateChartManagerEntry*> */ __um(ActiveChartEntries);              // 0x0028   (0x0050)  
	SDK_UNDEFINED(80,13076) /* TMap<int32_t, UUIStateChartManagerEntry*> */ __um(InactiveChartEntries);            // 0x0078   (0x0050)  
...
{ 
	SDK_UNDEFINED(80,13077) /* TMap<FGameplayTag, FString> */ __um(Changes);                                       // 0x0000   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(80,13078) /* TMap<FGameplayTag, UUIState*> */ __um(TaggedStates);                                // 0x0050   (0x0050)  
	...
	SDK_UNDEFINED(16,13079) /* FString */              __um(ChartName);                                            // 0x00D0   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(80,13080) /* TMap<UClass*, UObject*> */ __um(ResourcesByClass);                                  // 0x0028   (0x0050)  
};
...
public:
	unsigned char                                      UnknownData00_3[0x28];                                      // 0x0000   (0x0028)  MISSED
	SDK_UNDEFINED(80,13081) /* TSet<UUIStateChartTransitionOperation*> */ __um(Operations);                        // 0x0028   (0x0050)  
	SDK_UNDEFINED(80,13082) /* TSet<UUIStateChartTransitionOperation*> */ __um(OperationsReadyForContextUpdate);   // 0x0078   (0x0050)  
...
{ 
	SDK_UNDEFINED(16,13083) /* FString */              __um(OverrideValue);                                        // 0x0000   (0x0010)  
