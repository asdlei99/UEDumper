...
{ 
public:
	SDK_UNDEFINED(16,14824) /* FString */              __um(Filename);                                             // 0x0058   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,14825) /* TArray<FString> */      __um(Value);                                                // 0x0000   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(1,14826) /* TEnumAsByte<EHDRCaptureGamut> */ __um(CaptureGamut);                                 // 0x0070   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(1,14827) /* TEnumAsByte<EHDRCaptureGamut> */ __um(CaptureGamut);                                 // 0x00D9   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(16,14828) /* FString */              __um(OutputFormat);                                         // 0x0018   (0x0010)  
	...
	SDK_UNDEFINED(16,14829) /* FString */              __um(MovieExtension);                                       // 0x0030   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,14830) /* FString */              __um(AdditionalCommandLineArguments);                       // 0x00F0   (0x0010)  
	SDK_UNDEFINED(16,14831) /* FString */              __um(InheritedCommandLineArguments);                        // 0x0100   (0x0010)  
...
{ 
	SDK_UNDEFINED(80,14832) /* TMap<FName, FName> */   __um(Identifiers);                                          // 0x0000   (0x0050)  
};
