...
public:
	...
	// void OnPlayerStateSet(class AFortPlayerStateAthena* InPlayerState);                                                   // [0x2047e54] Event|Protected|BlueprintEvent 
	// Function /Script/MusterConsumablesUI.EnergyDrinkStaminaBarOverlayWidget.OnPlayerDeadStateChanged
	// void OnPlayerDeadStateChanged(class AFortPlayerStateAthena* PlayerState, bool bIsDead);                               // [0x2047e54] Event|Protected|BlueprintEvent 
};
